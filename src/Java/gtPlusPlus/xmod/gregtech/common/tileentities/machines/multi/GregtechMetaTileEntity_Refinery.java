...
public class GregtechMetaTileEntity_Refinery extends GT_MetaTileEntity_MultiBlockBase {
    ...
    public String[] getDescription() {
        return new String[]{
                "Controller Block for the Fuel Processing Unit",
                "Size(WxHxD): 3x9x3", "Controller (Front middle at bottom)",
                "3x2x3 Base platform of Hastelloy-X",
                "1x3x1 Incoloy-DS Fluid Containment Block pillar (Center of base)",
                "1x3x1 Hastelloy-N Sealant Blocks (Each Incoloy-DS Fluid Containment side and on top)",
