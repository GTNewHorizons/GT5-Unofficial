...
public abstract class GregtechMetaTileEntityLosslessTieredMachineBlock extends MetaTileEntity {
	...
	public GregtechMetaTileEntityLosslessTieredMachineBlock(final int aID, final String aName, final String aNameRegional, final int aTier, final int aInvSlotCount, final String aDescription, final ITexture... aTextures) {
	...
	public GregtechMetaTileEntityLosslessTieredMachineBlock(final String aName, final int aTier, final int aInvSlotCount, final String aDescription, final ITexture[][][] aTextures) {
