 ...
 * 
 * @author Alkalus
 * @category Core Class Improvements
 * @version 1.0.1
 * @see Fluid Tanks or Quantum Storage for examples
 *
 */

public class BaseMetaTileEntityCustomNBT extends BaseMetaTileEntity implements IGregTechTileEntity {
	...
	//Fluid Storage
	private String mStoredFluidName = "";
	private int mStoredFluidAmount = 0;
	
	//Boolean Switches
	//Machine General
	private boolean mIsFluidTank = false;
	...
	public BaseMetaTileEntityCustomNBT() {
	}
