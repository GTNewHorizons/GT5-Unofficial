...
/**
 * Tests some functions of {@link MultiBlockBase}.
 * <p>
...
class GT_MetaTileEntity_MultiBlockBaseTest {
    ...
    void checkExoticAndNormalEnergyHatches_parametrizedTest(int exoticEnergyHatchesCount, int normalEnergyHatchesCount,
        ...
        MultiBlockBase testedClassInstance = Mockito.mock(MultiBlockBase.class, Answers.CALLS_REAL_METHODS);

        testedClassInstance.setEnergyHatches(fillList(Hatch_Energy.class, normalEnergyHatchesCount));
        testedClassInstance.setExoticEnergyHatches(fillList(Hatch.class, exoticEnergyHatchesCount));
