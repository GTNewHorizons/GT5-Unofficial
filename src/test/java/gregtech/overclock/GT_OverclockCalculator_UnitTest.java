...
class GT_OverclockCalculator_UnitTest {
    ...
    void fullPerfectOverclockEBF_Test() {
        ...
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[5]).setDuration(1024)
                .setHeatOC(true).setHeatDiscount(true).setRecipeHeat(1800).setMachineHeat(1800 * 5).calculate();
    ...
    void imperfectOverclockEBFWithOneHeatDiscount_Test() {
        ...
        long correctConsumption = (long) Math.ceil(VP[5] * GTUtility.powInt(0.95, heatDiscounts));
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[5]).setDuration(1024)
                .setHeatOC(true).setHeatDiscount(true).setRecipeHeat(1800).setMachineHeat(2700).calculate();
    ...
    void imperfectOverclockEBFWithoutHeatDiscounts_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[5]).setDuration(1024)
                .setHeatOC(true).setHeatDiscount(true).setRecipeHeat(1800).setMachineHeat(1800).calculate();
        assertEquals(1024 / GTUtility.powInt(2, 4), calculator.getDuration(), messageDuration);
    ...
    void perfectAndImperfectOverclockEBFWithTwoHeatDiscounts_Test() {
        ...
        long correctConsumption = (long) Math.ceil(VP[5] * GTUtility.powInt(0.95, heatDiscounts));
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[5]).setDuration(1024)
                .setHeatOC(true).setHeatDiscount(true).setRecipeHeat(1800).setMachineHeat(3600).calculate();
    ...
    void generalImperfectOverclock_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[6]).setDuration(1024)
                .calculate();
    ...
    void generalPerfectOverclock_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[6]).setDuration(2048)
    ...
    void weirdHeatEBF_Test() {
        ...
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[6]).setDuration(2048)
                .setHeatOC(true).setHeatDiscount(true).setRecipeHeat(486).setMachineHeat(3900).calculate();
    ...
    void doubleEnergyHatchOC_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[6]).setAmperage(4)
                .setDuration(1024).setAmperageOC(true).calculate();
    ...
    void doubleEnergyHatchOCForULV_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[0]).setEUt(V[6]).setAmperage(4)
                .setDuration(1024).setAmperageOC(true).calculate();
        assertEquals(1024 / GTUtility.powInt(2, 6), calculator.getDuration(), messageDuration);
    ...
    void multiAmpHatchOC_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[6]).setAmperage(256)
                .setDuration(1024).setAmperageOC(true).calculate();
    ...
    void weirdAmpHatchOC_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[6]).setAmperage(320)
                .setDuration(1024).setAmperageOC(true).calculate();
        assertEquals(1024 / GTUtility.powInt(2, 9), calculator.getDuration(), messageDuration);
        assertEquals(VP[10], calculator.getConsumption(), messageEUt);
    }
    ...
    void parallelImperfectOC_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[8]).setAmperage(4)
                .setDuration(1024).setParallel(16).setAmperageOC(true).calculate();
        assertEquals(1024 / GTUtility.powInt(2, 6), calculator.getDuration(), messageDuration);
    ...
    void parallelPerfectOC_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[8]).setAmperage(4)
                .setDuration(4096).setParallel(16).setAmperageOC(true).enablePerfectOC().calculate();
    ...
    void weirdParallelOC_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[8]).setDuration(1024)
                .setParallel(8).calculate();
        assertEquals(1024 / GTUtility.powInt(2, 5), calculator.getDuration(), messageDuration);
    ...
    void weirdParallelAndAmpsOC_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[8]).setAmperage(320)
                .setDuration(1024).setParallel(8).setAmperageOC(true).calculate();
        assertEquals(1024 / GTUtility.powInt(2, 9), calculator.getDuration(), messageDuration);
    ...
    void weirdTimeOC_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[6]).setDuration(77)
                .calculate();
    ...
    void correctWhenOneTicking_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[6]).setDuration(1)
                .calculate();
    ...
    void imperfectOCWithEUtDiscount_Test() {
        ...
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[6]).setEUtDiscount(0.9)
    ...
    void perfectOCWithEUtDiscount_Test() {
        long correctConsumption = (long) Math.ceil(VP[1] * 0.9f) << 10;
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[6]).setEUtDiscount(0.9)
                .setDuration(1024).enablePerfectOC().calculate();
    ...
    void imperfectOCWithSpeedBoost_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[6])
                .setDurationModifier(0.9).setDuration(1024).calculate();
    ...
    void perfectOCWithSpeedBoost_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[6])
                .setDurationModifier(0.9).setDuration(2048).enablePerfectOC().calculate();
    ...
    void perfectOC3TicksTo1Tick_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[4]).setEUt(V[5]).setDuration(3)
                .enablePerfectOC().calculate();
        assertEquals(1, calculator.getDuration(), messageDuration);
        assertEquals(VP[5], calculator.getConsumption(), messageEUt);
    }
    ...
    void ulvRecipeWithDiscount_Test() {
        ...
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[0]).setEUt(V[6]).setEUtDiscount(0.9)
                .setDuration(1024).calculate();
        assertEquals(1024 / GTUtility.powInt(2, 5), calculator.getDuration(), messageDuration);
        assertEquals(correctConsumption, calculator.getConsumption(), messageEUt);
    }
    ...
    void ulvRecipeWithDiscountWithParallel_Test() {
        ...
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[0]).setEUt(V[5]).setEUtDiscount(0.9)
                .setParallel(14).setDuration(1024).calculate();
    ...
    void ulvRecipeCorrectWhenOneTicked_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[0]).setEUt(V[6]).setDuration(1)
                .calculate();
        assertEquals(1, calculator.getDuration(), messageDuration);
    ...
    void testNotPowerOverflowing_Test() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(16).setParallel(64).setAmperage(64)
                .setAmperageOC(true).setEUt(V[5]).setDuration(30).calculate();
        assertEquals(1, calculator.getDuration(), messageDuration);
    ...
    void testCorrectEUtWhenOverclockingUnderOneTick_Test() {
        ...
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(24).setParallel(56).setAmperage(1)
                .setAmperageOC(true).setDurationModifier(1 / 6.0).setEUt(V[14] * 1_048_576).setDuration(56)
                .setCurrentParallel(6144).calculate();
    ...
    void testCorrectEUtWhenOverclockingUnderOneTickWithHeat_Test() {
        ...
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(1920).setParallel(256).setAmperage(1)
                .setAmperageOC(true).setHeatDiscount(true).setHeatOC(true).setRecipeHeat(2000).setMachineHeat(15500)
                .setEUt(V[12] * 1_048_576).setDuration(250);
        calculator.setCurrentParallel((int) (256 * calculator.calculateMultiplierUnderOneTick())).calculate();
        assertEquals(
    ...
    void testCorrectOverclockWhenCurrentParallelLessThanOriginalParallel() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(24).setParallel(64).setAmperage(1)
                .setAmperageOC(true).setEUt(V[6]).setDuration(56).setCurrentParallel(16).calculate();
    ...
    void stopsCorrectlyWhenOverclockingUnderOneTick() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[2]).setEUt(V[9]).setParallel(4)
                .setDuration(10).setAmperageOC(false).setAmperage(16).setCurrentParallel(16).calculate();
        assertEquals((VP[2] * 4) * GTUtility.powInt(4, 7), calculator.getConsumption());
    }

    @Test
    void testNoOverclockCorrectWithUnderOneTickLogic_Test() {
        OverclockCalculator calculator = OverclockCalculator.ofNoOverclock(2_693_264_510L, 100).setParallel(24 * 64);
        assertEquals(1, calculator.calculateMultiplierUnderOneTick());
    }

    @Test
    void ulvRecipeDoesntOverclockExtraWithAmperageWithoutAmperageOC() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(2).setEUt(V[3]).setParallel(16)
                .setDuration(20).setAmperageOC(false).setAmperage(16).calculate();
    ...
    void ulvRecipeDoesntOverclockExtraWithAmperageWithoutAmperageOCVersion2() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(2).setEUt(V[3]).setParallel(64)
                .setDuration(20).setAmperageOC(false).setAmperage(16).calculate();
    ...
    void ulvRecipeDoesntOverclockExtraWithAmperageWithoutAmperageOCVersion3() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(2).setEUt(V[3]).setParallel(16)
                .setDuration(20).setAmperageOC(false).setAmperage(64).calculate();
        assertEquals(32 * 16, calculator.getConsumption(), messageEUt);
    }

    @Test
    void ulvRecipeDoesntOverclockExtraWithAmperageWithoutAmperageOCVersion4() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(8).setEUt(V[3]).setParallel(16)
                .setDuration(20).setAmperageOC(false).setAmperage(16).calculate();
    ...
    void ulvRecipeDoesntOverclockExtraWithAmperageWithoutAmperageOCVersion5() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(8).setEUt(V[3]).setParallel(16)
                .setDuration(20).setAmperageOC(false).calculate();
    ...
    void ulvRecipeDoesntOverclockExtraWithAmperageWithoutAmperageOCVersion6() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(7).setEUt(V[3]).setParallel(64)
                .setDuration(160).setAmperage(64).setAmperageOC(false).calculate();
    ...
    void ulvRecipeDoesntOverclockExtraWithAmperageWithoutAmperageOCVersion7() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(7).setEUt(V[3]).setParallel(19)
                .setDuration(160).setAmperage(19).setAmperageOC(false).calculate();
    ...
    void ulvRecipeDoesntOverclockExtraWithAmperageWithoutAmperageOCVersion8() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(7).setEUt(V[3]).setParallel(29)
                .setDuration(160).setAmperage(25).setAmperageOC(false).calculate();
    ...
    void ulvRecipeWorkCorrectlyWithCalculatingEutUnderOneTick() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(2).setEUt(V[8]).setParallel(64)
                .setDuration(300).setAmperage(64).setAmperageOC(false).calculate();
    ...
    void overclockWithAbnormalEnergyIncrease_Test() {
        ...
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[6]).setDuration(1024)
                .setEUtIncreasePerOC(4.1).calculate();
        assertEquals(1024 / GTUtility.powInt(2, 5), calculator.getDuration(), messageDuration);
    ...
    void overclockWithAbnormalDurationDecrease_Test() {
        ...
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(VP[1]).setEUt(V[6]).setDuration(1024)
                .setDurationDecreasePerOC(2.1).calculate();
    ...
    void slightlyOverOneAmpRecipeWorksWithSingleEnergyHatch() {
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(614400).setEUt(TierEU.UV)
                .setDuration(600).setAmperage(2).setAmperageOC(false).calculate();
    ...
    void floatPrecisionIssues(double speedBoost, double eutDiscount, int expectedEUt) {
        ...
        OverclockCalculator calculator = new OverclockCalculator().setRecipeEUt(10).setEUt(machineVoltage)
                .setDuration(20 * 20).setDurationModifier(speedBoost).setEUtDiscount(eutDiscount)
                .setParallel(maxParallel);
        maxParallel = GTUtility.safeInt((long) (maxParallel * calculator.calculateMultiplierUnderOneTick()), 0);
        calculator.setCurrentParallel(maxParallel).calculate();
