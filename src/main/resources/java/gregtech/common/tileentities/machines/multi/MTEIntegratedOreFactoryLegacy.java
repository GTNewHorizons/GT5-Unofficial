...
public class MTEIntegratedOreFactoryLegacy extends MTEExtendedPowerMultiBlockBase<MTEIntegratedOreFactoryLegacy>
    ...
    private static final IStructureDefinition<MTEIntegratedOreFactoryLegacy> STRUCTURE_DEFINITION = StructureDefinition
        .<MTEIntegratedOreFactoryLegacy>builder()
        .addShape(
        ...
        .addElement(
            'I',
            buildHatchAdder(MTEIntegratedOreFactoryLegacy.class).atLeast(InputBus)
                .casingIndex(CASING_INDEX1)
                .hint(2)
                .buildAndChain(GregTechAPI.sBlockCasings8, 7))
        .addElement(
            'W',
            buildHatchAdder(MTEIntegratedOreFactoryLegacy.class).atLeast(InputHatch, Muffler)
                .casingIndex(CASING_INDEX2)
                .hint(3)
                .buildAndChain(GregTechAPI.sBlockCasings4, 1))
        .addElement(
            'O',
            buildHatchAdder(MTEIntegratedOreFactoryLegacy.class).atLeast(OutputBus, OutputHatch)
                .casingIndex(CASING_INDEX2)
                .hint(4)
                .buildAndChain(GregTechAPI.sBlockCasings4, 1))
        .build();
    ...
    public MTEIntegratedOreFactoryLegacy(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEIntegratedOreFactoryLegacy(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTEIntegratedOreFactoryLegacy> getStructureDefinition() {
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEIntegratedOreFactoryLegacy(mName);
    }
    ...
    public ITexture getCasingTexture() {
        return Textures.BlockIcons.getCasingTextureForId(CASING_INDEX2);
    }
