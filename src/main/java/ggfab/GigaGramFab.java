...
public class GigaGramFab {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        GregTechAPI.sAfterGTPreload.add(() -> {
            ...
            GigaGramFabAPI.addSingleUseToolType(craftingToolFile, GTToolItems.FILE.getToolStats(), 2 * plate);
            ...
            GigaGramFabAPI.addSingleUseToolType(
                ...
                3 * plate + 2 * rod + screw);
            GigaGramFabAPI
                .addSingleUseToolType(craftingToolHardHammer, GTToolItems.HARD_HAMMER.getToolStats(), 6 * ingot);
            GigaGramFabAPI
