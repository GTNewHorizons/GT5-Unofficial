...
class ComponentRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Machine_Multi_Assemblyline.get(1L))
                ...
                .itemOutputs(GGItemList.AdvAssLine.get(1L)).eut(TierEU.RECIPE_LuV).duration(3 * MINUTES)
                .addTo(AssemblyLine);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Polybenzimidazole.getMolten(1 * INGOTS)).duration(30 * SECONDS)
