    ...
    public void run() {
        ...
        RA.stdBuilder()
                .itemInputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.wireGt16, Materials.Graphene, 64),
                        GTOreDictUnificator.get(OrePrefixes.wireGt16, Materials.Graphene, 64))
                .itemOutputs(ItemList.NanotubeSpool.get(1)).fluidInputs(Materials.AdvancedGlue.getFluid(720))
                .duration(1 * MINUTE).eut(TierEU.RECIPE_ZPM).requiresCleanRoom().addTo(assemblerRecipes);

        // Space Elevator Cable
        RA.stdBuilder()
                .itemInputs(
                        ItemList.NanotubeSpool.get(64),
                ...
                .itemOutputs(ItemList.SpaceElevatorCable.get(1)).duration(2 * MINUTE).eut(TierEU.RECIPE_UHV)
        ...
        RA.stdBuilder()
                ...
                .fluidInputs(MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(32 * INGOTS)).duration(2 * MINUTE)
        ...
        RA.stdBuilder()
                ...
                .fluidInputs(MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(1 * STACKS)).duration(2 * MINUTE)
                .eut(TierEU.RECIPE_UIV).addTo(assemblerRecipes);
        ...
        RA.stdBuilder()
                ...
                .itemOutputs(ItemList.MiningDroneLV.get(1)).fluidInputs(Materials.SolderingAlloy.getMolten(5 * INGOTS))
                .duration(1 * MINUTE).eut(TierEU.RECIPE_LV).addTo(assemblerRecipes);
        ...
        RA.stdBuilder()
                ...
                .itemOutputs(ItemList.MiningDroneMV.get(1)).fluidInputs(Materials.SolderingAlloy.getMolten(10 * INGOTS))
                .duration(1 * MINUTE).eut(TierEU.RECIPE_MV).addTo(assemblerRecipes);
        ...
        RA.stdBuilder()
                ...
                .itemOutputs(ItemList.MiningDroneHV.get(1)).fluidInputs(Materials.SolderingAlloy.getMolten(10 * INGOTS))
                .duration(1 * MINUTE).eut(TierEU.RECIPE_HV).addTo(assemblerRecipes);
