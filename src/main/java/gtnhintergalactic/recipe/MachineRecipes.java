    ...
    public void run() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderLuV, 5760), Materials.UUMatter.getFluid(16000),
                Materials.Lubricant.getFluid(32000), Materials.Neutronium.getMolten(10 * INGOTS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderLuV, 5760), Materials.UUMatter.getFluid(2 * BUCKETS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderLuV, 5760), Materials.UUMatter.getFluid(1 * BUCKETS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderLuV, 5760), Materials.UUMatter.getFluid(8 * BUCKETS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderLuV, 5760), Materials.UUMatter.getFluid(8 * BUCKETS),
                Materials.Naquadria.getMolten(10 * INGOTS), Materials.Lubricant.getFluid(16000) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.SpaceElevatorBaseCasing.get(1), ItemList.Electric_Motor_UEV.get(4),
                ...
                GTOreDictUnificator.get(OrePrefixes.plate, Materials.Osmiridium, 16), },
            new FluidStack[] { new FluidStack(solderUEV, 2880), Materials.UUMatter.getFluid(8 * BUCKETS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderUEV, 1296), Materials.Infinity.getMolten(4 * INGOTS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderUEV, 9216), MaterialsUEVplus.Eternity.getMolten(16 * INGOTS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderLuV, 1296), Materials.Naquadria.getMolten(9 * INGOTS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderUEV, 1296), Materials.Infinity.getMolten(9 * INGOTS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderUEV, 5184), MaterialsUEVplus.BlackDwarfMatter.getMolten(9 * INGOTS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderLuV, 4608), Materials.Infinity.getMolten(16 * INGOTS),
                Materials.UUMatter.getFluid(8 * BUCKETS), Materials.SuperCoolant.getFluid(4 * BUCKETS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderLuV, 4608), Materials.Iridium.getMolten(16 * INGOTS),
                Materials.UUMatter.getFluid(2 * BUCKETS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderLuV, 2880), Materials.Naquadria.getMolten(10 * INGOTS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderLuV, 2880), Materials.Naquadria.getMolten(20 * INGOTS),
                Materials.Lubricant.getFluid(16000) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderUEV, 2880),
                MaterialsUEVplus.TranscendentMetal.getMolten(10 * INGOTS), Materials.UUMatter.getFluid(2 * BUCKETS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderLuV, 720), Materials.Iridium.getMolten(5 * INGOTS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderLuV, 1440), Materials.Iridium.getMolten(10 * INGOTS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderLuV, 2880), Materials.Osmiridium.getMolten(10 * INGOTS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderUEV, 2880), Materials.Neutronium.getMolten(10 * INGOTS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderUEV, 2880), Materials.Quantium.getMolten(10 * INGOTS),
                new FluidStack(FluidRegistry.getFluid("liquid_drillingfluid"), 512000) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(solderUEV, 5760), Materials.Quantium.getMolten(20 * INGOTS),
                new FluidStack(FluidRegistry.getFluid("liquid_drillingfluid"), 512000) },
