...
public class MachineRecipes implements Runnable {
    ...
    public void run() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            (int) TierEU.RECIPE_UHV,
            4,
            new Object[] { ItemList.OilDrillInfinite.get(1), ItemList.PlanetarySiphon.get(1),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            64000000,
            4,
            new Object[] { ItemList.OilDrillInfinite.get(4), ItemList.PlanetarySiphon.get(4),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            256000000,
            4,
            new Object[] { ItemList.OilDrillInfinite.get(16), ItemList.PlanetarySiphon.get(16),
