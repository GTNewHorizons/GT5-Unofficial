...
public class GT_UITextures {
    ...
    public static final AdaptableUITexture BACKGROUND_FLOCCULATION_RECIPE = AdaptableUITexture
        .of(GregTech.ID, "gui/background/flocculation_recipe.png", 1040, 490, 2);
