...
public class GT_UITextures {
    ...
    public static final SteamTexture SLOT_ITEM_STEAM = SteamTexture.fullImage(GregTech.modID, "gui/slot/item_%s");
    public static final SteamTexture SLOT_FLUID_STEAM = SteamTexture.fullImage(GregTech.modID, "gui/slot/fluid_%s");
    ...
    public static final UITexture OVERLAY_SLOT_GEM = UITexture.fullImage(GregTech.modID, "gui/overlay_slot/gem");
    public static final UITexture OVERLAY_SLOT_HAMMER = UITexture.fullImage(GregTech.modID, "gui/overlay_slot/hammer");
    ...
    public static final UITexture OVERLAY_SLOT_SQUARE = UITexture.fullImage(GregTech.modID, "gui/overlay_slot/square");
    public static final UITexture OVERLAY_SLOT_UUA = UITexture.fullImage(GregTech.modID, "gui/overlay_slot/uua");
    ...
    public static final UITexture PROGRESSBAR_ARROW = UITexture.fullImage(GregTech.modID, "gui/progressbar/arrow");
    ...
    public static final UITexture PROGRESSBAR_BATH = UITexture.fullImage(GregTech.modID, "gui/progressbar/bath");
    public static final UITexture PROGRESSBAR_BENDING = UITexture.fullImage(GregTech.modID, "gui/progressbar/bending");
    ...
    public static final UITexture PROGRESSBAR_CUT = UITexture.fullImage(GregTech.modID, "gui/progressbar/cut");
    public static final UITexture PROGRESSBAR_EXTRACT = UITexture.fullImage(GregTech.modID, "gui/progressbar/extract");
    ...
    public static final UITexture PROGRESSBAR_MAGNET = UITexture.fullImage(GregTech.modID, "gui/progressbar/magnet");
    public static final UITexture PROGRESSBAR_MIXER = UITexture.fullImage(GregTech.modID, "gui/progressbar/mixer");
    ...
    public static final UITexture BUTTON_STANDARD_TOGGLE_DISABLED = AdaptableUITexture.of(
            ...
            18,
            1);
    public static final UITexture BUTTON_COVER_NORMAL = UITexture.fullImage(GregTech.modID, "gui/button/cover_normal");
    ...
    public static final UITexture PICTURE_GAUGE = UITexture.fullImage(GregTech.modID, "gui/picture/gauge");
    public static final UITexture PICTURE_ITEM_IN = UITexture.fullImage(GregTech.modID, "gui/picture/item_in");
    public static final UITexture PICTURE_ITEM_OUT = UITexture.fullImage(GregTech.modID, "gui/picture/item_out");
    public static final UITexture PICTURE_FLUID_IN = UITexture.fullImage(GregTech.modID, "gui/picture/fluid_in");
    public static final UITexture PICTURE_FLUID_OUT = UITexture.fullImage(GregTech.modID, "gui/picture/fluid_out");
}
