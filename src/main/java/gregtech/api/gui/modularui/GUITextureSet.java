...
public class GUITextureSet {
    ...
    public static final GUITextureSet DEFAULT = new GUITextureSet()
        .setMainBackground(UITextures.BACKGROUND_SINGLEBLOCK_DEFAULT)
        .setItemSlot(ModularUITextures.ITEM_SLOT)
        .setFluidSlot(ModularUITextures.FLUID_SLOT)
        .setCoverTab(UITextures.TAB_COVER_NORMAL, UITextures.TAB_COVER_HIGHLIGHT, UITextures.TAB_COVER_DISABLED)
        .setTitleTab(UITextures.TAB_TITLE, UITextures.TAB_TITLE_DARK, UITextures.TAB_TITLE_ANGULAR)
    ...
    public static final Function<SteamVariant, GUITextureSet> STEAM = steamVariant -> new GUITextureSet()
        .setMainBackground(UITextures.BACKGROUND_STEAM.get(steamVariant))
        .setItemSlot(UITextures.SLOT_ITEM_STEAM.get(steamVariant))
        .setFluidSlot(UITextures.SLOT_FLUID_STEAM.get(steamVariant))
        .setCoverTab(
            UITextures.TAB_COVER_STEAM_NORMAL.get(steamVariant),
            UITextures.TAB_COVER_STEAM_HIGHLIGHT.get(steamVariant),
            UITextures.TAB_COVER_STEAM_DISABLED.get(steamVariant))
        .setTitleTab(
            UITextures.TAB_TITLE_STEAM.getAdaptable(steamVariant),
            UITextures.TAB_TITLE_DARK_STEAM.getAdaptable(steamVariant),
            UITextures.TAB_TITLE_ANGULAR_STEAM.getAdaptable(steamVariant))
        .setGregTechLogo(UITextures.PICTURE_GT_LOGO_17x17_TRANSPARENT_STEAM.get(steamVariant));
