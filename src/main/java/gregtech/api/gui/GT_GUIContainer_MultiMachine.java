        ...
        if (mContainer
            ...
            if ((mContainer.mDisplayErrorCode & 16) != 0) {
                fontRendererObj.drawString(
                        GT_Utility.trans("136", "Circuitry burned out."), 10, line_counter, 16448255);
                line_counter += 8;
            }

            if ((mContainer.mDisplayErrorCode & 32) != 0) {
                fontRendererObj.drawString(
                        GT_Utility.trans("137", "That doesn't belong there."), 10, line_counter, 16448255);
                line_counter += 8;
            }

            if ((mContainer.mDisplayErrorCode & 64) != 0) {
                fontRendererObj.drawString(
                        GT_Utility.trans("138", "Incomplete Structure."), 10, line_counter, 16448255);
                line_counter += 8;
            }
            ...
            if (mContainer.mDisplayErrorCode == 0) {
                if (mContainer.mActive == 0) {
                    fontRendererObj.drawString(
                            GT_Utility.trans("139", "Hit with Soft Mallet"), 10, line_counter, 16448255);
                    line_counter += 8;
                    fontRendererObj.drawString(
                            GT_Utility.trans("140", "to (re-)start the Machine"), 10, line_counter, 16448255);
                    line_counter += 8;
                    fontRendererObj.drawString(
                            GT_Utility.trans("141", "if it doesn't start."), 10, line_counter, 16448255);
                    line_counter += 8;
                } else {
                    fontRendererObj.drawString(
                            GT_Utility.trans("142", "Running perfectly."), 10, line_counter, 16448255);
                    line_counter += 8;
                }
                if (mContainer.mTileEntity.getMetaTileEntity() instanceof GT_MetaTileEntity_DrillerBase) {
                    ...
                    if (tItem == null
                        ...
                        fontRendererObj.drawString(
                                GT_Utility.trans("143", "Missing Mining Pipe"), 10, line_counter, 16448255);
                    }
                    ...
                    if (tItem == null
                        ...
                        fontRendererObj.drawString(
                                GT_Utility.trans("144", "Missing Turbine Rotor"), 10, line_counter, 16448255);
                    }
                }
            }
        }
