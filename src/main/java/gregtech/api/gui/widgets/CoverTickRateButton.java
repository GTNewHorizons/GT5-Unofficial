...
import static gregtech.api.gui.modularui.UITextures.OVERLAY_BUTTON_HOURGLASS;
...
public class CoverTickRateButton extends ButtonWidget {
    ...
    private static final UITexture BACKGROUND = UITextures.BUTTON_COVER_NORMAL.getSubArea(0, 0, 1, 0.5f);
