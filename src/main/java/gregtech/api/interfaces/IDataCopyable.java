...
public interface IDataCopyable {
     ...
     * field with a value of {@link #getCopiedDataIdentifier(EntityPlayer)} Implementation should not try to alert
     * player of situations that copy has failed.
     *
    ...
    /**
     * Callee should check if the given tag is valid. Implementation should not try to alert player of situations that
     * paste has failed.
     *
