...
public interface IGTTool {
    ...
    /**
     * @return the melee damage this tool adds, which for a turbine rotor is not melee damage at all but the number
     *         its base efficiency is derived from.
     */
    float getToolCombatDamage(ItemStack stack);
