...
public abstract class GT_CoverBehaviorBase<T extends ISerializableObject> {
     ...
     */
    public final Block getFacadeBlock(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
     ...
     */
    public final int getFacadeMeta(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     * overloads.
     */
    public final ITexture getSpecialCoverFGTexture(ForgeDirection aSide, int aCoverID,
     ...
     */
    public final ITexture getSpecialCoverTexture(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     */
    public final boolean isDataNeededOnClient(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     */
    public final void onDataChanged(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     */
    public final void preDataChanged(ForgeDirection aSide, int aCoverID, int aNewCoverId,
     ...
     */
    public final void onDropped(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
        onDroppedImpl(aSide, aCoverID, forceCast(aCoverVariable), aTileEntity);
    }

    public final boolean isRedstoneSensitive(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
     ...
     */
    public final T doCoverThings(ForgeDirection aSide, byte aInputRedstone, int aCoverID,
     ...
     */
    public final boolean onCoverRightClick(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
     ...
     */
    public final T onCoverScrewdriverClick(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity, EntityPlayer aPlayer, float aX, float aY, float aZ) {
     ...
     */
    public final boolean onCoverShiftRightClick(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
    ...
    @Deprecated
    public final Object getClientGUI(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
     ...
     */
    public final boolean onCoverRemoval(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
     ...
     * survival.
     */
    public final void onBaseTEDestroyed(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     */
    public final String getDescription(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     */
    public final float getBlastProofLevel(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     */
    public final boolean letsRedstoneGoIn(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     */
    public final boolean letsRedstoneGoOut(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     * This is just Informative so that Machines know if their Redstone Input is blocked or not
     */
    public final boolean letsFibreGoIn(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     */
    public final boolean letsFibreGoOut(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     */
    public final boolean letsEnergyIn(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     */
    public final boolean letsEnergyOut(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     */
    public final boolean letsFluidIn(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
     ...
     */
    public final boolean letsFluidOut(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        Fluid aFluid, ICoverable aTileEntity) {
     ...
     * Slot).
     */
    public final boolean letsItemsIn(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable, int aSlot,
        ICoverable aTileEntity) {
     ...
     * Slot).
     */
    public final boolean letsItemsOut(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable, int aSlot,
        ICoverable aTileEntity) {
     ...
     */
    public final boolean isGUIClickable(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     */
    public final boolean manipulatesSidedRedstoneOutput(ForgeDirection aSide, int aCoverID,
        ISerializableObject aCoverVariable, ICoverable aTileEntity) {
     ...
     */
    public final boolean alwaysLookConnected(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     */
    public final byte getRedstoneInput(ForgeDirection aSide, byte aInputRedstone, int aCoverID,
        ISerializableObject aCoverVariable, ICoverable aTileEntity) {
     ...
     */
    public final int getTickRate(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     */
    public final byte getLensColor(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
     ...
     */
    public final ItemStack getDrop(ForgeDirection aSide, int aCoverID, ISerializableObject aCoverVariable,
        ICoverable aTileEntity) {
    ...
    protected class UIFactory {
        ...
        public boolean setCoverData(T data) {
            if (isCoverValid()) {
                getUIBuildContext().getTile()
                    .receiveCoverData(
                        (byte) getUIBuildContext().getCoverSide()
                            .ordinal(),
    ...
    protected Block getFacadeBlockImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, ICoverable aTileEntity) {
        return null;
    }

    protected int getFacadeMetaImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, ICoverable aTileEntity) {
        return 0;
    }
    ...
    protected ITexture getSpecialCoverFGTextureImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable,
        ICoverable aTileEntity) {
        return coverFGTexture;
    }

    protected ITexture getSpecialCoverTextureImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable,
        ICoverable aTileEntity) {
        return null;
    }

    protected boolean isDataNeededOnClientImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable,
        ICoverable aTileEntity) {
        return false;
    }

    protected void onDataChangedImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, ICoverable aTileEntity) {}
    ...
    protected void onDroppedImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, ICoverable aTileEntity) {}

    protected void onBaseTEDestroyedImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable,
        ICoverable aTileEntity) {}

    protected boolean isRedstoneSensitiveImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable,
        ICoverable aTileEntity, long aTimer) {
        return false;
    }
     ...
     * Called by updateEntity inside the covered TileEntity. aCoverVariable is the Value you returned last time.
     */
    protected T doCoverThingsImpl(ForgeDirection aSide, byte aInputRedstone, int aCoverID, T aCoverVariable,
        ICoverable aTileEntity, long aTimer) {
     ...
     * return true, if something actually happens.
     */
    protected boolean onCoverRightClickImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable,
        ICoverable aTileEntity, EntityPlayer aPlayer, float aX, float aY, float aZ) {
        return false;
    }
     ...
     * Called when someone shift-rightclicks this Cover with no tool. Doesn't call @onCoverRightclick in this Case.
     */
    protected boolean onCoverShiftRightClickImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable,
        ICoverable aTileEntity, EntityPlayer aPlayer) {
    ...
    @Deprecated
    protected Object getClientGUIImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, ICoverable aTileEntity,
     ...
     * getting broken, only if you break the Cover away from the Machine.
     */
    protected boolean onCoverRemovalImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, ICoverable aTileEntity,
        boolean aForced) {
        return true;
    }
     ...
     * Gives a small Text for the status of the Cover.
     */
    protected String getDescriptionImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, ICoverable aTileEntity) {
        return E;
    }
     ...
     * How Blast Proof the Cover is. 30 is normal.
     */
    protected float getBlastProofLevelImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable,
        ICoverable aTileEntity) {
        return 10.0F;
    }
     ...
     * This is just Informative so that Machines know if their Redstone Input is blocked or not
     */
    protected boolean letsRedstoneGoInImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable,
        ICoverable aTileEntity) {
        return false;
    }
     ...
     * If it lets RS-Signals out of the Block
     */
    protected boolean letsRedstoneGoOutImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable,
        ICoverable aTileEntity) {
        return false;
    }
     ...
     * This is just Informative so that Machines know if their Redstone Input is blocked or not
     */
    protected boolean letsFibreGoInImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, ICoverable aTileEntity) {
        return false;
    }
     ...
     * If it lets Fibre-Signals out of the Block
     */
    protected boolean letsFibreGoOutImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, ICoverable aTileEntity) {
        return false;
    }
     ...
     * If it lets Energy into the Block
     */
    protected boolean letsEnergyInImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, ICoverable aTileEntity) {
        return false;
    }
     ...
     * If it lets Energy out of the Block
     */
    protected boolean letsEnergyOutImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, ICoverable aTileEntity) {
        return false;
    }
     ...
     * If it lets Liquids into the Block, aFluid can be null meaning if this is generally allowing Fluids or not.
     */
    protected boolean letsFluidInImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, Fluid aFluid,
        ICoverable aTileEntity) {
        return false;
    }
     ...
     * If it lets Liquids out of the Block, aFluid can be null meaning if this is generally allowing Fluids or not.
     */
    protected boolean letsFluidOutImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, Fluid aFluid,
        ICoverable aTileEntity) {
        return false;
    }
     ...
     * Slot).
     */
    protected boolean letsItemsInImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, int aSlot,
        ICoverable aTileEntity) {
        return false;
    }
     ...
     * Slot).
     */
    protected boolean letsItemsOutImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, int aSlot,
        ICoverable aTileEntity) {
        return false;
    }
     ...
     * If it lets you rightclick the Machine normally
     */
    protected boolean isGUIClickableImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, ICoverable aTileEntity) {
        return false;
    }
     ...
     * Needs to return true for Covers, which have a Redstone Output on their Facing.
     */
    protected boolean manipulatesSidedRedstoneOutputImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable,
        ICoverable aTileEntity) {
        return false;
    }
     ...
     * if this Cover should let Pipe Connections look connected even if it is not the case.
     */
    protected boolean alwaysLookConnectedImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable,
        ICoverable aTileEntity) {
        return false;
    }
     ...
     * Cover should @letsRedstoneGoIn or the aInputRedstone Parameter is always 0.
     */
    protected byte getRedstoneInputImpl(ForgeDirection aSide, byte aInputRedstone, int aCoverID, T aCoverVariable,
        ICoverable aTileEntity) {
     ...
     * 0 = No Ticks! Yes, 0 is Default, you have to override this
     */
    protected int getTickRateImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, ICoverable aTileEntity) {
        return 0;
    }
     ...
     * The MC Color of this Lens. -1 for no Color (meaning this isn't a Lens then).
     */
    protected byte getLensColorImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, ICoverable aTileEntity) {
        return -1;
    }
     ...
     * @return the ItemStack dropped by this Cover
     */
    protected ItemStack getDropImpl(ForgeDirection aSide, int aCoverID, T aCoverVariable, ICoverable aTileEntity) {
     ...
     * 
     * @deprecated use {@link #isCoverPlaceable(ForgeDirection, ItemStack, ICoverable)} instead.
     */
    @Deprecated
    public boolean isCoverPlaceable(ForgeDirection aSide, GT_ItemStack aStack, ICoverable aTileEntity) {
        return true;
    }
     ...
     * return true, if something actually happens.
     */
    public boolean onCoverRightclickClient(ForgeDirection aSide, ICoverable aTileEntity, EntityPlayer aPlayer, float aX,
        float aY, float aZ) {
        return false;
    }
