...
public class AssemblyLineServer {
    ...
    public static void fillMap(FMLPreInitializationEvent aEvent) {
        ...
        for (Map.Entry<String, Property> entry : internal.entrySet()) {
            try {
                String s = entry.getValue().getString().replaceAll("%", "");
            ...
            try {
                if (entry.getKey().contains("name")) {
                    ...
                    if (GregTechAPI.sGeneratedMaterials[i] != null) lServerNames.put(
                            entry.getKey(),
                            entry.getValue().replace("material", GregTechAPI.sGeneratedMaterials[i].toString()));
            ...
            try {
                if (entry.getKey().contains("blockores")) {
                    ...
                    switch (i) {
                        ...
                        case 4 -> mMats = new Materials[] { Materials.Knightmetal, Materials.Lanthanum, Materials.Lead,
                                Materials.Lutetium, Materials.Magnalium, Materials.Magnesium, Materials.Manganese,
                                Materials.MeteoricIron, Materials.MeteoricSteel, Materials.Trinium, Materials.Mithril,
                    ...
                    int i = Integer.parseInt(t);
                    switch (i) {
                        case 1 -> mMats = new Materials[] { Materials.InfusedAir, Materials.Amber, Materials.Amethyst,
                        ...
                        case 2 -> mMats = new Materials[] { Materials.Lazurite, Materials.Lignite, Materials.Monazite,
                        ...
                        case 3 -> mMats = new Materials[] { Materials.Topaz, Materials.Vinteum, Materials.GarnetYellow,
