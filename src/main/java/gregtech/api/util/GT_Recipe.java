...
//		checkCellBalance();
    ...
    public static class GT_Recipe_Map {
        ...
        public static final GT_Recipe_Map sFusionCraftingRecipes = new GT_Recipe_Map(new HashSet<GT_Recipe>(800), "gt.recipe.fusioncrafting", "The Fusion Crafter", null, RES_PATH_GUI + "basicmachines/Default", 6, 1, 1, 0, 1, "Tier Casing: ", 1, E, false, true);
