...
public class GT_Recipe implements Comparable<GT_Recipe> {
    ...
    public static class GT_Recipe_Map_LargeChemicalReactor extends GT_Recipe_Map {
        ...
        public GT_Recipe addRecipe(
            ...
            return addRecipe(new GT_Recipe_LargeChemicalReactor(
                    aOptimize,
                    aInputs,
                    aOutputs,
                    aSpecial,
        ...
        private static class GT_Recipe_LargeChemicalReactor extends GT_Recipe {
            ...
            protected GT_Recipe_LargeChemicalReactor(
                    boolean aOptimize,
                    ItemStack[] aInputs,
                    ItemStack[] aOutputs,
                    Object aSpecialItems,
                ...
                for (int i = 0; i < itemLimit; i++, j++) {
                    if (this.mInputs == null || (this.mInputs[i] == null && (i == 0 && itemLimit == 1))) {
                        if (this.mOutputs != null && this.mOutputs.length > 0 && this.mOutputs[0] != null)
                            GT_Log.out.println("recipe " + this + " Output 0:" + this.mOutputs[0].getDisplayName()
                                    + " has errored!");
                        else GT_Log.out.println("recipe " + this + " has errored!");
                    ...
                    if ((this.mInputs != null && this.mInputs[i] != null) || !GT_Values.allow_broken_recipemap)
                        inputStacks.add(
                                new FixedPositionedStack(this.mInputs[i].copy(), 48 - j % 3 * 18, (j >= 3 ? 5 : 23)));
                    else
            ...
            public ArrayList<PositionedStack> getOutputPositionedStacks() {
                ...
                for (int i = 0; i < itemLimit; i++, j++) {
                    outputStacks.add(
                            new FixedPositionedStack(this.mOutputs[i].copy(), 102 + j % 3 * 18, (j >= 3 ? 5 : 23)));
                }
    ...
    public static class GT_Recipe_Map_DistillationTower extends GT_Recipe_Map {
        ...
        public GT_Recipe addRecipe(
                ...
                int aEUt,
                int aSpecialValue) {
            return addRecipe(new GT_Recipe_DistillationTower(
                    aOptimize,
                    aInputs,
                    aOutputs,
                    aSpecial,
        ...
        private static class GT_Recipe_DistillationTower extends GT_Recipe {
            ...
            public ArrayList<PositionedStack> getOutputPositionedStacks() {
                ...
                for (int i = 0; i < fluidLimit; i++) {
                    ...
                    outputStacks.add(new FixedPositionedStack(
                            GT_Utility.getFluidDisplayStack(this.mFluidOutputs[i], true), x, y));
                }
                return outputStacks;
            }
        }
    ...
    public static class GT_Recipe_Map_PlasmaForge extends GT_Recipe_Map {
        ...
        public GT_Recipe addRecipe(
                ...
                int aEUt,
                int aSpecialValue) {
            return addRecipe(new GT_Recipe_PlasmaForge(
                    aOptimize,
                    aInputs,
                    aOutputs,
                    aSpecial,
            ...
            public ArrayList<PositionedStack> getInputPositionedStacks() {
                ...
                if (mInputs != null) {
                    for (int j = 0; j < mInputs.length; j++, i++) {
                        ...
                        inputStacks.add(
                                new FixedPositionedStack(mInputs[j].copy(), 12 + 18 * (i % 3), 5 + 18 * (i / 3)));
                    }
                }
                if (mFluidInputs != null) {
                    for (int j = 0; j < mFluidInputs.length; j++, i++) {
                        ...
                        inputStacks.add(new FixedPositionedStack(
                                GT_Utility.getFluidDisplayStack(mFluidInputs[j], true),
                                12 + 18 * (i % 3),
                                5 + 18 * (i / 3)));
                    }
                }
            ...
            public ArrayList<PositionedStack> getOutputPositionedStacks() {
                ...
                if (mOutputs != null) {
                    for (int j = 0; j < mOutputs.length; j++, i++) {
                        ...
                        outputStacks.add(
                                new FixedPositionedStack(mOutputs[j].copy(), 102 + 18 * (i % 3), 5 + 18 * (i / 3)));
                    }
                }
                if (mFluidOutputs != null) {
                    for (int j = 0; j < mFluidOutputs.length; j++, i++) {
                        ...
                        outputStacks.add(new FixedPositionedStack(
                                GT_Utility.getFluidDisplayStack(mFluidOutputs[j], true),
                                102 + 18 * (i % 3),
                                5 + 18 * (i / 3)));
                    }
                }
    ...
    public static class GT_Recipe_Map_ComplexFusion extends GT_Recipe_Map {
        ...
        private static class GT_Recipe_ComplexFusion extends GT_Recipe {
            ...
            public GT_Recipe_ComplexFusion(
                    boolean aOptimize,
                    ItemStack[] aInputs,
                    ItemStack[] aOutputs,
                    Object aSpecialItems,
