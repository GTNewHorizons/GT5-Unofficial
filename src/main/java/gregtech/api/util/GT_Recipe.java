...
//		checkCellBalance();
    ...
    public static class GT_Recipe_Map {
        ...
        public static final GT_Recipe_Map sPlasmaForgeRecipes = new GT_Recipe_Map(new HashSet<>(20), "gt.recipe.plasmaforge", "Plasma Forge", null, RES_PATH_GUI + "basicmachines/Default", 1, 1, 0, 0, 1, "Heat Capacity: ", 1, " K", true, true);
