...
public abstract class CoverBehaviorBase<T extends ISerializableObject> {
     ...
     * passed to {@link gregtech.api.GregTech_API#registerCover(ItemStack, ITexture, CoverBehaviorBase)} or its
     * overloads.
     */
     ...
     * {@link gregtech.api.GregTech_API#registerCover(ItemStack, ITexture, CoverBehaviorBase)} or its overloads.
     */
