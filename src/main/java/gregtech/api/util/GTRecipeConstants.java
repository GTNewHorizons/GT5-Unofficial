...
public class GTRecipeConstants {
    ...
    /// [GTRecipeBuilder#withVariantGroup].
                    ...
                    builder.copy()
                        .fluidInputs(
                            ArrayUtils.addAll(
                                builder.fluidInputs,
                                MaterialLibAPI
                                    .getFluidStack(Materials.Grade1PurifiedWater, FluidShapes.fluidLiquid, 100)))
                    ...
                    builder.copy()
                        .fluidInputs(
                            ArrayUtils.addAll(
                                builder.fluidInputs,
                                MaterialLibAPI
                                    .getFluidStack(Materials.Grade2PurifiedWater, FluidShapes.fluidLiquid, 100)))
                    ...
                    builder.copy()
                        .fluidInputs(
                            ArrayUtils.addAll(
                                builder.fluidInputs,
                                MaterialLibAPI
                                    .getFluidStack(Materials.Grade3PurifiedWater, FluidShapes.fluidLiquid, 100)))
                        .duration(recipeTime)
                        .addTo(RecipeMaps.laserEngraverRecipes),
                    builder.copy()
                        .fluidInputs(
                            ArrayUtils.addAll(
                                builder.fluidInputs,
                                MaterialLibAPI
                                    .getFluidStack(Materials.Grade4PurifiedWater, FluidShapes.fluidLiquid, 100)))
                        .duration(boostedRecipeTime)
                        .addTo(RecipeMaps.laserEngraverRecipes));
            }
            case Americium -> {
                    ...
                    builder.copy()
                        .fluidInputs(
                            ArrayUtils.addAll(
                                builder.fluidInputs,
                                MaterialLibAPI
                                    .getFluidStack(Materials.Grade5PurifiedWater, FluidShapes.fluidLiquid, 100)))
                        .duration(recipeTime)
                        .addTo(RecipeMaps.laserEngraverRecipes),
                    builder.copy()
                        .fluidInputs(
                            ArrayUtils.addAll(
                                builder.fluidInputs,
                                MaterialLibAPI
                                    .getFluidStack(Materials.Grade6PurifiedWater, FluidShapes.fluidLiquid, 100)))
                        .duration(boostedRecipeTime)
                        .addTo(RecipeMaps.laserEngraverRecipes));
            }
                    ...
                    builder.copy()
                        .fluidInputs(
                            ArrayUtils.addAll(
                                builder.fluidInputs,
                                MaterialLibAPI
                                    .getFluidStack(Materials.Grade1PurifiedWater, FluidShapes.fluidLiquid, 32000)))
                        .duration(recipeTime)
                        .addTo(RecipeMaps.laserEngraverRecipes),
                    builder.copy()
                        .fluidInputs(
                            ArrayUtils.addAll(
                                builder.fluidInputs,
                                MaterialLibAPI
                                    .getFluidStack(Materials.Grade2PurifiedWater, FluidShapes.fluidLiquid, 32000)))
                        .duration(halfBoostedRecipeTime)
                        .addTo(RecipeMaps.laserEngraverRecipes),
                    builder.copy()
                        .fluidInputs(
                            ArrayUtils.addAll(
                                builder.fluidInputs,
                                MaterialLibAPI
                                    .getFluidStack(Materials.Grade3PurifiedWater, FluidShapes.fluidLiquid, 32000)))
                        .duration(boostedRecipeTime)
                        .addTo(RecipeMaps.laserEngraverRecipes));
            }
            case MaskT2 -> {
                    ...
                    builder.copy()
                        .fluidInputs(
                            ArrayUtils.addAll(
                                builder.fluidInputs,
                                MaterialLibAPI
                                    .getFluidStack(Materials.Grade4PurifiedWater, FluidShapes.fluidLiquid, 32000)))
                        .duration(recipeTime)
                        .addTo(RecipeMaps.laserEngraverRecipes),
                    builder.copy()
                        .fluidInputs(
                            ArrayUtils.addAll(
                                builder.fluidInputs,
                                MaterialLibAPI
                                    .getFluidStack(Materials.Grade5PurifiedWater, FluidShapes.fluidLiquid, 32000)))
                        .duration(boostedRecipeTime)
                        .addTo(RecipeMaps.laserEngraverRecipes));
            }
            case MaskT3 -> {
                    ...
                    builder.copy()
                        .fluidInputs(
                            ArrayUtils.addAll(
                                builder.fluidInputs,
                                MaterialLibAPI
                                    .getFluidStack(Materials.Grade6PurifiedWater, FluidShapes.fluidLiquid, 32000)))
                        .duration(recipeTime)
                        .addTo(RecipeMaps.laserEngraverRecipes),
                    builder.copy()
                        .fluidInputs(
                            ArrayUtils.addAll(
                                builder.fluidInputs,
                                MaterialLibAPI
                                    .getFluidStack(Materials.Grade7PurifiedWater, FluidShapes.fluidLiquid, 32000)))
                        .duration(halfBoostedRecipeTime)
                        .addTo(RecipeMaps.laserEngraverRecipes),
                    builder.copy()
                        .fluidInputs(
                            ArrayUtils.addAll(
                                builder.fluidInputs,
                                MaterialLibAPI
                                    .getFluidStack(Materials.Grade8PurifiedWater, FluidShapes.fluidLiquid, 32000)))
                        .duration(boostedRecipeTime)
                        .addTo(RecipeMaps.laserEngraverRecipes));
            }
        }
