...
public class RecipeBuilder {
    ...
    private RecipeBuilder(ItemStack[] inputsBasic, Object[] inputsOreDict, ItemStack[] outputs, ItemStack[][] alts,
    ...
    private static ItemStack[] fix(ItemStack[] inputs) {
        return OreDictUnificator.setStackArray(true, ArrayExt.withoutTrailingNulls(inputs, ItemStack[]::new));
    }
     ...
     */
    public static RecipeBuilder empty() {
        return new RecipeBuilder().duration(0)
            .eut(0);
    }
     ...
     */
    public RecipeBuilder itemInputs(ItemStack... inputs) {
        if (skip) return this;
    ...
    public RecipeBuilder itemInputs(Object... inputs) {
        ...
        for (int i = 0, inputsLength = inputs.length; i < inputsLength; i++) {
            ...
            if (input instanceof ItemStack) {
                ...
                List<ItemStack> ores = OreDictUnificator.getOres(arr[0]);
    ...
    public RecipeBuilder itemOutputs(ItemStack... outputs) {
        if (skip) return this;
     ...
     */
    public RecipeBuilder itemOutputs(ItemStack[] outputs, int[] chances) {
        if (skip) return this;
        if (debugNull() && containsNull(outputs)) handleNullRecipeComponents("itemOutputs");
        this.outputs = outputs;
        this.chances = chances;
    ...
    public RecipeBuilder fluidInputs(FluidStack... fluidInputs) {
        if (skip) return this;
    ...
    public RecipeBuilder fluidOutputs(FluidStack... fluidOutputs) {
        if (skip) return this;
    ...
    public RecipeBuilder outputChances(int... chances) {
        if (skip) return this;
     ...
     * <p>
     * {@link RecipeConstants} has a series of metadata keys. Or you can create one by yourself.
     */
    ...
    public RecipeBuilder requiresCleanRoom() {
        return metadata(RecipeConstants.CLEANROOM, true);
    }

    public RecipeBuilder requiresLowGravity() {
        return metadata(RecipeConstants.LOW_GRAVITY, true);
    }
     ...
     */
    public RecipeBuilder copyNoMetadata() {
        return new RecipeBuilder(
            copyItemArray(inputsBasic),
            copy(inputsOreDict),
            copyItemArray(outputs),
     ...
     */
    public RecipeBuilder validateNoInput() {
        if (skip) return this;
     ...
     * unset. Both bound inclusive. Only supposed to be called by IRecipeMap and not client code.
     */
    public RecipeBuilder validateNoInputFluid() {
        if (skip) return this;
     ...
     * unset. Both bound inclusive. Only supposed to be called by IRecipeMap and not client code.
     */
    public RecipeBuilder validateNoOutput() {
        if (skip) return this;
     ...
     * unset. Both bound inclusive. Only supposed to be called by IRecipeMap and not client code.
     */
    public RecipeBuilder validateNoOutputFluid() {
        if (skip) return this;
     ...
     * unset. Both bound inclusive. Only supposed to be called by IRecipeMap and not client code.
     */
    public RecipeBuilder validateInputCount(int min, int max) {
        if (skip) return this;
     ...
     * unset. Both bound inclusive. Only supposed to be called by IRecipeMap and not client code.
     */
    public RecipeBuilder validateInputFluidCount(int min, int max) {
        if (skip) return this;
     ...
     * unset. Both bound inclusive. Only supposed to be called by IRecipeMap and not client code.
     */
    public RecipeBuilder validateOutputCount(int min, int max) {
        if (skip) return this;
    ...
    public RecipeBuilder validateAnyOutput() {
        if (skip) return this;
    ...
    public RecipeBuilder forceOreDictInput() {
    ...
    private void applyDefaultSpecialValues(GT_Recipe recipe) {
        ...
        int specialValue = 0;
        if (getMetadataOrDefault(RecipeConstants.LOW_GRAVITY, false)) specialValue -= 100;
        if (getMetadataOrDefault(RecipeConstants.CLEANROOM, false)) specialValue -= 200;
