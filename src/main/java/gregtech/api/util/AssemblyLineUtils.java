    ...
    public static boolean setAssemblyLineRecipeOnDataStick(ItemStack aDataStick, GT_Recipe_AssemblyLine aNewRecipe) {
        if (isItemDataStick(aDataStick)) {
            ...
            if (FMLCommonHandler.instance()
                .getEffectiveSide()
                .isServer()) {
                s = Assemblyline_Server.lServerNames.get(aNewRecipe.mOutput.getDisplayName());
                if (s == null) {
            ...
            for (int i = 0; i < aNewRecipe.mInputs.length; i++) {
                if (aNewRecipe.mOreDictAlt[i] != null) {
                    ...
                    for (ItemStack tStack : aNewRecipe.mOreDictAlt[i]) {
                        if (tStack != null) {
                            ...
                            if (FMLCommonHandler.instance()
                                .getEffectiveSide()
                                .isServer()) {
                                s = Assemblyline_Server.lServerNames.get(tStack.getDisplayName());
                    ...
                    if (FMLCommonHandler.instance()
                        .getEffectiveSide()
                        .isServer()) {
                        s = Assemblyline_Server.lServerNames.get(aNewRecipe.mInputs[i].getDisplayName());
            ...
            for (int i = 0; i < aNewRecipe.mFluidInputs.length; i++) {
                if (aNewRecipe.mFluidInputs[i] != null) {
                    ...
                    if (FMLCommonHandler.instance()
                        .getEffectiveSide()
                        .isServer()) {
                        s = Assemblyline_Server.lServerNames.get(aNewRecipe.mFluidInputs[i].getLocalizedName());
