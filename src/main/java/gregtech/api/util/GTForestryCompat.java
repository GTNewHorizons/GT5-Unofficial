...
public class GTForestryCompat {
    ...
    public static void transferCentrifugeRecipes() {
        ...
        for (ICentrifugeRecipe tRecipe : RecipeManagers.centrifugeManager.recipes()) {
            ...
            if (input.getUnlocalizedName().contains("gt.comb") && !input.isItemEqual(DOBComb)) continue;
            ...
            GTValues.RA.stdBuilder().itemInputs(tRecipe.getInput()).itemOutputs(tOutputs).outputChances(tChances)
                    .duration(6 * SECONDS + 8 * TICKS).eut(5).addTo(centrifugeRecipes);
        }
    }
    ...
    public static void transferSqueezerRecipes() {
        for (ISqueezerRecipe tRecipe : RecipeManagers.squeezerManager.recipes()) {
            ...
            if ((resources.length == 1) && (tRecipe.getFluidOutput() != null) && (resources[0] != null)) {
                ...
                recipeBuilder.fluidOutputs(tRecipe.getFluidOutput()).duration(1 * SECONDS + 12 * TICKS).eut(8)
