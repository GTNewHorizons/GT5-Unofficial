...
public class TextureSet {
    ...
    private static final String[] SUFFIXES = new String[] { "/dustTiny", "/dustSmall", "/dust", "/dustImpure",
        ...
        "/screw", "/ring", "/foil", "/cell", "/cellPlasma", aTextVoidDir, aTextVoidDir, aTextVoidDir,
        aTextVoidDir, aTextVoidDir, "/toolHeadHammer", "/toolHeadFile", "/toolHeadSaw", "/toolHeadDrill",
        "/toolHeadChainsaw", "/toolHeadWrench", aTextVoidDir, aTextVoidDir, aTextVoidDir,
        aTextVoidDir, "/toolHeadScrewdriver", "/toolHeadBuzzSaw", "/toolHeadSoldering", "/nanites", "/wireFine",
