...
public class TextureSet {
    ...
    public static final TextureSet SET_DARKSTEEL = new TextureSet("darksteel", true),
        ...
        SET_CRUDE_STEEL = new TextureSet("crudesteel", false), SET_CRYSTALLINE_PINK_SLIME = new TextureSet("crystallinepinkslime", true), SET_DRACONIUM = new TextureSet("draconium", false),
