...
public class GTValues {
    ...
    public static final String AuthorHamCorp = "Author: " + EnumChatFormatting.GOLD + "Ham" + EnumChatFormatting.WHITE + "Corp";

    public static final String Authorzub = "Author: " + EnumChatFormatting.DARK_PURPLE + EnumChatFormatting.ITALIC + "zub";
