...
public class Tier {
    public static final Tier[]
            ...
            new Tier(SubTag.ENERGY_ELECTRICITY, 9, 2097152, 1, 1, 1, Materials.Tritanium, ItemList.Hull_MAX, OrePrefixes.wireGt01.get(Materials.Europium), OrePrefixes.wireGt04.get(Materials.Europium), OrePrefixes.circuit.get(Materials.Infinite), OrePrefixes.circuit.get(Materials.Bio)),
            new Tier(SubTag.ENERGY_ELECTRICITY, 10, 8388608, 1, 1, 1, Materials.Neutronium, ItemList.Hull_UEV, OrePrefixes.wireGt01.get(Materials.Diamericiumtitanium), OrePrefixes.wireGt04.get(Materials.Diamericiumtitanium), OrePrefixes.circuit.get(Materials.Bio), OrePrefixes.circuit.get(Materials.Bio)),
            new Tier(SubTag.ENERGY_ELECTRICITY, 11, 33554432, 1, 1, 1, Materials.Neutronium, ItemList.Hull_UIV, OrePrefixes.wireGt01.get(Materials.Neutronium), OrePrefixes.wireGt04.get(Materials.Neutronium), OrePrefixes.circuit.get(Materials.Bio), OrePrefixes.circuit.get(Materials.Bio)),
            new Tier(SubTag.ENERGY_ELECTRICITY, 12, 134217728, 1, 1, 1, Materials.Neutronium, ItemList.Hull_UMV, OrePrefixes.wireGt01.get(Materials.Quantium), OrePrefixes.wireGt04.get(Materials.Quantium), OrePrefixes.circuit.get(Materials.Bio), OrePrefixes.circuit.get(Materials.Bio)),
            new Tier(SubTag.ENERGY_ELECTRICITY, 13, 536870912, 1, 1, 1, Materials.Neutronium, ItemList.Hull_UXV, OrePrefixes.wireGt01.get(Materials.Superconductor), OrePrefixes.wireGt04.get(Materials.Superconductor), OrePrefixes.circuit.get(Materials.Bio), OrePrefixes.circuit.get(Materials.Bio)),
            new Tier(SubTag.ENERGY_ELECTRICITY, 14, 1073741824, 1, 1, 1, Materials.Neutronium, ItemList.Hull_OPV, OrePrefixes.wireGt01.get(Materials.Superconductor), OrePrefixes.wireGt04.get(Materials.Superconductor), OrePrefixes.circuit.get(Materials.Bio), OrePrefixes.circuit.get(Materials.Bio)),
            new Tier(SubTag.ENERGY_ELECTRICITY, 15, Integer.MAX_VALUE, 1, 1, 1, Materials.Neutronium, ItemList.Hull_MAXV, OrePrefixes.wireGt01.get(Materials.Superconductor), OrePrefixes.wireGt04.get(Materials.Superconductor), OrePrefixes.circuit.get(Materials.Bio), OrePrefixes.circuit.get(Materials.Bio)),
