...
public class Textures {
    ...
    public enum BlockIcons implements IIconContainer, Runnable {
        ...
        MACHINE_FOUNDRY_CASING,
        MACHINE_FOUNDRY_SIPHON_CASING,
        FOUNDRY_GLASS,

        MACHINE_FOUNDRY_INFINITE_CHASSIS,
        MACHINE_FOUNDRY_ETERNAL_CHASSIS,
        MACHINE_FOUNDRY_CELESTIAL_CHASSIS,
        MACHINE_FOUNDRY_INFINITE_CHASSIS_TOP,
        MACHINE_FOUNDRY_ETERNAL_CHASSIS_TOP,
        MACHINE_FOUNDRY_CELESTIAL_CHASSIS_TOP,
        MODULAR_SOLIDIFIER_EFFICIENT_OVERCLOCKING,
        MODULAR_SOLIDIFIER_POWER_EFFICIENT_SUBSYSTEMS,
        MODULAR_SOLIDIFIER_TRANSCENDENT_REINFORCEMENT,
        MODULAR_SOLIDIFIER_EXTRA_CASTING_BASINS,
        MODULAR_SOLIDIFIER_HYPERCOOLER,
        MODULAR_SOLIDIFIER_STREAMLINED_CASTERS,
        MODULAR_SOLIDIFIER_ACTIVE_TIME_DILATION_SYSTEM,
        OVERLAY_FRONT_FOUNDRY,
        OVERLAY_FRONT_FOUNDRY_GLOW,
        OVERLAY_FRONT_FOUNDRY_ACTIVE,
        OVERLAY_FRONT_FOUNDRY_ACTIVE_GLOW,
