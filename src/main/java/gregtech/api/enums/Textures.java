...
public class Textures {
    ...
    public enum BlockIcons implements IIconContainer, Runnable {
        ...
        public static final ITexture[] OVERLAYS_ENERGY_IN = {
            ...
            TextureFactory.of(OVERLAY_ENERGY_IN, toRGB(40, 40, 245)), };
        public static ITexture[] OVERLAYS_ENERGY_OUT = { TextureFactory.of(OVERLAY_ENERGY_OUT, toRGB(180, 180, 180)),
            ...
            TextureFactory.of(OVERLAY_ENERGY_OUT, toRGB(40, 40, 245)), };
        public static final ITexture[] OVERLAYS_ENERGY_IN_MULTI = {
            TextureFactory.of(OVERLAY_ENERGY_IN_MULTI, toRGB(180, 180, 180)),
            ...
            TextureFactory.of(OVERLAY_ENERGY_IN_MULTI, toRGB(40, 40, 245)), };

        public static final ITexture[] OVERLAYS_ENERGY_IN_MULTI_WIRELESS_ON = {
            TextureFactory.of(OVERLAY_ENERGY_ON_WIRELESS, toRGB(255, 255, 255)),
            TextureFactory.of(OVERLAY_ENERGY_ON_WIRELESS, toRGB(255, 255, 255)),
            TextureFactory.of(OVERLAY_ENERGY_ON_WIRELESS, toRGB(255, 255, 255)),
            TextureFactory.of(OVERLAY_ENERGY_ON_WIRELESS, toRGB(255, 255, 255)),
            TextureFactory.of(OVERLAY_ENERGY_ON_WIRELESS, toRGB(255, 255, 255)),
        ...
        public static final ITexture[] OVERLAYS_ENERGY_IN_MULTI_WIRELESS_OFF = {
            TextureFactory.of(OVERLAY_ENERGY_OFF_WIRELESS, toRGB(0, 0, 0)),
            TextureFactory.of(OVERLAY_ENERGY_OFF_WIRELESS, toRGB(0, 0, 0)),
            TextureFactory.of(OVERLAY_ENERGY_OFF_WIRELESS, toRGB(0, 0, 0)),
            TextureFactory.of(OVERLAY_ENERGY_OFF_WIRELESS, toRGB(0, 0, 0)),
            TextureFactory.of(OVERLAY_ENERGY_OFF_WIRELESS, toRGB(0, 0, 0)),
        ...
        public static final ITexture[] OVERLAYS_ENERGY_OUT_MULTI = {
            ...
            TextureFactory.of(OVERLAY_ENERGY_OUT_MULTI, toRGB(40, 40, 245)), };
        public static final ITexture[] OVERLAYS_ENERGY_IN_POWER = {
            TextureFactory.of(OVERLAY_ENERGY_IN_POWER, toRGB(180, 180, 180)),
            ...
            TextureFactory.of(OVERLAY_ENERGY_IN_POWER, toRGB(40, 40, 245)), };
        public static final ITexture[] OVERLAYS_ENERGY_OUT_POWER = {
            ...
            TextureFactory.of(OVERLAY_ENERGY_OUT_POWER, toRGB(40, 40, 245)), };
         ...
         */
        // spotless:on
        // page holder so we don't make a short long array
        public static ITexture[][] casingTexturePages = new ITexture[128][];
