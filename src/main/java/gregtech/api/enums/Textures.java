...
public class Textures {
    public enum BlockIcons implements IIconContainer, Runnable {
        ...
        MACHINE_CASING_ROBUST_NAQUADAHALLOY, MACHINE_CASING_BLOODYICHORIUM, MACHINE_CASING_DRACONIUM, MACHINE_CASING_WYVERN, MACHINE_CASING_DRACONIUMAWAKENED, MACHINE_CASING_CHAOTIC;
