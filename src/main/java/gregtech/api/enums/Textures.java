...
public class Textures {
    ...
    public enum BlockIcons implements IIconContainer, Runnable {
        ...
        OVERLAY_STEAMGATE_CONTROLLER,

        EXTRACTINATOR_CASING,
        EXTRACTINATOR_SIEVE,
        EXTRACTINATOR_BASE,
        EXTRACTINATOR_BASE_BASE,
        EXTRACTINATOR_BASE_TOP,

        OVERLAY_CACTUS_WONDER,
        OVERLAY_CACTUS_WONDER_ACTIVE,

        CASING_WOOD_IRON,
        CASING_WOOD_BRONZE,
        CASING_WOOD_STEEL,
        MACHINE_PIPE_CASING_BREEL,
        MACHINE_CASING_STRONZE,
        ...
        OVERLAY_MULTI_STEAMHOLE,
        OVERLAY_MULTI_STEAMHOLE_GLOW,
        OVERLAY_MULTI_STEAMHOLE_ACTIVE,
        OVERLAY_MULTI_STEAMHOLE_ACTIVE_GLOW,

        OVERLAY_STEAM_COKE_OVEN,
        OVERLAY_STEAM_COKE_OVEN_ACTIVE,
        OVERLAY_STEAM_COKE_OVEN_ACTIVE_GLOW,
        ...
        OVERLAY_FRONT_STEAM_GATE_ASSEMBLER,
        OVERLAY_STEAM_SMELTER_ACTIVE,
        OVERLAY_STEAM_SMELTER_INACTIVE,
        OVERLAY_LAVAMAKER,
        OVERLAY_LAVAMAKER_ACTIVE,

        OVERLAY_FRONT_STEAM_EXTRUDER_IDLE,
        OVERLAY_FRONT_STEAM_EXTRUDER_WORKING,
        OVERLAY_EXTRACTINATOR_ACTIVE,
        OVERLAY_EXTRACTINATOR,
        ...
        OVERLAY_STEAM_ALLOY_SMELTER_MULTI,
        ...
        OVERLAY_CARPENTER,
        OVERLAY_CARPENTER_ACTIVE,
        OVERLAY_MANUFACTURER,
        OVERLAY_MANUFACTURER_GLOW,
        OVERLAY_MANUFACTURER_ACTIVE,
        OVERLAY_MANUFACTURER_ACTIVE_GLOW,
