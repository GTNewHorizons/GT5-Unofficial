...
public enum SoundResource {
    ...
    GT_HUM(300, GregTech.ID, "hum"),
    GT_COOLING(301, GregTech.ID, "cooling"),
    ...
    GT_TOOLS_WIRECUTTER(312, GregTech.ID, "tools.wirecutter"),
    GT_TOOLS_PLUNGER(313, GregTech.ID, "tools.plunger"),
    GT_TOOLS_SAW(314, GregTech.ID, "tools.saw"),
    GT_TOOLS_CHAINSAW(315, GregTech.ID, "tools.chainsaw"),
    GT_TOOLS_SCREWDRIVER(316, GregTech.ID, "tools.screwdriver"),
    GT_TOOLS_FILE(317, GregTech.ID, "tools.file"),
    GT_TOOLS_MORTAR(318, GregTech.ID, "tools.mortar"),
    GT_TOOLS_DRILL(319, GregTech.ID, "tools.drill"),
    GT_TOOLS_SPRAYCAN(320, GregTech.ID, "tools.spraycan"),

    GT_MACHINES_FURNACE(330, GregTech.ID, "machines.Furnace"),
    GT_MACHINES_MINER(331, GregTech.ID, "machines.Miner"),
    GT_MACHINES_FORGEHAMMER(332, GregTech.ID, "machines.ForgeHammer"),
    GT_MACHINES_MACERATOR(333, GregTech.ID, "machines.Macerator"),
    GT_MACHINES_MIXER(334, GregTech.ID, "machines.Mixer"),
    GT_MACHINES_ELECTROLYZER(335, GregTech.ID, "machines.Electrolyzer"),
    GT_MACHINES_CHEMICAL(336, GregTech.ID, "machines.Chemical"),
