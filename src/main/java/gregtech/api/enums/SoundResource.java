...
public enum SoundResource {
    ...
    GT_MACHINES_MULTI_PRECISE_LOOP(243, GregTech.ID, "machines.MultiPreciseLoop"),

    GT_MACHINES_MULTI_ORE_WASHER_PLANT_LOOP(244, GregTech.ID, "machines.MultiPreciseLoop"),
    GT_MACHINES_MULTI_MEGA_VACUUM_FREEZER_LOOP(245, GregTech.ID, "machines.MultiMegaVacuumFreezerLoop"),
    GT_MACHINES_MULTI_VACUUM_FREEZER_LOOP(246, GregTech.ID, "machines.MultiVacuumFreezerLoop"),
    GT_MACHINES_EXTREME_ENTITY_CRUSHER_LOOP(247, GregTech.ID, "machines.MultiExtremeEntityCrusherFLoop"),
    GT_MACHINES_CUTTING_MACHINE_LOOP(248, GregTech.ID, "machines.MultiCuttingMachineFLoop"),
    GT_MACHINES_ARC_FURNACE_LOOP(249, GregTech.ID, "machines.MultiArcFurnaceFLoop"),
    GT_MACHINES_MEGA_INDUSTRIAL_APIARY_LOOP(250, GregTech.ID, "machines.MultiMegaIndustrialApiaryFLoop"),
    GT_MACHINES_ALGAE_LOOP(251, GregTech.ID, "machines.MultiAlgaeFLoop"),
    GT_MACHINES_THERMAL_CENTRIFUGE_LOOP(252, GregTech.ID, "machines.MultiThermalCentrifugeFLoop"),
    GT_MACHINES_SIFTER_LOOP(253, GregTech.ID, "machines.MultiSifterFLoop"),
    GT_MACHINES_EYE_OF_HARMONY_LOOP(254, GregTech.ID, "machines.MultiEyeOfHarmonyFLoop"),
