...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials Dimethylbenzene = new MaterialBuilder(593, TextureSet.SET_FLUID             ,                                                                                                     "1,2-Dimethylbenzen").addCell().addFluid().setRGB(102, 156, 64).setColor(Dyes.dyeLime).setMeltingPoint(248).setMaterialList(new MaterialStack(Carbon, 8), new MaterialStack(Hydrogen, 10)).addElectrolyzerRecipe().constructMaterial();
...
//      Midasium                .add(SubTag.MAGICAL);
        ...
        Manasteel.add(SubTag.MAGICAL);
        Terrasteel.add(SubTag.MAGICAL);
        ElvenElementium.add(SubTag.MAGICAL);
