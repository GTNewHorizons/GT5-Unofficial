...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials Universium               = new Materials(583, TextureSet.SET_METALLIC,   1.0F,4*2621440,  25, 1|2|64|128,   200,   200, 200,  255,   "Universium"                ,   "Universium"                      ,    -1,      -1,         0,    0, false,  true,   2,   1,   1, Dyes._NULL         , Collections.singletonList(new TC_AspectStack(TC_Aspects.AQUA, 1)));
