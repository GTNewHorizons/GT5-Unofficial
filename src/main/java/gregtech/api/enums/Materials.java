...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials SuperconductorUMVBase                                           = new Materials( 134, TextureSet.SET_SHINY          ,   1.0F,      0,  3, 1|2                ,  181, 38,   205,   0,   "SuperconductorUMVBase"                                         ,   "Superconductor Base UMV"      ,     0,       0,     13600,  13600,  true,  false,  1,   1,   1, Dyes.dyeWhite, Collections.singletonList(new TC_AspectStack(TC_Aspects.ELECTRUM, 40))).setProcessingMaterialTierEU((int) Tier.RECIPE_UIV);
    ...
    public static Materials MagnetohydrodynamicallyConstrainedStarMatter = new Materials(583, new TextureSet("MagnetohydrodynamicallyConstrainedStarMatter", true), 1.0F, 0, 2, 256, 255, 255, 255, 0, "MagnetohydrodynamicallyConstrainedStarMatter", "Magnetohydrodynamically Constrained Star Matter", -1, -1, 0, 0, true, false, 200, 1, 1, Dyes.dyePurple).setHasCorrespondingFluid(false).setProcessingMaterialTierEU((int) Tier.UXV);
    ...
    public static Materials Computronium = new Materials(481, TextureSet.SET_FLUID, 1.0F, 0, 2, 16, 100, 1, 255, 255, "Computronium", "Computronium", -1, -1, 0, 0, false, false, 200, 1, 1, Dyes.dyePurple).setHasCorrespondingFluid(true);
