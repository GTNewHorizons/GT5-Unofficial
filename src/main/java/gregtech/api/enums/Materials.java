...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials Rhodium                 = new Materials(  -1, TextureSet.SET_METALLIC          ,   1.0F,      0,  1, 0                         , 250, 240, 220,   0,   "Rhodium"                 ,   "Rhodium"                       ,    0,       0,        -1,    0, false, false,   2,   1,   1, Dyes._NULL           , Element.Rh           , Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2)));
