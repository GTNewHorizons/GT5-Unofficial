...
public class Materials implements IColorModulationContainer, ISubTagContainer {
  ...
  //Kevlar Line
    public static Materials Phosgene                             = new MaterialBuilder(  796, TextureSet.SET_FLUID            ,   "Phosgene").setName( "Phosgene").addCell().addGas().setRGB( 255, 255, 255).setColor(Dyes.dyeWhite).setMeltingPoint(145).setMaterialList(new MaterialStack(CarbonMonoxide, 1), new MaterialStack(Chlorine, 2)).setAspects(Arrays.asList(new TC_AspectStack(TC_Aspects.AQUA, 1), new TC_AspectStack(TC_Aspects.VENENUM, 1))).constructMaterial();//COCL2
    public static Materials DiphenylmethaneDiisocyanate          = new MaterialBuilder(  795, TextureSet.SET_DULL            ,   "Diphenylmethane 4,4′-diisocyanate").setName( "DiphenylmethaneDiisocyanate").addDustItems().setRGB( 255, 230, 50).setColor(Dyes.dyeYellow).setMeltingPoint(310).setMaterialList(new MaterialStack(Carbon, 15), new MaterialStack(Hydrogen, 10), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 2)).setAspects(Arrays.asList(new TC_AspectStack(TC_Aspects.TERRA, 1), new TC_AspectStack(TC_Aspects.VENENUM, 1))).constructMaterial();//C15H10N2O2
    public static Materials DiaminodiphenylmethanMixture         = new MaterialBuilder(  794, TextureSet.SET_FLUID            ,   "4,4′-Diaminodiphenylmethan Mixture").setName( "DiaminodiphenylmethanMixture").addCell().addFluid().setRGB( 255, 243, 122).setColor(Dyes.dyeYellow).setMeltingPoint(365).setMaterialList(new MaterialStack(Carbon, 13), new MaterialStack(Hydrogen, 14), new MaterialStack(Nitrogen, 2)).setAspects(Arrays.asList(new TC_AspectStack(TC_Aspects.AQUA, 1), new TC_AspectStack(TC_Aspects.VENENUM, 1))).constructMaterial();//C13H14N2
    public static Materials DiphenylmethaneDiisocyanateMixture   = new MaterialBuilder(  793, TextureSet.SET_FLUID            ,   "Diphenylmethane 4,4′-diisocyanate Mixture").setName( "DiphenylmethaneDiisocyanateMixture").addCell().addFluid().setRGB( 255, 230, 50).setColor(Dyes.dyeYellow).setMeltingPoint(310).setMaterialList(new MaterialStack(Carbon, 15), new MaterialStack(Hydrogen, 10), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 2)).setAspects(Arrays.asList(new TC_AspectStack(TC_Aspects.AQUA, 1), new TC_AspectStack(TC_Aspects.VENENUM, 1))).constructMaterial();//C15H10N2O2
