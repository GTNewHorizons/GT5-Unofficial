...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials InfinityAlloy           = new Materials( 983, TextureSet.SET_SHINY             , 128.0F, 500000,  13,1|2          |64|128      , 160, 128,  96,   0,   "InfinityAlloy"           ,   "Infinity Alloy"                ,     0,       0,     10800,  10800,  true, false, 22,   1,   1, Dyes.dyeBrown       , 2, Arrays.asList(new MaterialStack(DraconiumAwakened, 2), new MaterialStack(Neutronium, 2), new MaterialStack(Infinity, 1)));
