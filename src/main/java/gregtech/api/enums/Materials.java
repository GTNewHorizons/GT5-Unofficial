...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials TPV                     = new Materials( 576, TextureSet.SET_METALLIC          ,  16.0F,   4000,  5, 1|2          |64|128      , 250,  170,250,   0,   "TPVAlloy"                ,   "TPV-Alloy"                     ,    0,       0,       3600, 3600,  true, false,   4,   1,   1, Dyes.dyeRed         , 2, Arrays.asList(new MaterialStack(Titanium, 6), new MaterialStack(Platinum, 6), new MaterialStack(Vanadium, 2))).disableAutoGeneratedBlastFurnaceRecipes();
