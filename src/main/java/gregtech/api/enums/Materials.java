...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials EnrichedHolmium           = new Materials(582, TextureSet.SET_METALLIC, 1.0F, 0, 2, 18, 100, 1|2|16, 255, 255, "EnrichedHolmium", "Enriched Holmium", -1, -1, 0, 3000, true, false, 200, 1, 1, Dyes.dyePurple);
    // spotless:on
