...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials Pentaerythritol                      = new MaterialBuilder(  785, TextureSet.SET_DULL            ,   "Pentaerythritol").setName( "Pentaerythritol").addDustItems().setRGB( 255, 255, 255).setColor(Dyes.dyeWhite).setMeltingPoint(533).setMaterialList(new MaterialStack(Carbon, 5), new MaterialStack(Hydrogen, 12), new MaterialStack(Oxygen, 4)).setAspects(Arrays.asList(new TC_AspectStack(TC_Aspects.TERRA, 1), new TC_AspectStack(TC_Aspects.LUCRUM, 1))).constructMaterial();//C5H12O4
    public static Materials IVNitrochlorobenzene                 = new MaterialBuilder(  784, TextureSet.SET_DULL            ,   "4-Nitrochlorobenzene").setName( "4Nitrochlorobenzene").addDustItems().setRGB( 247, 247, 126).setColor(Dyes.dyeYellow).setMeltingPoint(357).setMaterialList(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 4), new MaterialStack(Chlorine, 1), new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 2)).setAspects(Arrays.asList(new TC_AspectStack(TC_Aspects.TERRA, 1), new TC_AspectStack(TC_Aspects.VENENUM, 1))).constructMaterial();//C6H4ClNO2
    public static Materials Sodiumamide                          = new MaterialBuilder(  783, TextureSet.SET_DULL            ,   "Sodium Amide").setName( "SodiumAmide").addDustItems().setRGB( 255, 255, 255).setColor(Dyes.dyeWhite).setMeltingPoint(483).setMaterialList(new MaterialStack(Sodium, 2), new MaterialStack(Nitrogen, 1), new MaterialStack(Hydrogen, 2)).setAspects(Arrays.asList(new TC_AspectStack(TC_Aspects.TERRA, 1), new TC_AspectStack(TC_Aspects.VITREUS, 1))).constructMaterial();//NaNH2
    public static Materials IronIIINitrate                       = new MaterialBuilder(  782, TextureSet.SET_DULL            ,   "Iron III Nitrate").setName("IronIIINitrate").addDustItems().setRGB(255, 204, 255).setColor(Dyes.dyePurple).setMeltingPoint(320).setMaterialList(new MaterialStack(Iron, 1), new MaterialStack(NitricOxide, 3)).constructMaterial();//Fe(NO3)3
    public static Materials IVNitroaniline                       = new MaterialBuilder(  781, TextureSet.SET_POWDER          ,   "4-Nitroaniline").setName("4Nitroaniline").addDustItems().setRGB(255, 135, 51).setColor(Dyes.dyeOrange).setMeltingPoint(420).setMaterialList(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 6), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 2)).constructMaterial();//C6H6N2O2
    public static Materials ParaPhenylenediamine                 = new MaterialBuilder(  780, TextureSet.SET_POWDER          ,   "p-Phenylenediamine").setName("pPhenylenediamine").addDustItems().setRGB(255, 255, 255).setColor(Dyes.dyeWhite).setMeltingPoint(293).setMaterialList(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 6), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 2)).constructMaterial();//C6H6N2O2
    public static Materials Methylamine                          = new MaterialBuilder(779, TextureSet.SET_FLUID             ,   "Methylamine").setName("Methylamine").addCell().addGas().setRGB(65, 68, 105).setColor(Dyes.dyeGray).setMeltingPoint(180).setMaterialList(new MaterialStack(Carbon, 1), new MaterialStack(Hydrogen, 1), new MaterialStack(Nitrogen, 5)).constructMaterial();//CH5N
    public static Materials Trimethylamine                       = new MaterialBuilder(778, TextureSet.SET_FLUID             ,   "Trimethylamine").setName("Trimethylamine").addCell().addGas().setRGB(105, 68, 105).setColor(Dyes.dyeGray).setMeltingPoint(156).setMaterialList(new MaterialStack(Carbon, 3), new MaterialStack(Hydrogen, 9), new MaterialStack(Nitrogen, 1)).constructMaterial();//C3H9N
    public static Materials GammaButyrolactone                   = new MaterialBuilder(777, TextureSet.SET_FLUID             ,   "γ-Butyrolactone").setName("GammaButyrolactone").addCell().addFluid().setRGB(255, 255, 151).setColor(Dyes.dyeYellow).setMeltingPoint(229).setMaterialList(new MaterialStack(Carbon, 4), new MaterialStack(Hydrogen, 6), new MaterialStack(Oxygen, 2)).constructMaterial();//C4H6O2
    public static Materials Butanediol                           = new MaterialBuilder(776, TextureSet.SET_FLUID             ,   "1,4-Butanediol").setName("Butanediol").addCell().addFluid().setRGB(255, 255, 255).setColor(Dyes.dyeWhite).setMeltingPoint(293).setMaterialList(new MaterialStack(Carbon, 4), new MaterialStack(Hydrogen, 10), new MaterialStack(Oxygen, 2)).constructMaterial();//C4H10O2
...
//      Duralumin.mChemicalFormula="Al\u2086CuMnMg";
        ...
        IronIIINitrate.mChemicalFormula = "Fe\u0028NO\u2083\u0029\u2083";
    }
