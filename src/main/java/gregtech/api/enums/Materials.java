...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials BlackSteel              = new Materials( 334, TextureSet.SET_METALLIC          ,   6.5F,    768,  3, 1|2          |64|128      , 100, 100, 100,   0,   "BlackSteel"              ,   "Black Steel"                   ,    0,       0,         -1, 1200,  true, false,   4,   1,   1, Dyes.dyeBlack       , 2, Arrays.asList(new MaterialStack(Nickel, 1), new MaterialStack(BlackBronze, 1), new MaterialStack(Steel, 3)));
    ...
    public static Materials DamascusSteel           = new Materials( 335, TextureSet.SET_METALLIC          ,   8.0F,   1280,  3, 1|2          |64|128      , 110, 110, 110,   0,   "DamascusSteel"           ,   "Damascus Steel"                ,    0,       0,       2000, 1500,  true, false,   4,   1,   1, Dyes.dyeGray        , 2, Arrays.asList(new MaterialStack(Steel, 1)));
    ...
    public static Materials InfinityAlloy           = new MaterialBuilder(983, TextureSet.SET_SHINY, "Infinity Alloy").addDustItems().addMetalItems().addToolHeadItems().addGearItems().setRGB(160,128,96).setColor(Dyes.dyeBrown).setToolSpeed(128).setDurability(500000).setToolQuality(13).setMeltingPoint(10800).setBlastFurnaceTemp(10800).setBlastFurnaceRequired(true).setOreValue(22).setDensityMultiplier(1).setDensityDivider(1).addCentrifugeRecipe().setMaterialList(new MaterialStack(DraconiumAwakened, 2), new MaterialStack(Neutronium, 2), new MaterialStack(Infinity, 1)).constructMaterial();
...
//      Duralumin.mChemicalFormula="Al\u2086CuMnMg";
        ...
        InfinityAlloy.mChemicalFormula = "D*\u2082Nt\u2082If*";
    }
