...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    //1234
    public static Materials DimensionallyTranscendentCrudeCatalyst           = new Materials( 748, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             , 10, 20,   20, 1,   "DimensionallyTranscendentCrudeCatalyst"           ,   "Dimensionally Transcendent Crude Catalyst"                ,    0,       0,         100000000,    1, false,  true,   1,   1,   1, Dyes.dyeCyan).setHasCorrespondingFluid(true);
    public static Materials DimensionallyTranscendentProsaicCatalyst         = new Materials( 747, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             , 10, 20,   20, 1,   "DimensionallyTranscendentProsaicCatalyst"           ,   "Dimensionally Transcendent Prosaic Catalyst"                ,    0,       0,         100000000,    1, false,  true,   1,   1,   1, Dyes.dyeGreen).setHasCorrespondingFluid(true);
    public static Materials DimensionallyTranscendentResplendentCatalyst     = new Materials( 746, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             , 10, 20,   20, 1,   "DimensionallyTranscendentResplendentCatalyst"           ,   "Dimensionally Transcendent Resplendent Catalyst"                ,    0,       0,         100000000,    1, false,  true,   1,   1,   1, Dyes.dyeLime).setHasCorrespondingFluid(true);
    public static Materials DimensionallyTranscendentExoticCatalyst          = new Materials( 745, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             , 10, 20,   20, 1,   "DimensionallyTranscendentExoticCatalyst"           ,   "Dimensionally Transcendent Exotic Catalyst"                ,    0,       0,         100000000,    1, false,  true,   1,   1,   1, Dyes.dyeMagenta).setHasCorrespondingFluid(true);

    public static Materials ExcitedDTCC     = new Materials( 109, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             , 10, 20,   20, 1,   "ExcitedDTCC"           ,   "Excited Dimensionally Transcendent Crude Catalyst"                 ,    0,       0,         500000000,    1, false,  true,   1,   1,   1, Dyes.dyeCyan);
    public static Materials ExcitedDTPC     = new Materials( 113, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             , 35, 59,   41, 1,   "ExcitedDTPC"           ,   "Excited Dimensionally Transcendent Prosaic Catalyst"             ,    0,       0,         500000000,    1, false,  true,   1,   1,   1, Dyes.dyeGreen);
    public static Materials ExcitedDTRC     = new Materials( 121, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             , 38, 20,   56, 1,   "ExcitedDTRC"           ,   "Excited Dimensionally Transcendent Resplendent Catalyst"     ,    0,       0,         500000000,    1, false,  true,   1,   1,   1, Dyes.dyeLime);
    public static Materials ExcitedDTEC     = new Materials( 126, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             , 240, 240, 41, 1,   "ExcitedDTEC"           ,   "Excited Dimensionally Transcendent Exotic Catalyst"               ,    0,       0,         500000000,    1, false,  true,   1,   1,   1, Dyes.dyeMagenta);

    public static Materials DimensionallyTranscendentResidue = new Materials( 589, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             , 0, 0, 0, 1,   "DimensionallyTranscendentResidue"           ,   "Dimensionally Transcendent Residue"                ,    0,       0,         25,    1, false,  true,   1,   1,   1, Dyes.dyeBlack);

    public static Materials SpaceTime                = new Materials(   588, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             ,   0,   0, 255, 240,   "SpaceTime"                ,   "SpaceTime"                      ,    1,      20,         14,    0, false,  true,   2,   1,   1, Dyes.dyeBlue         , Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.AQUA, 1)));
