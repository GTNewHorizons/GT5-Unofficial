...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    //1234
    public static Materials DimensionallyTranscendentCrudeCatalyst                 = new Materials(  781, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             ,   10, 20,   20, 0,   "DimensionallyTranscendentCrudeCatalyst"                   ,   "Dimensionally Transcendent Crude Catalyst"                       ,    0,       0,         83,    0, false,  true,   5,   1,   1, Dyes.dyeGreen       , Element.Di        , Arrays.asList(new TC_AspectStack(TC_Aspects.VACUOS, 2)));
    public static Materials DimensionallyTranscendentProsaicCatalyst               = new Materials(  782, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             ,   35, 59,   41, 0,   "DimensionallyTranscendentProsaicCatalyst"                 ,   "Dimensionally Transcendent Prosaic Catalyst"                     ,    0,       0,         84,    0, false,  true,   5,   1,   1, Dyes.dyeGreen       , Element.Di        , Arrays.asList(new TC_AspectStack(TC_Aspects.VACUOS, 4)));
    public static Materials DimensionallyTranscendentResplendentCatalyst           = new Materials(  783, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             ,   38, 20,   56, 0,   "DimensionallyTranscendentResplendentCatalyst"             ,   "Dimensionally Transcendent Resplendent Catalyst"                 ,    0,       0,         85,    0, false,  true,   5,   1,   1, Dyes.dyeGreen       , Element.Di        , Arrays.asList(new TC_AspectStack(TC_Aspects.VACUOS, 8)));
    public static Materials DimensionallyTranscendentExoticCatalyst                = new Materials(  784, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             ,   240, 240, 41, 0,   "DimensionallyTranscendentExoticCatalyst"                  ,   "Dimensionally Transcendent Exotic Catalyst"                      ,    0,       0,         86,    0, false,  true,   5,   1,   1, Dyes.dyeGreen       , Element.Di        , Arrays.asList(new TC_AspectStack(TC_Aspects.VACUOS, 16)));
