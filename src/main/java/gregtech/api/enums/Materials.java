...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    //Silicon Line
    public static Materials SiliconEG               = new Materials(  899, TextureSet.SET_METALLIC         ,   1.0F,      0,  2, 1|2  |8   |32             , 100, 100, 120,   0,   "SiliconElectronicGrade"  ,   "Silicon Electronic Grade (Mono SI)"      ,    0,       0,         2273,   2273, true, false,   1,   1,   1, Dyes.dyeBlack       , Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 8), new TC_AspectStack(TC_Aspects.TENEBRAE, 4)));
