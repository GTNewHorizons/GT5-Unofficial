...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    //1234
    public static Materials DimensionallyTranscendentCrudeCatalyst           = new Materials( 748, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             , 10, 20,   20, 1,   "DimensionallyTranscendentCrudeCatalyst"           ,   "Dimensionally Transcendent Crude Catalyst"                ,    0,       0,         100000000,    1, false,  true,   1,   1,   1, Dyes.dyeCyan).setLiquidTemperature(500000000).setHasCorrespondingFluid(true);
    public static Materials DimensionallyTranscendentProsaicCatalyst         = new Materials( 747, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             , 10, 20,   20, 1,   "DimensionallyTranscendentProsaicCatalyst"           ,   "Dimensionally Transcendent Prosaic Catalyst"                ,    0,       0,         100000000,    1, false,  true,   1,   1,   1, Dyes.dyeGreen).setLiquidTemperature(500000000).setHasCorrespondingFluid(true);
    public static Materials DimensionallyTranscendentResplendentCatalyst     = new Materials( 746, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             , 10, 20,   20, 1,   "DimensionallyTranscendentResplendentCatalyst"           ,   "Dimensionally Transcendent Resplendent Catalyst"                ,    0,       0,         100000000,    1, false,  true,   1,   1,   1, Dyes.dyeLime).setLiquidTemperature(500000000).setHasCorrespondingFluid(true);
    public static Materials DimensionallyTranscendentExoticCatalyst          = new Materials( 745, TextureSet.SET_FLUID             ,   1.0F,      0,  2,         16|32             , 10, 20,   20, 1,   "DimensionallyTranscendentExoticCatalyst"           ,   "Dimensionally Transcendent Exotic Catalyst"                ,    0,       0,         100000000,    1, false,  true,   1,   1,   1, Dyes.dyeMagenta).setLiquidTemperature(500000000).setHasCorrespondingFluid(true);
