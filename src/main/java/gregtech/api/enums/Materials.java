...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials Manasteel               = new MaterialBuilder(745, TextureSet.SET_METALLIC, "Mana Steel").setName("ManaSteel").addDustItems().addMetalItems().addOreItems().addToolHeadItems().addGemItems().setRGB(150, 212, 246).setColor(Dyes.dyeLightBlue).setToolSpeed(8.0F).setDurability(512).setToolQuality(3).setMeltingPoint(1500).setBlastFurnaceRequired(true).setMaterialList(new MaterialStack(Materials.Steel, 1), new MaterialStack(Materials.Magic, 1)).setAspects(Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.PRAECANTATIO, 4))).constructMaterial();
    public static Materials Terrasteel              = new MaterialBuilder(746, TextureSet.SET_METALLIC, "Terra Steel").setName("TerraSteel").addDustItems().addMetalItems().addOreItems().addToolHeadItems().addGemItems().setRGB(95, 211, 39).setColor(Dyes.dyeLime).setToolSpeed(32.0F).setDurability(10240).setToolQuality(5).setMeltingPoint(5400).setBlastFurnaceRequired(true).setMaterialList(new MaterialStack(Materials.Steel, 1), new MaterialStack(Materials.Magic, 2)).setAspects(Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.PRAECANTATIO, 8))).constructMaterial();
    public static Materials ElvenElementium         = new MaterialBuilder(747, TextureSet.SET_METALLIC, "Elementium").setName("ElvenElementium").addDustItems().addMetalItems().addOreItems().addToolHeadItems().addGemItems().setRGB(241, 104, 249).setColor(Dyes.dyePink).setToolSpeed(20.0F).setDurability(32768).setToolQuality(7).setMeltingPoint(7200).setBlastFurnaceRequired(true).setMaterialList(new MaterialStack(Materials.Magic, 4)).setAspects(Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.PRAECANTATIO, 16))).constructMaterial();
