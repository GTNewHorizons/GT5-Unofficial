...
public class Materials implements IColorModulationContainer, ISubTagContainer {
 ...
 // Polybenzimidazole stuff
    ...
    public static Materials Diamericiumtitanium = new Materials( 380, TextureSet.SET_METALLIC, 	   14.0F, 3000, 4, 1|2|64|128, 230, 160, 250, 0, "Diamericiumtitanium", "Diamericium Titanium", 0, 0, 8000, 8000, true, false, 4, 1, 1, Dyes.dyePurple, 2, Arrays.asList(new MaterialStack(Americium, 2), new MaterialStack(Titanium, 1))).disableAutoGeneratedBlastFurnaceRecipes();
    ...
    public static Materials BlackPlutonium          = new Materials( 416, TextureSet.SET_DULL              ,  36.0F,   8192,  6, 1|2  |8      |64|128      ,  50,  50,  50,   0,   "BlackPlutonium"          ,   "Black Plutonium"               ,     0,       0,     11000,  11000,  true, false,  4,   1,   1, Dyes.dyeBlack        );
    public static Materials Ledox                   = new Materials( 417, TextureSet.SET_SHINY             ,  15.0F,   1024,  4, 1|2  |8      |64|128      ,   0, 116, 255,   0,   "Ledox"                   ,   "Ledox"                         ,     0,       0,        -1,    0, false, false,  4,   1,   1, Dyes.dyeBlue         );
    public static Materials CosmicNeutronium        = new Materials( 418, TextureSet.SET_SHINY             ,   1.0F,      0,  8, 1|2    |8                 ,  50,  50,  50,   0,   "CosmicNeutronium"        ,   "Cosmic Neutronium"             ,     0,       0,     14000,  14000,  true,  false,  4,   1,   1, Dyes.dyeBlack        );
