...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials WhiteDwarfMatter = new Materials(585, TextureSet.SET_METALLIC, 1.0F, 0, 2, 1|2|64|128, 255, 255, 255, 255, "WhiteDwarfMatter", "White Dwarf Matter", -1, -1, 0, 0, false, false, 200, 1, 1, Dyes.dyePurple).setHasCorrespondingFluid(true);
