...
public class Materials implements IColorModulationContainer, ISubTagContainer {
 ...
 // Polybenzimidazole stuff
    ...
    public static Materials SuperconductorUV     = new Materials( -1, TextureSet.SET_SHINY       ,   1.0F,      0,  0, 0                ,  255, 255, 120,   0,   "SuperconductorUV"  ,   "Superconductor UV"      ,     0,       0,     -1,  -1,  false,  false,  1,   1,   1, Dyes.dyeYellow      , Arrays.asList(new TC_AspectStack(TC_Aspects.ELECTRUM, 36)));
    public static Materials SuperconductorUEV     = new Materials( -1, TextureSet.SET_SHINY       ,   1.0F,      0,  0, 0                ,  210, 120, 240,   0,   "SuperconductorUEV"  ,   "Superconductor UEV"      ,     0,       0,     -1,  -1,  false,  false,  1,   1,   1, Dyes.dyePurple      , Arrays.asList(new TC_AspectStack(TC_Aspects.ELECTRUM, 48)));
