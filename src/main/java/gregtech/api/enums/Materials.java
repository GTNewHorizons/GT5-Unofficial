...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    //Silicon Line
    public static Materials SiliconEG               = new Materials(  899, TextureSet.SET_METALLIC         ,   1.0F,      0,  2, 1|2  |8   |32             , 100, 100, 120,   0,   "MonoCrystallineSilicon"  ,   "Mono Crystalline Silicon"      ,    0,       0,         -1,   -1, false, false,   1,   1,   1, Dyes.dyeBlack       , Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 8), new TC_AspectStack(TC_Aspects.TENEBRAE, 4)));
    public static Materials SiliconSG               = new Materials(  856, TextureSet.SET_METALLIC         ,   1.0F,      0,  2, 1|2  |8   |32             ,  80,  80, 100,   0,   "PolyCrystallineSilicon"  ,   "Poly Crystalline Silicon"      ,    0,       0,         -1,   -1, false, false,   1,   1,   1, Dyes.dyeBlack       , Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 4), new TC_AspectStack(TC_Aspects.TENEBRAE, 2)));
