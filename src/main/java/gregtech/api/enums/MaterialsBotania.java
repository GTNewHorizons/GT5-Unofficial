...
public class MaterialsBotania {
    ...
    public static Materials Manasteel = new MaterialBuilder(201, new TextureSet("Manasteel", false), "Manasteel")
            .setName("Manasteel").setRGBA(70, 170, 230, 255).addDustItems().addMetalItems().addToolHeadItems()
    ...
    public static Materials Terrasteel = new MaterialBuilder(202, new TextureSet("Manasteel", false), "Terrasteel")
            .setName("Terrasteel").setRGBA(70, 200, 0, 255).addDustItems().addMetalItems().addToolHeadItems()
    ...
    public static Materials ElvenElementium = new MaterialBuilder(
            ...
            "Elven Elementium").setName("ElvenElementium").setRGBA(255, 45, 240, 255).addDustItems().addMetalItems()
                    .addToolHeadItems().addGearItems().setToolSpeed(20.0F).setDurability(32768).setToolQuality(7)
                    .setMeltingPoint(7200).setBlastFurnaceTemp(7200).setBlastFurnaceRequired(true)
                    .setAspects(
                            Arrays.asList(
                                    new TC_AspectStack(TCAspects.METALLUM, 3),
