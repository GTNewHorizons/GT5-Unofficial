...
public class MaterialsBotania {
    ...
    public static Materials Terrasteel = new MaterialBuilder(202, TextureSet.SET_METALLIC, "Terrasteel")
            ...
            .setAspects(Arrays.asList(
                    new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 2),
                    new TC_Aspects.TC_AspectStack(TC_Aspects.PRAECANTATIO, 8)))
            .constructMaterial();
    public static Materials ElvenElementium = new MaterialBuilder(203, TextureSet.SET_METALLIC, "Elementium")
            .setName("Elementium")
            ...
            .setBlastFurnaceRequired(true)
            .setAspects(Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.PRAECANTATIO, 16)))
            .constructMaterial();
    ...
    public static Materials GaiaSpirit = new Materials(
            ...
            1,
            Dyes._NULL,
            Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.PRAECANTATIO, 1)));
    ...
    public static Materials ManaDiamond = new Materials(
            ...
            Dyes._NULL,
            Arrays.asList(
                    new TC_Aspects.TC_AspectStack(TC_Aspects.PRAECANTATIO, 2),
                    new TC_Aspects.TC_AspectStack(TC_Aspects.ORDO, 1),
