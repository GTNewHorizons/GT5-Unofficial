...
public enum ItemList implements IItemContainer {
    ...
    Machine_Multi_ECCF,
    ECCF_cooling_block_0,
    ECCF_cooling_block_1,
    ECCF_cooling_block_2,
    ECCF_cooling_block_3,
    ECCF_heating_block_0,
    ECCF_heating_block_1,
    ECCF_heating_block_2,
    ECCF_heating_block_3,
    ECCF_pressure_block_0,
    ECCF_pressure_block_1,
    ECCF_pressure_block_2,
    ECCF_pressure_block_3,
    ECCF_vacuum_block_0,
    ECCF_vacuum_block_1,
    ECCF_vacuum_block_2,
    ECCF_vacuum_block_3,
