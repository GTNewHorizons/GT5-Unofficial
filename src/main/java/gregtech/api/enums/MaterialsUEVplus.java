...
public class MaterialsUEVplus {
    ...
    public static Materials SpaceTime = new Materials(
            ...
            Collections.singletonList(new TCAspects.TC_AspectStack(TCAspects.AQUA, 1)))
                    .setProcessingMaterialTierEU(TierEU.RECIPE_UEV).disableAutoGeneratedBlastFurnaceRecipes()
    ...
    public static Materials WhiteDwarfMatter = new Materials(
            ...
            1,
            1,
            Dyes.dyePurple).setHasCorrespondingFluid(true).setProcessingMaterialTierEU(TierEU.RECIPE_UEV)
                    .disableAutoGeneratedBlastFurnaceRecipes().disableAutoGeneratedVacuumFreezerRecipe();
    ...
    public static Materials DimensionallyShiftedSuperfluid = new MaterialBuilder(
            ...
            "Dimensionally Shifted Superfluid").addCell().addFluid().setRGBA(255, 255, 255, 0).setTransparent(true)
                    .setName("dimensionallyshiftedsuperfluid").setColor(Dyes._NULL).constructMaterial()
    ...
    public static Materials MoltenProtoHalkoniteBase = new MaterialBuilder(
            ...
            "Molten Proto-Halkonite Steel Base").setName("protohalkonitebase").addFluid().addCell()
                    .setLiquidTemperature(10000).setRGBA(255, 255, 255, 0).setTransparent(true).setColor(Dyes._NULL)
                    .constructMaterial().disableAutoGeneratedVacuumFreezerRecipe()
    ...
    public static Materials HotProtoHalkonite = new MaterialBuilder(
            ...
            "Hot Proto-Halkonite Steel").setName("hotprotohalkonite").setTypes(1 | 2 | 64 | 128).setOreValue(2)
                    .setRGBA(255, 255, 255, 0).setTransparent(false).constructMaterial()
                    .setProcessingMaterialTierEU(TierEU.RECIPE_UEV).disableAutoGeneratedVacuumFreezerRecipe()
                    .disableAutoGeneratedBlastFurnaceRecipes().disableAutoGeneratedRecycleRecipes();
    public static Materials ProtoHalkonite = new MaterialBuilder(
            154,
            new TextureSet("protohalkonite", true),
            "Proto-Halkonite Steel").setName("protohalkonite").setTypes(1 | 2 | 64 | 128).setRGBA(255, 255, 255, 0)
                    .setTransparent(false).constructMaterial().setProcessingMaterialTierEU(TierEU.RECIPE_UEV)
                    .disableAutoGeneratedVacuumFreezerRecipe().disableAutoGeneratedBlastFurnaceRecipes();

    public static Materials MoltenExoHalkoniteBase = new MaterialBuilder(
            155,
            TextureSet.SET_FLUID,
            "Molten Exo-Halkonite Steel Preparation Base").setName("moltenexohalkonitebase").addFluid().addCell()
                    .setLiquidTemperature(10000).setRGBA(30, 30, 30, 0).setTransparent(false).constructMaterial()
                    .disableAutoGeneratedVacuumFreezerRecipe().disableAutoGeneratedBlastFurnaceRecipes()
    ...
    public static Materials HotExoHalkonite = new MaterialBuilder(
            ...
            "Hot Exo-Halkonite Steel").setName("hotexohalkonite").setTypes(1 | 2 | 64 | 128).setOreValue(2)
                    .setRGBA(255, 255, 255, 0).setTransparent(false).constructMaterial()
                    .setProcessingMaterialTierEU(TierEU.RECIPE_UEV).disableAutoGeneratedVacuumFreezerRecipe()
                    .disableAutoGeneratedBlastFurnaceRecipes().disableAutoGeneratedRecycleRecipes();
    public static Materials ExoHalkonite = new MaterialBuilder(
            ...
            "Exo-Halkonite Steel").setName("exohalkonite").setTypes(1 | 2 | 64 | 128).setRGBA(255, 255, 255, 0)
                    .setTransparent(false).constructMaterial().setProcessingMaterialTierEU(TierEU.RECIPE_UEV)
                    .disableAutoGeneratedVacuumFreezerRecipe().disableAutoGeneratedBlastFurnaceRecipes();
    ...
    public static Materials StargateCrystalSlurry = new MaterialBuilder(
            ...
            "Stargate Crystal Slurry").setName("sgcrystalslurry").addFluid().addCell().setRGBA(255, 255, 255, 0)
                    .setTransparent(false).constructMaterial().setProcessingMaterialTierEU(TierEU.RECIPE_MAX);
