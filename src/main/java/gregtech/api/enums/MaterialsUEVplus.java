...
public class MaterialsUEVplus {
    ...
    // Moebianite Line
    public static Materials Moebianite = new Materials(
        161,
    ...
    public static Materials PurifiedMoebianite = new MaterialBuilder(165, TextureSet.SET_FLUID, "Purified Möebianite")
        ...
        .addFluid()
        .setLiquidTemperature(298)
        .setRGBA(254, 226, 139, 0)
        .setTransparent(true)
        .setName("PurifiedMoebianite")
        .setColor(Dyes._NULL)
        .constructMaterial()
        .setHasCorrespondingFluid(true);
    ...
    // Taranium Variants
    public static Materials InertTaranium = new Materials(
        167,
        TextureSet.SET_DULL,
        16F,
        4000000,
        ...
        1,
        1,
        Dyes.dyeBlue).disableAutoGeneratedBlastFurnaceRecipes()
            .disableAutoGeneratedVacuumFreezerRecipe();

    public static Materials HighlyReactiveTaranium = new Materials(
        168,
        ...
        181,
        100,
        "HighlyReactiveTaranium",
        "Highly Reactive Taranium",
        -1,
        -1,
        10800,
        10800,
    ...
    public static Materials HighlyStableTaranium = new Materials(
        169,
        TextureSet.SET_SHINY,
        64F,
        1310720,
        ...
        255,
        100,
        "HighlyStableTaranium",
        "Highly Stable Taranium",
        -1,
        -1,
        10800,
        10800,
    ...
    public static Materials QuanticalDisturbance = new Materials(
        170,
        new TextureSet("quanticalDisturbance", true), // TODO get texture set with infinity effect
        1.0F,
        8 * 2621440,
        26,
        0,
        ...
        200,
        0,
        "QuanticalDisturbance",
        "Quantically Disturbed Anomalous",
        -1,
        -1,
        100000,
        100000,
        ...
        1,
        Dyes._NULL,
        Collections.singletonList(new TCAspects.TC_AspectStack(TCAspects.SENSUS, 150)))
            .disableAutoGeneratedBlastFurnaceRecipes()
            .disableAutoGeneratedVacuumFreezerRecipe();

    public static Materials ParastableFractalHelium = new MaterialBuilder(
        171,
        TextureSet.SET_FLUID,
        "Parastable Fractal Helium").addCell()
            .addFluid()
            .setLiquidTemperature(6969)
            .setRGBA(57, 89, 65, 0)
            .setTransparent(true)
            .setName("ParastableFractalHelium")
            .setColor(Dyes._NULL)
            .constructMaterial()
            .setHasCorrespondingFluid(true);

    public static Materials FractalHeliumBoseEinsteinCondensate = new MaterialBuilder(
        172,
        TextureSet.SET_FLUID,
        "Fractal Helium Bose-Einstein Condensate").addCell()
            .addFluid()
            .setLiquidTemperature(0)
            .setRGBA(84, 21, 189, 0)
            .setTransparent(true)
            .setName("FractalHeliumBoseEinsteinCondensate")
            .setColor(Dyes._NULL)
            .constructMaterial()
            .setHasCorrespondingFluid(true);

    public static Materials Fractal = new Materials(
        173,
        new TextureSet("fractal", true),
        1.0F,
        8 * 2621440,
        26,
        0,
        ...
        1,
        1,
        Dyes._NULL).disableAutoGeneratedBlastFurnaceRecipes()
            .disableAutoGeneratedVacuumFreezerRecipe();

    public static Materials FractalJuice = new MaterialBuilder(174, TextureSet.SET_FLUID, "Fractal Juice").addCell()
        .addFluid()
        .setLiquidTemperature(0)
        .setRGBA(188, 221, 9, 0)
        .setTransparent(true)
        .setName("FractalJuice")
        .setColor(Dyes._NULL)
        .constructMaterial()
        .setHasCorrespondingFluid(true);
