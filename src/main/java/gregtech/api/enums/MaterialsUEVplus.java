...
public class MaterialsUEVplus {
    ...
    public static Materials HotProtoHalkonite = new MaterialBuilder(153, TextureSet.SET_METALLIC, "Hot Proto-Halkonite")
        .setName("hotprotohalkonite")
        .setTypes(1 | 2 | 64 | 128)
        .setOreValue(2)
        .setRGBA(244, 245, 208, 0)
        .setTransparent(false)
        .constructMaterial()
        .setProcessingMaterialTierEU(TierEU.RECIPE_UEV)
        .disableAutoGeneratedVacuumFreezerRecipe()
        .disableAutoGeneratedBlastFurnaceRecipes()
        .disableAutoGeneratedRecycleRecipes();
    public static Materials ProtoHalkonite = new MaterialBuilder(154, TextureSet.SET_METALLIC, "Proto-Halkonite")
