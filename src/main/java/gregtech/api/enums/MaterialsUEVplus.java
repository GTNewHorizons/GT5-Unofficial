...
public class MaterialsUEVplus {
    ...
    public static Materials LumipodExtract = new MaterialBuilder(161, TextureSet.SET_FLUID, "Bright Lumipod Extract")
        .addFluid()
        .addCell()
        .setLiquidTemperature(10000)
    ...
    public static Materials BiolcatalyzedPropulsionFluid = new MaterialBuilder(
        162,
        TextureSet.SET_FLUID,
