...
public final class GTGuiThemes {
    ...
    public static final GTGuiTheme STANDARD = GTGuiTheme.builder("gregtech:standard")
            .panel(GTTextureIds.BACKGROUND_STANDARD).itemSlot(GTTextureIds.SLOT_ITEM_STANDARD)
            .fluidSlot(GTTextureIds.SLOT_FLUID_STANDARD).color(Dyes.MACHINE_METAL.toInt()).textColor(0x404040)
            .textField(Dyes.dyeWhite.toInt()).customTextColor(GTWidgetThemes.TEXT_TITLE, 0x404040)
            ...
            .themedTexture(GTWidgetThemes.PICTURE_LOGO, GTTextureIds.PICTURE_GT_LOGO_STANDARD).build();
    public static final GTGuiTheme COVER = GTGuiTheme.builder("gregtech:cover").parent(STANDARD).textColor(0x555555)
            .customTextColor(GTWidgetThemes.TEXT_TITLE, 0x222222).textField(Dyes.dyeWhite.toInt()).build();
    public static final GTGuiTheme BRONZE = GTGuiTheme.builder("gregtech:bronze").parent(STANDARD)
            .panel(GTTextureIds.BACKGROUND_BRONZE).itemSlot(GTTextureIds.SLOT_ITEM_BRONZE)
            .fluidSlot(GTTextureIds.SLOT_FLUID_BRONZE).color(Dyes.dyeWhite.toInt()).button(GTTextureIds.BUTTON_BRONZE)
            ...
            .themedTexture(GTWidgetThemes.PICTURE_LOGO, GTTextureIds.PICTURE_GT_LOGO_BRONZE).build();
    public static final GTGuiTheme STEEL = GTGuiTheme.builder("gregtech:steel").parent(STANDARD)
            .panel(GTTextureIds.BACKGROUND_STEEL).itemSlot(GTTextureIds.SLOT_ITEM_STEEL)
            .fluidSlot(GTTextureIds.SLOT_FLUID_STEEL).color(Dyes.dyeWhite.toInt()).textColor(0xfafaff)
            .customTextColor(GTWidgetThemes.TEXT_TITLE, 0xfafaff).button(GTTextureIds.BUTTON_STEEL)
            ...
            .themedTexture(GTWidgetThemes.PICTURE_LOGO, GTTextureIds.PICTURE_GT_LOGO_STEEL).build();
    public static final GTGuiTheme PRIMITIVE = GTGuiTheme.builder("gregtech:primitive").parent(STANDARD)
            .panel(GTTextureIds.BACKGROUND_PRIMITIVE).itemSlot(GTTextureIds.SLOT_ITEM_PRIMITIVE)
            .fluidSlot(GTTextureIds.SLOT_FLUID_PRIMITIVE).color(Dyes.dyeWhite.toInt()).textColor(0xfafaff)
            .customTextColor(GTWidgetThemes.TEXT_TITLE, 0xfafaff).button(GTTextureIds.BUTTON_PRIMITIVE)
            .simpleToggleButton(
                    GTTextureIds.BUTTON_PRIMITIVE,
            ...
            .themedOverlayItemSlot(
                    GTWidgetThemes.OVERLAY_ITEM_SLOT_FURNACE,
            ...
            .themedTexture(GTWidgetThemes.PICTURE_LOGO, GTTextureIds.PICTURE_GT_LOGO_PRIMITIVE).build();
}
