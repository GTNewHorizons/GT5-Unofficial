...
public final class GTGuiThemes {
    ...
    public static final GTGuiTheme STANDARD = GTGuiTheme.builder("gregtech:standard")
        ...
        .color(Dyes.MACHINE_METAL.colorRGB)
        .textColor(0x404040)
        .textField(Dyes.dyeWhite.colorRGB)
    ...
    public static final GTGuiTheme BRONZE = GTGuiTheme.builder("gregtech:bronze")
        ...
        .color(Dyes.dyeWhite.colorRGB)
        .button(GTTextureIds.BUTTON_BRONZE)
        .simpleToggleButton(GTTextureIds.BUTTON_BRONZE, GTTextureIds.BUTTON_BRONZE_PRESSED, Dyes.dyeWhite.colorRGB)
    ...
    public static final GTGuiTheme STEEL = GTGuiTheme.builder("gregtech:steel")
        ...
        .simpleToggleButton(GTTextureIds.BUTTON_STEEL, GTTextureIds.BUTTON_STEEL_PRESSED, Dyes.dyeWhite.colorRGB)
