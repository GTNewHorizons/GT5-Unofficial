...
public final class GTGuiTextures {
    ...
    public static final UITexture BACKGROUND_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/background/singleblock_default").imageSize(176, 166).adaptable(4)
            .canApplyTheme().name(GTTextureIds.BACKGROUND_STANDARD).build();
    private static final SteamTextureRegisterer BACKGROUND_STEAM = SteamTextureRegisterer.builder()
            .location("gui/background/%s").imageSize(176, 166).adaptable(4).canApplyTheme()
    ...
    public static final UITexture BACKGROUND_TITLE_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/tab/title_dark").imageSize(28, 28).adaptable(4).canApplyTheme()
            .name(GTTextureIds.BACKGROUND_TITLE_STANDARD).build();
    private static final SteamTextureRegisterer BACKGROUND_TITLE_STEAM = SteamTextureRegisterer.builder()
            .location("gui/tab/title_dark_%s").imageSize(28, 28).adaptable(4).canApplyTheme()
            .name(
    ...
    public static final UITexture BACKGROUND_POPUP_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/background/popup").imageSize(195, 136).adaptable(4).canApplyTheme()
            .name(GTTextureIds.BACKGROUND_POPUP_STANDARD).build();
    private static final SteamTextureRegisterer BACKGROUND_POPUP_STEAM = SteamTextureRegisterer.builder()
            .location("gui/background/popup_%s").imageSize(195, 136).adaptable(4).canApplyTheme()
            .name(
    ...
    public static final UITexture BACKGROUND_TEXT_FIELD = UITexture.builder()
            .location(GregTech.ID, "gui/background/text_field").imageSize(142, 28).adaptable(1)
            .name(GTTextureIds.BACKGROUND_TERMINAL_STANDARD).build();
    ...
    public static final UITexture SLOT_ITEM_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/slot/item_standard").imageSize(18, 18).adaptable(1).canApplyTheme()
            .name(GTTextureIds.SLOT_ITEM_STANDARD).build();
    public static final UITexture SLOT_ITEM_BRONZE = UITexture.builder().location(GregTech.ID, "gui/slot/item_bronze")
            .imageSize(18, 18).adaptable(1).canApplyTheme().name(GTTextureIds.SLOT_ITEM_BRONZE).build();
    public static final UITexture SLOT_ITEM_STEEL = UITexture.builder().location(GregTech.ID, "gui/slot/item_steel")
            .imageSize(18, 18).adaptable(1).canApplyTheme().name(GTTextureIds.SLOT_ITEM_STEEL).build();
    public static final UITexture SLOT_ITEM_PRIMITIVE = UITexture.builder()
            .location(GregTech.ID, "gui/slot/item_primitive").imageSize(18, 18).adaptable(1).canApplyTheme()
            .name(GTTextureIds.SLOT_ITEM_PRIMITIVE).build();
    public static final UITexture SLOT_ITEM_DARK = UITexture.builder().location(GregTech.ID, "gui/slot/dark_gray")
            .imageSize(18, 18).adaptable(1).canApplyTheme().build();
    public static final UITexture SLOT_FLUID_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/slot/fluid_standard").imageSize(18, 18).adaptable(1).canApplyTheme()
            .name(GTTextureIds.SLOT_FLUID_STANDARD).build();
    public static final UITexture SLOT_FLUID_BRONZE = UITexture.builder().location(GregTech.ID, "gui/slot/fluid_bronze")
            .imageSize(18, 18).adaptable(1).name(GTTextureIds.SLOT_FLUID_BRONZE).build();
    public static final UITexture SLOT_FLUID_STEEL = UITexture.builder().location(GregTech.ID, "gui/slot/fluid_steel")
            .imageSize(18, 18).adaptable(1).canApplyTheme().name(GTTextureIds.SLOT_FLUID_STEEL).build();
    public static final UITexture SLOT_FLUID_PRIMITIVE = UITexture.builder()
            .location(GregTech.ID, "gui/slot/fluid_primitive").imageSize(18, 18).adaptable(1).canApplyTheme()
            .name(GTTextureIds.SLOT_FLUID_PRIMITIVE).build();
    ...
    public static final UITexture OVERLAY_SLOT_CANISTER_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/overlay_slot/canister").fullImage().canApplyTheme()
            .name(GTTextureIds.OVERLAY_SLOT_CANISTER_STANDARD).build();
    private static final SteamTextureRegisterer OVERLAY_SLOT_CANISTER_STEAM = SteamTextureRegisterer.builder()
            .location("gui/overlay_slot/canister_%s").fullImage().canApplyTheme()
            .name(GTTextureIds.OVERLAY_SLOT_CANISTER_BRONZE, GTTextureIds.OVERLAY_SLOT_CANISTER_STEEL, null).build();
    ...
    public static final UITexture OVERLAY_SLOT_DUST_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/overlay_slot/dust").fullImage().canApplyTheme()
            .name(GTTextureIds.OVERLAY_SLOT_DUST_STANDARD).build();
    private static final SteamTextureRegisterer OVERLAY_SLOT_DUST_STEAM = SteamTextureRegisterer.builder()
            .location("gui/overlay_slot/dust_%s").fullImage().canApplyTheme()
            .name(
    ...
    public static final UITexture OVERLAY_SLOT_INGOT_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/overlay_slot/ingot").fullImage().canApplyTheme()
            .name(GTTextureIds.OVERLAY_SLOT_INGOT_STANDARD).build();
    private static final SteamTextureRegisterer OVERLAY_SLOT_INGOT_STEAM = SteamTextureRegisterer.builder()
            .location("gui/overlay_slot/ingot_%s").fullImage().canApplyTheme()
            .name(
    ...
    public static final UITexture OVERLAY_SLOT_FURNACE_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/overlay_slot/furnace").fullImage().canApplyTheme()
            .name(GTTextureIds.OVERLAY_SLOT_FURNACE_STANDARD).build();
    private static final SteamTextureRegisterer OVERLAY_SLOT_FURNACE_STEAM = SteamTextureRegisterer.builder()
            .location("gui/overlay_slot/furnace_%s").fullImage().canApplyTheme()
            .name(
    ...
    public static final UITexture OVERLAY_SLOT_IN_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/overlay_slot/in").fullImage().canApplyTheme()
            .name(GTTextureIds.OVERLAY_SLOT_IN_STANDARD).build();
    private static final SteamTextureRegisterer OVERLAY_SLOT_IN_STEAM = SteamTextureRegisterer.builder()
            .location("gui/overlay_slot/in_%s").fullImage().canApplyTheme()
            .name(GTTextureIds.OVERLAY_SLOT_IN_BRONZE, GTTextureIds.OVERLAY_SLOT_IN_STEEL, null).build();
    public static final UITexture OVERLAY_SLOT_OUT_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/overlay_slot/out").fullImage().canApplyTheme()
            .name(GTTextureIds.OVERLAY_SLOT_OUT_STANDARD).build();
    private static final SteamTextureRegisterer OVERLAY_SLOT_OUT_STEAM = SteamTextureRegisterer.builder()
            .location("gui/overlay_slot/out_%s").fullImage().canApplyTheme()
            .name(GTTextureIds.OVERLAY_SLOT_OUT_BRONZE, GTTextureIds.OVERLAY_SLOT_OUT_STEEL, null).build();
    public static final UITexture OVERLAY_SLOT_COAL_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/overlay_slot/coal").fullImage().canApplyTheme()
            .name(GTTextureIds.OVERLAY_SLOT_COAL_STANDARD).build();
    private static final SteamTextureRegisterer OVERLAY_SLOT_COAL_STEAM = SteamTextureRegisterer.builder()
            .location("gui/overlay_slot/coal_%s").fullImage().canApplyTheme()
            .name(GTTextureIds.OVERLAY_SLOT_COAL_BRONZE, GTTextureIds.OVERLAY_SLOT_COAL_STEEL, null).build();
    public static final UITexture OVERLAY_SLOT_BLOCK_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/overlay_slot/block").fullImage().canApplyTheme()
            .name(GTTextureIds.OVERLAY_SLOT_BLOCK_STANDARD).build();
    private static final SteamTextureRegisterer OVERLAY_SLOT_BLOCK_STEAM = SteamTextureRegisterer.builder()
            .location("gui/overlay_slot/block_%s").fullImage().canApplyTheme()
            .name(
    ...
    public static final UITexture OVERLAY_BUTTON_VOID_EXCESS_NONE = UITexture.builder().canApplyTheme(true)
            .location(GregTech.ID, "gui/overlay_button/void_excess_none").build();
    public static final UITexture OVERLAY_BUTTON_VOID_EXCESS_ITEM = UITexture.builder().canApplyTheme(true)
            .location(GregTech.ID, "gui/overlay_button/void_excess_item").build();
    public static final UITexture OVERLAY_BUTTON_VOID_EXCESS_FLUID = UITexture.builder().canApplyTheme(true)
            .location(GregTech.ID, "gui/overlay_button/void_excess_fluid").build();
    public static final UITexture OVERLAY_BUTTON_VOID_EXCESS_ALL = UITexture.builder().canApplyTheme(true)
            .location(GregTech.ID, "gui/overlay_button/void_excess_all").build();
    ...
    public static final UITexture OVERLAY_BUTTON_BOUNDING_BOX = UITexture.builder()
            .location(GregTech.ID, "gui/overlay_button/bounding_box").fullImage().canApplyTheme(true).build();
    ...
    public static final UITexture PROGRESSBAR_BOILER_HEAT = UITexture.builder()
            .location(GregTech.ID, "gui/progressbar/boiler_heat").fullImage().name(GTTextureIds.PROGRESSBAR_BOILER_HEAT)
            .build();
    public static final UITexture PROGRESSBAR_FUEL_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/progressbar/fuel").fullImage().canApplyTheme()
            .name(GTTextureIds.PROGRESSBAR_FUEL_STANDARD).build();
    private static final SteamTextureRegisterer PROGRESSBAR_FUEL_STEAM = SteamTextureRegisterer.builder()
            .location("gui/progressbar/fuel_%s").fullImage().canApplyTheme()
            .name(GTTextureIds.PROGRESSBAR_FUEL_BRONZE, GTTextureIds.PROGRESSBAR_FUEL_STEEL, null).build();
    public static final UITexture PROGRESSBAR_SIEVERT = UITexture.builder()
            .location(MainMod.MOD_ID, "GUI/progressbar/sievert").fullImage().name(GTTextureIds.PROGRESSBAR_SIEVERT)
            .build();
    ...
    public static final UITexture BUTTON_STANDARD = UITexture.builder().location(GregTech.ID, "gui/button/standard")
            .imageSize(18, 18).adaptable(1).canApplyTheme().name(GTTextureIds.BUTTON_STANDARD).build();
    private static final SteamTextureRegisterer BUTTON_STEAM = SteamTextureRegisterer.builder()
            .location("gui/button/%s").imageSize(18, 18).adaptable(1).canApplyTheme()
            .name(GTTextureIds.BUTTON_BRONZE, GTTextureIds.BUTTON_STEEL, GTTextureIds.BUTTON_PRIMITIVE).build();
    public static final UITexture BUTTON_STANDARD_PRESSED = UITexture.builder()
            .location(GregTech.ID, "gui/button/standard_pressed").imageSize(18, 18).adaptable(1).canApplyTheme()
            .name(GTTextureIds.BUTTON_STANDARD_PRESSED).build();
    private static final SteamTextureRegisterer BUTTON_STEAM_PRESSED = SteamTextureRegisterer.builder()
            .location("gui/button/%s_pressed").imageSize(18, 18).adaptable(1).canApplyTheme()
            .name(
    ...
    public static final UITexture BUTTON_COVER_TAB_NORMAL_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/tab/cover_normal").fullImage().canApplyTheme()
            .name(GTTextureIds.BUTTON_COVER_TAB_NORMAL_STANDARD).build();
    public static final UITexture BUTTON_COVER_TAB_HIGHLIGHT_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/tab/cover_highlight").fullImage().canApplyTheme()
            .name(GTTextureIds.BUTTON_COVER_TAB_HIGHLIGHT_STANDARD).build();
    public static final UITexture BUTTON_COVER_TAB_DISABLED_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/tab/cover_disabled").fullImage().canApplyTheme()
            .name(GTTextureIds.BUTTON_COVER_TAB_DISABLED_STANDARD).build();
    private static final SteamTextureRegisterer BUTTON_COVER_TAB_NORMAL_STEAM = SteamTextureRegisterer.builder()
            .location("gui/tab/cover_%s_normal").fullImage().canApplyTheme()
            .name(
    ...
    private static final SteamTextureRegisterer BUTTON_COVER_TAB_HIGHLIGHT_STEAM = SteamTextureRegisterer.builder()
            .location("gui/tab/cover_%s_highlight").fullImage().canApplyTheme()
            .name(
    ...
    private static final SteamTextureRegisterer BUTTON_COVER_TAB_DISABLED_STEAM = SteamTextureRegisterer.builder()
            .location("gui/tab/cover_%s_disabled").fullImage().canApplyTheme()
            .name(
    ...
    public static final UITexture PICTURE_GT_LOGO_STANDARD = UITexture.builder()
            .location(GregTech.ID, "gui/picture/gt_logo_standard").fullImage()
            .name(GTTextureIds.PICTURE_GT_LOGO_STANDARD).build();
    public static final UITexture PICTURE_GT_LOGO_GRAY = UITexture.builder()
            .location(GregTech.ID, "gui/picture/gt_logo_gray").fullImage().name(GTTextureIds.PICTURE_GT_LOGO_GRAY)
            .build();
    private static final SteamTextureRegisterer PICTURE_GT_LOGO_STEAM = SteamTextureRegisterer.builder()
            .location("gui/picture/gt_logo_%s").fullImage()
            .name(
    ...
    public static final UITexture PICTURE_BARTWORKS_LOGO_STANDARD = UITexture.builder()
            .location(MainMod.MOD_ID, "GUI/picture/bw_logo_47x21").fullImage()
            .name(GTTextureIds.PICTURE_BW_LOGO_STANDARD).build();

    public static final UITexture PICTURE_TRANSPARENT = UITexture.builder()
            .location(GregTech.ID, "gui/picture/transparent").fullImage().name(GTTextureIds.PICTURE_TRANSPARENT)
            .build();
    public static final UITexture PICTURE_SIEVERT_CONTAINER = UITexture.builder()
            .location(MainMod.MOD_ID, "GUI/picture/sievert_container").fullImage().canApplyTheme()
            .name(GTTextureIds.PICTURE_SIEVERT_CONTAINER).build();
    public static final UITexture PICTURE_DECAY_TIME_CONTAINER = UITexture.builder()
            .location(MainMod.MOD_ID, "GUI/picture/decay_time_container").fullImage().canApplyTheme()
            .name(GTTextureIds.PICTURE_DECAY_TIME_CONTAINER).build();
    public static final UITexture PICTURE_DECAY_TIME_INSIDE = UITexture.builder()
            .location(MainMod.MOD_ID, "GUI/picture/decay_time_inside").fullImage().canApplyTheme()
            .name(GTTextureIds.PICTURE_DECAY_TIME_INSIDE).build();
    public static final UITexture PICTURE_RADIATION_SHUTTER_FRAME = UITexture.builder()
            .location(MainMod.MOD_ID, "GUI/picture/radiation_shutter_frame").fullImage().canApplyTheme()
            .name(GTTextureIds.PICTURE_RADIATION_SHUTTER_FRAME).build();
    public static final UITexture PICTURE_RADIATION_SHUTTER_INSIDE = UITexture.builder()
            .location(MainMod.MOD_ID, "GUI/picture/radiation_shutter_inside").adaptable(1, 1, 1, 1).canApplyTheme()
            .name(GTTextureIds.PICTURE_RADIATION_SHUTTER_INSIDE).build();
