...
public final class GTGuiTextures {
    ...
    public static final UITexture PICTURE_RADIATION_SHUTTER_INSIDE = UITexture.builder()
        ...
        .build();
    public static final UITexture MODULAR_SOLIDIFIER_BASE = UITexture.builder()
        .location(GregTech.ID, "gui/picture/modular_solidifier_base")
        .fullImage()
        .canApplyTheme()
        .name(GTTextureIds.PICTURE_MODULAR_SOLIDIFIER_BASE)
        .build();
    public static final UITexture MODULAR_SOLIDIFIER_UNSET = UITexture.builder()
        .location(GregTech.ID, "gui/picture/modular_solidifier_unset")
        .fullImage()
        .canApplyTheme()
        .name(GTTextureIds.PICTURE_MODULAR_SOLIDIFIER_UNSET)
        .build();
    public static final UITexture MODULAR_SOLIDIFIER_TR_RE = UITexture.builder()
        .location(GregTech.ID, "gui/picture/modular_solidifier_tr_re")
        .fullImage()
        .canApplyTheme()
        .name(GTTextureIds.PICTURE_MODULAR_SOLIDIFIER_TR_RE)
        .build();
    public static final UITexture MODULAR_SOLIDIFIER_HC = UITexture.builder()
        .location(GregTech.ID, "gui/picture/modular_solidifier_hypercooler")
        .fullImage()
        .canApplyTheme()
        .name(GTTextureIds.PICTURE_MODULAR_SOLIDIFIER_HC)
        .build();
    public static final UITexture MODULAR_SOLIDIFIER_TDS = UITexture.builder()
        .location(GregTech.ID, "gui/picture/modular_solidifier_tds")
        .fullImage()
        .canApplyTheme()
        .name(GTTextureIds.PICTURE_MODULAR_SOLIDIFIER_TDS)
        .build();
    public static final UITexture MODULAR_SOLIDIFIER_EFF_OC = UITexture.builder()
        .location(GregTech.ID, "gui/picture/modular_solidifier_efficient_oc")
        .fullImage()
        .canApplyTheme()
        .name(GTTextureIds.PICTURE_MODULAR_SOLIDIFIER_EOC)
        .build();
