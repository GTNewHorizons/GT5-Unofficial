...
public class Packet_ClientPreference extends Packet_New {

    private GT_ClientPreference mPreference;
    private EntityPlayerMP mPlayer;

    public Packet_ClientPreference() {
        super(true);
    }

    public Packet_ClientPreference(GT_ClientPreference mPreference) {
        super(false);
    ...
    public byte getPacketID() {
        return PacketTypes.CLIENT_PREFERENCE.id;
    }
    ...
    public Packet_New decode(ByteArrayDataInput aData) {
        return new Packet_ClientPreference(
