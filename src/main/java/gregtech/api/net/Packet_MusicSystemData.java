...
public class Packet_MusicSystemData extends Packet_New {

    ByteBuf storedData;

    public Packet_MusicSystemData() {
        super(true);
    }

    public Packet_MusicSystemData(ByteBuf data) {
        super(false);
    ...
    public byte getPacketID() {
        return PacketTypes.MUSIC_SYSTEM_DATA.id;
    }
    ...
    public Packet_New decode(ByteArrayDataInput aData) {
        ...
        return new Packet_MusicSystemData(Unpooled.wrappedBuffer(fullData));
    }
