...
public class Packet_TileEntity extends Packet_New {
    ...
    // For multi tiles
    public Packet_TileEntity(int aX, short aY, int aZ, short aRID, short aID, int aC0, int aC1, int aC2, int aC3,
    ...
    // For meta tiles
    public Packet_TileEntity(int aX, short aY, int aZ, short aID, int aC0, int aC1, int aC2, int aC3, int aC4, int aC5,
    ...
    public byte getPacketID() {
        return PacketTypes.TILE_ENTITY.id;
    }
}
