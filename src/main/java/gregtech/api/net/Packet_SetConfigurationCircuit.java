 ...
 */
public class Packet_SetConfigurationCircuit extends Packet_New {
    ...
    public Packet_SetConfigurationCircuit() {
        super(true);
    }

    public Packet_SetConfigurationCircuit(IGregTechTileEntity tile, ItemStack circuit) {
        this(tile.getXCoord(), tile.getYCoord(), tile.getZCoord(), circuit);
    }

    public Packet_SetConfigurationCircuit(BaseTileEntity tile, ItemStack circuit) {
        this(tile.getXCoord(), tile.getYCoord(), tile.getZCoord(), circuit);
    }

    public Packet_SetConfigurationCircuit(int x, short y, int z, ItemStack circuit) {
        super(false);
    ...
    public byte getPacketID() {
        return PacketTypes.SET_CONFIGURATION_CIRCUIT.id;
    }
    ...
    public Packet_New decode(ByteArrayDataInput aData) {
        return new Packet_SetConfigurationCircuit(
            aData.readInt(),
            aData.readShort(),
            aData.readInt(),
