 ...
 */
public class Packet_UpdateItem extends Packet_New {

    private NBTTagCompound tag;
    private EntityPlayerMP mPlayer;

    public Packet_UpdateItem() {
        super(true);
    }

    public Packet_UpdateItem(NBTTagCompound tag) {
        super(false);
        this.tag = tag;
    }
    ...
    public byte getPacketID() {
        return PacketTypes.UPDATE_ITEM.id;
    }
    ...
    public Packet_New decode(ByteArrayDataInput aData) {
        return new Packet_UpdateItem(ISerializableObject.readCompoundTagFromGreggyByteBuf(aData));
    }
