 ...
 */
public class Packet_RequestCoverData extends Packet_New {
    ...
    public Packet_RequestCoverData(CoverInfo info, ICoverable tile) {
        super(false);
    ...
    public Packet_RequestCoverData(int mX, short mY, int mZ, ForgeDirection coverSide, int coverID) {
        super(false);
        this.mX = mX;
        this.mY = mY;
        this.mZ = mZ;
    ...
    public Packet_RequestCoverData(ForgeDirection coverSide, int coverID, ICoverable tile) {
        super(false);
        this.mX = tile.getXCoord();
        this.mY = tile.getYCoord();
        this.mZ = tile.getZCoord();
    ...
    public byte getPacketID() {
        return PacketTypes.REQUEST_COVER_DATA.id;
    }
    ...
    public Packet_New decode(ByteArrayDataInput aData) {
        return new Packet_RequestCoverData(
            aData.readInt(),
            aData.readShort(),
            aData.readInt(),
