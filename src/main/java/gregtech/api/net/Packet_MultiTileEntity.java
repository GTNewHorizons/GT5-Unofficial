...
public class Packet_MultiTileEntity extends Packet_New {
    ...
    public Packet_MultiTileEntity(boolean reference) {
        super(reference);
    }
    ...
    @Override
    public Packet_New decode(ByteArrayDataInput in) {
    ...
    public byte getPacketID() {
        return PacketTypes.MULTI_TILE_ENTITY.id;
    }
