...
public class Runnable_MachineBlockUpdate implements Runnable {
    ...
    protected Runnable_MachineBlockUpdate(World aWorld, int posX, int posY, int posZ) {
        this.world = aWorld;
        this.initialX = posX;
        this.initialY = posY;
        this.initialZ = posZ;
    ...
    public static void setEnabled() {
        Runnable_MachineBlockUpdate.isEnabled = true;
    }

    public static void setDisabled() {
        Runnable_MachineBlockUpdate.isEnabled = false;
    }

    public static void setEnabled(boolean isEnabled) {
        Runnable_MachineBlockUpdate.isEnabled = isEnabled;
    }
    ...
    public static void setCurrentThreadEnabled(boolean perThreadEnable) {
        Runnable_MachineBlockUpdate.perThreadEnable.set(perThreadEnable);
    }
    ...
    public static void setMachineUpdateValues(World aWorld, int posX, int posY, int posZ) {
        if (isEnabled() && isCurrentThreadEnabled()) {
            EXECUTOR_SERVICE.submit(new Runnable_MachineBlockUpdate(aWorld, posX, posY, posZ));
        }
    }
