...
public class PositionedStructureErrorWithExpected implements StructureError {
    ...
    public PositionedStructureErrorWithExpected(int x, int y, int z, List<String> expectedBlocks) {
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    public StructureErrorId getId() {
        return StructureErrorId.POSITIONED_ERROR_WITH_EXPECTED;
    }
    ...
    public StructureError deserialize(PacketBuffer buffer) throws IOException {
        ...
        return new PositionedStructureErrorWithExpected(x, y, z, blocks);
    }
    ...
    public StructureError copy() {
        return new PositionedStructureErrorWithExpected(x, y, z, new ArrayList<>(expectedBlocks));
    }

    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof PositionedStructureErrorWithExpected other)) return false;
