...
public class AssemblyLineFrontend extends RecipeMapFrontend {
    ...
    public void addProgressBar(ModularWindow.Builder builder, Supplier<Float> progressSupplier, Pos2d windowOffset) {
        ...
        builder.widget(
            new ProgressBar().setTexture(UITextures.PROGRESSBAR_ASSEMBLY_LINE_1, bar1Width)
        ...
        builder.widget(
            new ProgressBar().setTexture(UITextures.PROGRESSBAR_ASSEMBLY_LINE_2, bar2Width)
                .setDirection(ProgressBar.Direction.RIGHT)
        ...
        builder.widget(
            new ProgressBar().setTexture(UITextures.PROGRESSBAR_ASSEMBLY_LINE_3, 18)
