...
public class PurificationUnitRecipeMapFrontend extends RecipeMapFrontend {
    ...
    public PurificationUnitRecipeMapFrontend(int overlayHeight, BasicUIPropertiesBuilder uiPropertiesBuilder,
        ...
        super(
                uiPropertiesBuilder.progressBarSize(new Size(0, 0)).progressBarPos(new Pos2d(0, 0)),
    ...
    public void addProgressBar(ModularWindow.Builder builder, Supplier<Float> progressSupplier, Pos2d windowOffset) {
        ...
        builder.widget(
                new ProgressBar().setTexture(texture, 170).setDirection(uiProperties.progressBarDirection)
                        .setProgress(progressSupplier).setSynced(false, false)
                        .setPos(realProgressBarPos.add(windowOffset)).setSize(new Size(170, overlayHeight)));
    }
