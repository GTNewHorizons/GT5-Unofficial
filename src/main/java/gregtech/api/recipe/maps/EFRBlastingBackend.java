...
public class EFRBlastingBackend extends NonGTBackend {

    public EFRBlastingBackend(RecipeMapBackendPropertiesBuilder propertiesBuilder) {
    ...
    protected GTRecipe overwriteFindRecipe(ItemStack[] items, FluidStack[] fluids, @Nullable ItemStack specialSlot,
        ...
        ItemStack output = GTModHandler.getEFRBlastingOutput(items[0], false, null);
