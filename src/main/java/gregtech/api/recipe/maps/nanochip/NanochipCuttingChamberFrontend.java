...
public class NanochipCuttingChamberFrontend extends CustomBackgroundRecipeMapFrontend {

    public NanochipCuttingChamberFrontend(BasicUIPropertiesBuilder uiPropertiesBuilder,
        NEIRecipePropertiesBuilder neiPropertiesBuilder) {
        super(
            120,
            uiPropertiesBuilder.progressBarTexture(new FallbackableUITexture(GTUITextures.PROGRESSBAR_CUTTING_CHAMBER)),
