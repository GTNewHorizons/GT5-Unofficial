    ...
    public static final RecipeMap<RecipeMapBackend> primitiveBlastRecipes = RecipeMapBuilder
        ...
        .recipeEmitter(builder -> {
            ...
            if ((aInput1 == null || aInput1.stackSize <= 6) && (aInput2 == null || aInput2.stackSize <= 6)
                ...
                ItemStack cactusCokeBlock = new ItemStack(Item.getItemFromBlock(ModBlocks.blockCactusCoke), aCoalAmount * 2, 0);
                ItemStack sugarCokeBlock = new ItemStack(Item.getItemFromBlock(ModBlocks.blockSugarCoke), aCoalAmount * 2, 0);
                coll.derive()
