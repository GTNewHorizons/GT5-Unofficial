...
public abstract class MetaTileEntity_SpecialFilter extends FilterBase {

    private static final String ALLOW_NBT_TOOLTIP = "GT5U.machines.allow_nbt.tooltip";
    private boolean allowNbt = false;

    public MetaTileEntity_SpecialFilter(int aID, String aName, String aNameRegional, int aTier, String[] aDescription) {
        // 9 buffer slot, 1 representation slot, 1 holo slot. last seems not needed...
        super(aID, aName, aNameRegional, aTier, 11, aDescription);
    }

    public MetaTileEntity_SpecialFilter(String aName, int aTier, int aInvSlotCount, String aDescription,
        ITexture[][][] aTextures) {
    ...
    public void addUIWidgets(ModularWindow.Builder builder, UIBuildContext buildContext) {
        ...
        builder.widget(
            new DrawableWidget().setDrawable(UITextures.PICTURE_ARROW_24_WHITE.apply(27, false))
                .setPos(6, 19)
                .setSize(27, 24))
            .widget(
                new DrawableWidget().setDrawable(UITextures.PICTURE_ARROW_24_BLUE.apply(42, true))
                    .setPos(53, 19)
                    .setSize(42, 24))
            .widget(
