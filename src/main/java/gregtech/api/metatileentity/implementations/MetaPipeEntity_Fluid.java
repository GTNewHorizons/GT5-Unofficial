...
import static gregtech.api.metatileentity.implementations.MetaPipeEntity_Fluid.Border.BOTTOM;
import static gregtech.api.metatileentity.implementations.MetaPipeEntity_Fluid.Border.LEFT;
import static gregtech.api.metatileentity.implementations.MetaPipeEntity_Fluid.Border.RIGHT;
import static gregtech.api.metatileentity.implementations.MetaPipeEntity_Fluid.Border.TOP;
...
public class MetaPipeEntity_Fluid extends MetaPipeEntity {
    ...
    public MetaPipeEntity_Fluid(int aID, String aName, String aNameRegional, float aThickNess, Materials aMaterial,
    ...
    public MetaPipeEntity_Fluid(String aName, float aThickNess, Materials aMaterial, int aCapacity, int aHeatResistance,
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MetaPipeEntity_Fluid(
            mName,
            mThickNess,
            mMaterial,
            mCapacity,
    ...
    public boolean onWrenchRightClick(ForgeDirection side, ForgeDirection wrenchingSide, EntityPlayer entityPlayer,
        ...
        if (GT_Mod.gregtechproxy.gt6Pipe) {
            ...
            MetaPipeEntity_Fluid currentPipe = (MetaPipeEntity_Fluid) currentPipeBase.getMetaTileEntity();
            ...
            if (mode == ToolModes.WRENCH_LINE.get()) {
                ...
                for (int connected = 0; connected < limit; connected++) {
                    ...
                    MetaPipeEntity_Fluid nextPipe = nextPipeBase.getMetaTileEntity() instanceof MetaPipeEntity_Fluid
                        ? (MetaPipeEntity_Fluid) nextPipeBase.getMetaTileEntity()
                        : null;
