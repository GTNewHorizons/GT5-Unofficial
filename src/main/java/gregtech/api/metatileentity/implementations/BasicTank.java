 ...
 */
public abstract class BasicTank extends TieredMachineBlock implements IAddUIWidgets {
     ...
     */
    public BasicTank(int aID, String aName, String aNameRegional, int aTier, int aInvSlotCount, String aDescription,
        ITexture... aTextures) {
    ...
    public BasicTank(String aName, int aTier, int aInvSlotCount, String aDescription, ITexture[][][] aTextures) {
    ...
    public void addUIWidgets(ModularWindow.Builder builder, UIBuildContext buildContext) {
        builder.widget(
            new DrawableWidget().setDrawable(UITextures.PICTURE_SCREEN_BLACK)
                ...
                .setSize(71, 45))
            .widget(
                new DrawableWidget().setDrawable(UITextures.PICTURE_GAUGE)
                    .setPos(79, 34)
                    .setSize(18, 18))
            .widget(
            ...
            .widget(
                new SlotWidget(inventoryHandler, getOutputSlot()).setAccess(true, false)
                    ...
                    .setPos(79, 52))
            .widget(
                createFluidSlot().setBackground(UITextures.TRANSPARENT)
                    .setPos(58, 41))
            .widget(
