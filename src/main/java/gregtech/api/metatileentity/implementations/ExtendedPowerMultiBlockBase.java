 ...
 */
public abstract class ExtendedPowerMultiBlockBase<T extends EnhancedMultiBlockBase<T>>
    extends EnhancedMultiBlockBase<T> {

    public long lEUt;

    protected ExtendedPowerMultiBlockBase(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    protected ExtendedPowerMultiBlockBase(String aName) {
        super(aName);
    }
