...
public class Hatch_DataAccess extends Hatch implements IAddUIWidgets {

    private int timeout = 4;

    public Hatch_DataAccess(int aID, String aName, String aNameRegional, int aTier) {
        super(
            aID,
            aName,
            aNameRegional,
    ...
    public Hatch_DataAccess(String aName, int aTier, String aDescription, ITexture[][][] aTextures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new Hatch_DataAccess(mName, mTier, mDescriptionArray, mTextures);
    }
    ...
    public void addUIWidgets(ModularWindow.Builder builder, UIBuildContext buildContext) {
        if (mTier == 4) {
            getBaseMetaTileEntity()
                .add2by2Slots(builder, getGUITextureSet().getItemSlot(), UITextures.OVERLAY_SLOT_CIRCUIT);
        } else {
            getBaseMetaTileEntity()
                .add4by4Slots(builder, getGUITextureSet().getItemSlot(), UITextures.OVERLAY_SLOT_CIRCUIT);
        }
    }
}
