...
public class MetaPipeEntity_Cable extends MetaPipeEntity implements IMetaTileEntityCable {
    ...
    public MetaPipeEntity_Cable(int aID, String aName, String aNameRegional, float aThickNess, Materials aMaterial,
    ...
    public MetaPipeEntity_Cable(String aName, float aThickNess, Materials aMaterial, long aCableLossPerMeter,
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MetaPipeEntity_Cable(
            mName,
            mThickNess,
            mMaterial,
            mCableLossPerMeter,
