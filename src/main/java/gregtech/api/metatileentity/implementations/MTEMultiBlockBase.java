...
public abstract class MTEMultiBlockBase extends MetaTileEntity
     ...
     * rely on a field being in {@code context} if an error is present in {@code errors}. This method is only called on
     * client.
     *
    ...
    public void getWailaBody(ItemStack itemStack, List<String> currentTip, IWailaDataAccessor accessor,
        ...
        if (tag.getBoolean("isLockedToRecipe")) {
            ...
            if (!lockedRecipe.isEmpty()) {
                ...
                currentTip.add(StatCollector.translateToLocalFormatted("GT5U.waila.multiblock.status.locked_recipe"));
