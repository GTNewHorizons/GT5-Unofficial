...
public abstract class MTEMultiBlockBase extends MetaTileEntity
    ...
    protected void validateStructureImpl() {
        ...
        mStructureErrorData = new NBTTagCompound();

        // intentionally not predicated on checkMachine
        validateStructure(mStructureErrors, mStructureErrorData);
     ...
     * @param data   Generic data blob that is synced with the client.
     */
