...
public class MetaPipeEntity_Item extends MetaPipeEntity implements IMetaTileEntityItemPipe {
    ...
    public MetaPipeEntity_Item(int aID, String aName, String aNameRegional, float aThickNess, Materials aMaterial,
    ...
    public MetaPipeEntity_Item(String aName, float aThickNess, Materials aMaterial, int aInvSlotCount, int aStepSize,
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MetaPipeEntity_Item(
            mName,
            mThickNess,
            mMaterial,
            mInventory.length,
