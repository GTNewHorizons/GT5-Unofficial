...
public class Hatch_Magnet extends Hatch {

    public Hatch_Magnet(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional, 5, 1, "Holds electromagnet for the Magnetic Flux Exhibitor");
    }

    public Hatch_Magnet(String aName, int aTier, String[] aDescription, ITexture[][][] aTextures) {
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new Hatch_Magnet(mName, mTier, mDescriptionArray, mTextures);
    }
}
