...
public class Hatch_Input extends Hatch {

    public RecipeMap<?> mRecipeMap = null;

    public Hatch_Input(int aID, String aName, String aNameRegional, int aTier) {
        this(
            aID,
            aName,
            aNameRegional,
    ...
    public Hatch_Input(int aID, String aName, String aNameRegional, int aTier, String[] aDescription) {
        this(aID, 3, aName, aNameRegional, aTier, aDescription);
    }

    public Hatch_Input(int aID, int aSlot, String aName, String aNameRegional, int aTier) {
        this(
            aID,
            aSlot,
            aName,
    ...
    public Hatch_Input(int aID, int aSlot, String aName, String aNameRegional, int aTier, String[] aDescription) {
        super(aID, aName, aNameRegional, aTier, aSlot, aDescription);
    }

    public Hatch_Input(int aID, String aName, String aNameRegional, int aTier, int allSlotCount, String[] strings) {
    ...
    public Hatch_Input(String aName, int aTier, String aDescription, ITexture[][][] aTextures) {
    ...
    public Hatch_Input(String aName, int aSlots, int aTier, String[] aDescription, ITexture[][][] aTextures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new Hatch_Input(mName, mTier, mDescriptionArray, mTextures);
    }
