 ...
 * Machine
 */
public class MetaTileEntity_Transformer extends TieredMachineBlock {

    public MetaTileEntity_Transformer(int aID, String aName, String aNameRegional, int aTier, String aDescription) {
        super(aID, aName, aNameRegional, aTier, 0, aDescription);
    }

    public MetaTileEntity_Transformer(String aName, int aTier, String aDescription, ITexture[][][] aTextures) {
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MetaTileEntity_Transformer(mName, mTier, mDescriptionArray, mTextures);
    }
