...
public class Hatch_OutputBus extends Hatch implements IAddUIWidgets, IItemLockable {
    ...
    public Hatch_OutputBus(int aID, String aName, String aNameRegional, int aTier) {
        this(aID, aName, aNameRegional, aTier, getSlots(aTier));
    }

    public Hatch_OutputBus(int id, String name, String nameRegional, int tier, int slots) {
        super(
            id,
            name,
            nameRegional,
    ...
    public Hatch_OutputBus(int aID, String aName, String aNameRegional, int aTier, String[] aDescription) {
    ...
    public Hatch_OutputBus(String aName, int aTier, String[] aDescription, ITexture[][][] aTextures) {
        super(aName, aTier, getSlots(aTier), aDescription, aTextures);
    }

    public Hatch_OutputBus(String name, int tier, int slots, String[] description, ITexture[][][] textures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new Hatch_OutputBus(mName, mTier, mDescriptionArray, mTextures);
    }
