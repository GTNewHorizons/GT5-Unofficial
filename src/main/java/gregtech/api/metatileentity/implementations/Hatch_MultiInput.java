...
public class Hatch_MultiInput extends Hatch_Input implements IAddUIWidgets {

    private final FluidStack[] mStoredFluid;
    private final FluidStackTank[] fluidTanks;
    public final int mCapacityPer;

    public Hatch_MultiInput(int aID, int aSlot, String aName, String aNameRegional, int aTier) {
    ...
    public Hatch_MultiInput(int aID, int aSlot, String aName, String aNameRegional, int aTier, String[] aDescription) {
    ...
    public Hatch_MultiInput(String aName, int aSlot, int aTier, String[] aDescription, ITexture[][][] aTextures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new Hatch_MultiInput(mName, getMaxType(), mTier, mDescriptionArray, mTextures);
    }
