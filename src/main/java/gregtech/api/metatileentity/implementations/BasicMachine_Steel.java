 ...
 * Machine
 */
public abstract class BasicMachine_Steel extends BasicMachine_Bronze implements IGetTitleColor {

    public BasicMachine_Steel(int aID, String aName, String aNameRegional, String aDescription, int aInputSlotCount,
    ...
    public BasicMachine_Steel(String aName, String[] aDescription, ITexture[][][] aTextures, int aInputSlotCount,
        int aOutputSlotCount, boolean aHighPressure) {
