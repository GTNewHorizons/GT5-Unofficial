...
public class Hatch_WirelessEnergy extends Hatch_Energy implements IWirelessEnergyHatchInformation {
    ...
    public Hatch_WirelessEnergy(String aName, byte aTier, String[] aDescription, ITexture[][][] aTextures) {
        super(aName, aTier, 0, aDescription, aTextures);
    }

    public Hatch_WirelessEnergy(int aID, String aName, String aNameRegional, int aTier) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new Hatch_WirelessEnergy(mName, mTier, new String[] { "" }, mTextures);
    }
