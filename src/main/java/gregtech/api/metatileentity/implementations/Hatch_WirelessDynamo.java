...
public class Hatch_WirelessDynamo extends Hatch_Dynamo implements IWirelessEnergyHatchInformation {

    private UUID owner_uuid;

    public Hatch_WirelessDynamo(String aName, byte aTier, String[] aDescription, ITexture[][][] aTextures) {
        super(aName, aTier, aDescription, aTextures);
    }

    public Hatch_WirelessDynamo(int aID, String aName, String aNameRegional, int aTier) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new Hatch_WirelessDynamo(mName, mTier, new String[] { "" }, mTextures);
    }
