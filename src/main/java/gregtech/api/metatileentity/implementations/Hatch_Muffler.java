...
public class Hatch_Muffler extends Hatch {
    ...
    public Hatch_Muffler(int aID, String aName, String aNameRegional, int aTier) {
        super(aID, aName, aNameRegional, aTier, 0, "");
    }

    public Hatch_Muffler(int aID, String aName, String aNameRegional, int aTier, int aInvSlotCount,
        String[] aDescription, ITexture... aTextures) {
        super(aID, aName, aNameRegional, aTier, aInvSlotCount, aDescription, aTextures);
    }

    public Hatch_Muffler(String aName, int aTier, String aDescription, ITexture[][][] aTextures) {
    ...
    public Hatch_Muffler(String aName, int aTier, int aInvSlotCount, String[] aDescription, ITexture[][][] aTextures) {
