 ...
 * Machine
 */
public class BasicMachine_Recipe extends BasicMachine {
     ...
     */
    public BasicMachine_Recipe(int aID, String aName, String aNameRegional, int aTier, String aDescription,
     ...
     */
    public BasicMachine_Recipe(String aName, int aTier, String[] aDescription, RecipeMap<?> aRecipes, int aInputSlots,
        int aOutputSlots, int aTankCapacity, int aAmperage, ITexture[][][] aTextures, ResourceLocation aSound,
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new BasicMachine_Recipe(
            this.mName,
            this.mTier,
    ...
    public BasicMachine_Recipe setProgressBarTexture(FallbackableUITexture progressBarTexture) {
        this.progressBarTexture = progressBarTexture;
        return this;
    }

    public BasicMachine_Recipe setProgressBarTextureName(String name, UITexture fallback) {
        return setProgressBarTexture(UITextures.fallbackableProgressbar(name, fallback));
    }

    public BasicMachine_Recipe setProgressBarTextureName(String name) {
        return setProgressBarTextureName(name, UITextures.PROGRESSBAR_ARROW);
    }
    ...
    public BasicMachine_Recipe setRecipeCatalystPriority(int recipeCatalystPriority) {
