...
public abstract class MultiBlockBase extends MetaTileEntity
    ...
    public ArrayList<Hatch_Input> mInputHatches = new ArrayList<>();
    public ArrayList<Hatch_Output> mOutputHatches = new ArrayList<>();
    public ArrayList<Hatch_InputBus> mInputBusses = new ArrayList<>();
    public ArrayList<Hatch_OutputBus> mOutputBusses = new ArrayList<>();
    ...
    public ArrayList<Hatch_Dynamo> mDynamoHatches = new ArrayList<>();
    public ArrayList<Hatch_Muffler> mMufflerHatches = new ArrayList<>();
    public ArrayList<Hatch_Energy> mEnergyHatches = new ArrayList<>();
    public ArrayList<Hatch_Maintenance> mMaintenanceHatches = new ArrayList<>();
    ...
    public MultiBlockBase(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional, 2);
        this.processingLogic = null;
        MultiBlockBase.disableMaintenance = GregTech_API.sMachineFile
    ...
    public MultiBlockBase(String aName) {
        super(aName, 2);
    ...
    public void checkMaintenance() {
        ...
        if (broken) {
            for (Hatch_Maintenance tHatch : filterValidMTEs(mMaintenanceHatches)) {
    ...
    protected CheckRecipeResult doCheckRecipe() {
        ...
        if (isInputSeparationEnabled()) {
            if (mInputBusses.isEmpty()) {
                ...
                for (Hatch_InputBus bus : mInputBusses) {
    ...
    public long getMaxInputVoltage() {
        long rVoltage = 0;
        for (Hatch_Energy tHatch : filterValidMTEs(mEnergyHatches)) rVoltage += tHatch.getBaseMetaTileEntity()
            .getInputVoltage();
        return rVoltage;
    }
    ...
    protected static boolean dumpFluid(List<Hatch_Output> aOutputHatches, FluidStack copiedFluidStack,
        boolean restrictiveHatchesOnly) {
        for (Hatch_Output tHatch : filterValidMTEs(aOutputHatches)) {
    ...
    public boolean addOutput(ItemStack aStack) {
        ...
        final List<Hatch_OutputBus> filteredBuses = filterValidMTEs(mOutputBusses);
    ...
    private boolean dumpItem(List<Hatch_OutputBus> outputBuses, ItemStack itemStack, boolean restrictiveBusesOnly) {
        for (Hatch_OutputBus outputBus : outputBuses) {
    ...
    public boolean depleteInput(ItemStack aStack) {
        ...
        for (Hatch_InputBus tHatch : filterValidMTEs(mInputBusses)) {
    ...
    public ArrayList<FluidStack> getStoredFluids() {
        ...
        for (Hatch_Input tHatch : filterValidMTEs(mInputHatches)) {
            setHatchRecipeMap(tHatch);
            if (tHatch instanceof Hatch_MultiInput multiInputHatch) {
     ...
     */
    public boolean drain(Hatch hatch, FluidStack fluid, boolean doDrain) {
        ...
        if (hatch instanceof Hatch_Input tHatch && tHatch.isValid()) {
    ...
    public void updateSlots() {
        ...
        for (Hatch_InputBus tHatch : filterValidMTEs(mInputBusses)) tHatch.updateSlots();
    }

    protected void startRecipeProcessing() {
        for (Hatch_InputBus hatch : filterValidMTEs(mInputBusses)) {
            if (hatch instanceof IRecipeProcessingAwareHatch aware) {
                aware.startRecipeProcessing();
            }
        }
        for (Hatch_Input hatch : filterValidMTEs(mInputHatches)) {
            if (hatch instanceof IRecipeProcessingAwareHatch aware) {
                aware.startRecipeProcessing();
            }
        }
    ...
    public boolean addToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        if (aMetaTileEntity instanceof Hatch_Input) {
            setHatchRecipeMap((Hatch_Input) aMetaTileEntity);
            return mInputHatches.add((Hatch_Input) aMetaTileEntity);
        }
        if (aMetaTileEntity instanceof Hatch_InputBus) {
            ((Hatch_InputBus) aMetaTileEntity).mRecipeMap = getRecipeMap();
            return mInputBusses.add((Hatch_InputBus) aMetaTileEntity);
        }
        if (aMetaTileEntity instanceof Hatch_Output) return mOutputHatches.add((Hatch_Output) aMetaTileEntity);
        if (aMetaTileEntity instanceof Hatch_OutputBus) return mOutputBusses.add((Hatch_OutputBus) aMetaTileEntity);
        if (aMetaTileEntity instanceof Hatch_Energy) return mEnergyHatches.add((Hatch_Energy) aMetaTileEntity);
        if (aMetaTileEntity instanceof Hatch_Dynamo) return mDynamoHatches.add((Hatch_Dynamo) aMetaTileEntity);
        if (aMetaTileEntity instanceof Hatch_Maintenance)
            return mMaintenanceHatches.add((Hatch_Maintenance) aMetaTileEntity);
        if (aMetaTileEntity instanceof Hatch_Muffler) return mMufflerHatches.add((Hatch_Muffler) aMetaTileEntity);
        return false;
    }
    ...
    public boolean addMaintenanceToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        IMetaTileEntity aMetaTileEntity = aTileEntity.getMetaTileEntity();
        if (aMetaTileEntity == null) return false;
        if (aMetaTileEntity instanceof Hatch_Maintenance hatch) {
            hatch.updateTexture(aBaseCasingIndex);
            hatch.updateCraftingIcon(this.getMachineCraftingIcon());
    ...
    public boolean addEnergyInputToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        IMetaTileEntity aMetaTileEntity = aTileEntity.getMetaTileEntity();
        if (aMetaTileEntity == null) return false;
        if (aMetaTileEntity instanceof Hatch_Energy hatch) {
            hatch.updateTexture(aBaseCasingIndex);
            hatch.updateCraftingIcon(this.getMachineCraftingIcon());
    ...
    public boolean addExoticEnergyInputToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        IMetaTileEntity aMetaTileEntity = aTileEntity.getMetaTileEntity();
        if (aMetaTileEntity == null) return false;
        if (aMetaTileEntity instanceof Hatch hatch && ExoticEnergyInputHelper.isExoticEnergyInput(aMetaTileEntity)) {
            hatch.updateTexture(aBaseCasingIndex);
            hatch.updateCraftingIcon(this.getMachineCraftingIcon());
    ...
    public boolean addDynamoToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        IMetaTileEntity aMetaTileEntity = aTileEntity.getMetaTileEntity();
        if (aMetaTileEntity == null) return false;
        if (aMetaTileEntity instanceof Hatch_Dynamo hatch) {
            hatch.updateTexture(aBaseCasingIndex);
            hatch.updateCraftingIcon(this.getMachineCraftingIcon());
    ...
    public boolean addMufflerToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        IMetaTileEntity aMetaTileEntity = aTileEntity.getMetaTileEntity();
        if (aMetaTileEntity == null) return false;
        if (aMetaTileEntity instanceof Hatch_Muffler hatch) {
            hatch.updateTexture(aBaseCasingIndex);
            hatch.updateCraftingIcon(this.getMachineCraftingIcon());
    ...
    public boolean addInputBusToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        if (aMetaTileEntity instanceof Hatch_InputBus hatch) {
            hatch.updateTexture(aBaseCasingIndex);
            hatch.updateCraftingIcon(this.getMachineCraftingIcon());
    ...
    public boolean addOutputBusToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        IMetaTileEntity aMetaTileEntity = aTileEntity.getMetaTileEntity();
        if (aMetaTileEntity == null) return false;
        if (aMetaTileEntity instanceof Hatch_OutputBus hatch) {
            hatch.updateTexture(aBaseCasingIndex);
            hatch.updateCraftingIcon(this.getMachineCraftingIcon());
    ...
    public boolean addInputHatchToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        if (aMetaTileEntity instanceof Hatch_Input hatch) {
            hatch.updateTexture(aBaseCasingIndex);
            hatch.updateCraftingIcon(this.getMachineCraftingIcon());
    ...
    public boolean addOutputHatchToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        IMetaTileEntity aMetaTileEntity = aTileEntity.getMetaTileEntity();
        if (aMetaTileEntity == null) return false;
        if (aMetaTileEntity instanceof Hatch_Output hatch) {
            hatch.updateTexture(aBaseCasingIndex);
            hatch.updateCraftingIcon(this.getMachineCraftingIcon());
    ...
    public List<Hatch> getExoticEnergyHatches() {
    ...
    public List<ItemStack> getItemOutputSlots(ItemStack[] toOutput) {
        ...
        for (final Hatch tBus : filterValidMTEs(mOutputBusses)) {
     ...
     */
    protected <T extends Hatch_Output> List<? extends IFluidStore> getFluidOutputSlotsByLayer(FluidStack[] toOutput,
        ...
        for (int i = 0; i < toOutput.length; i++) {
            ...
            for (Hatch_Output hatch : hatchesByLayer.get(i)) {
    ...
    public boolean canDumpItemToME() {
        for (Hatch tHatch : filterValidMTEs(mOutputBusses)) {
    ...
    public void setMachineModeIcons() {
        machineModeIcons.add(UITextures.OVERLAY_BUTTON_MACHINEMODE_DEFAULT);
        machineModeIcons.add(UITextures.OVERLAY_BUTTON_MACHINEMODE_DEFAULT);
    }
    ...
    public void addUIWidgets(ModularWindow.Builder builder, UIBuildContext buildContext) {
        ...
        builder.widget(
            inventorySlot.setPos(173, 167)
                .setBackground(UITextures.SLOT_DARK_GRAY));
    ...
    @TestOnly
    protected void setEnergyHatches(ArrayList<Hatch_Energy> EnergyHatches) {
        this.mEnergyHatches = EnergyHatches;
    }

    @TestOnly
    protected void setExoticEnergyHatches(List<Hatch> ExoticEnergyHatches) {
