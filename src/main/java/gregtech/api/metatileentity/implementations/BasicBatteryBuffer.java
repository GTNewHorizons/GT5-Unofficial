 ...
 * Machine
 */
public class BasicBatteryBuffer extends TieredMachineBlock implements IAddUIWidgets {
    ...
    public BasicBatteryBuffer(int aID, String aName, String aNameRegional, int aTier, String aDescription,
        int aSlotCount) {
        super(aID, aName, aNameRegional, aTier, aSlotCount, aDescription);
    }

    public BasicBatteryBuffer(String aName, int aTier, String aDescription, ITexture[][][] aTextures, int aSlotCount) {
        super(aName, aTier, aSlotCount, aDescription, aTextures);
    }

    public BasicBatteryBuffer(String aName, int aTier, String[] aDescription, ITexture[][][] aTextures,
        int aSlotCount) {
        super(aName, aTier, aSlotCount, aDescription, aTextures);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new BasicBatteryBuffer(mName, mTier, mDescriptionArray, mTextures, mInventory.length);
    }
