...
public class GT_MetaTileEntity_BasicBatteryBuffer extends GT_MetaTileEntity_TieredMachineBlock
    ...
    public void addUIWidgets(ModularWindow.Builder builder, UIBuildContext buildContext) {
        switch (mInventory.length) {
            case 4 -> builder.widget(SlotGroup.ofItemHandler(inventoryHandler, 2).startFromSlot(0).endAtSlot(3)
            ...
            case 9 -> builder.widget(SlotGroup.ofItemHandler(inventoryHandler, 3).startFromSlot(0).endAtSlot(8)
                    .slotCreator(index -> new BaseSlot(inventoryHandler, index) {
            ...
            case 16 -> builder.widget(SlotGroup.ofItemHandler(inventoryHandler, 4).startFromSlot(0).endAtSlot(15)
                    .slotCreator(index -> new BaseSlot(inventoryHandler, index) {
            ...
            default -> builder.widget(SlotGroup.ofItemHandler(inventoryHandler, 1).startFromSlot(0).endAtSlot(0)
                    .slotCreator(index -> new BaseSlot(inventoryHandler, index) {
