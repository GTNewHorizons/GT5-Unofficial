...
public abstract class BasicGenerator extends BasicTank implements RecipeMapWorkable {

    public BasicGenerator(int aID, String aName, String aNameRegional, int aTier, String aDescription,
        ITexture... aTextures) {
    ...
    public BasicGenerator(String aName, int aTier, String aDescription, ITexture[][][] aTextures) {
    ...
    public boolean solidFuelOverride(ItemStack stack) {
        ...
        ItemData association = OreDictUnificator.getAssociation(stack);
