...
public abstract class TieredMachineBlock extends MetaTileEntity {
    ...
    public TieredMachineBlock(int aID, String aName, String aNameRegional, int aTier, int aInvSlotCount,
    ...
    public TieredMachineBlock(String aName, int aTier, int aInvSlotCount, String aDescription,
        ITexture[][][] aTextures) {
    ...
    protected SlotWidget createChargerSlot(int x, int y, String tooltipKey, Object[] tooltipArgs) {
        return (SlotWidget) new SlotWidget(inventoryHandler, rechargerSlotStartIndex()).disableShiftInsert()
            ...
            .setBackground(getGUITextureSet().getItemSlot(), UITextures.OVERLAY_SLOT_CHARGER)
            .setPos(x, y);
    }
}
