...
public abstract class Buffer extends TieredMachineBlock implements IAddUIWidgets {
    ...
    public Buffer(int aID, String aName, String aNameRegional, int aTier, int aInvSlotCount, String aDescription) {
    ...
    public Buffer(String aName, int aTier, int aInvSlotCount, String aDescription, ITexture[][][] aTextures) {
    ...
    protected void addEmitEnergyButton(ModularWindow.Builder builder) {
        builder.widget(
            createToggleButton(
                () -> bOutput,
                val -> bOutput = val,
                UITextures.OVERLAY_BUTTON_EMIT_ENERGY,
    ...
    protected void addEmitRedstoneIfFullButton(ModularWindow.Builder builder) {
        builder.widget(
            createToggleButton(
                ...
                UITextures.OVERLAY_BUTTON_EMIT_REDSTONE,
    ...
    protected void addInvertRedstoneButton(ModularWindow.Builder builder) {
        builder.widget(
            createToggleButton(
                () -> bInvert,
                val -> bInvert = val,
                UITextures.OVERLAY_BUTTON_INVERT_REDSTONE,
    ...
    protected void addStockingModeButton(ModularWindow.Builder builder) {
        builder.widget(
            createToggleButton(
                ...
                UITextures.OVERLAY_BUTTON_STOCKING_MODE,
    ...
    protected void addSortStacksButton(ModularWindow.Builder builder) {
        builder.widget(
            createToggleButton(
                () -> bSortStacks,
                val -> bSortStacks = val,
                UITextures.OVERLAY_BUTTON_SORTING_MODE,
