...
/**
 * Enhanced multiblock base class, featuring following improvement over {@link MultiBlockBase}
 * <p>
 ...
 */
public abstract class EnhancedMultiBlockBase<T extends EnhancedMultiBlockBase<T>> extends TooltipMultiBlockBase
    implements IAlignment, IConstructable {

    private ExtendedFacing mExtendedFacing = ExtendedFacing.DEFAULT;
    private IAlignmentLimits mLimits = getInitialAlignmentLimits();

    protected EnhancedMultiBlockBase(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    protected EnhancedMultiBlockBase(String aName) {
        super(aName);
    }
