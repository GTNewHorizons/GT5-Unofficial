 ...
 */
public abstract class Hatch extends BasicTank implements ICraftingIconProvider {
    ...
    public Hatch(int aID, String aName, String aNameRegional, int aTier, int aInvSlotCount, String aDescription,
        ITexture... aTextures) {
    ...
    public Hatch(String aName, int aTier, int aInvSlotCount, String aDescription, ITexture[][][] aTextures) {
