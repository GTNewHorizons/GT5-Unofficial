...
public class Hatch_Output extends Hatch implements IFluidStore, IFluidLockable, IAddUIWidgets {

    private String lockedFluidName = null;
    private WeakReference<EntityPlayer> playerThatLockedfluid = null;
    public byte mMode = 0;

    public Hatch_Output(int aID, String aName, String aNameRegional, int aTier) {
        super(
            aID,
            aName,
            aNameRegional,
    ...
    public Hatch_Output(String aName, int aTier, String aDescription, ITexture[][][] aTextures) {
    ...
    public Hatch_Output(int aID, String aName, String aNameRegional, int aTier, String[] aDescription,
        int inventorySize) {
        super(aID, aName, aNameRegional, aTier, inventorySize, aDescription);
    }

    public Hatch_Output(String name, int tier, int slots, String[] description, ITexture[][][] textures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new Hatch_Output(mName, mTier, mDescriptionArray, mTextures);
    }
