                    ...
                    EnumChatFormatting.WHITE + "  Steam "
                        ...
                        + String.format(
                            ...
                            "" + EnumChatFormatting.GOLD
                                + formatNumbers(GT_Utility.safeInt((long) (turbine.getOptimalSteamFlow())))
                                + EnumChatFormatting.GRAY,
                            "" + EnumChatFormatting.DARK_GREEN
                                + formatNumbers(GT_Utility.safeInt((long) (turbine.getOptimalSteamEUt())))
                                + EnumChatFormatting.GRAY,
                ...
                aList.add(
                    ...
                    EnumChatFormatting.WHITE + "  Loose "
                        ...
                        + String.format(
                            "%s L/t > %s EU/t | %s",
                            "" + EnumChatFormatting.GOLD
                                + formatNumbers(GT_Utility.safeInt((long) (turbine.getOptimalLooseSteamFlow())))
                                + EnumChatFormatting.GRAY,
                            "" + EnumChatFormatting.DARK_GREEN
                                + formatNumbers(GT_Utility.safeInt((long) (turbine.getOptimalLooseSteamEUt())))
                                + EnumChatFormatting.GRAY,
                            "" + EnumChatFormatting.BLUE
                ...
                aList.add(
                    ...
                    EnumChatFormatting.AQUA + "  Gas "
                        ...
                        + String.format(
                            "%s EU/t > %s EU/t | %s",
                            "" + EnumChatFormatting.GOLD
                                + formatNumbers(GT_Utility.safeInt((long) (turbine.getOptimalGasFlow())))
                                + EnumChatFormatting.GRAY,
                            "" + EnumChatFormatting.DARK_GREEN
                                + formatNumbers(GT_Utility.safeInt((long) (turbine.getOptimalGasEUt())))
                                + EnumChatFormatting.GRAY,
                            "" + EnumChatFormatting.BLUE
                ...
                aList.add(
                    ...
                    EnumChatFormatting.AQUA + "  Loose "
                        ...
                        + String.format(
                            "%s EU/t > %s EU/t | %s",
                            "" + EnumChatFormatting.GOLD
                                + formatNumbers(GT_Utility.safeInt((long) (turbine.getOptimalLooseGasFlow())))
                                + EnumChatFormatting.GRAY,
                            "" + EnumChatFormatting.DARK_GREEN
                                + formatNumbers(GT_Utility.safeInt((long) (turbine.getOptimalLooseGasEUt())))
                                + EnumChatFormatting.GRAY,
                            "" + EnumChatFormatting.BLUE
                ...
                aList.add(
                    ...
                    EnumChatFormatting.LIGHT_PURPLE + "  Plasma"
                        ...
                        + String.format(
                            "%s EU/t > %s EU/t | %s",
                            "" + EnumChatFormatting.GOLD
                                + formatNumbers(GT_Utility.safeInt((long) (turbine.getOptimalPlasmaFlow())))
                                + EnumChatFormatting.GRAY,
                            "" + EnumChatFormatting.DARK_GREEN
                                + formatNumbers(GT_Utility.safeInt((long) (turbine.getOptimalPlasmaEUt())))
                                + EnumChatFormatting.GRAY,
                            "" + EnumChatFormatting.BLUE
                ...
                aList.add(
                    ...
                    EnumChatFormatting.LIGHT_PURPLE + "  Loose"
                        ...
                        + String.format(
                            "%s EU/t > %s EU/t | %s",
                            "" + EnumChatFormatting.GOLD
                                + formatNumbers(GT_Utility.safeInt((long) (turbine.getOptimalLoosePlasmaFlow())))
                                + EnumChatFormatting.GRAY,
                            "" + EnumChatFormatting.DARK_GREEN
                                + formatNumbers(GT_Utility.safeInt((long) (turbine.getOptimalLoosePlasmaEUt())))
                                + EnumChatFormatting.GRAY,
                            "" + EnumChatFormatting.BLUE
