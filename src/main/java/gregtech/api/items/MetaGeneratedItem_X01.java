 ...
 *         Item.
 */
public abstract class MetaGeneratedItem_X01 extends MetaGeneratedItem {
     ...
     */
    public MetaGeneratedItem_X01(String aUnlocalized, OrePrefixes aGeneratedPrefix, int aIconSetIndex) {
        ...
        for (int i = 0; i < GregTech_API.sGeneratedMaterials.length; i++) {
            ...
            if (mPrefix.doGenerateItem(tMaterial)) {
                ...
                if (tPrefix != null && tPrefix.mIsUnificatable) {
                    OreDictUnificator.set(tPrefix, OrePrefixes.getMaterial(tOreName, tPrefix), tStack);
                } else {
                    OreDictUnificator.registerOre(tOreName, tStack);
                }
            }
        }
    }
