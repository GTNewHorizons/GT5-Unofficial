 ...
 */
public class ItemGeneric extends Item implements IProjectileItem {

    private final String mName, mTooltip;
    protected IIcon mIcon;

    public ItemGeneric(String aUnlocalized, String aEnglish, String aEnglishTooltip) {
        super();
    ...
    public static class GT_Item_Dispense extends BehaviorProjectileDispense {
        ...
        public ItemStack dispenseStack(IBlockSource aSource, ItemStack aStack) {
            return ((ItemGeneric) aStack.getItem()).onDispense(aSource, aStack);
        }
