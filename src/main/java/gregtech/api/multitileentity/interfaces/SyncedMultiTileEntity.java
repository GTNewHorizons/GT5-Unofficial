...
public interface SyncedMultiTileEntity {
     ...
     */
    void getFullPacketData(Packet_MultiTileEntity packet);
     ...
     * @param packet The packet which will be sent
     */
    void getTimedPacketData(Packet_MultiTileEntity packet);
     ...
     * @param packet The packet which will be sent
     */
    void getGraphicPacketData(Packet_MultiTileEntity packet);
}
