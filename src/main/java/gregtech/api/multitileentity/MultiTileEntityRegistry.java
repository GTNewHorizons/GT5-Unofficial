...
public class MultiTileEntityRegistry {
    ...
    public ItemStack add(
        ...
        return add(
                aLocalised,
                aCategoricalName,
                new MultiTileEntityClassContainer(aID, aClass, aBlockMetaData, aStackSize, aBlock, aParameters),
                aRecipe);
    }
    ...
    public ItemStack add(
            String aLocalised,
            String aCategoricalName,
            MultiTileEntityClassContainer aClassContainer,
            Object... aRecipe) {
        ...
        if (sRegisteredTileEntities.add(aClassContainer.mCanonicalTileEntity.getClass())) {
            if (aClassContainer.mCanonicalTileEntity instanceof IMultiTileEntity)
                ((IMultiTileEntity) aClassContainer.mCanonicalTileEntity)
