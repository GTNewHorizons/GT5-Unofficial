                                ...
                                .getItemHandler() == fluidInputsInventory) {
                                    ...
                                    if (inputs.length > i && inputs[i] != null && inputs[i].getFluid() != null) {
                                        mInputs.add(
                                            new FixedPositionedStack(
                                                this,
                                                uiProperties.fluidDisplayFactory
                                                    .getFluidDisplay(inputs[i], FluidDisplayStackMode.SHOWN),
                                                GTNEIDefaultHandler.this.neiProperties.renderRealStackSizes,
                                                widget.getPos().x + 1,
                                                widget.getPos().y + 1,
                                        ...
                                        if (outputs.length > i && outputs[i] != null && outputs[i].getFluid() != null) {
                                            mOutputs.add(
                                                new FixedPositionedStack(
                                                    this,
                                                    uiProperties.fluidDisplayFactory
                                                        .getFluidDisplay(outputs[i], FluidDisplayStackMode.SHOWN),
                                                    GTNEIDefaultHandler.this.neiProperties.renderRealStackSizes,
                                                    widget.getPos().x + 1,
                                                    widget.getPos().y + 1,
                ...
                if (i >= GTNEIDefaultHandler.this.uiProperties.maxFluidInputs && aRecipe.mFluidInputs[i] != null
                    ...
                    mInputs.add(
                        new FixedPositionedStack(
                            this,
                            uiProperties.fluidDisplayFactory
                                .getFluidDisplay(aRecipe.mFluidInputs[i], FluidDisplayStackMode.SHOWN),
                            GTNEIDefaultHandler.this.neiProperties.renderRealStackSizes,
                            pos.x + 1,
                            pos.y + 1,
                            aRecipe.getFluidInputChance(i),
                ...
                if (i >= GTNEIDefaultHandler.this.uiProperties.maxFluidOutputs && aRecipe.mFluidOutputs[i] != null
                    ...
                    mOutputs.add(
                        new FixedPositionedStack(
                            this,
                            uiProperties.fluidDisplayFactory
                                .getFluidDisplay(aRecipe.mFluidOutputs[i], FluidDisplayStackMode.SHOWN),
                            GTNEIDefaultHandler.this.neiProperties.renderRealStackSizes,
                            pos.x + 1,
                            pos.y + 1,
                            aRecipe.getFluidOutputChance(i),
