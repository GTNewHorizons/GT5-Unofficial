...
public final class ConsumerGem {
    ...
    static void register() {
        ...
        ShapeConsumerSupport.delegate(Materials2Shapes.shapeGemChipped, OrePrefixes.gemChipped, ProcessingGem.INSTANCE);
        ShapeConsumerSupport
            .delegate(Materials2Shapes.shapeGemExquisite, OrePrefixes.gemExquisite, ProcessingGem.INSTANCE);
        ShapeConsumerSupport.delegate(Materials2Shapes.shapeGemFlawed, OrePrefixes.gemFlawed, ProcessingGem.INSTANCE);
        ShapeConsumerSupport
