...
/// shape via [MU#shapes]. Every candidate shape of a matching prefix is delegated, so the fluid and item pipe
...
/// `plate` internally) has no MaterialLib shape and is skipped like every other prefix [MU#shapes] does not
/// resolve.
