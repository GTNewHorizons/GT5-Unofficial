...
/// [Materials2CellShapes#cellPlasmaLight] for materials with no molten fluid (see [MaterialParts]'s javadoc on its
...
public final class ConsumerRecycling {
    ...
    static void register() {
        ...
        ShapeConsumerSupport
            .delegate(Materials2CellShapes.cellPlasmaLight, OrePrefixes.cellPlasma, () -> ProcessingRecycling.INSTANCE);
    }
}
