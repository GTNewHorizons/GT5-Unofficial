...
public class MaterialsInit1 {
    ...
    private static Materials loadPreActivatedCarbon() {
        return new MaterialBuilder(564, TextureSet.SET_DULL, "Pre-Activated Carbon")
            .addDustItems()
            .setRGB(15, 51, 65)
    ...
    private static Materials loadDirtyActivatedCarbon() {
        return new MaterialBuilder(565, TextureSet.SET_DULL, "Dirty Activated Carbon")
            .addDustItems()
            .setRGB(110, 110, 110)
    ...
    private static Materials loadPolyAluminiumChloride() {
        return new MaterialBuilder(566, TextureSet.SET_FLUID, "Polyaluminium Chloride")
            .addFluid()
            .addCell()
            .setRGB(252, 236, 5)
    ...
    private static Materials loadOzone() {
        return new MaterialBuilder(568, TextureSet.SET_FLUID, "Ozone")
            .addGas()
            .addCell()
            .setRGB(190, 244, 250)
            .setName("Ozone")
