...
public class MaterialsInit1 {
    ...
    private static Materials loadNetherAir() {
        return new MaterialBuilder(118, TextureSet.SET_FLUID, "Nether Air")
            .addFluid()
            .addCell()
            .setRGB(238, 163, 154)
            .setName("netherair")
    ...
    private static Materials loadNethersemifluid() {
        return new MaterialBuilder(119, TextureSet.SET_FLUID, "Nether Semi-Fluid")
            .addFluid()
            .addCell()
            .setRGB(218, 193, 114)
    ...
    private static Materials loadNefariousGas() {
        return new MaterialBuilder(120, TextureSet.SET_FLUID, "Nefarious Gas")
            .addFluid()
            .addCell()
            .setRGB(48, 10, 5)
    ...
    private static Materials loadNefariousOil() {
        return new MaterialBuilder(122, TextureSet.SET_FLUID, "Nefarious Oil")
            .addFluid()
            .addCell()
            .setRGB(57, 22, 22)
    ...
    private static Materials loadPoorNetherWaste() {
        return new MaterialBuilder(123, TextureSet.SET_FLUID, "Poor Nether Waste")
            .addFluid()
            .addCell()
            .setRGB(160, 130, 126)
    ...
    private static Materials loadRichNetherWaste() {
        return new MaterialBuilder(124, TextureSet.SET_FLUID, "Rich Nether Waste")
            .addFluid()
            .addCell()
            .setRGB(2490, 130, 126)
    ...
    private static Materials loadActivatedNetherite() {
        return new MaterialBuilder(133, TextureSet.SET_METALLIC, "Activated Netherite")
            .addFluid()
            .addCell()
            .setRGB(156, 87, 90)
