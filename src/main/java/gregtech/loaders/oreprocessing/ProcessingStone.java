        ...
        switch (aMaterial.mName) {
            case "NULL":
                GTValues.RA.stdBuilder()
                        ...
                        .fluidInputs(Materials.Redstone.getMolten(1 * INGOTS)).duration(5 * SECONDS).eut(48)
                        .addTo(assemblerRecipes);
                break;
            case "Sand":
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                        .itemOutputs(new ItemStack(Blocks.sand, 1, 0)).duration(20 * SECONDS).eut(2)
            ...
            case "Endstone":
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                        ...
                        .outputChances(10000, 500).duration(20 * SECONDS).eut(2).addTo(maceratorRecipes);
                break;
            case "Netherrack":
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                        .itemOutputs(
            ...
            case "NetherBrick":
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack), GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(new ItemStack(Blocks.nether_brick_fence, 1)).duration(5 * SECONDS).eut(4)
                        .addTo(assemblerRecipes);
                break;
            case "Obsidian":
            ...
            case "Concrete":
                ...
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                        ...
                        .duration(5 * SECONDS).eut(TierEU.RECIPE_LV).addTo(cutterRecipes);

                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                        .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, aMaterial, 1L)).duration(20 * SECONDS)
            ...
            case "Rhyolite":
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                        ...
                        .outputChances(10000, 2000).duration(20 * SECONDS).eut(2).addTo(maceratorRecipes);
                break;
            case "Komatiite":
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                        .itemOutputs(
            ...
            case "Marble":
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                        ...
                        .duration(20 * SECONDS).eut(TierEU.RECIPE_LV).addTo(cutterRecipes);
            ...
            case "GraniteBlack":
                ...
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                        ...
                        .outputChances(10000, 100).duration(20 * SECONDS).eut(2).addTo(maceratorRecipes);
                break;
            case "GraniteRed":
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                        .itemOutputs(GTOreDictUnificator.get(OrePrefixes.plate, aMaterial, 1L))
