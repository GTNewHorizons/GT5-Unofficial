    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName,
        ...
        switch (aPrefix) {
            case crushedCentrifuged -> {
                ...
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack)).itemOutputs(
            ...
            case crushedPurified -> {
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack)).itemOutputs(
                        ...
                        GTOreDictUnificator.get(
                                ...
                                1L))
                        .outputChances(10000, 1111).duration(25 * SECONDS).eut(48).addTo(thermalCentrifugeRecipes);
                ...
                switch (aMaterial.mName) {
                    case "Tanzanite", "Sapphire", "Olivine", "GreenSapphire", "Opal", "Amethyst", "Emerald", "Ruby", "Amber", "Diamond", "FoolsRuby", "BlueTopaz", "GarnetRed", "Topaz", "Jasper", "GarnetYellow" -> GTValues.RA
                            .stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                            .itemOutputs(
                            ...
                            .outputChances(300, 1200, 4500, 1400, 2800, 3500).duration(40 * SECONDS).eut(16)
                            .addTo(sifterRecipes);
                    default -> GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                            .itemOutputs(
                                    GTOreDictUnificator.get(OrePrefixes.gemExquisite, aMaterial, tGem, 1L),
                                    GTOreDictUnificator.get(OrePrefixes.gemFlawless, aMaterial, tGem, 1L),
                                    tGem,
                                    ...
                                    GTOreDictUnificator.get(OrePrefixes.gemChipped, aMaterial, tGem, 1L),
                                    GTOreDictUnificator.get(OrePrefixes.dust, aMaterial, tGem, 1L))
                            .outputChances(100, 400, 1500, 2000, 4000, 5000).duration(40 * SECONDS).eut(16)
                            .addTo(sifterRecipes);
                }
