...
public class ProcessingGem implements gregtech.api.interfaces.IOreRecipeRegistrator { // TODO COMPARE WITH GEM???
    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName,
        ...
        switch (aPrefix) {
            case gem -> {
                if (aFuelPower) {
                    GT_Values.RA.addFuel(GT_Utility.copyAmount(1L, aStack),
                            null,
                ...
                if (aNoSmashing) {
                    GT_Values.RA.addForgeHammerRecipe(aStack,
                ...
                if (aNoWorking) {
                    if (aMaterial.getProcessingMaterialTierEU() < TierEU.IV) {
                        GT_Values.RA.addLatheRecipe(GT_Utility.copyAmount(1L, aStack),
                    ...
                    if (aMaterial.mUnificatable && (aMaterial.mMaterialInto == aMaterial)) {
                        GT_ModHandler.addCraftingRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, aMaterial, 2L),
                                GT_Proxy.tBits,
                                new Object[] { "h", "X", 'X', OrePrefixes.gemFlawless.get(aMaterial) });
                        GT_Values.RA.addImplosionRecipe(GT_Utility.copyAmount(3L, aStack),
                                8,
                        ...
                        if (aMaterial.contains(SubTag.SMELTING_TO_GEM))
                            GT_ModHandler.addCraftingRecipe(GT_Utility.copyAmount(1L, aStack),
                                    GT_Proxy.tBits,
                                    new Object[] { "XXX", "XXX", "XXX", 'X', OrePrefixes.nugget.get(aMaterial) });
                        if (aSpecialRecipeReq)
                            GT_ModHandler.addCraftingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, aMaterial, 1L),
                                    GT_Proxy.tBits,
                ...
                switch (aMaterial.mName) {
                    ...
                    case "Coal":
                    case "Charcoal":
                        if (GregTech_API.sRecipeFile.get(ConfigCategories.Recipes.disabledrecipes,
                                "torchesFromCoal",
                                false)) {
                        ...
                        break;
                    case "CertusQuartz":
                        GT_Values.RA.addElectrolyzerRecipe(aStack,
                                0,
                ...
                for (ItemStack is : OreDictionary.getOres("craftingLens" + aMaterial.mColor.mName.replace(
                    ...
                    // adder
                    is.stackSize = 0;
                    GT_Values.RA.addLaserEngraverRecipe(GT_Utility.copyAmount(3L, aStack),
                            is,
            ...
            case gemChipped -> {
                if (aFuelPower) GT_Values.RA.addFuel(GT_Utility.copyAmount(1L, aStack),
                        null,
                        aMaterial.mFuelPower / 2,
                        aMaterial.mFuelType);
                if (!aNoWorking) {
                    ...
                    if (aMaterial.mUnificatable && (aMaterial.mMaterialInto == aMaterial)) {
                        GT_Values.RA.addImplosionRecipe(GT_Utility.copyAmount(3L, aStack),
                                ...
                                GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.DarkAsh, 2));
                        GT_ModHandler.addCraftingRecipe(GT_OreDictUnificator.get(OrePrefixes.gemChipped, aMaterial, 2L),
                                GT_Proxy.tBits,
                                new Object[] { "h", "X", 'X', OrePrefixes.gemFlawed.get(aMaterial) });
                        if (aSpecialRecipeReq)
                            GT_ModHandler.addCraftingRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall,
                                            aMaterial,
                                            1L),
                                    GT_Proxy.tBits,
            ...
            case gemExquisite -> {
                if (aFuelPower) GT_Values.RA.addFuel(GT_Utility.copyAmount(1L, aStack),
                        ...
                        aMaterial.mFuelType);
                if (!aNoWorking) {
                    if (aMaterial.mUnificatable && (aMaterial.mMaterialInto == aMaterial)) if (aSpecialRecipeReq)
                        GT_ModHandler.addCraftingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, aMaterial, 4L),
                                GT_Proxy.tBits,
                ...
                if (!aNoWorking) {
                    ...
                    if (aMaterial.mUnificatable && (aMaterial.mMaterialInto == aMaterial)) {
                        GT_Values.RA.addImplosionRecipe(GT_Utility.copyAmount(3L, aStack),
                                ...
                                GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.DarkAsh, 2));
                        GT_ModHandler.addCraftingRecipe(GT_OreDictUnificator.get(OrePrefixes.gemFlawed, aMaterial, 2L),
                                GT_Proxy.tBits,
            ...
            case gemFlawless -> {
                ...
                if (!aNoWorking) {
                    GT_Values.RA.addLatheRecipe(GT_Utility.copyAmount(1L, aStack),
                            ...
                            GT_OreDictUnificator.getDust(aMaterial,
                    ...
                    if (aMaterial.mUnificatable && (aMaterial.mMaterialInto == aMaterial)) {
                        ...
                        if (aSpecialRecipeReq)
                            GT_ModHandler.addCraftingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, aMaterial, 2L),
                                    GT_Proxy.tBits,
