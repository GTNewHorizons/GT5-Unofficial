        ...
        switch (aPrefix) {
            ...
            case pipeQuadruple -> {
                ...
                GTValues.RA.stdBuilder()
                        ...
                        .duration(3 * SECONDS).eut(calculateRecipeEU(aMaterial, 4)).addTo(assemblerRecipes);
            }
            case pipeNonuple -> {
                if (aMaterial.getProcessingMaterialTierEU() < TierEU.IV) {
                ...
                GTValues.RA.stdBuilder()
                        ...
                        .duration(3 * SECONDS).eut(calculateRecipeEU(aMaterial, 8)).addTo(assemblerRecipes);
            }
            default -> {}
        }
    }
