        ...
        switch (aPrefix) {
                ...
                if (aMaterial.mStandardMoltenFluid != null) {
                    if (!(aMaterial == Materials.AnnealedCopper || aMaterial == Materials.WroughtIron)) {
                        GT_Values.RA.stdBuilder()
                            ...
                            .itemOutputs(OreDictUnificator.get(aPrefix, aMaterial, 1L))
                ...
                if (aMaterial.mUnificatable && (aMaterial.mMaterialInto == aMaterial)
                    ...
                    switch (aMaterial.mName) {
                        case "Wood" -> GT_ModHandler.addCraftingRecipe(
                            OreDictUnificator.get(OrePrefixes.gearGt, aMaterial, 1L),
                            GT_Proxy.tBits,
            ...
            case gearGtSmall -> {
                ...
                if (aMaterial.mUnificatable && (aMaterial.mMaterialInto == aMaterial)
                    ...
                    switch (aMaterial.mName) {
                        case "Wood" -> GT_ModHandler.addCraftingRecipe(
                            OreDictUnificator.get(OrePrefixes.gearGtSmall, aMaterial, 1L),
                            GT_Proxy.tBits,
