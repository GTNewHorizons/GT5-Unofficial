    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName,
        ...
        if ((aMaterial.mUnificatable) && (aMaterial.mMaterialInto == aMaterial)
            ...
            if (GTUtility.isStackValid(tPlate) && GTUtility.isStackValid(tRing)) {
                ...
                GTValues.RA.stdBuilder().itemInputs(tPlate.copy(), tRing.copy(), GTUtility.getIntegratedCircuit(4))
                        ...
                        .eut(calculateRecipeEU(aMaterial, 24)).addTo(assemblerRecipes);
            ...
            if (GTOreDictUnificator.get(OrePrefixes.ingot, aMaterial, 1L) != null) {
                GTValues.RA.stdBuilder()
                        ...
                        .itemOutputs(GTOreDictUnificator.get(OrePrefixes.rotor, aMaterial, 1L))
                        .duration(((int) Math.max(aMaterial.getMass(), 1L)) * TICKS)
                        .eut(calculateRecipeEU(aMaterial, 24)).addTo(extruderRecipes);
            }
            if (aMaterial.mStandardMoltenFluid != null) {
                if (!(aMaterial == Materials.AnnealedCopper || aMaterial == Materials.WroughtIron)) {

                    GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Rotor.get(0L))
                            .itemOutputs(GTOreDictUnificator.get(OrePrefixes.rotor, aMaterial, 1L))
                            .fluidInputs(aMaterial.getMolten(612L))
                            .duration(((int) Math.max(aMaterial.getMass(), 1L)) * TICKS)
                            .eut(calculateRecipeEU(aMaterial, 24)).addTo(fluidSolidifierRecipes);
                }
            }
        }
    }
