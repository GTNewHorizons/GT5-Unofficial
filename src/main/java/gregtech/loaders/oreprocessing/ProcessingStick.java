    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName,
        ...
        if (aMaterial.getProcessingMaterialTierEU() < TierEU.IV) {
            GT_ModHandler.addCraftingRecipe(
                OreDictUnificator.get(OrePrefixes.springSmall, aMaterial, 1L),
                GT_ModHandler.RecipeBits.BUFFERED,
                new Object[] { " s ", "fPx", 'P', OrePrefixes.stick.get(aMaterial) });
        }
        if (!aMaterial.contains(gregtech.api.enums.SubTag.NO_WORKING)) {

            if ((aMaterial.contains(SubTag.CRYSTAL) ? OreDictUnificator.get(OrePrefixes.gem, aMaterial, 1L)
                : OreDictUnificator.get(OrePrefixes.ingot, aMaterial, 1L)) != null
                && OreDictUnificator.get(OrePrefixes.dustSmall, aMaterial.mMacerateInto, 1L) != null) {
                GT_Values.RA.stdBuilder()
                    .itemInputs(
                        aMaterial.contains(SubTag.CRYSTAL) ? OreDictUnificator.get(OrePrefixes.gem, aMaterial, 1L)
                            : OreDictUnificator.get(OrePrefixes.ingot, aMaterial, 1L))
                    .itemOutputs(
                        OreDictUnificator.get(OrePrefixes.stick, aMaterial, 1L),
                        OreDictUnificator.get(OrePrefixes.dustSmall, aMaterial.mMacerateInto, 2L))
            ...
            if (OreDictUnificator.get(OrePrefixes.bolt, aMaterial, 1L) != null) {
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .itemOutputs(OreDictUnificator.get(OrePrefixes.bolt, aMaterial, 4L))
                    .fluidInputs(
            ...
            if ((aMaterial.mUnificatable) && (aMaterial.mMaterialInto == aMaterial)) {
                if (aMaterial.getProcessingMaterialTierEU() < TierEU.IV) {
                    GT_ModHandler.addCraftingRecipe(
                        OreDictUnificator.get(OrePrefixes.stick, aMaterial, 2L),
                        GT_Proxy.tBits,
