...
public class ProcessingOre implements gregtech.api.interfaces.IOreRecipeRegistrator {
    ...
    private boolean registerStandardOreRecipes(OrePrefixes aPrefix, Materials aMaterial, ItemStack aOreStack, int aMultiplier) {
      ...
      //IndustrialPulverizer
        GT_Values.RA.addIndustrialPulverizerRecipe(GT_Utility.copyAmount(1L, new Object[]{aOreStack}), Materials.Water.getFluid(1000L), Materials.SluiceJuice.getFluid(900L), GT_OreDictUnificator.get(OrePrefixes.crushedPurified, aMaterial, 2 * aMultiplier), GT_OreDictUnificator.get(OrePrefixes.dust, GT_Utility.selectItemInList(0, aMaterial.mMacerateInto, aMaterial.mOreByProducts), 1L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, GT_Utility.selectItemInList(0, aMaterial, aMaterial.mOreByProducts), 2L), GT_OreDictUnificator.getDust(aPrefix.mSecondaryMaterial), new int[]{10000, 1000, 10000, 5000}, 100, 64);
        if (aMaterial.contains(SubTag.WASHING_MERCURY))
        	GT_Values.RA.addIndustrialPulverizerRecipe(GT_Utility.copyAmount(1L, new Object[]{aOreStack}), Materials.Mercury.getFluid(1000L), Materials.SluiceJuice.getFluid(900L), GT_OreDictUnificator.get(OrePrefixes.crushedPurified, aMaterial, 2 * aMultiplier), GT_OreDictUnificator.get(OrePrefixes.dust, GT_Utility.selectItemInList(0, aMaterial.mMacerateInto, aMaterial.mOreByProducts), 1L), GT_OreDictUnificator.get(OrePrefixes.dust, aMaterial.mMacerateInto, 2L), GT_OreDictUnificator.getDust(aPrefix.mSecondaryMaterial), new int[]{10000, 1000, 7000, 5000}, 100, 64);
            if (aMaterial.contains(SubTag.WASHING_SODIUMPERSULFATE))
            	GT_Values.RA.addIndustrialPulverizerRecipe(GT_Utility.copyAmount(1L, new Object[]{aOreStack}), Materials.SodiumPersulfate.getFluid(1000L), Materials.SluiceJuice.getFluid(900L), GT_OreDictUnificator.get(OrePrefixes.crushedPurified, aMaterial, 2 * aMultiplier), GT_OreDictUnificator.get(OrePrefixes.dust, GT_Utility.selectItemInList(0, aMaterial.mMacerateInto, aMaterial.mOreByProducts), 1L), GT_OreDictUnificator.get(OrePrefixes.dust, aMaterial.mMacerateInto, 2L), GT_OreDictUnificator.getDust(aPrefix.mSecondaryMaterial), new int[]{10000, 1000, 7000, 5000}, 100, 64);
