    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
        ...
        switch (aMaterial.mName) {
            ...
            case "Basic":
            	...
            	//GT_ModHandler.addCraftingRecipe(aStack, new Object[]{"RIR","VBV","CCC",'R',ItemList.Circuit_Parts_Resistor.get(1,new Object[0]),'C',GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.RedAlloy, 1),'V', GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Primitive, 1),'B',ItemList.Circuit_Board_Coated_Basic.get(1,new Object[0]),'I',GT_OreDictUnificator.get(OrePrefixes.casingSmall, Materials.Steel, 1)});
