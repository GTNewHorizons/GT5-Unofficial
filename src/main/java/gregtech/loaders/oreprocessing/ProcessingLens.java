...
public class ProcessingLens implements gregtech.api.interfaces.IOreRecipeRegistrator {
    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName,
        ...
        switch (aMaterial.mName) {
            case "Diamond", "Glass" -> {
                GT_Values.RA.addLatheRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, aMaterial, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.lens, aMaterial, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.dustSmall, aMaterial, 1L),
                        1200,
                        30);
                GT_Values.RA.addLatheRecipe(GT_OreDictUnificator.get(OrePrefixes.gemExquisite, aMaterial, 1L),
            ...
            case "ChromaticGlass" ->
                    GT_Values.RA.addCompressorRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, aMaterial, 16L),
                            GT_OreDictUnificator.get(OrePrefixes.lens, aMaterial, 1L),
                            600 * 20,
                            1966080);
            default -> {
                ...
                GT_Values.RA.addLatheRecipe(GT_OreDictUnificator.get(OrePrefixes.gemExquisite, aMaterial, 1L),
                        ...
                        2400,
                        30);
                final ITexture lensCoverTexture = TextureFactory.of(Textures.BlockIcons.OVERLAY_LENS,
                        aMaterial.mRGBa,
                        false);
