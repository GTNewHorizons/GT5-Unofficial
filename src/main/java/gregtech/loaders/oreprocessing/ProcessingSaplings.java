...
public class ProcessingSaplings implements gregtech.api.interfaces.IOreRecipeRegistrator {
    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName,
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dustSmall, Materials.Wood, 2L)).duration(20 * SECONDS)
                .eut(2).addTo(maceratorRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(8, aStack)).itemOutputs(ItemList.IC2_Plantball.get(1L))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                ...
                .duration(16 * TICKS).eut(8).addTo(latheRecipes);
    }
}
