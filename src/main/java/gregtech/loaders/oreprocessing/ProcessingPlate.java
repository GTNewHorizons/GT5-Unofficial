...
public class ProcessingPlate implements gregtech.api.interfaces.IOreRecipeRegistrator {
    ...
    private void registerPlate(final Materials aMaterial, final ItemStack aStack, final boolean aNoSmashing) {
        ...
        if (aMaterial.mStandardMoltenFluid != null
            ...
            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Plate.get(0L)).itemOutputs(aMaterial.getPlates(1))
    ...
    private void registerPlateDouble(final Materials aMaterial, final ItemStack aStack, final boolean aNoSmashing,
        ...
        if (!aNoSmashing || aMaterial.contains(SubTag.STRETCHY)) {
            ...
            if (GTOreDictUnificator.get(OrePrefixes.plateQuadruple, aMaterial, 1L) != null) {
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(2, aStack), GTUtility.getIntegratedCircuit(2))
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(GTUtility.copyAmount(1, aStack)).duration(Math.max(aMaterialMass * 2L, 1L))
                    .eut(calculateRecipeEU(aMaterial, 96)).addTo(benderRecipes);
        } else {
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            GTOreDictUnificator.get(OrePrefixes.plate, aMaterial, 2L),
                            GTUtility.getIntegratedCircuit(2))
                    .itemOutputs(GTUtility.copyAmount(1, aStack)).fluidInputs(Materials.Glue.getFluid(10L))
    ...
    private void registerPlateTriple(final Materials aMaterial, final ItemStack aStack, final boolean aNoSmashing,
        ...
        if (!aNoSmashing || aMaterial.contains(SubTag.STRETCHY)) {
            if (GTOreDictUnificator.get(OrePrefixes.plateDense, aMaterial, 1L) != null) {
                ...
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(3, aStack), GTUtility.getIntegratedCircuit(3))
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(GTUtility.copyAmount(1, aStack)).duration(Math.max(aMaterialMass * 3L, 1L))
                    .eut(calculateRecipeEU(aMaterial, 96)).addTo(benderRecipes);
        } else {
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            GTOreDictUnificator.get(OrePrefixes.plate, aMaterial, 3L),
                            GTUtility.getIntegratedCircuit(3))
                    .itemOutputs(GTUtility.copyAmount(1, aStack)).fluidInputs(Materials.Glue.getFluid(20L))
                    .duration(4 * SECONDS + 16 * TICKS).eut(8).addTo(assemblerRecipes);
        }
        ...
        if (GTOreDictUnificator.get(OrePrefixes.compressed, aMaterial, 1L) != null) {
            GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                    ...
                    .duration(1 * SECONDS).eut(TierEU.RECIPE_LV).metadata(ADDITIVE_AMOUNT, 2).addTo(implosionRecipes);
        }
    }
    ...
    private void registerPlateQuadruple(final Materials aMaterial, final ItemStack aStack, final boolean aNoSmashing,
        ...
        if (!aNoSmashing || aMaterial.contains(SubTag.STRETCHY)) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(GTUtility.copyAmount(1, aStack)).duration(Math.max(aMaterialMass * 4L, 1L))
                    .eut(calculateRecipeEU(aMaterial, 96)).addTo(benderRecipes);
        } else {
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            GTOreDictUnificator.get(OrePrefixes.plate, aMaterial, 4L),
                            GTUtility.getIntegratedCircuit(4))
                    .itemOutputs(GTUtility.copyAmount(1, aStack)).fluidInputs(Materials.Glue.getFluid(30L))
                    .duration(6 * SECONDS + 8 * TICKS).eut(8).addTo(assemblerRecipes);
        }
        if (!aNoSmashing) {
            if (aMaterial.getProcessingMaterialTierEU() < TierEU.IV) {
                Object aPlateStack = OrePrefixes.plate.get(aMaterial);
    ...
    private void registerPlateQuintuple(final Materials aMaterial, final ItemStack aStack, final boolean aNoSmashing,
        ...
        if (!aNoSmashing || aMaterial.contains(SubTag.STRETCHY)) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(GTUtility.copyAmount(1, aStack)).duration(Math.max(aMaterialMass * 5L, 1L))
                    .eut(calculateRecipeEU(aMaterial, 96)).addTo(benderRecipes);
        } else {
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            GTOreDictUnificator.get(OrePrefixes.plate, aMaterial, 5L),
                            GTUtility.getIntegratedCircuit(5))
                    .itemOutputs(GTUtility.copyAmount(1, aStack)).fluidInputs(Materials.Glue.getFluid(40L))
    ...
    private void registerPlateDense(final Materials aMaterial, final ItemStack aStack, final boolean aNoSmashing,
        ...
        if (!aNoSmashing || aMaterial.contains(SubTag.STRETCHY)) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(GTUtility.copyAmount(1, aStack)).duration(Math.max(aMaterialMass * 9L, 1L))
                    .eut(calculateRecipeEU(aMaterial, 96)).addTo(benderRecipes);
        }
    }
    ...
    private void registerPlateSuperdense(final Materials aMaterial, final ItemStack aStack, final boolean aNoSmashing,
        ...
        if (!aNoSmashing || aMaterial.contains(SubTag.STRETCHY)) {
            ...
            GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.plate, aMaterial, 64))
                    .itemOutputs(GTUtility.copyAmount(1, aStack)).duration(Math.max(aMaterialMass * 32L, 1L))
                    .eut(calculateRecipeEU(aMaterial, 96)).metadata(COMPRESSION_TIER, compression_tier)
    ...
    private void registerItemCasing(final OrePrefixes aPrefix, final Materials aMaterial, final ItemStack aStack,
        ...
        if (aMaterial.mStandardMoltenFluid != null) {
            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Casing.get(0L))
                    .itemOutputs(GTOreDictUnificator.get(OrePrefixes.itemCasing, aMaterial, 1L))
                    .fluidInputs(aMaterial.getMolten(1 * HALF_INGOTS)).duration(16 * TICKS)
                    .eut(calculateRecipeEU(aMaterial, 8)).addTo(fluidSolidifierRecipes);
        }
        ...
        if (GTOreDictUnificator.get(OrePrefixes.ingot, aMaterial, 1L) != null) {
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(GTUtility.copyAmount(3, aStack)).duration(6 * SECONDS + 8 * TICKS)
                    .eut(calculateRecipeEU(aMaterial, 15)).recipeCategory(RecipeCategories.alloySmelterMolding)
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(((int) Math.max(aMaterial.getMass(), 1L)) * TICKS).eut(calculateRecipeEU(aMaterial, 45))
                    .addTo(extruderRecipes);
        }

        if (GTOreDictUnificator.get(OrePrefixes.plate, aMaterial, 1L) != null) {
            GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.plate, aMaterial, 1L))
                    .itemOutputs(GTOreDictUnificator.get(OrePrefixes.itemCasing, aMaterial, 2L))
                    .fluidInputs(
                    ...
                    .eut(calculateRecipeEU(aMaterial, 16)).addTo(cutterRecipes);
                                    ...
                                    Math.max(
                                            ...
                                            Math.min(
                                                    ...
                                                    ((int) Math.max(aMaterial.getMass(), 1L))
                                                            * (calculateRecipeEU(aMaterial, 16))
                                                            / 1280))))
                    .duration(((int) Math.max(aMaterial.getMass(), 1L)) * TICKS).eut(calculateRecipeEU(aMaterial, 16))
                    .addTo(cutterRecipes);
        }
    }
        ...
        switch (aOreDictName) {
            case "plateAlloyCarbon" -> {
                GTValues.RA.stdBuilder()
                        ...
                        .itemOutputs(GTModHandler.getIC2Item("windMill", 1L)).duration(5 * MINUTES + 20 * SECONDS)
                        .eut(8).addTo(assemblerRecipes);

                GTValues.RA.stdBuilder()
                        .itemInputs(GTUtility.copyAmount(1, aStack), new ItemStack(Blocks.glass, 3, WILDCARD))
                        .itemOutputs(GTModHandler.getIC2Item("reinforcedGlass", 4L)).duration(20 * SECONDS).eut(4)
                        .addTo(alloySmelterRecipes);
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack), Materials.Glass.getDust(3))
                        .itemOutputs(GTModHandler.getIC2Item("reinforcedGlass", 4L)).duration(20 * SECONDS).eut(4)
                        .addTo(alloySmelterRecipes);
            }
            case "plateAlloyAdvanced" -> {
                RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack), new ItemStack(Blocks.glass, 3, WILDCARD))
                        .itemOutputs(GTModHandler.getIC2Item("reinforcedGlass", 4L)).duration(20 * SECONDS).eut(4)
                        .addTo(alloySmelterRecipes);
                RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack), Materials.Glass.getDust(3))
                        .itemOutputs(GTModHandler.getIC2Item("reinforcedGlass", 4L)).duration(20 * SECONDS).eut(4)
                        .addTo(alloySmelterRecipes);
            }
