...
public class ProcessingNugget implements gregtech.api.interfaces.IOreRecipeRegistrator {
    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName,
        ItemStack aStack) {
        if (!OreRecipeRegistrationGuard.tryProcessStack(aPrefix, aMaterial, aStack, "ProcessingNugget")) {
            return;
        }
        ...
        if (OreRecipeRegistrationGuard.tryRegisterReverseRecipe("macerator", aMaterial, aPrefix, canonicalStack)) {
