        ...
        switch (aPrefix) {
            case dust -> {
                if (aMaterial.mFuelPower > 0) {
                    GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                            .metadata(FUEL_VALUE, aMaterial.mFuelPower).metadata(FUEL_TYPE, aMaterial.mFuelType)
                ...
                if ((GTUtility.getFluidForFilledItem(GTOreDictUnificator.get(OrePrefixes.cell, aMaterial, 1L), true)
                    ...
                    GTValues.RA.stdBuilder().itemInputs(aStack, ItemList.Cell_Empty.get(1L))
                            .itemOutputs(GTOreDictUnificator.get(OrePrefixes.cell, aMaterial, 1L)).duration(5 * SECONDS)
                ...
                if ((null != (tDustStack = GTOreDictUnificator.get(OrePrefixes.ingot, aMaterial.mSmeltInto, 1L)))
                    ...
                    if (aMaterial.mBlastFurnaceRequired) {
                        ...
                        if (aMaterial.mAutoGenerateBlastFurnaceRecipes) {
                            ...
                            recipeBuilder.duration(
                                    (Math.max(aMaterial.getMass() / 40L, 1L) * aMaterial.mBlastFurnaceTemp) * TICKS)
                                    .eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, (int) aMaterial.mBlastFurnaceTemp)
                    ...
                    if ((!OrePrefixes.block.isIgnored(aMaterial))
                        ...
                        GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(9, aStack))
                        ...
                        if ((aMaterial.mExtraData & 0x1) != 0) {
                            if (!tList.isEmpty() || tFluid != null) {
                                ...
                                recipeBuilder
                                        ...
                                        .eut(Math.min(4, tList.size()) * 30).addTo(electrolyzerRecipes);
                            }
                        }
                        if ((aMaterial.mExtraData & 0x2) != 0) {
                            if (!tList.isEmpty() || tFluid != null) {
                                ...
                                recipeBuilder.duration(Math.max(1L, Math.abs(aMaterial.getMass() * 4L * tItemAmount)))
                                        .eut(Math.min(4, tList.size()) * 5).addTo(centrifugeRecipes);
                            }
                        }
                    }
                }
                if (aMaterial.contains(SubTag.CRYSTALLISABLE)
                    ...
                    GTValues.RA.stdBuilder()
                            .itemInputs(GTUtility.copyAmount(1, aStack), GTUtility.getIntegratedCircuit(1))
                            .itemOutputs(GTOreDictUnificator.get(OrePrefixes.gem, aMaterial, 1L)).outputChances(7000)
                            .fluidInputs(Materials.Water.getFluid(200L)).duration(1 * MINUTES + 40 * SECONDS).eut(24)
                            .addTo(autoclaveRecipes);
                    GTValues.RA.stdBuilder()
                            .itemInputs(GTUtility.copyAmount(1, aStack), GTUtility.getIntegratedCircuit(2))
                            .itemOutputs(GTOreDictUnificator.get(OrePrefixes.gem, aMaterial, 1L)).outputChances(9000)
                            .fluidInputs(GTModHandler.getDistilledWater(100L)).duration(1 * MINUTES + 15 * SECONDS)
                            .eut(24).addTo(autoclaveRecipes);
                    GTValues.RA.stdBuilder()
                            .itemInputs(GTUtility.copyAmount(1, aStack), GTUtility.getIntegratedCircuit(3))
                            .itemOutputs(GTOreDictUnificator.get(OrePrefixes.gem, aMaterial, 1L)).outputChances(10000)
                            .fluidInputs(Materials.Void.getMolten(1 * QUARTER_INGOTS)).duration(1 * MINUTES).eut(24)
                            .addTo(autoclaveRecipes);
                }
                switch (aMaterial.mName) {
                    ...
                    case "Oilsands":
                        GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                                .fluidOutputs(Materials.OilHeavy.getFluid(1_000)).duration(33 * SECONDS).eut(8)
                    ...
                    case "HydratedCoal":
                        ...
                        break;
                    case "Diamond": {
                        GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(4, aStack))
                                .itemOutputs(
                                        ItemList.IC2_Industrial_Diamond.get(3L),
                                        GTOreDictUnificator.get(OrePrefixes.dustTiny, Materials.DarkAsh, 16L))
                                .duration(1 * SECONDS).eut(TierEU.RECIPE_LV).metadata(ADDITIVE_AMOUNT, 32)
                    ...
                    case "Amethyst": {
                        GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(4, aStack))
                                ...
                                .duration(1 * SECONDS).eut(TierEU.RECIPE_LV).metadata(ADDITIVE_AMOUNT, 24)
                                .addTo(implosionRecipes);
                    }
                        break;
                    case "FoolsRuby":
                    ...
                    case "Force": {
                        GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(4, aStack))
                                ...
                                .duration(1 * SECONDS).eut(TierEU.RECIPE_LV).metadata(ADDITIVE_AMOUNT, 16)
                                .addTo(implosionRecipes);
                    }
                }
            }
            case dustPure, dustImpure, dustRefined -> {
                ...
                if (aMaterial.contains(SubTag.CRYSTALLISABLE)
                    ...
                    GTValues.RA.stdBuilder()
                            .itemInputs(GTUtility.copyAmount(1, aStack), GTUtility.getIntegratedCircuit(2))
                            .itemOutputs(GTOreDictUnificator.get(OrePrefixes.gem, aMaterial, 1L)).outputChances(9500)
                            .fluidInputs(GTModHandler.getDistilledWater(100L)).duration(1 * MINUTES + 15 * SECONDS)
                            .eut(24).addTo(autoclaveRecipes);
                    GTValues.RA.stdBuilder()
                            .itemInputs(GTUtility.copyAmount(1, aStack), GTUtility.getIntegratedCircuit(3))
                        ...
                        if (tImpureStack == null) {
                            ...
                            if (tImpureStack == null) {
                                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                                        ...
                                        .duration(Math.max(1L, aMaterial.getMass())).eut(5).addTo(centrifugeRecipes);
                            } else {
                                ...
                                if (tFluid == null) {
                                    GTValues.RA.stdBuilder()
                                            ...
                                            .itemOutputs(
                                                    ...
                                                    tImpureStack)
                                            .duration(Math.max(1L, aMaterial.getMass() * 72L)).eut(5)
                                            .addTo(centrifugeRecipes);
                                } else {
                                    tFluid.amount /= 10;
                                    GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                            ...
                            GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(9, aStack))
                                    ...
                                    .duration(Math.max(1L, aMaterial.getMass() * 72L)).eut(5).addTo(centrifugeRecipes);
                        }
                    } else {
                        GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(2, aStack))
                                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, aMaterial, 2L), tImpureStack)
                                .duration(Math.max(1L, aMaterial.getMass() * 16L)).eut(5).addTo(centrifugeRecipes);
                    }
                } else {
                    GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(1, aStack))
                            .itemOutputs(
                                    ...
                                    GTOreDictUnificator.get(
                                            ...
                                            GTOreDictUnificator.get(OrePrefixes.nugget, tByProduct, 1L),
                                            1L))
                            .outputChances(10000, 1111).duration(Math.max(1L, aMaterial.getMass() * 8L)).eut(5)
                            .addTo(centrifugeRecipes);
                }
            }
            case dustSmall -> {
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(4, aStack), ItemList.Schematic_Dust.get(0L))
                        .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, aMaterial, 1L)).duration(1 * SECONDS)
                        .eut(4).addTo(packagerRecipes);
                if (!aMaterial.mBlastFurnaceRequired) {
                    GTRecipeRegistrator
            ...
            case dustTiny -> {
                GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(9, aStack), ItemList.Schematic_Dust.get(0L))
                        .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, aMaterial, 1L)).duration(1 * SECONDS)
                        .eut(4).addTo(packagerRecipes);
                if (!aMaterial.mBlastFurnaceRequired) {
                    GTRecipeRegistrator
