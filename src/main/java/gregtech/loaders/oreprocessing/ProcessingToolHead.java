        ...
        switch (aPrefix) {
            ...
            case toolHeadDrill -> {
                ...
                if (aSpecialRecipeReq2) {
                    ...
                    if (aMaterial.mStandardMoltenFluid != null) {
                        GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_ToolHeadDrill.get(0))
                                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.toolHeadDrill, aMaterial, 1L))
                                .fluidInputs(aMaterial.getMolten(4 * INGOTS)).duration(5 * SECONDS)
                    ...
                    if (GTOreDictUnificator.get(OrePrefixes.ingot, aMaterial, 1L) != null) {
                        GTValues.RA.stdBuilder()
                                ...
                                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.toolHeadDrill, aMaterial, 1L))
                                .duration(5 * SECONDS).eut(calculateRecipeEU(aMaterial, (int) TierEU.RECIPE_MV))
                        ...
                        if (aMaterial.getProcessingMaterialTierEU() < TierEU.IV) {
                            GTModHandler.addCraftingRecipe(
                                    MetaGeneratedTool01.INSTANCE.getToolWithStats(
                                            ...
                                            aMaterial.mHandleMaterial,
                                            null),
                                    GTModHandler.RecipeBits.MIRRORED
                    ...
                    GTValues.RA.stdBuilder()
                            ...
                            .itemOutputs(
                                    MetaGeneratedTool01.INSTANCE.getToolWithStats(
                                            ...
                                            aMaterial.mHandleMaterial,
                                            null))
                            .duration(10 * SECONDS).eut(calculateRecipeEU(aMaterial, (int) TierEU.RECIPE_MV))
            ...
            case toolHeadHammer, toolHeadMallet -> {
                if (GTOreDictUnificator.get(OrePrefixes.stick, aMaterial.mHandleMaterial, 1L) != null) {
                    GTValues.RA.stdBuilder()
                            ...
                            .itemOutputs(
                                    MetaGeneratedTool01.INSTANCE.getToolWithStats(
                                            aProducesSoftMallet ? IDMetaTool01.SOFTMALLET.ID
            ...
            case turbineBlade -> {
                GTValues.RA.stdBuilder()
                        ...
                        .duration(8 * SECONDS).eut(calculateRecipeEU(aMaterial, 100)).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                        ...
                        .duration(16 * SECONDS).eut(calculateRecipeEU(aMaterial, 400)).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                        ...
                        .duration(32 * SECONDS).eut(calculateRecipeEU(aMaterial, 1600)).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                        ...
                        .duration(1 * MINUTES + 4 * SECONDS).eut(calculateRecipeEU(aMaterial, 6400))
                        .addTo(assemblerRecipes);
                if (aSpecialRecipeReq2) {
                    if (aMaterial.getProcessingMaterialTierEU() < TierEU.IV) {
                        GTModHandler.addCraftingRecipe(
                    ...
                    if (GTOreDictUnificator.get(OrePrefixes.plateDouble, aMaterial, 1L) != null
                        ...
                        GTValues.RA.stdBuilder()
                                ...
                                .duration(10 * SECONDS).eut(calculateRecipeEU(aMaterial, 60))
