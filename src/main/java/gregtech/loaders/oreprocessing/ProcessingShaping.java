            ...
            if ((tAmount > 0) && (tAmount <= 64) && (aPrefix.mMaterialAmount % 3628800L == 0L)) {
                ...
                if (!OrePrefixes.block.isIgnored(aMaterial.mSmeltInto)
                    ...
                    GTValues.RA.stdBuilder()
                            ...
                            .eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier)).addTo(extruderRecipes);
                ...
                if ((aPrefix != OrePrefixes.ingot || aMaterial != aMaterial.mSmeltInto)
                    ...
                    GTValues.RA.stdBuilder()
                            ...
                            .duration(10 * TICKS).eut(calculateRecipeEU(aMaterial, 4 * tVoltageMultiplier))
                ...
                if (GTOreDictUnificator.get(OrePrefixes.pipeTiny, aMaterial.mSmeltInto, 1L) != null) {
                    GTValues.RA.stdBuilder()
                            ...
                            .itemOutputs(
                                    GTOreDictUnificator.get(OrePrefixes.pipeTiny, aMaterial.mSmeltInto, tAmount * 2))
                            .duration((4 * tAmount) * TICKS).eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier))
                            .addTo(extruderRecipes);
                }
                if (GTOreDictUnificator.get(OrePrefixes.pipeSmall, aMaterial.mSmeltInto, 1L) != null) {
                    GTValues.RA.stdBuilder()
                            ...
                            .duration((8 * tAmount) * TICKS).eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier))
                            .addTo(extruderRecipes);
                }
                if (GTOreDictUnificator.get(OrePrefixes.pipeMedium, aMaterial.mSmeltInto, 1L) != null) {
                    GTValues.RA.stdBuilder()
                            ...
                            .duration((24 * tAmount) * TICKS).eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier))
                            .addTo(extruderRecipes);
                }
                if (GTOreDictUnificator.get(OrePrefixes.pipeLarge, aMaterial.mSmeltInto, 1L) != null) {
                    GTValues.RA.stdBuilder()
                            ...
                            .duration((48 * tAmount) * TICKS).eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier))
                            .addTo(extruderRecipes);
                }
                if (GTOreDictUnificator.get(OrePrefixes.pipeHuge, aMaterial.mSmeltInto, 1L) != null) {
                    GTValues.RA.stdBuilder()
                            ...
                            .duration((96 * tAmount) * TICKS).eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier))
                            .addTo(extruderRecipes);
                }
                ...
                if (GTOreDictUnificator.get(OrePrefixes.gearGtSmall, aMaterial.mSmeltInto, 1L) != null) {
                    GTValues.RA.stdBuilder()
                            ...
                            .itemOutputs(
                                    GTOreDictUnificator.get(OrePrefixes.gearGtSmall, aMaterial.mSmeltInto, tAmount))
                            .duration(((int) Math.max(aMaterialMass * tAmount, tAmount)) * TICKS)
                            .eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier)).addTo(extruderRecipes);
                }
                if (GTOreDictUnificator.get(OrePrefixes.turbineBlade, aMaterial.mSmeltInto, 1L) != null) {
                    GTValues.RA.stdBuilder()
                            ...
                            .itemOutputs(
                                    GTOreDictUnificator.get(OrePrefixes.turbineBlade, aMaterial.mSmeltInto, tAmount))
                            .duration(((int) Math.max(aMaterialMass * tAmount, tAmount)) * TICKS)
                            .eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier)).addTo(extruderRecipes);
                }
                ...
                if (!(aMaterial == Materials.AnnealedCopper || aMaterial == Materials.WroughtIron)
                    ...
                    if (aMaterial.mStandardMoltenFluid != null) {
                        if (GTOreDictUnificator.get(OrePrefixes.ring, aMaterial, 1L) != null) {
                            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Ring.get(0L))
                                    .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ring, aMaterial, 1L))
                                    .fluidInputs(aMaterial.getMolten(1 * QUARTER_INGOTS)).duration(5 * SECONDS)
                                    .eut(calculateRecipeEU(aMaterial, 4 * tVoltageMultiplier))
                                    .addTo(fluidSolidifierRecipes);
                        }
                        if (GTOreDictUnificator.get(OrePrefixes.screw, aMaterial, 1L) != null) {
                            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Screw.get(0L))
                        ...
                        if (GTOreDictUnificator.get(OrePrefixes.stick, aMaterial, 1L) != null) {
                            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Rod.get(0L))
                        ...
                        if (GTOreDictUnificator.get(OrePrefixes.bolt, aMaterial, 1L) != null) {
                            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Bolt.get(0L))
                        ...
                        if (GTOreDictUnificator.get(OrePrefixes.round, aMaterial, 1L) != null) {
                            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Round.get(0L))
                                    .itemOutputs(GTOreDictUnificator.get(OrePrefixes.round, aMaterial, 1L))
                                    .fluidInputs(aMaterial.getMolten(1 * NUGGETS)).duration(2 * SECONDS + 10 * TICKS)
                                    .eut(calculateRecipeEU(aMaterial, 2 * tVoltageMultiplier))
                                    .addTo(fluidSolidifierRecipes);
                        }
                        if (GTOreDictUnificator.get(OrePrefixes.stickLong, aMaterial, 1L) != null) {
                            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Rod_Long.get(0L))
                                    .itemOutputs(GTOreDictUnificator.get(OrePrefixes.stickLong, aMaterial, 1L))
                                    .fluidInputs(aMaterial.getMolten(1 * INGOTS)).duration(15 * SECONDS)
                                    .eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier))
                                    .addTo(fluidSolidifierRecipes);
                        }
                        if (GTOreDictUnificator.get(OrePrefixes.turbineBlade, aMaterial, 1L) != null) {
                            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Turbine_Blade.get(0L))
                                    .itemOutputs(GTOreDictUnificator.get(OrePrefixes.turbineBlade, aMaterial, 1L))
                                    .fluidInputs(aMaterial.getMolten(6 * INGOTS)).duration(20 * SECONDS)
                                    .eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier))
                                    .addTo(fluidSolidifierRecipes);
                        }
                        if (GTOreDictUnificator.get(OrePrefixes.pipeTiny, aMaterial, 1L) != null) {
                            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Pipe_Tiny.get(0L))
                                    ...
                                    .fluidInputs(aMaterial.getMolten(1 * HALF_INGOTS)).duration(1 * SECONDS)
                                    .eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier))
                                    .addTo(fluidSolidifierRecipes);
                        }
                        if (GTOreDictUnificator.get(OrePrefixes.pipeSmall, aMaterial, 1L) != null) {
                            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Pipe_Small.get(0L))
                                    ...
                                    .fluidInputs(aMaterial.getMolten(1 * INGOTS)).duration(2 * SECONDS)
                                    .eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier))
                                    .addTo(fluidSolidifierRecipes);
                        }
                        if (GTOreDictUnificator.get(OrePrefixes.pipeMedium, aMaterial, 1L) != null) {
                            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Pipe_Medium.get(0L))
                                    ...
                                    .fluidInputs(aMaterial.getMolten(3 * INGOTS)).duration(4 * SECONDS)
                                    .eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier))
                                    .addTo(fluidSolidifierRecipes);
                        }
                        if (GTOreDictUnificator.get(OrePrefixes.pipeLarge, aMaterial, 1L) != null) {
                            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Pipe_Large.get(0L))
                                    ...
                                    .fluidInputs(aMaterial.getMolten(6 * INGOTS)).duration(8 * SECONDS)
                                    .eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier))
                                    .addTo(fluidSolidifierRecipes);
                        }
                        if (GTOreDictUnificator.get(OrePrefixes.pipeHuge, aMaterial, 1L) != null) {
                            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Pipe_Huge.get(0L))
                                    ...
                                    .fluidInputs(aMaterial.getMolten(1728L)).duration(16 * SECONDS)
                                    .eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier))
                                    .addTo(fluidSolidifierRecipes);
                        }
                    }
                    ...
                    if (!(aMaterial == Materials.Aluminium)) {
                        if (GTOreDictUnificator.get(OrePrefixes.stick, aMaterial.mSmeltInto, 1L) != null) {
                            GTValues.RA.stdBuilder()
                                    ...
                                    .itemOutputs(
                                            GTOreDictUnificator
                                                    .get(OrePrefixes.stick, aMaterial.mSmeltInto, tAmount * 2))
                                    .duration(((int) Math.max(aMaterialMass * 2L * tAmount, tAmount)) * TICKS)
                                    .eut(calculateRecipeEU(aMaterial, 6 * tVoltageMultiplier)).addTo(extruderRecipes);
                        }
                    } else {
                        if (GTOreDictUnificator.get(OrePrefixes.stick, aMaterial.mSmeltInto, 1L) != null) {
                            GTValues.RA.stdBuilder()
                                    ...
                                    .itemOutputs(
                                            GTOreDictUnificator
                                                    .get(OrePrefixes.stick, aMaterial.mSmeltInto, tAmount * 2))
                                    .duration(10 * SECONDS).eut(calculateRecipeEU(aMaterial, 2 * tVoltageMultiplier))
                                    .addTo(extruderRecipes);
                        }
                    }
                }
                if (tAmount * 2 <= 64) {
                    if (GTOreDictUnificator.get(OrePrefixes.wireGt01, aMaterial.mSmeltInto, 1L) != null) {
                        GTValues.RA.stdBuilder()
                                ...
                                .itemOutputs(
                                        GTOreDictUnificator
                                                .get(OrePrefixes.wireGt01, aMaterial.mSmeltInto, tAmount * 2))
                                .duration(((int) Math.max(aMaterialMass * 2L * tAmount, tAmount)) * TICKS)
                                .eut(calculateRecipeEU(aMaterial, 6 * tVoltageMultiplier)).addTo(extruderRecipes);
                    }
                }
                if (tAmount * 8 <= 64) {
                    if (GTOreDictUnificator.get(OrePrefixes.bolt, aMaterial.mSmeltInto, 1L) != null) {
                        GTValues.RA.stdBuilder()
                                ...
                                .itemOutputs(
                                        GTOreDictUnificator.get(OrePrefixes.bolt, aMaterial.mSmeltInto, tAmount * 8))
                                .duration(((int) Math.max(aMaterialMass * 2L * tAmount, tAmount)) * TICKS)
                                .eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier)).addTo(extruderRecipes);
                    }
                }
                if (tAmount * 4 <= 64) {
                    if (GTOreDictUnificator.get(OrePrefixes.ring, aMaterial.mSmeltInto, 1L) != null) {
                        GTValues.RA.stdBuilder()
                                ...
                                .itemOutputs(
                                        GTOreDictUnificator.get(OrePrefixes.ring, aMaterial.mSmeltInto, tAmount * 4))
                                .duration(((int) Math.max(aMaterialMass * 2L * tAmount, tAmount)) * TICKS)
                                .eut(calculateRecipeEU(aMaterial, 6 * tVoltageMultiplier)).addTo(extruderRecipes);
                    }
                ...
                if (GTOreDictUnificator.get(OrePrefixes.toolHeadHammer, aMaterial.mSmeltInto, 1L) != null) {
                    GTValues.RA.stdBuilder()
                            ...
                            .itemOutputs(
                                    GTOreDictUnificator.get(OrePrefixes.toolHeadHammer, aMaterial.mSmeltInto, tAmount))
                ...
                if (GTOreDictUnificator.get(OrePrefixes.toolHeadFile, aMaterial.mSmeltInto, 1L) != null) {
                    GTValues.RA.stdBuilder()
                            ...
                            .itemOutputs(
                                    GTOreDictUnificator.get(OrePrefixes.toolHeadFile, aMaterial.mSmeltInto, tAmount))
                            .duration(((int) Math.max(aMaterialMass * 2L * tAmount, tAmount)) * TICKS)
                            .eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier)).addTo(extruderRecipes);
                }
                if (GTOreDictUnificator.get(OrePrefixes.toolHeadSaw, aMaterial.mSmeltInto, 1L) != null) {
                    GTValues.RA.stdBuilder()
                            ...
                            .itemOutputs(
                                    GTOreDictUnificator.get(OrePrefixes.toolHeadSaw, aMaterial.mSmeltInto, tAmount))
                            .duration(((int) Math.max(aMaterialMass * 2L * tAmount, tAmount)) * TICKS)
                            .eut(calculateRecipeEU(aMaterial, 8 * tVoltageMultiplier)).addTo(extruderRecipes);
                }
                    ...
                    if (aMaterial.getProcessingMaterialTierEU() < TierEU.IV) {
                        if (GTOreDictUnificator.get(OrePrefixes.plate, aMaterial.mSmeltInto, 1L) != null) {
                            GTValues.RA.stdBuilder()
                                    ...
                                    .itemOutputs(
                                            GTOreDictUnificator.get(OrePrefixes.plate, aMaterial.mSmeltInto, tAmount))
                                    .duration(((int) Math.max(aMaterialMass * 2L * tAmount, tAmount)) * TICKS)
                                    .eut(calculateRecipeEU(aMaterial, 2 * tVoltageMultiplier))
                                    .recipeCategory(RecipeCategories.alloySmelterMolding).addTo(alloySmelterRecipes);
                        }
                ...
                switch (aMaterial.mSmeltInto.mName) {
                    case "Glass" -> {
                        GTValues.RA.stdBuilder()
                                ...
                                .itemOutputs(new ItemStack(Items.glass_bottle, 1)).duration((tAmount * 32) * TICKS)
                                .eut(16).addTo(extruderRecipes);
                        GTValues.RA.stdBuilder()
                                .itemInputs(GTUtility.copyAmount(1, aStack), ItemList.Shape_Mold_Bottle.get(0L))
                                .itemOutputs(new ItemStack(Items.glass_bottle, 1)).duration((tAmount * 64) * TICKS)
                                .eut(4).addTo(alloySmelterRecipes);
                    }
                    case "Steel" -> {
                        GTValues.RA.stdBuilder()
                                .itemInputs(GTUtility.copyAmount(1, aStack), ItemList.Shape_Extruder_Cell.get(0L))
                                .itemOutputs(ItemList.Cell_Empty.get(tAmount)).duration((tAmount * 128) * TICKS)
                                .eut(TierEU.RECIPE_LV).addTo(extruderRecipes);
                    }
                    case "Iron", "WroughtIron" -> {
                        GTValues.RA.stdBuilder()
                                .itemInputs(GTUtility.copyAmount(1, aStack), ItemList.Shape_Extruder_Cell.get(0L))
                                .itemOutputs(ItemList.IC2_Fuel_Rod_Empty.get(tAmount)).duration((tAmount * 128) * TICKS)
                                .eut(TierEU.RECIPE_LV).addTo(extruderRecipes);
                        if (tAmount * 31 <= 64) {
                            GTValues.RA.stdBuilder()
                                    .itemInputs(GTUtility.copyAmount(31, aStack), ItemList.Shape_Mold_Anvil.get(0L))
                                    .itemOutputs(new ItemStack(Blocks.anvil, 1, 0)).duration((tAmount * 512) * TICKS)
                                    .eut(4 * tVoltageMultiplier).addTo(alloySmelterRecipes);
                        }
                    }
                    case "Tin" -> {
                        GTValues.RA.stdBuilder()
                    ...
                    case "Polytetrafluoroethylene" -> {
                        GTValues.RA.stdBuilder()
                                .itemInputs(GTUtility.copyAmount(1, aStack), ItemList.Shape_Extruder_Cell.get(0L))
                                .itemOutputs(ItemList.Cell_Empty.get(tAmount * 4)).duration((tAmount * 128) * TICKS)
                                .eut(TierEU.RECIPE_LV).addTo(extruderRecipes);
                    }
                }
            }
