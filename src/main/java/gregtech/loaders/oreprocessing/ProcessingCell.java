                ...
                if (aMaterial == Materials.Empty) {
                    ...
                    if (aMaterial.mFuelPower > 0) {
                        GT_Values.RA.addFuel(GT_Utility.copyAmount(1L, aStack),
                                GT_Utility.getFluidForFilledItem(aStack, true) == null ? GT_Utility.getContainerItem(
                                        aStack,
                                        true) : null,
                        ...
                        for (MaterialStack tMat : aMaterial.mMaterialList) {
                            if (tMat.mAmount > 0L) {
                                ...
                                if (tMat.mMaterial == Materials.Air) {
                                    ...
                                    if (tStack == null) {
                                        tStack = GT_OreDictUnificator.get(OrePrefixes.cell,
                                                tMat.mMaterial,
                                                tMat.mAmount);
                                    }
                                }
                                if (tItemAmount + tMat.mAmount * 3628800L
                                    ...
                                    if (tStack != null) {
                                        ...
                                        while ((tStack.stackSize > 64) && (tCapsuleCount
                                                + GT_ModHandler.getCapsuleCellContainerCount(tStack) * 64L < 0L
                                                ? tList.size() < 5
                                                : tList.size() < 6) && (tCapsuleCount
                                                + GT_ModHandler.getCapsuleCellContainerCount(tStack) * 64L <= 64L)) {
            ...
            case cellPlasma -> {
                if (aMaterial == Materials.Empty) {
                    ...
                    GT_Values.RA.addFuel(GT_Utility.copyAmount(1L, aStack),
                            ...
                            4);
                    GT_Values.RA.addVacuumFreezerRecipe(GT_Utility.copyAmount(1L, aStack),
