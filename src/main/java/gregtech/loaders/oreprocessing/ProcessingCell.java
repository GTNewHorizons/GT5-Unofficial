        ...
        switch (aPrefix) {
            case cell -> {
                if (aMaterial == Materials.Empty) {
                    ...
                    if (aMaterial.mFuelPower > 0) {
                        RecipeBuilder recipeBuilder = RA.stdBuilder();
                    ...
                    for (MaterialStack tMat : aMaterial.mMaterialList) {
                        ...
                        if (tMat.mMaterial == Materials.Air) {
                            ...
                            tStack = OreDictUnificator.get(OrePrefixes.dust, tMat.mMaterial, tMat.mAmount);
                            if (tStack == null) {
                                tStack = OreDictUnificator.get(OrePrefixes.cell, tMat.mMaterial, tMat.mAmount);
                            }
                        }
            ...
            case cellPlasma -> {
                if (aMaterial == Materials.Empty) {
                    ...
                    if (OreDictUnificator.get(OrePrefixes.cell, aMaterial, 1L) != null) {
                        RA.stdBuilder()
