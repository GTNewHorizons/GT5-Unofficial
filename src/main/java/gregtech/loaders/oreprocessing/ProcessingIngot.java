        ...
        switch (aPrefix) {
            case ingot -> {
                ...
                if (aMaterial.mStandardMoltenFluid != null
                    ...
                    GT_Values.RA.stdBuilder()
                        ...
                        .itemOutputs(OreDictUnificator.get(OrePrefixes.ingot, aMaterial, 1L))
                ...
                ItemStack tStack = OreDictUnificator.get(OrePrefixes.dust, aMaterial.mMacerateInto, 1L);
                ...
                if (!aNoSmashing) {
                    ...
                    if (aMaterial.getProcessingMaterialTierEU() < TierEU.IV
                        ...
                        GT_Values.RA.stdBuilder()
                            ...
                            .itemOutputs(OreDictUnificator.get(OrePrefixes.plate, aMaterial, 2L))
                ...
                if (!aNoSmashing || aStretchy) {
                    ...
                    // Bender recipes
                    {
                        ...
                        if (OreDictUnificator.get(OrePrefixes.foil, aMaterial, 1L) != null) {
                            GT_Values.RA.stdBuilder()
                                .itemInputs(GT_Utility.copyAmount(1, aStack), GT_Utility.getIntegratedCircuit(10))
                                .itemOutputs(OreDictUnificator.get(OrePrefixes.foil, aMaterial, 4L))
                                .duration(Math.max(aMaterialMass * 2L, 1L))
                                .eut(calculateRecipeEU(aMaterial, 24))
                                .addTo(benderRecipes);
                        }
                ...
                if (!aNoSmashing || aStretchy) {
                    ...
                    if (aMaterial.getProcessingMaterialTierEU() < TierEU.IV && aSpecialRecipeReq) {
                        GT_ModHandler.addCraftingRecipe(
                            OreDictUnificator.get(OrePrefixes.ingotDouble, aMaterial, 1L),
                            GT_Proxy.tBits,
            ...
            case ingotTriple -> {
                if (!aNoSmashing || aStretchy) {
                    ...
                    if (aMaterial.getProcessingMaterialTierEU() < TierEU.IV && aSpecialRecipeReq) {
                        GT_ModHandler.addCraftingRecipe(
                            OreDictUnificator.get(OrePrefixes.ingotTriple, aMaterial, 1L),
                            GT_Proxy.tBits,
            ...
            case ingotQuadruple -> {
                if (!aNoSmashing || aStretchy) {
                    ...
                    if (aMaterial.getProcessingMaterialTierEU() < TierEU.IV && aSpecialRecipeReq) {
                        GT_ModHandler.addCraftingRecipe(
                            OreDictUnificator.get(OrePrefixes.ingotQuadruple, aMaterial, 1L),
                            GT_Proxy.tBits,
            ...
            case ingotQuintuple -> {
                if (!aNoSmashing || aStretchy) {
                    ...
                    if (aMaterial.getProcessingMaterialTierEU() < TierEU.IV && aSpecialRecipeReq) {
                        GT_ModHandler.addCraftingRecipe(
                            OreDictUnificator.get(OrePrefixes.ingotQuintuple, aMaterial, 1L),
                            GT_Proxy.tBits,
