...
public class LoaderMetaTileEntities implements Runnable { // TODO CHECK CIRCUIT RECIPES AND USAGES
    ...
    private static void registerMultiblockControllers() {
        ...
        ItemList.OilCracker.set(
                new MTEOilCracker(OIL_CRACKER_CONTROLLER.ID, "multimachine.cracker", "Oil Cracking Unit")
                        .getStackForm(1));
        ...
        ItemList.NanoForge.set(
                new MTENanoForge(NANO_FORGE_CONTROLLER.ID, "multimachine.nanoforge", "Nano Forge").getStackForm(1));
        ...
        ItemList.Machine_Multi_Canner.set(
                new MTEMultiCanner(MULTI_CANNER_CONTROLLER.ID, "multimachine.canner", "TurboCan Pro").getStackForm(1));
    ...
    private static void registerSteamMachines() {
        ...
        ItemList.Machine_Bronze_AlloySmelter.set(
                new MTESteamAlloySmelterBronze(
    ...
    private static void registerHPSteamMachines() {
        ItemList.Machine_HP_Extractor.set(
                new MTESteamExtractorSteel(
                        HP_STEAM_EXTRACTOR.ID,
                        "hpmachine.extractor",
                        "High Pressure Steam Extractor").getStackForm(1L));
        ...
        ItemList.Machine_HP_Macerator.set(
                new MTESteamMaceratorSteel(
                        ...
                        "hpmachine.macerator",
                        "High Pressure Steam Macerator").getStackForm(1L));
    ...
    private static void registerLocker() {
        ...
        ItemList.Locker_MAX.set(
                new MTELocker(LOCKER_UHV.ID, "locker.tier.09", "Highly Ultimate Voltage Locker", 9).getStackForm(1L));
    }

    private static void registerScanner() {
        ItemList.Machine_LV_Scanner.set(
                new MTEScanner(SCANNER_LV.ID, "basicmachine.scanner.tier.01", "Basic Scanner", 1).getStackForm(1L));
        ItemList.Machine_MV_Scanner.set(
                new MTEScanner(SCANNER_MV.ID, "basicmachine.scanner.tier.02", "Advanced Scanner", 2).getStackForm(1L));
        ItemList.Machine_HV_Scanner.set(
                new MTEScanner(SCANNER_HV.ID, "basicmachine.scanner.tier.03", "Advanced Scanner II", 3)
                        .getStackForm(1L));
        ItemList.Machine_EV_Scanner.set(
                new MTEScanner(SCANNER_EV.ID, "basicmachine.scanner.tier.04", "Advanced Scanner III", 4)
                        .getStackForm(1L));
        ItemList.Machine_IV_Scanner.set(
                new MTEScanner(SCANNER_IV.ID, "basicmachine.scanner.tier.05", "Advanced Scanner IV", 5)
                        .getStackForm(1L));
        ItemList.ScannerLuV.set(
                new MTEScanner(SCANNER_LuV.ID, "basicmachine.scanner.tier.06", "Elite Scanner", 6).getStackForm(1L));
    ...
    private static void registerPackager() {
        ItemList.Machine_LV_Boxinator.set(
                new MTEBoxinator(PACKAGER_LV.ID, "basicmachine.boxinator.tier.01", "Basic Packager", 1)
                        .getStackForm(1L));
        ...
        ItemList.Machine_IV_Boxinator.set(
                new MTEBoxinator(PACKAGER_IV.ID, "basicmachine.boxinator.tier.05", "Boxinator", 5).getStackForm(1L));
        ItemList.Machine_LuV_Boxinator.set(
                new MTEBoxinator(PACKAGER_LuV.ID, "basicmachine.boxinator.tier.06", "Boxinator", 6).getStackForm(1L));
        ItemList.Machine_ZPM_Boxinator.set(
                new MTEBoxinator(PACKAGER_ZPM.ID, "basicmachine.boxinator.tier.07", "Boxinator", 7).getStackForm(1L));
        ItemList.Machine_UV_Boxinator.set(
                new MTEBoxinator(PACKAGER_UV.ID, "basicmachine.boxinator.tier.08", "Boxinator", 8).getStackForm(1L));
    }
    ...
    private static void registerBrewery() {
        ItemList.Machine_LV_Brewery.set(
                new MTEPotionBrewer(BREWERY_LV.ID, "basicmachine.brewery.tier.01", "Basic Brewery", 1)
                        .getStackForm(1L));
        ItemList.Machine_MV_Brewery.set(
                new MTEPotionBrewer(BREWERY_MV.ID, "basicmachine.brewery.tier.02", "Advanced Brewery", 2)
                        .getStackForm(1L));
        ...
        ItemList.BreweryLuV.set(
                new MTEPotionBrewer(BREWERY_LuV.ID, "basicmachine.brewery.tier.06", "Elite Brewery", 6)
                        .getStackForm(1L));
    ...
    private static void registerMachineHull() {
        ...
        ItemList.Hull_ULV.set(
                new MTEBasicHull(HULL_ULV.ID, "hull.tier.00", "ULV Machine Hull", 0, imagination).getStackForm(1L));
        ItemList.Hull_LV
        ...
        ItemList.Hull_LuV.set(
                new MTEBasicHull(HULL_LuV.ID, "hull.tier.06", "LuV Machine Hull", 6, imagination).getStackForm(1L));
        ItemList.Hull_ZPM.set(
                new MTEBasicHull(HULL_ZPM.ID, "hull.tier.07", "ZPM Machine Hull", 7, imagination).getStackForm(1L));
        ItemList.Hull_UV
                .set(new MTEBasicHull(HULL_UV.ID, "hull.tier.08", "UV Machine Hull", 8, imagination).getStackForm(1L));
        ItemList.Hull_MAX.set(
                new MTEBasicHull(HULL_UHV.ID, "hull.tier.09", "UHV Machine Hull", 9, imagination).getStackForm(1L));
        ...
        ItemList.Hull_UEV.set(
                new MTEBasicHull(
                        ...
                        "UEV Machine Hull",
                        10,
                        LoaderMetaTileEntities.imagination).getStackForm(1L));
    ...
    private void registerElectricFurnace() {
        ItemList.Machine_LV_E_Furnace.set(
                new MTEBasicMachineWithRecipe(
                        ...
                        MTEBasicMachineWithRecipe.SpecialEffects.NONE,
                        "ELECTRIC_FURNACE").setProgressBarTextureName("E_Furnace").getStackForm(1L));
    ...
    private static void registerOven() {
        ItemList.Machine_LV_Oven.set(
                new MTEBasicMachineWithRecipe(
                        ...
                        SoundResource.IC2_MACHINES_ELECTROFURNACE_LOOP,
                        MTEBasicMachineWithRecipe.SpecialEffects.NONE,
                        "ELECTRIC_OVEN").setProgressBarTextureName("E_Oven").getStackForm(1L));
    ...
    private static void registerDynamoHatch() {
        ItemList.Hatch_Dynamo_ULV.set(
                new MTEHatchDynamo(DYNAMO_HATCH_ULV.ID, "hatch.dynamo.tier.00", "ULV Dynamo Hatch", 0)
                        .getStackForm(1L));
        ItemList.Hatch_Dynamo_LV.set(
                new MTEHatchDynamo(DYNAMO_HATCH_LV.ID, "hatch.dynamo.tier.01", "LV Dynamo Hatch", 1).getStackForm(1L));
        ItemList.Hatch_Dynamo_MV.set(
                new MTEHatchDynamo(DYNAMO_HATCH_MV.ID, "hatch.dynamo.tier.02", "MV Dynamo Hatch", 2).getStackForm(1L));
        ItemList.Hatch_Dynamo_HV.set(
                new MTEHatchDynamo(DYNAMO_HATCH_HV.ID, "hatch.dynamo.tier.03", "HV Dynamo Hatch", 3).getStackForm(1L));
        ItemList.Hatch_Dynamo_EV.set(
                new MTEHatchDynamo(DYNAMO_HATCH_EV.ID, "hatch.dynamo.tier.04", "EV Dynamo Hatch", 4).getStackForm(1L));
        ItemList.Hatch_Dynamo_IV.set(
                new MTEHatchDynamo(DYNAMO_HATCH_IV.ID, "hatch.dynamo.tier.05", "IV Dynamo Hatch", 5).getStackForm(1L));
        ItemList.Hatch_Dynamo_LuV.set(
                new MTEHatchDynamo(DYNAMO_HATCH_LuV.ID, "hatch.dynamo.tier.06", "LuV Dynamo Hatch", 6)
                        .getStackForm(1L));
        ItemList.Hatch_Dynamo_ZPM.set(
                new MTEHatchDynamo(DYNAMO_HATCH_ZPM.ID, "hatch.dynamo.tier.07", "ZPM Dynamo Hatch", 7)
                        .getStackForm(1L));
        ItemList.Hatch_Dynamo_UV.set(
                new MTEHatchDynamo(DYNAMO_HATCH_UV.ID, "hatch.dynamo.tier.08", "UV Dynamo Hatch", 8).getStackForm(1L));
        ItemList.Hatch_Dynamo_UHV.set(
                new MTEHatchDynamo(DYNAMO_HATCH_UHV.ID, "hatch.dynamo.tier.09", "UHV Dynamo Hatch", 9)
                        .getStackForm(1L));
        ItemList.Hatch_Dynamo_UEV.set(
                new MTEHatchDynamo(DYNAMO_HATCH_UEV.ID, "hatch.dynamo.tier.10", "UEV Dynamo Hatch", 10)
                        .getStackForm(1L));

        ItemList.Hatch_Dynamo_UIV.set(
                new MTEHatchDynamo(DYNAMO_HATCH_UIV.ID, "hatch.dynamo.tier.11", "UIV Dynamo Hatch", 11)
                        .getStackForm(1L));

        ItemList.Hatch_Dynamo_UMV.set(
                new MTEHatchDynamo(DYNAMO_HATCH_UMV.ID, "hatch.dynamo.tier.12", "UMV Dynamo Hatch", 12)
                        .getStackForm(1L));

        ItemList.Hatch_Dynamo_UXV.set(
                new MTEHatchDynamo(DYNAMO_HATCH_UXV.ID, "hatch.dynamo.tier.13", "UXV Dynamo Hatch", 13)
                        .getStackForm(1L));
    }

    private static void registerEnergyHatch() {
        ItemList.Hatch_Energy_ULV.set(
                new MTEHatchEnergy(ENERGY_HATCH_ULV.ID, "hatch.energy.tier.00", "ULV Energy Hatch", 0)
                        .getStackForm(1L));
        ItemList.Hatch_Energy_LV.set(
                new MTEHatchEnergy(ENERGY_HATCH_LV.ID, "hatch.energy.tier.01", "LV Energy Hatch", 1).getStackForm(1L));
        ItemList.Hatch_Energy_MV.set(
                new MTEHatchEnergy(ENERGY_HATCH_MV.ID, "hatch.energy.tier.02", "MV Energy Hatch", 2).getStackForm(1L));
        ItemList.Hatch_Energy_HV.set(
                new MTEHatchEnergy(ENERGY_HATCH_HV.ID, "hatch.energy.tier.03", "HV Energy Hatch", 3).getStackForm(1L));
        ItemList.Hatch_Energy_EV.set(
                new MTEHatchEnergy(ENERGY_HATCH_EV.ID, "hatch.energy.tier.04", "EV Energy Hatch", 4).getStackForm(1L));
        ItemList.Hatch_Energy_IV.set(
                new MTEHatchEnergy(ENERGY_HATCH_IV.ID, "hatch.energy.tier.05", "IV Energy Hatch", 5).getStackForm(1L));
        ItemList.Hatch_Energy_LuV.set(
                new MTEHatchEnergy(ENERGY_HATCH_LuV.ID, "hatch.energy.tier.06", "LuV Energy Hatch", 6)
                        .getStackForm(1L));
        ItemList.Hatch_Energy_ZPM.set(
                new MTEHatchEnergy(ENERGY_HATCH_ZPM.ID, "hatch.energy.tier.07", "ZPM Energy Hatch", 7)
                        .getStackForm(1L));
        ItemList.Hatch_Energy_UV.set(
                new MTEHatchEnergy(ENERGY_HATCH_UV.ID, "hatch.energy.tier.08", "UV Energy Hatch", 8).getStackForm(1L));
        ItemList.Hatch_Energy_UHV.set(
                new MTEHatchEnergy(ENERGY_HATCH_UHV.ID, "hatch.energy.tier.09", "UHV Energy Hatch", 9)
                        .getStackForm(1L));
        ItemList.Hatch_Energy_UEV.set(
                new MTEHatchEnergy(ENERGY_HATCH_UEV.ID, "hatch.energy.tier.10", "UEV Energy Hatch", 10)
                        .getStackForm(1L));

        ItemList.Hatch_Energy_UIV.set(
                new MTEHatchEnergy(ENERGY_HATCH_UIV.ID, "hatch.energy.tier.11", "UIV Energy Hatch", 11)
                        .getStackForm(1L));

        ItemList.Hatch_Energy_UMV.set(
                new MTEHatchEnergy(ENERGY_HATCH_UMV.ID, "hatch.energy.tier.12", "UMV Energy Hatch", 12)
                        .getStackForm(1L));

        ItemList.Hatch_Energy_UXV.set(
                new MTEHatchEnergy(ENERGY_HATCH_UXV.ID, "hatch.energy.tier.13", "UXV Energy Hatch", 13)
                        .getStackForm(1L));
    }
    ...
    private static void registerInputHatch() {
        ...
        ItemList.Hatch_Input_LV.set(
                new MTEHatchInput(INPUT_HATCH_LV.ID, "hatch.input.tier.01", "Input Hatch (LV)", 1).getStackForm(1L));
        ItemList.Hatch_Input_MV.set(
                new MTEHatchInput(INPUT_HATCH_MV.ID, "hatch.input.tier.02", "Input Hatch (MV)", 2).getStackForm(1L));
        ItemList.Hatch_Input_HV.set(
                new MTEHatchInput(INPUT_HATCH_HV.ID, "hatch.input.tier.03", "Input Hatch (HV)", 3).getStackForm(1L));
        ItemList.Hatch_Input_EV.set(
                new MTEHatchInput(INPUT_HATCH_EV.ID, "hatch.input.tier.04", "Input Hatch (EV)", 4).getStackForm(1L));
        ItemList.Hatch_Input_IV.set(
                new MTEHatchInput(INPUT_HATCH_IV.ID, "hatch.input.tier.05", "Input Hatch (IV)", 5).getStackForm(1L));
        ItemList.Hatch_Input_LuV.set(
                new MTEHatchInput(INPUT_HATCH_LuV.ID, "hatch.input.tier.06", "Input Hatch (LuV)", 6).getStackForm(1L));
        ItemList.Hatch_Input_ZPM.set(
                new MTEHatchInput(INPUT_HATCH_ZPM.ID, "hatch.input.tier.07", "Input Hatch (ZPM)", 7).getStackForm(1L));
        ItemList.Hatch_Input_UV.set(
                new MTEHatchInput(INPUT_HATCH_UV.ID, "hatch.input.tier.08", "Input Hatch (UV)", 8).getStackForm(1L));
        ItemList.Hatch_Input_UHV.set(
                new MTEHatchInput(INPUT_HATCH_UHV.ID, "hatch.input.tier.09", "Input Hatch (UHV)", 9).getStackForm(1L));
    ...
    private static void registerOutputHatch() {
        ItemList.Hatch_Output_ULV.set(
                new MTEHatchOutput(OUTPUT_HATCH_ULV.ID, "hatch.output.tier.00", "Output Hatch (ULV)", 0)
                        .getStackForm(1L));
        ...
        ItemList.Hatch_Output_HV.set(
                new MTEHatchOutput(OUTPUT_HATCH_HV.ID, "hatch.output.tier.03", "Output Hatch (HV)", 3)
                        .getStackForm(1L));
        ItemList.Hatch_Output_EV.set(
                new MTEHatchOutput(OUTPUT_HATCH_EV.ID, "hatch.output.tier.04", "Output Hatch (EV)", 4)
                        .getStackForm(1L));
        ItemList.Hatch_Output_IV.set(
                new MTEHatchOutput(OUTPUT_HATCH_IV.ID, "hatch.output.tier.05", "Output Hatch (IV)", 5)
                        .getStackForm(1L));
        ItemList.Hatch_Output_LuV.set(
                new MTEHatchOutput(OUTPUT_HATCH_LuV.ID, "hatch.output.tier.06", "Output Hatch (LuV)", 6)
                        .getStackForm(1L));
        ItemList.Hatch_Output_ZPM.set(
                new MTEHatchOutput(OUTPUT_HATCH_ZPM.ID, "hatch.output.tier.07", "Output Hatch (ZPM)", 7)
                        .getStackForm(1L));
        ItemList.Hatch_Output_UV.set(
                new MTEHatchOutput(OUTPUT_HATCH_UV.ID, "hatch.output.tier.08", "Output Hatch (UV)", 8)
                        .getStackForm(1L));
        ItemList.Hatch_Output_UHV.set(
                new MTEHatchOutput(OUTPUT_HATCH_UHV.ID, "hatch.output.tier.09", "Output Hatch (UHV)", 9)
                        .getStackForm(1L));
        ItemList.Hatch_Output_UEV.set(
                new MTEHatchOutput(OUTPUT_HATCH_UEV.ID, "hatch.output.tier.10", "Output Hatch (UEV)", 10)
                        .getStackForm(1L));
        ItemList.Hatch_Output_UIV.set(
                new MTEHatchOutput(OUTPUT_HATCH_UIV.ID, "hatch.output.tier.11", "Output Hatch (UIV)", 11)
                        .getStackForm(1L));
        ItemList.Hatch_Output_UMV.set(
                new MTEHatchOutput(OUTPUT_HATCH_UMV.ID, "hatch.output.tier.12", "Output Hatch (UMV)", 12)
                        .getStackForm(1L));
        ItemList.Hatch_Output_UXV.set(
                new MTEHatchOutput(OUTPUT_HATCH_UXV.ID, "hatch.output.tier.13", "Output Hatch (UXV)", 13)
                        .getStackForm(1L));
        ItemList.Hatch_Output_MAX.set(
                new MTEHatchOutput(OUTPUT_HATCH_MAX.ID, "hatch.output.tier.14", "Output Hatch (MAX)", 14)
                        .getStackForm(1L));
    }
    ...
    private static void registerQuantumTank() {
        ItemList.Quantum_Tank_LV.set(
                new MTEQuantumTank(QUANTUM_TANK_LV.ID, "quantum.tank.tier.06", "Quantum Tank I", 6).getStackForm(1L));
        ItemList.Quantum_Tank_MV.set(
                new MTEQuantumTank(QUANTUM_TANK_MV.ID, "quantum.tank.tier.07", "Quantum Tank II", 7).getStackForm(1L));
        ...
        ItemList.Quantum_Tank_EV.set(
                new MTEQuantumTank(QUANTUM_TANK_EV.ID, "quantum.tank.tier.09", "Quantum Tank IV", 9).getStackForm(1L));
        ItemList.Quantum_Tank_IV.set(
                new MTEQuantumTank(QUANTUM_TANK_IV.ID, "quantum.tank.tier.10", "Quantum Tank V", 10).getStackForm(1L));
    }

    private static void registerQuantumChest() {
        ItemList.Quantum_Chest_LV.set(
                new MTEQuantumChest(QUANTUM_CHEST_LV.ID, "quantum.chest.tier.06", "Quantum Chest I", 6)
                        .getStackForm(1L));
        ItemList.Quantum_Chest_MV.set(
                new MTEQuantumChest(QUANTUM_CHEST_MV.ID, "quantum.chest.tier.07", "Quantum Chest II", 7)
                        .getStackForm(1L));
        ItemList.Quantum_Chest_HV.set(
                new MTEQuantumChest(QUANTUM_CHEST_HV.ID, "quantum.chest.tier.08", "Quantum Chest III", 8)
                        .getStackForm(1L));
        ItemList.Quantum_Chest_EV.set(
                new MTEQuantumChest(QUANTUM_CHEST_EV.ID, "quantum.chest.tier.09", "Quantum Chest IV", 9)
                        .getStackForm(1L));
        ItemList.Quantum_Chest_IV.set(
                new MTEQuantumChest(QUANTUM_CHEST_IV.ID, "quantum.chest.tier.10", "Quantum Chest V", 10)
                        .getStackForm(1L));
    }
    ...
    private static void registerSuperChest() {
        ...
        ItemList.Super_Chest_HV.set(
                new MTESuperChest(SUPER_CHEST_HV.ID, "super.chest.tier.03", "Super Chest III", 3).getStackForm(1L));
    ...
    private static void registerAE2Hatches() {
        ItemList.Hatch_Output_Bus_ME.set(
                new MTEHatchOutputBusME(OUTPUT_BUS_ME.ID, "hatch.output_bus.me", "Output Bus (ME)").getStackForm(1L));
    ...
    private static void registerInputBus() {
        ItemList.Hatch_Input_Bus_ULV.set(
                new MTEHatchInputBus(INPUT_BUS_ULV.ID, "hatch.input_bus.tier.00", "Input Bus (ULV)", 0)
                        .getStackForm(1L));
        ...
        ItemList.Hatch_Input_Bus_LuV.set(
                new MTEHatchInputBus(INPUT_BUS_LuV.ID, "hatch.input_bus.tier.06", "Input Bus (LuV)", 6)
                        .getStackForm(1L));
        ItemList.Hatch_Input_Bus_ZPM.set(
                new MTEHatchInputBus(INPUT_BUS_ZPM.ID, "hatch.input_bus.tier.07", "Input Bus (ZPM)", 7)
                        .getStackForm(1L));
        ...
        ItemList.Hatch_Input_Bus_MAX.set(
                new MTEHatchInputBus(INPUT_BUS_UHV.ID, "hatch.input_bus.tier.09", "Input Bus (UHV)", 9)
                        .getStackForm(1L));
    }
    ...
    private static void registerOutputBus() {
        ...
        ItemList.Hatch_Output_Bus_LV.set(
                new MTEHatchOutputBus(OUTPUT_BUS_LV.ID, "hatch.output_bus.tier.01", "Output Bus (LV)", 1)
                        .getStackForm(1L));
        ItemList.Hatch_Output_Bus_MV.set(
                new MTEHatchOutputBus(OUTPUT_BUS_MV.ID, "hatch.output_bus.tier.02", "Output Bus (MV)", 2)
                        .getStackForm(1L));
        ItemList.Hatch_Output_Bus_HV.set(
                new MTEHatchOutputBus(OUTPUT_BUS_HV.ID, "hatch.output_bus.tier.03", "Output Bus (HV)", 3)
                        .getStackForm(1L));
        ItemList.Hatch_Output_Bus_EV.set(
                new MTEHatchOutputBus(OUTPUT_BUS_EV.ID, "hatch.output_bus.tier.04", "Output Bus (EV)", 4)
                        .getStackForm(1L));
        ItemList.Hatch_Output_Bus_IV.set(
                new MTEHatchOutputBus(OUTPUT_BUS_IV.ID, "hatch.output_bus.tier.05", "Output Bus (IV)", 5)
                        .getStackForm(1L));
        ...
        ItemList.Hatch_Output_Bus_UV.set(
                new MTEHatchOutputBus(OUTPUT_BUS_UV.ID, "hatch.output_bus.tier.08", "Output Bus (UV)", 8)
                        .getStackForm(1L));
    ...
    private static void registerBoiler() {
        ...
        ItemList.Machine_Bronze_Boiler_Solar.set(
                new MTEBoilerSolar(SIMPLE_SOLAR_BOILER.ID, "boiler.solar", "Simple Solar Boiler").getStackForm(1L));
    ...
    public void run() {
        ...
        ItemList.Hatch_DataAccess_EV.set(
                new MTEHatchDataAccess(DATA_ACCESS_HATCH.ID, "hatch.dataaccess", "Data Access Hatch", 4)
                        .getStackForm(1L));
        ...
        ItemList.Hatch_HeatSensor.set(
                new MTEHeatSensor(HEAT_DETECTOR_HATCH.ID, "hatch.heatsensor", "Heat Sensor Hatch", 7).getStackForm(1));
        ...
        ItemList.Hatch_LensHousing.set(
                new MTEHatchLensHousing(HATCH_LENS_HOUSING.ID, "hatch.lenshousing", "Lens Housing").getStackForm(1L));
