...
public class LoaderMetaTileEntities implements Runnable { // TODO CHECK CIRCUIT RECIPES AND USAGES
    ...
    private static void generateWiresAndPipes() {
        ...
        generateFluidMultiPipes(
            ...
            2147483647,
            true);
        generateFluidPipes(Materials.Stronze, Materials.Stronze.mName, 5320, 15000, 10000, true);
        generateFluidPipes(Materials.CompressedSteam, Materials.CompressedSteam.mName, 5330, 250000, 10000, true);
        ...
        generateItemPipes(Materials.Breel, Materials.Breel.mName, 5730, 64);
