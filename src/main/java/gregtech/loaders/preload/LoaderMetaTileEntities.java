...
public class LoaderMetaTileEntities implements Runnable { // TODO CHECK CIRCUIT RECIPES AND USAGES
    ...
    private static void generateWiresAndPipes() {
        ...
        makeWires(Materials.Cobalt, 1200, 1L, 3L, 3L, GTValues.V[1], true, false);
        ...
        makeWires(Materials.Copper, 1360, 2L, 4L, 2L, GTValues.V[2], true, false);
        makeWires(Materials.AnnealedCopper, 1380, 1L, 2L, 2L, GTValues.V[2], true, false);
        ...
        makeWires(Materials.BlackSteel, 1540, 2L, 4L, 4L, GTValues.V[4], true, false);
        makeWires(Materials.Titanium, 1560, 1L, 2L, 4L, GTValues.V[4], true, false);
        ...
        makeWires(Materials.VanadiumGallium, 1740, 4L, 4L, 4L, GTValues.V[6], true, false);
        makeWires(Materials.YttriumBariumCuprate, 1760, 3L, 6L, 6L, GTValues.V[6], true, false);

        makeWires(Materials.Naquadah, 1780, 2L, 4L, 4L, GTValues.V[7], true, false);
        ...
        makeWires(Materials.Ichorium, 2600, 4L, 4L, 12L, GTValues.V[9], false, true);
