...
public class GT_Loader_Item_Block_And_Fluid implements Runnable {
    ...
    public void run() {
        ...
        // 1234
        GT_Mod.gregtechproxy.addFluid("DimensionallyTranscendentCrudeCatalyst", "Dimensionally Transcendent Crude Catalyst", Materials.DimensionallyTranscendentCrudeCatalyst, 2, 500000000, GT_OreDictUnificator.get(OrePrefixes.cell, Materials.DimensionallyTranscendentCrudeCatalyst, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 1000);
        GT_Mod.gregtechproxy.addFluid("DimensionallyTranscendentProsaicCatalyst", "Dimensionally Transcendent Prosaic Catalyst", Materials.DimensionallyTranscendentProsaicCatalyst, 2, 500000000, GT_OreDictUnificator.get(OrePrefixes.cell, Materials.DimensionallyTranscendentProsaicCatalyst, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 1000);
        GT_Mod.gregtechproxy.addFluid("DimensionallyTranscendentResplendentCatalyst", "Dimensionally Transcendent Resplendent Catalyst", Materials.DimensionallyTranscendentResplendentCatalyst, 2, 500000000, GT_OreDictUnificator.get(OrePrefixes.cell, Materials.DimensionallyTranscendentResplendentCatalyst, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 1000);
        GT_Mod.gregtechproxy.addFluid("DimensionallyTranscendentExoticCatalyst", "Dimensionally Transcendent Exotic Catalyst", Materials.DimensionallyTranscendentExoticCatalyst, 2, 500000000, GT_OreDictUnificator.get(OrePrefixes.cell, Materials.DimensionallyTranscendentExoticCatalyst, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 1000);
