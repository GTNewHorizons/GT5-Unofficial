...
public class LoaderGTBlockFluid implements Runnable {
    ...
    public void run() {
        ...
        // LegacyNameDomain.contains excludes markers/superconductors and non-legacy reconstructions, so a registry
        // material with no legacy name -- a werkstoff or gtpp reconstruction -- is skipped rather than gaining
        // an autogenerated fluid it never had (a naive getMaterials() swap would triple the loop).
