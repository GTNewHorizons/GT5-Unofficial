...
public class LoaderGTBlockFluid implements Runnable {
    ...
    public void run() {
        ...
        for (Material material : MaterialLibAPI.getMaterials()) {
            ...
            if ((GTFluid.DUMP_MODE || !MaterialUtils.hasMolten(material))
                ...
                if (smeltInto != material && (GTFluid.DUMP_MODE || !MaterialUtils.hasMolten(smeltInto))) {
            ...
            if (MaterialUtils.element(material) != null
                || (MaterialUtils.generates(material, GTMaterialGenerationFlag.PLASMA)
                    && !MaterialUtils.iconSet(material).is_custom)) {
