    ...
    public void run() {
        ...
        GTOreDictUnificator.addItemData(
            ...
            new ItemData(
                Materials.Stone,
                696729600L,
                new MaterialStack(Materials.Wood, 464486400L)));
        GTOreDictUnificator.addItemData(
            GTModHandler.getModItem(TwilightForest.ID, "item.giantSword", 1L, 0),
            new ItemData(
                Materials.Stone,
                464486400L,
                new MaterialStack(Materials.Wood, 232243200L)));
        GTOreDictUnificator.addItemData(
        ...
        GTOreDictUnificator
            .addItemData(ItemList.TF_LiveRoot.get(1L), new ItemData(Materials.LiveRoot, 3628800L));
        GTOreDictUnificator.addItemData(
        ...
        GTOreDictUnificator
            .addItemData(new ItemStack(Blocks.snow, 1, 32767), new ItemData(Materials.Snow, 14515200L));
        GTOreDictUnificator.addItemData(
        ...
        GTOreDictUnificator
            .addItemData(new ItemStack(Blocks.ice, 1, 32767), new ItemData(Materials.Ice, 3628800L));
        GTOreDictUnificator
        ...
        GTOreDictUnificator
            .addItemData(new ItemStack(Blocks.clay, 1, 32767), new ItemData(Materials.Clay, 7257600L));
        GTOreDictUnificator.addItemData(
        ...
        GTOreDictUnificator
            .addItemData(ItemList.IC2_Uranium_238.get(1), new ItemData(Materials.Uranium, 3628800L));
        GTOreDictUnificator
            .addItemData(ItemList.IC2_Uranium_235.get(1), new ItemData(Materials.Uranium235, 3628800L));
        GTOreDictUnificator
            .addItemData(ItemList.IC2_Plutonium.get(1), new ItemData(Materials.Plutonium, 3628800L));
        GTOreDictUnificator
        ...
        GTOreDictUnificator
            .addItemData(ItemList.IC2_Item_Casing_Iron.get(1L), new ItemData(Materials.Iron, 1814400L));
        GTOreDictUnificator
            .addItemData(ItemList.IC2_Item_Casing_Gold.get(1L), new ItemData(Materials.Gold, 1814400L));
        GTOreDictUnificator
        ...
        GTOreDictUnificator
            .addItemData(ItemList.IC2_Item_Casing_Tin.get(1L), new ItemData(Materials.Tin, 1814400L));
        GTOreDictUnificator
            .addItemData(ItemList.IC2_Item_Casing_Lead.get(1L), new ItemData(Materials.Lead, 1814400L));
        GTOreDictUnificator
            .addItemData(ItemList.IC2_Item_Casing_Steel.get(1L), new ItemData(Materials.Steel, 1814400L));
        GTOreDictUnificator
            .addItemData(new ItemStack(Items.book, 1, 32767), new ItemData(Materials.Paper, 10886400L));
        GTOreDictUnificator.addItemData(
        ...
        GTOreDictUnificator.addItemData(
            ...
            new ItemData(Materials.Gold, OrePrefixes.nugget.getMaterialAmount() * 8L));
        GTOreDictUnificator
            .addItemData(new ItemStack(Items.minecart, 1), new ItemData(Materials.Iron, 18144000L));
        GTOreDictUnificator
            .addItemData(new ItemStack(Items.iron_door, 1), new ItemData(Materials.Iron, 21772800L));
        GTOreDictUnificator
            .addItemData(new ItemStack(Items.cauldron, 1), new ItemData(Materials.Iron, 25401600L));
        GTOreDictUnificator
        ...
        ImmutableMap.of(
            ...
            ImmutableMap.<String, Material>builder()
                .put("AluminiumBars", Materials.Aluminium)
                .put("ChromeBars", Materials.Chrome)
                .put("IridiumBars", Materials.Iridium)
                .put("NeutroniumBars", Materials.Neutronium)
                .put("OsmiumBars", Materials.Osmium)
                .put("StainlessSteelBars", Materials.StainlessSteel)
                .put("SteelBars", Materials.Steel)
                .put("TitaniumBars", Materials.Titanium)
                .put("TungstenSteelBars", Materials.TungstenSteel)
                .build(),
            EnderIO.ID,
            ImmutableMap.<String, Material>builder()
        ...
        GTOreDictUnificator
            .addItemData(ItemList.IC2_Food_Can_Empty.get(1L), new ItemData(Materials.Tin, 1814400L));
        GTOreDictUnificator
            .addItemData(ItemList.IC2_Fuel_Rod_Empty.get(1L), new ItemData(Materials.Iron, 3628800L));
        GTOreDictUnificator.addItemData(
        ...
        GTOreDictUnificator
            .addItemData(new ItemStack(Blocks.anvil, 1, 0), new ItemData(Materials.Iron, 108864000L));
        GTOreDictUnificator
            .addItemData(new ItemStack(Blocks.anvil, 1, 1), new ItemData(Materials.Iron, 72576000L));
        GTOreDictUnificator
            .addItemData(new ItemStack(Blocks.anvil, 1, 2), new ItemData(Materials.Iron, 36288000L));
        GTOreDictUnificator.addItemData(
            new ItemStack(Blocks.hopper, 1, 32767),
            new ItemData(Materials.Iron, 18144000L, new MaterialStack(Materials.Wood, 29030400L)));
        GTOreDictUnificator
            .addItemData(ItemList.Cell_Universal_Fluid.get(1L), new ItemData(Materials.Tin, 7257600L));
        ...
        GTOreDictUnificator
            .addItemData(ItemList.Bottle_Empty.get(1L), new ItemData(Materials.Glass, 3628800L));
        GTOreDictUnificator
        ...
        GTOreDictUnificator.addItemData(
            ...
            new ItemData(
                Materials.Gold,
                14515200L,
                new MaterialStack(Materials.Redstone, 3628800L)));
        GTOreDictUnificator.addItemData(
        ...
        GTOreDictUnificator.addItemData(
            ...
            new ItemData(
                Materials.EnderEye,
                3628800L,
                new MaterialStack(Materials.Obsidian, 29030400L)));
        GTOreDictUnificator.addItemData(
        ...
        GTOreDictUnificator
            .addItemData(new ItemStack(Blocks.packed_ice, 1, 32767), new ItemData(Materials.Ice, 7257600L));
        GTOreDictUnificator
            .addItemData(new ItemStack(Blocks.snow, 1, 32767), new ItemData(Materials.Snow, 3628800L));
        GTOreDictUnificator
            .addItemData(new ItemStack(Items.snowball, 1, 32767), new ItemData(Materials.Snow, 907200L));
        GTOreDictUnificator
            .addItemData(new ItemStack(Blocks.snow_layer, 1, 32767), new ItemData(Materials.Snow, -1L));
        GTOreDictUnificator
        ...
        GTOreDictUnificator
            .addItemData(new ItemStack(Blocks.fence, 1, 32767), new ItemData(Materials.Wood, 5443200L));
        GTOreDictUnificator
            .addItemData(new ItemStack(Items.bowl, 1, 32767), new ItemData(Materials.Wood, 3628800L));
        GTOreDictUnificator
            .addItemData(new ItemStack(Items.sign, 1, 32767), new ItemData(Materials.Wood, 7257600L));
        GTOreDictUnificator
        ...
        GTOreDictUnificator.addItemData(
            ...
            new ItemData(
                Materials.Wood,
                29030400L,
                new MaterialStack(Materials.Diamond, 3628800L)));
        GTOreDictUnificator.addItemData(
