...
public class LoaderGTItemData implements Runnable {
    ...
    public void run() {
        ...
        ImmutableMap.of(
                ...
                ImmutableMap.<String, Materials>builder().put("item.AluminiumBars", Materials.Aluminium)
                        ...
                        .put("item.IridiumBars", Materials.Iridium).put("item.NeutroniumBars", Materials.Neutronium)
                        .put("item.OsmiumBars", Materials.Osmium).put("item.PulsatingIronBars", Materials.PulsatingIron)
                        .put("item.RedstoneAlloyBars", Materials.RedstoneAlloy)
                        .put("item.SoulariumBars", Materials.Soularium)
                        .put("item.StainlessSteelBars", Materials.StainlessSteel).put("item.SteelBars", Materials.Steel)
                        .put("item.TitaniumBars", Materials.Titanium).put("item.TungstenBars", Materials.Tungsten)
                        .put("item.TungstenSteelBars", Materials.TungstenSteel)
                        .put("item.VibrantAlloyBars", Materials.VibrantAlloy).build(),
                EnderIO.ID,
                ImmutableMap.<String, Materials>builder().put("blockDarkIronBars", Materials.DarkSteel)
                        .put("blockEndSteelBars", Materials.EndSteel).put("blockSoulariumBars", Materials.Soularium)
                        .build())
                .forEach(
                        (modId, items) -> items
