...
public class GT_Loader_ItemData implements Runnable {
    ...
    public void run() {
        ...
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(TwilightForest.modID, "item.giantPick", 1L, 0),
                new ItemData(Materials.Stone, 696729600L, new MaterialStack(Materials.Wood, 464486400L)));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(TwilightForest.modID, "item.giantSword", 1L, 0),
                new ItemData(Materials.Stone, 464486400L, new MaterialStack(Materials.Wood, 232243200L)));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(TwilightForest.modID, "tile.GiantLog", 1L, 32767),
                new ItemData(Materials.Wood, 232243200L));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(TwilightForest.modID, "tile.GiantCobble", 1L, 32767),
                new ItemData(Materials.Stone, 232243200L));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(TwilightForest.modID, "tile.GiantObsidian", 1L, 32767),
                new ItemData(Materials.Obsidian, 232243200L));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(TwilightForest.modID, "item.minotaurAxe", 1L, 0),
                new ItemData(
                        Materials.Diamond,
                        14515200L,
                        new MaterialStack(Materials.Wood, OrePrefixes.stick.mMaterialAmount * 2L)));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(TwilightForest.modID, "item.armorShards", 1L, 0),
                new ItemData(Materials.Knightmetal, 403200L));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(TwilightForest.modID, "item.shardCluster", 1L, 0),
        ...
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(AppliedEnergistics2.modID, "item.ItemMultiMaterial", 1L, 10),
                new ItemData(Materials.CertusQuartz, 1814400L));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(AppliedEnergistics2.modID, "item.ItemMultiMaterial", 1L, 11),
                new ItemData(Materials.NetherQuartz, 1814400L));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(AppliedEnergistics2.modID, "item.ItemMultiMaterial", 1L, 12),
        ...
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(AppliedEnergistics2.modID, "tile.BlockQuartz", 1L, 32767),
                new ItemData(Materials.CertusQuartz, 14515200L));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(AppliedEnergistics2.modID, "tile.BlockQuartzPillar", 1L, 32767),
                new ItemData(Materials.CertusQuartz, 14515200L));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(AppliedEnergistics2.modID, "tile.BlockQuartzChiseled", 1L, 32767),
                new ItemData(Materials.CertusQuartz, 14515200L));
        ...
        GT_OreDictUnificator.addItemData(
                ...
                new ItemData(
                        ...
                        new MaterialStack(Materials.Redstone, OrePrefixes.dust.mMaterialAmount * 4L)));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(Forestry.modID, "craftingMaterial", 1L, 5),
        ...
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(Railcraft.modID, "tile.railcraft.anvil", 1L, 0),
                new ItemData(Materials.Steel, 108864000L));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(Railcraft.modID, "tile.railcraft.anvil", 1L, 1),
                new ItemData(Materials.Steel, 72576000L));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(Railcraft.modID, "tile.railcraft.anvil", 1L, 2),
        ...
        GT_OreDictUnificator.addItemData(
                ...
                new ItemData(Materials.Stone, 25401600L, new MaterialStack(Materials.Redstone, 3628800L)));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(Thaumcraft.modID, "ItemNuggetChicken", 1L, 32767),
                new ItemData(Materials.MeatCooked, 403200L));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(Thaumcraft.modID, "ItemNuggetBeef", 1L, 32767),
                new ItemData(Materials.MeatCooked, 403200L));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(Thaumcraft.modID, "ItemNuggetPork", 1L, 32767),
                new ItemData(Materials.MeatCooked, 403200L));
        GT_OreDictUnificator.addItemData(
                GT_ModHandler.getModItem(Thaumcraft.modID, "ItemNuggetFish", 1L, 32767),
                new ItemData(Materials.MeatCooked, 403200L));
        for (ItemStack tItem : new ItemStack[] { GT_ModHandler.getModItem(TwilightForest.modID, "item.meefRaw", 1L, 0),
                GT_ModHandler.getModItem(TwilightForest.modID, "item.venisonRaw", 1L, 0), new ItemStack(Items.porkchop),
