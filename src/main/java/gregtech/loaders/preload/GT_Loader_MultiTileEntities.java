...
public class GT_Loader_MultiTileEntities implements Runnable {
    ...
    public void run() {
        ...
        aRegistry.create(1000, MultiBlock_Macerator.class).name("Large Macerator").category("Multiblock Controller")
                ...
                .inputInventorySize(16).outputInventorySize(16).register();
        aRegistry.create(18000, BasicCasing.class).name("Test Casing").category("Multiblock Casing").setBlock(aMachine)
                .material(Materials.Cobalt).texture("metalwall").register();
        aRegistry.create(20001, InventoryUpgrade.class).name("Inventory Upgrade LV")
        ...
        aRegistry.create(20002, InventoryUpgrade.class).name("Inventory Upgrade MV")
        ...
        aRegistry.create(10000, MotorCasing.class).name("Motor Casing LV").tier(1)
