...
public class GT_MachineRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur, 8L), GT_Utility.getIntegratedCircuit(2), Materials.Chlorine.getFluid(8000),  MaterialsKevlar.SulfurDichloride.getFluid(4000), GT_Values.NI,800, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SulfurTrioxide, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.SulfurDichloride, 1L), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.ThionylChloride, 1L), 150, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SulfurTrioxide, 1L), GT_Utility.getIntegratedCircuit(2), MaterialsKevlar.SulfurDichloride.getFluid(1000L), MaterialsKevlar.ThionylChloride.getFluid(1000L), GT_Values.NI, 150, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.DimethylTerephthalate, 1L)}, new FluidStack[]{MaterialsKevlar.ThionylChloride.getFluid(1000)}, new FluidStack[]{MaterialsKevlar.TerephthaloylChloride.getFluid(1000L), Materials.DilutedHydrochloricAcid.getFluid(1000L)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SulfurDioxide, 1L)},400, 1920);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.DimethylTerephthalate, 9L)}, new FluidStack[]{MaterialsKevlar.ThionylChloride.getFluid(9000)}, new FluidStack[]{MaterialsKevlar.TerephthaloylChloride.getFluid(9000L), Materials.DilutedHydrochloricAcid.getFluid(9000L)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SulfurDioxide, 9L),3000, 1920);
