         ...
         * Adds recipes related to producing Polybenzimidazole.
     	 */
            private void addPolybenzimidazoleRecipes() {
            	...
            	//Nitrochlorobenzene
            	GT_Values.RA.addChemicalRecipe(Materials.Chlorobenzene.getCells(2), GT_Utility.getIntegratedCircuit(1), Materials.NitrationMixture.getFluid(1000), Materials.DilutedSulfuricAcid.getFluid(1000), Materials.Nitrochlorobenzene.getDust(1), ItemList.Cell_Empty.get(1L), 100, 480);
            	GT_Values.RA.addChemicalRecipe(Materials.Chlorobenzene.getCells(2), GT_Utility.getIntegratedCircuit(11), Materials.NitrationMixture.getFluid(1000), GT_Values.NF, Materials.DilutedSulfuricAcid.getCells(1), Materials.Nitrochlorobenzene.getDust(1),100, 480);
            	GT_Values.RA.addChemicalRecipe(Materials.NitrationMixture.getCells(2), GT_Utility.getIntegratedCircuit(1), Materials.Chlorobenzene.getFluid(1000), Materials.DilutedSulfuricAcid.getFluid(1000), Materials.Nitrochlorobenzene.getDust(1), ItemList.Cell_Empty.get(1L), 100, 480);
            	GT_Values.RA.addChemicalRecipe(Materials.NitrationMixture.getCells(2), GT_Utility.getIntegratedCircuit(11), Materials.Chlorobenzene.getFluid(1000), GT_Values.NF, Materials.DilutedSulfuricAcid.getCells(1), Materials.Nitrochlorobenzene.getDust(1),100, 480);
