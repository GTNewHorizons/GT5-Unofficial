...
//Kevlar Line
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 1L), ItemList.Cell_Empty.get(1L), Materials.NitricAcid.getFluid(4000), Materials.Water.getFluid(2000), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IronIIINitrate, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NitricAcid, 1),200, 30);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 9L)}, new FluidStack[]{Materials.NitricAcid.getFluid(36000)}, new FluidStack[]{Materials.Water.getFluid(18000), Materials.NitricOxide.getGas(9000)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IronIIINitrate, 9L)}, 100, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 2L), GT_Utility.getIntegratedCircuit(2), Materials.NitricAcid.getFluid(6000), Materials.Hydrogen.getGas(6000), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IronIIINitrate, 2L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NitricAcid, 2),400, 30);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(18), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 18L)}, new FluidStack[]{Materials.NitricAcid.getFluid(54000)}, new FluidStack[]{ Materials.Hydrogen.getGas(54000),}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IronIIINitrate, 18L)}, 200, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium, 2L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, MaterialsKevlar.IronIIINitrate, 1L), Materials.Ammonia.getGas(2000), Materials.Hydrogen.getGas(2000), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.Sodiumamide, 2L), 250, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium, 18L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IronIIINitrate, 1L)}, new FluidStack[]{Materials.Ammonia.getFluid(18000)}, new FluidStack[]{ Materials.Hydrogen.getGas(18000),}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.Sodiumamide, 18L)}, 2000, 480);
