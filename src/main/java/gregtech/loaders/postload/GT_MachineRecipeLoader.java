...
//        Quantumsuite
        ...
        */
        ...
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 	    Materials.Longasssuperconductornameforuhvwire, 1L), 		GT_Utility.getIntegratedCircuit(11), 		Materials.PerroxGas.getGas(20L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Longasssuperconductornameforuhvwire, 1L), GT_Values.NI,800, 122880, 10000);
        ...
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 	    Materials.Longasssuperconductornameforuevwire, 1L), 		GT_Utility.getIntegratedCircuit(11), 		Materials.PerroxGas.getGas(20L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Longasssuperconductornameforuevwire, 1L), GT_Values.NI,1000, 500000, 10000);
        ...
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.DraconiumAwakened, 1L), 		GT_Utility.getIntegratedCircuit(11), Materials.Argon.getGas(1000L), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.DraconiumAwakened, 1L), GT_Values.NI, 5000, 122880, 11000);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.DraconiumAwakened, 1L), 		GT_Utility.getIntegratedCircuit(11), Materials.PerroxGas.getGas(20L), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.DraconiumAwakened, 1L), GT_Values.NI, 1500, 122880, 11000);
        ...
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Quantium, 1L), 		GT_Utility.getIntegratedCircuit(11), Materials.PerroxGas.getGas(20L), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Quantium, 1L), GT_Values.NI, 750, 122880, 11000);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Quantium, 1L), 		GT_Utility.getIntegratedCircuit(11), Materials.Argon.getGas(1000L), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Quantium, 1L), GT_Values.NI, 3000, 122880, 11000);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Quantium, 1L), 		GT_Utility.getIntegratedCircuit(1), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Quantium, 1L), GT_Values.NI, 4800, 122880, 11000);
        
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.BlackPlutonium, 1L), 		GT_Utility.getIntegratedCircuit(11), Materials.PerroxGas.getGas(20L), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.BlackPlutonium, 1L), GT_Values.NI, 1000, 500000, 15000);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.BlackPlutonium, 1L), 		GT_Utility.getIntegratedCircuit(11), Materials.Argon.getGas(1000L), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.BlackPlutonium, 1L), GT_Values.NI, 4000, 500000, 15000);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.BlackPlutonium, 1L), 		GT_Utility.getIntegratedCircuit(1), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.BlackPlutonium, 1L), GT_Values.NI, 6400, 500000, 15000);
 	 ...
 	 */
       ...
       public void run3() {
    	...
    	GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Casing_Fusion_Coil.get(1L), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Infuscolium, 4), ItemList.Circuit_Crystalmainframe.get(6L), ItemList.Field_Generator_ZPM.get(2L), ItemList.Electric_Pump_ZPM.get(1L), GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Superconductor, 4), ItemList.Neutron_Reflector.get(4L), GT_Utility.getIntegratedCircuit(1)},Materials.ElectrumFlux.getMolten(864), ItemList.Casing_Fusion_Coil2.get(1L), 200, 500000, true);
   		...
   		GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Casing_Fusion_Coil.get(1L), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Infuscolium, 4), ItemList.Circuit_Piko.get(6L), ItemList.Field_Generator_ZPM.get(2L), ItemList.Electric_Pump_ZPM.get(1L), GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Superconductor, 4), ItemList.Neutron_Reflector.get(4L), GT_Utility.getIntegratedCircuit(1)},Materials.ElectrumFlux.getMolten(864), ItemList.Casing_Fusion_Coil2.get(1L), 200, 500000, true);
   		...
   		GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Casing_Fusion_Coil.get(2L), GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Neutronium, 4), ItemList.Circuit_Quantum.get(4L), ItemList.Field_Generator_UV.get(2L), ItemList.Electric_Pump_UV.get(1L), GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Superconductor, 6), ItemList.Neutron_Reflector.get(4L), GT_Utility.getIntegratedCircuit(1)},Materials.ElectrumFlux.getMolten(1728), ItemList.Casing_Fusion_Coil2.get(2L), 300, 2000000, true);
        ...
        ItemList.Casing_Fusion_Coil3.get(1, new Object[]{}), 800, 500000);
    	   ...
    	   if(Loader.isModLoaded("tectech")){
   		    TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Casing_Fusion_Coil3.get(1L), 12000,32, 500000, 6,new ItemStack[]{
        	 ...
        	 GT_Values.RA.addDistillationTowerRecipe(Materials.DelutedXenoxene.getFluid(1000),new FluidStack[]{Materials.Xenoxene.getFluid(250),Materials.RadoxLight.getGas(750)},Materials.Ash.getDust(1),600,500000);
        	   ...
        	   if(Loader.isModLoaded("GalaxySpace")){
        	        ...
        	        GT_Values.RA.addDistillationTowerRecipe(
        	        		Materials.RawRadox.getFluid(1000),
        	                new FluidStack[]{
        	                		Materials.OilHeavy.getFluid(200),
        	                		Materials.Oil.getFluid(100),
        	                		Materials.Creosote.getFluid(250),
        	                		Materials.Water.getFluid(300),
        	                		Materials.EnrichedBacterialSludge.getFluid(9),
        	                		Materials.FermentedBiomass.getFluid(10),
        	                		Materials.RadoxSuperHeavy.getFluid(10),
        	                		Materials.RadoxHeavy.getFluid(10),
        	                		Materials.DelutedXenoxene.getFluid(10),
        	                		Materials.RadoxLight.getGas(10),
        	                		Materials.RadoxSuperLight.getGas(1),
        	                },
        	        ...
        	        GT_Values.RA.addCrackingRecipe(
        	                24,
        	                Materials.RadoxSuperLight.getGas(100),
        	                Materials.Silver.getPlasma(1),
        	                Materials.RadoxCracked.getGas(100),
        	                500,500000);

        	        GT_Values.RA.addDistillationTowerRecipe(
        	        		Materials.RadoxCracked.getGas(1000),
        	                new FluidStack[]{
        	                		Materials.RadoxGas.getGas(1),
        	                		Materials.RadoxLight.getGas(999),
        	                },
        	                Materials.Ash.getDust(1),
        	                600,500000
        	        );
        	        ...
        	        GT_Values.RA.addMultiblockChemicalRecipe(
        	                ...
        	                new FluidStack[]{
        	                		Materials.RadoxGas.getGas(2160),
        	                		Materials.Oxygen.getPlasma(7500L),
        	        ...
        	        GT_Values.RA.addFluidSolidifierRecipe(ItemList.Shape_Mold_Ingot.get(0), Materials.RadoxPolymerHot.getGas(144), GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.RadoxPolymer, 1L), 100, 500000);
        	        GT_Values.RA.addVacuumFreezerRecipe(GT_OreDictUnificator.get(OrePrefixes.ingotHot,Materials.RadoxPolymer,1L),GT_OreDictUnificator.get(OrePrefixes.ingot,Materials.RadoxPolymer,1L),200,500000);
           }
      ...
      //EnderIO Fused Quartz and Glass
        ...
        //New coils
        GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stick, Materials.IronMagnetic, 1L), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Lead, 16L), GT_Utility.getIntegratedCircuit(1)}, GT_Values.NF, ItemList.ULV_Coil.get(1L), 200, 2, false);
        GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stick, Materials.IronMagnetic, 1L), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Steel, 16L), GT_Utility.getIntegratedCircuit(1)}, GT_Values.NF, ItemList.LV_Coil.get(1L), 200, 8, false);
        GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stick, Materials.SteelMagnetic, 1L), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Aluminium, 16L), GT_Utility.getIntegratedCircuit(1)}, GT_Values.NF, ItemList.MV_Coil.get(1L), 200, 30, false);
        GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stick, Materials.SteelMagnetic, 1L), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.EnergeticAlloy, 16L), GT_Utility.getIntegratedCircuit(1)}, GT_Values.NF, ItemList.HV_Coil.get(1L), 200, 120, false);
        GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stick, Materials.SteelMagnetic, 1L), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.TungstenSteel, 16L), GT_Utility.getIntegratedCircuit(1)}, GT_Values.NF, ItemList.EV_Coil.get(1L), 200, 480, false);
        GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stick, Materials.NeodymiumMagnetic, 1L), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Iridium, 16L), GT_Utility.getIntegratedCircuit(1)}, GT_Values.NF, ItemList.IV_Coil.get(1L), 200, 1920, false);
        GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stick, Materials.NeodymiumMagnetic, 1L), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Osmiridium, 16L), GT_Utility.getIntegratedCircuit(1)}, GT_Values.NF, ItemList.LuV_Coil.get(1L), 200, 7680, false);
        GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stick, Materials.EuropiumoxideMagnetic, 1L), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Europium, 16L), GT_Utility.getIntegratedCircuit(1)}, GT_Values.NF, ItemList.ZPM_Coil.get(1L), 200, 30720, false);
        GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stick, Materials.EuropiumoxideMagnetic, 1L), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.ElectrumFlux, 16L), GT_Utility.getIntegratedCircuit(1)}, GT_Values.NF, ItemList.UV_Coil.get(1L), 200, 122880, false);
        GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stick, Materials.EuropiumoxideMagnetic, 1L), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Infuscolium, 16L), GT_Utility.getIntegratedCircuit(1)}, GT_Values.NF, ItemList.UHV_Coil.get(1L), 200, 500000, false);
        GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stick, Materials.EuropiumoxideMagnetic, 1L), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Neutronium, 16L), GT_Utility.getIntegratedCircuit(1)}, GT_Values.NF, ItemList.UEV_Coil.get(1L), 200, 2000000, false);
        GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stick, Materials.EuropiumoxideMagnetic, 1L), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Quantium, 16L), GT_Utility.getIntegratedCircuit(1)}, GT_Values.NF, ItemList.UIV_Coil.get(1L), 200, 8000000, false);
    ...
    ItemList.Hatch_Dynamo_UIV.get(1, new Object[]{}), 1400, 32000000);
     ...
     // Vacuum Freezer
      ...
      //Fusion Coil
		...
		if(Loader.isModLoaded("tectech")){
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Electric_Motor_UV.get(1, new Object(){}),24000, 32, 100000, 4,new ItemStack[]{
	        ...
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Electric_Motor_UHV.get(1, new Object(){}),48000, 64, 500000, 8,new ItemStack[]{
	                ...
	                Materials.Naquadria.getMolten(5184)}, ItemList.Electric_Motor_UEV.get(1, new Object[]{}), 1000, 800000);
	    
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Electric_Pump_UV.get(1, new Object(){}),24000, 32, 100000, 4,new ItemStack[]{
	        ...
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Electric_Pump_UHV.get(1, new Object(){}),48000, 64, 500000, 8,new ItemStack[]{
	                ...
	                Materials.SolderingAlloy.getMolten(5184),
	                Materials.Lubricant.getFluid(8000),
	                Materials.Naquadria.getMolten(5184)}, ItemList.Electric_Pump_UEV.get(1, new Object[]{}), 1000, 800000);
	    
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Conveyor_Module_UV.get(1, new Object(){}),24000, 32, 100000, 4,new ItemStack[]{
	        ...
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Conveyor_Module_UHV.get(1, new Object(){}),48000, 64, 500000, 8,new ItemStack[]{
	                ...
	                Materials.Naquadria.getMolten(5184)}, ItemList.Conveyor_Module_UEV.get(1, new Object[]{}), 1000, 800000);
	    
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Electric_Piston_UV.get(1, new Object(){}),24000, 32, 100000, 4,new ItemStack[]{
                    ItemList.Electric_Motor_UHV.get(1, new Object(){}),
	        ...
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Electric_Piston_UHV.get(1, new Object(){}),48000, 64, 500000, 8,new ItemStack[]{
                    ItemList.Electric_Motor_UEV.get(1, new Object(){}),
                    ...
                    Materials.SolderingAlloy.getMolten(5184),
                    Materials.Lubricant.getFluid(8000),
                    Materials.Naquadria.getMolten(5184)}, ItemList.Electric_Piston_UEV.get(1, new Object[]{}), 1000, 800000);
        
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Robot_Arm_UV.get(1, new Object(){}),24000, 32, 100000, 4,new ItemStack[]{
                    GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.Infuscolium, 8L),
                    GT_OreDictUnificator.get(OrePrefixes.gear, Materials.NaquadahAlloy, 2L),
	        ...
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Robot_Arm_UHV.get(1, new Object(){}),48000, 64, 500000, 8,new ItemStack[]{
                    GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.Neutronium, 8L),
                    GT_OreDictUnificator.get(OrePrefixes.gear, Materials.Neutronium, 2L),
                    ...
                    Materials.Lubricant.getFluid(8000),
                    Materials.Naquadria.getMolten(5184)}, ItemList.Robot_Arm_UEV.get(1, new Object[]{}), 1000, 800000);
        
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Emitter_UV.get(1, new Object(){}),24000, 32, 100000, 4,new ItemStack[]{
	        ...
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Emitter_UHV.get(1, new Object(){}),48000, 64, 500000, 8,new ItemStack[]{
	        ...
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Sensor_UV.get(1, new Object(){}),24000, 32, 100000, 4,new ItemStack[]{
                    GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Americium, 1L),
                    ItemList.Electric_Motor_UHV.get(1, new Object(){}),
	        ...
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Sensor_UHV.get(1, new Object(){}),48000, 64, 500000, 8,new ItemStack[]{
                    GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Neutronium, 1L),
                    ItemList.Electric_Motor_UEV.get(1, new Object(){}),
	        ...
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Field_Generator_UV.get(1, new Object(){}),24000, 32, 100000, 4,new ItemStack[]{
                    GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Americium, 1L),
                    GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Infuscolium, 6L),
	        ...
	        TT_recipeAdder.addResearchableAssemblylineRecipe(ItemList.Field_Generator_UHV.get(1, new Object(){}),48000, 64, 500000, 8,new ItemStack[]{
                    GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Neutronium, 1L),
                    GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Neutronium, 6L),
