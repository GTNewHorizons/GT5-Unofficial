...
public class GT_MachineRecipeLoader implements Runnable {
	...
	GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 4L), GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.TungstenSteel, 1L), ItemList.Robot_Arm_IV.get(2L), GT_Utility.getIntegratedCircuit(3)}, GT_Values.NF, ItemList.Casing_Gearbox_TungstenSteel.get(1L), 200, 30);
        ...
        if (Loader.isModLoaded("bartworks") && (Loader.isModLoaded("miscutils"))){
            ...
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Butyraldehyde, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), GT_Values.NF, new FluidStack(FluidRegistry.getFluid("buthanol"), 1000), ItemList.Cell_Empty.get(2L),200, 30);
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Butyraldehyde, 1L), GT_Utility.getIntegratedCircuit(1), Materials.Hydrogen.getGas(1000), new FluidStack(FluidRegistry.getFluid("buthanol"), 1000), ItemList.Cell_Empty.get(2L),200, 30);
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), GT_Utility.getIntegratedCircuit(1), Materials.Butyraldehyde.getFluid(1000), new FluidStack(FluidRegistry.getFluid("buthanol"), 1000), ItemList.Cell_Empty.get(2L),200, 30);
            ...
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Butyraldehyde, 1L), GT_Utility.getIntegratedCircuit(2), Materials.Hydrogen.getGas(1000), GT_Values.NF, GT_ModHandler.getModItem("miscutils", "butanol", 1L), ItemList.Cell_Empty.get(1L), 200, 30);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 1L), GT_Utility.getIntegratedCircuit(1), Materials.CarbonMonoxide.getFluid(4000), Materials.NickelTetracarbonyl.getFluid(1000), GT_Values.NI,400, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.CarbonMonoxide, 4L), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.cell, Materials.NickelTetracarbonyl, 1L), ItemList.Cell_Empty.get(3L),400, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 1L), GT_Utility.getIntegratedCircuit(2), Materials.CarbonMonoxide.getFluid(4000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.cell, Materials.NickelTetracarbonyl, 1L), 400, 30);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Silver, 1L)}, new FluidStack[]{Materials.Ethylene.getGas(1000), Materials.Oxygen.getGas(1000)}, new FluidStack[]{Materials.EthylenOxide.getGas(1000)}, null,50, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silver, 1L)}, new FluidStack[]{Materials.Ethylene.getGas(9000), Materials.Oxygen.getGas(9000)}, new FluidStack[]{Materials.EthylenOxide.getGas(9000)}, null,400, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Ethylene, 1L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Silver, 1L), Materials.Oxygen.getFluid(1000), Materials.EthylenOxide.getGas(1000), ItemList.Cell_Empty.get(1L), 800, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Ethylene, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 5L), Materials.Dimethyldichlorosilane.getFluid(4000), Materials.SiliconOil.getFluid(1000), ItemList.Cell_Empty.get(6L), 600, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Ethylene, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Dimethyldichlorosilane, 4L), Materials.Water.getFluid(5000), Materials.SiliconOil.getFluid(1000), ItemList.Cell_Empty.get(5L), 600, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Dimethyldichlorosilane, 4L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 5L), Materials.Ethylene.getGas(1000), Materials.SiliconOil.getFluid(1000), ItemList.Cell_Empty.get(9L), 600, 480);
