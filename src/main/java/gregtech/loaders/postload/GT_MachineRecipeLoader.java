...
//Kevlar Line
        ...
        if (Loader.isModLoaded("bartworks") && (Loader.isModLoaded("miscutils"))){
            ...
            GT_Values.RA.addBlastRecipe(GT_ModHandler.getModItem("bartworks", "gt.bwMetaGenerateddust", 1L, 78), GT_Utility.getIntegratedCircuit(1), Materials.Chlorine.getGas(3000L), GT_Values.NF, MaterialsKevlar.RhodiumChloride.getDust(1), GT_Values.NI, 600, 480, 573);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Borax, 4L)}, new FluidStack[]{Materials.HydrofluoricAcid.getFluid(2000L)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("boricacid"), 2000), Materials.Water.getFluid(5000L)}, new ItemStack[]{Materials.Salt.getDust(5)},800, 480);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Borax, 36L)}, new FluidStack[]{Materials.HydrofluoricAcid.getFluid(18000L)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("boricacid"), 18000), Materials.Water.getFluid(45000L)}, new ItemStack[]{Materials.Salt.getDust(45)},6000, 480);
            ...
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.PhosphorusTrichloride, 6L), GT_OreDictUnificator.get(OrePrefixes.dust,MaterialsKevlar.RhodiumChloride, 2L)}, new FluidStack[]{Materials.CarbonMonoxide.getFluid(4000L), MaterialsKevlar.SodiumBorohydride.getFluid(2000L)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("phosgene"), 2000), Materials.Water.getFluid(6000L)}, new ItemStack[]{MaterialsKevlar.OrganorhodiumCatalyst.getDust(2)},800, 7680);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.PhosphorusTrichloride, 54L), GT_OreDictUnificator.get(OrePrefixes.dust,MaterialsKevlar.RhodiumChloride, 18L)}, new FluidStack[]{Materials.CarbonMonoxide.getFluid(36000L), MaterialsKevlar.SodiumBorohydride.getFluid(18000L)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("phosgene"), 18000), Materials.Water.getFluid(54000L)}, new ItemStack[]{MaterialsKevlar.OrganorhodiumCatalyst.getDust(18)},6000, 7680);
        }
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{MaterialsKevlar.ThionylChloride.getFluid(1000)}, new FluidStack[]{Materials.DilutedHydrochloricAcid.getFluid(1000L), Materials.SulfurDioxide.getGas(1000L), MaterialsKevlar.DimethylTerephthalate.getFluid(1000L)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.TerephthaloylChloride, 1L)},400, 1920);
        ...
        GT_Values.RA.addChemicalRecipe(Materials.Sodium.getDust(1), GT_Utility.getIntegratedCircuit(9), Materials.Hydrogen.getGas(9000L), GT_Values.NF, MaterialsKevlar.SodiumHydride.getDust(9),1500, 120);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{MaterialsKevlar.SodiumHydride.getFluid(4000L), MaterialsKevlar.TrimethylBorate.getFluid(1000L)}, new FluidStack[]{Materials.Water.getFluid(3000L), MaterialsKevlar.TrimethylBorate.getFluid(1000)},new ItemStack[]{MaterialsKevlar.SodiumBorohydride.getDust(1)},600, 1920);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9)}, new FluidStack[]{Materials.Methanol.getFluid(27000L), new FluidStack(FluidRegistry.getFluid("boricacid"), 9000)}, new FluidStack[]{Materials.Water.getFluid(27000L), MaterialsKevlar.TrimethylBorate.getFluid(9000)},null,4500, 960);
