...
public class GT_MachineRecipeLoader implements Runnable {
	...
	GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 4L), GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.TungstenSteel, 1L), ItemList.Robot_Arm_IV.get(2L), GT_Utility.getIntegratedCircuit(3)}, GT_Values.NF, ItemList.Casing_Gearbox_TungstenSteel.get(1L), 200, 30);
        ...
        GT_Values.RA.addUniversalDistillationRecipe(Materials.OilLight.getFluid(150),
                new FluidStack[]{ Materials.SulfuricHeavyFuel.getFluid(10),  Materials.SulfuricLightFuel.getFluid(20), Materials.SulfuricNaphtha.getFluid(30), Materials.SulfuricGas.getGas(240)}, null, 20, 96);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.OilMedium.getFluid(100),
                new FluidStack[]{Materials.SulfuricHeavyFuel.getFluid(15),  Materials.SulfuricLightFuel.getFluid(50), Materials.SulfuricNaphtha.getFluid(20), Materials.SulfuricGas.getGas(60)}, null, 20, 96);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Oil.getFluid(50L),
                new FluidStack[]{Materials.SulfuricHeavyFuel.getFluid(15),  Materials.SulfuricLightFuel.getFluid(50), Materials.SulfuricNaphtha.getFluid(20), Materials.SulfuricGas.getGas(60)}, null, 20, 96);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.OilHeavy.getFluid(100),
                new FluidStack[]{Materials.SulfuricHeavyFuel.getFluid(250), Materials.SulfuricLightFuel.getFluid(45), Materials.SulfuricNaphtha.getFluid(15), Materials.SulfuricGas.getGas(60)}, null, 20, 288);
...
//Kevlar Line
        ...
        if (Loader.isModLoaded("bartworks") && (Loader.isModLoaded("miscutils"))){
            ...
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.CopperIIOxide, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.BismuthIIIOxide, 1L),GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 1L)}, new FluidStack[]{MaterialsKevlar.Acetylene.getGas(1000L), new FluidStack(FluidRegistry.getFluid("formaldehyde"), 2000)}, null, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IIButinIIVdiol, 1L)},400, 1920);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.CopperIIOxide, 9L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.BismuthIIIOxide, 9L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 9L)}, new FluidStack[]{MaterialsKevlar.Acetylene.getGas(9000L), new FluidStack(FluidRegistry.getFluid("formaldehyde"), 18000)}, null, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IIButinIIVdiol, 9L)}, 3000, 1920);
        ...
        // DT Recipes to separate 1,2-Dimethylbenzene into the other isomers (IV-tier)
        GT_Values.RA.addDistillationTowerRecipe(Materials.Dimethylbenzene.getFluid(1000), new ItemStack[]{GT_Utility.getIntegratedCircuit(1)},
            new FluidStack[]{MaterialsKevlar.IIIDimethylbenzene.getFluid(100), MaterialsKevlar.IVDimethylbenzene.getFluid(900)},
            GT_Values.NI,  20, 7680);
        GT_Values.RA.addDistillationTowerRecipe(Materials.Dimethylbenzene.getFluid(1000), new ItemStack[]{GT_Utility.getIntegratedCircuit(2)},
            new FluidStack[]{MaterialsKevlar.IIIDimethylbenzene.getFluid(900), MaterialsKevlar.IVDimethylbenzene.getFluid(100)},
            GT_Values.NI,  20, 7680);

        // DT Recipes to separate 1,3-Dimethylbenzene into the other isomers (IV-tier)
        GT_Values.RA.addDistillationTowerRecipe(MaterialsKevlar.IIIDimethylbenzene.getFluid(1000), new ItemStack[]{GT_Utility.getIntegratedCircuit(1)},
            new FluidStack[]{Materials.Dimethylbenzene.getFluid(100), MaterialsKevlar.IVDimethylbenzene.getFluid(900)},
            GT_Values.NI,  20, 7680);
        GT_Values.RA.addDistillationTowerRecipe(MaterialsKevlar.IIIDimethylbenzene.getFluid(1000), new ItemStack[]{GT_Utility.getIntegratedCircuit(2)},
            new FluidStack[]{Materials.Dimethylbenzene.getFluid(900), MaterialsKevlar.IVDimethylbenzene.getFluid(100)},
            GT_Values.NI,  20, 7680);

        // DT Recipes to separate 1,4-Dimethylbenzene into the other isomers (IV-tier)
        GT_Values.RA.addDistillationTowerRecipe(MaterialsKevlar.IVDimethylbenzene.getFluid(1000), new ItemStack[]{GT_Utility.getIntegratedCircuit(1)},
            new FluidStack[]{Materials.Dimethylbenzene.getFluid(100), MaterialsKevlar.IIIDimethylbenzene.getFluid(900)},
            GT_Values.NI,  20, 7680);
        GT_Values.RA.addDistillationTowerRecipe(MaterialsKevlar.IVDimethylbenzene.getFluid(1000), new ItemStack[]{GT_Utility.getIntegratedCircuit(2)},
            new FluidStack[]{Materials.Dimethylbenzene.getFluid(900), MaterialsKevlar.IIIDimethylbenzene.getFluid(100)},
            GT_Values.NI,  20, 7680);

        // DT Recipe to get Naphthenic Acid from Sulfuric Naphtha (IV-tier)
        GT_Values.RA.addDistillationTowerRecipe(Materials.SulfuricNaphtha.getFluid(1000),
            new FluidStack[]{Materials.Naphtha.getFluid(700), MaterialsKevlar.NaphthenicAcid.getFluid(100)},
            Materials.Sulfur.getDust(1),  60, 7680);
