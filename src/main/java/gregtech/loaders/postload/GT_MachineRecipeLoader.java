...
public class GT_MachineRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.addCutterRecipe(new ItemStack[]{ItemList.Circuit_Silicon_Ingot.get(1)}, new ItemStack[]{ItemList.Circuit_Silicon_Wafer.get(16), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 4L)}, 400, 30, false);
        ...
        GT_Values.RA.addCutterRecipe(new ItemStack[]{ItemList.Circuit_Silicon_Ingot2.get(1)}, new ItemStack[]{ ItemList.Circuit_Silicon_Wafer2.get(32), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 8L)}, 800, 120, true);
        ...
        GT_Values.RA.addCutterRecipe(new ItemStack[]{ItemList.Circuit_Silicon_Ingot3.get(1)}, new ItemStack[]{ ItemList.Circuit_Silicon_Wafer3.get(64), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 16L)}, 1600, 480, true);
        ...
        GT_Values.RA.addCutterRecipe(new ItemStack[]{ItemList.Circuit_Silicon_Ingot4.get(1)}, new ItemStack[]{ItemList.Circuit_Silicon_Wafer4.get(64), ItemList.Circuit_Silicon_Wafer4.get(32), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 32L)}, 2400, 1920, true);
        ...
        GT_Values.RA.addCutterRecipe(new ItemStack[]{ItemList.Circuit_Silicon_Ingot5.get(1)}, new ItemStack[]{ItemList.Circuit_Silicon_Wafer5.get(64), ItemList.Circuit_Silicon_Wafer5.get(64), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 64L)}, 3200, 7680, true);
        ...
        GT_Values.RA.addDistillationTowerRecipe(Materials.OilLight.getFluid(150), new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{ Materials.SulfuricHeavyFuel.getFluid(10),  Materials.SulfuricLightFuel.getFluid(20), Materials.SulfuricNaphtha.getFluid(30), Materials.SulfuricGas.getGas(240)}, null, 20, 96);
        GT_Values.RA.addDistillationTowerRecipe(Materials.OilMedium.getFluid(100), new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{Materials.SulfuricHeavyFuel.getFluid(15),  Materials.SulfuricLightFuel.getFluid(50), Materials.SulfuricNaphtha.getFluid(20), Materials.SulfuricGas.getGas(60)}, null, 20, 96);
        GT_Values.RA.addDistillationTowerRecipe(Materials.Oil.getFluid(50L), new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{Materials.SulfuricHeavyFuel.getFluid(15),  Materials.SulfuricLightFuel.getFluid(50), Materials.SulfuricNaphtha.getFluid(20), Materials.SulfuricGas.getGas(60)}, null, 20, 96);
        GT_Values.RA.addDistillationTowerRecipe(Materials.OilHeavy.getFluid(100), new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{ Materials.SulfuricHeavyFuel.getFluid(250), Materials.SulfuricLightFuel.getFluid(45), Materials.SulfuricNaphtha.getFluid(15), Materials.SulfuricGas.getGas(60)}, null, 20, 288);
        ...
        GT_Values.RA.addPulveriserRecipe(ItemList.Circuit_Silicon_Ingot.get(1), new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 8L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 2L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 2L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 2L)}, new int[]{10000, 5000, 2500, 1250}, 160, 4);
        GT_Values.RA.addPulveriserRecipe(ItemList.Circuit_Silicon_Ingot2.get(1), new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 24L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 2L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 2L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 2L)}, new int[]{10000, 5000, 2500, 1250}, 160, 48);
        GT_Values.RA.addPulveriserRecipe(ItemList.Circuit_Silicon_Ingot3.get(1), new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 64L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 2L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 2L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 2L)}, new int[]{10000, 5000, 2500, 1250}, 160, 480);
        GT_Values.RA.addPulveriserRecipe(ItemList.Circuit_Silicon_Ingot4.get(1), new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 64L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 32L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 16L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 8L)}, new int[]{10000, 5000, 2500, 1250}, 160, 1920);
        GT_Values.RA.addPulveriserRecipe(ItemList.Circuit_Silicon_Ingot5.get(1), new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 64L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 64L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 32L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 16L)}, new int[]{10000, 5000, 2500, 1250}, 160, 7680);
        ...
        if (Loader.isModLoaded("bartworks") && (Loader.isModLoaded("miscutils"))){
            ...
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.CopperIIOxide, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.BismuthIIIOxide, 1L),GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 1L)}, new FluidStack[]{MaterialsKevlar.Acetylen.getGas(1000L), new FluidStack(FluidRegistry.getFluid("formaldehyde"), 2000)}, null, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IIButinIIVdiol, 1L)},400, 1920);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.CopperIIOxide, 9L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.BismuthIIIOxide, 9L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 9L)}, new FluidStack[]{MaterialsKevlar.Acetylen.getGas(9000L), new FluidStack(FluidRegistry.getFluid("formaldehyde"), 18000)}, null, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IIButinIIVdiol, 9L)}, 3000, 1920);
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(2), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silver, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 1L)}, new FluidStack[]{Materials.Ethylene.getGas(1000), Materials.Oxygen.getGas(1000)}, new FluidStack[]{MaterialsKevlar.EthylenOxide.getGas(1000)}, null,50, 480);
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(2)}, new FluidStack[]{MaterialsKevlar.EthylenOxide.getGas(1000), Materials.Dimethyldichlorosilane.getFluid(4000), Materials.Water.getFluid(5000)}, new FluidStack[]{MaterialsKevlar.SiliconOil.getFluid(5000)}, null,15, 1920);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.EthylenOxide, 1L), GT_Utility.getIntegratedCircuit(1), Materials.Water.getFluid(1000), MaterialsKevlar.Ethyleneglycol.getFluid(1000), ItemList.Cell_Empty.get(1L), 200, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 1L), GT_Utility.getIntegratedCircuit(2), MaterialsKevlar.EthylenOxide.getGas(1000), MaterialsKevlar.Ethyleneglycol.getFluid(1000), ItemList.Cell_Empty.get(1L), 200, 480);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.SulfurTrioxide, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.SulfurDichloride, 1L), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.ThionylChloride, 1L), ItemList.Cell_Empty.get(1),150, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.SulfurTrioxide, 1L), GT_Utility.getIntegratedCircuit(2), MaterialsKevlar.SulfurDichloride.getFluid(1000L), MaterialsKevlar.ThionylChloride.getFluid(1000L), GT_Values.NI, 150, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.DimethylTerephthalate, 1L)}, new FluidStack[]{MaterialsKevlar.ThionylChloride.getFluid(1000)}, new FluidStack[]{Materials.DilutedHydrochloricAcid.getFluid(1000L), Materials.SulfurDioxide.getGas(1000L)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.TerephthaloylChloride, 1L)},400, 1920);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.DimethylTerephthalate, 9L)}, new FluidStack[]{MaterialsKevlar.ThionylChloride.getFluid(9000)}, new FluidStack[]{Materials.DilutedHydrochloricAcid.getFluid(9000L), Materials.SulfurDioxide.getGas(9000L)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.TerephthaloylChloride, 9L)},3000, 1920);
        ...
        GT_Values.RA.addDistillationTowerRecipe(Materials.CharcoalByproducts.getGas(1000), new ItemStack[]{GT_Utility.getIntegratedCircuit(3)},
            ...
            Materials.Charcoal.getDustSmall(1),  40, 256);
        GT_Values.RA.addDistillationTowerRecipe(Materials.WoodTar.getFluid(1000), new ItemStack[]{GT_Utility.getIntegratedCircuit(3)},
	...
	private void addRecipesApril2017ChemistryUpdate(){
        ...
        GT_Values.RA.addDistillationTowerRecipe(Materials.CharcoalByproducts.getGas(1000), new ItemStack[]{ GT_Utility.getIntegratedCircuit(1)},
                ...
                Materials.Charcoal.getDustSmall(1),  40, 256);
        GT_Values.RA.addDistillationTowerRecipe(Materials.WoodGas.getGas(1000), new ItemStack[]{ GT_Utility.getIntegratedCircuit(1)},
                ...
                GT_Values.NI,  40, 256);
        GT_Values.RA.addDistillationTowerRecipe(Materials.WoodVinegar.getFluid(1000), new ItemStack[]{ GT_Utility.getIntegratedCircuit(1)},
                ...
                GT_Values.NI,  40, 256);
        GT_Values.RA.addDistillationTowerRecipe(Materials.WoodTar.getFluid(1000), new ItemStack[]{ GT_Utility.getIntegratedCircuit(1)},
         ...
         * Adds recipes related to producing Polybenzimidazole.
     	 */
            private void addPolybenzimidazoleRecipes() {
            	...
            	GT_Values.RA.addChemicalRecipe(Materials.Chlorobenzene.getCells(1), GT_Utility.getIntegratedCircuit(11), Materials.NitrationMixture.getFluid(1000), Materials.Nitrochlorobenzene.getFluid(1000L), Materials.DilutedSulfuricAcid.getCells(1),100, 480);
