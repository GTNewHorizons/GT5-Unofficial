...
public class GT_MachineRecipeLoader implements Runnable {
    ...
    private void addPyrometallurgicalRecipes() {
        ...
        GT_Values.RA.addBlastRecipe(Materials.Stibnite.getDust(1), GT_Values.NI, Materials.Oxygen.getGas(3000), Materials.SulfurDioxide.getGas(1500), Materials.AntimonyTrioxide.getDust(5), Materials.Ash.getDustTiny(1), 120, 120, 1200);
