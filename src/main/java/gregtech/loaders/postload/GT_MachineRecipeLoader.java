...
//        Quantumsuite
		...
		*/
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Neutronium, 1L), 		GT_Utility.getIntegratedCircuit(14), GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Neutronium, 1L), 5000,  500000);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.ElectrumFlux, 1L), 		GT_Utility.getIntegratedCircuit(11), GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.ElectrumFlux, 1L), 1000, 62880);
        ...
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.HSSG, 4L), 				GT_Utility.getIntegratedCircuit(4), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.HSSG, 1L), GT_Values.NI, 4200, 1920, 4500);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Naquadah, 1L), 			GT_Utility.getIntegratedCircuit(11), GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Naquadah, 1L), 500, 7680);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NaquadahAlloy, 1L), 		GT_Utility.getIntegratedCircuit(11), GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.NaquadahAlloy, 1L), 1000, 62880);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NaquadahEnriched, 1L), 	GT_Utility.getIntegratedCircuit(11), GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.NaquadahEnriched, 1L), 500, 7680);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Naquadria, 1L), 			GT_Utility.getIntegratedCircuit(11), GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Naquadria, 1L), 500, 122880);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust,Materials.Osmiridium, 1L), 		    GT_Utility.getIntegratedCircuit(11), 		GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Osmiridium, 1L), 1500, 30720);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust,Materials.Pentacadmiummagnesiumhexaoxid, 1L), 		GT_Utility.getIntegratedCircuit(11), 		GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Pentacadmiummagnesiumhexaoxid, 1L), 1800, 480);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust,Materials.Titaniumonabariumdecacoppereikosaoxid, 1L), 		GT_Utility.getIntegratedCircuit(11), 		GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Titaniumonabariumdecacoppereikosaoxid, 1L), 2000, 480);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust,Materials.Uraniumtriplatinid, 1L), 		GT_Utility.getIntegratedCircuit(11), 		GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Uraniumtriplatinid, 1L), 2200, 1920);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust,Materials.Vanadiumtriindinid, 1L), 		GT_Utility.getIntegratedCircuit(11), 		GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Vanadiumtriindinid, 1L), 2400, 1920);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust,Materials.Tetraindiumditindibariumtitaniumheptacoppertetrakaidekaoxid, 1L), 		GT_Utility.getIntegratedCircuit(11), 		GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Tetraindiumditindibariumtitaniumheptacoppertetrakaidekaoxid, 1L), 2800, 7680);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust,Materials.Tetranaquadahdiindiumhexaplatiumosminid, 1L), 		GT_Utility.getIntegratedCircuit(11), 		GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Tetranaquadahdiindiumhexaplatiumosminid, 1L), 3000, 7680);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust,Materials.Longasssuperconductornameforuvwire, 1L), 		GT_Utility.getIntegratedCircuit(11), 		GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Longasssuperconductornameforuvwire, 1L),3400, 30720);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust,Materials.Longasssuperconductornameforuhvwire, 1L), 		GT_Utility.getIntegratedCircuit(11), 		GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Longasssuperconductornameforuhvwire, 1L), 3600, 122880);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust,Materials.Longasssuperconductornameforuevwire, 1L), 		GT_Utility.getIntegratedCircuit(11), 		GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Longasssuperconductornameforuevwire, 1L),3800, 500000);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Draconium, 1L), 			GT_Utility.getIntegratedCircuit(11), GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Draconium, 1L), 4000, 30720);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.DraconiumAwakened, 1L), 	GT_Utility.getIntegratedCircuit(11), GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.DraconiumAwakened, 1L), 5000, 122880);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Europiumoxide, 1L), 			GT_Utility.getIntegratedCircuit(11), GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Europiumoxide, 1L), 1000, 30720);
        ...
        GT_Values.RA.addPlasmaBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Diamericiumtitanium, 1L), 		GT_Utility.getIntegratedCircuit(11), GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Diamericiumtitanium, 1L), 2000, 122880);
