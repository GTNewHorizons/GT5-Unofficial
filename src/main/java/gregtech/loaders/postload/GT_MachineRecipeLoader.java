...
public class GT_MachineRecipeLoader implements Runnable {
	...
	GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 4L), GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.TungstenSteel, 1L), ItemList.Robot_Arm_IV.get(2L), GT_Utility.getIntegratedCircuit(3)}, GT_Values.NF, ItemList.Casing_Gearbox_TungstenSteel.get(1L), 200, 30);
        ...
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconSG, 32), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.GalliumArsenide, 1), null, null, ItemList.Circuit_Silicon_Ingot.get(1), null, 9000, 120, 1784);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 16), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.GalliumArsenide, 1), null, null, ItemList.Circuit_Silicon_Ingot.get(1), null, 9000, 120, 1784);
        ...
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 64), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Naquadah, 1), Materials.Argon.getGas(8000), null, ItemList.Circuit_Silicon_Ingot3.get(1), null, 15000, 1920, 4484);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 1),  ItemList.Cell_Empty.get(2L), Materials.HydrofluoricAcid.getGas(4000), Materials.SiliconTetrafluoride.getGas(1000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 2),300, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NetherQuartz, 1),  ItemList.Cell_Empty.get(2L), Materials.HydrofluoricAcid.getGas(4000), Materials.SiliconTetrafluoride.getGas(1000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 2),300, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.CertusQuartz, 1),  ItemList.Cell_Empty.get(2L), Materials.HydrofluoricAcid.getGas(4000), Materials.SiliconTetrafluoride.getGas(1000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 2),300, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Quartzite, 2),  ItemList.Cell_Empty.get(2L), Materials.HydrofluoricAcid.getGas(4000), Materials.SiliconTetrafluoride.getGas(1000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 2),300, 30);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silicon, 1), ItemList.Cell_Empty.get(2L), Materials.HydrochloricAcid.getFluid(3000), Materials.Trichlorosilane.getFluid(1000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2),  300, 30);
        //GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silicon, 9)}, new FluidStack[]{Materials.HydrochloricAcid.getFluid(27000)}, new FluidStack[]{Materials.Trichlorosilane.getFluid(9000), Materials.SiliconTetrachloride.getFluid(100), Materials.Hexachlorodisilane.getGas(100), Materials.Dichlorosilane.getGas(100), Materials.Hydrogen.getGas(18000)}, null,150, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silicon, 9)}, new FluidStack[]{Materials.HydrochloricAcid.getFluid(27000)}, new FluidStack[]{Materials.Trichlorosilane.getFluid(9000)}, null,150, 480);
        GT_Values.RA.addChemicalRecipe(GT_Values.NI, GT_Utility.getIntegratedCircuit(1), Materials.Trichlorosilane.getFluid(2000), Materials.HydrochloricAcid.getFluid(2000), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconSG, 1),  GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconTetrachloride, 1), 300, 30);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silicon, 1), GT_Utility.getIntegratedCircuit(1), Materials.Chlorine.getGas(2000), Materials.SiliconTetrachloride.getGas(1000), null,300, 30);
