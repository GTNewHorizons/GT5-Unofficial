...
//Kevlar Line
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silver, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 1L)}, new FluidStack[]{Materials.Ethylene.getGas(1000), Materials.Oxygen.getGas(1000)}, new FluidStack[]{MaterialsKevlar.EthylenOxide.getGas(1000)}, null,50, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silver, 9L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 9L)}, new FluidStack[]{Materials.Ethylene.getGas(9000), Materials.Oxygen.getGas(9000)}, new FluidStack[]{MaterialsKevlar.EthylenOxide.getGas(9000)}, null,400, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.EthylenOxide, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 5L), Materials.Dimethyldichlorosilane.getFluid(4000), MaterialsKevlar.SiliconOil.getFluid(5000), ItemList.Cell_Empty.get(6L), 600, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.EthylenOxide, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Dimethyldichlorosilane, 4L), Materials.Water.getFluid(5000), MaterialsKevlar.SiliconOil.getFluid(5000), ItemList.Cell_Empty.get(5L), 600, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(8)}, new FluidStack[]{MaterialsKevlar.EthylenOxide.getGas(9000), Materials.Dimethyldichlorosilane.getFluid(36000), Materials.Water.getFluid(45000)}, new FluidStack[]{MaterialsKevlar.SiliconOil.getFluid(45000)}, null,100, 1920);
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{Materials.Chlorobenzene.getFluid(1000), Materials.NitrationMixture.getFluid(1000)}, new FluidStack[]{Materials.DilutedSulfuricAcid.getFluid(1000)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IVNitrochlorobenzene, 1)},600, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(11)}, new FluidStack[]{Materials.Chlorobenzene.getFluid(2000), Materials.NitrationMixture.getFluid(2000)}, new FluidStack[]{Materials.DilutedSulfuricAcid.getFluid(2000)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IINitrochlorobenzene, 1)},600, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(5)}, new FluidStack[]{Materials.Chlorobenzene.getFluid(5000), Materials.NitrationMixture.getFluid(5000)}, new FluidStack[]{Materials.DilutedSulfuricAcid.getFluid(5000)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IINitrochlorobenzene, 2), GT_OreDictUnificator.get(OrePrefixes.dustTiny, MaterialsKevlar.IIINitrochlorobenzene, 1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IVNitrochlorobenzene, 9)},1200, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9)}, new FluidStack[]{Materials.Chlorobenzene.getFluid(45000), Materials.NitrationMixture.getFluid(45000)}, new FluidStack[]{Materials.DilutedSulfuricAcid.getFluid(4500)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IINitrochlorobenzene, 18), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IIINitrochlorobenzene, 1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IVNitrochlorobenzene, 64), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IVNitrochlorobenzene, 17)},8400, 480);
         ...
         * Adds recipes related to producing Polybenzimidazole.
     	 */
            private void addPolybenzimidazoleRecipes() {
            	...
            	//Dichlorobenzidine
            	GT_Values.RA.addChemicalRecipe(Materials.Copper.getDustTiny(1), Materials.Nitrochlorobenzene.getCells(1), GT_Values.NF, Materials.Dichlorobenzidine.getFluid(1000), null, 200, 1920);
            	GT_Values.RA.addChemicalRecipe(Materials.Copper.getDust(1),  Materials.Nitrochlorobenzene.getCells(9), GT_Values.NF, Materials.Dichlorobenzidine.getFluid(9000), null, 1800, 1920);
                GT_Values.RA.addChemicalRecipe(Materials.Copper.getDustTiny(1), MaterialsKevlar.IINitrochlorobenzene.getDust(1), GT_Values.NF, Materials.Dichlorobenzidine.getFluid(1000), null, 200, 1920);
                GT_Values.RA.addChemicalRecipe(Materials.Copper.getDust(1),  MaterialsKevlar.IINitrochlorobenzene.getDust(9), GT_Values.NF, Materials.Dichlorobenzidine.getFluid(9000), null, 1800, 1920);
