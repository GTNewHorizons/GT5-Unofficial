...
public class GT_MachineRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.DimethylTerephthalate, 1L)}, new FluidStack[]{MaterialsKevlar.ThionylChloride.getFluid(1000)}, new FluidStack[]{Materials.DilutedHydrochloricAcid.getFluid(1000L)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.TerephthaloylChloride, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SulfurDioxide, 1L)},400, 1920);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.DimethylTerephthalate, 9L)}, new FluidStack[]{MaterialsKevlar.ThionylChloride.getFluid(9000)}, new FluidStack[]{Materials.DilutedHydrochloricAcid.getFluid(9000L)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.TerephthaloylChloride, 9L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SulfurDioxide, 9L)},3000, 1920);
