...
//Kevlar Line
        ...
        if (Loader.isModLoaded("bartworks") && (Loader.isModLoaded("miscutils"))){
            ...
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.Butyraldehyde, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), GT_Values.NF, new FluidStack(FluidRegistry.getFluid("butanol"), 1000), ItemList.Cell_Empty.get(2L),200, 30);
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.Butyraldehyde, 1L), GT_Utility.getIntegratedCircuit(1), Materials.Hydrogen.getGas(1000), new FluidStack(FluidRegistry.getFluid("butanol"), 1000), ItemList.Cell_Empty.get(1L),200, 30);
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), GT_Utility.getIntegratedCircuit(1), MaterialsKevlar.Butyraldehyde.getFluid(1000), new FluidStack(FluidRegistry.getFluid("butanol"), 1000), ItemList.Cell_Empty.get(1L),200, 30);
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.Butyraldehyde, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), GT_Values.NF, GT_Values.NF, GT_ModHandler.getModItem("miscutils", "butanol", 1L), ItemList.Cell_Empty.get(1L),200, 30);
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.Butyraldehyde, 1L), GT_Utility.getIntegratedCircuit(2), Materials.Hydrogen.getGas(1000), GT_Values.NF, GT_ModHandler.getModItem("miscutils", "butanol", 1L), 200, 30);
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), GT_Utility.getIntegratedCircuit(2), MaterialsKevlar.Butyraldehyde.getFluid(1000), GT_Values.NF, GT_ModHandler.getModItem("miscutils", "butanol", 1L), 200, 30);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{MaterialsKevlar.Butyraldehyde.getFluid(1000), Materials.Hydrogen.getGas(1000)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("butanol"), 1000)}, null,10, 480);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9)}, new FluidStack[]{MaterialsKevlar.Butyraldehyde.getFluid(9000), Materials.Hydrogen.getGas(9000)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("butanol"), 9000)}, null,80, 480);
            ...
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), GT_Utility.getIntegratedCircuit(2), MaterialsKevlar.Butyraldehyde.getFluid(1000), GT_Values.NF, GT_ModHandler.getModItem("miscutils", "butanol", 1L), ItemList.Cell_Empty.get(1L), 200, 30);
            ...
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("aniline"), 1000), new FluidStack(FluidRegistry.getFluid("aceticanhydride"), 1000), Materials.AceticAcid.getFluid(100), Materials.SulfuricAcid.getFluid(100), Materials.NitricAcid.getFluid(100)}, null, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IVNitroaniline, 1L)},300, 7680);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("aniline"), 9000), new FluidStack(FluidRegistry.getFluid("aceticanhydride"), 9000), Materials.AceticAcid.getFluid(900), Materials.SulfuricAcid.getFluid(900), Materials.NitricAcid.getFluid(900)}, null, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IVNitroaniline, 9L)},2000, 7680);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IVNitroaniline, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Palladium, 1L)}, new FluidStack[]{Materials.NitricOxide.getGas(1000), Materials.NitrogenDioxide.getGas(1000), Materials.Hydrogen.getGas(6000)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("aniline"), 500)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dustSmall, MaterialsKevlar.ParaPhenylenediamine, 2L)},400, 30720);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IVNitroaniline, 9L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Palladium, 9L)}, new FluidStack[]{Materials.NitricOxide.getGas(9000), Materials.NitrogenDioxide.getGas(9000), Materials.Hydrogen.getGas(54000)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("aniline"), 5000)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.ParaPhenylenediamine, 5L)},3000, 30720);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Copper, 1L)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("1-4,butanediol"), 1000)}, new FluidStack[]{MaterialsKevlar.GammaButyrolactone.getFluid(1000), Materials.Hydrogen.getGas(2000)}, null,200, 480);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Copper, 9L)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("1-4,butanediol"), 9000)}, new FluidStack[]{MaterialsKevlar.GammaButyrolactone.getFluid(9000), Materials.Hydrogen.getGas(18000)}, null,1500, 480);
            ...
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.Acetylen, 2L), GT_ModHandler.getModItem("miscutils", "Formaldehyde", 1L), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IIButinIIVdiol, 1L),  ItemList.Cell_Empty.get(3L),200, 1920);
            GT_Values.RA.addChemicalRecipe(GT_ModHandler.getModItem("miscutils", "Formaldehyde", 1L), GT_Utility.getIntegratedCircuit(1), MaterialsKevlar.Acetylen.getGas(2000L), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IIButinIIVdiol, 1L),  ItemList.Cell_Empty.get(1L),200, 1920);
        }
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Propene, 2L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.CarbonMonoxide, 2L), Materials.Hydrogen.getGas(2000), MaterialsKevlar.Butyraldehyde.getFluid(1000), GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.Isobutyraldehyde, 1L), ItemList.Cell_Empty.get(3L),300, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.CarbonMonoxide, 2L), Materials.Propene.getGas(2000), MaterialsKevlar.Butyraldehyde.getFluid(1000), GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.Isobutyraldehyde, 1L), ItemList.Cell_Empty.get(3L),300, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Propene, 2L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2L), Materials.CarbonMonoxide.getGas(2000), MaterialsKevlar.Butyraldehyde.getFluid(1000), GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.Isobutyraldehyde, 1L), ItemList.Cell_Empty.get(3L),300, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.CarbonMonoxide, 4L), GT_Values.NF, MaterialsKevlar.NickelTetracarbonyl.getFluid(1000), ItemList.Cell_Empty.get(4L),400, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 1L), GT_Utility.getIntegratedCircuit(1), Materials.CarbonMonoxide.getGas(4000), MaterialsKevlar.NickelTetracarbonyl.getFluid(1000), GT_Values.NI,400, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 1L), ItemList.Cell_Empty.get(1L), Materials.CarbonMonoxide.getGas(4000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.NickelTetracarbonyl, 1L), 400, 30);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(8), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silver, 1L)}, new FluidStack[]{Materials.Ethylene.getGas(9000), Materials.Oxygen.getGas(9000)}, new FluidStack[]{MaterialsKevlar.EthylenOxide.getGas(9000)}, null,400, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Ethylene, 1L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Silver, 1L), Materials.Oxygen.getGas(1000), MaterialsKevlar.EthylenOxide.getGas(1000), ItemList.Cell_Empty.get(1L), 800, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Ethylene, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 5L), Materials.Dimethyldichlorosilane.getFluid(4000), MaterialsKevlar.SiliconOil.getFluid(5000), ItemList.Cell_Empty.get(6L), 600, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Ethylene, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Dimethyldichlorosilane, 4L), Materials.Water.getFluid(5000), MaterialsKevlar.SiliconOil.getFluid(5000), ItemList.Cell_Empty.get(5L), 600, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(8)}, new FluidStack[]{Materials.Ethylene.getGas(9000), Materials.Dimethyldichlorosilane.getFluid(36000), Materials.Water.getFluid(45000)}, new FluidStack[]{MaterialsKevlar.SiliconOil.getFluid(45000)}, null,100, 1920);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.EthylenOxide, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 1L), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.Ethyleneglycol, 1L), ItemList.Cell_Empty.get(1L), 300, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.EthylenOxide, 1L), GT_Utility.getIntegratedCircuit(1), Materials.Water.getFluid(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.Ethyleneglycol, 1L), 300, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 1L), GT_Utility.getIntegratedCircuit(4), MaterialsKevlar.EthylenOxide.getFluid(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.Ethyleneglycol, 1L), 300, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 1L), GT_Utility.getIntegratedCircuit(5), MaterialsKevlar.EthylenOxide.getFluid(1000), MaterialsKevlar.Ethyleneglycol.getFluid(1000), ItemList.Cell_Empty.get(1), 300, 480);
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.KevlarCatalyst, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.Pentaerythritol, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.DiphenylmethaneDiisocyanate, 5L)}, new FluidStack[]{MaterialsKevlar.Ethyleneglycol.getFluid(4000), MaterialsKevlar.SiliconOil.getFluid(1000)}, null, new ItemStack[]{ItemList.PolyurethaneResin.get(1L)},200, 500000);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.KevlarCatalyst, 9L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.Pentaerythritol, 9L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.DiphenylmethaneDiisocyanate, 45L)}, new FluidStack[]{MaterialsKevlar.Ethyleneglycol.getFluid(36000), MaterialsKevlar.SiliconOil.getFluid(9000)}, null, new ItemStack[]{ItemList.PolyurethaneResin.get(9L)},1500, 500000);
        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Chlorobenzene, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.NitrationMixture, 1L), GT_Values.NF, Materials.DilutedSulfuricAcid.getGas(1000), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IVNitrochlorobenzene, 1L), ItemList.Cell_Empty.get(1L),200, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{Materials.Chlorobenzene.getFluid(1000), Materials.NitrationMixture.getFluid(1000)}, new FluidStack[]{Materials.DilutedSulfuricAcid.getGas(1000),}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IVNitrochlorobenzene, 1)},100, 480);
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(5)}, new FluidStack[]{Materials.Chlorobenzene.getFluid(5000), Materials.NitrationMixture.getFluid(5000)}, null, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nitrochlorobenzene, 2), GT_OreDictUnificator.get(OrePrefixes.dustTiny, MaterialsKevlar.IIINitrochlorobenzene, 1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IVNitrochlorobenzene, 9)},1200, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9)}, new FluidStack[]{Materials.Chlorobenzene.getFluid(45000), Materials.NitrationMixture.getFluid(45000)}, null, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nitrochlorobenzene, 18), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IIINitrochlorobenzene, 1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IVNitrochlorobenzene, 64), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IVNitrochlorobenzene, 17)},9000, 480);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.CalciumCarbide, 1L), GT_Utility.getIntegratedCircuit(1), Materials.Water.getFluid(2000L), MaterialsKevlar.Acetylen.getGas(1000L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.CalciumHydroxide, 1L), 300, 480);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Copper, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Oxygen, 1l), GT_Values.NF,  GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.CopperIIOxide, 1L), ItemList.Cell_Empty.get(1), 100, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Copper, 1L), GT_Utility.getIntegratedCircuit(1), Materials.Oxygen.getGas(1000L),  GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.CopperIIOxide, 1L), 100, 30);
