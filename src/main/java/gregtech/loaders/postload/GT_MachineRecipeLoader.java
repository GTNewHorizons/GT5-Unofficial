...
public class GT_MachineRecipeLoader implements Runnable {
	...
	private void addRecipesApril2017ChemistryUpdate(){
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9)},                               new FluidStack[]{Materials.HydricSulfide.getGas(9000), Materials.Oxygen.getFluid(27000)}, new FluidStack[]{Materials.SulfurDioxide.getGas(9000), Materials.Water.getFluid(9000)}, null, 60, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(8)},                               new FluidStack[]{Materials.HydricSulfide.getGas(9000), Materials.Oxygen.getFluid(27000)}, new FluidStack[]{Materials.SulfurDioxide.getGas(9000)}, null, 60, 480);
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9)},                               new FluidStack[]{Materials.HydricSulfide.getGas(18000), Materials.SulfurDioxide.getGas(9000)}, null, new ItemStack[]{Materials.Sulfur.getDust(27)}, 60, 480);
