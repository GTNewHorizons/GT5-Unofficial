...
public class GT_MachineRecipeLoader implements Runnable {
	...
	GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 4L), GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.TungstenSteel, 1L), ItemList.Robot_Arm_IV.get(2L), GT_Utility.getIntegratedCircuit(3)}, GT_Values.NF, ItemList.Casing_Gearbox_TungstenSteel.get(1L), 200, 30);
        ...
        //Kevlar Line
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.CarbonMonoxide, 1), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Chlorine, 2), GT_Values.NF, Materials.Phosgene.getGas(1000), ItemList.Cell_Empty.get(3L),300, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.CarbonMonoxide, 1),  GT_Utility.getIntegratedCircuit(1), Materials.Chlorine.getGas(2000), Materials.Phosgene.getGas(1000), ItemList.Cell_Empty.get(2L),300, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Chlorine, 2), GT_Utility.getIntegratedCircuit(1), Materials.CarbonMonoxide.getGas(1000), Materials.Phosgene.getGas(1000), ItemList.Cell_Empty.get(1L),300, 480);
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{Materials.DiaminodiphenylmethanMixture.getFluid(1000L), Materials.Phosgene.getGas(2000L)}, new FluidStack[]{Materials.DiphenylmethaneDiisocyanateMixture.getFluid(1000L)}, null,600, 1920);
