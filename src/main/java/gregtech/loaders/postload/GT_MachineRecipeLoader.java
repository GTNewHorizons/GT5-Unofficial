...
public class GT_MachineRecipeLoader implements Runnable {
    ...
    public void run2() {
        ...
        GT_Values.RA.addCentrifugeRecipe(new ItemStack(Blocks.soul_sand, 1), GT_Values.NI, GT_Values.NF, Materials.Oil.getFluid(200L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Saltpeter, 1L), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Coal, 1L), new ItemStack(Blocks.sand, 1), GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{8000, 5000, 9000, 0, 0, 0}, 200, 12);
