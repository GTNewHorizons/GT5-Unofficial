...
//        GT_Values.RA.addAlloySmelterRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Rubber, 2), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Copper, 1), GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Copper, 1), 100, 16);
        ...
        for (OrePrefixes tPrefix : Arrays.asList(OrePrefixes.dust, OrePrefixes.dustSmall, OrePrefixes.dustTiny)) {
            ...
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.DraconiumAwakened, 2L), GT_OreDictUnificator.get(tPrefix, Materials.Neutronium, 2L), GT_OreDictUnificator.get(tPrefix, Materials.Infinity, 1L), GT_Values.NI, GT_Values.NI, GT_Utility.getIntegratedCircuit(2),GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.InfinityAlloy, 5L * tPrefix.mMaterialAmount), (int) (2400L * tPrefix.mMaterialAmount / 3628800L), 491520);
...
//        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Gunpowder, 4L), new ItemStack(Blocks.sand, 4, 32767), new ItemStack(Blocks.tnt, 1), 400, 1);
        ...
        GT_Values.RA.addArcFurnaceRecipe(ItemList.Casing_Coil_InfinityAlloy.get(1L),new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.ingot,Materials.InfinityAlloy,8),GT_OreDictUnificator.get(OrePrefixes.ingot,Materials.DraconiumAwakened,1),GT_OreDictUnificator.get(OrePrefixes.dust,Materials.Ash,10)},null,360,128);
        GT_Values.RA.addArcFurnaceRecipe(ItemList.Casing_Coil_Infinity.get(1L),new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.ingot,Materials.Infinity,8),GT_OreDictUnificator.get(OrePrefixes.ingot,Materials.InfinityAlloy,1),GT_OreDictUnificator.get(OrePrefixes.dust,Materials.Ash,10)},null,360,128);
        ...
        GT_Values.RA.addPulveriserRecipe(ItemList.Casing_Coil_InfinityAlloy.get(1L),new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust,Materials.InfinityAlloy,8),GT_OreDictUnificator.get(OrePrefixes.dust,Materials.DraconiumAwakened,1),GT_OreDictUnificator.get(OrePrefixes.dust,Materials.QuartzSand,10)},null,1500,80);
        GT_Values.RA.addPulveriserRecipe(ItemList.Casing_Coil_Infinity.get(1L),new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust,Materials.Infinity,8),GT_OreDictUnificator.get(OrePrefixes.dust,Materials.InfinityAlloy,1),GT_OreDictUnificator.get(OrePrefixes.dust,Materials.QuartzSand,10)},null,1500,80);
