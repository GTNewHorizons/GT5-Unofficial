...
//            GT_Values.RA.addBrewingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.RockSalt, 1L), tFluid, FluidRegistry.getFluid("potion.saltywater"), true);
		...
		GT_Values.RA.addChemicalRecipe(Materials.Carbon.getDust(8), GT_Utility.getIntegratedCircuit(8),  Materials.Hydrogen.getGas(18000L), Materials.Octane.getFluid(26000L), GT_Values.NI, 14000);
        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(Materials.Carbon.getDust(8), Materials.Empty.getCells(26),         Materials.Hydrogen.getGas(18000L), GT_Values.NF, Materials.Octane.getCells(26), GT_Values.NI, 200, 30);
...
//        Quantumsuite
        ...
        GT_Values.RA.addVacuumFreezerRecipe(GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Titanium, 1L), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Titanium, 1L), 144, 480);
            ...
            GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Cover_SolarPanel_IV.get(3L), ItemList.Circuit_Crystalmainframe.get(6L), ItemList.Circuit_Silicon_Wafer3.get(6L), GT_OreDictUnificator.get(OrePrefixes.plateAlloy, Materials.Carbon, 6), GT_OreDictUnificator.get(OrePrefixes.plateTriple, Materials.Osmium, 2), GT_OreDictUnificator.get(OrePrefixes.plateQuadruple, Materials.Polybenzimidazole, 2), GT_OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Silicone, 6), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorLuV, 10)},Materials.SolderingAlloy.getMolten(576), ItemList.Cover_SolarPanel_LuV.get(1L), 480, 122880, true);
