     ...
     * Adds recipes related to producing Polybenzimidazole.
 	 */
      ...
      //Solar Panel
        ...
        GT_Values.RA.addAssemblerSpaceRecipe(new ItemStack[]{ItemList.Cover_SolarPanel_LuV.get(3L), ItemList.Circuit_Wetwaremainframe.get(6L), ItemList.Circuit_Silicon_Wafer3.get(8L), GT_OreDictUnificator.get(OrePrefixes.plateAlloy, Materials.Carbon, 8), GT_OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Tritanium, 4), GT_OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Polybenzimidazole, 2), GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Silicon, 6), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorZPM, 12)},Materials.SolderingAlloy.getMolten(720), ItemList.Cover_SolarPanel_ZPM.get(1L), 600, 122880, true);
        GT_Values.RA.addAssemblerSpaceRecipe(new ItemStack[]{ItemList.Cover_SolarPanel_LuV.get(3L), ItemList.Circuit_Biowaresupercomputer.get(6L), ItemList.Circuit_Silicon_Wafer3.get(8L), GT_OreDictUnificator.get(OrePrefixes.plateAlloy, Materials.Carbon, 8), GT_OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Tritanium, 4), GT_OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Polybenzimidazole, 2), GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Silicon, 6), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorZPM, 12)},Materials.SolderingAlloy.getMolten(720), ItemList.Cover_SolarPanel_ZPM.get(1L), 600, 122880, true);
        GT_Values.RA.addAssemblerSpaceRecipe(new ItemStack[]{ItemList.Cover_SolarPanel_LuV.get(3L), ItemList.Circuit_Quantum.get(6L), ItemList.Circuit_Silicon_Wafer3.get(8L), GT_OreDictUnificator.get(OrePrefixes.plateAlloy, Materials.Carbon, 8), GT_OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Tritanium, 4), GT_OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Polybenzimidazole, 2), GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Silicon, 6), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorZPM, 12)},Materials.SolderingAlloy.getMolten(720), ItemList.Cover_SolarPanel_ZPM.get(1L), 600, 122880, true);
        ...
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Cover_SolarPanel_LuV.get(3L), ItemList.Circuit_Wetwaremainframe.get(6L), ItemList.Circuit_Silicon_Wafer3.get(8L), GT_OreDictUnificator.get(OrePrefixes.plateAlloy, Materials.Carbon, 8), GT_OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Tritanium, 4), GT_OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Polybenzimidazole, 2), GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Silicon, 6), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorZPM, 12)},Materials.SolderingAlloy.getMolten(720), ItemList.Cover_SolarPanel_ZPM.get(1L), 600, 122880, true);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Cover_SolarPanel_LuV.get(3L), ItemList.Circuit_Biowaresupercomputer.get(6L), ItemList.Circuit_Silicon_Wafer3.get(8L), GT_OreDictUnificator.get(OrePrefixes.plateAlloy, Materials.Carbon, 8), GT_OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Tritanium, 4), GT_OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Polybenzimidazole, 2), GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Silicon, 6), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorZPM, 12)},Materials.SolderingAlloy.getMolten(720), ItemList.Cover_SolarPanel_ZPM.get(1L), 600, 122880, true);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Cover_SolarPanel_LuV.get(3L), ItemList.Circuit_Quantum.get(6L), ItemList.Circuit_Silicon_Wafer3.get(8L), GT_OreDictUnificator.get(OrePrefixes.plateAlloy, Materials.Carbon, 8), GT_OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Tritanium, 4), GT_OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Polybenzimidazole, 2), GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Silicon, 6), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorZPM, 12)},Materials.SolderingAlloy.getMolten(720), ItemList.Cover_SolarPanel_ZPM.get(1L), 600, 122880, true);
