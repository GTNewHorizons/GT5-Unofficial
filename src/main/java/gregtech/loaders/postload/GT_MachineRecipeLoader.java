...
public class GT_MachineRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Wood, 4L), GT_Values.NI, GT_Values.NI, GT_Utility.getIntegratedCircuit(1), Materials.Glue.getFluid(500), null, ItemList.SFMixture.get(4), 800, 16);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Lithium, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Wood, 4L), GT_Values.NI, GT_Values.NI, GT_Utility.getIntegratedCircuit(1), Materials.Glue.getFluid(500), null, ItemList.SFMixture.get(8), 800, 16);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Caesium, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Wood, 4L), GT_Values.NI, GT_Values.NI, GT_Utility.getIntegratedCircuit(1), Materials.Glue.getFluid(500), null, ItemList.SFMixture.get(12), 800, 16);

        GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.EnderEye, 1L), null, null, Materials.Mercury.getFluid(1000), null, ItemList.MSFMixture.get(8), 300, 64);
        GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(2), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Blaze, 1L), null, null, Materials.Mercury.getFluid(500), null, ItemList.MSFMixture.get(16), 300, 64);
        ...
        GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(20), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.InfusedWater, 1L), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Utility.getIntegratedCircuit(1), Materials.FierySteel.getFluid(50), null, ItemList.MSFMixture.get(20), 200, 64);
            ...
            if (tFD != null && tFD.getFluid() != null && tFD.amount > 0) {
                ...
                GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Charcoal,1), ItemList.MSFMixture.get(4), GT_ModHandler.getModItem("Thaumcraft", "ItemResource", 3), GT_Values.NI, GT_Values.NI, GT_Utility.getIntegratedCircuit(1), Materials.NitroFuel.getFluid(750), null, ItemList.Block_MSSFUEL.get(1), 120, 600);
                GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Coal,1), ItemList.MSFMixture.get(2), GT_ModHandler.getModItem("Thaumcraft", "ItemResource", 2), GT_Values.NI, GT_Values.NI, GT_Utility.getIntegratedCircuit(1), Materials.NitroFuel.getFluid(500), null, ItemList.Block_MSSFUEL.get(1), 100, 600);
            }
        }
	...
	GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 4L), GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.TungstenSteel, 1L), ItemList.Robot_Arm_IV.get(2L), GT_Utility.getIntegratedCircuit(3)}, GT_Values.NF, ItemList.Casing_Gearbox_TungstenSteel.get(1L), 200, 30);
        ...
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconSG, 32), ItemList.GalliumArsenideCrystalSmallPart.get(1L), null, null, ItemList.Circuit_Silicon_Ingot.get(1), null, 9000, 120, 1784);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 16), ItemList.GalliumArsenideCrystalSmallPart.get(1L), null, null, ItemList.Circuit_Silicon_Ingot.get(1), null, 9000, 120, 1784);
        GT_Values.RA.addCutterRecipe(new ItemStack[]{ItemList.Circuit_Silicon_Ingot.get(1), ItemList.Component_Sawblade_Diamond.get(0)}, new ItemStack[]{ItemList.Circuit_Silicon_Wafer.get(16), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 4L)}, 400, 30, false);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconSG, 64), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Glowstone, 8), Materials.Nitrogen.getGas(8000), null, ItemList.Circuit_Silicon_Ingot2.get(1), null, 12000, 480, 2484);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 32), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Glowstone, 8), Materials.Nitrogen.getGas(8000), null, ItemList.Circuit_Silicon_Ingot2.get(1), null, 12000, 480, 2484);
        GT_Values.RA.addCutterRecipe(new ItemStack[]{ItemList.Circuit_Silicon_Ingot2.get(1), ItemList.Component_Sawblade_Diamond.get(0)}, new ItemStack[]{ ItemList.Circuit_Silicon_Wafer2.get(32), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 8L)}, 800, 120, true);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.block, Materials.SiliconSG, 16), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Naquadah, 1), Materials.Argon.getGas(8000), null, ItemList.Circuit_Silicon_Ingot3.get(1), null, 15000, 1920, 4484);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.block, Materials.SiliconEG, 8), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Naquadah, 1), Materials.Argon.getGas(8000), null, ItemList.Circuit_Silicon_Ingot3.get(1), null, 15000, 1920, 4484);
        GT_Values.RA.addCutterRecipe(new ItemStack[]{ItemList.Circuit_Silicon_Ingot3.get(1), ItemList.Component_Sawblade_Diamond.get(0)},new ItemStack[]{ ItemList.Circuit_Silicon_Wafer3.get(64), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 16L)}, 1600, 480, true);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.block, Materials.SiliconSG, 32), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Europium, 2), Materials.Radon.getGas(8000), null, ItemList.Circuit_Silicon_Ingot4.get(1), null, 18000, 7680, 6484);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.block, Materials.SiliconEG, 16), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Europium, 2), Materials.Radon.getGas(8000), null, ItemList.Circuit_Silicon_Ingot4.get(1), null, 18000, 7680, 6484);
        GT_Values.RA.addCutterRecipe(new ItemStack[]{ItemList.Circuit_Silicon_Ingot4.get(1), ItemList.Component_Sawblade_Diamond.get(0)}, new ItemStack[]{ItemList.Circuit_Silicon_Wafer4.get(64), ItemList.Circuit_Silicon_Wafer4.get(32), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 32L)}, 2400, 1920, true);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.block, Materials.SiliconSG, 64), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Americium, 4), Materials.Radon.getGas(16000), null, ItemList.Circuit_Silicon_Ingot5.get(1), null, 21000, 30720, 9000);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.block, Materials.SiliconEG, 32), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Americium, 4), Materials.Radon.getGas(16000), null, ItemList.Circuit_Silicon_Ingot5.get(1), null, 21000, 30720, 9000);
        GT_Values.RA.addCutterRecipe(new ItemStack[]{ItemList.Circuit_Silicon_Ingot5.get(1), ItemList.Component_Sawblade_Diamond.get(0)}, new ItemStack[]{ItemList.Circuit_Silicon_Wafer5.get(64), ItemList.Circuit_Silicon_Wafer5.get(64), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconEG, 64L)}, 3200, 7680, true);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium, 4), GT_Utility.getIntegratedCircuit(1), Materials.SiliconTetrachloride.getFluid(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconSG, 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Salt, 4), 100, 30);
        if (Loader.isModLoaded("bartworks")) {
            ...
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Zinc, 2), GT_Utility.getIntegratedCircuit(1), Materials.SiliconTetrachloride.getFluid(2000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconSG, 1), GT_ModHandler.getModItem("bartworks", "gt.bwMetaGenerateddust", 2L, 10052),400, 30);
        }
        ...
        GT_Values.RA.addChemicalRecipe(ItemList.Cell_Empty.get(1L), GT_Utility.getIntegratedCircuit(2), Materials.Trichlorosilane.getFluid(4000), Materials.SiliconTetrachloride.getFluid(3000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Silane, 1), 300, 30);
        GT_Values.RA.addChemicalRecipe(ItemList.Cell_Empty.get(1L), GT_Utility.getIntegratedCircuit(1), Materials.Silane.getGas(1000), Materials.Hydrogen.getGas(2000), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconSG, 1), 300, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Silane, 1), GT_Utility.getIntegratedCircuit(1), GT_Values.NF, Materials.Hydrogen.getGas(2000), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconSG, 1), ItemList.Cell_Empty.get(1L),300, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Silane, 1), ItemList.Cell_Empty.get(1L), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconSG, 1), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2),300, 30);
...
//Kevlar Line
        ...
        if (Loader.isModLoaded("bartworks") && (Loader.isModLoaded("miscutils"))){
            ...
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{Materials.DiaminodiphenylmethanMixture.getFluid(1000L),new FluidStack(FluidRegistry.getFluid("phosgene"), 2000)}, new FluidStack[]{Materials.DiphenylmethaneDiisocyanateMixture.getFluid(1000L)}, null,600, 1920);
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Butyraldehyde, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), GT_Values.NF, new FluidStack(FluidRegistry.getFluid("butanol"), 1000), ItemList.Cell_Empty.get(2L),200, 30);
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Butyraldehyde, 1L), GT_Utility.getIntegratedCircuit(1), Materials.Hydrogen.getGas(1000), new FluidStack(FluidRegistry.getFluid("butanol"), 1000), ItemList.Cell_Empty.get(1L),200, 30);
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), GT_Utility.getIntegratedCircuit(1), Materials.Butyraldehyde.getFluid(1000), new FluidStack(FluidRegistry.getFluid("butanol"), 1000), ItemList.Cell_Empty.get(1L),200, 30);
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Butyraldehyde, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), GT_Values.NF, GT_Values.NF, GT_ModHandler.getModItem("miscutils", "butanol", 1L), ItemList.Cell_Empty.get(1L),200, 30);
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Butyraldehyde, 1L), GT_Utility.getIntegratedCircuit(2), Materials.Hydrogen.getGas(1000), GT_Values.NF, GT_ModHandler.getModItem("miscutils", "butanol", 1L), 200, 30);
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), GT_Utility.getIntegratedCircuit(2), Materials.Butyraldehyde.getFluid(1000), GT_Values.NF, GT_ModHandler.getModItem("miscutils", "butanol", 1L), 200, 30);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{Materials.Butyraldehyde.getFluid(1000), Materials.Hydrogen.getGas(1000)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("butanol"), 1000)}, null,10, 480);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9)}, new FluidStack[]{Materials.Butyraldehyde.getFluid(9000), Materials.Hydrogen.getGas(9000)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("butanol"), 9000)}, null,80, 480);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Tin, 1L)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("butanol"), 2000), new FluidStack(FluidRegistry.getFluid("propionicacid"), 1000),Materials.IronIIIChloride.getFluid(100)}, null, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.KevlarCatalyst, 1L)},600, 1920);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Tin, 9L)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("butanol"), 18000), new FluidStack(FluidRegistry.getFluid("propionicacid"), 9000),Materials.IronIIIChloride.getFluid(900)}, null, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.KevlarCatalyst, 9L)},4500, 1920);
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), GT_Utility.getIntegratedCircuit(2), Materials.Butyraldehyde.getFluid(1000), GT_Values.NF, GT_ModHandler.getModItem("miscutils", "butanol", 1L), ItemList.Cell_Empty.get(1L), 200, 30);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{Materials.Ethylene.getGas(1000), Materials.CarbonMonoxide.getGas(1000), Materials.NickelTetracarbonyl.getFluid(100), Materials.Water.getFluid(2000)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("propionicacid"), 1000)}, null,200, 480);
            GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9)}, new FluidStack[]{Materials.Ethylene.getGas(9000), Materials.CarbonMonoxide.getGas(9000), Materials.NickelTetracarbonyl.getFluid(900), Materials.Water.getFluid(18000)}, new FluidStack[]{new FluidStack(FluidRegistry.getFluid("propionicacid"), 9000)}, null,1500, 480);
            }
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Propene, 2L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.CarbonMonoxide, 2L), Materials.Hydrogen.getGas(2000), Materials.Butyraldehyde.getFluid(1000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Isobutyraldehyde, 1L), ItemList.Cell_Empty.get(3L),300, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.CarbonMonoxide, 2L), Materials.Propene.getGas(2000), Materials.Butyraldehyde.getFluid(1000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Isobutyraldehyde, 1L), ItemList.Cell_Empty.get(3L),300, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Propene, 2L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2L), Materials.CarbonMonoxide.getGas(2000), Materials.Butyraldehyde.getFluid(1000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Isobutyraldehyde, 1L), ItemList.Cell_Empty.get(3L),300, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.CarbonMonoxide, 4L), GT_Values.NF, Materials.NickelTetracarbonyl.getFluid(1000), ItemList.Cell_Empty.get(4L),400, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 1L), GT_Utility.getIntegratedCircuit(1), Materials.CarbonMonoxide.getGas(4000), Materials.NickelTetracarbonyl.getFluid(1000), GT_Values.NI,400, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 1L), ItemList.Cell_Empty.get(1L), Materials.CarbonMonoxide.getGas(4000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.cell, Materials.NickelTetracarbonyl, 1L), 400, 30);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(8), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silver, 1L)}, new FluidStack[]{Materials.Ethylene.getGas(9000), Materials.Oxygen.getGas(9000)}, new FluidStack[]{Materials.EthylenOxide.getGas(9000)}, null,400, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Ethylene, 1L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Silver, 1L), Materials.Oxygen.getGas(1000), Materials.EthylenOxide.getGas(1000), ItemList.Cell_Empty.get(1L), 800, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Ethylene, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 5L), Materials.Dimethyldichlorosilane.getFluid(4000), Materials.SiliconOil.getFluid(5000), ItemList.Cell_Empty.get(6L), 600, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Ethylene, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Dimethyldichlorosilane, 4L), Materials.Water.getFluid(5000), Materials.SiliconOil.getFluid(5000), ItemList.Cell_Empty.get(5L), 600, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(8)}, new FluidStack[]{Materials.Ethylene.getGas(9000), Materials.Dimethyldichlorosilane.getFluid(36000), Materials.Water.getFluid(45000)}, new FluidStack[]{Materials.SiliconOil.getFluid(45000)}, null,100, 1920);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.EthylenOxide, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 1L), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Ethyleneglycol, 1L), ItemList.Cell_Empty.get(1L), 300, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.EthylenOxide, 1L), GT_Utility.getIntegratedCircuit(1), Materials.Water.getFluid(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Ethyleneglycol, 1L), 300, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 1L), GT_Utility.getIntegratedCircuit(4), Materials.EthylenOxide.getFluid(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Ethyleneglycol, 1L), 300, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 1L), GT_Utility.getIntegratedCircuit(5), Materials.EthylenOxide.getFluid(1000), Materials.Ethyleneglycol.getFluid(1000), ItemList.Cell_Empty.get(1), 300, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Ethylene, 2L), GT_Utility.getIntegratedCircuit(4), Materials.Oxygen.getGas(1000), Materials.Acetaldehyde.getGas(1000), ItemList.Cell_Empty.get(2), 200, 120);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Oxygen, 1L), GT_Utility.getIntegratedCircuit(5), Materials.Ethylene.getGas(2000), Materials.Acetaldehyde.getGas(1000), ItemList.Cell_Empty.get(1), 200, 120);
        GT_Values.RA.addChemicalRecipe(GT_ModHandler.getModItem("miscutils", "Formaldehyde", 4L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SodiumHydroxide, 1L), Materials.Acetaldehyde.getGas(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Pentaerythritol, 1L), 600, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Acetaldehyde, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SodiumHydroxide, 1L), new FluidStack(FluidRegistry.getFluid("formaldehyde"), 4000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Pentaerythritol, 1L), 600, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.KevlarCatalyst, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Pentaerythritol, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.DiphenylmethaneDiisocyanate, 5L)}, new FluidStack[]{Materials.Ethyleneglycol.getFluid(4000), Materials.SiliconOil.getFluid(1000)}, null, new ItemStack[]{ItemList.PolyurethaneResin.get(1L)},200, 500000);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.KevlarCatalyst, 9L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Pentaerythritol, 9L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.DiphenylmethaneDiisocyanate, 45L)}, new FluidStack[]{Materials.Ethyleneglycol.getFluid(36000), Materials.SiliconOil.getFluid(9000)}, null, new ItemStack[]{ItemList.PolyurethaneResin.get(9L)},1500, 500000);
        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Chlorobenzene, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.NitrationMixture, 1L), GT_Values.NF, Materials.DilutedSulfuricAcid.getGas(1000), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.IVNitrochlorobenzene, 1L), ItemList.Cell_Empty.get(1L),200, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{Materials.Chlorobenzene.getFluid(1000), Materials.NitrationMixture.getFluid(1000)}, new FluidStack[]{Materials.DilutedSulfuricAcid.getGas(1000),}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.IVNitrochlorobenzene, 1)},100, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(11)}, new FluidStack[]{Materials.Chlorobenzene.getFluid(2000), Materials.NitrationMixture.getFluid(2000)}, null, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nitrochlorobenzene, 1)},200, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(5)}, new FluidStack[]{Materials.Chlorobenzene.getFluid(5000), Materials.NitrationMixture.getFluid(5000)}, null, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nitrochlorobenzene, 2), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.IIINitrochlorobenzene, 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.IVNitrochlorobenzene, 9)},1200, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9)}, new FluidStack[]{Materials.Chlorobenzene.getFluid(45000), Materials.NitrationMixture.getFluid(45000)}, null, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nitrochlorobenzene, 18), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.IIINitrochlorobenzene, 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.IVNitrochlorobenzene, 64), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.IVNitrochlorobenzene, 17)},9000, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 1L), ItemList.Cell_Empty.get(1L), Materials.NitricAcid.getFluid(4000), Materials.Water.getFluid(2000), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.IronIIINitrate, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NitricAcid, 1),200, 30);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 9L)}, new FluidStack[]{Materials.NitricAcid.getFluid(36000)}, new FluidStack[]{Materials.Water.getFluid(18000), Materials.NitricOxide.getGas(9000)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.IronIIINitrate, 9L)}, 100, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 2L), GT_Utility.getIntegratedCircuit(2), Materials.NitricAcid.getFluid(6000), Materials.Hydrogen.getGas(6000), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.IronIIINitrate, 2L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NitricAcid, 2),400, 30);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(18), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 18L)}, new FluidStack[]{Materials.NitricAcid.getFluid(54000)}, new FluidStack[]{ Materials.Hydrogen.getGas(54000),}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.IronIIINitrate, 18L)}, 200, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium, 2L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.IronIIINitrate, 1L), Materials.Ammonia.getGas(2000), Materials.Hydrogen.getGas(2000), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodiumamide, 2L), 250, 480);
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium, 18L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.IronIIINitrate, 1L)}, new FluidStack[]{Materials.Ammonia.getFluid(18000)}, new FluidStack[]{ Materials.Hydrogen.getGas(18000),}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodiumamide, 18L)}, 2000, 480);
         ...
         * Adds recipes related to producing Polybenzimidazole.
     	 */
            private void addPolybenzimidazoleRecipes() {
            	...
            	//Nitrochlorobenzene
            	//GT_Values.RA.addChemicalRecipe(Materials.Chlorobenzene.getCells(1), GT_Utility.getIntegratedCircuit(1), Materials.NitrationMixture.getFluid(1000), Materials.DilutedSulfuricAcid.getFluid(1000), Materials.Nitrochlorobenzene.getDust(1), ItemList.Cell_Empty.get(1L), 100, 480);
            	//GT_Values.RA.addChemicalRecipe(Materials.Chlorobenzene.getCells(1), GT_Utility.getIntegratedCircuit(11), Materials.NitrationMixture.getFluid(1000), GT_Values.NF, Materials.DilutedSulfuricAcid.getCells(1), Materials.Nitrochlorobenzene.getDust(1),100, 480);
            	//GT_Values.RA.addChemicalRecipe(Materials.NitrationMixture.getCells(1), GT_Utility.getIntegratedCircuit(1), Materials.Chlorobenzene.getFluid(1000), Materials.DilutedSulfuricAcid.getFluid(1000), Materials.Nitrochlorobenzene.getDust(1), ItemList.Cell_Empty.get(1L), 100, 480);
            	//GT_Values.RA.addChemicalRecipe(Materials.NitrationMixture.getCells(1), GT_Utility.getIntegratedCircuit(11), Materials.Chlorobenzene.getFluid(1000), GT_Values.NF, Materials.DilutedSulfuricAcid.getCells(1), Materials.Nitrochlorobenzene.getDust(1),100, 480);
            	...
            	//Dichlorobenzidine
            	GT_Values.RA.addChemicalRecipe(Materials.Copper.getDustTiny(1), Materials.Nitrochlorobenzene.getDust(1), GT_Values.NF, Materials.Dichlorobenzidine.getFluid(1000), null, 200, 1920);
            	GT_Values.RA.addChemicalRecipe(Materials.Copper.getDust(1),  Materials.Nitrochlorobenzene.getDust(9), GT_Values.NF, Materials.Dichlorobenzidine.getFluid(9000), null, 1800, 1920);
