...
public class GT_MachineRecipeLoader implements Runnable {
	...
	private void addRecipesApril2017ChemistryUpdate(){
		...
		GT_Values.RA.addMixerRecipe(Materials.Salt.getDust(1), GT_Values.NI, GT_Values.NI, GT_Values.NI, Materials.Water.getFluid(2000), Materials.SaltWater.getFluid(2000), GT_Values.NI, 100, 8);
