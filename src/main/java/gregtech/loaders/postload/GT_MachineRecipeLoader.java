...
public class GT_MachineRecipeLoader implements Runnable {
	...
	private void addRecipesApril2017ChemistryUpdate(){
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7)},                               new FluidStack[]{Materials.HydricSulfide.getGas(18000), Materials.SulfurDioxide.getGas(9000)}, null, new ItemStack[]{Materials.Sulfur.getDust(27)}, 60, 480);
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{Materials.Sulfur.getDust(9), GT_Utility.getIntegratedCircuit(7)}, new FluidStack[]{Materials.Oxygen.getGas(27000),        Materials.Water.getFluid(9000)},                                new FluidStack[]{Materials.SulfuricAcid.getFluid(9000)}, null, 260, 480);
