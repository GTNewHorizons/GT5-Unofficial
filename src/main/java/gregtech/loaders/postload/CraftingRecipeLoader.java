...
public class CraftingRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        if (tStack != null) {
            ...
            GTModHandler.addCraftingRecipe(
                    GTUtility
                            .copyAmount(GTMod.proxy.mNerfedWoodPlank ? tStack.stackSize / 2 : tStack.stackSize, tStack),
                    bits_no_remove_buffered,
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "PPP", "IwI", "PPP", 'P',
                        GTOreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 1L), 'I',
        ...
        List<ItemStack> iToRemoveAndHide = Arrays.stream(
                ...
                .map(x -> GTModHandler.getIC2Item(x, 1L)).collect(Collectors.toList());
        ...
        Arrays.stream(
                new String[] { "batBox", "mfeUnit", "lvTransformer", "mvTransformer", "hvTransformer", "evTransformer",
                        "cesuUnit", "luminator", "teleporter", "energyOMat", "advBattery", "boatElectric",
                        "cropnalyzer", "coil", "powerunit", "powerunitsmall", "remote", "odScanner", "ovScanner",
                        "solarHelmet", "staticBoots", "ecMeter", "obscurator", "overclockerUpgrade",
                        "transformerUpgrade", "energyStorageUpgrade", "ejectorUpgrade", "suBattery",
                        "frequencyTransmitter", "pullingUpgrade" })
                .map(x -> GTModHandler.getIC2Item(x, 1L)).forEach(GTModHandler::removeRecipeByOutputDelayed);
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "GFG", "CMC", "GDG", 'C', OrePrefixes.cableGt01.get(Materials.Platinum), 'G',
                        ...
                        GTModHandler.getIC2Item("machine", 1L), 'F',
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "CCC", "WEW", 'W', OrePrefixes.cableGt01.get(Materials.Copper), 'C',
                        GTModHandler.getIC2Item("reactorCoolantSimple", 1L, 1), 'E',
                        OrePrefixes.circuit.get(Materials.LV) });
        GTModHandler.addCraftingRecipe(
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "PPP", "GEC", "SBd", 'P', OrePrefixes.plate.get(Materials.Titanium), 'G',
                        ...
                        new ItemStack(Ic2Items.chargingEnergyCrystal.copy().getItem(), 1, WILDCARD) });
        GTModHandler.addCraftingRecipe(
                Ic2Items.miningLaser.copy(),
                GTModHandler.RecipeBits.BUFFERED,
                new Object[] { "PPP", "GEC", "SBd", 'P', OrePrefixes.plate.get(Materials.Titanium), 'G',
        ...
        if (GTOreDictUnificator.get(OrePrefixes.gear, Materials.Diamond, 1L) != null) {
            ...
            GTModHandler.addCraftingRecipe(
                    ...
                    new Object[] { "ICI", "GIG", "DPD", 'C', OrePrefixes.circuit.get(Materials.HV), 'D',
                            ...
                            GTModHandler.getIC2Item("diamondDrill", 1L, 32767) });
        }
        ...
        GTModHandler.addCraftingRecipe(
                ...
                GTModHandler.RecipeBits.BUFFERED,
                new Object[] { " C ", "SSS", " C ", 'S', GTOreDictUnificator.get(OrePrefixes.dust, Materials.Paper, 1),
        ...
        if (Thaumcraft.isModLoaded()) {
            GTModHandler.addCraftingRecipe(
                    ...
                    new Object[] { "RAR", "SBS", "RSR", 'R', OrePrefixes.stick.get(Materials.Thaumium), 'A',
                            OrePrefixes.plate.get(Materials.InfusedAir), 'S',
                            OrePrefixes.plate.get(Materials.SteelMagnetic), 'B',
                            GTModHandler.getModItem(Thaumcraft.ID, "ItemBaubleBlanks", 1, 2), });
        }
        ...
        if (EtFuturumRequiem.isModLoaded()) {
            GTModHandler.addCraftingRecipe(
                    ...
                    GTModHandler.RecipeBits.NOT_REMOVABLE | GTModHandler.RecipeBits.REVERSIBLE,
                    new Object[] { "s ", " P", 'P', GTModHandler.getModItem(EtFuturumRequiem.ID, "wood_slab", 1, 3),
                            's', "craftingToolSaw" });
        }
    }
}
