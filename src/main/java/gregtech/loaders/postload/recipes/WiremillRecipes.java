...
public class WiremillRecipes implements Runnable {
    ...
    void registerWiremillRecipes(Materials materials, int baseDuration, int eut, OrePrefixes prefix1, OrePrefixes prefix2, int multiplier){
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.wireGt01, materials, multiplier)
            )
            .noFluidInputs()
            .noFluidOutputs()
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.wireGt02, materials, 1L)
            )
            .noFluidInputs()
            .noFluidOutputs()
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.wireGt04, materials, 1L)
            )
            .noFluidInputs()
            .noFluidOutputs()
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.wireGt08, materials, 1L)
            )
            .noFluidInputs()
            .noFluidOutputs()
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.wireGt12, materials, 1L)
            )
            .noFluidInputs()
            .noFluidOutputs()
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.wireGt16, materials, 1L)
            )
            .noFluidInputs()
            .noFluidOutputs()
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.wireGt01, materials, 1L)
            )
            .noFluidInputs()
            .noFluidOutputs()
            .duration(baseDuration / 2)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.wireFine, materials, 4L * multiplier)
            )
            .noFluidInputs()
            .noFluidOutputs()
            .duration(baseDuration)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.wireFine, materials, 2L * multiplier)
            )
            .noFluidInputs()
            .noFluidOutputs()
            .duration(baseDuration / 2)
