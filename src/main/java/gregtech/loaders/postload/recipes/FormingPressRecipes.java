    ...
    public void run() {
        if (BuildCraftSilicon.isModLoaded()) {
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(getModItem(BuildCraftSilicon.ID, "redstoneChipset", 1L, 1)).duration(5 * SECONDS)
            ...
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(BuildCraftSilicon.ID, "redstoneChipset", 1L, 0))
                    .itemOutputs(getModItem(BuildCraftSilicon.ID, "redstoneChipset", 1L, 2)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_MV).addTo(formingPressRecipes);
            ...
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(BuildCraftSilicon.ID, "redstoneChipset", 1L, 0))
                    .itemOutputs(getModItem(BuildCraftSilicon.ID, "redstoneChipset", 1L, 3)).duration(5 * SECONDS)
                    .eut(TierEU.RECIPE_MV).addTo(formingPressRecipes);
            ...
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(BuildCraftSilicon.ID, "redstoneChipset", 1L, 0))
                    .itemOutputs(getModItem(BuildCraftSilicon.ID, "redstoneChipset", 2L, 4)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_MV).addTo(formingPressRecipes);
            ...
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(BuildCraftSilicon.ID, "redstoneChipset", 1L, 0))
                    .itemOutputs(getModItem(BuildCraftSilicon.ID, "redstoneChipset", 1L, 5)).duration(15 * SECONDS)
                    .eut(TierEU.RECIPE_MV).addTo(formingPressRecipes);
            ...
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(BuildCraftSilicon.ID, "redstoneChipset", 1L, 0))
                    .itemOutputs(getModItem(BuildCraftSilicon.ID, "redstoneChipset", 1L, 6)).duration(15 * SECONDS)
                    .eut(TierEU.RECIPE_MV).addTo(formingPressRecipes);
        }
        ...
        if (AppliedEnergistics2.isModLoaded()) {
            GTValues.RA.stdBuilder()
                    ...
                    .duration(10 * SECONDS).eut(16).addTo(formingPressRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.Food_Dough_Sugar.get(4L), ItemList.Shape_Mold_Cylinder.get(0L))
                .itemOutputs(ItemList.Food_Raw_Cake.get(1L)).duration(19 * SECONDS + 4 * TICKS).eut(4)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.Credit_Greg_Cupronickel.get(4L)).duration(5 * SECONDS).eut(16)
                .addTo(formingPressRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        ItemList.Shape_Mold_Credit.get(0L))
                .itemOutputs(ItemList.Coin_Doge.get(4L)).duration(5 * SECONDS).eut(16).addTo(formingPressRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 1L),
                        ItemList.Shape_Mold_Credit.get(0L))
                .itemOutputs(ItemList.Credit_Iron.get(4L)).duration(5 * SECONDS).eut(16).addTo(formingPressRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(new ItemStack(Items.brick, 1, 0)).duration(5 * SECONDS).eut(16).addTo(formingPressRecipes);
        // Bartworks Glass Tube
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Glass, 2L),
                        ItemList.Shape_Mold_Rod_Long.get(0L))
                .itemOutputs(new ItemStack(ItemRegistry.PUMPPARTS, 1, 0)).duration(15 * SECONDS).eut(16)
                .addTo(formingPressRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.UUMatter.getFluid(4_096_000L)).itemOutputs(ItemList.NaniteFramework.get(1))
                .duration(60 * SECONDS).eut(TierEU.RECIPE_UXV).addTo(formingPressRecipes);
    }
}
