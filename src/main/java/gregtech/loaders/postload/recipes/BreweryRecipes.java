...
public class BreweryRecipes implements Runnable {
    ...
    public void run() {
        ...
        // water based recipe input
        {
            ...
            /*
            if IC2 isn't loaded, getDistilledWater returns the base minecraft water, so no need to do the recipe loading
            twice.
             */
            if (IndustrialCraft2.isModLoaded()) {
                waterArray = new String[]{
                    FluidRegistry.WATER.getUnlocalizedName(),
            ...
            for (String fluid : waterArray) {
                GT_Values.RA.stdBuilder()
                    ...
                    .noItemOutputs()
                    .fluidInputs(
                        getFluidStack(fluid, 750)
                    )
                    .fluidOutputs(
                        getFluidStack("milk", 750)
                    )
                    .duration(6 * SECONDS + 8 * TICKS)
                    .eut(4)
                    .addTo(sBrewingRecipes);
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .fluidOutputs(
                        getFluidStack("potion.wheatyjuice", 750)
                    )
                    .duration(6 * SECONDS + 8 * TICKS)
                    .eut(4)
                    .addTo(sBrewingRecipes);
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .fluidOutputs(
                        getFluidStack("potion.mineralwater", 750)
                    )
                    .duration(6 * SECONDS + 8 * TICKS)
                    .eut(4)
                    .addTo(sBrewingRecipes);
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .fluidOutputs(
                        getFluidStack("potion.thick", 750)
                    )
                    .duration(6 * SECONDS + 8 * TICKS)
                    .eut(4)
                    .addTo(sBrewingRecipes);
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .fluidOutputs(
                        getFluidStack("potion.mundane", 750)
                    )
                    .duration(6 * SECONDS + 8 * TICKS)
                    .eut(4)
                    .addTo(sBrewingRecipes);
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .fluidOutputs(
                        getFluidStack("potion.awkward", 750)
                    )
                    .duration(6 * SECONDS + 8 * TICKS)
                    .eut(4)
                    .addTo(sBrewingRecipes);
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .fluidOutputs(
                        getFluidStack("potion.poison", 750)
                    )
                    .duration(6 * SECONDS + 8 * TICKS)
                    .eut(4)
                    .addTo(sBrewingRecipes);
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .fluidOutputs(
                        getFluidStack("potion.poison.strong", 750)
                    )
                    .duration(6 * SECONDS + 8 * TICKS)
                    .eut(4)
                    .hidden()
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .fluidOutputs(
                        getFluidStack("potion.reedwater", 750)
                    )
                    .duration(6 * SECONDS + 8 * TICKS)
                    .eut(4)
                    .addTo(sBrewingRecipes);
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .fluidOutputs(
                        getFluidStack("potion.applejuice", 750)
                    )
                    .duration(6 * SECONDS + 8 * TICKS)
                    .eut(4)
                    .addTo(sBrewingRecipes);
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .fluidOutputs(
                        getFluidStack("potion.goldenapplejuice", 750)
                    )
                    .duration(6 * SECONDS + 8 * TICKS)
                    .eut(4)
                    .hidden()
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .fluidOutputs(
                        getFluidStack("potion.idunsapplejuice", 750)
                    )
                    .duration(6 * SECONDS + 8 * TICKS)
                    .eut(4)
                    .hidden()
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .fluidOutputs(
                        getFluidStack("potion.hopsjuice", 750)
                    )
                    .duration(6 * SECONDS + 8 * TICKS)
                    .eut(4)
                    .addTo(sBrewingRecipes);
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .fluidOutputs(
                        getFluidStack("potion.darkcoffee", 750)
                    )
                    .duration(6 * SECONDS + 8 * TICKS)
                    .eut(4)
                    .addTo(sBrewingRecipes);
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .fluidOutputs(
                        getFluidStack("potion.chillysauce", 750)
                    )
                    .duration(6 * SECONDS + 8 * TICKS)
                    .eut(4)
                    .addTo(sBrewingRecipes);
        ...
        //potion brewing 1
        {
            GT_Values.RA.stdBuilder()
                ...
                .fluidOutputs(
                    getFluidStack("potion.hotsauce", 750)
                )
                .duration(6 * SECONDS + 8 * TICKS)
                .eut(4)
                .addTo(sBrewingRecipes);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidOutputs(
                    getFluidStack("potion.diabolosauce", 750)
                )
                .duration(6 * SECONDS + 8 * TICKS)
                .eut(4)
                .hidden()
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidOutputs(
                    getFluidStack("potion.diablosauce", 750)
                )
                .duration(6 * SECONDS + 8 * TICKS)
                .eut(4)
                .hidden()
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidOutputs(
                    getFluidStack("potion.coffee", 750)
                )
                .duration(6 * SECONDS + 8 * TICKS)
                .eut(4)
                .addTo(sBrewingRecipes);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidOutputs(
                    getFluidStack("potion.darkchocolatemilk", 750)
                )
                .duration(6 * SECONDS + 8 * TICKS)
                .eut(4)
                .addTo(sBrewingRecipes);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidOutputs(
                    getFluidStack("potion.wheatyhopsjuice", 750)
                )
                .duration(6 * SECONDS + 8 * TICKS)
                .eut(4)
                .addTo(sBrewingRecipes);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .noItemOutputs()
                .fluidInputs(
                    getFluidStack("potion.tea", 750)
                )
                .fluidOutputs(
                    getFluidStack("potion.sweettea", 750)
                )
                .duration(6 * SECONDS + 8 * TICKS)
                .eut(4)
                .hidden()
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidOutputs(
                    getFluidStack("potion.cafeaulait", 750)
                )
                .duration(6 * SECONDS + 8 * TICKS)
                .eut(4)
                .addTo(sBrewingRecipes);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidOutputs(
                    getFluidStack("potion.laitaucafe", 750)
                )
                .duration(6 * SECONDS + 8 * TICKS)
                .eut(4)
                .hidden()
            ...
            GT_Values.RA.stdBuilder()
                ...
                .noItemOutputs()
                .fluidInputs(
                    getFluidStack("potion.lemonjuice", 750)
                )
                .fluidOutputs(
                    getFluidStack("potion.lemonade", 750)
                )
                .duration(6 * SECONDS + 8 * TICKS)
                .eut(4)
                .addTo(sBrewingRecipes);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidOutputs(
                    getFluidStack("potion.darkcafeaulait", 750)
                )
                .duration(6 * SECONDS + 8 * TICKS)
                .eut(4)
                .hidden()
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidOutputs(
                    getFluidStack("potion.chocolatemilk", 750)
                )
                .duration(6 * SECONDS + 8 * TICKS)
                .eut(4)
                .addTo(sBrewingRecipes);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidOutputs(
                    getFluidStack("potion.icetea", 750)
                )
                .duration(6 * SECONDS + 8 * TICKS)
                .eut(4)
                .addTo(sBrewingRecipes);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidOutputs(
                    getFluidStack("potion.cavejohnsonsgrenadejuice", 750)
                )
                .duration(6 * SECONDS + 8 * TICKS)
                .eut(4)
                .hidden()
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidOutputs(
                    getFluidStack("potion.weakness", 750)
                )
                .duration(6 * SECONDS + 8 * TICKS)
                .eut(4)
                .addTo(sBrewingRecipes);
        ...
        // biomass recipes
        {
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    getModItem(Forestry.modID, "fertilizerBio", 4L, 0)
                )
                .noItemOutputs()
                .fluidInputs(
                    getFluidStack(FluidRegistry.WATER.getUnlocalizedName(), 750)
                )
                .fluidOutputs(
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    getModItem(Forestry.modID, "mulch", 16L, 0)
                )
                .noItemOutputs()
                .fluidInputs(
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    getModItem(Forestry.modID, "mulch", 8L, 0)
                )
                .noItemOutputs()
                .fluidInputs(
    ...
    public void addPotionRecipes(String aName, ItemStack aItem) {
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidOutputs(
                getFluidStack("potion." + aName, 750)
            )
            .duration(6 * SECONDS + 8 * TICKS)
            .eut(4)
            .addTo(sBrewingRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidOutputs(
                getFluidStack("potion." + aName + ".strong", 750)
            )
            .duration(6 * SECONDS + 8 * TICKS)
            .eut(4)
            .addTo(sBrewingRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidOutputs(
                getFluidStack("potion." + aName + ".long", 750)
            )
            .duration(6 * SECONDS + 8 * TICKS)
            .eut(4)
            .addTo(sBrewingRecipes);
