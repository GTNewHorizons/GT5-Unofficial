...
public class TranscendentPlasmaMixerRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .fluidOutputs(MaterialsUEVplus.ExcitedDTCC.getFluid(1_000)).duration(100).eut(CRUDE_EU_PER_L)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                ...
                .fluidOutputs(MaterialsUEVplus.ExcitedDTPC.getFluid(1_000)).duration(100).eut(PROSAIC_EU_PER_L)
                .addTo(transcendentPlasmaMixerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(3))
                ...
                .fluidOutputs(MaterialsUEVplus.ExcitedDTRC.getFluid(1_000)).duration(100).eut(RESPLENDENT_EU_PER_L)
                .addTo(transcendentPlasmaMixerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(4))
                ...
                .fluidOutputs(MaterialsUEVplus.ExcitedDTEC.getFluid(1_000)).duration(100).eut(EXOTIC_EU_PER_L)
                .addTo(transcendentPlasmaMixerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(5))
                ...
                .fluidOutputs(MaterialsUEVplus.ExcitedDTSC.getFluid(1_000)).duration(100).eut(STELLAR_EU_PER_HALF_L)
                .metadata(GTRecipeConstants.EU_MULTIPLIER, 20).addTo(transcendentPlasmaMixerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(24))
                ...
                .fluidOutputs(MaterialsUEVplus.PrimordialMatter.getFluid(1_000)).duration(100).eut(PRIMORDIAL_MATTER)
                .addTo(transcendentPlasmaMixerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(24))
                .fluidInputs(
                        ...
                        Materials.Calcium.getPlasma(1_000),
                        MaterialsUEVplus.DimensionallyTranscendentResidue.getFluid(1_000))
                .fluidOutputs(MaterialsUEVplus.Creon.getPlasma(5_000)).duration(100).eut(TierEU.RECIPE_UMV)
                .addTo(transcendentPlasmaMixerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(24))
                ...
                // 1 Trillion EU/t
                .metadata(GTRecipeConstants.EU_MULTIPLIER, 1000).eut(1_000_000_000L)
                .addTo(transcendentPlasmaMixerRecipes);
    }
}
