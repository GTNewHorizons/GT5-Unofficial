...
public class AutoclaveRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(ItemList.Carbon_Fibre.get(16))
            .outputChances(10000)
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(ItemList.Carbon_Fibre.get(4))
            .outputChances(10000)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Carbon, 4))
            .itemOutputs(ItemList.Carbon_Fibre.get(2))
            .outputChances(10000)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Carbon, 4))
            .itemOutputs(ItemList.Carbon_Fibre.get(1))
            .outputChances(10000)
