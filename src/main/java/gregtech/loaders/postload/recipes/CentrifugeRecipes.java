...
public class CentrifugeRecipes implements Runnable {
    ...
    public void run() {
        GTValues.RA.stdBuilder()
            ...
            .circuit(1)
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.Methane, FluidShapes.fluidGas, (int) (60)))
            .duration(10 * SECONDS)
            .eut(20)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Mercury, FluidShapes.fluidLiquid, (int) (200)))
            .duration(20 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.Nitrogen, FluidShapes.fluidGas, (int) (3_900)))
            .duration(1 * MINUTES + 20 * SECONDS)
            .eut(TierEU.RECIPE_ULV)
            .addTo(centrifugeRecipes);

        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.PlatinumGroupSludge, Shapes.dust, (int) (3)))
            .itemOutputs(
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.Methane, FluidShapes.fluidGas, (int) (4608)))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.Methane, FluidShapes.fluidGas, (int) (576)))
            .duration(7 * MINUTES + 40 * SECONDS + 16 * TICKS)
            .eut(5)
            .addTo(centrifugeRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.Methane, FluidShapes.fluidGas, (int) (36)))
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(1)
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.Methane, FluidShapes.fluidGas, (int) (18)))
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(1)
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.Methane, FluidShapes.fluidGas, (int) (9)))
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(1)
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.Methane, FluidShapes.fluidGas, (int) (72)))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.Glue, FluidShapes.fluidLiquid, (int) (100)))
            .duration(15 * SECONDS)
            .eut(5)
            .addTo(centrifugeRecipes);
        ...
        if (!Mods.NuclearHorizons.isModLoaded()) {
            ...
            GTValues.RA.stdBuilder()
                ...
                .outputChances(10000)
                .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Fluorine, FluidShapes.fluidGas, (int) (4_000)))
        ...
        GTValues.RA.stdBuilder()
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Hydrogen, FluidShapes.fluidGas, (int) (160)))
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.Deuterium, FluidShapes.fluidGas, (int) (40)))
            .duration(8 * SECONDS)
            .eut(20)
            .addTo(centrifugeRecipes);

        GTValues.RA.stdBuilder()
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Deuterium, FluidShapes.fluidGas, (int) (160)))
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.Tritium, FluidShapes.fluidGas, (int) (40)))
            .duration(8 * SECONDS)
            .eut(80)
            .addTo(centrifugeRecipes);

        GTValues.RA.stdBuilder()
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Helium, FluidShapes.fluidGas, (int) (80)))
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.Helium3, FluidShapes.fluidGas, (int) (5)))
            .duration(8 * SECONDS)
            .eut(80)
            .addTo(centrifugeRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.Helium, FluidShapes.fluidGas, (int) (4_320)))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.Oil, FluidShapes.fluidLiquid, (int) (200)))
            .duration(10 * SECONDS)
            .eut(12)
            .addTo(centrifugeRecipes);
        ...
        GTValues.RA.stdBuilder()
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Propane, FluidShapes.fluidGas, (int) (320)))
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.LPG, FluidShapes.fluidLiquid, (int) (290)))
            .duration(20 * TICKS)
            .eut(5)
            .addTo(centrifugeRecipes);

        GTValues.RA.stdBuilder()
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Butane, FluidShapes.fluidGas, (int) (320)))
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.LPG, FluidShapes.fluidLiquid, (int) (370)))
            .duration(20 * TICKS)
            .eut(5)
            .addTo(centrifugeRecipes);
        ...
        if (Thaumcraft.isModLoaded() && Forestry.isModLoaded()) {
            ...
            GTValues.RA.stdBuilder()
                ...
                .circuit(1)
                .itemOutputs(MaterialLibAPI.getStack(Materials.InfusedEntropy, Shapes.gem, (int) (1)))
                .duration(51 * SECONDS + 4 * TICKS)
                .eut(12)
                .addTo(centrifugeRecipes);
