...
public class CentrifugeRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ItemList.Food_Raw_Potato.get(16),
                GT_Utility.getIntegratedCircuit(1)
            )
            .noItemOutputs()
            .noFluidInputs()
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ItemList.Food_Poisonous_Potato.get(12),
                GT_Utility.getIntegratedCircuit(1)
            )
            .noItemOutputs()
            .noFluidInputs()
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ItemList.Food_Baked_Potato.get(24),
                GT_Utility.getIntegratedCircuit(1)
            )
            .noItemOutputs()
            .noFluidInputs()
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_ModHandler.getIC2Item("terraWart", 16),
                GT_Utility.getIntegratedCircuit(1)
            )
            .noItemOutputs()
            .noFluidInputs()
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Naquadah, 9)
            )
            .itemOutputs(
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NaquadahEnriched, 4)
            )
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Naquadria, 1),
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Hydrogen.getGas(160)
            )
            .fluidOutputs(
                Materials.Deuterium.getGas(40)
            )
            .duration(8 * SECONDS)
            .eut(20)
            .addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Deuterium.getGas(160)
            )
            .fluidOutputs(
                Materials.Tritium.getGas(40)
            )
            .duration(8 * SECONDS)
            .eut(80)
            .addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Helium.getGas(80)
            )
            .fluidOutputs(
                Materials.Helium_3.getGas(5)
            )
            .duration(8 * SECONDS)
            .eut(80)
            .addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Glowstone, 2)
            )
            .itemOutputs(
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Endstone, 36)
            )
            .itemOutputs(
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Netherrack, 36)
            )
            .itemOutputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidOutputs(
                Materials.FluidNaquadahFuel.getFluid(4806)
            )
            .duration(30 * SECONDS)
            .eut(2000000)
            .addTo(sCentrifugeRecipes);
        ...
        if (Thaumcraft.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    getModItem(GregTech.modID, "gt.comb", 1L, 144),
                    GT_Utility.getIntegratedCircuit(1)
                )
                .itemOutputs(
                    GT_OreDictUnificator.get(OrePrefixes.gem, Materials.InfusedAir, 1)
                )
                .noFluidInputs()
                .noFluidOutputs()
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    getModItem(GregTech.modID, "gt.comb", 1L, 146),
                    GT_Utility.getIntegratedCircuit(1)
                )
                .itemOutputs(
                    GT_OreDictUnificator.get(OrePrefixes.gem, Materials.InfusedFire, 1)
                )
                .noFluidInputs()
                .noFluidOutputs()
                .duration(51 * SECONDS + 4 * TICKS)
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    getModItem(GregTech.modID, "gt.comb", 1L, 147),
                    GT_Utility.getIntegratedCircuit(1)
                )
                .itemOutputs(
                    GT_OreDictUnificator.get(OrePrefixes.gem, Materials.InfusedWater, 1)
                )
                .noFluidInputs()
                .noFluidOutputs()
                .duration(51 * SECONDS + 4 * TICKS)
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    getModItem(GregTech.modID, "gt.comb", 1L, 145),
                    GT_Utility.getIntegratedCircuit(1)
                )
                .itemOutputs(
                    GT_OreDictUnificator.get(OrePrefixes.gem, Materials.InfusedEarth, 1)
                )
                .noFluidInputs()
                .noFluidOutputs()
                .duration(51 * SECONDS + 4 * TICKS)
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    getModItem(GregTech.modID, "gt.comb", 1L, 148),
                    GT_Utility.getIntegratedCircuit(1)
                )
                .itemOutputs(
                    GT_OreDictUnificator.get(OrePrefixes.gem, Materials.InfusedOrder, 1)
                )
                .noFluidInputs()
                .noFluidOutputs()
                .duration(51 * SECONDS + 4 * TICKS)
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    getModItem(GregTech.modID, "gt.comb", 1L, 149),
                    GT_Utility.getIntegratedCircuit(1)
                )
                .itemOutputs(
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    getModItem(GregTech.modID, "gt.comb", 1L, 152),
                    GT_Utility.getIntegratedCircuit(1)
                )
                .itemOutputs(
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    getModItem(GregTech.modID, "gt.comb", 1L, 153),
                    GT_Utility.getIntegratedCircuit(1)
                )
                .itemOutputs(
        ...
        if (ExtraUtilities.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    getModItem(GregTech.modID, "gt.comb", 1L, 154),
                    GT_Utility.getIntegratedCircuit(1)
                )
                .itemOutputs(
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    getModItem(GregTech.modID, "gt.comb", 1L, 155),
                    GT_Utility.getIntegratedCircuit(1)
                )
                .itemOutputs(
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    getModItem(GregTech.modID, "gt.comb", 1L, 156),
                    GT_Utility.getIntegratedCircuit(1)
                )
                .itemOutputs(
