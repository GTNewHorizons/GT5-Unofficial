...
public class SmelterRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_ModHandler.addSmeltingRecipe(
            OreDictUnificator.get(OrePrefixes.ore, Materials.Graphite, 1L),
            OreDictUnificator.get(OrePrefixes.dust, Materials.Graphite, 1L));

        GT_ModHandler.addSmeltingRecipe(
            OreDictUnificator.get(OrePrefixes.oreBlackgranite, Materials.Graphite, 1L),
            OreDictUnificator.get(OrePrefixes.dust, Materials.Graphite, 1L));

        GT_ModHandler.addSmeltingRecipe(
            OreDictUnificator.get(OrePrefixes.oreEndstone, Materials.Graphite, 1L),
            OreDictUnificator.get(OrePrefixes.dust, Materials.Graphite, 1L));

        GT_ModHandler.addSmeltingRecipe(
            OreDictUnificator.get(OrePrefixes.oreNetherrack, Materials.Graphite, 1L),
            OreDictUnificator.get(OrePrefixes.dust, Materials.Graphite, 1L));

        GT_ModHandler.addSmeltingRecipe(
            OreDictUnificator.get(OrePrefixes.nugget, Materials.Iron, 1L),
            OreDictUnificator.get(OrePrefixes.nugget, Materials.WroughtIron, 1L));

        GT_ModHandler.addSmeltingRecipe(
            OreDictUnificator.get(OrePrefixes.oreRedgranite, Materials.Graphite, 1L),
            OreDictUnificator.get(OrePrefixes.dust, Materials.Graphite, 1L));
