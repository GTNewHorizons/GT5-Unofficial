...
public class CannerRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Cadmium, Materials2Shapes.dust, (int) (2L)),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Lithium, Materials2Shapes.dust, (int) (2L)),
                ItemList.Battery_Hull_LV.get(1L))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Sodium, Materials2Shapes.dust, (int) (2L)),
                ItemList.Battery_Hull_LV.get(1L))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Cadmium, Materials2Shapes.dust, (int) (8L)),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Lithium, Materials2Shapes.dust, (int) (8L)),
                ItemList.Battery_Hull_MV.get(1L))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Sodium, Materials2Shapes.dust, (int) (8L)),
                ItemList.Battery_Hull_MV.get(1L))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Cadmium, Materials2Shapes.dust, (int) (32L)),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Lithium, Materials2Shapes.dust, (int) (32L)),
                ItemList.Battery_Hull_HV.get(1L))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Sodium, Materials2Shapes.dust, (int) (32L)),
                ItemList.Battery_Hull_HV.get(1L))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Sunnarium, Materials2Shapes.dust, (int) (4L)),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Sunnarium, Materials2Shapes.dust, (int) (16L)),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Sunnarium, Materials2Shapes.dust, (int) (32L)),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Naquadria, Materials2Shapes.dust, (int) (16L)),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Naquadria, Materials2Shapes.dust, (int) (32L)),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Neutronium, Materials2Shapes.dust, (int) (16L)),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Neutronium, Materials2Shapes.dust, (int) (32L)),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Neutronium, Materials2Shapes.dust, (int) (64L)),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Infinity, Materials2Shapes.dust, (int) (4L)),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Infinity, Materials2Shapes.dust, (int) (8L)),
