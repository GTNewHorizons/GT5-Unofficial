...
public class AssemblyLineRecipes implements Runnable {
    ...
    public AssemblyLineRecipes(){
        solderIndalloy = GTPlusPlus.isModLoaded()
    ...
    public void run() {
        ...
        // Motors
        {
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ItemList.Electric_Motor_ZPM.get(1),
                288000,
                new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.SamariumMagnetic, 2),
        ...
        // Pumps
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .metadata(RESEARCH_TIME, 144000)
                .itemInputs(ItemList.Electric_Motor_LuV.get(1),
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ...
                144000,
                new Object[]{ItemList.Electric_Motor_ZPM.get(1),
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ItemList.Electric_Pump_ZPM.get(1),
                288000,
                new Object[]{ItemList.Electric_Motor_UV.get(1),
        ...
        // Conveyors
        {
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ...
                144000,
                new Object[]{ItemList.Electric_Motor_LuV.get(2),
                    GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSSS, 2),
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ItemList.Conveyor_Module_LuV.get(1),
                144000,
                new Object[]{ItemList.Electric_Motor_ZPM.get(2),
                    GT_OreDictUnificator.get(OrePrefixes.plate, Materials.NaquadahAlloy, 2),
                    GT_OreDictUnificator.get(OrePrefixes.ring, Materials.NaquadahAlloy, 4),
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ItemList.Conveyor_Module_ZPM.get(1),
                288000,
                new Object[]{ItemList.Electric_Motor_UV.get(2),
                    GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Neutronium, 2),
                    GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Neutronium, 4),
        ...
        // Pistons
        {
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ...
                144000,
                new ItemStack[]{ItemList.Electric_Motor_LuV.get(1),
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ItemList.Electric_Piston_LuV.get(1),
                144000,
                new ItemStack[]{ItemList.Electric_Motor_ZPM.get(1),
        ...
        // RobotArms
        {
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ...
                144000,
                new Object[]{GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.HSSS, 4),
                    GT_OreDictUnificator.get(OrePrefixes.gear, Materials.HSSS, 1),
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ItemList.Robot_Arm_LuV.get(1),
                144000,
                new Object[]{GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.NaquadahAlloy, 4),
                    GT_OreDictUnificator.get(OrePrefixes.gear, Materials.NaquadahAlloy, 1),
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ItemList.Robot_Arm_ZPM.get(1),
                288000,
                new Object[]{GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.Neutronium, 4),
                    GT_OreDictUnificator.get(OrePrefixes.gear, Materials.Neutronium, 1),
        ...
        // Emitters
        {
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ...
                144000,
                new Object[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.HSSS, 1),
                    ItemList.Electric_Motor_LuV.get(1),
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ItemList.Emitter_LuV.get(1),
                144000,
                new Object[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.NaquadahAlloy, 1),
                    ItemList.Electric_Motor_ZPM.get(1),
        ...
        // Energy Hatches
        {
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ItemList.Hatch_Energy_LuV.get(1),
                144000,
                new Object[]{ItemList.Hull_ZPM.get(1),
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ItemList.Hatch_Energy_ZPM.get(1),
                288000,
                new Object[]{ItemList.Hull_UV.get(1),
        ...
        // Dynamo Hatches
        {
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ...
                72000,
                new Object[]{ItemList.Hull_LuV.get(1),
        ...
        // Fusion Controller
        {
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ...
                new FluidStack[]{new FluidStack(solderIndalloy, 2880), Materials.VanadiumGallium.getMolten(1152),},
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ...
                new FluidStack[]{new FluidStack(solderIndalloy, 2880), Materials.NiobiumTitanium.getMolten(1152),},
            ...
            GT_Values.RA.addAssemblylineRecipe(
                ...
                new FluidStack[]{new FluidStack(solderIndalloy, 2880), Materials.ElectrumFlux.getMolten(1152),},
        ...
        GT_Values.RA.addAssemblylineRecipe(
            ...
            288000,
            new Object[] { GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Europium, 16),
                new Object[] { OrePrefixes.circuit.get(Materials.Ultimate), 1 },
                new Object[] { OrePrefixes.circuit.get(Materials.Ultimate), 1 },
                new Object[] { OrePrefixes.circuit.get(Materials.Ultimate), 1 },
                new Object[] { OrePrefixes.circuit.get(Materials.Ultimate), 1 },
                ItemList.Energy_LapotronicOrb2.get(8), ItemList.Field_Generator_LuV.get(2),
        ...
        GT_Values.RA.addAssemblylineRecipe(
            ItemList.Energy_Module.get(1),
            288000,
            new Object[] { GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Americium, 32),
                new Object[] { OrePrefixes.circuit.get(Materials.SuperconductorUHV), 1 },
                new Object[] { OrePrefixes.circuit.get(Materials.SuperconductorUHV), 1 },
                new Object[] { OrePrefixes.circuit.get(Materials.SuperconductorUHV), 1 },
                new Object[] { OrePrefixes.circuit.get(Materials.SuperconductorUHV), 1 },
                ItemList.Energy_Module.get(8), ItemList.Field_Generator_ZPM.get(2),
        ...
        GT_Values.RA.addAssemblylineRecipe(
                ...
                432000,
                new Object[] { ItemList.Hull_MAX.get(1), ItemList.Electric_Motor_UHV.get(32),
                        ItemList.Electric_Piston_UHV.get(8), ItemList.Electric_Pump_UHV.get(16),
                        ItemList.Conveyor_Module_UHV.get(8), ItemList.Robot_Arm_UHV.get(8),
