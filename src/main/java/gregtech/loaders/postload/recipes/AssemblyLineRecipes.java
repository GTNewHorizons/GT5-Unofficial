    ...
    public void run() {
        ...
        // Motors
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    OreDictUnificator.get(OrePrefixes.stick, Materials.SamariumMagnetic, 1),
                    OreDictUnificator.get(OrePrefixes.stickLong, Materials.HSSS, 2),
                    OreDictUnificator.get(OrePrefixes.wireFine, LuVMat, 64),
                    OreDictUnificator.get(OrePrefixes.wireFine, LuVMat, 64),
                    OreDictUnificator.get(OrePrefixes.cableGt01, Materials.YttriumBariumCuprate, 2))
            ...
            GT_Values.RA.stdBuilder()
                ...
                .metadata(RESEARCH_TIME, 2 * HOURS)
                .itemInputs(
                    OreDictUnificator.get(OrePrefixes.stick, Materials.SamariumMagnetic, 2),
                    OreDictUnificator.get(OrePrefixes.stickLong, Materials.NaquadahAlloy, 4),
                    OreDictUnificator.get(OrePrefixes.ring, Materials.NaquadahAlloy, 4),
                    OreDictUnificator.get(OrePrefixes.round, Materials.NaquadahAlloy, 16),
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    OreDictUnificator.get(OrePrefixes.stickLong, Materials.SamariumMagnetic, 2),
                    OreDictUnificator.get(OrePrefixes.stickLong, Materials.Neutronium, 4),
                    OreDictUnificator.get(OrePrefixes.ring, Materials.Neutronium, 4),
                    OreDictUnificator.get(OrePrefixes.round, Materials.Neutronium, 16),
                    OreDictUnificator.get(OrePrefixes.wireFine, Materials.Americium, 64),
                    OreDictUnificator.get(OrePrefixes.wireFine, Materials.Americium, 64),
                    OreDictUnificator.get(OrePrefixes.wireFine, Materials.Americium, 64),
                    OreDictUnificator.get(OrePrefixes.wireFine, Materials.Americium, 64),
                    OreDictUnificator.get(OrePrefixes.wireFine, Materials.Americium, 64),
                    OreDictUnificator.get(OrePrefixes.wireFine, Materials.Americium, 64),
                    OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NaquadahAlloy, 2))
                .fluidInputs(
        ...
        // Pumps
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.pipeSmall, Materials.NiobiumTitanium, 2),
                    OreDictUnificator.get(OrePrefixes.plate, Materials.HSSS, 2),
                    OreDictUnificator.get(OrePrefixes.screw, Materials.HSSS, 8),
                    new Object[] { OrePrefixes.ring.get(Materials.AnySyntheticRubber), 4 },
                    OreDictUnificator.get(OrePrefixes.rotor, Materials.HSSS, 2),
                    OreDictUnificator.get(OrePrefixes.cableGt01, Materials.YttriumBariumCuprate, 2))
                .fluidInputs(new FluidStack(solderIndalloy, 144), Materials.Lubricant.getFluid(250))
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Enderium, 2),
                    OreDictUnificator.get(OrePrefixes.plate, Materials.NaquadahAlloy, 2),
                    OreDictUnificator.get(OrePrefixes.screw, Materials.NaquadahAlloy, 8),
                    new Object[] { OrePrefixes.ring.get(Materials.AnySyntheticRubber), 8 },
                    OreDictUnificator.get(OrePrefixes.rotor, Materials.NaquadahAlloy, 2),
                    OreDictUnificator.get(OrePrefixes.cableGt04, Materials.VanadiumGallium, 2))
                .fluidInputs(new FluidStack(solderIndalloy, 288), Materials.Lubricant.getFluid(750))
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.screw, Materials.Neutronium, 8),
                    new Object[] { OrePrefixes.ring.get(Materials.AnySyntheticRubber), 16 },
                    OreDictUnificator.get(OrePrefixes.rotor, Materials.Neutronium, 2),
                    OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NaquadahAlloy, 2))
        ...
        // Conveyors
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.plate, Materials.HSSS, 2),
                    OreDictUnificator.get(OrePrefixes.ring, Materials.HSSS, 4),
                    OreDictUnificator.get(OrePrefixes.round, Materials.HSSS, 32),
                    OreDictUnificator.get(OrePrefixes.cableGt01, Materials.YttriumBariumCuprate, 2),
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.plate, Materials.NaquadahAlloy, 2),
                    OreDictUnificator.get(OrePrefixes.ring, Materials.NaquadahAlloy, 4),
                    OreDictUnificator.get(OrePrefixes.round, Materials.NaquadahAlloy, 32),
                    OreDictUnificator.get(OrePrefixes.cableGt04, Materials.VanadiumGallium, 2),
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.plate, Materials.Neutronium, 2),
                    OreDictUnificator.get(OrePrefixes.ring, Materials.Neutronium, 4),
                    OreDictUnificator.get(OrePrefixes.round, Materials.Neutronium, 32),
                    OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NaquadahAlloy, 2),
        ...
        // Pistons
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ItemList.Electric_Motor_LuV.get(1),
                    OreDictUnificator.get(OrePrefixes.plate, Materials.HSSS, 6),
                    OreDictUnificator.get(OrePrefixes.ring, Materials.HSSS, 4),
                    OreDictUnificator.get(OrePrefixes.round, Materials.HSSS, 32),
                    OreDictUnificator.get(OrePrefixes.stick, Materials.HSSS, 4),
                    OreDictUnificator.get(OrePrefixes.gear, Materials.HSSS, 1),
                    OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.HSSS, 2),
                    OreDictUnificator.get(OrePrefixes.cableGt01, Materials.YttriumBariumCuprate, 4))
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ItemList.Electric_Motor_ZPM.get(1),
                    OreDictUnificator.get(OrePrefixes.plate, Materials.NaquadahAlloy, 6),
                    OreDictUnificator.get(OrePrefixes.ring, Materials.NaquadahAlloy, 4),
                    OreDictUnificator.get(OrePrefixes.round, Materials.NaquadahAlloy, 32),
                    OreDictUnificator.get(OrePrefixes.stick, Materials.NaquadahAlloy, 4),
                    OreDictUnificator.get(OrePrefixes.gear, Materials.NaquadahAlloy, 1),
                    OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.NaquadahAlloy, 2),
                    OreDictUnificator.get(OrePrefixes.cableGt04, Materials.VanadiumGallium, 4))
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.ring, Materials.Neutronium, 4),
                    OreDictUnificator.get(OrePrefixes.round, Materials.Neutronium, 32),
                    OreDictUnificator.get(OrePrefixes.stick, Materials.Neutronium, 4),
                    OreDictUnificator.get(OrePrefixes.gear, Materials.Neutronium, 1),
                    OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.Neutronium, 2),
                    OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NaquadahAlloy, 4))
        ...
        // RobotArms
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .metadata(RESEARCH_TIME, 2 * HOURS)
                .itemInputs(
                    OreDictUnificator.get(OrePrefixes.stickLong, Materials.HSSS, 4),
                    OreDictUnificator.get(OrePrefixes.gear, Materials.HSSS, 1),
                    OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.HSSS, 3),
                    ItemList.Electric_Motor_LuV.get(2),
                    ...
                    OreDictUnificator.get(OrePrefixes.cableGt01, Materials.YttriumBariumCuprate, 6))
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    OreDictUnificator.get(OrePrefixes.stickLong, Materials.NaquadahAlloy, 4),
                    OreDictUnificator.get(OrePrefixes.gear, Materials.NaquadahAlloy, 1),
                    OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.NaquadahAlloy, 3),
                    ItemList.Electric_Motor_ZPM.get(2),
                    ...
                    OreDictUnificator.get(OrePrefixes.cableGt04, Materials.VanadiumGallium, 6))
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    OreDictUnificator.get(OrePrefixes.stickLong, Materials.Neutronium, 4),
                    OreDictUnificator.get(OrePrefixes.gear, Materials.Neutronium, 1),
                    OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.Neutronium, 3),
                    ItemList.Electric_Motor_UV.get(2),
                    ...
                    OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NaquadahAlloy, 6))
        ...
        // Emitters
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .metadata(RESEARCH_TIME, 2 * HOURS)
                .itemInputs(
                    OreDictUnificator.get(OrePrefixes.frameGt, Materials.HSSS, 1),
                    ItemList.Electric_Motor_LuV.get(1),
                    OreDictUnificator.get(OrePrefixes.stick, LuVMat, 8),
                    ItemList.QuantumStar.get(1),
                    new Object[] { OrePrefixes.circuit.get(Materials.LuV), 4 },
                    OreDictUnificator.get(OrePrefixes.foil, Materials.Gallium, 64),
                    OreDictUnificator.get(OrePrefixes.foil, Materials.Gallium, 64),
                    OreDictUnificator.get(OrePrefixes.foil, Materials.Gallium, 64),
                    OreDictUnificator.get(OrePrefixes.cableGt01, Materials.YttriumBariumCuprate, 7))
            ...
            GT_Values.RA.stdBuilder()
                ...
                .metadata(RESEARCH_TIME, 2 * HOURS)
                .itemInputs(
                    OreDictUnificator.get(OrePrefixes.frameGt, Materials.NaquadahAlloy, 1),
                    ItemList.Electric_Motor_ZPM.get(1),
                    OreDictUnificator.get(OrePrefixes.stick, Materials.Osmiridium, 8),
                    ItemList.QuantumStar.get(2),
                    new Object[] { OrePrefixes.circuit.get(Materials.ZPM), 4 },
                    OreDictUnificator.get(OrePrefixes.foil, Materials.Trinium, 64),
                    OreDictUnificator.get(OrePrefixes.foil, Materials.Trinium, 64),
                    OreDictUnificator.get(OrePrefixes.foil, Materials.Trinium, 64),
                    OreDictUnificator.get(OrePrefixes.cableGt04, Materials.VanadiumGallium, 7))
            ...
            GT_Values.RA.stdBuilder()
                ...
                .metadata(RESEARCH_TIME, 4 * HOURS)
                .itemInputs(
                    OreDictUnificator.get(OrePrefixes.frameGt, Materials.Neutronium, 1),
                    ItemList.Electric_Motor_UV.get(1),
                    OreDictUnificator.get(OrePrefixes.stick, Materials.Neutronium, 8),
                    ItemList.Gravistar.get(4),
                    new Object[] { OrePrefixes.circuit.get(Materials.UV), 4 },
                    OreDictUnificator.get(OrePrefixes.foil, Materials.Naquadria, 64),
                    OreDictUnificator.get(OrePrefixes.foil, Materials.Naquadria, 64),
                    OreDictUnificator.get(OrePrefixes.foil, Materials.Naquadria, 64),
                    OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NaquadahAlloy, 7))
        ...
        // Sensors
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    OreDictUnificator.get(OrePrefixes.frameGt, Materials.HSSS, 1),
                    ItemList.Electric_Motor_LuV.get(1),
                    OreDictUnificator.get(OrePrefixes.plate, LuVMat, 8),
                    ItemList.QuantumStar.get(1),
                    new Object[] { OrePrefixes.circuit.get(Materials.LuV), 4 },
                    OreDictUnificator.get(OrePrefixes.foil, Materials.Gallium, 64),
                    OreDictUnificator.get(OrePrefixes.foil, Materials.Gallium, 64),
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    OreDictUnificator.get(OrePrefixes.frameGt, Materials.NaquadahAlloy, 1),
                    ItemList.Electric_Motor_ZPM.get(1),
                    OreDictUnificator.get(OrePrefixes.plate, Materials.Osmiridium, 8),
                    ItemList.QuantumStar.get(2),
                    new Object[] { OrePrefixes.circuit.get(Materials.ZPM), 4 },
                    OreDictUnificator.get(OrePrefixes.foil, Materials.Trinium, 64),
                    OreDictUnificator.get(OrePrefixes.foil, Materials.Trinium, 64),
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    OreDictUnificator.get(OrePrefixes.frameGt, Materials.Neutronium, 1),
                    ItemList.Electric_Motor_UV.get(1),
                    OreDictUnificator.get(OrePrefixes.plate, Materials.Neutronium, 8),
                    ItemList.Gravistar.get(4),
                    new Object[] { OrePrefixes.circuit.get(Materials.UV), 4 },
                    OreDictUnificator.get(OrePrefixes.foil, Materials.Naquadria, 64),
                    OreDictUnificator.get(OrePrefixes.foil, Materials.Naquadria, 64),
        ...
        // Field Generators
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.wireFine, LuVMat, 64),
                    OreDictUnificator.get(OrePrefixes.wireFine, LuVMat, 64),
                    OreDictUnificator.get(OrePrefixes.cableGt01, Materials.YttriumBariumCuprate, 8))
        ...
        // Energy Hatches
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorLuV, 2),
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.wireGt02, Materials.SuperconductorZPM, 2),
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.wireGt02, Materials.SuperconductorUV, 2),
        ...
        // Dynamo Hatches
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ItemList.Hull_ZPM.get(1),
                    OreDictUnificator.get(OrePrefixes.spring, Materials.Tetranaquadahdiindiumhexaplatiumosminid, 4),
                    ItemList.Circuit_Chip_NPIC.get(2),
                    new Object[] { OrePrefixes.circuit.get(Materials.ZPM), 2 },
                    ItemList.ZPM_Coil.get(2),
                    new ItemStack[] { ItemList.Reactor_Coolant_He_6.get(1), ItemList.Reactor_Coolant_NaK_6.get(1),
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ItemList.Hull_UV.get(1),
                    OreDictUnificator.get(OrePrefixes.spring, Materials.Longasssuperconductornameforuvwire, 4),
                    ItemList.Circuit_Chip_PPIC.get(2),
                    new Object[] { OrePrefixes.circuit.get(Materials.UV), 2 },
                    ItemList.UV_Coil.get(2),
                    new ItemStack[] { ItemList.Reactor_Coolant_He_6.get(1), ItemList.Reactor_Coolant_NaK_6.get(1),
        ...
        // Fusion Controller
        {
            // mkI
            GT_Values.RA.stdBuilder()
                .metadata(RESEARCH_ITEM, OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorLuV, 1))
                .metadata(RESEARCH_TIME, 2 * HOURS)
                .itemInputs(
                    ...
                    new Object[] { OrePrefixes.circuit.get(Materials.ZPM), 1 },
                    new Object[] { OrePrefixes.circuit.get(Materials.ZPM), 1 },
                    OreDictUnificator.get(OrePrefixes.plateDense, Materials.NaquadahAlloy, 4),
                    OreDictUnificator.get(OrePrefixes.plateDense, Materials.Osmiridium, 4),
                    ItemList.Field_Generator_LuV.get(2),
                    ItemList.Circuit_Wafer_UHPIC.get(32),
                    OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorLuV, 32))
            ...
            // mkII
            GT_Values.RA.stdBuilder()
                .metadata(RESEARCH_ITEM, OreDictUnificator.get(OrePrefixes.block, Materials.Europium, 1))
                .metadata(RESEARCH_TIME, 4 * HOURS)
                .itemInputs(
                    ItemList.Casing_Fusion_Coil.get(1),
                    ...
                    new Object[] { OrePrefixes.circuit.get(Materials.UV), 1 },
                    new Object[] { OrePrefixes.circuit.get(Materials.UV), 1 },
                    OreDictUnificator.get(OrePrefixes.plateDense, Materials.Europium, 4),
                    ItemList.Field_Generator_ZPM.get(2),
                    ItemList.Circuit_Wafer_PPIC.get(48),
                    OreDictUnificator.get(OrePrefixes.wireGt02, Materials.SuperconductorZPM, 32))
            ...
            // mkIII
            GT_Values.RA.stdBuilder()
                .metadata(RESEARCH_ITEM, OreDictUnificator.get(OrePrefixes.block, Materials.Americium, 1))
                ...
                .itemInputs(
                    ...
                    new Object[] { OrePrefixes.circuit.get(Materials.UHV), 1 },
                    new Object[] { OrePrefixes.circuit.get(Materials.UHV), 1 },
                    OreDictUnificator.get(OrePrefixes.plateDense, Materials.Americium, 4),
                    ItemList.Field_Generator_UV.get(2),
                    ItemList.Circuit_Wafer_QPIC.get(64),
                    OreDictUnificator.get(OrePrefixes.wireGt04, Materials.SuperconductorUV, 32))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .metadata(RESEARCH_TIME, 4 * HOURS)
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.plate, Materials.Europium, 16),
                new Object[] { OrePrefixes.circuit.get(Materials.ZPM), 1 },
                new Object[] { OrePrefixes.circuit.get(Materials.ZPM), 1 },
                new Object[] { OrePrefixes.circuit.get(Materials.ZPM), 1 },
                new Object[] { OrePrefixes.circuit.get(Materials.ZPM), 1 },
        ...
        GT_Values.RA.stdBuilder()
            ...
            .metadata(RESEARCH_TIME, 4 * HOURS)
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.plate, Materials.Americium, 32),
                new Object[] { OrePrefixes.circuit.get(Materials.UV), 1 },
                new Object[] { OrePrefixes.circuit.get(Materials.UV), 1 },
                new Object[] { OrePrefixes.circuit.get(Materials.UV), 1 },
                new Object[] { OrePrefixes.circuit.get(Materials.UV), 1 },
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemInputs(
                ...
                new ItemStack[] { OreDictUnificator.get(OrePrefixes.wireGt04, Materials.Duranium, 32),
                    OreDictUnificator.get(OrePrefixes.wireGt04, Materials.NaquadahAlloy, 32) },
                OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Polybenzimidazole, 64),
                new ItemStack[] { ItemList.Component_Grinder_Tungsten.get(64),
                    ItemList.Component_Grinder_Diamond.get(64) },
                OreDictUnificator.get(OrePrefixes.plateDouble, Materials.StainlessSteel, 32),
                OreDictUnificator.get(OrePrefixes.rotor, Materials.Chrome, 16))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .metadata(RESEARCH_TIME, 2 * HOURS)
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.plateDense, Materials.NaquadahAlloy, 16),
                new Object[] { OrePrefixes.circuit.get(Materials.UV), 4 },
                ...
                OreDictUnificator.get(OrePrefixes.pipeQuadruple, Materials.MysteriousCrystal, 1),
                ItemList.Emitter_ZPM.get(4),
