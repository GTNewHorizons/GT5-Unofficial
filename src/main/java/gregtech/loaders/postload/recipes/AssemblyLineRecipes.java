...
public class AssemblyLineRecipes implements Runnable {
    ...
    public void run() {
        ...
        {
            // LuV motor
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Electric_Motor_IV.get(1))
                    ...
                    .itemOutputs(ItemList.Electric_Motor_LuV.get(1)).eut(TierEU.RECIPE_IV).duration(30 * SECONDS)
                    .addTo(AssemblyLine);

            // ZPM motor
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Electric_Motor_LuV.get(1))
                    ...
                    .itemOutputs(ItemList.Electric_Motor_ZPM.get(1)).eut(TierEU.RECIPE_LuV).duration(30 * SECONDS)
                    .addTo(AssemblyLine);

            // UV motor
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Electric_Motor_ZPM.get(1))
                    ...
                    .itemOutputs(ItemList.Electric_Motor_UV.get(1)).eut(TierEU.RECIPE_ZPM).duration(30 * SECONDS)
                    .addTo(AssemblyLine);
        }
        ...
        {
            // LuV Pump
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Electric_Pump_IV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_EV))
                    .itemInputs(
                    ...
                    .fluidInputs(
                            MaterialsAlloy.INDALLOY_140.getFluidStack(1 * INGOTS),
                            Materials.Lubricant.getFluid(250))
                    .itemOutputs(ItemList.Electric_Pump_LuV.get(1)).eut(TierEU.RECIPE_IV).duration(600)
                    .addTo(AssemblyLine);

            // ZPM Pump
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Electric_Pump_LuV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_IV))
                    .itemInputs(
                    ...
                    .fluidInputs(
                            MaterialsAlloy.INDALLOY_140.getFluidStack(2 * INGOTS),
                            Materials.Lubricant.getFluid(750))
                    .itemOutputs(ItemList.Electric_Pump_ZPM.get(1)).eut(TierEU.RECIPE_LuV).duration(30 * SECONDS)
                    .addTo(AssemblyLine);

            // UV Pump
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Electric_Pump_ZPM.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_LuV))
                    .itemInputs(
                    ...
                    .fluidInputs(
                            ...
                            MaterialsAlloy.INDALLOY_140.getFluidStack(9 * INGOTS),
                            Materials.Lubricant.getFluid(2_000))
                    .duration(30 * SECONDS).eut((int) TierEU.RECIPE_ZPM).addTo(AssemblyLine);
        }

        // Conveyors
        {
            // LuV Conveyor
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Conveyor_Module_IV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_EV))
                    .itemInputs(
                    ...
                    .fluidInputs(
                            MaterialsAlloy.INDALLOY_140.getFluidStack(1 * INGOTS),
                            Materials.Lubricant.getFluid(250))
                    .duration(30 * SECONDS).eut((int) TierEU.RECIPE_IV).addTo(AssemblyLine);

            // ZPM Conveyor
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Conveyor_Module_LuV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_IV))
                    .itemInputs(
                    ...
                    .fluidInputs(
                            MaterialsAlloy.INDALLOY_140.getFluidStack(2 * INGOTS),
                            Materials.Lubricant.getFluid(750))
                    .duration(30 * SECONDS).eut((int) TierEU.RECIPE_LuV).addTo(AssemblyLine);

            // UV Conveyor
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Conveyor_Module_ZPM.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_LuV))
                    .itemInputs(
        ...
        {
            // LuV Piston
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Electric_Piston_IV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_EV))
                    .itemInputs(
                            ItemList.Electric_Motor_LuV.get(1),
            ...
            // ZPM Pistons
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Electric_Piston_LuV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_IV))
                    .itemInputs(
                            ItemList.Electric_Motor_ZPM.get(1),
            ...
            // UV Piston
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Electric_Piston_ZPM.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_LuV))
                    .itemInputs(
                            ItemList.Electric_Motor_UV.get(1),
        ...
        {
            // LuV Robot Arm
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Robot_Arm_IV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_EV))
                    .itemInputs(
            ...
            // ZPM Robot Arm
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Robot_Arm_LuV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_IV))
                    .itemInputs(
                            GTOreDictUnificator.get(OrePrefixes.stickLong, Materials.NaquadahAlloy, 4),
                            GTOreDictUnificator.get(OrePrefixes.gear, Materials.NaquadahAlloy, 1),
            ...
            // UV Robot Arm
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Robot_Arm_ZPM.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_LuV))
                    .itemInputs(
                            GTOreDictUnificator.get(OrePrefixes.stickLong, Materials.Neutronium, 4),
                            GTOreDictUnificator.get(OrePrefixes.gear, Materials.Neutronium, 1),
        ...
        {
            // LuV Emitter
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Emitter_IV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_EV))
                    .itemInputs(
                    ...
                    .fluidInputs(MaterialsAlloy.INDALLOY_140.getFluidStack(4 * INGOTS)).duration(30 * SECONDS)
                    .eut((int) TierEU.RECIPE_IV).addTo(AssemblyLine);

            // ZPM Emitter
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Emitter_LuV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_IV))
                    .itemInputs(
                    ...
                    .fluidInputs(MaterialsAlloy.INDALLOY_140.getFluidStack(8 * INGOTS)).duration(30 * SECONDS)
                    .eut((int) TierEU.RECIPE_LuV).addTo(AssemblyLine);

            // UV Emitter
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Emitter_ZPM.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_LuV))
                    .itemInputs(
        ...
        {
            // LuV Sensor
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Sensor_IV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_EV))
                    .itemInputs(
                            GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.HSSS, 1),
                            ItemList.Electric_Motor_LuV.get(1),
            ...
            // ZPM Sensor
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Sensor_LuV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_IV))
                    .itemInputs(
                            GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.NaquadahAlloy, 1),
                            ItemList.Electric_Motor_ZPM.get(1),
            ...
            // UV Sensor
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Sensor_ZPM.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_LuV))
                    .itemInputs(
                            GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Neutronium, 1),
                            ItemList.Electric_Motor_UV.get(1),
        ...
        {
            // LuV Field Generator
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Field_Generator_IV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_EV))
                    .itemInputs(
                            GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.HSSS, 1),
                            GTOreDictUnificator.get(OrePrefixes.plate, Materials.HSSS, 6),
            ...
            // ZPM Field Generator
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Field_Generator_LuV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_IV))
                    .itemInputs(
                            GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.NaquadahAlloy, 1),
                            GTOreDictUnificator.get(OrePrefixes.plate, Materials.NaquadahAlloy, 6),
            ...
            // UV Field Generator
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Field_Generator_ZPM.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_LuV))
                    .itemInputs(
                            GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Neutronium, 1),
                            GTOreDictUnificator.get(OrePrefixes.plate, Materials.Neutronium, 6),
        ...
        {
            // LuV Energy Hatch
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Hatch_Energy_IV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_IV))
                    .itemInputs(
                    ...
                    .duration(20 * SECONDS).eut((int) TierEU.RECIPE_LuV).addTo(AssemblyLine);

            // ZPM Energy Hatch
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Hatch_Energy_LuV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_LuV))
                    .itemInputs(
            ...
            // UV Energy Hatch
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Hatch_Energy_ZPM.get(1))
                    ...
                    .duration(40 * SECONDS).eut((int) TierEU.RECIPE_UV).addTo(AssemblyLine);
        }

        // Dynamo Hatches
        {
            // LuV Dynamo Hatch
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Hatch_Dynamo_IV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_IV))
                    .itemInputs(
                            ItemList.Hull_LuV.get(1),
            ...
            // ZPM Dynamo Hatch
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Hatch_Dynamo_LuV.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_LuV))
                    .itemInputs(
                            ItemList.Hull_ZPM.get(1),
                            GTOreDictUnificator
            ...
            // UV Dynamo Hatch
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Hatch_Dynamo_ZPM.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_ZPM))
                    .itemInputs(
                            ItemList.Hull_UV.get(1),
                            GTOreDictUnificator
        ...
        // Fusion Controller
        {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(50 * SECONDS).eut((int) TierEU.RECIPE_LuV).addTo(AssemblyLine);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(50 * SECONDS).eut(TierEU.RECIPE_LuV).addTo(AssemblyLine);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(50 * SECONDS).eut(TierEU.RECIPE_ZPM).addTo(AssemblyLine);
        }
        // Energy Module
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Energy_LapotronicOrb2.get(1))
                ...
                .duration(1 * MINUTES + 40 * SECONDS).eut((int) TierEU.RECIPE_ZPM).addTo(AssemblyLine);

        // Energy Cluster
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Energy_Module.get(1))
                ...
                .fluidInputs(MaterialsAlloy.INDALLOY_140.getFluidStack(20 * INGOTS), GTModHandler.getIC2Coolant(16_000))
                .duration(1 * MINUTES + 40 * SECONDS).eut(200000).addTo(AssemblyLine);

        // Integrated Ore Factory
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Machine_IV_OreWasher.get(1))
        ...
        // Drone T2
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.TierdDrone0.get(1))
        ...
        // Drone T3
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.TierdDrone1.get(1))
