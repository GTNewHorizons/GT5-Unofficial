    ...
    public void run() {
        ...
        // Pumps
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    Materials.Naquadria.getMolten(1296), new FluidStack(solderIndalloy, 1296), Materials.Lubricant.getFluid(2000))
                .noFluidOutputs()
                .duration(30 * SECONDS)
        ...
        // Conveyors
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    new FluidStack(solderIndalloy, 144), Materials.Lubricant.getFluid(250))
                .noFluidOutputs()
                .duration(30 * SECONDS)
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    new FluidStack(solderIndalloy, 288), Materials.Lubricant.getFluid(750))
                .noFluidOutputs()
                .duration(30 * SECONDS)
        ...
        // RobotArms
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    new FluidStack(solderIndalloy, 576), Materials.Lubricant.getFluid(250))
                .noFluidOutputs()
                .duration(30 * SECONDS)
                .eut((int) TierEU.RECIPE_IV)
                .addTo(AssemblyLine);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    new FluidStack(solderIndalloy, 1152), Materials.Lubricant.getFluid(750))
                .noFluidOutputs()
                .duration(30 * SECONDS)
                .eut((int) TierEU.RECIPE_LuV)
                .addTo(AssemblyLine);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    Materials.Naquadria.getMolten(1296), new FluidStack(solderIndalloy, 2304), Materials.Lubricant.getFluid(2000))
                .noFluidOutputs()
                .duration(30 * SECONDS)
                .eut((int) TierEU.RECIPE_ZPM)
                .addTo(AssemblyLine);
        ...
        // Emitters
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    Materials.Naquadria.getMolten(1296), new FluidStack(solderIndalloy, 2304))
                .noFluidOutputs()
                .duration(30 * SECONDS)
                .eut((int) TierEU.RECIPE_ZPM)
                .addTo(AssemblyLine);
        ...
        // Energy Hatches
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ...
                    new ItemStack[]{ ItemList.Reactor_Coolant_He_3.get(1), ItemList.Reactor_Coolant_NaK_3.get(1), ItemList.Reactor_Coolant_Sp_1.get(1)},
                    new ItemStack[]{ ItemList.Reactor_Coolant_He_3.get(1), ItemList.Reactor_Coolant_NaK_3.get(1), ItemList.Reactor_Coolant_Sp_1.get(1)},
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ...
                    new ItemStack[]{ItemList.Reactor_Coolant_He_6.get(1), ItemList.Reactor_Coolant_NaK_6.get(1), ItemList.Reactor_Coolant_Sp_2.get(1)},
                    new ItemStack[]{ItemList.Reactor_Coolant_He_6.get(1), ItemList.Reactor_Coolant_NaK_6.get(1), ItemList.Reactor_Coolant_Sp_2.get(1)},
                    ItemList.Electric_Pump_ZPM.get(1))
                .itemOutputs(
        ...
        // Dynamo Hatches
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    ItemList.Hull_LuV.get(1),
                    GT_OreDictUnificator.get(OrePrefixes.spring,Materials.Tetraindiumditindibariumtitaniumheptacoppertetrakaidekaoxid, 2),
                    ItemList.Circuit_Chip_UHPIC.get(2),
                    new Object[]{OrePrefixes.circuit.get(Materials.Master), 2},
                    ItemList.LuV_Coil.get(2),
                    new ItemStack[]{ItemList.Reactor_Coolant_He_3.get(1), ItemList.Reactor_Coolant_NaK_3.get(1), ItemList.Reactor_Coolant_Sp_1.get(1)},
        ...
        // Fusion Controller
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    new FluidStack(solderIndalloy, 2880), Materials.VanadiumGallium.getMolten(1152))
                .noFluidOutputs()
                .duration(50 * SECONDS)
                .eut((int) TierEU.RECIPE_LuV)
                .addTo(AssemblyLine);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    new FluidStack(solderIndalloy, 2880), Materials.NiobiumTitanium.getMolten(1152))
                .noFluidOutputs()
                .duration(50 * SECONDS)
                .eut(TierEU.RECIPE_LuV)
                .addTo(AssemblyLine);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    new FluidStack(solderIndalloy, 2880), Materials.ElectrumFlux.getMolten(1152))
                .noFluidOutputs()
                .duration(50 * SECONDS)
                .eut(TierEU.RECIPE_ZPM)
                .addTo(AssemblyLine);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemInputs(
                ...
                new ItemStack[] { ItemList.Component_Grinder_Tungsten.get(64), ItemList.Component_Grinder_Diamond.get(64) },
            ...
            .fluidInputs(
                new FluidStack(solderIndalloy, 2880), Materials.Naquadria.getMolten(1440))
            .noFluidOutputs()
            .duration(60 * SECONDS)
