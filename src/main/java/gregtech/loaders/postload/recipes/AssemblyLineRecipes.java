    ...
    public void run() {
        ...
        // Motors
        {
            ...
            GTValues.RA.stdBuilder()
                ...
                .metadata(SCANNING, new Scanning(8 * MINUTES, TierEU.RECIPE_HV))
                .itemInputs(
        ...
        // Fusion Controller
        {
            ...
            GTValues.RA.stdBuilder()
                ...
                .metadata(SCANNING, new Scanning(16 * MINUTES, TierEU.RECIPE_EV))
                .itemInputs(
            ...
            GTValues.RA.stdBuilder()
                ...
                .metadata(SCANNING, new Scanning(16 * MINUTES, TierEU.RECIPE_LuV))
                .itemInputs(
                    ItemList.Casing_Fusion_Coil.get(1),
        ...
        GTValues.RA.stdBuilder()
            ...
            .metadata(SCANNING, new Scanning(10 * MINUTES + 40 * SECONDS, TierEU.RECIPE_ZPM))
            .itemInputs(
