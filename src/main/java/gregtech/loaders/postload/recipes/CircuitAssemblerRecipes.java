...
public class CircuitAssemblerRecipes implements Runnable {
    ...
    public void registerRailcraftRecipes() {
        ...
        for (Materials tMat : solderingMats) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(tMat.getMolten(tMultiplier * HALF_INGOTS)).duration(15 * SECONDS)
                    .eut((int) TierEU.RECIPE_LV).addTo(circuitAssemblerRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(tMat.getMolten(tMultiplier * HALF_INGOTS)).duration(20 * SECONDS)
                    .eut((int) TierEU.RECIPE_LV).addTo(circuitAssemblerRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(tMat.getMolten(tMultiplier * HALF_INGOTS)).duration(25 * SECONDS)
                    .eut((int) TierEU.RECIPE_LV).addTo(circuitAssemblerRecipes);
    ...
    public void registerForestryRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Glass.getMolten(4 * INGOTS)).duration(10 * SECONDS).eut((int) TierEU.RECIPE_LV)
        ...
        for (int metaid = 0; metaid < rodMaterials.length; metaid++) {
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(Materials.Glass.getMolten(4 * INGOTS)).duration(10 * SECONDS)
                    .eut((int) TierEU.RECIPE_LV).addTo(circuitAssemblerRecipes);
        }
        ...
        for (Materials tMat : solderingMats) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(tMat.getMolten(1152L * tMultiplier / 2)).duration(10 * SECONDS)
                    .eut((int) TierEU.RECIPE_LV).addTo(circuitAssemblerRecipes);
