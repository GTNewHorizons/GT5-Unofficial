    ...
    public void run() {
...

        {
            ...
            GTValues.RA.stdBuilder().itemInputs()
                    .fluidInputs(
                            ...
                            MaterialsUEVplus.ExcitedDTSC.getFluid(2_000))
                    .fluidOutputs(
                            MaterialsUEVplus.DimensionallyShiftedSuperfluid.getFluid(360_000),
                            MaterialsUEVplus.DimensionallyTranscendentResidue.getFluid(4_000))
                    .duration(7 * SECONDS + 10 * TICKS).eut((int) TierEU.RECIPE_UXV).metadata(COIL_HEAT, 13500)
            ...
            GTValues.RA.stdBuilder().itemInputs()
                    ...
                    .duration(30 * SECONDS).eut((int) TierEU.RECIPE_UMV).metadata(COIL_HEAT, 13500)
                    .addTo(plasmaForgeRecipes);
            ...
            GTValues.RA.stdBuilder().itemInputs()
                    ...
                    .fluidOutputs(
                            MaterialsUEVplus.DimensionallyShiftedSuperfluid.getFluid(30_000),
                            MaterialsUEVplus.DimensionallyTranscendentResidue.getFluid(1_000))
                    .duration(30 * SECONDS).eut((int) TierEU.RECIPE_UMV).metadata(COIL_HEAT, 12600)
                    .addTo(plasmaForgeRecipes);
            ...
            GTValues.RA.stdBuilder().itemInputs()
                    ...
                    .fluidOutputs(
                            MaterialsUEVplus.DimensionallyShiftedSuperfluid.getFluid(7_500),
                            MaterialsUEVplus.DimensionallyTranscendentResidue.getFluid(250))
                    .duration(30 * SECONDS).eut((int) TierEU.RECIPE_UIV).metadata(COIL_HEAT, 10800)
                    .addTo(plasmaForgeRecipes);
        }
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                        ...
                        MaterialsUEVplus.SpaceTime.getMolten(18 * STACKS))
                .itemOutputs(ItemList.GigaChad.get(1)).duration(86400 * 20 * 2).eut(2_000_000_000)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsUEVplus.DimensionallyTranscendentResidue.getFluid(46)).duration(60 * SECONDS)
                .eut((int) TierEU.RECIPE_UEV).metadata(COIL_HEAT, 10800).addTo(plasmaForgeRecipes);

        if (Avaritia.isModLoaded()) {
            // Six-Phased Copper
            GTValues.RA.stdBuilder().itemInputs(getModItem(Avaritia.ID, "Singularity", 8, 5))
                    .fluidInputs(
                            ...
                            MaterialsUEVplus.Mellion.getMolten(1 * STACKS + 8 * INGOTS))
                    .fluidOutputs(MaterialsUEVplus.SixPhasedCopper.getMolten(1 * STACKS + 8 * INGOTS))
                    .duration(60 * SECONDS).eut((int) TierEU.RECIPE_UMV).metadata(COIL_HEAT, 12600)
                    .addTo(plasmaForgeRecipes);
        }
    }
}
