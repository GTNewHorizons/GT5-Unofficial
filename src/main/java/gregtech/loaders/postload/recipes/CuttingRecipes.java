...
public class CuttingRecipes implements Runnable {
    ...
    public void run() {
        // silicon wafer recipes
        {
            recipeWithClassicFluids(
                ...
                new ItemStack[]{ItemList.Circuit_Silicon_Wafer.get(16), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconSG, 4)},
                20 * SECONDS,
                TierEU.RECIPE_LV,
                false);
            ...
            recipeWithClassicFluids(
                ...
                new ItemStack[]{ItemList.Circuit_Silicon_Wafer2.get(32), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconSG, 8)},
                40 * SECONDS,
                TierEU.RECIPE_MV,
                true);
            ...
            recipeWithClassicFluids(
                ...
                new ItemStack[]{ItemList.Circuit_Silicon_Wafer3.get(64), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconSG, 16)},
            ...
            recipeWithClassicFluids(
                ...
                new ItemStack[]{ItemList.Circuit_Silicon_Wafer4.get(64), ItemList.Circuit_Silicon_Wafer4.get(32), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconSG, 32)},
                2 * MINUTES,
                TierEU.RECIPE_EV,
                true);
            ...
            recipeWithClassicFluids(
                ...
                new ItemStack[]{ItemList.Circuit_Silicon_Wafer5.get(64), ItemList.Circuit_Silicon_Wafer5.get(64), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconSG, 64)},
        ...
        // glass pane recipes
        {
            ...
            for (int i = 0; i < 16; i++) {
                recipeWithClassicFluids(
                    ...
                    new ItemStack[]{new ItemStack(Blocks.stained_glass, 3, i), new ItemStack(Blocks.stained_glass_pane, 8, i)},
                    2 * SECONDS + 10 * TICKS,
                    8,
                    false);
            ...
            if (TinkerConstruct.isModLoaded()) {
                recipeWithClassicFluids(
                    ...
                    new ItemStack[]{getModItem(TinkerConstruct.modID, "GlassBlock", 3L, 0), getModItem(TinkerConstruct.modID, "GlassPane", 8L, 0)},
                    2 * SECONDS + 10 * TICKS,
                    8,
                    false);
            }
        ...
        // stone slab recipes
        {
            ...
            recipeWithClassicFluids(
                ...
                new ItemStack[]{new ItemStack(Blocks.quartz_block, 1, 32767), new ItemStack(Blocks.stone_slab, 2, 7)},
                1 * SECONDS + 5 * TICKS,
                8,
                false);
        }
        ...
        recipeWithClassicFluids(
            ...
            new ItemStack[]{new ItemStack(Blocks.glowstone, 1, 0), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Glowstone, 4)},
            5 * SECONDS,
            16,
            false);
        ...
        if (BuildCraftTransport.isModLoaded()) {
            recipeWithClassicFluids(
                new ItemStack[]{getModItem(BuildCraftTransport.modID, "item.buildcraftPipe.pipestructurecobblestone", 1L, 0)},
                new ItemStack[]{getModItem(BuildCraftTransport.modID, "item.buildcraftPipe.pipestructurecobblestone", 1L, 0), getModItem(BuildCraftTransport.modID, "pipePlug", 8L, 0)},
                1 * SECONDS + 12 * TICKS,
                16,
                false);
    ...
    public void recipeWithClassicFluids(ItemStack[] inputs, ItemStack[] outputs, int duration, long eut, boolean cleanroomRequired){
