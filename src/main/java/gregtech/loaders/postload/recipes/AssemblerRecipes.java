...
public class AssemblerRecipes implements Runnable {
    ...
    public void run() {
...

        {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    MaterialLibAPI.getStack(Materials.Aluminium, Shapes.ring, 2))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    MaterialLibAPI.getStack(Materials.Steel, Shapes.plateDouble, 4),
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    MaterialLibAPI.getStack(Materials.Platinum, Shapes.ring, 4))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    MaterialLibAPI.getStack(Materials.Aluminium, Shapes.plateDouble, 4),
                    MaterialLibAPI.getStack(Materials.Silver, Shapes.ring, 4))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    MaterialLibAPI.getStack(Materials.StainlessSteel, Shapes.plateDouble, 4),
                    MaterialLibAPI.getStack(Materials.Electrum, Shapes.ring, 4))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    MaterialLibAPI.getStack(Materials.Titanium, Shapes.plateDouble, 4),
                    MaterialLibAPI.getStack(Materials.RoseGold, Shapes.ring, 4))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    MaterialLibAPI.getStack(Materials.RhodiumPlatedPalladium, Shapes.plateDouble, 4),
                    MaterialLibAPI.getStack(Materials.Palladium, Shapes.ring, 4))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    MaterialLibAPI.getStack(Materials.Iridium, Shapes.plateDouble, 4),
                    MaterialLibAPI.getStack(Materials.Naquadah, Shapes.ring, 4))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    MaterialLibAPI.getStack(Materials.Osmium, Shapes.plateDouble, 4),
                    MaterialLibAPI.getStack(Materials.ElectrumFlux, Shapes.ring, 4))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    MaterialLibAPI.getStack(Materials.Neutronium, Shapes.plateDouble, 4),
                    MaterialLibAPI.getStack(Materials.Draconium, Shapes.ring, 4))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    MaterialLibAPI.getStack(Materials.Wood, Shapes.bolt, 1),
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    MaterialLibAPI.getStack(Materials.Wood, Shapes.bolt, 1),
                    MaterialLibAPI.getStack(Materials.TricalciumPhosphate, Shapes.dustSmall, 1))
                .circuit(1)
                .itemOutputs(ItemList.Tool_Matches.get(1L))
                .duration(16 * TICKS)
                .eut(TierEU.RECIPE_LV / 2)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    MaterialLibAPI.getStack(Materials.Wood, Shapes.bolt, 4),
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    MaterialLibAPI.getStack(Materials.Wood, Shapes.bolt, 4),
                    MaterialLibAPI.getStack(Materials.TricalciumPhosphate, Shapes.dust, 1))
                .circuit(1)
                .itemOutputs(ItemList.Tool_Matches.get(4L))
                .duration(3 * SECONDS + 4 * TICKS)
                .eut(TierEU.RECIPE_LV / 2)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(MaterialLibAPI.getStack(Materials.Invar, Shapes.plate, 2), new ItemStack(Items.flint, 1))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(MaterialLibAPI.getStack(Materials.Platinum, Shapes.plate, 2), new ItemStack(Items.flint, 1))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Sensor_EV.get(1L), MaterialLibAPI.getStack(Materials.Titanium, Shapes.plate, 1))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(MaterialLibAPI.getStack(Materials.Aluminium, Shapes.plate, 1), ItemList.Cover_Drain.get(1L))
                .circuit(1)
                ...
                .addTo(assemblerRecipes);
            GTValues.RA.stdBuilder()
                .itemInputs(MaterialLibAPI.getStack(Materials.Iron, Shapes.plate, 1), ItemList.Cover_Drain.get(1L))
                .circuit(1)
                .itemOutputs(ItemList.Cover_Shutter.get(1L))
                .duration(40 * SECONDS)
                .eut(TierEU.RECIPE_LV / 2)
                .addTo(assemblerRecipes);
            GTValues.RA.stdBuilder()
                .itemInputs(MaterialLibAPI.getStack(Materials.CastIron, Shapes.plate, 1), ItemList.Cover_Drain.get(1L))
                .circuit(1)
                .itemOutputs(ItemList.Cover_Shutter.get(1L))
                .duration(40 * SECONDS)
                .eut(TierEU.RECIPE_LV / 2)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    MaterialLibAPI.getStack(Materials.CastIron, Shapes.plate, 2),
                    new ItemStack(Blocks.iron_bars, 2))
                .circuit(1)
                .itemOutputs(ItemList.Cover_Drain.get(1L))
                .duration(40 * SECONDS)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Emitter_MV.get(1L), MaterialLibAPI.getStack(Materials.Aluminium, Shapes.plate, 1))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    MaterialLibAPI.getStack(Materials.BlueSteel, Shapes.plate, 2))
                .itemOutputs(ItemList.BatteryHull_EV.get(1L))
                .fluidInputs(
                    MaterialLibAPI
                        .getFluidStack(Materials.Polytetrafluoroethylene, FluidShapes.fluidMolten, 1 * INGOTS))
                .duration(5 * SECONDS)
                .eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    MaterialLibAPI.getStack(Materials.RoseGold, Shapes.plate, 6))
                .itemOutputs(ItemList.BatteryHull_IV.get(1L))
                .fluidInputs(
                    MaterialLibAPI
                        .getFluidStack(Materials.Polytetrafluoroethylene, FluidShapes.fluidMolten, 2 * INGOTS))
                .duration(10 * SECONDS)
                .eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI.getFluidStack(Materials.Polybenzimidazole, FluidShapes.fluidMolten, 1 * INGOTS))
                .duration(15 * SECONDS)
                .eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI.getFluidStack(Materials.Polybenzimidazole, FluidShapes.fluidMolten, 2 * INGOTS))
                .duration(10 * SECONDS)
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI.getFluidStack(Materials.Polybenzimidazole, FluidShapes.fluidMolten, 4 * INGOTS))
                .duration(15 * SECONDS)
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI.getFluidStack(Materials.Polybenzimidazole, FluidShapes.fluidMolten, 8 * INGOTS))
                .duration(5 * SECONDS)
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI.getFluidStack(Materials.Polybenzimidazole, FluidShapes.fluidMolten, 16 * INGOTS))
                .duration(10 * SECONDS)
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI.getFluidStack(Materials.Polybenzimidazole, FluidShapes.fluidMolten, 32 * INGOTS))
                .duration(15 * SECONDS)
                .eut(TierEU.RECIPE_UHV)
                .addTo(assemblerRecipes);
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI.getFluidStack(Materials.Polybenzimidazole, FluidShapes.fluidMolten, 1 * STACKS))
                .duration(30 * SECONDS)
                .eut(TierEU.RECIPE_UHV)
                .addTo(assemblerRecipes);
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Polybenzimidazole, FluidShapes.fluidMolten, 18432))
                .duration(60 * SECONDS)
                .eut(TierEU.RECIPE_UHV)
                .addTo(assemblerRecipes);
            ...
            for (int i = 0; i < ItemList.WIRELESS_ENERGY_COVERS.length; i++) {
                GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(MaterialLibAPI.getFluidStack(Materials.ExcitedDTEC, FluidShapes.fluidLiquid, 32_000))
                    .duration(10 * SECONDS)
        ...
        if (GTMod.proxy.mEnableCleanroom) {
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI.getFluidStack(Materials.StainlessSteel, FluidShapes.fluidMolten, 1 * INGOTS))
                .duration(60 * SECONDS)
                .eut(TierEU.RECIPE_MV)
                .addTo(assemblerRecipes);
        }
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.SeedOil, FluidShapes.fluidLiquid, 50))
            .duration(16 * TICKS)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Concrete, FluidShapes.fluidMolten, 1 * INGOTS))
            .duration(10 * SECONDS)
            .eut(48)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.AdvancedGlue, FluidShapes.fluidLiquid, 1 * INGOTS))
            .duration(10 * SECONDS)
            .eut(48)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.AdvancedGlue, FluidShapes.fluidLiquid, 8_000))
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_IV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.PolyvinylChloride, Shapes.foil, 1),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Steel, Shapes.wireFine, 64),
                MaterialLibAPI.getStack(Materials.Zinc, Shapes.foil, 16))
            .circuit(1)
            .itemOutputs(ItemList.Component_Filter.get(1))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.AdvancedGlue, FluidShapes.fluidLiquid, 500))
            .duration(2 * MINUTES + 40 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(1)
            .itemOutputs(MaterialLibAPI.getStack(Materials.Graphene, Shapes.dust, 64))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.AdvancedGlue, FluidShapes.fluidLiquid, 250))
            .duration(40 * SECONDS)
            .eut(TierEU.RECIPE_IV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ItemList.Hull_IV.get(1L),
                MaterialLibAPI.getStack(Materials.Vanadiumtriindinid, Shapes.spring, 1),
                ItemList.Circuit_Chip_HPIC.get(2L),
                ItemList.IV_Coil.get(2L),
                ItemList.Reactor_Coolant_He_3.get(1L),
                ItemList.Electric_Pump_IV.get(1L))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Tin, FluidShapes.fluidMolten, 1 * INGOTS))
            .duration(15 * SECONDS)
            .eut(TierEU.RECIPE_LV / 2)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Steel, Shapes.plate, 9))
            .circuit(24)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Glass, FluidShapes.fluidMolten, 16 * INGOTS))
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Enderium, Shapes.rotor, 1))
            .circuit(3)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.NaquadahAlloy, Shapes.rotor, 1))
            .circuit(3)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Neutronium, Shapes.rotor, 1))
            .circuit(3)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.CosmicNeutronium, Shapes.rotor, 1))
            .circuit(3)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Manganese, Shapes.foil, 1))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Redstone, FluidShapes.fluidMolten, 1 * INGOTS))
            .duration(3 * SECONDS + 4 * TICKS)
            .eut(TierEU.RECIPE_LV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(1)
            .itemOutputs(new ItemStack(Blocks.sticky_piston, 1, 0))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Glue, FluidShapes.fluidLiquid, 100))
            .duration(5 * SECONDS)
            .eut(4)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Rubber, Shapes.plate, 3),
                GTModHandler.getIC2Item("carbonMesh", 3))
            .circuit(1)
            .itemOutputs(ItemList.Duct_Tape.get(1))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Glue, FluidShapes.fluidLiquid, 300))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.StyreneButadieneRubber, Shapes.plate, 2),
                GTModHandler.getIC2Item("carbonMesh", 2))
            .circuit(2)
            .itemOutputs(ItemList.Duct_Tape.get(1))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Glue, FluidShapes.fluidLiquid, 200))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Glue, FluidShapes.fluidLiquid, 1_000))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                GTOreDictUnificator.get("platePaper", 3),
                MaterialLibAPI.getStack(Materials.Paper, Shapes.plateQuadruple, 1))
            .itemOutputs(new ItemStack(Items.book, 1, 0))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Glue, FluidShapes.fluidLiquid, 20))
            .duration(1 * SECONDS + 12 * TICKS)
            .eut(TierEU.RECIPE_ULV)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(ItemList.Food_Sliced_Bun.get(2), MaterialLibAPI.getStack(Materials.MeatCooked, Shapes.dust, 1))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(ItemList.Food_Sliced_Buns.get(1), MaterialLibAPI.getStack(Materials.MeatCooked, Shapes.dust, 1))
            .itemOutputs(ItemList.Food_Burger_Meat.get(1))
            .duration(5 * SECONDS)
            .eut(4)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(ItemList.Food_Flat_Dough.get(1), MaterialLibAPI.getStack(Materials.MeatCooked, Shapes.dust, 1))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Helium, FluidShapes.fluidGas, 4_000))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Helium, FluidShapes.fluidGas, 6_000))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Helium, FluidShapes.fluidGas, 12_000))
            .duration(40 * SECONDS)
            .eut(TierEU.RECIPE_LuV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Helium, FluidShapes.fluidGas, 16_000))
            .duration(1 * MINUTES + 20 * SECONDS)
            .eut(TierEU.RECIPE_ZPM)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Helium, FluidShapes.fluidGas, 20_000))
            .duration(1 * MINUTES + 20 * SECONDS)
            .eut(TierEU.RECIPE_UV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Helium, FluidShapes.fluidGas, 24000))
            .duration(2 * MINUTES + 40 * SECONDS)
            .eut(TierEU.RECIPE_UHV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(9)
            .itemOutputs(GTOreDictUnificator.get("wireGt01SuperconductorMV", 3))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.SpaceTime, FluidShapes.fluidMolten, 4))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(9)
            .itemOutputs(GTOreDictUnificator.get("wireGt01SuperconductorHV", 6))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.SpaceTime, FluidShapes.fluidMolten, 8))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(9)
            .itemOutputs(GTOreDictUnificator.get("wireGt01SuperconductorEV", 9))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.SpaceTime, FluidShapes.fluidMolten, 12))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(9)
            .itemOutputs(GTOreDictUnificator.get("wireGt01SuperconductorIV", 12))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.SpaceTime, FluidShapes.fluidMolten, 1 * NUGGETS))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_IV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(9)
            .itemOutputs(GTOreDictUnificator.get("wireGt01SuperconductorLuV", 15))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.SpaceTime, FluidShapes.fluidMolten, 24))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_LuV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(9)
            .itemOutputs(GTOreDictUnificator.get("wireGt01SuperconductorZPM", 18))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.SpaceTime, FluidShapes.fluidMolten, 2 * NUGGETS))
            .duration(40 * SECONDS)
            .eut(TierEU.RECIPE_ZPM)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(9)
            .itemOutputs(GTOreDictUnificator.get("wireGt01SuperconductorUV", 21))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.SpaceTime, FluidShapes.fluidMolten, 40))
            .duration(40 * SECONDS)
            .eut(TierEU.RECIPE_UV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(9)
            .itemOutputs(GTOreDictUnificator.get("wireGt01Superconductor", 24))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.SpaceTime, FluidShapes.fluidMolten, 3 * NUGGETS))
            .duration(1 * MINUTES + 20 * SECONDS)
            .eut(TierEU.RECIPE_UHV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(9)
            .itemOutputs(GTOreDictUnificator.get("wireGt01SuperconductorUEV", 27))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.SpaceTime, FluidShapes.fluidMolten, 56))
            .duration(1 * MINUTES + 20 * SECONDS)
            .eut(TierEU.RECIPE_UEV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.SpaceTime, FluidShapes.fluidMolten, 68))
            .duration(1 * MINUTES + 20 * SECONDS)
            .eut(TierEU.RECIPE_UIV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.SpaceTime, FluidShapes.fluidMolten, 1 * HALF_INGOTS))
            .duration(2 * MINUTES + 40 * SECONDS)
            .eut(TierEU.RECIPE_UMV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Lead, Shapes.wireFine, 16))
            .circuit(1)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Aluminium, Shapes.wireFine, 16))
            .circuit(1)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.SteelMagnetic, Shapes.stick, 1),
                MaterialLibAPI.getStack(Materials.EnergeticAlloy, Shapes.wireFine, 16))
            .circuit(1)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.TungstenSteel, Shapes.wireFine, 16))
            .circuit(1)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.NeodymiumMagnetic, Shapes.stick, 1),
                MaterialLibAPI.getStack(Materials.Iridium, Shapes.wireFine, 16))
            .circuit(1)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.SamariumMagnetic, Shapes.stick, 1),
                MaterialLibAPI.getStack(Materials.Europium, Shapes.wireFine, 16))
            .circuit(1)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.SamariumMagnetic, Shapes.stick, 1),
                MaterialLibAPI.getStack(Materials.ElectrumFlux, Shapes.wireFine, 16))
            .circuit(1)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.TengamAttuned, Shapes.stick, 1),
                MaterialLibAPI.getStack(Materials.CelestialTungsten, Shapes.wireFine, 16))
            .circuit(1)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.TengamAttuned, Shapes.stick, 1),
                MaterialLibAPI.getStack(Materials.Rhugnor, Shapes.wireFine, 16))
            .circuit(1)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.TengamAttuned, Shapes.stick, 1),
                MaterialLibAPI.getStack(Materials.Dragonblood, Shapes.wireFine, 16))
            .circuit(1)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Magmatter, Shapes.stick, 1),
                MaterialLibAPI.getStack(Materials.Universium, Shapes.wireFine, 16))
            .circuit(1)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Wood, Shapes.plate, 6))
            .circuit(2)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Wood, Shapes.plate, 3))
            .circuit(4)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Wood, Shapes.plate, 1))
            .circuit(12)
            .itemOutputs(GTOreDictUnificator.get("pipeSmallWood", 6))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Glue, FluidShapes.fluidLiquid, 60))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                ItemList.Electric_Motor_UV.get(1),
                MaterialLibAPI.getStack(Materials.Iridium, Shapes.rotor, 1),
                ItemList.Component_Filter.get(8),
                MaterialLibAPI.getStack(Materials.Iridium, Shapes.stickLong, 8))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Iron, Shapes.stick, 1))
            .circuit(1)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.CastIron, Shapes.stick, 1))
            .circuit(1)
            .itemOutputs(ItemList.FenceIron.get(1L))
            .duration(5 * SECONDS)
            .eut(4)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.CastIron, Shapes.ring, 2))
            .itemOutputs(ItemList.Component_Minecart_Wheels_Iron.get(1))
            .duration(4 * SECONDS)
            .eut(20)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Iron, Shapes.plate, 8))
            .circuit(8)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.CastIron, Shapes.plate, 8))
            .circuit(8)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Steel, Shapes.plate, 8))
            .circuit(8)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Aluminium, Shapes.plate, 8))
            .circuit(8)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.StainlessSteel, Shapes.plate, 8))
            .circuit(8)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Titanium, Shapes.plate, 8))
            .circuit(8)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.TungstenSteel, Shapes.plate, 8))
            .circuit(8)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Iridium, Shapes.plate, 8))
            .circuit(8)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Osmium, Shapes.plate, 8))
            .circuit(8)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Neutronium, Shapes.plate, 8))
            .circuit(8)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Invar, Shapes.plate, 6),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.StainlessSteel, Shapes.plate, 6),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Osmiridium, Shapes.plate, 6),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.BlackPlutonium, Shapes.plate, 6),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.HSSS, Shapes.plate, 4),
                ItemList.Casing_LuV.get(1))
            .itemOutputs(ItemList.Casing_Fusion.get(1))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.HSSG, FluidShapes.fluidMolten, 2 * INGOTS))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_IV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Netherite, Shapes.plate, 4),
                MaterialLibAPI.getStack(Materials.Americium, Shapes.plate, 4),
                ItemList.Casing_Fusion.get(1))
            .itemOutputs(ItemList.Casing_Fusion2.get(1))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.NaquadahAlloy, FluidShapes.fluidMolten, 2 * INGOTS))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_LuV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Magnalium, Shapes.plate, 6),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Titanium, Shapes.plate, 6), ItemList.Casing_Turbine.get(1))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Polytetrafluoroethylene, FluidShapes.fluidMolten, 216))
            .duration(2 * SECONDS + 10 * TICKS)
            .eut(TierEU.RECIPE_LV / 2)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Iridium, Shapes.plate, 6),
                GTOreDictUnificator.get("frameGtIridium", 1))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Plastic, FluidShapes.fluidMolten, 2 * INGOTS))
            .duration(1 * SECONDS + 5 * TICKS)
            .eut(TierEU.RECIPE_LV / 2)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialLibAPI.getFluidStack(Materials.Polytetrafluoroethylene, FluidShapes.fluidMolten, 2 * INGOTS))
            .duration(2 * SECONDS + 10 * TICKS)
            .eut(TierEU.RECIPE_LV / 2)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Polybenzimidazole, FluidShapes.fluidMolten, 2 * INGOTS))
            .duration(2 * SECONDS + 10 * TICKS)
            .eut(TierEU.RECIPE_LV / 2)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.BatteryAlloy, Shapes.plate, 3))
            .itemOutputs(ItemList.Battery_Hull_MV.get(1))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Plastic, FluidShapes.fluidMolten, 3 * INGOTS))
            .duration(16 * SECONDS)
            .eut(20)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.BatteryAlloy, Shapes.plate, 9))
            .itemOutputs(ItemList.Battery_Hull_HV.get(1))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Plastic, FluidShapes.fluidMolten, 9 * INGOTS))
            .duration(1 * MINUTES + 4 * SECONDS)
            .eut(20)
            .addTo(assemblerRecipes);
        ...
        ItemStack[] plates = new ItemStack[] { MaterialLibAPI.getStack(Materials.Iron, Shapes.plate, 1),
            MaterialLibAPI.getStack(Materials.CastIron, Shapes.plate, 1),
            MaterialLibAPI.getStack(Materials.Aluminium, Shapes.plate, 1) };
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.SuperconductorUIVBase, Shapes.foil, 64),
                MaterialLibAPI.getStack(Materials.Netherite, Shapes.plate, 32),
                ItemList.Electric_Pump_UIV.get(1))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.PhononMedium, FluidShapes.fluidLiquid, 100))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.SuperconductorUIVBase, Shapes.plate, 8),
                MaterialLibAPI.getStack(Materials.SixPhasedCopper, Shapes.rotor, 3),
                ItemList.Field_Generator_UEV.get(1))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.PhononMedium, FluidShapes.fluidLiquid, 500))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ItemList.Hull_UV.get(1),
                MaterialLibAPI.getStack(Materials.Americium, Shapes.stick, 2),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.FleroviumGT5U, Shapes.stickLong, 64),
                ItemList.Field_Generator_UMV.get(1L))
            .itemOutputs(ItemList.NaniteShieldingGlass.get(4L))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Universium, FluidShapes.fluidMolten, 16))
            .duration(16 * SECONDS)
            .eut(TierEU.RECIPE_UXV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.prismaticnaquadah, Shapes.plateSuperdense, 2))
            .itemOutputs(ItemList.FieldEnergyAbsorberCasing.get(2L))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.ExcitedDTSC, FluidShapes.fluidLiquid, 16_000))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_UXV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Magmatter, Shapes.plate, 6),
                GTOreDictUnificator.get("circuitCosmic", 1L))
            .itemOutputs(ItemList.LoadbearingDistributionCasing.get(1L))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.CosmicNeutronium, FluidShapes.fluidPlasma, 1 * STACKS))
            .duration(1 * SECONDS)
            .eut(TierEU.RECIPE_UXV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Silver, Shapes.plateTriple, 1),
                MaterialLibAPI.getStack(Materials.CastIron, Shapes.plate, 2),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Steel, Shapes.itemCasing, 10),
                MaterialLibAPI.getStack(Materials.Iron, Shapes.stick, 2),
                new ItemStack(Blocks.chest, 1),
                new OreDictItemStack("dyeRed", 4),
                new OreDictItemStack("dyeOrange", 1))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Plastic, FluidShapes.fluidMolten, 4 * INGOTS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Polytetrafluoroethylene, FluidShapes.fluidMolten, 144))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                ItemList.Casing_Chemically_Inert.get(1L))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Naquadah, FluidShapes.fluidMolten, 9))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Netherite, Shapes.plate, 2),
                ItemList.Casing_Chemically_Inert.get(1L))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Quantium, FluidShapes.fluidMolten, 144))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.SolderingAlloy, FluidShapes.fluidMolten, 8 * INGOTS))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Naquadah, Shapes.stick, 4),
                MaterialLibAPI.getStack(Materials.TungstenSteel, Shapes.itemCasing, 4),
                new Object[] { Circuits.IV.getIngredient(), 1 })
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.SolderingAlloy, FluidShapes.fluidMolten, 16 * INGOTS))
    ...
    public void loadInputBusesRecipes() {
        // ULV input bus
        {
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Glue, FluidShapes.fluidLiquid, 1 * INGOTS))
                .duration(24 * SECONDS)
                .eut(TierEU.RECIPE_ULV)
                .addTo(assemblerRecipes);
            ...
            GTValues.RA.stdBuilder()
                ...
                .circuit(1)
                .itemOutputs(ItemList.Hatch_Input_Bus_ULV.get(1))
                .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Plastic, FluidShapes.fluidMolten, 1 * HALF_INGOTS))
                .duration(24 * SECONDS)
                .eut(TierEU.RECIPE_ULV)
                .addTo(assemblerRecipes);
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI
                        .getFluidStack(Materials.Polytetrafluoroethylene, FluidShapes.fluidMolten, 1 * EIGHTH_INGOTS))
                .duration(24 * SECONDS)
                .eut(TierEU.RECIPE_ULV)
                .addTo(assemblerRecipes);
            ...
            GTValues.RA.stdBuilder()
                ...
                .circuit(1)
                .itemOutputs(ItemList.Hatch_Input_Bus_ULV.get(1))
                .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Polybenzimidazole, FluidShapes.fluidMolten, 4))
                .duration(24 * SECONDS)
                .eut(TierEU.RECIPE_ULV)
                .addTo(assemblerRecipes);
        }
        ...
        // LV input bus
        {
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Glue, FluidShapes.fluidLiquid, 5 * INGOTS))
                .duration(24 * SECONDS)
                .eut(TierEU.RECIPE_LV)
                .addTo(assemblerRecipes);
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI
                        .getFluidStack(Materials.Polytetrafluoroethylene, FluidShapes.fluidMolten, 1 * HALF_INGOTS))
                .duration(24 * SECONDS)
                .eut(TierEU.RECIPE_LV)
                .addTo(assemblerRecipes);
        ...
        // MV input bus
        {
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI
                        .getFluidStack(Materials.Polybenzimidazole, FluidShapes.fluidMolten, 1 * EIGHTH_INGOTS))
                .duration(24 * SECONDS)
                .eut(TierEU.RECIPE_MV)
                .addTo(assemblerRecipes);
        }
        ...
        // HV input bus
        {
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI
                        .getFluidStack(Materials.Polybenzimidazole, FluidShapes.fluidMolten, 1 * QUARTER_INGOTS))
                .duration(24 * SECONDS)
                .eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        }
        ...
        // EV input bus
        {
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI
                        .getFluidStack(Materials.Polytetrafluoroethylene, FluidShapes.fluidMolten, 4 * INGOTS))
                .duration(24 * SECONDS)
                .eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
            ...
            GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.Hatch_Input_Bus_EV.get(1))
                .fluidInputs(
                    MaterialLibAPI.getFluidStack(Materials.Polybenzimidazole, FluidShapes.fluidMolten, 1 * HALF_INGOTS))
                .duration(24 * SECONDS)
                .eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
        }
        ...
        // IV input bus
        {
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI
                        .getFluidStack(Materials.Polytetrafluoroethylene, FluidShapes.fluidMolten, 8 * INGOTS))
                .duration(24 * SECONDS)
                .eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        ...
        // LuV input bus
        {
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI
                        .getFluidStack(Materials.Polytetrafluoroethylene, FluidShapes.fluidMolten, 16 * INGOTS))
                .duration(24 * SECONDS)
                .eut(TierEU.RECIPE_LuV)
                .addTo(assemblerRecipes);
        ...
        // Fluid Pipe
        {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    MaterialLibAPI.getStack(Materials.Polytetrafluoroethylene, Shapes.plate, 4),
        ...
        // Item Pipe
        {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    MaterialLibAPI.getStack(Materials.Brass, Shapes.plate, 4),
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    MaterialLibAPI.getStack(Materials.Platinum, Shapes.plate, 4),
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    MaterialLibAPI.getStack(Materials.Osmium, Shapes.plate, 4),
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    MaterialLibAPI.getStack(Materials.Quantium, Shapes.plate, 4),
    ...
    private void withRailcraft() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Steel, Shapes.stick, 3),
                MaterialLibAPI.getStack(Materials.Electrum, Shapes.stick, 3))
            .circuit(8)
            .itemOutputs(ItemList.RC_Rail_HS.get(16))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Blaze, FluidShapes.fluidMolten, 216))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_LV / 2)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.ConductiveIron, FluidShapes.fluidMolten, 3 * INGOTS))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_LV / 2)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.VibrantAlloy, FluidShapes.fluidMolten, 216))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.CrystallineAlloy, FluidShapes.fluidMolten, 216))
            .duration(5 * SECONDS)
            .eut(48)
            .addTo(assemblerRecipes);

        GTValues.RA.stdBuilder()
            .itemInputs(ItemList.RC_Rail_Standard.get(3), MaterialLibAPI.getStack(Materials.Electrum, Shapes.stick, 3))
            .circuit(8)
            .itemOutputs(ItemList.RC_Rail_Adv.get(8))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Redstone, FluidShapes.fluidMolten, 216))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_LV / 2)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.RedAlloy, FluidShapes.fluidMolten, 216))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_LV / 2)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.ConductiveIron, FluidShapes.fluidMolten, 216))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(ItemList.RC_Tie_Wood.get(1), MaterialLibAPI.getStack(Materials.Iron, Shapes.stick, 1))
            .circuit(10)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(ItemList.RC_Tie_Wood.get(1), MaterialLibAPI.getStack(Materials.CastIron, Shapes.stick, 1))
            .circuit(11)
            .itemOutputs(ItemList.RC_Rail_Wooden.get(8))
            .duration(6 * SECONDS + 13 * TICKS)
            .eut(4)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(ItemList.RC_Tie_Wood.get(1), MaterialLibAPI.getStack(Materials.Steel, Shapes.stick, 1))
            .circuit(11)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(ItemList.RC_Tie_Wood.get(1), MaterialLibAPI.getStack(Materials.StainlessSteel, Shapes.stick, 1))
            .circuit(11)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(ItemList.RC_Tie_Wood.get(1), MaterialLibAPI.getStack(Materials.Titanium, Shapes.stick, 1))
            .circuit(11)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.copyAmount(2, tRailRe), MaterialLibAPI.getStack(Materials.RedAlloy, Shapes.plate, 1))
            .circuit(22)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.copyAmount(2, tRailHs), MaterialLibAPI.getStack(Materials.RedAlloy, Shapes.plate, 1))
            .circuit(22)
        ...
        if (tRailSS != null) {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailWood),
                    MaterialLibAPI.getStack(Materials.Steel, Shapes.springSmall, 2))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailWood),
                    MaterialLibAPI.getStack(Materials.Titanium, Shapes.springSmall, 1))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailWood),
                    MaterialLibAPI.getStack(Materials.TungstenSteel, Shapes.springSmall, 1))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailWood),
                    MaterialLibAPI.getStack(Materials.Iridium, Shapes.springSmall, 1))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailWood),
                    MaterialLibAPI.getStack(Materials.Osmium, Shapes.springSmall, 1))
                .circuit(1)
        ...
        if (tRailSW != null) {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailWood),
                    MaterialLibAPI.getStack(Materials.Iridium, Shapes.gearGtSmall, 1))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailWood),
                    MaterialLibAPI.getStack(Materials.Osmium, Shapes.gearGtSmall, 1))
                .circuit(1)
        ...
        if (tRailSJ != null) {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailWood),
                    MaterialLibAPI.getStack(Materials.Iridium, Shapes.screw, 1))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailWood),
                    MaterialLibAPI.getStack(Materials.Osmium, Shapes.screw, 1))
                .circuit(1)
        ...
        if (tRailNS != null) {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    MaterialLibAPI.getStack(Materials.Steel, Shapes.springSmall, 4))
                .circuit(1)
                .itemOutputs(tRailNS)
                .duration(10 * SECONDS)
                .eut(TierEU.RECIPE_LV / 2)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    new ItemStack(Blocks.rail, 2, 0),
                    MaterialLibAPI.getStack(Materials.StainlessSteel, Shapes.springSmall, 2))
                .circuit(1)
        ...
        if (tRailNW != null) {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    new ItemStack(Blocks.rail, 2, 0),
                    MaterialLibAPI.getStack(Materials.Steel, Shapes.gearGtSmall, 4))
                .circuit(1)
                .itemOutputs(tRailNW)
                .duration(10 * SECONDS)
                .eut(TierEU.RECIPE_LV / 2)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    new ItemStack(Blocks.rail, 2, 0),
                    MaterialLibAPI.getStack(Materials.Neutronium, Shapes.gearGtSmall, 1))
                .circuit(1)
        ...
        if (tRailNJ != null) {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Blocks.rail, 2, 0), MaterialLibAPI.getStack(Materials.Steel, Shapes.screw, 4))
                .circuit(1)
                .itemOutputs(tRailNJ)
                .duration(10 * SECONDS)
                .eut(TierEU.RECIPE_LV / 2)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    new ItemStack(Blocks.rail, 2, 0),
                    MaterialLibAPI.getStack(Materials.StainlessSteel, Shapes.screw, 2))
                .circuit(1)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    new ItemStack(Blocks.rail, 2, 0),
                    MaterialLibAPI.getStack(Materials.Neutronium, Shapes.screw, 1))
                .circuit(1)
        ...
        if (tRailRJ != null) {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(GTUtility.copyAmount(2, tRailRe), MaterialLibAPI.getStack(Materials.Steel, Shapes.screw, 4))
                .circuit(1)
                .itemOutputs(tRailRJ)
                .duration(15 * SECONDS)
                .eut(TierEU.RECIPE_LV / 2)
        ...
        if (tRailES != null) {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    MaterialLibAPI.getStack(Materials.Copper, Shapes.springSmall, 4))
                .circuit(17)
                .itemOutputs(tRailES)
                .duration(20 * SECONDS)
                .eut(TierEU.RECIPE_LV / 2)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailEl),
                    MaterialLibAPI.getStack(Materials.Gold, Shapes.springSmall, 2))
                .circuit(17)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailEl),
                    MaterialLibAPI.getStack(Materials.Electrum, Shapes.springSmall, 1))
                .circuit(17)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailEl),
                    MaterialLibAPI.getStack(Materials.Platinum, Shapes.springSmall, 1))
                .circuit(17)
        ...
        if (tRailEw != null) {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailEl),
                    MaterialLibAPI.getStack(Materials.Copper, Shapes.gearGtSmall, 4))
                .circuit(17)
                .itemOutputs(tRailEw)
                .duration(20 * SECONDS)
                .eut(TierEU.RECIPE_LV / 2)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailEl),
                    MaterialLibAPI.getStack(Materials.Electrum, Shapes.gearGtSmall, 1))
                .circuit(17)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailEl),
                    MaterialLibAPI.getStack(Materials.Platinum, Shapes.gearGtSmall, 1))
                .circuit(17)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailEl),
                    MaterialLibAPI.getStack(Materials.VanadiumGallium, Shapes.gearGtSmall, 1))
                .circuit(17)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailEl),
                    MaterialLibAPI.getStack(Materials.Naquadah, Shapes.gearGtSmall, 1))
                .circuit(17)
        ...
        if (tRailEJ != null) {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailEl),
                    MaterialLibAPI.getStack(Materials.Copper, Shapes.screw, 4))
                .circuit(17)
                .itemOutputs(tRailEJ)
                .duration(20 * SECONDS)
                .eut(TierEU.RECIPE_LV / 2)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(GTUtility.copyAmount(2, tRailEl), MaterialLibAPI.getStack(Materials.Gold, Shapes.screw, 2))
                .circuit(17)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailEl),
                    MaterialLibAPI.getStack(Materials.Platinum, Shapes.screw, 1))
                .circuit(17)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailEl),
                    MaterialLibAPI.getStack(Materials.VanadiumGallium, Shapes.screw, 1))
                .circuit(17)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTUtility.copyAmount(2, tRailEl),
                    MaterialLibAPI.getStack(Materials.Naquadah, Shapes.screw, 1))
                .circuit(17)
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(1)
            .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "EngineCore", 1L, 0))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Lubricant, FluidShapes.fluidLiquid, 125))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_LV / 2)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                getModItem(NewHorizonsCoreMod.ID, "EngineCore", 1),
                MaterialLibAPI.getStack(Materials.Steel, Shapes.plate, 10))
            .circuit(10)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                getModItem(NewHorizonsCoreMod.ID, "EngineCore", 1),
                MaterialLibAPI.getStack(Materials.Aluminium, Shapes.plate, 10))
            .circuit(10)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Steel, Shapes.plate, 2))
            .circuit(20)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Steel, Shapes.plate, 2), new OreDictItemStack("paneGlass", 2))
            .circuit(21)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Aluminium, Shapes.plate, 2))
            .circuit(20)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.StainlessSteel, Shapes.plate, 2))
            .circuit(20)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Titanium, Shapes.plate, 2))
            .circuit(20)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.TungstenSteel, Shapes.plate, 2))
            .circuit(20)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Palladium, Shapes.plate, 2))
            .circuit(20)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials.Palladium, Shapes.plate, 2),
                new OreDictItemStack("paneGlass", 2))
            .circuit(21)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Iridium, Shapes.plate, 2))
            .circuit(20)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Osmium, Shapes.plate, 2))
            .circuit(20)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Neutronium, Shapes.plate, 2))
            .circuit(20)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Iron, Shapes.itemCasing, 6))
            .circuit(6)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials.Steel, Shapes.itemCasing, 6))
            .circuit(6)
    ...
    public void withGalacticraftMars() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialLibAPI.getFluidStack(Materials.StainlessSteel, FluidShapes.fluidMolten, 1 * HALF_INGOTS))
            .duration(15 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.MeteoricIron, Shapes.plate, 2))
            .circuit(1)
            .itemOutputs(ItemList.Ingot_Heavy2.get(1))
            .fluidInputs(
                MaterialLibAPI.getFluidStack(Materials.TungstenSteel, FluidShapes.fluidMolten, 1 * HALF_INGOTS))
            .duration(15 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Desh, Shapes.plate, 4))
            .circuit(1)
            .itemOutputs(ItemList.Ingot_Heavy3.get(1))
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Platinum, FluidShapes.fluidMolten, 1 * HALF_INGOTS))
            .duration(15 * SECONDS)
            .eut(TierEU.RECIPE_IV)
            .addTo(assemblerRecipes);
    }
    ...
    public void withGTNHLanthAndGTPP() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Titanium, Shapes.screw, 16),
                MaterialLibAPI.getStack(Materials.BorosilicateGlass, Shapes.ring, 16),
