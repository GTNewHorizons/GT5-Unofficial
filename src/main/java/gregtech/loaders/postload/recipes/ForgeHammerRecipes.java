...
public class ForgeHammerRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Ice, 2)
            )
            .noFluidInputs()
            .noFluidOutputs()
            .duration(10 * TICKS)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                Materials.Brick.getIngots(1)
            )
            .itemOutputs(
                Materials.Brick.getDustSmall(1)
            )
            .noFluidInputs()
            .noFluidOutputs()
            .duration(10 * TICKS)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ItemList.Casing_Firebricks.get(1)
            )
            .itemOutputs(
                ItemList.Firebrick.get(3)
            )
            .noFluidInputs()
            .noFluidOutputs()
            .duration(10 * TICKS)
        ...
        if (GTPlusPlus.isModLoaded()){
            GT_Values.RA.stdBuilder()
                ...
                .fluidOutputs(
                    Materials.Space.getMolten(1440L),
                    Materials.Time.getMolten(1440L)
                )
                .duration(10*SECONDS)
