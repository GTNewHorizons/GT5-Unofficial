...
public class FluidCannerRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Mercury, FluidShapes.fluidLiquid, 4_000))
            .duration(64)
            .eut(1)
            .addTo(cannerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Mercury, FluidShapes.fluidLiquid, 16_000))
            .duration(258)
            .eut(1)
            .addTo(cannerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.SulfuricAcid, FluidShapes.fluidLiquid, 16_000))
            .duration(258)
            .eut(1)
            .addTo(cannerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.FierySteel, FluidShapes.fluidLiquid, 250))
            .duration(4)
            .eut(1)
            .addTo(cannerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Acetone, FluidShapes.fluidLiquid, 4_000))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialLibAPI.getFluidStack(Materials.Acetone, FluidShapes.fluidLiquid, 4_000))
            .duration(74)
            .eut(1)
            .addTo(cannerRecipes);
    }
