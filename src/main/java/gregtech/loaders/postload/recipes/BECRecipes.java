    ...
    public void run() {
        ...
        addBec(
            ...
            new ItemStack[] { CustomItemList.EOH_Infinite_Energy_Casing.get(1),
                ...
                MaterialLibAPI.getStack(Materials.MetastableOganesson, Shapes.plateDense, 32),
        ...
        addBec(
            ...
            new ItemStack[] { GTOreDictUnificator.get("frameGtSpaceTime", 1),
                MaterialLibAPI.getStack(Materials.SpaceTime, Shapes.plateSuperdense, (int) (1)),
                ItemList.Robot_Arm_UMV.get(8), ItemList.Electric_Piston_UMV.get(10),
                ItemList.Electric_Motor_UMV.get(16),
                MaterialLibAPI.getStack(Materials.SpaceTime, Shapes.gearGt, (int) (4)),
                MaterialLibAPI.getStack(Materials.SpaceTime, Shapes.gearGtSmall, (int) (16)),
    ...
    private void addGodforgeRecipes() {
        ...
        addBec(
            ...
            new ItemStack[] { GTOreDictUnificator.get("frameGtTranscendentMetal", 12),
                ...
                MaterialLibAPI.getStack(Materials.SixPhasedCopper, Shapes.screw, (int) (8)),
        ...
        if (GalacticraftAmunRa.isModLoaded()) {
            ...
            addBec(
                ...
                new ItemStack[] { GTOreDictUnificator.get("frameGtMellion", 24),
                    ...
                    MaterialLibAPI.getStack(Materials.Creon, Shapes.plate, (int) (9)),
        ...
        addBec(
            ...
            new ItemStack[] { CustomItemList.Godforge_BoundlessStructureCasing.get(2), ItemList.ZPM2.get(2),
                ...
                MaterialLibAPI.getStack(Materials.Creon, Shapes.plate, (int) (9)),
                MaterialLibAPI.getStack(Materials.Creon, Shapes.gearGt, (int) (12)),
                MaterialLibAPI.getStack(Materials.Mellion, Shapes.gearGtSmall, (int) (12)) },
        ...
        addBec(
            ...
            new ItemStack[] { new ItemStack(BlockQuantumGlass.INSTANCE, 12),
                ...
                MaterialLibAPI.getStack(Materials.MagnetoResonatic, Shapes.lens, 9),
                MaterialLibAPI.getStack(Materials.Rhugnor, Shapes.plate, 24),
                MaterialLibAPI.getStack(Materials.Creon, Shapes.stickLong, (int) (33)),
                MaterialLibAPI.getStack(Materials.Mellion, Shapes.stickLong, (int) (9)),
                MaterialLibAPI.getStack(Materials.SixPhasedCopper, Shapes.stickLong, (int) (9)),
                MaterialLibAPI.getStack(Materials.AdvancedNitinol, Shapes.plateSuperdense, 24) },
        ...
        addBec(
            ...
            new ItemStack[] { CustomItemList.Godforge_MagneticConfinementCasing.get(3),
                ...
                MaterialLibAPI.getStack(Materials.Creon, Shapes.plate, (int) (16)),
                MaterialLibAPI.getStack(Materials.Mellion, Shapes.gearGtSmall, (int) (8)),
                ...
                MaterialLibAPI
                    .getStack(Materials.SuperconductorUIVBase, Shapes.plate, (int) (32)) },
        ...
        addBec(
            ...
            new ItemStack[] { CustomItemList.Godforge_MagneticConfinementCasing.get(1),
                ...
                MaterialLibAPI.getStack(Materials.Creon, Shapes.plateDense, (int) (8)),
                MaterialLibAPI.getStack(Materials.Mellion, Shapes.gearGt, (int) (4)),
        ...
        addBec(
            ...
            new ItemStack[] { CustomItemList.Godforge_MagneticConfinementCasing.get(1),
                ...
                MaterialLibAPI.getStack(Materials.Creon, Shapes.plateSuperdense, (int) (8)),
                MaterialLibAPI.getStack(Materials.Mellion, Shapes.gearGt, (int) (64)),
        ...
        addBec(
            ...
            new ItemStack[] { GTOreDictUnificator.get("frameGtTranscendentMetal", 2),
                MaterialLibAPI.getStack(Materials.Creon, Shapes.stickLong, (int) (18)),
                ...
                MaterialLibAPI.getStack(Materials.SixPhasedCopper, Shapes.bolt, (int) (36)) },
    ...
    public void runLateRecipes() {
        ...
        addBec(
            ...
            new ItemStack[] { GTOreDictUnificator.get("frameGtSixPhasedCopper", 4),
                ...
                MaterialLibAPI
                    .getStack(Materials.SuperconductorUIVBase, Shapes.stickLong, (int) (8)),
                MaterialLibAPI.getStack(Materials.Creon, Shapes.plate, (int) (16)),
                MaterialLibAPI.getStack(Materials.Mellion, Shapes.plate, (int) (16)),
                MaterialLibAPI
                    .getStack(Materials.SuperconductorUEVBase, Shapes.stickLong, (int) (8)),
                getModItem(EternalSingularity.ID, "combined_singularity", 1L, 4),
                MaterialLibAPI
                    .getStack(Materials.TranscendentMetal, Shapes.plateSuperdense, (int) (2)),
                ...
                MaterialLibAPI
                    .getStack(Materials.CosmicNeutronium, Shapes.plateSuperdense, (int) (2)),
    ...
    private void addBECCasingRecipes() {
        ...
        addBec(
            ...
            new ItemStack[] { ItemList.BlockQuarkContainmentCasing.get(8),
                ...
                MaterialLibAPI.getStack(Materials.SixPhasedCopper, Shapes.bolt, (int) (32)),
                MaterialLibAPI.getStack(Materials.Tairitsu, Shapes.ring, 16),
                MaterialLibAPI.getStack(Materials.Hypogen, Shapes.screw, 32),
        ...
        addBec(
            ...
            new ItemStack[] { ItemList.PeaceEnforcementCasing.get(8), Casings.ParticleBeamGuidancePipeCasing.toStack(8),
                ...
                MaterialLibAPI.getStack(Materials.SixPhasedCopper, Shapes.rotor, (int) (1)),
                MaterialLibAPI.getStack(Materials.Churitsu, Shapes.stickLong, (int) (4)),
        ...
        addBec(
            ...
            new ItemStack[] { ItemList.ConflictInducementCasing.get(4),
                ...
                MaterialLibAPI.getStack(Materials.SixPhasedCopper, Shapes.gearGtSmall, (int) (2)),
                MaterialLibAPI.getStack(Materials.Shijima, Shapes.gearGt, (int) (1)),
                MaterialLibAPI.getStack(Materials.Hypogen, Shapes.gearGtSmall, 2),
        ...
        addBec(
            ...
            new ItemStack[] { ItemRefer.Field_Restriction_Coil_T3.get(1),
                ...
                MaterialLibAPI.getStack(Materials.Tairitsu, Shapes.screw, 16),
                MaterialLibAPI.getStack(Materials.Shijima, Shapes.bolt, (int) (16)) },
            nanites(3, 1, 4, 1, 1, 1),
        ...
        addBec(
            ...
            new ItemStack[] { ItemRefer.AntimatterContainmentCasing.get(4), ItemList.MetaMaterial_Waveguide1.get(4),
                MaterialLibAPI.getStack(Materials.Churitsu, Shapes.itemCasing, (int) (4)),
                ItemList.Field_Generator_UEV.get(1) },
            nanites(3, 4, 1, 1),
            new FluidStack[] { CondensateType.ChromaticGlass.getEntangled(512 * INGOTS),
    ...
    private void addEyeOfHarmonyCasings() {
        ...
        addBec(
            ...
            new ItemStack[] { CustomItemList.Godforge_SingularityShieldingCasing.get(32),
                ...
                MaterialLibAPI.getStack(Materials.Bedrockium, Shapes.plateSuperdense, (int) (1)),
                MaterialLibAPI
                    .getStack(Materials.CosmicNeutronium, Shapes.plateSuperdense, (int) (1)),
                MaterialLibAPI.getStack(Materials.Shirabon, Shapes.plateSuperdense, 1),
        ...
        addBec(
            ...
            new ItemStack[] { TileEntities.lsc.getStackForm(1), ItemList.Machine_UV_SolarPanel.get(1),
                ...
                MaterialLibAPI.getStack(Materials.BlueTopaz, Shapes.plate, (int) (6)),
                MaterialLibAPI.getStack(Materials.CallistoIce, Shapes.plate, (int) (6)),
                MaterialLibAPI.getStack(Materials.Ledox, Shapes.plate, (int) (6)),
                GTOreDictUnificator.get("screwMetastableOganesson", 6),
                MaterialLibAPI.getStack(Materials.BlueTopaz, Shapes.screw, (int) (6)),
                MaterialLibAPI.getStack(Materials.CallistoIce, Shapes.screw, (int) (6)),
                MaterialLibAPI.getStack(Materials.Ledox, Shapes.screw, (int) (6)) },
    ...
    private void addTimeDilation() {
        ...
        for (int t = 0; t < 9; t++) {
            ...
            ItemStack[] inputs = { CustomItemList.EOH_Reinforced_Temporal_Casing.get(1),
                ...
                MaterialLibAPI.getStack(Materials.Hexanite, Shapes.ring, (int) (4 * tp1)),
                MaterialLibAPI.getStack(Materials.Hexanite, Shapes.gearGtSmall, (int) (4 * tp1)),
    ...
    private void addSpacetimeCompression() {
        ...
        for (int t = 0; t < 9; t++) {
            ...
            ItemStack[] inputs = { CustomItemList.EOH_Reinforced_Spatial_Casing.get(1),
                ...
                MaterialLibAPI
                    .getStack(Materials.CosmicNeutronium, Shapes.plateSuperdense, (int) (tp1)),
                MaterialLibAPI.getStack(Materials.Infinity, Shapes.plateSuperdense, (int) (tp1)),
                MaterialLibAPI
                    .getStack(Materials.TranscendentMetal, Shapes.plateSuperdense, (int) (tp1)) };
    ...
    private void addStabilisation() {
        ...
        for (int t = 0; t < 9; t++) {
            ...
            ItemStack[] inputs = { timeGens[t].get(1), spaceGens[t].get(1),
                ...
                MaterialLibAPI.getStack(Materials.Hexanite, Shapes.screw, (int) (4 * tp1)),
