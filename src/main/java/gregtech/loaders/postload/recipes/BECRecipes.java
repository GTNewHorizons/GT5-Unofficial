    ...
    public void run() {
        ...
        addBec(
            ...
            new ItemStack[] { CustomItemList.EOH_Infinite_Energy_Casing.get(1),
                ...
                MaterialLibAPI.getStack(Materials2Materials.MetastableOganesson, Materials2Shapes.plateDense, 32),
    ...
    private void addGodforgeRecipes() {
        ...
        addBec(
            ...
            new ItemStack[] { GTOreDictUnificator.get("frameGtTranscendentMetal", 12),
                MaterialLibAPI.getStack(Materials2Materials.MagnetoResonatic, Materials2BlockShapes.block, 16),
        ...
        if (GalacticraftAmunRa.isModLoaded()) {
            ...
            addBec(
                ...
                new ItemStack[] { GTOreDictUnificator.get("frameGtMellion", 24),
                    ...
                    MaterialLibAPI.getStack(Materials2Materials.AstralTitanium, Materials2PipeShapes.frameGt, 12),
        ...
        addBec(
            ...
            new ItemStack[] { new ItemStack(BlockQuantumGlass.INSTANCE, 12),
                ...
                MaterialLibAPI.getStack(Materials2Materials.MagnetoResonatic, Materials2Shapes.lens, 9),
                ...
                MaterialLibAPI.getStack(Materials2Materials.AdvancedNitinol, Materials2Shapes.plateSuperdense, 24) },
    ...
    public void runLateRecipes() {
        ...
        addBec(
            ...
            new ItemStack[] { GTOreDictUnificator.get("frameGtSixPhasedCopper", 4),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Quantum, Materials2Shapes.plate, 16),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Titansteel, Materials2PipeShapes.frameGt, 4),
                ...
                MaterialLibAPI.getStack(Materials2Materials.AbyssalAlloy, Materials2PipeShapes.frameGt, 4) },
    ...
    private void addBECCasingRecipes() {
        ...
        addBec(
            ...
            new ItemStack[] { ItemList.BlockQuarkContainmentCasing.get(8),
                MaterialLibAPI.getStack(Materials2Materials.Tairitsu, Materials2PipeShapes.frameGt, 8),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Tairitsu, Materials2Shapes.ring, 16),
        ...
        addBec(
            ...
            new ItemStack[] { ItemList.PeaceEnforcementCasing.get(8), Casings.ParticleBeamGuidancePipeCasing.toStack(8),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Hypogen, Materials2Shapes.rotor, 1),
        ...
        addBec(
            ...
            new ItemStack[] { ItemList.ConflictInducementCasing.get(4),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Hypogen, Materials2Shapes.gearGtSmall, 2),
        ...
        addBec(
            ...
            new ItemStack[] { ItemRefer.Field_Restriction_Coil_T3.get(1),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Tairitsu, Materials2Shapes.screw, 16),
    ...
    private void addEyeOfHarmonyCasings() {
        ...
        addBec(
            ...
            new ItemStack[] { CustomItemList.Godforge_SingularityShieldingCasing.get(32),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Shirabon, Materials2Shapes.plateSuperdense, 1),
