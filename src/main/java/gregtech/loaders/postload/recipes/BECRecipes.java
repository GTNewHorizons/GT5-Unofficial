...
public class BECRecipes implements Runnable {
    ...
    private static final Material[] TIER_MATS = { Materials.Netherite, Materials.protohalkonite,
        Materials.SixPhasedCopper, Materials.TranscendentMetal, Materials.Mellion,
        Materials.Creon, Materials.SpaceTime, Materials.Hexanite,
        Materials.Eternity };
    ...
    public void run() {
        ...
        addBec(
            ...
            new ItemStack[] { CustomItemList.EOH_Infinite_Energy_Casing.get(1),
                ...
                MaterialLibAPI.getStack(Materials.MetastableOganesson, Materials2Shapes.plateDense, 32),
        ...
        addBec(
            ...
            new ItemStack[] { GTOreDictUnificator.get("frameGtSpaceTime", 1),
                MaterialLibAPI.getStack(Materials.SpaceTime, Materials2Shapes.plateSuperdense, (int) (1)),
                ItemList.Robot_Arm_UMV.get(8), ItemList.Electric_Piston_UMV.get(10),
                ItemList.Electric_Motor_UMV.get(16),
                MaterialLibAPI.getStack(Materials.SpaceTime, Materials2Shapes.gearGt, (int) (4)),
                MaterialLibAPI.getStack(Materials.SpaceTime, Materials2Shapes.gearGtSmall, (int) (16)),
    ...
    private void addGodforgeRecipes() {
        ...
        addBec(
            ...
            new ItemStack[] { GTOreDictUnificator.get("frameGtTranscendentMetal", 12),
                ...
                MaterialLibAPI.getStack(Materials.TengamAttuned, Materials2Shapes.plateDense, (int) (32)),
                MaterialLibAPI.getStack(Materials.Creon, Materials2Shapes.plate, (int) (16)),
                MaterialLibAPI.getStack(Materials.Hypogen, Materials2Shapes.screw, 8),
                MaterialLibAPI.getStack(Materials.SixPhasedCopper, Materials2Shapes.screw, (int) (8)),
        ...
        if (GalacticraftAmunRa.isModLoaded()) {
            ...
            addBec(
                ...
                new ItemStack[] { GTOreDictUnificator.get("frameGtMellion", 24),
                    ...
                    MaterialLibAPI.getStack(Materials.AstralTitanium, Materials2PipeShapes.frameGt, 12),
                    MaterialLibAPI.getStack(Materials.Creon, Materials2Shapes.plate, (int) (9)),
        ...
        addBec(
            ...
            new ItemStack[] { CustomItemList.Godforge_BoundlessStructureCasing.get(2), ItemList.ZPM2.get(2),
                ...
                MaterialLibAPI.getStack(Materials.Creon, Materials2Shapes.plate, (int) (9)),
                MaterialLibAPI.getStack(Materials.Creon, Materials2Shapes.gearGt, (int) (12)),
                MaterialLibAPI.getStack(Materials.Mellion, Materials2Shapes.gearGtSmall, (int) (12)) },
        ...
        addBec(
            ...
            new ItemStack[] { new ItemStack(BlockQuantumGlass.INSTANCE, 12),
                ...
                MaterialLibAPI.getStack(Materials.MagnetoResonatic, Materials2Shapes.lens, 9),
                MaterialLibAPI.getStack(Materials.Rhugnor, Materials2Shapes.plate, 24),
                MaterialLibAPI.getStack(Materials.Creon, Materials2Shapes.stickLong, (int) (33)),
                MaterialLibAPI.getStack(Materials.Mellion, Materials2Shapes.stickLong, (int) (9)),
                MaterialLibAPI.getStack(Materials.SixPhasedCopper, Materials2Shapes.stickLong, (int) (9)),
                MaterialLibAPI.getStack(Materials.AdvancedNitinol, Materials2Shapes.plateSuperdense, 24) },
        ...
        addBec(
            ...
            new ItemStack[] { CustomItemList.Godforge_MagneticConfinementCasing.get(3),
                ...
                MaterialLibAPI.getStack(Materials.Creon, Materials2Shapes.plate, (int) (16)),
                MaterialLibAPI.getStack(Materials.Mellion, Materials2Shapes.gearGtSmall, (int) (8)),
                ...
                MaterialLibAPI
                    .getStack(Materials.SuperconductorUIVBase, Materials2Shapes.plate, (int) (32)) },
        ...
        addBec(
            ...
            new ItemStack[] { CustomItemList.Godforge_MagneticConfinementCasing.get(1),
                ...
                MaterialLibAPI.getStack(Materials.Creon, Materials2Shapes.plateDense, (int) (8)),
                MaterialLibAPI.getStack(Materials.Mellion, Materials2Shapes.gearGt, (int) (4)),
        ...
        addBec(
            ...
            new ItemStack[] { CustomItemList.Godforge_MagneticConfinementCasing.get(1),
                ...
                MaterialLibAPI.getStack(Materials.Creon, Materials2Shapes.plateSuperdense, (int) (8)),
                MaterialLibAPI.getStack(Materials.Mellion, Materials2Shapes.gearGt, (int) (64)),
        ...
        addBec(
            ...
            new ItemStack[] { GTOreDictUnificator.get("frameGtTranscendentMetal", 2),
                MaterialLibAPI.getStack(Materials.Creon, Materials2Shapes.stickLong, (int) (18)),
                ...
                MaterialLibAPI.getStack(Materials.SixPhasedCopper, Materials2Shapes.bolt, (int) (36)) },
    ...
    public void runLateRecipes() {
        ...
        addBec(
            ...
            new ItemStack[] { GTOreDictUnificator.get("frameGtSixPhasedCopper", 4),
                ...
                MaterialLibAPI.getStack(Materials.Quantum, Materials2Shapes.plate, 16),
                ...
                MaterialLibAPI
                    .getStack(Materials.SuperconductorUIVBase, Materials2Shapes.stickLong, (int) (8)),
                MaterialLibAPI.getStack(Materials.Creon, Materials2Shapes.plate, (int) (16)),
                MaterialLibAPI.getStack(Materials.Mellion, Materials2Shapes.plate, (int) (16)),
                MaterialLibAPI
                    .getStack(Materials.SuperconductorUEVBase, Materials2Shapes.stickLong, (int) (8)),
                getModItem(EternalSingularity.ID, "combined_singularity", 1L, 4),
                MaterialLibAPI
                    .getStack(Materials.TranscendentMetal, Materials2Shapes.plateSuperdense, (int) (2)),
                ...
                MaterialLibAPI
                    .getStack(Materials.CosmicNeutronium, Materials2Shapes.plateSuperdense, (int) (2)),
    ...
    private void addBECCasingRecipes() {
        ...
        addBec(
            ...
            new ItemStack[] { ItemList.BlockQuarkContainmentCasing.get(8),
                MaterialLibAPI.getStack(Materials.Tairitsu, Materials2PipeShapes.frameGt, 8),
                GTOreDictUnificator.get("frameGtChuritsu", 8), GTOreDictUnificator.get("frameGtShijima", 8),
                ItemList.MetaMaterial_Shielding1.get(8),
                MaterialLibAPI.getStack(Materials.SixPhasedCopper, Materials2Shapes.bolt, (int) (32)),
                MaterialLibAPI.getStack(Materials.Tairitsu, Materials2Shapes.ring, 16),
                MaterialLibAPI.getStack(Materials.Hypogen, Materials2Shapes.screw, 32),
        ...
        addBec(
            ...
            new ItemStack[] { ItemList.PeaceEnforcementCasing.get(8), Casings.ParticleBeamGuidancePipeCasing.toStack(8),
                ...
                MaterialLibAPI.getStack(Materials.SixPhasedCopper, Materials2Shapes.rotor, (int) (1)),
                MaterialLibAPI.getStack(Materials.Churitsu, Materials2Shapes.stickLong, (int) (4)),
                MaterialLibAPI.getStack(Materials.Hypogen, Materials2Shapes.rotor, 1),
        ...
        addBec(
            ...
            new ItemStack[] { ItemList.ConflictInducementCasing.get(4),
                ...
                MaterialLibAPI.getStack(Materials.SixPhasedCopper, Materials2Shapes.gearGtSmall, (int) (2)),
                MaterialLibAPI.getStack(Materials.Shijima, Materials2Shapes.gearGt, (int) (1)),
                MaterialLibAPI.getStack(Materials.Hypogen, Materials2Shapes.gearGtSmall, 2),
        ...
        addBec(
            ...
            new ItemStack[] { ItemRefer.Field_Restriction_Coil_T3.get(1),
                ...
                MaterialLibAPI.getStack(Materials.Tairitsu, Materials2Shapes.screw, 16),
                MaterialLibAPI.getStack(Materials.Shijima, Materials2Shapes.bolt, (int) (16)) },
            nanites(3, 1, 4, 1, 1, 1),
        ...
        addBec(
            ...
            new ItemStack[] { ItemRefer.AntimatterContainmentCasing.get(4), ItemList.MetaMaterial_Waveguide1.get(4),
                MaterialLibAPI.getStack(Materials.Churitsu, Materials2Shapes.itemCasing, (int) (4)),
                ItemList.Field_Generator_UEV.get(1) },
            nanites(3, 4, 1, 1),
            new FluidStack[] { CondensateType.ChromaticGlass.getEntangled(512 * INGOTS),
    ...
    private void addEyeOfHarmonyCasings() {
        ...
        addBec(
            ...
            new ItemStack[] { CustomItemList.Godforge_SingularityShieldingCasing.get(32),
                ...
                MaterialLibAPI.getStack(Materials.Bedrockium, Materials2Shapes.plateSuperdense, (int) (1)),
                MaterialLibAPI
                    .getStack(Materials.CosmicNeutronium, Materials2Shapes.plateSuperdense, (int) (1)),
                MaterialLibAPI.getStack(Materials.Shirabon, Materials2Shapes.plateSuperdense, 1),
        ...
        addBec(
            ...
            new ItemStack[] { TileEntities.lsc.getStackForm(1), ItemList.Machine_UV_SolarPanel.get(1),
                ...
                MaterialLibAPI.getStack(Materials.BlueTopaz, Materials2Shapes.plate, (int) (6)),
                MaterialLibAPI.getStack(Materials.CallistoIce, Materials2Shapes.plate, (int) (6)),
                MaterialLibAPI.getStack(Materials.Ledox, Materials2Shapes.plate, (int) (6)),
                GTOreDictUnificator.get("screwMetastableOganesson", 6),
                MaterialLibAPI.getStack(Materials.BlueTopaz, Materials2Shapes.screw, (int) (6)),
                MaterialLibAPI.getStack(Materials.CallistoIce, Materials2Shapes.screw, (int) (6)),
                MaterialLibAPI.getStack(Materials.Ledox, Materials2Shapes.screw, (int) (6)) },
    ...
    private void addTimeDilation() {
        ...
        for (int t = 0; t < 9; t++) {
            ...
            ItemStack[] inputs = { CustomItemList.EOH_Reinforced_Temporal_Casing.get(1),
                ...
                MaterialLibAPI.getStack(Materials.Hexanite, Materials2Shapes.ring, (int) (4 * tp1)),
                MaterialLibAPI.getStack(Materials.Hexanite, Materials2Shapes.gearGtSmall, (int) (4 * tp1)),
    ...
    private void addSpacetimeCompression() {
        ...
        for (int t = 0; t < 9; t++) {
            ...
            ItemStack[] inputs = { CustomItemList.EOH_Reinforced_Spatial_Casing.get(1),
                ...
                MaterialLibAPI.getStack(Materials.Hexanite, Materials2Shapes.stickLong, (int) (2 * tp1)),
                GTOreDictUnificator.get(OrePrefixes.plateDense, TIER_MATS[t], tp1),
                MaterialLibAPI.getStack(Materials.Hexanite, Materials2Shapes.plateSuperdense, (int) (tp1)),
                MaterialLibAPI
                    .getStack(Materials.CosmicNeutronium, Materials2Shapes.plateSuperdense, (int) (tp1)),
                MaterialLibAPI.getStack(Materials.Infinity, Materials2Shapes.plateSuperdense, (int) (tp1)),
                MaterialLibAPI
                    .getStack(Materials.TranscendentMetal, Materials2Shapes.plateSuperdense, (int) (tp1)) };
    ...
    private void addStabilisation() {
        ...
        for (int t = 0; t < 9; t++) {
            ...
            ItemStack[] inputs = { timeGens[t].get(1), spaceGens[t].get(1),
                ...
                MaterialLibAPI.getStack(Materials.Hexanite, Materials2Shapes.screw, (int) (4 * tp1)),
