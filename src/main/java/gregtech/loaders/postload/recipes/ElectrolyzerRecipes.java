...
public class ElectrolyzerRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.Oxygen.getGas(2 * BUCKETS))
            .duration(45 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(electrolyzerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.Chlorine.getGas(1 * BUCKETS))
            .duration(16 * SECONDS)
            .eut(30)
            .addTo(electrolyzerRecipes);
        // (NaCl·H2O)= NaOH + H
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.SaltWater.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Chlorine.getGas(1 * BUCKETS))
            .duration(36 * SECONDS)
            .eut(30)
            .addTo(electrolyzerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.SodiumPersulfate.getFluid(1 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(30)
            .addTo(electrolyzerRecipes);
