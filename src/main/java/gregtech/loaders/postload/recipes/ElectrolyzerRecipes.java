...
public class ElectrolyzerRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2L))
            .fluidInputs(Materials.Water.getFluid(1000L))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2L),
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(OreDictUnificator.get(OrePrefixes.dust, Materials.Calcium, 1L))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 3L))
            .duration(25 * SECONDS)
            .eut(25)
            .addTo(electrolyzerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(OreDictUnificator.get(OrePrefixes.dust, Materials.Graphite, 1))
            .itemOutputs(OreDictUnificator.get(OrePrefixes.dust, Materials.Carbon, 4))
            .duration(5 * SECONDS)
            .eut(64)
            .addTo(electrolyzerRecipes);
        // ZnS = Zn + S + 1 Ga(9.17%)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(OreDictUnificator.get(OrePrefixes.dust, Materials.Sphalerite, 2))
            .itemOutputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Calcite, 1L),
        ...
        GT_Values.RA.stdBuilder()
            .itemOutputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Lead, 3),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Silver, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Zinc, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur, 4))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.cell, Materials.PhosphoricAcid, 1L),
                ItemList.Cell_Empty.get(6L))
            .itemOutputs(
                OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 3L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Phosphorus, 1L),
                OreDictUnificator.get(OrePrefixes.cell, Materials.Oxygen, 4L))
            .duration(27 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(electrolyzerRecipes);
