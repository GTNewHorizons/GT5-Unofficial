...
public class BlastFurnaceRecipes implements Runnable {
    ...
    public void registerBlastFurnaceRecipes() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Nitrogen.getGas(8 * BUCKETS))
            .duration(10 * MINUTES)
            .eut((int) TierEU.RECIPE_HV)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Radon.getGas(8 * BUCKETS))
            .duration(15 * MINUTES)
        ...
        for (ItemStack silicon : tSiliconDioxide) {
            GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(Materials.SulfurDioxide.getGas(2 * BUCKETS))
                .duration(6 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialsUEVplus.PhononCrystalSolution.getFluid(1 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialsUEVplus.PhononCrystalSolution.getFluid(3 * BUCKETS))
