...
public class ArcFurnaceRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.Block_TungstenSteelReinforced.get(1))
                .itemOutputs(
                ...
                .duration(8 * SECONDS).eut(96).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Long_Distance_Pipeline_Fluid.get(1L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 19L)).duration(9 * SECONDS)
                .eut((int) TierEU.RECIPE_MV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Long_Distance_Pipeline_Item.get(1L))
                .itemOutputs(
                        GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Tin, 12L),
                        GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 7L))
                .duration(9 * SECONDS).eut((int) TierEU.RECIPE_MV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Long_Distance_Pipeline_Fluid_Pipe.get(1L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.nugget, Materials.Steel, 2L)).duration(10 * TICKS)
                .eut((int) TierEU.RECIPE_MV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Long_Distance_Pipeline_Item_Pipe.get(1L))
                .itemOutputs(
                        GTOreDictUnificator.get(OrePrefixes.nugget, Materials.Tin, 1L),
                        GTOreDictUnificator.get(OrePrefixes.nugget, Materials.Steel, 1L))
                .duration(10 * TICKS).eut((int) TierEU.RECIPE_MV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Casing_Coil_Cupronickel.get(1L))
                .itemOutputs(
                ...
                .duration(15 * SECONDS).eut(TierEU.RECIPE_HV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Casing_Coil_Kanthal.get(1L))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.Casing_Coil_Nichrome.get(1L))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.Casing_Coil_TungstenSteel.get(1L))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.Casing_Coil_HSSG.get(1L))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.Casing_Coil_HSSS.get(1L))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.Casing_Coil_Naquadah.get(1L))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.Casing_Coil_NaquadahAlloy.get(1L))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.Casing_Coil_Trinium.get(1L))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.Casing_Coil_ElectrumFlux.get(1L))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.Casing_Coil_AwakenedDraconium.get(1L))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.beta", 1L, 0))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Iron, 2L))
                .duration(7 * SECONDS + 10 * TICKS).eut(90).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.beta", 1L, 1))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.beta", 1L, 2))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.beta", 1L, 13))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 2L)).duration(9 * SECONDS)
                .eut((int) TierEU.RECIPE_MV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.beta", 1L, 14))
                .itemOutputs(
                        GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1L),
                        GTOreDictUnificator.get(OrePrefixes.dustTiny, Materials.Glass, 3))
                .duration(9 * SECONDS).eut((int) TierEU.RECIPE_MV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.beta", 1L, 15))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.zeta", 1L, 0))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Aluminium, 2L))
                .duration(10 * SECONDS + 10 * TICKS).eut(150).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.zeta", 1L, 1))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.nugget, Materials.Aluminium, 3))
                .duration(10 * SECONDS + 10 * TICKS).eut(150).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.zeta", 1L, 2))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.zeta", 1L, 3))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.StainlessSteel, 2L))
                .duration(12 * SECONDS).eut(TierEU.RECIPE_MV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.zeta", 1L, 4))
                .itemOutputs(
                        GTOreDictUnificator.get(OrePrefixes.ingot, Materials.StainlessSteel, 1L),
                        GTOreDictUnificator.get(OrePrefixes.dustTiny, Materials.Glass, 3))
                .duration(12 * SECONDS).eut(TierEU.RECIPE_MV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.zeta", 1L, 5))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.zeta", 1L, 6))
        ...
        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.zeta", 1L, 8))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.zeta", 1L, 9))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.TungstenSteel, 2L))
                .duration(15 * SECONDS).eut(TierEU.RECIPE_MV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.zeta", 1L, 10))
                .itemOutputs(
                        GTOreDictUnificator.get(OrePrefixes.ingot, Materials.TungstenSteel, 1L),
                        GTOreDictUnificator.get(OrePrefixes.dustTiny, Materials.Glass, 3))
                .duration(15 * SECONDS).eut(TierEU.RECIPE_MV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.zeta", 1L, 11))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.zeta", 1L, 12))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Palladium, 2L))
                .duration(16 * SECONDS + 10 * TICKS).eut(270).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.zeta", 1L, 13))
                .itemOutputs(
                        GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Palladium, 1L),
                        GTOreDictUnificator.get(OrePrefixes.dustTiny, Materials.Glass, 3))
                .duration(16 * SECONDS + 10 * TICKS).eut(270).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.zeta", 1L, 14))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.eta", 1L, 0))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Iridium, 2L)).duration(18 * SECONDS)
                .eut(TierEU.RECIPE_HV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.eta", 1L, 1))
                .itemOutputs(
                        GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Iridium, 1L),
                        GTOreDictUnificator.get(OrePrefixes.dustTiny, Materials.Glass, 3))
                .duration(18 * SECONDS).eut(TierEU.RECIPE_HV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.eta", 1L, 2))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.eta", 1L, 3))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Osmium, 2L)).duration(18 * SECONDS)
                .eut(330).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.eta", 1L, 4))
                .itemOutputs(
                        GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Osmium, 1L),
                        GTOreDictUnificator.get(OrePrefixes.dustTiny, Materials.Glass, 3))
                .duration(18 * SECONDS).eut(330).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.eta", 1L, 5))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.eta", 1L, 6))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Neutronium, 2L))
                .duration(18 * SECONDS).eut(TierEU.RECIPE_HV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.eta", 1L, 7))
                .itemOutputs(
                        GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Neutronium, 1L),
                        GTOreDictUnificator.get(OrePrefixes.dustTiny, Materials.Glass, 3))
                .duration(18 * SECONDS).eut(TierEU.RECIPE_HV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.eta", 1L, 8))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Silicon, 1L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 3))
                .fluidInputs(Materials.Oxygen.getGas(2_000)).duration(60 * SECONDS).eut((int) TierEU.RECIPE_LV)
                .addTo(arcFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Casing_Coil_Infinity.get(1))
                .itemOutputs(
                ...
                .duration(20 * SECONDS).eut(TierEU.RECIPE_UHV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Casing_Coil_Hypogen.get(1))
                .itemOutputs(
                ...
                .duration(20 * SECONDS).eut(TierEU.RECIPE_UEV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Casing_Coil_Eternal.get(1))
                .itemOutputs(
                ...
                .duration(20 * SECONDS).eut(TierEU.RECIPE_UIV).metadata(RECYCLE, true).addTo(UniversalArcFurnace);
    }
}
