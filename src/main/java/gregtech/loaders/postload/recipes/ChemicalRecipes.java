...
public class ChemicalRecipes implements Runnable {
    ...
    public void multiblockOnly() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialsKevlar.PhosphorusTrichloride.getFluid(1_000), Materials.Chlorobenzene.getFluid(3000))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.SulfuricAcid.getFluid(5_000), Materials.Water.getFluid(10000))
            .fluidOutputs(Materials.PhosphoricAcid.getFluid(3000), Materials.HydrochloricAcid.getFluid(1_000))
            .duration(16 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.Epoxid.getMolten(1000), Materials.SaltWater.getFluid(2_000))
            .duration(24 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.Tetrafluoroethylene.getGas(1_000), Materials.HydrochloricAcid.getFluid(12000))
            .duration(27 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Ammonia.getGas(2_000), Materials.Oxygen.getGas(7000))
            .fluidOutputs(Materials.DinitrogenTetroxide.getGas(1_000), Materials.Water.getFluid(3000))
            .duration(24 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(9))
            .fluidInputs(Materials.Oxygen.getGas(100_000), Materials.Ammonia.getGas(36000))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(Materials.LightFuel.getFluid(20000), Materials.HeavyFuel.getFluid(4_000))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(Materials.GasolineRaw.getFluid(10000), Materials.Toluene.getFluid(1_000))
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Salt.getDust(4))
            .fluidInputs(Materials.HydrochloricAcid.getFluid(2_000))
            .fluidOutputs(new FluidStack(FluidRegistry.getFluid("boricacid"), 4000), Materials.Water.getFluid(5_000))
            .duration(40 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
