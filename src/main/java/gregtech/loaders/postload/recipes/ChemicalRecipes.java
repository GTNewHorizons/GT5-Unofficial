...
public class ChemicalRecipes implements Runnable {
    ...
    public void multiblockOnly() {
        ...
        // Same as above, but with Quicklime. The line it's shortcutting accepts Calcium, quicklime, and Clacite as
        // inptus, however Calcite gets deconstructed into Quiclime and Carbon Monoxide.
        GTValues.RA.stdBuilder()
