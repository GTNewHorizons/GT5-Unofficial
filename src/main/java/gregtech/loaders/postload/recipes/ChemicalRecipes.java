...
public class ChemicalRecipes implements Runnable {
    ...
    public void registerBoth(){
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_ModHandler.getIC2Item("dynamite", 1)
            )
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Thaumium, 16)
            )
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                getModItem(GalaxySpace.modID, "item.UnknowCrystal", 4),
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.BioMediumSterilized.getFluid(2000)
            )
            .fluidOutputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_ModHandler.getIC2Item("industrialTnt", 1)
            )
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Gas, 16)
            )
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Naphtha, 12)
            )
            .fluidInputs(
                Materials.Hydrogen.getGas(2000)
            )
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.cell, Materials.LightFuel, 12)
            )
            .fluidInputs(
                Materials.Hydrogen.getGas(2000)
            )
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.cell, Materials.HeavyFuel, 8)
            )
            .fluidInputs(
                Materials.Hydrogen.getGas(2000)
            )
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.gem, Materials.NetherQuartz, 3)
            )
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.gem, Materials.CertusQuartz, 3)
            )
            .fluidInputs(
                Materials.Water.getFluid(1000)
            )
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Quartzite, 3)
            )
            .fluidInputs(
                Materials.Water.getFluid(1000)
            )
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Calcite, 5)
            )
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.cell, Materials.CarbonMonoxide, 2)
            )
            .fluidInputs(
                Materials.Chlorine.getGas(4000)
            )
            .fluidOutputs(
                Materials.Titaniumtetrachloride.getFluid(1000)
            )
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(UniversalChemical);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noFluidInputs()
            .fluidOutputs(
                Materials.Rubber.getMolten(1296)
            )
            .duration(30 * SECONDS)
            .eut(16)
            .addTo(UniversalChemical);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.NickelTetracarbonyl, 1)
            )
            .fluidInputs(
                Materials.CarbonMonoxide.getGas(4000)
            )
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsKevlar.TerephthalicAcid, 1)
            )
            .fluidInputs(
                Materials.Oxygen.getGas(6000)
            )
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialsKevlar.NaphthenicAcid.getFluid(1000)
            )
            .noFluidOutputs()
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_HV)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Chlorine.getGas(27000)
            )
            .fluidOutputs(
                MaterialsKevlar.PhosphorusTrichloride.getFluid(9000)
            )
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                getModItem(Railcraft.modID, "tile.railcraft.glass", 6)
            )
            .fluidInputs(
                Materials.Glass.getMolten(864)
            )
            .noFluidOutputs()
            .duration(2 * SECONDS + 10 * TICKS)
            .eut(TierEU.RECIPE_LV)
        ...
        if (GTNHLanthanides.isModLoaded() && GTPlusPlus.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(
                    getModItem(GTPlusPlus.modID, "itemDustCalciumHydroxide", 5)
                )
                .fluidInputs(
                    Materials.Water.getFluid(2000)
                )
    ...
    public void multiblockOnly() {
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Hydrogen.getGas(16000), Materials.Oxygen.getGas(8000))
            .fluidOutputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noFluidInputs()
            .fluidOutputs(
                Materials.NitricOxide.getGas(2000), Materials.Oxygen.getGas(3000))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                Materials.PotassiumNitrade.getDust(64), Materials.PotassiumNitrade.getDust(64), Materials.PotassiumNitrade.getDust(32), Materials.Chrome.getDust(2 * 16), GT_Utility.getIntegratedCircuit(11))
            .itemOutputs(
                Materials.Potassiumdichromate.getDust(64), Materials.Potassiumdichromate.getDust(64), Materials.Potassiumdichromate.getDust(48))
            .fluidInputs(
                Materials.Oxygen.getGas(6000 * 16))
            .fluidOutputs(
                Materials.NitricOxide.getGas(2000 * 16), Materials.Oxygen.getGas(3000 * 16))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                Materials.Saltpeter.getDust(64), Materials.Saltpeter.getDust(64), Materials.Saltpeter.getDust(32), Materials.Chrome.getDust(2 * 16), GT_Utility.getIntegratedCircuit(11))
            .itemOutputs(
                Materials.Potassiumdichromate.getDust(64), Materials.Potassiumdichromate.getDust(64), Materials.Potassiumdichromate.getDust(48))
            .fluidInputs(
                Materials.Oxygen.getGas(6000 * 16))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Benzene.getFluid(1000), Materials.Methane.getGas(2000))
            .fluidOutputs(
                Materials.Dimethylbenzene.getFluid(1000), Materials.Hydrogen.getGas(4000))
            .duration(3 * MINUTES + 20 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.crushedPurified, Materials.Galena, 3), GT_OreDictUnificator.get(OrePrefixes.crushedPurified, Materials.Sphalerite, 1))
            .noItemOutputs()
            .fluidInputs(
                Materials.SulfuricAcid.getFluid(4000))
            .fluidOutputs(
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(8), GT_OreDictUnificator.get(OrePrefixes.crushedPurified, Materials.Galena, 27), GT_OreDictUnificator.get(OrePrefixes.crushedPurified, Materials.Sphalerite, 9))
            .noItemOutputs()
            .fluidInputs(
                Materials.SulfuricAcid.getFluid(36000))
            .fluidOutputs(
                new FluidStack(ItemList.sIndiumConcentrate, 72000))
            .duration(8 * SECONDS)
            .eut(TierEU.RECIPE_HV)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.crushedPurified, Materials.Pentlandite, 9))
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.PlatinumGroupSludge, 1))
            .fluidInputs(
                Materials.SulfuricAcid.getFluid(9000))
            .fluidOutputs(
                new FluidStack(ItemList.sNickelSulfate, 18000))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.crushedPurified, Materials.Chalcopyrite, 9))
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.PlatinumGroupSludge, 1))
            .fluidInputs(
                Materials.SulfuricAcid.getFluid(9000))
            .fluidOutputs(
                new FluidStack(ItemList.sBlueVitriol, 18000))
            .duration(1 * SECONDS + 5 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Plutonium, 64), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Uranium, 1), GT_Utility.getIntegratedCircuit(8))
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Plutonium, 64))
            .fluidInputs(
                Materials.Air.getGas(8000))
            .fluidOutputs(
                Materials.Radon.getGas(800))
            .duration(1 * MINUTES + 15 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminium, 4))
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silicon, 3), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 10))
            .noFluidInputs()
            .noFluidOutputs()
            .duration(10 * TICKS)
            .eut(TierEU.RECIPE_MV)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silicon, 10))
            .noItemOutputs()
            .fluidInputs(
                Materials.HydrochloricAcid.getFluid(30000))
            .fluidOutputs(
                Materials.Trichlorosilane.getFluid(9000), Materials.SiliconTetrachloride.getFluid(300), Materials.Hexachlorodisilane.getFluid(200), Materials.Dichlorosilane.getGas(300), Materials.Hydrogen.getGas(20400))
            .duration(7 * SECONDS + 10 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Hydrogen.getGas(4000), Materials.Propene.getGas(2000), Materials.CarbonMonoxide.getGas(2000))
            .fluidOutputs(
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(9), MaterialsKevlar.OrganorhodiumCatalyst.getDust(1))
            .noItemOutputs()
            .fluidInputs(
                Materials.Hydrogen.getGas(36000), Materials.Propene.getGas(18000), Materials.CarbonMonoxide.getGas(18000))
            .fluidOutputs(
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(2), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silver, 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 1))
            .noItemOutputs()
            .fluidInputs(
                Materials.Ethylene.getGas(1000), Materials.Oxygen.getGas(1000))
            .fluidOutputs(
                MaterialsKevlar.EthyleneOxide.getGas(1000))
            .duration(2 * SECONDS + 10 * TICKS)
            .eut(TierEU.RECIPE_HV)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(8), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silver, 9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 9))
            .noItemOutputs()
            .fluidInputs(
                Materials.Ethylene.getGas(9000), Materials.Oxygen.getGas(9000))
            .fluidOutputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                MaterialsKevlar.EthyleneOxide.getGas(1000), Materials.Dimethyldichlorosilane.getFluid(4000), Materials.Water.getFluid(5000))
            .fluidOutputs(
                MaterialsKevlar.SiliconOil.getFluid(5000))
            .duration(15 * TICKS)
            .eut(TierEU.RECIPE_EV)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                MaterialsKevlar.EthyleneOxide.getGas(9000), Materials.Dimethyldichlorosilane.getFluid(36000), Materials.Water.getFluid(45000))
            .fluidOutputs(
                MaterialsKevlar.SiliconOil.getFluid(45000))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(10), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 1))
            .noItemOutputs()
            .fluidInputs(
                Materials.Methanol.getFluid(1000), Materials.Ammonia.getGas(1000))
            .fluidOutputs(
                MaterialsKevlar.Methylamine.getGas(1000), Materials.Water.getFluid(1000))
            .duration(1 * MINUTES + 15 * SECONDS)
            .eut(500000)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.KevlarCatalyst, 1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.Pentaerythritol, 1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.DiphenylmethaneDiisocyanate, 5))
            .noItemOutputs()
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.KevlarCatalyst, 9), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.Pentaerythritol, 9), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.DiphenylmethaneDiisocyanate, 45))
            .noItemOutputs()
            .fluidInputs(
                MaterialsKevlar.Ethyleneglycol.getFluid(36000), MaterialsKevlar.SiliconOil.getFluid(9000))
            .fluidOutputs(
                MaterialsKevlar.PolyurethaneResin.getFluid(9000))
            .duration(1 * MINUTES + 15 * SECONDS)
            .eut(500000)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(3), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 1))
            .noItemOutputs()
            .fluidInputs(
                Materials.Methanol.getFluid(6000), Materials.Ammonia.getGas(3000))
            .fluidOutputs(
                MaterialsKevlar.Methylamine.getGas(1000), Materials.Dimethylamine.getGas(1000), MaterialsKevlar.Trimethylamine.getGas(1000), Materials.Water.getFluid(6000))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(11), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 9))
            .noItemOutputs()
            .fluidInputs(
                Materials.Methanol.getFluid(54000), Materials.Ammonia.getGas(27000))
            .fluidOutputs(
                MaterialsKevlar.Methylamine.getGas(9000), Materials.Dimethylamine.getGas(9000), MaterialsKevlar.Trimethylamine.getGas(9000), Materials.Water.getFluid(54000))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.TerephthaloylChloride, 64), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.TerephthaloylChloride, 48))
            .fluidInputs(
                MaterialsKevlar.ThionylChloride.getFluid(18000), MaterialsKevlar.DimethylTerephthalate.getFluid(5000), Materials.CarbonDioxide.getGas(6000))
            .fluidOutputs(
                Materials.DilutedHydrochloricAcid.getFluid(22000), Materials.SulfurDioxide.getGas(18000))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                MaterialsKevlar.TerephthalicAcid.getFluid(1000), Materials.Methanol.getFluid(2000), Materials.SulfuricAcid.getFluid(2000))
            .fluidOutputs(
                MaterialsKevlar.DimethylTerephthalate.getFluid(1000), Materials.DilutedSulfuricAcid.getFluid(2000))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                MaterialsKevlar.TerephthalicAcid.getFluid(9000), Materials.Methanol.getFluid(18000), Materials.SulfuricAcid.getFluid(18000))
            .fluidOutputs(
                MaterialsKevlar.DimethylTerephthalate.getFluid(9000), Materials.DilutedSulfuricAcid.getFluid(18000))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Benzene.getFluid(1000), Materials.Methane.getGas(2000))
            .fluidOutputs(
                MaterialsKevlar.IIIDimethylbenzene.getFluid(1000), Materials.Hydrogen.getGas(4000))
            .duration(3 * MINUTES + 20 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Benzene.getFluid(1000), Materials.Methane.getGas(2000))
            .fluidOutputs(
                MaterialsKevlar.IVDimethylbenzene.getFluid(1000), Materials.Hydrogen.getGas(4000))
            .duration(3 * MINUTES + 20 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.CobaltIIHydroxide, 45))
            .itemOutputs(
                MaterialsKevlar.CobaltIINaphthenate.getDust(64), MaterialsKevlar.CobaltIINaphthenate.getDust(64), MaterialsKevlar.CobaltIINaphthenate.getDust(64), MaterialsKevlar.CobaltIINaphthenate.getDust(64), MaterialsKevlar.CobaltIINaphthenate.getDust(64), MaterialsKevlar.CobaltIINaphthenate.getDust(49))
            .fluidInputs(
                MaterialsKevlar.NaphthenicAcid.getFluid(10000))
            .noFluidOutputs()
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.CobaltIIAcetate, 64), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.CobaltIIAcetate, 64), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.CobaltIIAcetate, 7))
            .itemOutputs(
                MaterialsKevlar.CobaltIINaphthenate.getDust(64), MaterialsKevlar.CobaltIINaphthenate.getDust(64), MaterialsKevlar.CobaltIINaphthenate.getDust(64), MaterialsKevlar.CobaltIINaphthenate.getDust(64), MaterialsKevlar.CobaltIINaphthenate.getDust(64), MaterialsKevlar.CobaltIINaphthenate.getDust(49))
            .fluidInputs(
                MaterialsKevlar.NaphthenicAcid.getFluid(10000))
            .fluidOutputs(
                Materials.AceticAcid.getFluid(15000))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium, 6))
            .itemOutputs(
                MaterialsKevlar.Triphenylphosphene.getDust(34), Materials.Salt.getDust(12))
            .fluidInputs(
                MaterialsKevlar.PhosphorusTrichloride.getFluid(1000), Materials.Chlorobenzene.getFluid(3000))
            .noFluidOutputs()
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(1), MaterialsKevlar.SodiumHydride.getDust(8))
            .itemOutputs(
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(9), MaterialsKevlar.SodiumHydride.getDust(64))
            .itemOutputs(
                MaterialsKevlar.SodiumBorohydride.getDust(48), MaterialsKevlar.SodiumMethoxide.getDust(64), MaterialsKevlar.SodiumMethoxide.getDust(64), MaterialsKevlar.SodiumMethoxide.getDust(16))
            .fluidInputs(
                MaterialsKevlar.TrimethylBorate.getFluid(8000))
            .noFluidOutputs()
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidOutputs(
                Materials.Acetone.getFluid(1000), Materials.CarbonDioxide.getGas(1000), Materials.Water.getFluid(1000))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                Materials.Carbon.getDust(1), GT_Utility.getIntegratedCircuit(23))
            .noItemOutputs()
            .fluidInputs(
                Materials.Hydrogen.getGas(4000), Materials.Oxygen.getGas(1000))
            .fluidOutputs(
                Materials.Methanol.getFluid(1000))
            .duration(16 * SECONDS)
            .eut(96)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                Materials.Carbon.getDust(2), GT_Utility.getIntegratedCircuit(24))
            .noItemOutputs()
            .fluidInputs(
                Materials.Hydrogen.getGas(4000), Materials.Oxygen.getGas(2000))
            .fluidOutputs(
                Materials.AceticAcid.getFluid(1000))
            .duration(24 * SECONDS)
            .eut(30)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.CarbonMonoxide.getGas(2000), Materials.Hydrogen.getGas(4000))
            .fluidOutputs(
                Materials.AceticAcid.getFluid(1000))
            .duration(16 * SECONDS)
            .eut(30)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Hydrogen.getGas(9000), Materials.Chlorine.getGas(9000))
            .fluidOutputs(
                Materials.HydrochloricAcid.getFluid(9000))
            .duration(7 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidOutputs(
                Materials.HypochlorousAcid.getFluid(10000), Materials.Hydrogen.getGas(10000))
            .duration(30 * SECONDS)
            .eut(8)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                Materials.SodiumHydroxide.getDust(3), GT_Utility.getIntegratedCircuit(23))
            .noItemOutputs()
            .fluidInputs(
                Materials.Propene.getGas(1000), Materials.Chlorine.getGas(4000), Materials.Water.getFluid(1000))
            .fluidOutputs(
                Materials.Epichlorohydrin.getFluid(1000), Materials.SaltWater.getFluid(1000), Materials.HydrochloricAcid.getFluid(2000))
            .duration(32 * SECONDS)
            .eut(30)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                Materials.SodiumHydroxide.getDust(3), GT_Utility.getIntegratedCircuit(24))
            .noItemOutputs()
            .fluidInputs(
                Materials.Propene.getGas(1000), Materials.Chlorine.getGas(2000), Materials.Water.getFluid(1000), Materials.Mercury.getFluid(100))
            .fluidOutputs(
                Materials.Epichlorohydrin.getFluid(1000), Materials.SaltWater.getFluid(1000), Materials.Hydrogen.getGas(2000))
            .duration(32 * SECONDS)
            .eut(30)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Propene.getGas(1000), Materials.Chlorine.getGas(2000), Materials.HypochlorousAcid.getFluid(1000))
            .fluidOutputs(
                Materials.Epichlorohydrin.getFluid(1000), Materials.SaltWater.getFluid(1000), Materials.HydrochloricAcid.getFluid(1000))
            .duration(32 * SECONDS)
            .eut(30)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                Materials.Apatite.getDust(9))
            .itemOutputs(
                Materials.Gypsum.getDust(40))
            .fluidInputs(
                Materials.SulfuricAcid.getFluid(5000), Materials.Water.getFluid(10000))
            .fluidOutputs(
                Materials.PhosphoricAcid.getFluid(3000), Materials.HydrochloricAcid.getFluid(1000))
            .duration(16 * SECONDS)
            .eut(30)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                Materials.Phosphorus.getDust(4), GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(
                Materials.PhosphorousPentoxide.getDust(14))
            .fluidInputs(
                Materials.Oxygen.getGas(10000))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                Materials.Phosphorus.getDust(1), GT_Utility.getIntegratedCircuit(24))
            .noItemOutputs()
            .fluidInputs(
                Materials.Oxygen.getGas(2500), Materials.Water.getFluid(1500))
            .fluidOutputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Propene.getGas(8000), Materials.Benzene.getFluid(8000), Materials.PhosphoricAcid.getFluid(1000))
            .fluidOutputs(
                Materials.Cumene.getFluid(8000))
            .duration(1 * MINUTES + 36 * SECONDS)
            .eut(30)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Propene.getGas(1000), Materials.Benzene.getFluid(1000), Materials.PhosphoricAcid.getFluid(100), Materials.Oxygen.getGas(2000))
            .fluidOutputs(
                Materials.Phenol.getFluid(1000), Materials.Acetone.getFluid(1000))
            .duration(24 * SECONDS)
            .eut(30)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Acetone.getFluid(1000), Materials.Phenol.getFluid(2000), Materials.HydrochloricAcid.getFluid(1000))
            .fluidOutputs(
                Materials.BisphenolA.getFluid(1000), Materials.Water.getFluid(1000))
            .duration(8 * SECONDS)
            .eut(30)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                Materials.SodiumHydroxide.getDust(6), GT_Utility.getIntegratedCircuit(24))
            .noItemOutputs()
            .fluidInputs(
                Materials.Acetone.getFluid(1000), Materials.Phenol.getFluid(2000), Materials.HydrochloricAcid.getFluid(1000), Materials.Epichlorohydrin.getFluid(2000))
            .fluidOutputs(
                Materials.Epoxid.getMolten(1000), Materials.SaltWater.getFluid(2000))
            .duration(24 * SECONDS)
            .eut(30)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Hydrogen.getGas(9000), Materials.Fluorine.getGas(9000))
            .fluidOutputs(
                Materials.HydrofluoricAcid.getFluid(9000))
            .duration(7 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.HydrofluoricAcid.getFluid(4000), Materials.Methane.getGas(2000), Materials.Chlorine.getGas(12000))
            .fluidOutputs(
                Materials.Tetrafluoroethylene.getGas(1000), Materials.HydrochloricAcid.getFluid(12000))
            .duration(27 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                Materials.Silicon.getDust(1), GT_Utility.getIntegratedCircuit(24))
            .itemOutputs(
                Materials.Polydimethylsiloxane.getDust(3))
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                Materials.Polydimethylsiloxane.getDust(3))
            .fluidInputs(
                Materials.Methanol.getFluid(2000), Materials.HydrochloricAcid.getFluid(2000))
            .fluidOutputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Nitrogen.getGas(10000), Materials.Hydrogen.getGas(30000))
            .fluidOutputs(
                Materials.Ammonia.getGas(10000))
            .duration(40 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Ammonia.getGas(2000), Materials.Oxygen.getGas(7000))
            .fluidOutputs(
                Materials.DinitrogenTetroxide.getGas(1000), Materials.Water.getFluid(3000))
            .duration(24 * SECONDS)
            .eut(30)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Oxygen.getGas(100000), Materials.Ammonia.getGas(36000))
            .fluidOutputs(
                Materials.NitricOxide.getGas(36000), Materials.Water.getFluid(54000))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Oxygen.getGas(100000), Materials.Ammonia.getGas(36000))
            .fluidOutputs(
                Materials.NitricOxide.getGas(36000))
            .duration(8 * SECONDS + 10 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.NitricOxide.getGas(9000), Materials.Oxygen.getGas(9000))
            .fluidOutputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.NitrogenDioxide.getGas(27000), Materials.Water.getFluid(9000))
            .fluidOutputs(
                Materials.NitricAcid.getFluid(18000), Materials.NitricOxide.getGas(9000))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidOutputs(
                Materials.NitricAcid.getFluid(1000), Materials.Water.getFluid(1000))
            .duration(16 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Ammonia.getGas(1000), Materials.Oxygen.getGas(4000))
            .fluidOutputs(
                Materials.NitricAcid.getFluid(1000), Materials.Water.getFluid(1000))
            .duration(16 * SECONDS)
            .eut(30)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.NitrogenDioxide.getGas(2000), Materials.Oxygen.getGas(1000), Materials.Water.getFluid(1000))
            .fluidOutputs(
                Materials.NitricAcid.getFluid(2000))
            .duration(16 * SECONDS)
            .eut(30)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(9), Materials.Sulfur.getDust(9))
            .noItemOutputs()
            .fluidInputs(
                Materials.Hydrogen.getGas(18000))
            .fluidOutputs(
                Materials.HydricSulfide.getGas(9000))
            .duration(4 * TICKS)
            .eut(TierEU.RECIPE_MV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.HydricSulfide.getGas(9000), Materials.Oxygen.getGas(27000))
            .fluidOutputs(
                Materials.SulfurDioxide.getGas(9000), Materials.Water.getFluid(9000))
            .duration(3 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                Materials.Sulfur.getDust(27))
            .fluidInputs(
                Materials.SulfurDioxide.getGas(9000), Materials.HydricSulfide.getGas(18000))
            .noFluidOutputs()
            .duration(3 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.SulfurTrioxide.getGas(9000), Materials.Water.getFluid(9000))
            .fluidOutputs(
                Materials.SulfuricAcid.getFluid(9000))
            .duration(13 * SECONDS)
            .eut(TierEU.RECIPE_HV)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(24), Materials.Sulfur.getDust(1))
            .noItemOutputs()
            .fluidInputs(
                Materials.Oxygen.getGas(3000), Materials.Water.getFluid(1000))
            .fluidOutputs(
                Materials.SulfuricAcid.getFluid(1000))
            .duration(24 * SECONDS)
            .eut(30)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(7), Materials.Sulfur.getDust(9))
            .noItemOutputs()
            .fluidInputs(
                Materials.Oxygen.getGas(27000), Materials.Water.getFluid(9000))
            .fluidOutputs(
                Materials.SulfuricAcid.getFluid(9000))
            .duration(13 * SECONDS)
            .eut(TierEU.RECIPE_HV)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.HydricSulfide.getGas(1000), Materials.Oxygen.getGas(4000))
            .fluidOutputs(
                Materials.SulfuricAcid.getFluid(1000))
            .duration(24 * SECONDS)
            .eut(30)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.HydrochloricAcid.getFluid(1000), Materials.Ethylene.getGas(1000), Materials.Oxygen.getGas(1000))
            .fluidOutputs(
                Materials.VinylChloride.getGas(1000), Materials.Water.getFluid(1000))
            .duration(8 * SECONDS)
            .eut(30)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidOutputs(
                Materials.VinylChloride.getGas(2000), Materials.Water.getFluid(1000))
            .duration(12 * SECONDS)
            .eut(30)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(2))
            .itemOutputs(
                Materials.RawRubber.getDust(18))
            .fluidInputs(
                Materials.Isoprene.getFluid(1728), Materials.Air.getGas(6000), Materials.Titaniumtetrachloride.getFluid(80))
            .noFluidOutputs()
            .duration(32 * SECONDS)
            .eut(30)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(2))
            .itemOutputs(
                Materials.RawRubber.getDust(24))
            .fluidInputs(
                Materials.Isoprene.getFluid(1728), Materials.Oxygen.getGas(6000), Materials.Titaniumtetrachloride.getFluid(80))
            .noFluidOutputs()
            .duration(32 * SECONDS)
            .eut(30)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(3))
            .itemOutputs(
                Materials.RawStyreneButadieneRubber.getDust(3))
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Styrene.getFluid(540), Materials.Butadiene.getGas(1620), Materials.Titaniumtetrachloride.getFluid(100), Materials.Air.getGas(15000))
            .noFluidOutputs()
            .duration(32 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(4))
            .itemOutputs(
                Materials.RawStyreneButadieneRubber.getDust(30))
            .fluidInputs(
                Materials.Styrene.getFluid(540), Materials.Butadiene.getGas(1620), Materials.Titaniumtetrachloride.getFluid(100), Materials.Oxygen.getGas(7500))
            .noFluidOutputs()
            .duration(32 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(9), Materials.Salt.getDust(18))
            .itemOutputs(
                Materials.SodiumBisulfate.getDust(63))
            .fluidInputs(
                Materials.SulfuricAcid.getFluid(9000))
            .fluidOutputs(
                Materials.HydrochloricAcid.getFluid(9000))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_Utility.getIntegratedCircuit(9), Materials.SodiumHydroxide.getDust(27))
            .itemOutputs(
                Materials.SodiumBisulfate.getDust(63))
            .fluidInputs(
                Materials.SulfuricAcid.getFluid(9000))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidOutputs(
                Materials.Phenol.getFluid(1000), Materials.HydrochloricAcid.getFluid(1000), Materials.DilutedHydrochloricAcid.getFluid(1000))
            .duration(28 * SECONDS)
            .eut(30)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Benzene.getFluid(2000), Materials.Chlorine.getGas(4000))
            .fluidOutputs(
                Materials.Phenol.getFluid(2000), Materials.HydrochloricAcid.getFluid(2000))
            .duration(56 * SECONDS)
            .eut(30)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.LightFuel.getFluid(20000), Materials.HeavyFuel.getFluid(4000))
            .fluidOutputs(
                Materials.Fuel.getFluid(24000))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Fuel.getFluid(10000), Materials.Tetranitromethane.getFluid(200))
            .fluidOutputs(
                Materials.NitroFuel.getFluid(10000))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.BioDiesel.getFluid(10000), Materials.Tetranitromethane.getFluid(400))
            .fluidOutputs(
                Materials.NitroFuel.getFluid(9000))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Methane.getGas(5000), GT_ModHandler.getDistilledWater(10000))
            .fluidOutputs(
                Materials.CarbonDioxide.getGas(5000), Materials.Hydrogen.getGas(40000))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Methane.getGas(5000), GT_ModHandler.getDistilledWater(5000))
            .fluidOutputs(
                Materials.CarbonMonoxide.getGas(5000), Materials.Hydrogen.getGas(30000))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Nitrogen.getGas(20000), Materials.Oxygen.getGas(10000))
            .fluidOutputs(
                Materials.NitrousOxide.getGas(10000))
            .duration(2 * SECONDS + 10 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Naphtha.getFluid(16000), Materials.Gas.getGas(2000), Materials.Methanol.getFluid(1000), Materials.Acetone.getFluid(1000))
            .fluidOutputs(
                Materials.GasolineRaw.getFluid(20000))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.GasolineRaw.getFluid(10000), Materials.Toluene.getFluid(1000))
            .fluidOutputs(
                Materials.GasolineRegular.getFluid(11000))
            .duration(10 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.GasolineRegular.getFluid(20000), Materials.Octane.getFluid(2000), Materials.NitrousOxide.getGas(6000), Materials.Toluene.getFluid(1000), Materials.AntiKnock.getFluid(3000))
            .fluidOutputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Ethanol.getFluid(1000), Materials.Butene.getGas(1000))
            .fluidOutputs(
                Materials.AntiKnock.getFluid(1000))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Methanol.getFluid(1000), Materials.Butene.getGas(1000))
            .fluidOutputs(
                Materials.MTBEMixture.getGas(1000))
            .duration(20 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(sMultiblockChemicalRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Naquadria.getMolten(4608), Materials.ElectrumFlux.getMolten(4608), Materials.Radon.getGas(16000))
            .fluidOutputs(
                Materials.EnrichedNaquadria.getFluid(9216))
            .duration(30 * SECONDS)
            .eut(500000)
            .addTo(sMultiblockChemicalRecipes);
        ...
        if (GTNHLanthanides.isModLoaded() && GTPlusPlus.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .noItemOutputs()
                .fluidInputs(
                    new FluidStack(FluidRegistry.getFluid("formaldehyde"), 1000), new FluidStack(FluidRegistry.getFluid("aniline"), 2000), Materials.HydrochloricAcid.getFluid(1000))
                .fluidOutputs(
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Palladium, 1))
                .noItemOutputs()
                .fluidInputs(
            ...
            GT_Values.RA.stdBuilder()
                ...
                .noItemOutputs()
                .fluidInputs(
                    Materials.Benzene.getFluid(5000), Materials.SulfuricAcid.getFluid(3000), Materials.NitricAcid.getFluid(5000), GT_ModHandler.getDistilledWater(10000))
                .fluidOutputs(
                    new FluidStack(FluidRegistry.getFluid("nitrobenzene"), 5000), Materials.DilutedSulfuricAcid.getFluid(3000))
                .duration(8 * TICKS)
            ...
            GT_Values.RA.stdBuilder()
                ...
                .noItemOutputs()
                .fluidInputs(
                    MaterialsKevlar.DiaminodiphenylmethanMixture.getFluid(1000), new FluidStack(FluidRegistry.getFluid("phosgene"), 2000))
                .fluidOutputs(
                    MaterialsKevlar.DiphenylmethaneDiisocyanateMixture.getFluid(1000))
                .duration(30 * SECONDS)
                .eut(TierEU.RECIPE_EV)
                .addTo(sMultiblockChemicalRecipes);
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Palladium, 1))
                .noItemOutputs()
                .fluidInputs(
                    MaterialsKevlar.Butyraldehyde.getFluid(9000), Materials.Hydrogen.getGas(18000))
                .fluidOutputs(
                    new FluidStack(FluidRegistry.getFluid("butanol"), 9000))
                .duration(4 * SECONDS)
                .eut(TierEU.RECIPE_HV)
                .addTo(sMultiblockChemicalRecipes);
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Tin, 1))
                .itemOutputs(
                    GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.KevlarCatalyst, 1))
                .fluidInputs(
                    new FluidStack(FluidRegistry.getFluid("butanol"), 2000), new FluidStack(FluidRegistry.getFluid("propionicacid"), 1000), Materials.IronIIIChloride.getFluid(100))
                .noFluidOutputs()
                .duration(30 * SECONDS)
                .eut(TierEU.RECIPE_EV)
                .addTo(sMultiblockChemicalRecipes);
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Tin, 9))
                .itemOutputs(
                    GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.KevlarCatalyst, 9))
                .fluidInputs(
                    new FluidStack(FluidRegistry.getFluid("butanol"), 18000), new FluidStack(FluidRegistry.getFluid("propionicacid"), 9000), Materials.IronIIIChloride.getFluid(900))
                .noFluidOutputs()
            ...
            GT_Values.RA.stdBuilder()
                ...
                .noItemOutputs()
                .fluidInputs(
                    Materials.Ethylene.getGas(1000), Materials.CarbonMonoxide.getGas(1000), MaterialsKevlar.NickelTetracarbonyl.getFluid(100), Materials.Water.getFluid(1000))
                .fluidOutputs(
            ...
            GT_Values.RA.stdBuilder()
                ...
                .noItemOutputs()
                .fluidInputs(
                    Materials.Ethylene.getGas(9000), Materials.CarbonMonoxide.getGas(9000), MaterialsKevlar.NickelTetracarbonyl.getFluid(900), Materials.Water.getFluid(9000))
                .fluidOutputs(
            ...
            GT_Values.RA.stdBuilder()
                ...
                .noItemOutputs()
                .fluidInputs(
                    new FluidStack(FluidRegistry.getFluid("aniline"), 1000), new FluidStack(FluidRegistry.getFluid("molten.aceticanhydride"), 100), Materials.NitrationMixture.getFluid(2000))
                .fluidOutputs(
                    MaterialsKevlar.IVNitroaniline.getFluid(1000), Materials.DilutedSulfuricAcid.getFluid(1000))
                .duration(15 * SECONDS)
                .eut(TierEU.RECIPE_EV)
                .addTo(sMultiblockChemicalRecipes);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .noItemOutputs()
                .fluidInputs(
                    new FluidStack(FluidRegistry.getFluid("aniline"), 9000), new FluidStack(FluidRegistry.getFluid("molten.aceticanhydride"), 900), Materials.NitrationMixture.getFluid(18000))
                .fluidOutputs(
                    MaterialsKevlar.IVNitroaniline.getFluid(9000), Materials.DilutedSulfuricAcid.getFluid(9000))
                .duration(1 * MINUTES + 40 * SECONDS)
                .eut(TierEU.RECIPE_EV)
                .addTo(sMultiblockChemicalRecipes);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    Materials.NitrogenDioxide.getGas(100), Materials.Hydrogen.getGas(6000), MaterialsKevlar.IVNitroaniline.getFluid(1000))
                .fluidOutputs(
                    Materials.Water.getFluid(2000))
                .duration(20 * SECONDS)
                .eut(500000)
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Copper, 1))
                .noItemOutputs()
                .fluidInputs(
                    new FluidStack(FluidRegistry.getFluid("1,4-butanediol"), 1000))
                .fluidOutputs(
                    MaterialsKevlar.GammaButyrolactone.getFluid(1000), Materials.Hydrogen.getGas(4000))
                .duration(5 * SECONDS)
                .eut(TierEU.RECIPE_EV)
                .addTo(sMultiblockChemicalRecipes);
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Copper, 9))
                .noItemOutputs()
                .fluidInputs(
                    new FluidStack(FluidRegistry.getFluid("1,4-butanediol"), 9000))
                .fluidOutputs(
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.CupricOxide, 1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.BismuthIIIOxide, 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 1))
                .itemOutputs(
                    GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IIButinIIVdiol, 12))
                .fluidInputs(
                    MaterialsKevlar.Acetylene.getGas(1000), new FluidStack(FluidRegistry.getFluid("formaldehyde"), 2000))
                .noFluidOutputs()
                .duration(20 * SECONDS)
                .eut(TierEU.RECIPE_EV)
                .addTo(sMultiblockChemicalRecipes);
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    GT_Utility.getIntegratedCircuit(9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.CupricOxide, 9), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.BismuthIIIOxide, 9), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 9))
                .itemOutputs(
                    GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IIButinIIVdiol, 64), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IIButinIIVdiol, 44))
                .fluidInputs(
                    MaterialsKevlar.Acetylene.getGas(9000), new FluidStack(FluidRegistry.getFluid("formaldehyde"), 18000))
                .noFluidOutputs()
                .duration(2 * MINUTES + 30 * SECONDS)
                .eut(TierEU.RECIPE_EV)
                .addTo(sMultiblockChemicalRecipes);
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.IIButinIIVdiol, 12), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.RaneyNickelActivated, 1))
                .noItemOutputs()
                .fluidInputs(
                    Materials.Hydrogen.getGas(4000))
                .fluidOutputs(
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    GT_Utility.getIntegratedCircuit(1), getModItem(GTPlusPlus.modID, "itemDustCalciumChloride", 1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.ParaPhenylenediamine, 9), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.TerephthaloylChloride, 9))
                .noItemOutputs()
                .fluidInputs(
                    MaterialsKevlar.NMethylIIPyrrolidone.getFluid(1000))
                .fluidOutputs(
                    MaterialsKevlar.LiquidCrystalKevlar.getFluid(9000), Materials.DilutedHydrochloricAcid.getFluid(2000))
                .duration(30 * SECONDS)
                .eut(500000)
                .addTo(sMultiblockChemicalRecipes);
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    GT_Utility.getIntegratedCircuit(9), getModItem(GTPlusPlus.modID, "itemDustCalciumChloride", 7), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.ParaPhenylenediamine, 63), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.TerephthaloylChloride, 63))
                .noItemOutputs()
                .fluidInputs(
                    MaterialsKevlar.NMethylIIPyrrolidone.getFluid(7000))
                .fluidOutputs(
                    MaterialsKevlar.LiquidCrystalKevlar.getFluid(63000), Materials.DilutedHydrochloricAcid.getFluid(14000))
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Borax, 23))
                .itemOutputs(
                    Materials.Salt.getDust(4))
                .fluidInputs(
                    Materials.HydrochloricAcid.getFluid(2000))
                .fluidOutputs(
                    new FluidStack(FluidRegistry.getFluid("boricacid"), 4000), Materials.Water.getFluid(5000))
                .duration(40 * SECONDS)
                .eut(TierEU.RECIPE_HV)
                .addTo(sMultiblockChemicalRecipes);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .noItemOutputs()
                .fluidInputs(
                    Materials.Methanol.getFluid(3000), new FluidStack(FluidRegistry.getFluid("boricacid"), 1000), Materials.SulfuricAcid.getFluid(6000))
                .fluidOutputs(
                    Materials.DilutedSulfuricAcid.getFluid(6000), MaterialsKevlar.TrimethylBorate.getFluid(1000))
                .duration(30 * SECONDS)
                .eut(TierEU.RECIPE_EV)
                .addTo(sMultiblockChemicalRecipes);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .noItemOutputs()
                .fluidInputs(
                    Materials.Methanol.getFluid(27000), new FluidStack(FluidRegistry.getFluid("boricacid"), 9000), Materials.SulfuricAcid.getFluid(54000))
                .fluidOutputs(
                    Materials.DilutedSulfuricAcid.getFluid(54000), MaterialsKevlar.TrimethylBorate.getFluid(9000))
                .duration(3 * MINUTES + 45 * SECONDS)
                .eut(TierEU.RECIPE_EV)
                .addTo(sMultiblockChemicalRecipes);
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    GT_Utility.getIntegratedCircuit(1), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.RhodiumChloride, 4), MaterialsKevlar.Triphenylphosphene.getDust(64), MaterialsKevlar.Triphenylphosphene.getDust(38), MaterialsKevlar.SodiumBorohydride.getDust(18))
                .itemOutputs(
                    MaterialsKevlar.OrganorhodiumCatalyst.getDust(64), MaterialsKevlar.OrganorhodiumCatalyst.getDust(42), Materials.Salt.getDust(6), Materials.Boron.getDust(3))
                .fluidInputs(
                    Materials.CarbonMonoxide.getGas(1000))
                .fluidOutputs(
                    Materials.Hydrogen.getGas(11000))
                .duration(40 * SECONDS)
                .eut(500000)
                .addTo(sMultiblockChemicalRecipes);
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    GT_Utility.getIntegratedCircuit(9), Materials.SodiumHydroxide.getDust(6), Materials.Manganese.getDustTiny(1))
                .itemOutputs(
                    MaterialsKevlar.SodiumHydride.getDust(4))
                .fluidInputs(
                    new FluidStack(FluidRegistry.getFluid("hydrazine"), 1000))
                .fluidOutputs(
                    Materials.Nitrogen.getGas(2000), Materials.Water.getFluid(2000))
                .duration(10 * TICKS)
                .eut(TierEU.RECIPE_EV)
                .addTo(sMultiblockChemicalRecipes);
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    GT_Utility.getIntegratedCircuit(18), Materials.SodiumHydroxide.getDust(54), Materials.Manganese.getDust(1))
                .itemOutputs(
                    MaterialsKevlar.SodiumHydride.getDust(36))
                .fluidInputs(
                    new FluidStack(FluidRegistry.getFluid("hydrazine"), 9000))
                .fluidOutputs(
                    Materials.Nitrogen.getGas(18000), Materials.Water.getFluid(18000))
