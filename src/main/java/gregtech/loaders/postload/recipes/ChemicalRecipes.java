...
public class ChemicalRecipes implements Runnable {
    ...
    public void registerBoth() {
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Glyceryl.getFluid(1 * HALF_BUCKETS))
            .duration(8 * SECONDS)
            .eut(4)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.HydrochloricAcid.getFluid(3 * BUCKETS))
            .fluidOutputs(Materials.IronIIIChloride.getFluid(1 * BUCKETS))
            .duration(20 * SECONDS)
            .eut(30)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(new FluidStack(FluidRegistry.getFluid("ic2coolant"), 1 * BUCKETS))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.GrowthMediumSterilized.getFluid(1 * BUCKETS))
            .fluidOutputs(getFluidStack("bacterialsludge", 1 * BUCKETS))
            .duration(30 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.BioMediumSterilized.getFluid(2 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Hydrogen.getGas(1 * QUARTER_BUCKETS))
            .fluidOutputs(Materials.HydricSulfide.getGas(1 * EIGHT_BUCKETS))
            .duration(1 * SECONDS)
            .eut(TierEU.RECIPE_LV)
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                GTOreDictUnificator.get(OrePrefixes.cell, Materials.HydricSulfide, 1),
                Materials.Empty.getCells(1))
            .fluidInputs(Materials.SulfuricNaphtha.getFluid(12 * BUCKETS))
            .fluidOutputs(Materials.Naphtha.getFluid(12 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Hydrogen.getGas(1 * HALF_BUCKETS))
            .fluidOutputs(Materials.HydricSulfide.getGas(1 * QUARTER_BUCKETS))
            .duration(2 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                GTOreDictUnificator.get(OrePrefixes.cell, Materials.HydricSulfide, 1),
                Materials.Empty.getCells(1))
            .fluidInputs(Materials.SulfuricLightFuel.getFluid(12 * BUCKETS))
            .fluidOutputs(Materials.LightFuel.getFluid(12 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                GTOreDictUnificator.get(OrePrefixes.cell, Materials.HydricSulfide, 1),
                Materials.Empty.getCells(1))
            .fluidInputs(Materials.SulfuricHeavyFuel.getFluid(8 * BUCKETS))
            .fluidOutputs(Materials.HeavyFuel.getFluid(8 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        for (Fluid tFluid : new Fluid[] { FluidRegistry.WATER, GTModHandler.getDistilledWater(1L)
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(new FluidStack(tFluid, 1 * BUCKETS))
                .duration(10 * SECONDS)
                .eut(TierEU.RECIPE_LV)
                .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                GTOreDictUnificator.get(OrePrefixes.dust, Materials.Sodium, 1))
            .itemOutputs(GTOreDictUnificator.get(OrePrefixes.gem, Materials.NetherQuartz, 3))
            .fluidInputs(GTModHandler.getDistilledWater(1 * BUCKETS))
            .duration(25 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Chlorine.getGas(4 * BUCKETS))
            .fluidOutputs(Materials.Titaniumtetrachloride.getFluid(1 * BUCKETS))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Chlorine.getGas(4 * BUCKETS))
            .fluidOutputs(
                Materials.CarbonMonoxide.getGas(2 * BUCKETS),
                Materials.Titaniumtetrachloride.getFluid(1 * BUCKETS))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_HV)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Air.getGas(1 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.SiliconTetrafluoride.getGas(3 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(30)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.HydrofluoricAcid.getFluid(4 * BUCKETS))
            .fluidOutputs(Materials.SiliconTetrafluoride.getGas(1 * BUCKETS))
            .duration(15 * SECONDS)
            .eut(30)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                GTOreDictUnificator.get(OrePrefixes.dust, Materials.Salt, 8))
            .fluidInputs(Materials.SiliconTetrachloride.getFluid(1 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(30)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Trichlorosilane.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.HydrochloricAcid.getFluid(3 * BUCKETS))
            .duration(15 * SECONDS)
            .eut(30)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Trichlorosilane.getFluid(4 * BUCKETS))
            .fluidOutputs(Materials.SiliconTetrachloride.getFluid(3 * BUCKETS))
            .duration(12 * SECONDS)
            .eut(30)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Silane.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.Hydrogen.getGas(4 * BUCKETS))
            .duration(15 * SECONDS)
            .eut(30)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                GTUtility.getIntegratedCircuit(2))
            .fluidInputs(Materials.Chlorine.getGas(4 * BUCKETS))
            .fluidOutputs(Materials.SiliconTetrachloride.getFluid(1 * BUCKETS))
            .duration(20 * SECONDS)
            .eut(30)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Empty.getCells(1))
            .fluidInputs(Materials.HydricSulfide.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.DilutedSulfuricAcid.getFluid(750))
            .duration(3 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialsKevlar.NickelTetracarbonyl.getFluid(1 * BUCKETS))
            .duration(20 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                GTOreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 1),
                GTUtility.getIntegratedCircuit(1))
            .fluidInputs(Materials.CarbonMonoxide.getGas(4 * BUCKETS))
            .fluidOutputs(MaterialsKevlar.NickelTetracarbonyl.getFluid(1 * BUCKETS))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Water.getFluid(1 * BUCKETS))
            .fluidOutputs(MaterialsKevlar.Ethyleneglycol.getFluid(1 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialsKevlar.Acetaldehyde.getGas(1 * BUCKETS))
            .duration(10 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Water.getFluid(2 * BUCKETS))
            .fluidOutputs(Materials.Hydrogen.getGas(6 * BUCKETS))
            .duration(60 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Oxygen.getGas(6 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialsKevlar.SulfurDichloride.getFluid(8 * BUCKETS))
            .duration(40 * SECONDS)
            .eut(30)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                ItemList.Cell_Empty.get(1))
            .fluidOutputs(Materials.SulfurDioxide.getGas(1 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Benzene.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Hydrogen.getGas(4 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Methane.getGas(2 * BUCKETS))
            .fluidOutputs(Materials.Hydrogen.getGas(4 * BUCKETS))
            .duration(3 * MINUTES + 20 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialsKevlar.NaphthenicAcid.getFluid(1 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Chlorine.getGas(3 * BUCKETS))
            .fluidOutputs(MaterialsKevlar.PhosphorusTrichloride.getFluid(1 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialsKevlar.PhosphorusTrichloride.getFluid(9 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Water.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Methanol.getFluid(1 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.NitricAcid.getFluid(1 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Methanol.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.MethylAcetate.getFluid(1 * BUCKETS))
            .duration(12 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Water.getCells(1))
            .fluidInputs(Materials.AceticAcid.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.MethylAcetate.getFluid(1 * BUCKETS))
            .duration(12 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(Materials.Carbon.getDust(1), GTUtility.getIntegratedCircuit(1))
            .fluidInputs(Materials.Oxygen.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.CarbonMonoxide.getGas(1 * BUCKETS))
            .duration(2 * SECONDS)
            .eut(8)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.CarbonDioxide.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.CarbonMonoxide.getGas(2 * BUCKETS))
            .duration(40 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Oxygen.getGas(9 * BUCKETS))
            .fluidOutputs(Materials.CarbonMonoxide.getGas(9 * BUCKETS))
            .duration(36 * SECONDS)
            .eut(8)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.CarbonDioxide.getGas(9 * BUCKETS))
            .duration(18 * SECONDS)
            .eut(8)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.CarbonMonoxide.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.Methanol.getFluid(1 * BUCKETS))
            .duration(6 * SECONDS)
            .eut(96)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Water.getCells(1))
            .fluidInputs(Materials.Hydrogen.getGas(6 * BUCKETS))
            .fluidOutputs(Materials.Methanol.getFluid(1 * BUCKETS))
            .duration(6 * SECONDS)
            .eut(96)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Empty.getCells(1))
            .fluidInputs(Materials.CarbonMonoxide.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.AceticAcid.getFluid(1 * BUCKETS))
            .duration(15 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Ethylene.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.AceticAcid.getFluid(1 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Oxygen.getGas(1 * BUCKETS),
                Materials.Ethylene.getGas(1 * BUCKETS),
                Materials.AceticAcid.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.VinylAcetate.getFluid(1 * BUCKETS), Materials.Water.getFluid(1 * BUCKETS))
            .duration(9 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Oxygen.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.VinylAcetate.getFluid(1 * BUCKETS))
            .duration(9 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.SulfuricAcid.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.DilutedSulfuricAcid.getFluid(1 * BUCKETS))
            .duration(60 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.SulfuricAcid.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Ethylene.getGas(1 * BUCKETS))
            .duration(60 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Propene.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.AllylChloride.getFluid(1 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.HydrochloricAcid.getCells(1))
            .fluidInputs(Materials.Chlorine.getGas(2 * BUCKETS))
            .fluidOutputs(Materials.AllylChloride.getFluid(1 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Water.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.HypochlorousAcid.getFluid(1 * BUCKETS))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Water.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.DilutedHydrochloricAcid.getFluid(1 * BUCKETS))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.AllylChloride.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Epichlorohydrin.getFluid(1 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.SaltWater.getCells(1))
            .fluidInputs(Materials.HypochlorousAcid.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Epichlorohydrin.getFluid(1 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Glycerol.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Epichlorohydrin.getFluid(1 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Water.getFluid(6 * BUCKETS))
            .fluidOutputs(Materials.PhosphoricAcid.getFluid(4 * BUCKETS))
            .duration(2 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Cumene.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Acetone.getFluid(1 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Oxygen.getGas(2 * BUCKETS))
            .fluidOutputs(Materials.Phenol.getFluid(1 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.BisphenolA.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Epoxid.getMolten(1 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Water.getCells(1))
            .fluidInputs(Materials.HydrochloricAcid.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Chloromethane.getGas(1 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(Materials.Chlorine.getCells(2), GTUtility.getIntegratedCircuit(1))
            .itemOutputs(Materials.HydrochloricAcid.getCells(1), Materials.Empty.getCells(1))
            .fluidInputs(Materials.Methane.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.Chloromethane.getGas(1 * BUCKETS))
            .duration(4 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Methane.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.Chloroform.getFluid(1 * BUCKETS))
            .duration(4 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Chlorine.getGas(6 * BUCKETS))
            .fluidOutputs(Materials.HydrochloricAcid.getFluid(3 * BUCKETS))
            .duration(4 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Empty.getCells(1))
            .fluidInputs(Materials.Hydrogen.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.HydrofluoricAcid.getFluid(1 * BUCKETS))
            .duration(3 * SECONDS)
            .eut(8)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(Materials.Hydrogen.getCells(1), GTUtility.getIntegratedCircuit(1))
            .itemOutputs(Materials.Empty.getCells(1))
            .fluidInputs(Materials.Fluorine.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.HydrofluoricAcid.getFluid(1 * BUCKETS))
            .duration(3 * SECONDS)
            .eut(8)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.Tetrafluoroethylene.getGas(1 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.HydrochloricAcid.getCells(6))
            .fluidInputs(Materials.Chloroform.getFluid(2 * BUCKETS))
            .fluidOutputs(Materials.Tetrafluoroethylene.getGas(1 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Chloroform.getFluid(2 * BUCKETS))
            .fluidOutputs(Materials.HydrochloricAcid.getFluid(6 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Chloromethane.getGas(2 * BUCKETS))
            .fluidOutputs(Materials.Dimethyldichlorosilane.getFluid(1 * BUCKETS))
            .duration(12 * SECONDS)
            .eut(96)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(Materials.Water.getCells(1), GTUtility.getIntegratedCircuit(1))
            .itemOutputs(Materials.Polydimethylsiloxane.getDust(3), Materials.Empty.getCells(1))
            .fluidInputs(Materials.Dimethyldichlorosilane.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.DilutedHydrochloricAcid.getFluid(1 * BUCKETS))
            .duration(12 * SECONDS)
            .eut(96)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.NitrationMixture.getFluid(2 * BUCKETS))
            .fluidOutputs(Materials.DilutedSulfuricAcid.getFluid(1 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.DilutedSulfuricAcid.getCells(1))
            .fluidInputs(Materials.NitrationMixture.getFluid(2 * BUCKETS))
            .fluidOutputs(Materials.Nitrochlorobenzene.getFluid(1 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Chlorobenzene.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.DilutedSulfuricAcid.getFluid(1 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Dimethylbenzene.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Water.getFluid(2 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.Water.getFluid(18 * BUCKETS))
            .duration(45 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Dimethylbenzene.getFluid(9 * BUCKETS))
            .fluidOutputs(Materials.Water.getFluid(18 * BUCKETS))
            .duration(45 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Nitrochlorobenzene.getFluid(2 * BUCKETS))
            .fluidOutputs(Materials.Dichlorobenzidine.getFluid(1 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Nitrochlorobenzene.getFluid(18 * BUCKETS))
            .fluidOutputs(Materials.Dichlorobenzidine.getFluid(9 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Phenol.getFluid(2 * BUCKETS))
            .fluidOutputs(Materials.DilutedSulfuricAcid.getFluid(1 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_IV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Dichlorobenzidine.getFluid(1 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.Polybenzimidazole.getMolten(1 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_IV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Water.getCells(2))
            .fluidInputs(Materials.Ammonia.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.Dimethylamine.getGas(1 * BUCKETS))
            .duration(12 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Methanol.getFluid(2 * BUCKETS))
            .fluidOutputs(Materials.Water.getFluid(1 * BUCKETS))
            .duration(12 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Water.getCells(1))
            .fluidInputs(Materials.HypochlorousAcid.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Chloramine.getFluid(1 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.NitrogenDioxide.getGas(2 * BUCKETS))
            .fluidOutputs(Materials.DinitrogenTetroxide.getGas(1 * BUCKETS))
            .duration(32 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Oxygen.getGas(10 * BUCKETS))
            .fluidOutputs(Materials.Water.getFluid(6 * BUCKETS))
            .duration(16 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Ammonia.getGas(4 * BUCKETS))
            .fluidOutputs(Materials.Water.getFluid(6 * BUCKETS))
            .duration(16 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Ammonia.getGas(4 * BUCKETS))
            .fluidOutputs(Materials.NitricOxide.getGas(4 * BUCKETS))
            .duration(16 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Empty.getCells(1))
            .fluidInputs(Materials.Oxygen.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.NitrogenDioxide.getGas(1 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Empty.getCells(1))
            .fluidInputs(Materials.NitricOxide.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.NitrogenDioxide.getGas(1 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.NitrogenDioxide.getGas(3 * BUCKETS))
            .fluidOutputs(Materials.NitricAcid.getFluid(2 * BUCKETS))
            .duration(12 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Water.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.NitricOxide.getGas(1 * BUCKETS))
            .duration(12 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Hydrogen.getGas(2 * BUCKETS))
            .fluidOutputs(Materials.HydricSulfide.getGas(1 * BUCKETS))
            .duration(3 * SECONDS)
            .eut(8)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.HydricSulfide.getGas(2 * BUCKETS))
            .fluidOutputs(Materials.Water.getFluid(2 * BUCKETS))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.SulfurDioxide.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.Water.getFluid(2 * BUCKETS))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Empty.getCells(1))
            .fluidInputs(Materials.SulfurDioxide.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.SulfurTrioxide.getGas(1 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(Materials.Water.getCells(1), GTUtility.getIntegratedCircuit(1))
            .itemOutputs(Materials.Empty.getCells(1))
            .fluidInputs(Materials.SulfurTrioxide.getGas(1 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.HydrochloricAcid.getCells(1), Materials.Empty.getCells(1))
            .fluidInputs(Materials.Ethylene.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.VinylChloride.getGas(1 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.NitricAcid.getFluid(8 * BUCKETS))
            .fluidOutputs(Materials.Water.getFluid(9 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Empty.getCells(1))
            .fluidInputs(Materials.NitricAcid.getFluid(8 * BUCKETS))
            .fluidOutputs(Materials.Tetranitromethane.getFluid(2 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Ethenone.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.Water.getFluid(9 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Ethylene.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.Isoprene.getFluid(1 * BUCKETS))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Ethylene.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.Hydrogen.getGas(2 * BUCKETS))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Propene.getGas(2 * BUCKETS))
            .fluidOutputs(Materials.Isoprene.getFluid(1 * BUCKETS))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Benzene.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Dichlorobenzene.getFluid(1 * BUCKETS))
            .duration(12 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Dichlorobenzene.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.PolyphenyleneSulfide.getMolten(1 * BUCKETS))
            .duration(12 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.SeedOil.getFluid(6 * BUCKETS))
            .fluidOutputs(Materials.BioDiesel.getFluid(6 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Methanol.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Glycerol.getFluid(1 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(Materials.SodiumHydroxide.getDustTiny(1), Materials.Methanol.getCells(1))
            .itemOutputs(Materials.Glycerol.getCells(1))
            .fluidInputs(Materials.FishOil.getFluid(6 * BUCKETS))
            .fluidOutputs(Materials.BioDiesel.getFluid(6 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Methanol.getFluid(9 * BUCKETS))
            .fluidOutputs(Materials.Glycerol.getFluid(9 * BUCKETS))
            .duration(4 * MINUTES + 30 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(Materials.SodiumHydroxide.getDust(1), Materials.SeedOil.getCells(54))
            .itemOutputs(Materials.BioDiesel.getCells(54))
            .fluidInputs(Materials.Ethanol.getFluid(9 * BUCKETS))
            .fluidOutputs(Materials.Glycerol.getFluid(9 * BUCKETS))
            .duration(4 * MINUTES + 30 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.NitrationMixture.getFluid(6 * BUCKETS))
            .fluidOutputs(Materials.DilutedSulfuricAcid.getFluid(3 * BUCKETS))
            .duration(9 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Glycerol.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Glyceryl.getFluid(1 * BUCKETS))
            .duration(9 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.HydrochloricAcid.getCells(1), Materials.Empty.getCells(1))
            .fluidInputs(Materials.Benzene.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Chlorobenzene.getFluid(1 * BUCKETS))
            .duration(12 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Chlorobenzene.getFluid(4 * BUCKETS))
            .fluidOutputs(Materials.Phenol.getFluid(4 * BUCKETS))
            .duration(48 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(ItemList.Cell_Empty.get(1))
            .fluidInputs(Materials.Hydrogen.getGas(2 * BUCKETS))
            .fluidOutputs(new FluidStack(FluidRegistry.getFluid("butanol"), 1 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(30)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialsKevlar.Acetaldehyde.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.CarbonMonoxide.getGas(1 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Water.getFluid(2 * BUCKETS))
            .fluidOutputs(MaterialsKevlar.Acetylene.getGas(1 * BUCKETS))
            .duration(15 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(UniversalChemical);
    ...
    public void addDefaultPolymerizationRecipes(Fluid aBasicMaterial, ItemStack aBasicMaterialCell, Fluid aPolymer) {
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Empty.getCells(1))
            .fluidInputs(Materials.Air.getGas(14000))
            .fluidOutputs(new FluidStack(aPolymer, 1 * BUCKETS))
            .duration(56 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(aBasicMaterialCell, GTUtility.getIntegratedCircuit(9))
            .itemOutputs(Materials.Empty.getCells(1))
            .fluidInputs(Materials.Oxygen.getGas(7 * BUCKETS))
    ...
    public void singleBlockOnly() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Hydrogen.getCells(2))
            .fluidInputs(Materials.Ethylene.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.Styrene.getFluid(1 * BUCKETS))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_LV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Water.getFluid(10 * BUCKETS))
            .fluidOutputs(Materials.PhosphoricAcid.getFluid(3 * BUCKETS))
            .duration(16 * SECONDS)
            .eut(30)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Water.getFluid(10 * BUCKETS))
            .fluidOutputs(Materials.HypochlorousAcid.getFluid(10 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(8)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Hydrogen.getCells(10), Materials.Empty.getCells(1))
            .fluidInputs(Materials.Chlorine.getGas(10 * BUCKETS))
            .fluidOutputs(Materials.HypochlorousAcid.getFluid(10 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(8)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Dimethyldichlorosilane.getFluid(4 * BUCKETS))
            .fluidOutputs(MaterialsKevlar.SiliconOil.getFluid(5 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Water.getFluid(5 * BUCKETS))
            .fluidOutputs(MaterialsKevlar.SiliconOil.getFluid(5 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                GTUtility.getIntegratedCircuit(2))
            .itemOutputs(ItemList.Cell_Empty.get(1))
            .fluidInputs(MaterialsKevlar.EthyleneOxide.getGas(1 * BUCKETS))
            .fluidOutputs(MaterialsKevlar.Ethyleneglycol.getFluid(1 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(ItemList.Cell_Empty.get(1))
            .fluidInputs(Materials.Hydrogen.getGas(2 * BUCKETS))
            .fluidOutputs(GTModHandler.getDistilledWater(1 * BUCKETS))
            .duration(10 * TICKS)
            .eut(30)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.HydrochloricAcid.getFluid(3 * BUCKETS))
            .fluidOutputs(Materials.Trichlorosilane.getFluid(1 * BUCKETS))
            .duration(15 * SECONDS)
            .eut(30)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Benzene.getFluid(8 * BUCKETS))
            .fluidOutputs(Materials.Cumene.getFluid(8 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Empty.getCells(9))
            .fluidInputs(Materials.Propene.getGas(8 * BUCKETS))
            .fluidOutputs(Materials.Cumene.getFluid(8 * BUCKETS))
            .duration(1 * MINUTES + 36 * SECONDS)
            .eut(30)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Empty.getCells(2))
            .fluidInputs(Materials.PhosphoricAcid.getFluid(1 * EIGHT_BUCKETS))
            .fluidOutputs(Materials.Cumene.getFluid(1 * BUCKETS))
            .duration(12 * SECONDS)
            .eut(30)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Water.getCells(1), Materials.Empty.getCells(2))
            .fluidInputs(Materials.HydrochloricAcid.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.BisphenolA.getFluid(1 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(30)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.Ammonia.getGas(1 * BUCKETS))
            .duration(16 * SECONDS)
            .eut(TierEU.HV * 3 / 4)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Butadiene.getGas(3 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Empty.getCells(2))
            .fluidInputs(Materials.Oxygen.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.NitrousOxide.getGas(1 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(30)
            .addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.NitricOxide.getGas(2 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(chemicalReactorRecipes);
    ...
    public void multiblockOnly() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Hydrogen.getGas(16000), Materials.Oxygen.getGas(8 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(Materials.PotassiumNitrade.getDust(10), Materials.ChromiumTrioxide.getDust(8))
            .itemOutputs(Materials.Potassiumdichromate.getDust(11))
            .fluidOutputs(Materials.NitricOxide.getGas(2 * BUCKETS), Materials.Oxygen.getGas(3 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1))
            .fluidInputs(Materials.Benzene.getFluid(1 * BUCKETS), Materials.Methane.getGas(2 * BUCKETS))
            .fluidOutputs(Materials.Dimethylbenzene.getFluid(1 * BUCKETS), Materials.Hydrogen.getGas(4 * BUCKETS))
            .duration(3 * MINUTES + 20 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.SulfuricAcid.getFluid(9 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Air.getGas(8 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(
                Materials.Trichlorosilane.getFluid(9 * BUCKETS),
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Hydrogen.getGas(4 * BUCKETS),
                Materials.Propene.getGas(2 * BUCKETS),
                Materials.CarbonMonoxide.getGas(2 * BUCKETS))
            .fluidOutputs(
                MaterialsKevlar.Butyraldehyde.getFluid(1 * BUCKETS),
                MaterialsKevlar.Isobutyraldehyde.getFluid(1 * BUCKETS))
            .duration(15 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(
                MaterialsKevlar.Butyraldehyde.getFluid(9 * BUCKETS),
                MaterialsKevlar.Isobutyraldehyde.getFluid(9 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Ethylene.getGas(1 * BUCKETS), Materials.Oxygen.getGas(1 * BUCKETS))
            .fluidOutputs(MaterialsKevlar.EthyleneOxide.getGas(1 * BUCKETS))
            .duration(2 * SECONDS + 10 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Ethylene.getGas(9 * BUCKETS), Materials.Oxygen.getGas(9 * BUCKETS))
            .fluidOutputs(MaterialsKevlar.EthyleneOxide.getGas(9 * BUCKETS))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(2))
            .fluidInputs(
                MaterialsKevlar.EthyleneOxide.getGas(1 * BUCKETS),
                Materials.Dimethyldichlorosilane.getFluid(4 * BUCKETS),
                Materials.Water.getFluid(5 * BUCKETS))
            .fluidOutputs(MaterialsKevlar.SiliconOil.getFluid(5 * BUCKETS))
            .duration(15 * TICKS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialsKevlar.EthyleneOxide.getGas(9 * BUCKETS),
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Methanol.getFluid(1 * BUCKETS), Materials.Ammonia.getGas(1 * BUCKETS))
            .fluidOutputs(MaterialsKevlar.Methylamine.getGas(1 * BUCKETS), Materials.Water.getFluid(1 * BUCKETS))
            .duration(1 * MINUTES + 15 * SECONDS)
            .eut(TierEU.RECIPE_UV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialsKevlar.Ethyleneglycol.getFluid(4 * BUCKETS),
                MaterialsKevlar.SiliconOil.getFluid(1 * BUCKETS))
            .fluidOutputs(MaterialsKevlar.PolyurethaneResin.getFluid(1 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_UV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                ...
                MaterialsKevlar.SiliconOil.getFluid(9 * BUCKETS))
            .fluidOutputs(MaterialsKevlar.PolyurethaneResin.getFluid(9 * BUCKETS))
            .duration(1 * MINUTES + 15 * SECONDS)
            .eut(TierEU.RECIPE_UV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                GTOreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 1),
                GTOreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 1))
            .fluidInputs(Materials.Methanol.getFluid(6 * BUCKETS), Materials.Ammonia.getGas(3 * BUCKETS))
            .fluidOutputs(
                MaterialsKevlar.Methylamine.getGas(1 * BUCKETS),
                Materials.Dimethylamine.getGas(1 * BUCKETS),
                MaterialsKevlar.Trimethylamine.getGas(1 * BUCKETS),
                Materials.Water.getFluid(6 * BUCKETS))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(
                MaterialsKevlar.Methylamine.getGas(9 * BUCKETS),
                Materials.Dimethylamine.getGas(9 * BUCKETS),
                MaterialsKevlar.Trimethylamine.getGas(9 * BUCKETS),
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialsKevlar.ThionylChloride.getFluid(18 * BUCKETS),
                MaterialsKevlar.DimethylTerephthalate.getFluid(5 * BUCKETS),
                Materials.CarbonDioxide.getGas(6 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1))
            .fluidInputs(
                MaterialsKevlar.TerephthalicAcid.getFluid(1 * BUCKETS),
                Materials.Methanol.getFluid(2 * BUCKETS),
                Materials.SulfuricAcid.getFluid(2 * BUCKETS))
            .fluidOutputs(
                MaterialsKevlar.DimethylTerephthalate.getFluid(1 * BUCKETS),
                Materials.DilutedSulfuricAcid.getFluid(2 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialsKevlar.TerephthalicAcid.getFluid(9 * BUCKETS),
                Materials.Methanol.getFluid(18 * BUCKETS),
                Materials.SulfuricAcid.getFluid(18 * BUCKETS))
            .fluidOutputs(
                MaterialsKevlar.DimethylTerephthalate.getFluid(9 * BUCKETS),
                Materials.DilutedSulfuricAcid.getFluid(18 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Benzene.getFluid(1 * BUCKETS), Materials.Methane.getGas(2 * BUCKETS))
            .fluidOutputs(
                MaterialsKevlar.IIIDimethylbenzene.getFluid(1 * BUCKETS),
                Materials.Hydrogen.getGas(4 * BUCKETS))
            .duration(3 * MINUTES + 20 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Benzene.getFluid(1 * BUCKETS), Materials.Methane.getGas(2 * BUCKETS))
            .fluidOutputs(
                MaterialsKevlar.IVDimethylbenzene.getFluid(1 * BUCKETS),
                Materials.Hydrogen.getGas(4 * BUCKETS))
            .duration(3 * MINUTES + 20 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialsKevlar.NaphthenicAcid.getFluid(10 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                MaterialsKevlar.CobaltIINaphthenate.getDust(49))
            .fluidInputs(MaterialsKevlar.NaphthenicAcid.getFluid(10 * BUCKETS))
            .fluidOutputs(Materials.AceticAcid.getFluid(15 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialsKevlar.PhosphorusTrichloride.getFluid(1 * BUCKETS),
                Materials.Chlorobenzene.getFluid(3 * BUCKETS))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialsKevlar.TrimethylBorate.getFluid(1 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialsKevlar.TrimethylBorate.getFluid(8 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.AceticAcid.getFluid(2 * BUCKETS))
            .fluidOutputs(
                Materials.Acetone.getFluid(1 * BUCKETS),
                Materials.CarbonDioxide.getGas(1 * BUCKETS),
                Materials.Water.getFluid(1 * BUCKETS))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Hydrogen.getGas(4 * BUCKETS), Materials.Oxygen.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.Methanol.getFluid(1 * BUCKETS))
            .duration(16 * SECONDS)
            .eut(96)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Hydrogen.getGas(4 * BUCKETS), Materials.Oxygen.getGas(2 * BUCKETS))
            .fluidOutputs(Materials.AceticAcid.getFluid(1 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.CarbonMonoxide.getGas(2 * BUCKETS), Materials.Hydrogen.getGas(4 * BUCKETS))
            .fluidOutputs(Materials.AceticAcid.getFluid(1 * BUCKETS))
            .duration(16 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(8))
            .fluidInputs(Materials.Hydrogen.getGas(9 * BUCKETS), Materials.Chlorine.getGas(9 * BUCKETS))
            .fluidOutputs(Materials.HydrochloricAcid.getFluid(9 * BUCKETS))
            .duration(7 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(2))
            .fluidInputs(
                Materials.Chlorine.getGas(10 * BUCKETS),
                Materials.Water.getFluid(10 * BUCKETS),
                Materials.Mercury.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.HypochlorousAcid.getFluid(10 * BUCKETS), Materials.Hydrogen.getGas(10 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(8)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Propene.getGas(1 * BUCKETS),
                Materials.Chlorine.getGas(4 * BUCKETS),
                Materials.Water.getFluid(1 * BUCKETS))
            .fluidOutputs(
                Materials.Epichlorohydrin.getFluid(1 * BUCKETS),
                Materials.SaltWater.getFluid(1 * BUCKETS),
                Materials.HydrochloricAcid.getFluid(2 * BUCKETS))
            .duration(32 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Propene.getGas(1 * BUCKETS),
                Materials.Chlorine.getGas(2 * BUCKETS),
                Materials.Water.getFluid(1 * BUCKETS),
                Materials.Mercury.getFluid(100))
            .fluidOutputs(
                Materials.Epichlorohydrin.getFluid(1 * BUCKETS),
                Materials.SaltWater.getFluid(1 * BUCKETS),
                Materials.Hydrogen.getGas(2 * BUCKETS))
            .duration(32 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Propene.getGas(1 * BUCKETS),
                Materials.Chlorine.getGas(2 * BUCKETS),
                Materials.HypochlorousAcid.getFluid(1 * BUCKETS))
            .fluidOutputs(
                Materials.Epichlorohydrin.getFluid(1 * BUCKETS),
                Materials.SaltWater.getFluid(1 * BUCKETS),
                Materials.HydrochloricAcid.getFluid(1 * BUCKETS))
            .duration(32 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.SulfuricAcid.getFluid(5 * BUCKETS), Materials.Water.getFluid(10 * BUCKETS))
            .fluidOutputs(
                Materials.PhosphoricAcid.getFluid(3 * BUCKETS),
                Materials.HydrochloricAcid.getFluid(1 * BUCKETS))
            .duration(16 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.PhosphoricAcid.getFluid(1 * BUCKETS))
            .duration(16 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1))
            .fluidInputs(
                Materials.Propene.getGas(8 * BUCKETS),
                Materials.Benzene.getFluid(8 * BUCKETS),
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Propene.getGas(1 * BUCKETS),
                Materials.Benzene.getFluid(1 * BUCKETS),
                Materials.PhosphoricAcid.getFluid(100),
                Materials.Oxygen.getGas(2 * BUCKETS))
            .fluidOutputs(Materials.Phenol.getFluid(1 * BUCKETS), Materials.Acetone.getFluid(1 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Acetone.getFluid(1 * BUCKETS),
                Materials.Phenol.getFluid(2 * BUCKETS),
                Materials.HydrochloricAcid.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.BisphenolA.getFluid(1 * BUCKETS), Materials.Water.getFluid(1 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                ...
                Materials.Phenol.getFluid(2 * BUCKETS),
                Materials.HydrochloricAcid.getFluid(1 * BUCKETS),
                Materials.Epichlorohydrin.getFluid(2 * BUCKETS))
            .fluidOutputs(Materials.Epoxid.getMolten(1 * BUCKETS), Materials.SaltWater.getFluid(2 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(9))
            .fluidInputs(Materials.Hydrogen.getGas(9 * BUCKETS), Materials.Fluorine.getGas(9 * BUCKETS))
            .fluidOutputs(Materials.HydrofluoricAcid.getFluid(9 * BUCKETS))
            .duration(7 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(
                Materials.HydrofluoricAcid.getFluid(4 * BUCKETS),
                Materials.Methane.getGas(2 * BUCKETS),
                Materials.Chlorine.getGas(12000))
            .fluidOutputs(
                Materials.Tetrafluoroethylene.getGas(1 * BUCKETS),
                Materials.HydrochloricAcid.getFluid(12 * BUCKETS))
            .duration(27 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(
                Materials.HydrochloricAcid.getFluid(2 * BUCKETS),
                Materials.DilutedHydrochloricAcid.getFluid(2 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(96)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(Materials.Silicon.getDust(1), GTUtility.getIntegratedCircuit(24))
            .itemOutputs(Materials.Polydimethylsiloxane.getDust(3))
            .fluidInputs(Materials.Methanol.getFluid(2 * BUCKETS), Materials.HydrochloricAcid.getFluid(2 * BUCKETS))
            .fluidOutputs(Materials.DilutedHydrochloricAcid.getFluid(2 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(96)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1))
            .fluidInputs(Materials.Nitrogen.getGas(1 * BUCKETS), Materials.Hydrogen.getGas(3 * BUCKETS))
            .fluidOutputs(Materials.Ammonia.getGas(1 * BUCKETS))
            .duration(16 * SECONDS)
            .eut(TierEU.HV * 3 / 4)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(Materials.Nitrogen.getGas(10 * BUCKETS), Materials.Hydrogen.getGas(30000))
            .fluidOutputs(Materials.Ammonia.getGas(10 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Ammonia.getGas(2 * BUCKETS), Materials.Oxygen.getGas(7 * BUCKETS))
            .fluidOutputs(Materials.DinitrogenTetroxide.getGas(1 * BUCKETS), Materials.Water.getFluid(3 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(23))
            .fluidInputs(
                Materials.Nitrogen.getGas(2 * BUCKETS),
                Materials.Hydrogen.getGas(6 * BUCKETS),
                Materials.Oxygen.getGas(7 * BUCKETS))
            .fluidOutputs(Materials.DinitrogenTetroxide.getGas(1 * BUCKETS), Materials.Water.getFluid(3 * BUCKETS))
            .duration(55 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(9))
            .fluidInputs(Materials.Oxygen.getGas(100 * BUCKETS), Materials.Ammonia.getGas(36000))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(9))
            .fluidInputs(Materials.NitricOxide.getGas(9 * BUCKETS), Materials.Oxygen.getGas(9 * BUCKETS))
            .fluidOutputs(Materials.NitrogenDioxide.getGas(9 * BUCKETS))
            .duration(4 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(9))
            .fluidInputs(Materials.NitrogenDioxide.getGas(27000), Materials.Water.getFluid(9 * BUCKETS))
            .fluidOutputs(Materials.NitricAcid.getFluid(18 * BUCKETS), Materials.NitricOxide.getGas(9 * BUCKETS))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Hydrogen.getGas(3 * BUCKETS),
                Materials.Nitrogen.getGas(1 * BUCKETS),
                Materials.Oxygen.getGas(4 * BUCKETS))
            .fluidOutputs(Materials.NitricAcid.getFluid(1 * BUCKETS), Materials.Water.getFluid(1 * BUCKETS))
            .duration(16 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(Materials.Ammonia.getGas(1 * BUCKETS), Materials.Oxygen.getGas(4 * BUCKETS))
            .fluidOutputs(Materials.NitricAcid.getFluid(1 * BUCKETS), Materials.Water.getFluid(1 * BUCKETS))
            .duration(16 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(
                Materials.NitrogenDioxide.getGas(2 * BUCKETS),
                Materials.Oxygen.getGas(1 * BUCKETS),
                Materials.Water.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.NitricAcid.getFluid(2 * BUCKETS))
            .duration(16 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.HydricSulfide.getGas(9 * BUCKETS))
            .duration(4 * TICKS)
            .eut(TierEU.RECIPE_MV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(9), Materials.Sulfur.getDust(9))
            .fluidInputs(Materials.Oxygen.getGas(18000))
            .fluidOutputs(Materials.SulfurDioxide.getGas(9 * BUCKETS))
            .duration(4 * TICKS)
            .eut(TierEU.RECIPE_MV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(9))
            .fluidInputs(Materials.HydricSulfide.getGas(9 * BUCKETS), Materials.Oxygen.getGas(27000))
            .fluidOutputs(Materials.SulfurDioxide.getGas(9 * BUCKETS), Materials.Water.getFluid(9 * BUCKETS))
            .duration(3 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.SulfurDioxide.getGas(9 * BUCKETS), Materials.HydricSulfide.getGas(18000))
            .duration(3 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(9))
            .fluidInputs(Materials.SulfurTrioxide.getGas(9 * BUCKETS), Materials.Water.getFluid(9 * BUCKETS))
            .fluidOutputs(Materials.SulfuricAcid.getFluid(9 * BUCKETS))
            .duration(13 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Oxygen.getGas(3 * BUCKETS), Materials.Water.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.SulfuricAcid.getFluid(1 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Oxygen.getGas(27000), Materials.Water.getFluid(9 * BUCKETS))
            .fluidOutputs(Materials.SulfuricAcid.getFluid(9 * BUCKETS))
            .duration(13 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(Materials.HydricSulfide.getGas(1 * BUCKETS), Materials.Oxygen.getGas(4 * BUCKETS))
            .fluidOutputs(Materials.SulfuricAcid.getFluid(1 * BUCKETS))
            .duration(24 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(
                Materials.SulfurDioxide.getGas(1 * BUCKETS),
                Materials.Oxygen.getGas(1 * BUCKETS),
                Materials.Water.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.SulfuricAcid.getFluid(1 * BUCKETS))
            .duration(30 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(9))
            .fluidInputs(
                Materials.SulfurDioxide.getGas(9 * BUCKETS),
                Materials.Oxygen.getGas(9 * BUCKETS),
                Materials.Water.getFluid(9 * BUCKETS))
            .fluidOutputs(Materials.SulfuricAcid.getFluid(9 * BUCKETS))
            .duration(7 * SECONDS + 10 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                ...
                Materials.Ethylene.getGas(1 * BUCKETS),
                Materials.Oxygen.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.VinylChloride.getGas(1 * BUCKETS), Materials.Water.getFluid(1 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Chlorine.getGas(2 * BUCKETS),
                Materials.Ethylene.getGas(2 * BUCKETS),
                Materials.Oxygen.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.VinylChloride.getGas(2 * BUCKETS), Materials.Water.getFluid(1 * BUCKETS))
            .duration(12 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                ...
                Materials.Air.getGas(6 * BUCKETS),
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Isoprene.getFluid(1728),
                Materials.Oxygen.getGas(6 * BUCKETS),
                Materials.Titaniumtetrachloride.getFluid(80))
            .duration(32 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                ...
                Materials.Air.getGas(2 * BUCKETS))
            .duration(8 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                ...
                Materials.Water.getFluid(1 * BUCKETS))
            .fluidOutputs(
                Materials.Phenol.getFluid(1 * BUCKETS),
                Materials.HydrochloricAcid.getFluid(1 * BUCKETS),
                Materials.DilutedHydrochloricAcid.getFluid(1 * BUCKETS))
            .duration(28 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Benzene.getFluid(2 * BUCKETS), Materials.Chlorine.getGas(4 * BUCKETS))
            .fluidOutputs(Materials.Phenol.getFluid(2 * BUCKETS), Materials.HydrochloricAcid.getFluid(2 * BUCKETS))
            .duration(56 * SECONDS)
            .eut(30)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(Materials.LightFuel.getFluid(20 * BUCKETS), Materials.HeavyFuel.getFluid(4 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(Materials.Fuel.getFluid(10 * BUCKETS), Materials.Tetranitromethane.getFluid(200))
            .fluidOutputs(Materials.NitroFuel.getFluid(10 * BUCKETS))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(Materials.BioDiesel.getFluid(10 * BUCKETS), Materials.Tetranitromethane.getFluid(400))
            .fluidOutputs(Materials.NitroFuel.getFluid(9 * BUCKETS))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Methane.getGas(5 * BUCKETS), GTModHandler.getDistilledWater(10 * BUCKETS))
            .fluidOutputs(Materials.CarbonDioxide.getGas(5 * BUCKETS), Materials.Hydrogen.getGas(40000))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Methane.getGas(5 * BUCKETS), GTModHandler.getDistilledWater(5000))
            .fluidOutputs(Materials.CarbonMonoxide.getGas(5 * BUCKETS), Materials.Hydrogen.getGas(30000))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(Materials.Nitrogen.getGas(20000), Materials.Oxygen.getGas(10 * BUCKETS))
            .fluidOutputs(Materials.NitrousOxide.getGas(10 * BUCKETS))
            .duration(2 * SECONDS + 10 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(
                Materials.Naphtha.getFluid(16 * BUCKETS),
                Materials.Gas.getGas(2 * BUCKETS),
                Materials.Methanol.getFluid(1 * BUCKETS),
                Materials.Acetone.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.GasolineRaw.getFluid(20 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(Materials.GasolineRaw.getFluid(10 * BUCKETS), Materials.Toluene.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.GasolineRegular.getFluid(11 * BUCKETS))
            .duration(10 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(
                Materials.GasolineRegular.getFluid(20 * BUCKETS),
                Materials.Octane.getFluid(2 * BUCKETS),
                Materials.NitrousOxide.getGas(6 * BUCKETS),
                Materials.Toluene.getFluid(1 * BUCKETS),
                Materials.AntiKnock.getFluid(3 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(Materials.Ethanol.getFluid(1 * BUCKETS), Materials.Butene.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.AntiKnock.getFluid(1 * BUCKETS))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(Materials.Methanol.getFluid(1 * BUCKETS), Materials.Butene.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.MTBEMixture.getGas(1 * BUCKETS))
            .duration(20 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(24))
            .fluidInputs(Materials.Methanol.getFluid(1 * BUCKETS), Materials.Butane.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.MTBEMixtureAlt.getGas(1 * BUCKETS))
            .duration(20 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1))
            .fluidInputs(
                new FluidStack(FluidRegistry.getFluid("fluid.formaldehyde"), 1 * BUCKETS),
                new FluidStack(FluidRegistry.getFluid("aniline"), 2000),
                Materials.HydrochloricAcid.getFluid(1 * BUCKETS))
            .fluidOutputs(MaterialsKevlar.DiaminodiphenylmethanMixture.getFluid(1 * BUCKETS))
            .duration(60 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(
                Materials.Water.getFluid(18 * BUCKETS),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1))
            .fluidInputs(
                Materials.Benzene.getFluid(5 * BUCKETS),
                Materials.SulfuricAcid.getFluid(3 * BUCKETS),
                Materials.NitricAcid.getFluid(5 * BUCKETS),
                GTModHandler.getDistilledWater(10 * BUCKETS))
            .fluidOutputs(
                new FluidStack(FluidRegistry.getFluid("nitrobenzene"), 5000),
                Materials.DilutedSulfuricAcid.getFluid(3 * BUCKETS))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_IV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1))
            .fluidInputs(
                MaterialsKevlar.DiaminodiphenylmethanMixture.getFluid(1 * BUCKETS),
                new FluidStack(FluidRegistry.getFluid("phosgene"), 2000))
            .fluidOutputs(MaterialsKevlar.DiphenylmethaneDiisocyanateMixture.getFluid(1 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                GTUtility.getIntegratedCircuit(9),
                GTOreDictUnificator.get(OrePrefixes.dust, Materials.Palladium, 1))
            .fluidInputs(MaterialsKevlar.Butyraldehyde.getFluid(9 * BUCKETS), Materials.Hydrogen.getGas(18000))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                ...
                new FluidStack(FluidRegistry.getFluid("propionicacid"), 1 * BUCKETS),
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                Materials.Ethylene.getGas(1 * BUCKETS),
                Materials.CarbonMonoxide.getGas(1 * BUCKETS),
                MaterialsKevlar.NickelTetracarbonyl.getFluid(100),
                Materials.Water.getFluid(1 * BUCKETS))
            .fluidOutputs(new FluidStack(FluidRegistry.getFluid("propionicacid"), 1 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(9))
            .fluidInputs(
                Materials.Ethylene.getGas(9 * BUCKETS),
                Materials.CarbonMonoxide.getGas(9 * BUCKETS),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(2))
            .fluidInputs(
                new FluidStack(FluidRegistry.getFluid("aniline"), 1 * BUCKETS),
                new FluidStack(FluidRegistry.getFluid("molten.aceticanhydride"), 100),
                Materials.NitrationMixture.getFluid(2 * BUCKETS))
            .fluidOutputs(
                MaterialsKevlar.IVNitroaniline.getFluid(1 * BUCKETS),
                Materials.DilutedSulfuricAcid.getFluid(1 * BUCKETS))
            .duration(15 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                ...
                Materials.NitrationMixture.getFluid(18 * BUCKETS))
            .fluidOutputs(
                MaterialsKevlar.IVNitroaniline.getFluid(9 * BUCKETS),
                Materials.DilutedSulfuricAcid.getFluid(9 * BUCKETS))
            .duration(1 * MINUTES + 40 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                GTUtility.getIntegratedCircuit(1),
                GTOreDictUnificator.get(OrePrefixes.dust, Materials.Copper, 1))
            .fluidInputs(new FluidStack(FluidRegistry.getFluid("1,4-butanediol"), 1 * BUCKETS))
            .fluidOutputs(
                MaterialsKevlar.GammaButyrolactone.getFluid(1 * BUCKETS),
                Materials.Hydrogen.getGas(4 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialsKevlar.GammaButyrolactone.getFluid(9 * BUCKETS), Materials.Hydrogen.getGas(36000))
            .duration(35 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialsKevlar.Acetylene.getGas(1 * BUCKETS),
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialsKevlar.Acetylene.getGas(9 * BUCKETS),
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Hydrogen.getGas(4 * BUCKETS))
            .fluidOutputs(new FluidStack(FluidRegistry.getFluid("1,4-butanediol"), 1 * BUCKETS))
            .duration(15 * SECONDS)
            .eut(TierEU.RECIPE_UV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialsKevlar.NMethylIIPyrrolidone.getFluid(1 * BUCKETS))
            .fluidOutputs(
                MaterialsKevlar.LiquidCrystalKevlar.getFluid(9 * BUCKETS),
                Materials.DilutedHydrochloricAcid.getFluid(2 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_UV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialsKevlar.NMethylIIPyrrolidone.getFluid(7 * BUCKETS))
            .fluidOutputs(
                MaterialsKevlar.LiquidCrystalKevlar.getFluid(63000),
                Materials.DilutedHydrochloricAcid.getFluid(14 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1))
            .fluidInputs(
                Materials.Methanol.getFluid(3 * BUCKETS),
                new FluidStack(FluidRegistry.getFluid("boricacid"), 1 * BUCKETS),
                Materials.SulfuricAcid.getFluid(6 * BUCKETS))
            .fluidOutputs(
                Materials.DilutedSulfuricAcid.getFluid(6 * BUCKETS),
                MaterialsKevlar.TrimethylBorate.getFluid(1 * BUCKETS))
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(
                ...
                MaterialsKevlar.TrimethylBorate.getFluid(9 * BUCKETS))
            .duration(3 * MINUTES + 45 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.CarbonMonoxide.getGas(1 * BUCKETS))
            .fluidOutputs(Materials.Hydrogen.getGas(11 * BUCKETS))
            .duration(40 * SECONDS)
            .eut(TierEU.RECIPE_UV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(new FluidStack(FluidRegistry.getFluid("fluid.hydrazine"), 1 * BUCKETS))
            .fluidOutputs(Materials.Nitrogen.getGas(2 * BUCKETS), Materials.Water.getFluid(2 * BUCKETS))
            .duration(10 * TICKS)
            .eut(TierEU.RECIPE_EV)
            .addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.Nitrogen.getGas(18000), Materials.Water.getFluid(18 * BUCKETS))
