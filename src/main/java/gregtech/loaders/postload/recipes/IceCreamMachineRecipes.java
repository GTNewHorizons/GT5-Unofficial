...
public class IceCreamMachineRecipes implements Runnable {
    ...
    public void run() {
        ...
        addRecipe(ItemList.Ice_Cream_BlueberryBlastStargate);
        addRecipe(ItemList.Ice_Cream_Blueberry);
        addRecipe(ItemList.Ice_Cream_Boucream);
        addRecipe(ItemList.Ice_Cream_BowlOfHarmony);
        ...
        addRecipe(ItemList.Ice_Cream_CherryParfait);
        addRecipe(ItemList.Ice_Cream_ChocoVanilla);
        ...
        addRecipe(ItemList.Ice_Cream_ChocolateWalnutFudge);
        ...
        addRecipe(ItemList.Ice_Cream_ElectronicBlast);
        addRecipe(ItemList.Ice_Cream_Engineers);
        addRecipe(ItemList.Ice_Cream_FrenchVanilla);
        addRecipe(ItemList.Ice_Cream_Popsicle_Fruit);
        addRecipe(ItemList.Ice_Cream_GrapeMatterManipulator);
        ...
        addRecipe(ItemList.Ice_Cream_Peach);
