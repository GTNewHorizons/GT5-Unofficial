...
public class BenderRecipes implements Runnable {
    ...
    public void run() {
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.RC_Rail_Standard.get(64L)).duration(15 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(benderRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.RC_Rail_Reinforced.get(64L)).duration(30 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(benderRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.RC_Rebar.get(64L)).duration(10 * SECONDS).eut(200).addTo(benderRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.IC2_Mixed_Metal_Ingot.get(1L), GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.plateAlloy, Materials.Advanced, 1L))
                .duration(5 * SECONDS).eut(8).addTo(benderRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.plate, Materials.Tin, 2L),
                        GTUtility.getIntegratedCircuit(12))
                .itemOutputs(ItemList.Cell_Empty.get(1L)).duration(10 * SECONDS).eut(8).addTo(benderRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 1L),
                        GTUtility.getIntegratedCircuit(12))
                .itemOutputs(ItemList.Cell_Empty.get(1L)).duration(5 * SECONDS).eut(8).addTo(benderRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.plate, Materials.Polytetrafluoroethylene, 1L),
                        GTUtility.getIntegratedCircuit(12))
                .itemOutputs(ItemList.Cell_Empty.get(4L)).duration(5 * SECONDS).eut(8).addTo(benderRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 3L),
                        GTUtility.getIntegratedCircuit(12))
                .itemOutputs(new ItemStack(Items.bucket, 1, 0)).duration(10 * SECONDS).eut(4).addTo(benderRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.IC2_Fuel_Rod_Empty.get(1)).duration(5 * SECONDS).eut(8).addTo(benderRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(GGMaterial.tairitsu.get(OrePrefixes.ingot, 9), GTUtility.getIntegratedCircuit(9))
                .itemOutputs(GGMaterial.tairitsu.get(OrePrefixes.plateDense, 1)).duration(5 * SECONDS)
                .eut(TierEU.RECIPE_ZPM).addTo(benderRecipes);
        ...
        if (GTOreDictUnificator.get(OrePrefixes.itemCasing, Materials.Tin, 1L) != null) {
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemList.IC2_Food_Can_Empty.get(1L)).duration(20 * TICKS).eut((int) TierEU.RECIPE_HV)
                    .addTo(benderRecipes);
        }
