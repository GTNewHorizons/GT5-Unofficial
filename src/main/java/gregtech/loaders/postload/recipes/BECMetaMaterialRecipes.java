...
public class BECMetaMaterialRecipes implements Runnable {
    ...
    private void registerResonanceChamber() {
        ...
        ItemList[] emitters  = { ItemList.Emitter_UHV, ItemList.Emitter_UEV, ItemList.Emitter_UIV, ItemList.Emitter_UMV };
        long[] euts = { TierEU.RECIPE_UEV, TierEU.RECIPE_UIV, TierEU.RECIPE_UMV, TierEU.RECIPE_UXV };

        for (int t = 0; t < 4; t++) {
            ItemStack[] inputs = { emitters[t].get(2), rodPart(black4Tier[t], 2),
