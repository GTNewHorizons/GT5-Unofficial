...
public class FluidHeaterRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.Water.getFluid(6)
            )
            .fluidOutputs(
                Materials.Water.getGas(960)
            )
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                GT_ModHandler.getDistilledWater(6)
            )
            .fluidOutputs(
                Materials.Water.getGas(960)
            )
        ...
        GT_Values.RA.stdBuilder()
            ...
            .noItemOutputs()
            .fluidInputs(
                Materials.SeedOil.getFluid(16)
            )
            .fluidOutputs(
                Materials.FryingOilHot.getFluid(16)
            )
            .duration(16 * TICKS)
            .eut(30)
            .addTo(sFluidHeaterRecipes);
