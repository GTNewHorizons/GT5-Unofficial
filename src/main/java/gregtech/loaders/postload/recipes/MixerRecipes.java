...
public class MixerRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(15 * SECONDS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(
                        GTOreDictUnificator.getDust(Materials.StainlessSteel, 9L * OrePrefixes.dust.mMaterialAmount))
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(15 * SECONDS).eut(TierEU.RECIPE_MV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(2 * SECONDS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(10 * SECONDS).eut(24).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                        GTOreDictUnificator.getDust(Materials.SterlingSilver, 5L * OrePrefixes.dust.mMaterialAmount))
                .duration(25 * SECONDS).eut(TierEU.RECIPE_MV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(25 * SECONDS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(
                        GTOreDictUnificator.getDust(Materials.BismuthBronze, 5L * OrePrefixes.dust.mMaterialAmount))
                .duration(25 * SECONDS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(40 * SECONDS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(40 * SECONDS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(60 * SECONDS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(3 * MINUTES).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(45 * SECONDS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(45 * SECONDS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(30 * SECONDS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(25 * SECONDS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(2 * SECONDS).eut(TierEU.RECIPE_EV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(
                        GTOreDictUnificator.getDust(Materials.NiobiumTitanium, 2L * OrePrefixes.dust.mMaterialAmount))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(
                        GTOreDictUnificator.getDust(Materials.VanadiumGallium, 4L * OrePrefixes.dust.mMaterialAmount))
                .duration(2 * SECONDS).eut(TierEU.RECIPE_EV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(
                        GTOreDictUnificator.getDust(Materials.TungstenCarbide, 2L * OrePrefixes.dust.mMaterialAmount))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(
                        GTOreDictUnificator.getDust(Materials.TungstenSteel, 2L * OrePrefixes.dust.mMaterialAmount))
                .duration(2 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_EV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(8 * SECONDS + 15 * TICKS).eut(TierEU.RECIPE_EV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(30 * SECONDS).eut(TierEU.RECIPE_EV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(35 * SECONDS).eut(TierEU.RECIPE_IV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(40 * SECONDS).eut(TierEU.RECIPE_IV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(3))
                .itemOutputs(
                        GTOreDictUnificator.getDust(Materials.FerriteMixture, 6L * OrePrefixes.dust.mMaterialAmount))
                .duration(10 * SECONDS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(MaterialsAlloy.EGLIN_STEEL.getDust(48)).duration(15 * SECONDS).eut(64).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(16))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Enderium, 8L)).duration(10 * SECONDS)
                .eut(64).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(getFluidStack("sludge", 1_000)).duration(6 * SECONDS + 8 * TICKS).eut(24)
                .addTo(mixerRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Wheat, 1))
                .itemOutputs(ItemList.Food_Dough.get(2)).fluidInputs(Materials.Water.getFluid(1_000))
                .duration(1 * SECONDS + 12 * TICKS).eut(8).addTo(mixerRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Chili, 1),
                        ItemList.Food_PotatoChips.get(1))
                .itemOutputs(ItemList.Food_ChiliChips.get(1)).duration(1 * SECONDS + 12 * TICKS).eut(8)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.IC2_Energium_Dust.get(1)).duration(15 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.IC2_Energium_Dust.get(9)).duration(30 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(new ItemStack(Items.fermented_spider_eye, 1)).duration(5 * SECONDS).eut(8)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.IronWood, 2)).duration(5 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.IronWood, 18)).duration(45 * SECONDS)
                .eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Water.getFluid(500)).duration(20 * TICKS).eut(16).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.gem, Materials.NetherQuartz, 1))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.gem, Materials.Fluix, 2))
                .fluidInputs(GTModHandler.getDistilledWater(500)).duration(20 * TICKS).eut(16).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(getModItem(Forestry.ID, "soil", 8L, 0)).fluidInputs(Materials.Water.getFluid(1_000))
                .duration(3 * SECONDS + 4 * TICKS).eut(16).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(getModItem(Forestry.ID, "soil", 2L, 1)).fluidInputs(Materials.Water.getFluid(250))
                .duration(16 * TICKS).eut(16).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.cell, Materials.Fuel, 6)).duration(16 * TICKS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.HeavyFuel.getFluid(1_000)).duration(16 * TICKS).eut(TierEU.RECIPE_MV)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.cell, Materials.Fuel, 6))
                .fluidInputs(Materials.LightFuel.getFluid(5_000)).duration(16 * TICKS).eut(TierEU.RECIPE_MV)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.cell, Materials.LightFuel, 5),
                        GTUtility.getIntegratedCircuit(5))
                .itemOutputs(Materials.Empty.getCells(5)).fluidInputs(Materials.HeavyFuel.getFluid(1_000))
                .fluidOutputs(Materials.Fuel.getFluid(6_000)).duration(16 * TICKS).eut(TierEU.RECIPE_MV)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(Materials.Empty.getCells(1)).fluidInputs(Materials.LightFuel.getFluid(5_000))
                .fluidOutputs(Materials.Fuel.getFluid(6_000)).duration(16 * TICKS).eut(TierEU.RECIPE_MV)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(ItemList.sDrillingFluid, 5_000)).duration(3 * SECONDS + 4 * TICKS).eut(16)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(4))
                .fluidInputs(Materials.Water.getFluid(125)).fluidOutputs(GTModHandler.getIC2Coolant(125))
                .duration(12 * SECONDS + 16 * TICKS).eut(48).addTo(mixerRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Lapis, 1),
                        GTUtility.getIntegratedCircuit(4))
                .fluidInputs(GTModHandler.getDistilledWater(1_000)).fluidOutputs(GTModHandler.getIC2Coolant(1_000))
                .duration(12 * SECONDS + 16 * TICKS).eut(48).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(40 * SECONDS).eut(16).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Wood, 4),
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.SFMixture.get(64)).fluidInputs(Materials.McGuffium239.getFluid(12))
                .duration(20 * SECONDS).eut(16).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Wood, 4),
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.SFMixture.get(64)).fluidInputs(Materials.McGuffium239.getFluid(8))
                .duration(20 * SECONDS).eut(16).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Wood, 4),
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.SFMixture.get(64)).fluidInputs(Materials.McGuffium239.getFluid(4))
                .duration(20 * SECONDS).eut(16).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Lava.getFluid(125L)).fluidOutputs(Materials.GraniteRed.getMolten(1 * INGOTS))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Lava.getFluid(125L)).fluidOutputs(Materials.GraniteBlack.getMolten(1 * INGOTS))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_LV).addTo(mixerRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(ItemList.SFMixture.get(2), GTOreDictUnificator.get(OrePrefixes.dust, Materials.EnderEye, 1))
                .itemOutputs(ItemList.MSFMixture.get(4)).fluidInputs(Materials.Mercury.getFluid(1_000))
                .duration(15 * SECONDS).eut(64).addTo(mixerRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(ItemList.SFMixture.get(1), GTOreDictUnificator.get(OrePrefixes.dust, Materials.Blaze, 1))
                .itemOutputs(ItemList.MSFMixture.get(1)).fluidInputs(Materials.Mercury.getFluid(500))
                .duration(15 * SECONDS).eut(64).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.Block_MSSFUEL.get(4)).fluidInputs(Materials.NitroFuel.getFluid(4_000))
                .duration(20 * SECONDS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Diamond, 1),
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.Block_MSSFUEL.get(4)).fluidInputs(Materials.NitroFuel.getFluid(3_000))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Diamond, 1),
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.Block_MSSFUEL.get(4)).fluidInputs(Materials.NitroFuel.getFluid(2_000))
                .duration(10 * SECONDS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Diamond, 1),
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.Block_MSSFUEL.get(4)).fluidInputs(Materials.GasolinePremium.getFluid(1_600))
                .duration(20 * SECONDS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Diamond, 1),
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.Block_MSSFUEL.get(4)).fluidInputs(Materials.GasolinePremium.getFluid(1_200))
                .duration(15 * SECONDS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);
        ...
        if (Thaumcraft.isModLoaded()) {
            GTValues.RA.stdBuilder()
                    ...
                    .duration(10 * SECONDS).eut(64).addTo(mixerRecipes);
            ...
            if (tFD != null && tFD.getFluid() != null && tFD.amount > 0) {
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTOreDictUnificator.get(OrePrefixes.dust, Materials.InfusedAir, 1),
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(ItemList.MSFMixture.get(30)).fluidInputs(tFD).duration(10 * SECONDS).eut(64)
                        .addTo(mixerRecipes);
                ...
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(ItemList.Block_MSSFUEL.get(1)).fluidInputs(Materials.NitroFuel.getFluid(1_000))
                        .duration(7 * SECONDS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);
                ...
                GTValues.RA.stdBuilder()
                        ...
                        .duration(6 * SECONDS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);
                ...
                GTValues.RA.stdBuilder()
                        ...
                        .duration(5 * SECONDS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.Block_SSFUEL.get(1)).fluidInputs(Materials.NitroFuel.getFluid(1_000))
                .duration(7 * SECONDS).eut(250).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(6 * SECONDS).eut(250).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(5 * SECONDS).eut(250).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.Cell_Empty.get(1)).fluidInputs(Materials.NitricAcid.getFluid(1_000))
                .fluidOutputs(new FluidStack(ItemList.sNitrationMixture, 2_000)).duration(24 * SECONDS).eut(2)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(24 * SECONDS).eut(2).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(2))
                .itemOutputs(getModItem(Forestry.ID, "fertilizerBio", 1L, 0)).fluidInputs(Materials.Water.getFluid(100))
                .duration(10 * SECONDS).eut(16).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(MaterialsOreAlum.SluiceSand.getDust(1))
                .fluidInputs(Materials.Water.getFluid(500)).fluidOutputs(MaterialsOreAlum.SluiceJuice.getFluid(1_000))
                .duration(5 * SECONDS).eut(16).addTo(mixerRecipes);

        // NaCl + H2O = (NaCl·H2O)

        GTValues.RA.stdBuilder().itemInputs(Materials.Salt.getDust(2), GTUtility.getIntegratedCircuit(3))
                .fluidInputs(Materials.Water.getFluid(1_000)).fluidOutputs(Materials.SaltWater.getFluid(1_000))
                .duration(5 * SECONDS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(Materials.CalciumAcetateSolution.getFluid(1_000)).duration(12 * SECONDS).eut(16)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.AceticAcid.getFluid(2_000)).fluidOutputs(Materials.Water.getFluid(1_000))
                .duration(12 * SECONDS).eut(16).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.AceticAcid.getFluid(2_000)).fluidOutputs(Materials.CarbonDioxide.getGas(1_000))
                .duration(12 * SECONDS).eut(16).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Empty.getCells(1),
                        GTUtility.getIntegratedCircuit(4))
                .itemOutputs(Materials.CarbonDioxide.getCells(1)).fluidInputs(Materials.AceticAcid.getFluid(2_000))
                .fluidOutputs(Materials.CalciumAcetateSolution.getFluid(1_000)).duration(12 * SECONDS).eut(16)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Empty.getCells(2),
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(Materials.Hydrogen.getCells(2)).fluidInputs(Materials.AceticAcid.getFluid(2_000))
                .fluidOutputs(Materials.CalciumAcetateSolution.getFluid(1_000)).duration(4 * SECONDS).eut(16)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(11))
                .itemOutputs(Materials.CalciumAcetateSolution.getCells(1))
                .fluidInputs(Materials.AceticAcid.getFluid(2_000)).fluidOutputs(Materials.Hydrogen.getGas(2_000))
                .duration(4 * SECONDS).eut(16).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Empty.getCells(1),
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(Materials.Water.getCells(1)).fluidInputs(Materials.AceticAcid.getFluid(2_000))
                .fluidOutputs(Materials.CalciumAcetateSolution.getFluid(1_000)).duration(4 * SECONDS).eut(16)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(Materials.Acetone.getCells(3)).itemOutputs(Materials.Empty.getCells(3))
                .fluidInputs(Materials.PolyvinylAcetate.getFluid(2_000))
                .fluidOutputs(Materials.AdvancedGlue.getFluid(5_000)).duration(5 * SECONDS).eut(8).addTo(mixerRecipes);

        GTValues.RA.stdBuilder().itemInputs(Materials.PolyvinylAcetate.getCells(2))
                .itemOutputs(Materials.Empty.getCells(2)).fluidInputs(Materials.Acetone.getFluid(3_000))
                .fluidOutputs(Materials.AdvancedGlue.getFluid(5_000)).duration(5 * SECONDS).eut(8).addTo(mixerRecipes);

        GTValues.RA.stdBuilder().itemInputs(Materials.MethylAcetate.getCells(3))
                .itemOutputs(Materials.Empty.getCells(3)).fluidInputs(Materials.PolyvinylAcetate.getFluid(2_000))
                .fluidOutputs(Materials.AdvancedGlue.getFluid(5_000)).duration(5 * SECONDS).eut(8).addTo(mixerRecipes);

        GTValues.RA.stdBuilder().itemInputs(Materials.PolyvinylAcetate.getCells(2))
                .itemOutputs(Materials.Empty.getCells(2)).fluidInputs(Materials.MethylAcetate.getFluid(3_000))
                .fluidOutputs(Materials.AdvancedGlue.getFluid(5_000)).duration(5 * SECONDS).eut(8).addTo(mixerRecipes);

        GTValues.RA.stdBuilder().itemInputs(Materials.Sugar.getDust(4)).itemOutputs(Materials.Charcoal.getGems(1))
                .fluidInputs(Materials.SulfuricAcid.getFluid(1_000))
                .fluidOutputs(Materials.DilutedSulfuricAcid.getFluid(1_000)).duration(60 * SECONDS).eut(2)
                .addTo(mixerRecipes);

        GTValues.RA.stdBuilder().itemInputs(Materials.Wood.getDust(4)).itemOutputs(Materials.Charcoal.getGems(1))
                .fluidInputs(Materials.SulfuricAcid.getFluid(1_000))
                .fluidOutputs(Materials.DilutedSulfuricAcid.getFluid(1_000)).duration(60 * SECONDS).eut(2)
                .addTo(mixerRecipes);

        GTValues.RA.stdBuilder().itemInputs(Materials.Fuel.getCells(1)).itemOutputs(Materials.Empty.getCells(1))
                .fluidInputs(Materials.Tetranitromethane.getFluid(20)).fluidOutputs(Materials.NitroFuel.getFluid(1_000))
                .duration(20 * TICKS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);

        GTValues.RA.stdBuilder().itemInputs(Materials.BioDiesel.getCells(1)).itemOutputs(Materials.Empty.getCells(1))
                .fluidInputs(Materials.Tetranitromethane.getFluid(40)).fluidOutputs(Materials.NitroFuel.getFluid(900))
                .duration(20 * TICKS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);

        // CH4O + C4H8 = C5H12O

        GTValues.RA.stdBuilder().itemInputs(Materials.Methanol.getCells(1), Materials.Butene.getCells(1))
                .itemOutputs(Materials.MTBEMixture.getCells(1), Materials.Empty.getCells(1)).duration(20 * TICKS)
                .eut(TierEU.RECIPE_HV).addTo(mixerRecipes);

        GTValues.RA.stdBuilder().itemInputs(Materials.Methanol.getCells(1), Materials.Butane.getCells(1))
                .itemOutputs(Materials.MTBEMixtureAlt.getCells(1), Materials.Empty.getCells(1)).duration(20 * TICKS)
                .eut(TierEU.RECIPE_HV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(Materials.GasolineRaw.getCells(20)).duration(5 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(Materials.Empty.getCells(29)).fluidInputs(Materials.AntiKnock.getFluid(3_000))
        ...
        if (Railcraft.isModLoaded()) {
            ...
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            GTOreDictUnificator.get(OrePrefixes.dust, Materials.Diamond, 1),
                            GTUtility.getIntegratedCircuit(1))
                    .itemOutputs(ItemList.Block_SSFUEL.get(4)).fluidInputs(Materials.GasolinePremium.getFluid(480))
                    .duration(10 * SECONDS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);
    ...
    public static void addMixerPotionRecipes(String aName) {
        ...
        if (splash)
            GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Gunpowder, 1))
    ...
    public void registerSingleBlockAndMulti() {
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(4))
                .itemOutputs(Materials.EnrichedHolmium.getDust(5)).duration(15 * SECONDS).eut(TierEU.RECIPE_ZPM)
                .addTo(mixerRecipes);
        ...
        // Catalysts for Plasma Forge.
        {
            GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(9))
                    ...
                    .duration(41 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_ZPM).addTo(mixerNonCellRecipes);

            GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(10))
                    .fluidInputs(
                    ...
                    .duration(41 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_UV).addTo(mixerNonCellRecipes);
            ...
            GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(11))
                    ...
                    .duration(41 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_UHV).addTo(mixerNonCellRecipes);
            ...
            GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(12))
                    ...
                    .duration(41 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_UEV).addTo(mixerNonCellRecipes);
            ...
            GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(13))
                    ...
                    .duration(41 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_UIV).addTo(mixerNonCellRecipes);
        }

        GTValues.RA.stdBuilder().itemInputs(ItemList.IC2_Spray_WeedEx.get(1))
                .fluidInputs(MaterialsKevlar.NaphthenicAcid.getFluid(10))
                .fluidOutputs(Materials.WeedEX9000.getFluid(750)).duration(5 * SECONDS).eut(100).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsUEVplus.DimensionallyTranscendentResidue.getFluid(5_000)).duration(15 * SECONDS)
                .eut((int) TierEU.RECIPE_UMV).addTo(mixerRecipes);
    }
}
