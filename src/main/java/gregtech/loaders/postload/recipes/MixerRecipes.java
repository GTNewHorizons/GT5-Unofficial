...
public class MixerRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Water.getFluid(1 * HALF_BUCKETS))
            .duration(20 * TICKS)
            .eut(16)
            .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                GTUtility.getIntegratedCircuit(1))
            .itemOutputs(GTOreDictUnificator.get(OrePrefixes.cell, Materials.Fuel, 6))
            .fluidInputs(Materials.LightFuel.getFluid(5 * BUCKETS))
            .duration(16 * TICKS)
            .eut(TierEU.RECIPE_MV)
            .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.HeavyFuel.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.Fuel.getFluid(6 * BUCKETS))
            .duration(16 * TICKS)
            .eut(TierEU.RECIPE_MV)
            .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Mercury.getFluid(1 * HALF_BUCKETS))
            .duration(15 * SECONDS)
            .eut(64)
            .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.NitroFuel.getFluid(4 * BUCKETS))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                GTUtility.getIntegratedCircuit(1))
            .itemOutputs(ItemList.Block_MSSFUEL.get(4))
            .fluidInputs(Materials.NitroFuel.getFluid(3 * BUCKETS))
            .duration(15 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                GTUtility.getIntegratedCircuit(1))
            .itemOutputs(ItemList.Block_MSSFUEL.get(4))
            .fluidInputs(Materials.NitroFuel.getFluid(2 * BUCKETS))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(mixerRecipes);
        ...
        if (Thaumcraft.isModLoaded()) {
            ...
            if (tFD != null && tFD.getFluid() != null && tFD.amount > 0) {
                ...
                GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(Materials.NitroFuel.getFluid(1 * BUCKETS))
                    .duration(7 * SECONDS)
                    .eut(TierEU.RECIPE_HV)
                    .addTo(mixerRecipes);
                ...
                GTValues.RA.stdBuilder()
                    .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                    .itemOutputs(ItemList.Block_MSSFUEL.get(1))
                    .fluidInputs(Materials.NitroFuel.getFluid(1 * HALF_BUCKETS))
                    .duration(5 * SECONDS)
                    .eut(TierEU.RECIPE_HV)
                    .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Helium.getGas(1 * QUARTER_BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Water.getFluid(1 * HALF_BUCKETS))
            .fluidOutputs(MaterialsOreAlum.SluiceJuice.getFluid(1 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(16)
            .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Water.getFluid(1 * BUCKETS))
            .fluidOutputs(Materials.SaltWater.getFluid(1 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.CalciumAcetateSolution.getFluid(1 * BUCKETS))
            .duration(12 * SECONDS)
            .eut(16)
            .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.PolyvinylAcetate.getFluid(2 * BUCKETS))
            .fluidOutputs(Materials.AdvancedGlue.getFluid(5 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Acetone.getFluid(3 * BUCKETS))
            .fluidOutputs(Materials.AdvancedGlue.getFluid(5 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(Materials.PolyvinylAcetate.getCells(2))
            .itemOutputs(Materials.Empty.getCells(2))
            .fluidInputs(Materials.MethylAcetate.getFluid(3 * BUCKETS))
            .fluidOutputs(Materials.AdvancedGlue.getFluid(5 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.NitroFuel.getFluid(1 * BUCKETS))
            .duration(20 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.AntiKnock.getFluid(3 * BUCKETS))
    ...
    public void registerSingleBlockAndMulti() {
        ...
        // Catalysts for Plasma Forge.
        {
            GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsUEVplus.DimensionallyTranscendentCrudeCatalyst.getFluid(1 * BUCKETS))
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialsUEVplus.DimensionallyTranscendentCrudeCatalyst.getFluid(1 * BUCKETS),
                ...
                .fluidOutputs(MaterialsUEVplus.DimensionallyTranscendentProsaicCatalyst.getFluid(1 * BUCKETS))
                .duration(41 * MINUTES + 40 * SECONDS)
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialsUEVplus.DimensionallyTranscendentProsaicCatalyst.getFluid(1 * BUCKETS),
                ...
                .fluidOutputs(MaterialsUEVplus.DimensionallyTranscendentResplendentCatalyst.getFluid(1 * BUCKETS))
                .duration(41 * MINUTES + 40 * SECONDS)
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialsUEVplus.DimensionallyTranscendentResplendentCatalyst.getFluid(1 * BUCKETS),
                ...
                .fluidOutputs(MaterialsUEVplus.DimensionallyTranscendentExoticCatalyst.getFluid(1 * BUCKETS))
                .duration(41 * MINUTES + 40 * SECONDS)
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialsUEVplus.DimensionallyTranscendentExoticCatalyst.getFluid(1 * BUCKETS),
                ...
                .fluidOutputs(MaterialsUEVplus.DimensionallyTranscendentStellarCatalyst.getFluid(1 * BUCKETS))
                .duration(41 * MINUTES + 40 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialsUEVplus.DimensionallyTranscendentResidue.getFluid(5 * BUCKETS))
            .duration(15 * SECONDS)
