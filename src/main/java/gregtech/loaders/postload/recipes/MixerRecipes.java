...
public class MixerRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.EnderPearl, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Blaze, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.EnderEye, OrePrefixes.dust.mMaterialAmount))
            .duration(5 * SECONDS)
            .eut(48)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.Electrum, 2L * OrePrefixes.dust.mMaterialAmount))
            .duration(10 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 2),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.Invar, 3L * OrePrefixes.dust.mMaterialAmount))
            .duration(15 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 4),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Invar, 3),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Manganese, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Chrome, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.StainlessSteel, 9L * OrePrefixes.dust.mMaterialAmount))
            .duration(45 * SECONDS)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminium, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Chrome, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.Kanthal, 3L * OrePrefixes.dust.mMaterialAmount))
            .duration(15 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Copper, 3),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Zinc, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.Brass, 4L * OrePrefixes.dust.mMaterialAmount))
            .duration(2 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.Bronze, 4L * OrePrefixes.dust.mMaterialAmount))
            .duration(2 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(OreDictUnificator.getDust(Materials.Cupronickel, 2L * OrePrefixes.dust.mMaterialAmount))
            .duration(10 * SECONDS)
            .eut(24)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Copper, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Silver, 4),
                GT_Utility.getIntegratedCircuit(4))
            .itemOutputs(OreDictUnificator.getDust(Materials.SterlingSilver, 5L * OrePrefixes.dust.mMaterialAmount))
            .duration(25 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Copper, 3),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Electrum, 2),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.BlackBronze, 5L * OrePrefixes.dust.mMaterialAmount))
            .duration(25 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Bismuth, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Brass, 4),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.BismuthBronze, 5L * OrePrefixes.dust.mMaterialAmount))
            .duration(25 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.BlackBronze, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Steel, 3),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.BlackSteel, 5L * OrePrefixes.dust.mMaterialAmount))
            .duration(25 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.SterlingSilver, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.BismuthBronze, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.BlackSteel, 4),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Steel, 2),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.RedSteel, 8L * OrePrefixes.dust.mMaterialAmount))
            .duration(40 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.RoseGold, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Brass, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.BlackSteel, 4),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Steel, 2),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.BlueSteel, 8L * OrePrefixes.dust.mMaterialAmount))
            .duration(40 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.dust, Materials.Gold, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Silver, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 5),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Steel, 15),
                GT_Utility.getIntegratedCircuit(14))
            .itemOutputs(OreDictUnificator.getDust(Materials.BlackSteel, 25L * OrePrefixes.dust.mMaterialAmount))
            .duration(40 * SECONDS)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Copper, 4),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Silver, 4),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Bismuth, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Zinc, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.BlackSteel, 20),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Steel, 10),
                GT_Utility.getIntegratedCircuit(15))
            .itemOutputs(OreDictUnificator.getDust(Materials.RedSteel, 40L * OrePrefixes.dust.mMaterialAmount))
            .duration(60 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Copper, 19),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Gold, 16),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Zinc, 5),
                OreDictUnificator.get(OrePrefixes.dust, Materials.BlackSteel, 64),
                OreDictUnificator.get(OrePrefixes.dust, Materials.BlackSteel, 16),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Steel, 40),
                GT_Utility.getIntegratedCircuit(16))
            .itemOutputs(
                OreDictUnificator.getDust(Materials.BlueSteel, 64L * OrePrefixes.dust.mMaterialAmount),
                OreDictUnificator.getDust(Materials.BlueSteel, 64L * OrePrefixes.dust.mMaterialAmount),
                OreDictUnificator.getDust(Materials.BlueSteel, 32L * OrePrefixes.dust.mMaterialAmount))
            .duration(3 * MINUTES)
            .eut(TierEU.RECIPE_HV)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Cobalt, 5),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Chrome, 2),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Molybdenum, 1),
                GT_Utility.getIntegratedCircuit(2))
            .itemOutputs(OreDictUnificator.getDust(Materials.Ultimet, 9L * OrePrefixes.dust.mMaterialAmount))
            .duration(45 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Brass, 7),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminium, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Cobalt, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.CobaltBrass, 9L * OrePrefixes.dust.mMaterialAmount))
            .duration(45 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Saltpeter, 2),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Coal, 3),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.Gunpowder, 6L * OrePrefixes.dust.mMaterialAmount))
            .duration(30 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Saltpeter, 2),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Charcoal, 3),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.Gunpowder, 6L * OrePrefixes.dust.mMaterialAmount))
            .duration(30 * SECONDS)
            .eut(8)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Saltpeter, 2),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Carbon, 3),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.Gunpowder, 6L * OrePrefixes.dust.mMaterialAmount))
            .duration(30 * SECONDS)
            .eut(8)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Indium, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Gallium, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Phosphorus, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(
                OreDictUnificator.getDust(Materials.IndiumGalliumPhosphide, 3L * OrePrefixes.dust.mMaterialAmount))
            .duration(10 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Brick, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Clay, 1))
            .itemOutputs(OreDictUnificator.getDust(Materials.Fireclay, 2L * OrePrefixes.dust.mMaterialAmount))
            .duration(10 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 4),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Chrome, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.Nichrome, 5L * OrePrefixes.dust.mMaterialAmount))
            .duration(25 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Osmium, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Iridium, 3),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.Osmiridium, 4L * OrePrefixes.dust.mMaterialAmount))
            .duration(2 * SECONDS)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Niobium, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Titanium, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.NiobiumTitanium, 2L * OrePrefixes.dust.mMaterialAmount))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Vanadium, 3),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Gallium, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.VanadiumGallium, 4L * OrePrefixes.dust.mMaterialAmount))
            .duration(2 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Tungsten, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Carbon, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.TungstenCarbide, 2L * OrePrefixes.dust.mMaterialAmount))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Tungsten, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Steel, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.TungstenSteel, 2L * OrePrefixes.dust.mMaterialAmount))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Titanium, 3),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Platinum, 3),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Vanadium, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.TPV, 7L * OrePrefixes.dust.mMaterialAmount))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.TungstenSteel, 5),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Chrome, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Molybdenum, 2),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Vanadium, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.HSSG, 9L * OrePrefixes.dust.mMaterialAmount))
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_EV)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.HSSG, 6),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Cobalt, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Manganese, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Silicon, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.getDust(Materials.HSSE, 9L * OrePrefixes.dust.mMaterialAmount))
            .duration(35 * SECONDS)
            .eut(4096)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.HSSG, 6),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Iridium, 2),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Osmium, 1),
                GT_Utility.getIntegratedCircuit(2))
            .itemOutputs(OreDictUnificator.getDust(Materials.HSSS, 9L * OrePrefixes.dust.mMaterialAmount))
            .duration(40 * SECONDS)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 4),
                GT_Utility.getIntegratedCircuit(3))
            .itemOutputs(OreDictUnificator.getDust(Materials.FerriteMixture, 6L * OrePrefixes.dust.mMaterialAmount))
            .duration(10 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Boron, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Glass, 7))
            .itemOutputs(OreDictUnificator.getDust(Materials.BorosilicateGlass, 8L * OrePrefixes.dust.mMaterialAmount))
            .duration(10 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.dust, Materials.MeatRaw, 1))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(OreDictUnificator.get(OrePrefixes.dust, Materials.Wheat, 1))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(OreDictUnificator.get(OrePrefixes.dust, Materials.Chili, 1), ItemList.Food_PotatoChips.get(1))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Redstone, 5),
                OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Ruby, 4))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone, 5),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Ruby, 4))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Gold, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.LiveRoot, 1))
            .itemOutputs(OreDictUnificator.get(OrePrefixes.dust, Materials.IronWood, 2))
            .duration(5 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Gold, 1),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 9),
                OreDictUnificator.get(OrePrefixes.dust, Materials.LiveRoot, 9))
            .itemOutputs(OreDictUnificator.get(OrePrefixes.dust, Materials.IronWood, 18))
            .duration(45 * SECONDS)
            .eut(8)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.gem, Materials.NetherQuartz, 1))
            .itemOutputs(OreDictUnificator.get(OrePrefixes.gem, Materials.Fluix, 2))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.cell, Materials.LightFuel, 5),
                OreDictUnificator.get(OrePrefixes.cell, Materials.HeavyFuel, 1))
            .itemOutputs(OreDictUnificator.get(OrePrefixes.cell, Materials.Fuel, 6))
            .duration(16 * TICKS)
            .eut(TierEU.RECIPE_MV)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.dust, Materials.Stone, 1))
            .itemOutputs(Materials.Empty.getCells(5))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(OreDictUnificator.get(OrePrefixes.dust, Materials.Lapis, 1), GT_Utility.getIntegratedCircuit(4))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.dust, Materials.Wood, 4),
                GT_Utility.getIntegratedCircuit(1))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(ItemList.SFMixture.get(2), OreDictUnificator.get(OrePrefixes.dust, Materials.EnderEye, 1))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(ItemList.SFMixture.get(1), OreDictUnificator.get(OrePrefixes.dust, Materials.Blaze, 1))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.block, Materials.Lignite, 4),
                ItemList.MSFMixture.get(24),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Diamond, 1),
                GT_Utility.getIntegratedCircuit(1))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.block, Materials.Charcoal, 4),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.block, Materials.Coal, 4),
        ...
        if (Thaumcraft.isModLoaded()) {
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.dust, Materials.InfusedAir, 1),
                    GT_Utility.getIntegratedCircuit(1))
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ItemList.SFMixture.get(20),
                    OreDictUnificator.get(OrePrefixes.dust, Materials.InfusedEarth, 1),
                    GT_Utility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.MSFMixture.get(20))
                .fluidInputs(Materials.FierySteel.getFluid(50))
                .duration(10 * SECONDS)
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ItemList.SFMixture.get(20),
                    OreDictUnificator.get(OrePrefixes.dust, Materials.InfusedEntropy, 1),
                    GT_Utility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.MSFMixture.get(20))
                .fluidInputs(Materials.FierySteel.getFluid(50))
                .duration(10 * SECONDS)
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ItemList.SFMixture.get(20),
                    OreDictUnificator.get(OrePrefixes.dust, Materials.InfusedFire, 1),
                    GT_Utility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.MSFMixture.get(20))
                .fluidInputs(Materials.FierySteel.getFluid(50))
                .duration(10 * SECONDS)
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ItemList.SFMixture.get(20),
                    OreDictUnificator.get(OrePrefixes.dust, Materials.InfusedOrder, 1),
                    GT_Utility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.MSFMixture.get(20))
                .fluidInputs(Materials.FierySteel.getFluid(50))
                .duration(10 * SECONDS)
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ItemList.SFMixture.get(20),
                    OreDictUnificator.get(OrePrefixes.dust, Materials.InfusedWater, 1),
                    GT_Utility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.MSFMixture.get(20))
                .fluidInputs(Materials.FierySteel.getFluid(50))
                .duration(10 * SECONDS)
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.cell, Materials.SulfuricAcid, 1),
                GT_Utility.getIntegratedCircuit(1))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.cell, Materials.SulfuricAcid, 1),
                OreDictUnificator.get(OrePrefixes.cell, Materials.NitricAcid, 1),
                GT_Utility.getIntegratedCircuit(1))
            .itemOutputs(OreDictUnificator.get(OrePrefixes.cell, Materials.NitrationMixture, 2))
            .duration(24 * SECONDS)
            .eut(2)
            .addTo(mixerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                new ItemStack(Blocks.dirt, 1, 32767),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Ash, 4),
                GT_Utility.getIntegratedCircuit(3))
            .itemOutputs(getModItem(Forestry.ID, "fertilizerBio", 1L, 0))
            .fluidInputs(Materials.Water.getFluid(100))
            .duration(10 * SECONDS)
    ...
    public static void addMixerPotionRecipes(String aName) {
        ...
        if (splash) GT_Values.RA.stdBuilder()
            .itemInputs(OreDictUnificator.get(OrePrefixes.dust, Materials.Gunpowder, 1))
