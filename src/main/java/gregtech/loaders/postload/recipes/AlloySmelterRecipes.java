    ...
    public void run() {
        for (MaterialStack[] materials : mAlloySmelterList) {
            ...
            if (outputIngot != GTValues.NI) {
                if (ingot1 != null) {
                    GTValues.RA.stdBuilder().itemInputs(ingot1, dust2).itemOutputs(outputIngot)
                            .duration((int) materials[2].mAmount * 50).eut(16).addTo(alloySmelterRecipes);
                    if (ingot2 != null) {
                        GTValues.RA.stdBuilder().itemInputs(ingot1, ingot2).itemOutputs(outputIngot)
                                .duration((int) materials[2].mAmount * 50).eut(16).addTo(alloySmelterRecipes);
                    }
                }

                if (ingot2 != null) {
                    GTValues.RA.stdBuilder().itemInputs(dust1, ingot2).itemOutputs(outputIngot)
                            .duration((int) materials[2].mAmount * 50).eut(16).addTo(alloySmelterRecipes);
                }

                GTValues.RA.stdBuilder().itemInputs(dust1, dust2).itemOutputs(outputIngot)
                        .duration((int) materials[2].mAmount * 50).eut(16).addTo(alloySmelterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Rubber, 1L)).duration(10 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(new ItemStack(ItemRegistry.PUMPPARTS, 1, 0)).duration(15 * SECONDS).eut(8)
