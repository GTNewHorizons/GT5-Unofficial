...
public class AlloySmelterRecipes implements Runnable {
    ...
    public void run() {
        for (MaterialStack[] materials : mAlloySmelterList) {
            ...
            ItemStack ingot1 = GT_OreDictUnificator.get(OrePrefixes.ingot, materials[0].mMaterial, materials[0].mAmount);
            ItemStack ingot2 = GT_OreDictUnificator.get(OrePrefixes.ingot, materials[1].mMaterial, materials[1].mAmount);
            ItemStack outputIngot = GT_OreDictUnificator.get(OrePrefixes.ingot, materials[2].mMaterial, materials[2].mAmount);
