...
public class ChemicalBathRecipes implements Runnable {
    ...
    public void run() {
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ItemList.Food_Raw_Fries.get(1)
            )
            .itemOutputs(
                ItemList.Food_Fries.get(1)
            )
            .fluidInputs(
                Materials.FryingOilHot.getFluid(10)
            )
            .noFluidOutputs()
            .duration(16 * TICKS)
            .eut(4)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_ModHandler.getIC2Item("stickyDynamite", 1)
            )
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_ModHandler.getIC2Item("reinforcedStone", 1)
            )
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.HydratedCoal, 1)
            )
            .fluidInputs(
        ...
        for (ItemStack paperSource: paperSources) {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    GT_ModHandler.getDistilledWater(100)
                )
                .noFluidOutputs()
                .duration(10 * SECONDS)
                .eut(4)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(
                GT_ModHandler.getDistilledWater(125)
            )
            .noFluidOutputs()
            .duration(12 * TICKS)
            .eut(4)
        ...
        for (int i=0;i<8;i++) {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    GT_ModHandler.getDistilledWater(250)
                )
                .noFluidOutputs()
                .duration(10 * SECONDS)
                .eut(4)
        ...
        // reinforced blocks
        {
            GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(
                    ItemList.Block_BronzePlate.get(1)
                )
                .fluidInputs(
                    Materials.Concrete.getMolten(144)
                )
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(
                    ItemList.Block_SteelPlate.get(1)
                )
                .fluidInputs(
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(
                    ItemList.Block_TitaniumPlate.get(1)
                )
                .fluidInputs(
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(
                    ItemList.Block_NaquadahPlate.get(1)
                )
                .fluidInputs(
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(
                    ItemList.Block_NeutroniumPlate.get(1)
                )
                .fluidInputs(
        ...
        for (int j = 0; j < Dyes.dyeGreen.getSizeOfFluidList(); j++) {
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    Dyes.dyeGreen.getFluidDye(j, 72)
                )
                .noFluidOutputs()
                .duration(1 * SECONDS + 12 * TICKS)
                .eut(16)
        ...
        for (int j = 0; j < Dyes.dyeYellow.getSizeOfFluidList(); j++) {
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    Dyes.dyeYellow.getFluidDye(j, 72)
                )
                .noFluidOutputs()
                .duration(1 * SECONDS + 12 * TICKS)
                .eut(16)
            ...
            for (int j = 0; j < Dyes.VALUES[i].getSizeOfFluidList(); j++) {
                if (i != 15) {
                    GT_Values.RA.stdBuilder()
                        ...
                        .fluidInputs(
                            Dyes.VALUES[i].getFluidDye(j, 72)
                        )
                        .noFluidOutputs()
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .fluidInputs(
                        Dyes.VALUES[i].getFluidDye(j, 18)
                    )
                    .noFluidOutputs()
                    .duration(3 * SECONDS + 4 * TICKS)
                    .eut(2)
        ...
        for (Materials material : materialList){
            GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(
                    Materials.SodiumPersulfate.getFluid(100)
                )
                .noFluidOutputs()
                .duration(40 * SECONDS)
                .eut(8)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                getModItem(Railcraft.modID, "cube", 1, 8)
            )
            .fluidInputs(
                Materials.Creosote.getFluid(100)
            )
            .noFluidOutputs()
            .duration(5 * SECONDS)
            .eut(4)
