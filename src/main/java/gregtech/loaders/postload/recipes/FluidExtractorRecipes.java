...
public class FluidExtractorRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTOreDictUnificator.get(OrePrefixes.block, Materials.GraniteBlack, 1))
            .fluidOutputs(Materials.GraniteBlack.getFluid(1 * INGOTS))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTOreDictUnificator.get(OrePrefixes.block, Materials.GraniteRed, 1))
            .fluidOutputs(Materials.GraniteRed.getFluid(1 * INGOTS))
            .duration(6 * SECONDS + 8 * TICKS)
            .eut(4)
            .recipeCategory(RecipeCategories.fluidExtractorRecycling)
            .addTo(fluidExtractionRecipes);
