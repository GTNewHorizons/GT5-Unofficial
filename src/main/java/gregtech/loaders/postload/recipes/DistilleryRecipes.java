...
public class DistilleryRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(24))
                .fluidInputs(Materials.Creosote.getFluid(25)).fluidOutputs(Materials.Lubricant.getFluid(8))
                .duration(3 * SECONDS).eut(30).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(24))
                .fluidInputs(Materials.SeedOil.getFluid(8)).fluidOutputs(Materials.Lubricant.getFluid(2))
                .duration(1 * SECONDS).eut(30).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(24))
                .fluidInputs(Materials.FishOil.getFluid(8)).fluidOutputs(Materials.Lubricant.getFluid(2))
                .duration(1 * SECONDS).eut(30).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(24)).fluidInputs(Materials.Oil.getFluid(12))
                .fluidOutputs(Materials.Lubricant.getFluid(6)).duration(16 * TICKS).eut(30).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(24))
                .fluidInputs(Materials.OilLight.getFluid(12)).fluidOutputs(Materials.Lubricant.getFluid(3))
                .duration(16 * TICKS).eut(30).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(24))
                .fluidInputs(Materials.OilMedium.getFluid(12)).fluidOutputs(Materials.Lubricant.getFluid(6))
                .duration(16 * TICKS).eut(30).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(24))
                .fluidInputs(Materials.OilHeavy.getFluid(12)).fluidOutputs(Materials.Lubricant.getFluid(9))
                .duration(16 * TICKS).eut(30).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(5))
                .fluidInputs(Materials.Biomass.getFluid(40)).fluidOutputs(Materials.Water.getFluid(12))
                .duration(16 * TICKS).eut(24).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().fluidInputs(Materials.Water.getFluid(10))
                .fluidOutputs(GTModHandler.getDistilledWater(10)).duration(1 * SECONDS + 5 * TICKS).eut(8)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .duration(16 * TICKS).eut(16).addTo(distilleryRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .fluidInputs(MaterialsOreAlum.SluiceJuice.getFluid(1_000)).fluidOutputs(Materials.Water.getFluid(500))
                .duration(5 * SECONDS).eut(16).addTo(distilleryRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(7))
                .fluidInputs(Materials.WoodTar.getFluid(200))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1)).itemOutputs(Materials.Salt.getDust(2))
                .fluidInputs(Materials.SaltWater.getFluid(1_000)).fluidOutputs(GTModHandler.getDistilledWater(1_000))
                .duration(1 * MINUTES + 20 * SECONDS).eut(30).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.IC2_Fertilizer.get(1)).fluidInputs(Materials.FermentedBiomass.getFluid(1_000))
                .fluidOutputs(Materials.AceticAcid.getFluid(25)).duration(1 * MINUTES + 15 * SECONDS).eut(8)
                .addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                .itemOutputs(ItemList.IC2_Fertilizer.get(1)).fluidInputs(Materials.FermentedBiomass.getFluid(1_000))
                .fluidOutputs(Materials.Water.getFluid(375)).duration(1 * MINUTES + 15 * SECONDS).eut(8)
                .addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(3))
                .itemOutputs(ItemList.IC2_Fertilizer.get(1)).fluidInputs(Materials.FermentedBiomass.getFluid(1_000))
                .fluidOutputs(Materials.Ethanol.getFluid(150)).duration(1 * MINUTES + 15 * SECONDS).eut(8)
                .addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(4))
                .itemOutputs(ItemList.IC2_Fertilizer.get(1)).fluidInputs(Materials.FermentedBiomass.getFluid(1_000))
                .fluidOutputs(Materials.Methanol.getFluid(150)).duration(1 * MINUTES + 15 * SECONDS).eut(8)
                .addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(5))
                .itemOutputs(ItemList.IC2_Fertilizer.get(1)).fluidInputs(Materials.FermentedBiomass.getFluid(1_000))
                .fluidOutputs(Materials.Ammonia.getGas(100)).duration(1 * MINUTES + 15 * SECONDS).eut(8)
                .addTo(distilleryRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(7))
                .itemOutputs(ItemList.IC2_Fertilizer.get(1)).fluidInputs(Materials.FermentedBiomass.getFluid(1_000))
                .fluidOutputs(Materials.Methane.getGas(600)).duration(1 * MINUTES + 15 * SECONDS).eut(8)
                .addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(17))
                .itemOutputs(ItemList.IC2_Fertilizer.get(1)).fluidInputs(Materials.FermentedBiomass.getFluid(1_000))
                .fluidOutputs(new FluidStack(FluidRegistry.getFluid("ic2biogas"), 1_800))
                .duration(1 * MINUTES + 20 * SECONDS).eut(8).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .fluidInputs(Materials.Methane.getGas(100))
                .fluidOutputs(new FluidStack(FluidRegistry.getFluid("ic2biogas"), 300)).duration(16 * TICKS).eut(8)
                .addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                .fluidInputs(Materials.HeavyFuel.getFluid(100)).fluidOutputs(Materials.Benzene.getFluid(40))
                .duration(8 * SECONDS).eut(24).addTo(distilleryRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .fluidInputs(Materials.HeavyFuel.getFluid(10)).fluidOutputs(new FluidStack(ItemList.sToluene, 4))
                .duration(16 * TICKS).eut(24).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .fluidInputs(new FluidStack(ItemList.sToluene, 30)).fluidOutputs(Materials.LightFuel.getFluid(30))
                .duration(16 * TICKS).eut(24).addTo(distilleryRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                ...
                .fluidOutputs(Materials.Water.getFluid(2)).duration(4 * SECONDS).eut(30).addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .fluidInputs(getFluidStack("potion.wheatyjuice", 75)).fluidOutputs(getFluidStack("potion.scotch", 1))
                .duration(1 * SECONDS).eut(TierEU.RECIPE_MV).addTo(distilleryRecipes);

        if (TinkerConstruct.isModLoaded()) {

            GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                    .fluidInputs(Materials.Glue.getFluid(8)).fluidOutputs(getFluidStack("glue", 8)).duration(1 * TICKS)
                    .eut(24).addTo(distilleryRecipes);

            GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1)).fluidInputs(getFluidStack("glue", 8))
                    .fluidOutputs(Materials.Glue.getFluid(4)).duration(1 * TICKS).eut(24).addTo(distilleryRecipes);
    ...
    public void distillationTowerRecipes() {
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                .fluidInputs(Materials.Creosote.getFluid(1_000)).fluidOutputs(Materials.Lubricant.getFluid(500))
                .duration(20 * SECONDS).eut(TierEU.RECIPE_MV).addTo(distillationTowerRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                .fluidInputs(Materials.SeedOil.getFluid(1_400)).fluidOutputs(Materials.Lubricant.getFluid(500))
                .duration(20 * SECONDS).eut(TierEU.RECIPE_MV).addTo(distillationTowerRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                .fluidInputs(Materials.FishOil.getFluid(1_200)).fluidOutputs(Materials.Lubricant.getFluid(500))
                .duration(20 * SECONDS).eut(TierEU.RECIPE_MV).addTo(distillationTowerRecipes);

        GTValues.RA.stdBuilder().itemOutputs(GTOreDictUnificator.get(OrePrefixes.dustSmall, Materials.Wood, 2L))
                .fluidInputs(Materials.Biomass.getFluid(1_000))
                .fluidOutputs(Materials.Ethanol.getFluid(600), Materials.Water.getFluid(300))
                .duration(1 * SECONDS + 12 * TICKS).eut(400).addTo(distillationTowerRecipes);

        GTValues.RA.stdBuilder().fluidInputs(Materials.Water.getFluid(1_000))
                .fluidOutputs(GTModHandler.getDistilledWater(1_000)).duration(1 * SECONDS + 12 * TICKS)
                .eut(TierEU.RECIPE_MV).addTo(distillationTowerRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                .fluidInputs(Materials.OilLight.getFluid(1_000)).fluidOutputs(Materials.Lubricant.getFluid(250))
                .duration(20 * SECONDS).eut(TierEU.RECIPE_MV).addTo(distillationTowerRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                .fluidInputs(Materials.OilMedium.getFluid(1_000)).fluidOutputs(Materials.Lubricant.getFluid(500))
                .duration(20 * SECONDS).eut(TierEU.RECIPE_MV).addTo(distillationTowerRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                .fluidInputs(Materials.OilHeavy.getFluid(1_000)).fluidOutputs(Materials.Lubricant.getFluid(750))
                .duration(20 * SECONDS).eut(TierEU.RECIPE_MV).addTo(distillationTowerRecipes);
        // C15H10N2O2(5HCl) = C15H10N2O2 + 5HCl

        GTValues.RA.stdBuilder()
                .itemOutputs(
                        GTOreDictUnificator.get(OrePrefixes.dust, MaterialsKevlar.DiphenylmethaneDiisocyanate, 29L))
                .fluidInputs(MaterialsKevlar.DiphenylmethaneDiisocyanateMixture.getFluid(1_000))
                .fluidOutputs(Materials.HydrochloricAcid.getFluid(5_000)).duration(2 * MINUTES + 5 * SECONDS)
                .eut(TierEU.RECIPE_EV).addTo(distillationTowerRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                .itemOutputs(Materials.Charcoal.getDustSmall(1)).fluidInputs(Materials.CharcoalByproducts.getGas(1_000))
                .fluidOutputs(
                ...
                .duration(2 * SECONDS).eut(256).addTo(distillationTowerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(9))
                ...
                .duration(1 * SECONDS + 1 * TICKS).eut(TierEU.RECIPE_HV).addTo(distillationTowerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(9))
                ...
                .duration(1 * SECONDS + 12 * TICKS).eut(TierEU.RECIPE_HV).addTo(distillationTowerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(9))
                ...
                .duration(3 * SECONDS + 4 * TICKS).eut(TierEU.RECIPE_HV).addTo(distillationTowerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(9))
                ...
                .fluidOutputs(
                        ...
                        MaterialsKevlar.NaphthenicAcid.getFluid(50),
                        Materials.SulfuricGas.getGas(600))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_HV).addTo(distillationTowerRecipes);
        // 9C5H12O = 4C6H14O + 5CH4O + 4C4H8

        GTValues.RA.stdBuilder().fluidInputs(Materials.MTBEMixture.getGas(900))
                .fluidOutputs(
                        Materials.AntiKnock.getFluid(400),
                        Materials.Methanol.getFluid(500),
                        Materials.Butene.getGas(400))
                .duration(2 * SECONDS).eut(TierEU.RECIPE_MV).addTo(distillationTowerRecipes);

        GTValues.RA.stdBuilder().fluidInputs(Materials.MTBEMixtureAlt.getGas(900))
                .fluidOutputs(
                        Materials.AntiKnock.getFluid(400),
                        Materials.Methanol.getFluid(500),
        ...
        GTValues.RA.stdBuilder().itemOutputs(ItemList.IC2_Fertilizer.get(1))
                ...
                .duration(3 * SECONDS + 15 * TICKS).eut(TierEU.RECIPE_MV).addTo(distillationTowerRecipes);
        ...
        GTValues.RA.stdBuilder().itemOutputs(ItemList.IC2_Fertilizer.get(1))
                ...
                .duration(12 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_HV).addTo(distillationTowerRecipes);
        GTValues.RA.stdBuilder().fluidInputs(new FluidStack(ItemList.sOilExtraHeavy, 1_000))
                .fluidOutputs(Materials.OilHeavy.getFluid(1_500)).duration(16 * TICKS).eut(2400)
    ...
    public void addUniversalDistillationRecipewithCircuit(FluidStack aInput, ItemStack[] aCircuit,
        ...
        for (int i = 0; i < Math.min(aOutputs.length, 11); i++) {
            ...
            buildDistillation.fluidInputs(aInputDivided).fluidOutputs(aOutputDivided).duration(2 * aDuration / ratio)
                    .eut(aEUt / 4).addTo(distilleryRecipes);
        }
    }
