...
public class NaniteChain {
    ...
    public static void run() {
        ...
        // Nano Forge
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, Materials.Carbon.getNanite(1))
                ...
                .itemOutputs(ItemList.NanoForge.get(1)).eut(TierEU.RECIPE_ZPM).duration(5 * MINUTES)
                .addTo(AssemblyLine);

        // Carbon Nanite Recipe Before Nano Forge
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Circuit_Crystalmainframe.get(1))
                ...
                .fluidInputs(
                        Materials.UUMatter.getFluid(10_000),
                        MaterialsAlloy.INDALLOY_140.getFluidStack(32 * INGOTS))
                .itemOutputs(Materials.Carbon.getNanite(2)).eut(TierEU.RECIPE_UV).duration(50 * SECONDS)
                .addTo(AssemblyLine);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(Materials.Carbon.getNanite(64)).fluidInputs(Materials.UUMatter.getFluid(200_000))
                .metadata(NANO_FORGE_TIER, 1).duration(8 * MINUTES + 20 * SECONDS).eut(10_000_000)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(Materials.Silver.getNanite(1)).fluidInputs(Materials.UUMatter.getFluid(200_000))
                .metadata(NANO_FORGE_TIER, 2).duration(12 * MINUTES + 30 * SECONDS).eut(10_000_000)
                .addTo(nanoForgeRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(Materials.Neutronium.getNanite(1)).fluidInputs(Materials.UUMatter.getFluid(200_000))
                .metadata(NANO_FORGE_TIER, 1).duration(1 * MINUTES + 40 * SECONDS).eut(100_000_000)
                .addTo(nanoForgeRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        ItemList.Circuit_Chip_SoC2.get(64))
                .itemOutputs(Materials.Glowstone.getNanite(64)).fluidInputs(Materials.UUMatter.getFluid(50_000))
                .metadata(NANO_FORGE_TIER, 2).duration(3 * MINUTES + 20 * SECONDS).eut(50_000_000)
                .addTo(nanoForgeRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(Materials.Gold.getNanite(1)).fluidInputs(Materials.UUMatter.getFluid(300_000))
                .metadata(NANO_FORGE_TIER, 3).duration(16 * MINUTES + 40 * SECONDS).eut(100_000_000)
                .addTo(nanoForgeRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.UUMatter.getFluid(2_000_000)).metadata(NANO_FORGE_TIER, 2)
                .duration(12 * MINUTES + 30 * SECONDS).eut(1_000_000_000).addTo(nanoForgeRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .metadata(NANO_FORGE_TIER, 3).duration(100 * SECONDS).eut(2_000_000_000).addTo(nanoForgeRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .metadata(NANO_FORGE_TIER, 3).duration(12 * MINUTES + 30 * SECONDS).eut(2_000_000_000)
                .addTo(nanoForgeRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(
                ...
                getModItem(NewHorizonsCoreMod.ID, "item.PicoWafer", 32),
                ItemList.Timepiece.get(4)).itemOutputs(MaterialsUEVplus.Eternity.getNanite(4))
                .fluidInputs(
                        MaterialsUEVplus.Space.getMolten(8 * INGOTS),
                        MaterialsUEVplus.ExcitedDTSC.getFluid(50_000),
                        MaterialsUEVplus.PrimordialMatter.getFluid(64_000))
                .metadata(NANO_FORGE_TIER, 3).duration(12 * MINUTES + 30 * SECONDS).eut(TierEU.RECIPE_MAX)
                .addTo(nanoForgeRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .metadata(NANO_FORGE_TIER, 4).duration(16 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_MAX)
                .addTo(nanoForgeRecipes);
    }
}
