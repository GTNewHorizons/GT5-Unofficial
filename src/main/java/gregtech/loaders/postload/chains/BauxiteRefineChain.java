...
public class BauxiteRefineChain {
    ...
    public static void run() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialsOreAlum.BauxiteSlurry.getFluid(8_000))
            .duration(10 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(MaterialsOreAlum.HeatedBauxiteSlurry.getFluid(2_000))
            .duration(2 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialsOreAlum.SapphireJuice.getFluid(1_000))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialsOreAlum.RubyJuice.getFluid(1_000))
            .fluidOutputs(Materials.HydrochloricAcid.getFluid(1_000))
            .duration(2 * SECONDS + 5 * TICKS)
            .eut(100)
            .addTo(centrifugeRecipes);
