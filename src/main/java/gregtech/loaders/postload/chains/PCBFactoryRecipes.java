...
public class PCBFactoryRecipes {
    ...
    public static void load() {
        // Load Multi Recipes
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Circuit_Board_Wetware.get(1))
                ...
                .itemOutputs(ItemList.PCBFactory.get(1)).eut(TierEU.RECIPE_UV).duration(5 * MINUTES)
                .addTo(AssemblyLine);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.BasicPhotolithographicFrameworkCasing.get(1)).duration(30 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.ReinforcedPhotolithographicFrameworkCasing.get(1)).duration(30 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.RadiationProofPhotolithographicFrameworkCasing.get(1)).duration(30 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsUEVplus.SpaceTime.getMolten(8 * INGOTS)).duration(10 * SECONDS)
        ...
        for (int tier = 1; tier <= PCBFactoryManager.mTiersOfPlastics; tier++) {
            ...
            GTValues.RA.stdBuilder().itemInputs(
                    ...
                    PCBFactoryManager.getPlasticMaterialFromTier(tier).getPlates(1),
                    GTOreDictUnificator
                    ...
                    .eut((int) GTValues.VP[tier] * 3 / 4).metadata(TIER, 1).addTo(RecipeMaps.pcbFactoryRecipes);
        }
        for (int tier = 1; tier <= PCBFactoryManager.mTiersOfPlastics; tier++) {
            ...
            GTValues.RA.stdBuilder().itemInputs(
                    ...
                    .eut((int) GTValues.VP[tier + 1] * 3 / 4).metadata(TIER, 2)
                    .metadata(PCB_NANITE_MATERIAL, Materials.Silver).addTo(RecipeMaps.pcbFactoryRecipes);
        }
        for (int tier = 1; tier <= PCBFactoryManager.mTiersOfPlastics; tier++) {
            ...
            GTValues.RA.stdBuilder().itemInputs(
                    ...
                    .eut((int) GTValues.VP[tier + 1] * 3 / 4).metadata(TIER, 3)
                    .metadata(PCB_NANITE_MATERIAL, Materials.Gold).addTo(RecipeMaps.pcbFactoryRecipes);
        }
        ...
        for (int tier = 5; tier <= PCBFactoryManager.mTiersOfPlastics; tier++) {
            ...
            GTValues.RA.stdBuilder().itemInputs(
                    ...
                    .eut((int) GTValues.VP[tier] * 3 / 4).metadata(TIER, 1).metadata(UPGRADE, BIO)
        ...
        for (int tier = 5; tier <= PCBFactoryManager.mTiersOfPlastics; tier++) {
            ...
            GTValues.RA.stdBuilder().itemInputs(
                    ...
                    .eut((int) GTValues.VP[tier + 1] * 3 / 4).metadata(TIER, 2)
                    .metadata(PCB_NANITE_MATERIAL, Materials.Silver).metadata(UPGRADE, BIO)
                    .addTo(RecipeMaps.pcbFactoryRecipes);
        }
        for (int tier = 5; tier <= PCBFactoryManager.mTiersOfPlastics; tier++) {
            int amountOfBoards = (int) Math.ceil(8 * (Math.sqrt(Math.pow(2, tier - 4))));
            ...
            GTValues.RA.stdBuilder().itemInputs(
                    ...
                    .eut((int) GTValues.VP[tier + 1] * 3 / 4).metadata(TIER, 3)
                    .metadata(PCB_NANITE_MATERIAL, Materials.Gold).metadata(UPGRADE, BIO)
                    .addTo(RecipeMaps.pcbFactoryRecipes);
        }
