...
public class NetheriteRecipes {
    ...
    public static void run() {
        ...
        // Prismatic Acid
        {
            GTValues.RA.stdBuilder() // Prismarine
                    ...
                    .duration(15 * SECONDS).eut(TierEU.RECIPE_LuV).addTo(autoclaveRecipes);
            ...
            GTValues.RA.stdBuilder() // Leaching
                    ...
                    .fluidOutputs(Materials.PrismarineSolution.getFluid(8000)).duration(20 * SECONDS)
                    .eut(TierEU.RECIPE_IV).metadata(DISSOLUTION_TANK_RATIO, 1).addTo(dissolutionTankRecipes);
            ...
            GTValues.RA.stdBuilder() // Looped Leaching
                    ...
                    .fluidOutputs(Materials.PrismarineSolution.getFluid(8000)).duration(20 * SECONDS)
                    .eut(TierEU.RECIPE_IV).metadata(DISSOLUTION_TANK_RATIO, 3).addTo(dissolutionTankRecipes);
            ...
            GTValues.RA.stdBuilder() // Extraction
                    ...
                    .duration(15 * SECONDS).eut(TierEU.RECIPE_EV).addTo(chemicalBathRecipes);
            ...
            GTValues.RA.stdBuilder() // Looped Extraction
                    ...
                    .fluidOutputs(
                            Materials.PrismarineContaminatedHydrogenPeroxide.getFluid(1000),
                            Materials.PrismarineRichNitrobenzeneSolution.getFluid(2000))
                    .duration(30 * SECONDS).eut(TierEU.RECIPE_IV).addTo(chemicalBathRecipes);
            ...
            GTValues.RA.stdBuilder() // Strontium Hydroxide
                    ...
                    .fluidInputs(Materials.Oxygen.getGas(1000), Materials.Hydrogen.getGas(1000)).duration(10 * SECONDS)
            ...
            GTValues.RA.stdBuilder() // Precipitation
                    ...
                    .duration(40 * SECONDS).eut(TierEU.RECIPE_LuV).addTo(chemicalPlantRecipes);
            ...
            GTValues.RA.stdBuilder() // Crystallization
                    ...
                    .fluidOutputs(Materials.Strontium.getMolten(288)).duration(10 * SECONDS).eut(TierEU.RECIPE_LuV)
                    .addTo(laserEngraverRecipes);

            GTValues.RA.stdBuilder() // Gasification
                    .itemInputs(ItemList.Prismatic_Crystal.get(1)).fluidInputs(Materials.Boron.getPlasma(100))
                    .fluidOutputs(Materials.PrismaticGas.getFluid(1000)).duration(80 * SECONDS).eut(TierEU.RECIPE_LuV)
                    .metadata(COIL_HEAT, 7200).addTo(vacuumFurnaceRecipes);

            GTValues.RA.stdBuilder() // Reaction
                    .fluidInputs(Materials.PrismaticGas.getFluid(4000), Materials.LiquidNitrogen.getGas(12000))
                    .fluidOutputs(Materials.PrismaticAcid.getFluid(16000)).duration(25 * SECONDS).eut(TierEU.RECIPE_ZPM)
        ...
        // Naquarite
        {
            GTValues.RA.stdBuilder()
                    ...
                    .fluidOutputs(Materials.PrismaticNaquadah.getMolten(2304)).duration(20 * SECONDS)
                    .eut(TierEU.RECIPE_LuV).addTo(alloyBlastSmelterRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidOutputs(Materials.PrismaticNaquadahCompositeSlurry.getFluid(2000)).duration(5 * SECONDS)
                    .eut(TierEU.RECIPE_IV).addTo(mixerNonCellRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(16 * SECONDS).eut(TierEU.RECIPE_ZPM).addTo(chemicalDehydratorNonCellRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemList.Naquarite_Universal_Insulator_Foil.get(8)).duration(24 * SECONDS)
                    .eut(TierEU.RECIPE_ZPM).addTo(formingPressRecipes);
        }

        GTValues.RA.stdBuilder().fluidInputs(Materials.NetherAir.getFluid(10_000))
                .fluidOutputs(
                        Materials.NitrogenDioxide.getGas(1_400),
                        Materials.SulfurDioxide.getGas(3_800),
                        Materials.SulfurTrioxide.getGas(2_100))
                .duration(60 * SECONDS).eut(TierEU.RECIPE_LV).addTo(centrifugeNonCellRecipes);

        GTValues.RA.stdBuilder().fluidInputs(Materials.NetherAir.getFluid(1_000))
                .fluidOutputs(Materials.NetherSemiFluid.getFluid(100)).duration(10 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(vacuumFreezerRecipes);

        GTValues.RA.stdBuilder().fluidInputs(Materials.NetherSemiFluid.getFluid(100_000))
                ...
                .duration(24 * SECONDS).eut(TierEU.RECIPE_IV).addTo(distillationTowerRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.cell, Materials.NefariousGas, 1))
                .metadata(FUEL_VALUE, 1200).metadata(FUEL_TYPE, 1).duration(0).eut(0).addTo(GTRecipeConstants.Fuel);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .fluidOutputs(Materials.NefariousOil.getFluid(12_000)).duration(26 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(crackingRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .fluidInputs(Materials.Grade2PurifiedWater.getFluid(1_000), Materials.NefariousGas.getFluid(16_000))
                .fluidOutputs(Materials.NefariousOil.getFluid(18_000)).duration(6 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(crackingRecipes);

        GTValues.RA.stdBuilder().fluidInputs(Materials.NefariousOil.getFluid(1_000)).duration(0).eut(0)
                .metadata(FUEL_VALUE, 572).addTo(semiFluidFuels);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Heavy_Hellish_Mud.get(32))
                .fluidInputs(Materials.PoorNetherWaste.getFluid(16_000))
                .fluidOutputs(Materials.RichNetherWaste.getFluid(16_000)).duration(15 * SECONDS).eut(TierEU.RECIPE_ZPM)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(getModItem(EtFuturumRequiem.ID, "ancient_debris", 1)).duration(1 * TICKS)
                .eut(TierEU.RECIPE_UEV).addTo(electricImplosionCompressorRecipes);

        GTValues.RA.stdBuilder().itemInputs(getModItem(EtFuturumRequiem.ID, "netherite_scrap", 3, missing))
                .fluidInputs(Materials.NefariousOil.getFluid(16_000))
                .itemOutputs(getModItem(EtFuturumRequiem.ID, "ancient_debris", 1)).duration(1 * TICKS)
                .eut(TierEU.RECIPE_UEV).addTo(electricImplosionCompressorRecipes);

        GTValues.RA.stdBuilder().itemInputs(getModItem(EtFuturumRequiem.ID, "ancient_debris", 1, missing))
                .itemOutputs(
                        getModItem(EtFuturumRequiem.ID, "netherite_scrap", 1, missing),
                        getModItem(EtFuturumRequiem.ID, "netherite_scrap", 1, missing))
                .outputChances(10000, 2500).duration(27 * SECONDS).eut(TierEU.RECIPE_ZPM).addTo(hammerRecipes);

        GTValues.RA.stdBuilder().itemInputs(getModItem(EtFuturumRequiem.ID, "netherite_scrap", 1, missing))
                .fluidInputs(Materials.Lava.getFluid(100)).itemOutputs(ItemList.Hot_Netherite_Scrap.get(1))
                .duration(25 * SECONDS).eut(TierEU.RECIPE_MV).addTo(chemicalBathRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Hot_Netherite_Scrap.get(2))
                ...
                .outputChances(1000, 10000).duration(60 * SECONDS).eut(TierEU.RECIPE_IV).addTo(autoclaveRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Hot_Netherite_Scrap.get(16), ItemList.Heavy_Hellish_Mud.get(16))
                ...
                .duration(10 * SECONDS).eut(TierEU.RECIPE_UHV).addTo(chemicalBathRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Netherite_Scrap_Seed.get(1))
                .fluidInputs(Materials.PoorNetherWaste.getFluid(16_000))
                .itemOutputs(ItemList.Brittle_Netherite_Scrap.get(3), ItemList.Netherite_Scrap_Seed.get(1))
                .outputChances(5000, 5000).duration(60 * SECONDS).eut(TierEU.RECIPE_IV).addTo(chemicalBathRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Brittle_Netherite_Scrap.get(1))
                .itemOutputs(ItemList.Netherite_Nanoparticles.get(1)).duration(16 * SECONDS).eut(TierEU.RECIPE_LuV)
                .addTo(maceratorRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1), ItemList.Netherite_Nanoparticles.get(1))
                .fluidInputs(Materials.HellishMetal.getMolten(1 * INGOTS))
                .itemOutputs(ItemList.Intensely_Bonded_Netherite_Nanoparticles.get(1))
                .fluidOutputs(Materials.Thaumium.getMolten(2 * NUGGETS)).duration(15 * SECONDS).eut(TierEU.RECIPE_ZPM)
        ...
        if (Forestry.isModLoaded()) {
            GTValues.RA.stdBuilder()
                    ...
                    .fluidOutputs(Materials.Thaumium.getMolten(2 * NUGGETS)).duration(15 * SECONDS)
                    .eut(TierEU.RECIPE_ZPM).metadata(COIL_HEAT, 7500).addTo(blastFurnaceRecipes);
        }
    ...
    private static void addNetheriteParts() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(3 * SECONDS + 4 * TICKS).eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.plate, Materials.Netherite, 64))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.plateSuperdense, Materials.Netherite, 1))
                .duration(500 * SECONDS).eut(TierEU.RECIPE_ZPM).metadata(CompressionTierKey.INSTANCE, 1)
                .addTo(compressorRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Netherite, 2))
                .itemOutputs(
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.InfusedGold, 1),
                        ItemList.Netherite_Nanoparticles.get(1))
                .duration(23 * SECONDS + 8 * TICKS).eut(TierEU.RECIPE_ZPM).addTo(centrifugeRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Netherite, 1))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Netherite, 1))
                .duration(4 * SECONDS + 18 * TICKS).eut(TierEU.RECIPE_LV).addTo(maceratorRecipes);

        GTValues.RA.stdBuilder().itemInputs(getModItem(EtFuturumRequiem.ID, "netherite_block", 3, missing))
                .itemOutputs(getModItem(EtFuturumRequiem.ID, "netherite_stairs", 4, missing)).duration(1 * HOURS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(FluidUtils.getFluidStack("pyrotheum", 128000)).duration(180 * SECONDS)
                .eut(TierEU.RECIPE_ZPM).metadata(COIL_HEAT, 7600).addTo(blastFurnaceRecipes);
    }
    ...
    private static void addNetheritePartRecipe(OrePrefixes prefix, int multiplier, int inverseMultiplier) {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(Materials.Boron.getMolten(2L * inverseMultiplier)).duration(34 * SECONDS)
                .eut(TierEU.RECIPE_ZPM).addTo(plasmaArcFurnaceRecipes);
    ...
    private static void addNetheritePartRecipe(ItemStack inputStack, ItemStack outputStack, int inverseMultiplier) {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(outputStack).fluidInputs(Materials.Boron.getPlasma(2L * inverseMultiplier))
                .fluidOutputs(Materials.Boron.getMolten(2L * inverseMultiplier)).duration(4 * SECONDS)
                .eut(TierEU.RECIPE_ZPM).addTo(plasmaArcFurnaceRecipes);
