...
public class PurifiedWaterRecipes {
    ...
    public static void run() {
        ...
        // Grade 1 - Clarifier
        GTValues.RA.stdBuilder().itemInputs(ItemList.ActivatedCarbonFilterMesh.get(1))
                .fluidInputs(Materials.Water.getFluid(1_000)).fluidOutputs(Materials.Grade1PurifiedWater.getFluid(900))
                .itemOutputs(new ItemStack(Items.stick, 1), Materials.Stone.getDust(1), Materials.Gold.getNuggets(1))
                .outputChances(1000, 500, 100).duration(duration).eut(TierEU.RECIPE_LuV).metadata(BASE_CHANCE, 70.0f)
        ...
        GTValues.RA.stdBuilder().itemInputs(Materials.Carbon.getDust(1))
                ...
                .itemOutputs(Materials.PreActivatedCarbon.getDust(1)).duration(5 * SECONDS).eut(TierEU.RECIPE_LuV)
                .addTo(multiblockChemicalReactorRecipes);
        GTValues.RA.stdBuilder().itemInputs(Materials.PreActivatedCarbon.getDust(1))
                .itemOutputs(Materials.DirtyActivatedCarbon.getDust(1)).duration(10 * SECONDS).eut(TierEU.RECIPE_EV)
                .specialValue((int) HeatingCoilLevel.EV.getHeat()).addTo(blastFurnaceRecipes);
        GTValues.RA.stdBuilder().itemInputs(Materials.DirtyActivatedCarbon.getDust(1))
                .fluidInputs(Materials.Water.getFluid(1_000)).itemOutputs(Materials.ActivatedCarbon.getDust(1))
                .fluidOutputs(Materials.PhosphoricAcid.getFluid(1_000)).duration(2 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(chemicalBathRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        Materials.ActivatedCarbon.getDust(64),
                        GTOreDictUnificator.get(OrePrefixes.foil, Materials.Zinc, 16))
                .itemOutputs(ItemList.ActivatedCarbonFilterMesh.get(1)).duration(10 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);

        // Grade 2 - Ozonation
        for (ItemStack lens : GTOreDictUnificator.getOres("craftingLensBlue")) {
            GTValues.RA.stdBuilder().itemInputs(GTUtility.copyAmount(0, lens)).fluidInputs(Materials.Air.getGas(10_000))
                    .fluidOutputs(Materials.Ozone.getGas(2_000)).duration(1 * SECONDS).eut(TierEU.RECIPE_LuV)
        ...
        for (int tier = 1; tier <= 4; ++tier) {
            GTValues.RA.stdBuilder()
                    ...
                    .outputChances(500, 500, 500).duration(duration).ignoreCollision().eut(TierEU.RECIPE_LuV)
                    .metadata(BASE_CHANCE, tier * 20.0f).addTo(purificationOzonationRecipes);
        }

        // Grade 3 - Flocculation.
        GTValues.RA.stdBuilder().fluidInputs(Materials.Grade2PurifiedWater.getFluid(1_000))
                ...
                .outputChances(1000, 500, 100).duration(duration).eut(TierEU.RECIPE_ZPM)
                .metadata(BASE_CHANCE, 1 * 10.0f).addTo(purificationFlocculationRecipes);

        // 2 Al(OH)3 + 3 HCl -> Al2(OH)3 Cl3 + 3 H2O
        GTValues.RA.stdBuilder().itemInputs(Materials.Aluminiumhydroxide.getDust(8))
                ...
                .duration(4 * SECONDS).eut(TierEU.RECIPE_EV).addTo(multiblockChemicalReactorRecipes);

        GTValues.RA.stdBuilder().fluidInputs(Materials.FlocculationWasteLiquid.getFluid(10_000))
                ...
                .duration(1 * SECONDS).eut(TierEU.RECIPE_EV).addTo(distillationTowerRecipes);

        // Grade 4 - pH adjustment
        GTValues.RA.stdBuilder().fluidInputs(Materials.Grade3PurifiedWater.getFluid(1_000))
                .fluidOutputs(Materials.Grade4PurifiedWater.getFluid(900)).ignoreCollision().duration(duration)
                .eut(TierEU.RECIPE_ZPM).metadata(BASE_CHANCE, 0.0f).addTo(purificationPhAdjustmentRecipes);

        // Grade 5 - Plasma Heating
        GTValues.RA.stdBuilder().fluidInputs(Materials.Grade4PurifiedWater.getFluid(1_000))
                .fluidOutputs(Materials.Grade5PurifiedWater.getFluid(900)).ignoreCollision().duration(duration)
                .eut(TierEU.RECIPE_UV).metadata(BASE_CHANCE, 0.0f).addTo(purificationPlasmaHeatingRecipes);
        ...
        GTValues.RA.stdBuilder().fluidInputs(Materials.Grade5PurifiedWater.getFluid(1_000))
                .fluidOutputs(Materials.Grade6PurifiedWater.getFluid(900)).ignoreCollision().duration(duration)
                .eut(TierEU.RECIPE_UV).metadata(BASE_CHANCE, 0.0f).addTo(purificationUVTreatmentRecipes);

        // Grade 7 - Degasification
        GTValues.RA.stdBuilder().fluidInputs(Materials.Grade6PurifiedWater.getFluid(1_000))
                .fluidOutputs(Materials.Grade7PurifiedWater.getFluid(900)).ignoreCollision().duration(duration)
                .eut(TierEU.RECIPE_UHV).metadata(BASE_CHANCE, 0.0f).addTo(purificationDegasifierRecipes);
        ...
        for (int i = 0; i < catalystInputs.length; ++i) {
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ItemList.Quark_Creation_Catalyst_Unaligned.get(1),
                            GTUtility.getIntegratedCircuit(i + 1))
                    .fluidInputs(Materials.StableBaryonicMatter.getFluid(1_000)).itemOutputs(catalystInputs[i])
        ...
        for (int i = 0; i < catalystInputs.length; ++i) {
            GTValues.RA.stdBuilder().itemInputs(ItemList.Quark_Catalyst_Housing.get(1), quarks[i])
                    .fluidInputs(MaterialsUEVplus.ExcitedDTRC.getFluid(10_000)).itemOutputs(catalystInputs[i])
                    .fluidOutputs(MaterialsUEVplus.DimensionallyTranscendentResidue.getFluid(5_000))
                    .metadata(COIL_HEAT, 10800).eut(TierEU.RECIPE_UMV).duration(5 * MINUTES).addTo(plasmaForgeRecipes);
        }

        // Recipe for quark catalyst housing
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Electromagnet_Tengam.get(1))
                ...
                .itemOutputs(ItemList.Quark_Catalyst_Housing.get(1)).eut(TierEU.RECIPE_UIV).duration(60 * SECONDS)
                .addTo(AssemblyLine);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                        ItemList.Quark_Creation_Catalyst_Unaligned.get(2L),
                        Particle.getBaseParticle(Particle.UNKNOWN))
                .outputChances(10000, 100).ignoreCollision().duration(duration).eut(TierEU.RECIPE_UEV)
                .metadata(BASE_CHANCE, 0.0f).fake().addTo(purificationParticleExtractionRecipes);

        // real recipe
        GTValues.RA.stdBuilder().fluidInputs(Materials.Grade7PurifiedWater.getFluid(1_000))
                .fluidOutputs(
                ...
                .itemOutputs(
                        ...
                        Particle.getBaseParticle(Particle.UNKNOWN))
                .outputChances(10000, 100).ignoreCollision().duration(duration).eut(TierEU.RECIPE_UEV)
                .metadata(BASE_CHANCE, 0.0f).hidden().addTo(purificationParticleExtractionRecipes);
    }
}
