...
public class ScrapboxDropLoader implements Runnable {
    ...
    public void run() {
        ...
        GTModHandler.addScrapboxDrop(
            0.8F,
            MaterialLibAPI.getStack(Materials.Rubber, Shapes.dust, (int) (1L)));
        ...
        GTModHandler
            .addScrapboxDrop(1.2F, MaterialLibAPI.getStack(Materials.Tin, Shapes.dust, (int) (1L)));
        GTModHandler.addScrapboxDrop(
            1.2F,
            MaterialLibAPI.getStack(Materials.Copper, Shapes.dust, (int) (1L)));
        GTModHandler.addScrapboxDrop(
            0.5F,
            MaterialLibAPI.getStack(Materials.Bauxite, Shapes.dust, (int) (1L)));
        GTModHandler.addScrapboxDrop(
            0.5F,
            MaterialLibAPI.getStack(Materials.Aluminium, Shapes.dust, (int) (1L)));
        GTModHandler.addScrapboxDrop(
            0.5F,
            MaterialLibAPI.getStack(Materials.Lead, Shapes.dust, (int) (1L)));
        GTModHandler.addScrapboxDrop(
            0.5F,
            MaterialLibAPI.getStack(Materials.Nickel, Shapes.dust, (int) (1L)));
        GTModHandler.addScrapboxDrop(
            0.5F,
            MaterialLibAPI.getStack(Materials.Zinc, Shapes.dust, (int) (1L)));
        GTModHandler.addScrapboxDrop(
            0.5F,
            MaterialLibAPI.getStack(Materials.Brass, Shapes.dust, (int) (1L)));
        GTModHandler.addScrapboxDrop(
            0.5F,
        ...
        GTModHandler.addScrapboxDrop(
            2.0F,
            MaterialLibAPI.getStack(Materials.Saltpeter, Shapes.dust, (int) (1L)));
        GTModHandler.addScrapboxDrop(
            2.0F,
            MaterialLibAPI.getStack(Materials.Lazurite, Shapes.dust, (int) (1L)));
        GTModHandler.addScrapboxDrop(
            2.0F,
            MaterialLibAPI.getStack(Materials.Pyrite, Shapes.dust, (int) (1L)));
        GTModHandler.addScrapboxDrop(
            2.0F,
            MaterialLibAPI.getStack(Materials.Calcite, Shapes.dust, (int) (1L)));
        GTModHandler.addScrapboxDrop(
            2.0F,
        ...
        GTModHandler.addScrapboxDrop(
            0.5F,
            MaterialLibAPI.getStack(Materials.GarnetRed, Shapes.dust, (int) (1L)));
        GTModHandler.addScrapboxDrop(
            0.5F,
            MaterialLibAPI.getStack(Materials.GarnetYellow, Shapes.dust, (int) (1L)));
        GTModHandler.addScrapboxDrop(
            0.05F,
