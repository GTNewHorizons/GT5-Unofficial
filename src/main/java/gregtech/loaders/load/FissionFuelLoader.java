    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Lithium, Materials2Shapes.dustTiny, (int) (1)))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ItemList.IC2_Fuel_Rod_Empty.get(1),
                MaterialLibAPI.getStack(Materials.Glowstone, Materials2Shapes.dust, (int) (9)))
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                MaterialLibAPI.getStack(Materials.Glowstone, Materials2Shapes.dust, (int) (2)),
        ...
        if (!Mods.NuclearHorizons.isModLoaded()) {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    MaterialLibAPI.getStack(Materials.Steel, Materials2Shapes.stick, (int) (4)))
                .circuit(2)
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    MaterialLibAPI.getStack(Materials.Steel, Materials2Shapes.stickLong, (int) (6)))
                .circuit(4)
            ...
            GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                    MaterialLibAPI.getStack(Materials.Lutetium, Materials2Shapes.dustSmall, (int) (2)),
            ...
            GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                    ...
                    MaterialLibAPI.getStack(Materials.Thorium, Materials2Shapes.dust, (int) (2)),
                    MaterialLibAPI.getStack(Materials.Iron, Materials2Shapes.dust, (int) (3)))
                .duration(25 * SECONDS)
                .eut(48)
                .addTo(thermalCentrifugeRecipes);
            GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                    MaterialLibAPI.getStack(Materials.Lutetium, Materials2Shapes.dust, (int) (2)),
                    MaterialLibAPI.getStack(Materials.Thorium, Materials2Shapes.dust, (int) (4)),
                    MaterialLibAPI.getStack(Materials.Iron, Materials2Shapes.dust, (int) (6)))
                .duration(25 * SECONDS)
                .eut(48)
                .addTo(thermalCentrifugeRecipes);
            ...
            GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                    ...
                    MaterialLibAPI.getStack(Materials.Lutetium, Materials2Shapes.dustSmall, (int) (1)),
                    MaterialLibAPI.getStack(Materials.Polonium, Materials2Shapes.dustSmall, 1),
                    MaterialLibAPI.getStack(Materials.Thallium, Materials2Shapes.dustTiny, 1))
            ...
            GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                    ItemList.IC2_Fuel_Rod_Empty.get(8),
                    MaterialLibAPI.getStack(Materials.Uranium, Materials2Shapes.dust, (int) (2)),
                    MaterialLibAPI.getStack(Materials.Uranium232, Materials2Shapes.dustSmall, 1),
                    MaterialLibAPI.getStack(Materials.Uranium233, Materials2Shapes.dustSmall, 1),
                    MaterialLibAPI.getStack(Materials.Uranium235, Materials2Shapes.dustSmall, (int) (1)),
                    MaterialLibAPI.getStack(Materials.Plutonium, Materials2Shapes.dustTiny, (int) (1)))
            ...
            GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                    ItemList.IC2_Fuel_Rod_Empty.get(8),
                    MaterialLibAPI.getStack(Materials.Plutonium, Materials2Shapes.dust, (int) (2)),
                    MaterialLibAPI.getStack(Materials.Plutonium241, Materials2Shapes.dustTiny, (int) (1)),
                    MaterialLibAPI.getStack(Materials.Plutonium, Materials2Shapes.dustTiny, (int) (1)),
                    MaterialLibAPI.getStack(Materials.Plutonium238, Materials2Shapes.dustTiny, 1),
                    MaterialLibAPI.getStack(Materials.Plutonium, Materials2Shapes.dustTiny, (int) (1)))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Zircaloy2, Materials2Shapes.stick, 4))
            .circuit(2)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Zircaloy2, Materials2Shapes.stickLong, 6))
            .circuit(4)
            .itemOutputs(ItemList.RodHighDensityUranium4.get(1))
            .duration(11 * SECONDS)
            .eut(TierEU.RECIPE_EV)
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                MaterialLibAPI.getStack(Materials.Graphite, Materials2Shapes.dust, (int) (2)),
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                MaterialLibAPI.getStack(Materials.Uranium, Materials2Shapes.dust, (int) (4)),
                MaterialLibAPI.getStack(Materials.Plutonium, Materials2Shapes.dust, (int) (1)),
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                MaterialLibAPI.getStack(Materials.Uranium, Materials2Shapes.dust, (int) (8)),
                MaterialLibAPI.getStack(Materials.Plutonium, Materials2Shapes.dust, (int) (2)),
                MaterialLibAPI.getStack(Materials.Graphite, Materials2Shapes.dust, (int) (8)),
                MaterialLibAPI.getStack(Materials.Uranium235, Materials2Shapes.dust, (int) (1)),
                MaterialLibAPI.getStack(Materials.Plutonium241, Materials2Shapes.dust, (int) (1)))
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ItemRefer.Advanced_Fuel_Rod.get(1),
                MaterialLibAPI.getStack(Materials.Plutonium, Materials2Shapes.dust, (int) (4)),
                MaterialLibAPI.getStack(Materials.Plutonium241, Materials2Shapes.dust, (int) (2)),
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ItemRefer.Advanced_Fuel_Rod.get(2),
                MaterialLibAPI.getStack(Materials.Plutonium, Materials2Shapes.dust, (int) (8)),
                ...
                MaterialLibAPI.getStack(Materials.Uranium, Materials2Shapes.dust, (int) (2)),
                MaterialLibAPI.getStack(Materials.Uranium235, Materials2Shapes.dust, (int) (2)))
            .outputChances(100_00, 100_00, 100_00, 90_00, 50_00, 30_00)
            .fluidOutputs(
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ItemRefer.Advanced_Fuel_Rod.get(4),
                MaterialLibAPI.getStack(Materials.Plutonium, Materials2Shapes.dust, (int) (16)),
                MaterialLibAPI.getStack(Materials.Plutonium241, Materials2Shapes.dust, (int) (8)),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.NaquadahEnriched, Materials2Shapes.dust, (int) (3)))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.stick, (int) (4)))
            .circuit(2)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.stickLong, (int) (6)))
            .circuit(4)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.stickLong, (int) (64L)),
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.stickLong, (int) (64L)),
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.stickLong, (int) (64L)),
                MaterialLibAPI.getStack(Materials.Tiberium, Materials2Shapes.dust, 64),
                MaterialLibAPI.getStack(Materials.Tiberium, Materials2Shapes.dust, 64))
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                MaterialLibAPI.getStack(Materials.Naquadah, Materials2Shapes.dust, (int) (1)),
                MaterialLibAPI.getStack(Materials.Naquadria, Materials2Shapes.dustSmall, (int) (2)),
                MaterialLibAPI.getStack(Materials.NaquadahEnriched, Materials2Shapes.dustTiny, (int) (2)),
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                MaterialLibAPI.getStack(Materials.Naquadah, Materials2Shapes.dust, (int) (2)),
                MaterialLibAPI.getStack(Materials.Naquadah, Materials2Shapes.dust, (int) (2)),
                MaterialLibAPI.getStack(Materials.Naquadria, Materials2Shapes.dust, (int) (1)),
                MaterialLibAPI.getStack(Materials.NaquadahEnriched, Materials2Shapes.dustTiny, (int) (4)),
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.dust, (int) (18)),
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                MaterialLibAPI.getStack(Materials.Naquadah, Materials2Shapes.dust, (int) (4)),
                MaterialLibAPI.getStack(Materials.Naquadah, Materials2Shapes.dust, (int) (4)),
                MaterialLibAPI.getStack(Materials.Naquadria, Materials2Shapes.dust, (int) (2)),
                MaterialLibAPI.getStack(Materials.NaquadahEnriched, Materials2Shapes.dustTiny, (int) (8)),
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.dust, (int) (38)),
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.dust, (int) (64)),
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.dust, (int) (16)))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ItemList.Large_Fluid_Cell_TungstenSteel.get(1L),
                MaterialLibAPI.getStack(Materials.Naquadria, Materials2Shapes.dust, (int) (3)))
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                MaterialLibAPI.getStack(Materials.Naquadah, Materials2Shapes.dust, (int) (1)),
                MaterialLibAPI.getStack(Materials.Naquadah, Materials2Shapes.dust, (int) (1)),
                MaterialLibAPI.getStack(Materials.NaquadahEnriched, Materials2Shapes.dustSmall, (int) (2)),
                MaterialLibAPI.getStack(Materials.Naquadria, Materials2Shapes.dustTiny, (int) (2)),
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.dust, (int) (8)),
                MaterialLibAPI.getStack(Materials.Platinum, Materials2Shapes.dust, (int) (1)))
            .outputChances(100_00, 50_00, 50_00, 25_00, 100_00, 100_00)
            .duration(25 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                MaterialLibAPI.getStack(Materials.Naquadria, Materials2Shapes.dustTiny, (int) (4)),
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.dust, (int) (18)),
                MaterialLibAPI.getStack(Materials.Platinum, Materials2Shapes.dust, (int) (2)))
            .outputChances(100_00, 50_00, 50_00, 25_00, 100_00, 100_00)
            .duration(50 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                MaterialLibAPI.getStack(Materials.Naquadah, Materials2Shapes.dust, (int) (4)),
                MaterialLibAPI.getStack(Materials.Naquadah, Materials2Shapes.dust, (int) (4)),
                MaterialLibAPI.getStack(Materials.NaquadahEnriched, Materials2Shapes.dust, (int) (2)),
                MaterialLibAPI.getStack(Materials.Naquadria, Materials2Shapes.dustTiny, (int) (8)),
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.dust, (int) (38)),
                MaterialLibAPI.getStack(Materials.Platinum, Materials2Shapes.dust, (int) (4)))
            .outputChances(100_00, 50_00, 50_00, 25_00, 100_00, 100_00)
            .duration(100 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ItemList.Large_Fluid_Cell_TungstenSteel.get(1L),
                MaterialLibAPI.getStack(Materials.Tiberium, Materials2Shapes.dust, 3))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.stick, (int) (4L)))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.stickLong, (int) (6L)))
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                MaterialLibAPI.getStack(Materials.Zirconium, Materials2Shapes.dust, 1),
                MaterialLibAPI.getStack(Materials.Tiberium, Materials2Shapes.dustSmall, 2),
                MaterialLibAPI.getStack(Materials.Zirconium, Materials2Shapes.dust, 2),
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.dust, (int) (8)),
                MaterialLibAPI.getStack(Materials.Platinum, Materials2Shapes.dust, (int) (1)))
            .outputChances(100_00, 50_00, 50_00, 25_00, 100_00, 100_00)
            .fluidOutputs(
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                MaterialLibAPI.getStack(Materials.Zirconium, Materials2Shapes.dust, 4),
                MaterialLibAPI.getStack(Materials.Zirconium, Materials2Shapes.dust, 4),
                MaterialLibAPI.getStack(Materials.Tiberium, Materials2Shapes.dust, 2),
                MaterialLibAPI.getStack(Materials.Zirconium, Materials2Shapes.dust, 8),
                MaterialLibAPI.getStack(Materials.TungstenSteel, Materials2Shapes.dust, (int) (38)),
                MaterialLibAPI.getStack(Materials.Platinum, Materials2Shapes.dust, (int) (4)))
            .outputChances(100_00, 50_00, 50_00, 25_00, 100_00, 100_00)
            .fluidOutputs(
