...
public class FissionFuelLoader implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(ItemList.RodThorium.get(4), GTOreDictUnificator.get(OrePrefixes.stickLong, Materials.Steel, 6))
            .iCircuit(4)
        ...
        GTValues.RA.stdBuilder()
            ...
            .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
            .itemInputs(ItemList.RodUranium.get(4), GTOreDictUnificator.get(OrePrefixes.stickLong, Materials.Steel, 6))
            .iCircuit(4)
