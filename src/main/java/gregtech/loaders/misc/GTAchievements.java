...
public class GTAchievements {
    ...
    public GTAchievements() {
        ...
        GT_FML_LOGGER.debug("Registering autogenerated achievements from Visual Assembly Line recipe map.");
        ...
        registerAchievement(
            ...
            0,
            6,
            MaterialLibAPI.getStack(Materials2Materials.Tin, Materials2Shapes.shapeCrushed, (int) (1)),
            "tools",
            false);
        registerAchievement(
            "cleandust",
        ...
        registerAchievement(
            ...
            -2,
            6,
            MaterialLibAPI.getStack(Materials2Materials.Iron, Materials2Shapes.shapeCrushedPurified, (int) (1)),
            "crushed",
            false);
        registerAchievement(
            "spinit",
            -4,
            6,
            MaterialLibAPI.getStack(Materials2Materials.Redstone, Materials2Shapes.shapeCrushedCentrifuged, (int) (1)),
            "crushed",
            false);
        ...
        registerAchievement(
            ...
            2,
            0,
            MaterialLibAPI.getStack(Materials2Materials.Bronze, Materials2Shapes.shapeDust, (int) (1)),
            "gettingstartedwithgt",
            false);
        registerAchievement(
            "simplyeco",
        ...
        registerAchievement(
            ...
            6,
            3,
            MaterialLibAPI.getStack(Materials2Materials.BlueSteel, Materials2Shapes.shapeIngot, (int) (1)),
            "cheapermac",
            false);
        ...
        registerAchievement(
            ...
            14,
            0,
            MaterialLibAPI.getStack(Materials2Materials.Titanium, Materials2Shapes.shapeIngot, (int) (1)),
            "upgrade",
            false);
        ...
        registerAchievement(
            ...
            16,
            2,
            MaterialLibAPI.getStack(Materials2Materials.Tungsten, Materials2Shapes.shapeIngot, (int) (1)),
            "upgrade2",
            false);
        registerAchievement(
            "osmium",
            16,
            -2,
            MaterialLibAPI.getStack(Materials2Materials.Osmium, Materials2Shapes.shapeIngot, (int) (1)),
            "upgrade2",
            false);
        ...
        registerAchievement(
            ...
            16,
            4,
            MaterialLibAPI.getStack(Materials2Materials.TungstenSteel, Materials2Shapes.shapeIngot, (int) (1)),
            "tungsten",
            false);
        ...
        registerAchievement(
            ...
            7,
            9,
            MaterialLibAPI.getStack(Materials2Materials.Naquadria, Materials2Shapes.shapeIngot, (int) (1)),
            "over9000",
            false);
    ...
    public Achievement registerAchievement(String textId, int x, int y, ItemStack icon, Achievement requirement,
        ...
        if (!StatCollector.canTranslate(name)) {
            GT_FML_LOGGER.debug("{}={}", name, icon.getDisplayName());
        }

        if (!StatCollector.canTranslate(name)) {
            GT_FML_LOGGER.debug("{}=Pick up this item to see the recipe in NEI", desc);
        }
    ...
    public Achievement registerAssAchievement(GTRecipe recipe) {
        if (recipe == null) {
            GT_FML_LOGGER.error("Invalid achievement registration attempt for null recipe", new Exception());
            return null;
        }
