...
public interface IOreAdapter {
     ...
     */
    OreInfo getOreInfo(Block block, int meta);
     ...
     * Calling {@link #getBlock(OreInfo)} with the returned info must give back the same block/meta combination.
     */
    default OreInfo getOreInfo(World world, int x, int y, int z) {
     ...
     * Calling {@link #getBlock(OreInfo)} with the returned info must give back the same block/meta combination.
     */
    default OreInfo getOreInfo(ItemStack stack) {
