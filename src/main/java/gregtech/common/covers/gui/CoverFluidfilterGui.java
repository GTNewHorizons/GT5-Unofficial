                ...
                new Grid().marginLeft(WIDGET_MARGIN).coverChildren().minElementMarginRight(WIDGET_MARGIN)
                        ...
                        .row(
                                new EnumRowBuilder<>(FilterDirectionMode.class).value(ioModeSyncValue)
                                        .overlay(
                                                GTGuiTextures.OVERLAY_BUTTON_IMPORT,
                                                GTGuiTextures.OVERLAY_BUTTON_EXPORT)
                                        .build(),
                                IKey.str(GTUtility.trans("238", "Filter Direction")).asWidget())
                        .row(
                                new EnumRowBuilder<>(FilterType.class).value(filterTypeSyncValue)
                                        ...
                                        .build(),
                                IKey.str(GTUtility.trans("239", "Filter Type")).asWidget())
                        .row(
                                new EnumRowBuilder<>(BlockMode.class).value(blockModeSyncValue)
                                        ...
                                        .build(),
                                IKey.str(GTUtility.trans("240", "Block Flow")).asWidget()))
                .child(
                        Flow.row().marginLeft(WIDGET_MARGIN).marginTop(WIDGET_MARGIN).coverChildren()
