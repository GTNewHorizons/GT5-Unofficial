    ...
    private class GUI extends GT_GUICover {
        ...
        public void drawExtras(int mouseX, int mouseY, float parTicks) {
            ...
            this.fontRendererObj.drawString(
                    GT_Utility.trans("229", "Import/Export"), startX + spaceX * 3, 3 + startY + spaceY * 0, 0xFF555555);
            this.fontRendererObj.drawString(
                    GT_Utility.trans("230", "Conditional"), startX + spaceX * 3, 3 + startY + spaceY * 1, 0xFF555555);
            this.fontRendererObj.drawString(
                    GT_Utility.trans("231", "Enable Input"), startX + spaceX * 3, 3 + startY + spaceY * 2, 0xFF555555);
        }
