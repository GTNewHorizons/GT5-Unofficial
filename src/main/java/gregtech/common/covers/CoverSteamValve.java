...
public class CoverSteamValve extends CoverPump {
    ...
    public static boolean isFluidCompatible(FluidStack fluid) {
        ...
        return GTModHandler.isAnySteam(fluid) || GTModHandler.isSuperHeatedSteam(fluid)
            ...
            || fluid.getFluid()
                == MaterialLibAPI.getFluidStack(Materials.DenseSteam, Materials2FluidShapes.fluidGas, 1)
                    .getFluid()
            || fluid.getFluid() == MaterialLibAPI
                .getFluidStack(Materials.DenseSuperheatedSteam, Materials2FluidShapes.fluidGas, 1)
                .getFluid()
            || fluid.getFluid() == MaterialLibAPI
                .getFluidStack(Materials.DenseSupercriticalSteam, Materials2FluidShapes.fluidGas, 1)
                .getFluid();
    }
}
