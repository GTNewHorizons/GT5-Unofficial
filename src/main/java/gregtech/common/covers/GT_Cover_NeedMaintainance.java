    ...
    private class GUI extends GT_GUICover {
        ...
        public void drawExtras(int mouseX, int mouseY, float parTicks) {
            ...
            this.fontRendererObj.drawString(
                    buttontext[4], startX + spaceX * 5 + 4, 4 + startY + spaceY * 0, 0xFF555555);
            this.fontRendererObj.drawString(
                    buttontext[5], startX + spaceX * 5 + 4, 4 + startY + spaceY * 1, 0xFF555555);
            this.fontRendererObj.drawString(
                    buttontext[6], startX + spaceX * 5 + 4, 4 + startY + spaceY * 2, 0xFF555555);
            //                                          inverted        normal
