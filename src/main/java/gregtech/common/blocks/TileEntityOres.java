...
import gregtech.api.net.Packet_Ores;
    ...
    public void onUpdated() {
        if ((!this.worldObj.isRemote) && (this.mBlocked)) {
            ...
            GT_Values.NW.sendPacketToAllPlayersInRange(
                this.worldObj,
                new Packet_Ores(this.xCoord, (short) this.yCoord, this.zCoord, this.mMetaData),
                this.xCoord,
                this.zCoord);
        }
    }
    ...
    public ArrayList<ItemStack> getDrops(Block aDroppedOre, int aFortune) {
        ...
        if (aOreMaterial != null) {
            ...
            if (tRandom.nextInt(3 + aFortune) > 1) {
                Materials dustMat = ((BlockOresAbstract) aDroppedOre).getDroppedDusts()[this.mMetaData / 1000
                    % 16];
