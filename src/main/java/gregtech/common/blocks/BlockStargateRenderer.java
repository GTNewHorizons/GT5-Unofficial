...
public class BlockStargateRenderer extends Block {

    public BlockStargateRenderer() {
        super(Material.iron);
        this.setResistance(20f);
        this.setHardness(-1.0f);
        this.setBlockName("stargate_renderer");
    ...
    public TileEntity createTileEntity(World world, int metadata) {
        return new TileEntityStargateRenderer();
    }
