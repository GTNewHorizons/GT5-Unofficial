...
public class BlockCasingsFoundry extends BlockCasingsAbstract {
    ...
    public BlockCasingsFoundry() {
        ...
        register(0, ItemList.Casing_Solidifier_Modular, "Primary Exo-Foundry Casing");
        ...
        register(5, ItemList.Efficient_Overclocking_Solidifier_Modular, "Sentient Overclocker Casing");
        ...
        register(9, ItemList.Hypercooler_Solidifier_Modular, "Hypercooler Casing");
        register(10, ItemList.Streamlined_Casters_Solidifier_Modular, "Streamlined Casting Casing");
        register(11, ItemList.Secondary_Casing_Solidifier_Modular, "Inner Foundry Siphon Casing");
        for (int i = 1; i <= 3; i++) {
