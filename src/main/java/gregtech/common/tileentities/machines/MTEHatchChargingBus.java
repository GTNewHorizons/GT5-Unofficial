...
public class MTEHatchChargingBus extends MTEHatch implements IConfigurationCircuitSupport, IAddUIWidgets {
    ...
    public MTEHatchChargingBus(int id, String name, String nameRegional, int tier) {
        this(id, name, nameRegional, tier, 4);
    }

    protected MTEHatchChargingBus(int id, String name, String nameRegional, int tier, int slots, String[] description) {
        super(id, name, nameRegional, tier, slots, description);
    }

    public MTEHatchChargingBus(int id, String name, String nameRegional, int tier, int slots) {
        super(
            id,
            name,
            nameRegional,
    ...
    public MTEHatchChargingBus(String aName, int aTier, String[] aDescription, ITexture[][][] aTextures) {
        this(aName, aTier, 4, aDescription, aTextures);
    }

    public MTEHatchChargingBus(String aName, int aTier, int aSlots, String[] aDescription, ITexture[][][] aTextures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEHatchChargingBus(mName, mTier, mDescriptionArray, mTextures);
    }
