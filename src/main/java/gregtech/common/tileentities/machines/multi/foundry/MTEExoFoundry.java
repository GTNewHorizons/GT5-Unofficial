...
public class MTEExoFoundry extends MTEExtendedPowerMultiBlockBase<MTEExoFoundry>
    ...
    public void checkMachine(IGregTechTileEntity aBaseMetaTileEntity, ItemStack aStack, List<StructureError> errors) {
        ...
        // limit hatch space to about 25 hatches without modules. T.D.S removes 15 for balance, and casters adds 36 by
        // proxy.
        if (checkPiece(STRUCTURE_PIECE_MAIN, horizontalOffset, verticalOffset, depthOffset, errors)) {
            ...
            checkModules(errors);
            int requiredCasings = MIN_CASINGS + (foundryData.tdsPresent ? 15 : 0);
