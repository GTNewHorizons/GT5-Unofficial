...
public class MTELatex extends MTEExtendedPowerMultiBlockBase<MTELatex> implements ISurvivalConstructable {
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("Cable Coater, LATEX")
            .addInfo("§8§oAKA Laminated Application and Thermal Enclosure eXpert")
            .addBulkMachineInfo(8, 2F, 0.85F)
            .addInfo("gt.latex.tips.1", TooltipHelper.tierText(TooltipTier.ITEM_PIPE_CASING))
            .addSeparator()
            .addInfo("gt.latex.tips.2")
            .addSeparator()
