...
public class MTELayeringMachine extends MTEExtendedPowerMultiBlockBase<MTELayeringMachine>
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(
            ...
            .addSeparator()
            .addInfo(StatCollector.translateToLocalFormatted("gt.blockmachines.multimachine.layeringmachine.tooltip10"))
            .addInfo(StatCollector.translateToLocalFormatted("gt.blockmachines.multimachine.layeringmachine.tooltip11"))
            .addSeparator()
            .addInfo(StatCollector.translateToLocalFormatted("gt.blockmachines.multimachine.layeringmachine.tooltip12"))
            ...
            .addCasing("16", "Infinity Frame Box", false)
            .addCasing("12", "Pump Machine Casing", false)
            .addCasing("12", "Neutronium Sheetmetal", false)
            .addCasing("12", "Motor Machine Casing", false)
            .addCasing("10", "Incoloy-DS Fluid Containment Block", false)
            .addCasing("10", "Assembly Line Casing", false)
            .addCasing("6", "Advanced Filter Casing", false)
            .addMiscHatch(
                "0+",
