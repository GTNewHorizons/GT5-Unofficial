package gregtech.common.tileentities.machines.multi.mega;
...
public class MTENewMegaVacuumFreezer extends MTEExtendedPowerMultiBlockBase<MTENewMegaVacuumFreezer>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTENewMegaVacuumFreezer> STRUCTURE_DEFINITION = StructureDefinition
        .<MTENewMegaVacuumFreezer>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTENewMegaVacuumFreezer.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTENewMegaVacuumFreezer::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTENewMegaVacuumFreezer(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTENewMegaVacuumFreezer(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTENewMegaVacuumFreezer> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTENewMegaVacuumFreezer(this.mName);
    }
