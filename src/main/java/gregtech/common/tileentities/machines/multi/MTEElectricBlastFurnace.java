...
public class MTEElectricBlastFurnace extends MTEAbstractMultiFurnace<MTEElectricBlastFurnace>
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("machtype.ebf")
            ...
            .addCasingInfoExactly("gt.ebf.info.1", 16, true)
            .addEnergyHatch("gt.ebf.info.2", 1)
            .addMaintenanceHatch("gt.ebf.info.2", 1)
            .addMufflerHatch("gt.ebf.info.3", 2)
            .addInputBus("gt.ebf.info.2", 1)
            .addInputHatch("gt.ebf.info.2", 1)
            .addOutputBus("gt.ebf.info.2", 1)
            .addOutputHatch("gt.ebf.info.4", 3)
