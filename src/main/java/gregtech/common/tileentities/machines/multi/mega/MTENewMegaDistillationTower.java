...
public class MTENewMegaDistillationTower extends MTEExtendedPowerMultiBlockBase<MTENewMegaDistillationTower>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTENewMegaDistillationTower> STRUCTURE_DEFINITION = StructureDefinition
        .<MTENewMegaDistillationTower>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTENewMegaDistillationTower.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTENewMegaDistillationTower::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTENewMegaDistillationTower(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTENewMegaDistillationTower(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTENewMegaDistillationTower> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTENewMegaDistillationTower(this.mName);
    }
