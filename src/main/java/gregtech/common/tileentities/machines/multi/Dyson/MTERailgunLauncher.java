...
public class MTERailgunLauncher
    extends MTEExtendedPowerMultiBlockBase<gregtech.common.tileentities.machines.multi.Dyson.MTERailgunLauncher>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<gregtech.common.tileentities.machines.multi.Dyson.MTERailgunLauncher> STRUCTURE_DEFINITION = StructureDefinition.<gregtech.common.tileentities.machines.multi.Dyson.MTERailgunLauncher>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(gregtech.common.tileentities.machines.multi.Dyson.MTERailgunLauncher.class)
                ...
                .buildAndChain(
                    onElementPass(
                        gregtech.common.tileentities.machines.multi.Dyson.MTERailgunLauncher::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTERailgunLauncher(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTERailgunLauncher(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<gregtech.common.tileentities.machines.multi.Dyson.MTERailgunLauncher> getStructureDefinition() {
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new gregtech.common.tileentities.machines.multi.Dyson.MTERailgunLauncher(this.mName);
    }
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("Railgun")
            .addInfo("Launches Dyson Satelites Into Space")
            .addInfo("Consumes Superconducting Coils & Large Amounts of EU")
