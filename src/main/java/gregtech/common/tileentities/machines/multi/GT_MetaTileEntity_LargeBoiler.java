                ...
                protected IStructureDefinition<GT_MetaTileEntity_LargeBoiler> computeValue(Class<?> type) {
                    return StructureDefinition.<GT_MetaTileEntity_LargeBoiler>builder()
                            ...
                            .addElement(
                                    ...
                                    lazy(t -> ofChain(
                                            ofHatchAdder(
                                                    GT_MetaTileEntity_LargeBoiler::addOutputToMachineList,
                            ...
                            .addElement(
                                    ...
                                    lazy(t -> ofChain(
                                            ofHatchAdder(
                                                    GT_MetaTileEntity_LargeBoiler::addMaintenanceToMachineList,
                                                    t.getFireboxTextureIndex(),
                                                    1),
                                            ofHatchAdder(
                                                    GT_MetaTileEntity_LargeBoiler::addInputToMachineList,
                                                    t.getFireboxTextureIndex(),
                                                    1),
                                            ofHatchAdder(
                                                    GT_MetaTileEntity_LargeBoiler::addMufflerToMachineList,
                                                    t.getFireboxTextureIndex(),
                                                    1),
                                            onElementPass(
