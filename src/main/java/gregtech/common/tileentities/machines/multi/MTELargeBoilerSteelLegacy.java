...
public class MTELargeBoilerSteelLegacy extends MTELargeBoiler {

    public MTELargeBoilerSteelLegacy(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
        pollutionPerSecond = GTMod.proxy.mPollutionLargeSteelBoilerPerSecond;
    }

    public MTELargeBoilerSteelLegacy(String aName) {
        super(aName);
        pollutionPerSecond = GTMod.proxy.mPollutionLargeSteelBoilerPerSecond;
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTELargeBoilerSteelLegacy(this.mName);
    }
    ...
    @Override
    public int getEUt() {
        return MTELargeBoilerSteelLegacy.EUT_GENERATED;
    }
