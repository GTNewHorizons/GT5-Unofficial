...
public class MTENewMegaOilCracker extends MTEExtendedPowerMultiBlockBase<MTENewMegaOilCracker>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTENewMegaOilCracker> STRUCTURE_DEFINITION = StructureDefinition
        .<MTENewMegaOilCracker>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTENewMegaOilCracker.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTENewMegaOilCracker::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTENewMegaOilCracker(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTENewMegaOilCracker(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTENewMegaOilCracker> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTENewMegaOilCracker(this.mName);
    }
