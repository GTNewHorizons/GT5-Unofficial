...
public class MTELargeTurbineSteamLegacy extends MTELargeTurbineLegacy {

    private int excessWater;
    private boolean achievement = false;

    public MTELargeTurbineSteamLegacy(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTELargeTurbineSteamLegacy(String aName) {
        super(aName);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTELargeTurbineSteamLegacy(mName);
    }
