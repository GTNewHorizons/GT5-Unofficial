package gregtech.common.tileentities.machines.multi.Dyson;

import static com.gtnewhorizon.structurelib.structure.StructureUtility.ofBlock;
import static com.gtnewhorizon.structurelib.structure.StructureUtility.onElementPass;
import static gregtech.api.enums.GTValues.AuthorTheEpicGamer274;
...
public class MTEDysonReciever2
    extends MTEExtendedPowerMultiBlockBase<gregtech.common.tileentities.machines.multi.Dyson.MTEDysonReciever2>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<gregtech.common.tileentities.machines.multi.Dyson.MTEDysonReciever2> STRUCTURE_DEFINITION = StructureDefinition.<gregtech.common.tileentities.machines.multi.Dyson.MTEDysonReciever2>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(gregtech.common.tileentities.machines.multi.Dyson.MTEDysonReciever2.class)
                ...
                .buildAndChain(
                    onElementPass(
                        gregtech.common.tileentities.machines.multi.Dyson.MTEDysonReciever2::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEDysonReciever2(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEDysonReciever2(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<gregtech.common.tileentities.machines.multi.Dyson.MTEDysonReciever2> getStructureDefinition() {
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new gregtech.common.tileentities.machines.multi.Dyson.MTEDysonReciever2(this.mName);
    }
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("Ray Reciever")
            .addInfo("Recieves Beams of Power")
            ...
            .toolTipFinisher(AuthorTheEpicGamer274);
        return tt;
    }
