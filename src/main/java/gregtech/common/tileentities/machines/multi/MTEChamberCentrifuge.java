...
public class MTEChamberCentrifuge extends MTEExtendedPowerMultiBlockBase<MTEChamberCentrifuge>
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("gt.recipe.centrifuge")
            ...
            .addManyInfo("gt.spinmatron.tips.4", "gt.spinmatron.tips.5", "gt.spinmatron.tips.6")
            ...
            .addCasingInfoExactly("gt.spinmatron.info.1", 9, true)
            .addCasingInfoExactly("gt.spinmatron.info.2", 56, true)
            ...
            .addInputBus("gt.spinmatron.info.3", 1)
            .addOutputBus("gt.spinmatron.info.3", 1)
            .addInputHatch("gt.spinmatron.info.3", 1)
            .addOutputHatch("gt.spinmatron.info.3", 1)
            .addEnergyHatch("gt.spinmatron.info.3", 1)
            .addMaintenanceHatch("gt.spinmatron.info.3", 1)
