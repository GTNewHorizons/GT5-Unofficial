...
public class MTELargeBoilerTitaniumLegacy extends MTELargeBoiler {

    public MTELargeBoilerTitaniumLegacy(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
        pollutionPerSecond = GTMod.proxy.mPollutionLargeTitaniumBoilerPerSecond;
    }

    public MTELargeBoilerTitaniumLegacy(String aName) {
        super(aName);
        pollutionPerSecond = GTMod.proxy.mPollutionLargeTitaniumBoilerPerSecond;
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTELargeBoilerTitaniumLegacy(this.mName);
    }
    ...
    @Override
    public int getEUt() {
        return MTELargeBoilerTitaniumLegacy.EUT_GENERATED;
    }
