...
public class MTEDysonReciever1
    extends MTEExtendedPowerMultiBlockBase<gregtech.common.tileentities.machines.multi.Dyson.MTEDysonReciever1>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<gregtech.common.tileentities.machines.multi.Dyson.MTEDysonReciever1> STRUCTURE_DEFINITION = StructureDefinition.<gregtech.common.tileentities.machines.multi.Dyson.MTEDysonReciever1>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(gregtech.common.tileentities.machines.multi.Dyson.MTEDysonReciever1.class)
                ...
                .buildAndChain(
                    onElementPass(
                        gregtech.common.tileentities.machines.multi.Dyson.MTEDysonReciever1::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEDysonReciever1(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEDysonReciever1(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<gregtech.common.tileentities.machines.multi.Dyson.MTEDysonReciever1> getStructureDefinition() {
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new gregtech.common.tileentities.machines.multi.Dyson.MTEDysonReciever1(this.mName);
    }
