...
public class MTELargeTurbineHPSteamLegacy extends MTELargeTurbineLegacy {

    public boolean achievement = false;

    public MTELargeTurbineHPSteamLegacy(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTELargeTurbineHPSteamLegacy(String aName) {
        super(aName);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTELargeTurbineHPSteamLegacy(mName);
    }
