...
public class MTEIndustrialSolidifier extends MTEExtendedPowerMultiBlockBase<MTEIndustrialSolidifier>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTEIndustrialSolidifier> STRUCTURE_DEFINITION = StructureDefinition
        .<MTEIndustrialSolidifier>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTEIndustrialSolidifier.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTEIndustrialSolidifier::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEIndustrialSolidifier(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEIndustrialSolidifier(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTEIndustrialSolidifier> getStructureDefinition() {
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEIndustrialSolidifier(this.mName);
    }
