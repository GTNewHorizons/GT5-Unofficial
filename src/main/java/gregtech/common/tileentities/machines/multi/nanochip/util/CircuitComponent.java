...
public enum CircuitComponent {
    ...
    ProcessedBoardMultifiberglassElite("gt.circuitcomponent.processed.boardmultifiberelite",
        RecipeMaps.nanochipAssemblyMatrixRecipes),
    ProcessedBoardWetwareLifesupport("gt.circuitcomponent.processed.boardwetwarelifesupport",
        RecipeMaps.nanochipAssemblyMatrixRecipes),
    ProcessedBoardBioMutated("gt.circuitcomponent.processed.boardbiomutated",
        RecipeMaps.nanochipAssemblyMatrixRecipes),
