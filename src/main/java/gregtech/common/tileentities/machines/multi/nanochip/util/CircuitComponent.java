...
public enum CircuitComponent {
    ...
    BoardWetwareLifesupport("gt.circuitcomponent.boardwetwarelifesupport", RecipeMaps.nanochipBoardProcessorRecipes),
    BoardBioMutated("gt.circuitcomponent.boardbiomutated", RecipeMaps.nanochipBoardProcessorRecipes),
    ...
    ProcessedBoardMultifiberglassElite("gt.circuitcomponent.processed.boardmultifiberelite",
        RecipeMaps.nanochipAssemblyMatrixRecipes),
    ProcessedBoardWetwareLifesupport("gt.circuitcomponent.processed.boardbiomutated",
        RecipeMaps.nanochipAssemblyMatrixRecipes),
    ProcessedBoardBioMutated("gt.circuitcomponent.processed.boardwetwarelifesupport",
        RecipeMaps.nanochipAssemblyMatrixRecipes),
    ...
    ChipAdvCrystal("gt.circuitcomponent.chipadvcrystal", RecipeMaps.nanochipEtchingArray),
    ...
    ProcessedChipAdvCrystal("gt.circuitcomponent.processed.chipadvcrystal", RecipeMaps.nanochipAssemblyMatrixRecipes),
    ...
    ProcessedFrameboxTritanium("gt.circuitcomponent.processed.frame.tritanium",
        RecipeMaps.nanochipAssemblyMatrixRecipes),
    SheetSiliconeRubber("gt.circuitcomponent.sheet.siliconerubber", RecipeMaps.nanochipAssemblyMatrixRecipes),
