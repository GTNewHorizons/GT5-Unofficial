...
public class MTENewMegaElectricBlastFurnace extends MTEExtendedPowerMultiBlockBase<MTENewMegaElectricBlastFurnace>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTENewMegaElectricBlastFurnace> STRUCTURE_DEFINITION = StructureDefinition
        .<MTENewMegaElectricBlastFurnace>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTENewMegaElectricBlastFurnace.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTENewMegaElectricBlastFurnace::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTENewMegaElectricBlastFurnace(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTENewMegaElectricBlastFurnace(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTENewMegaElectricBlastFurnace> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTENewMegaElectricBlastFurnace(this.mName);
    }
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("Electric Blast Furnace")
