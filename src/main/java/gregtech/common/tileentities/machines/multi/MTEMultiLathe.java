...
public class MTEMultiLathe extends MTEExtendedPowerMultiBlockBase<MTEMultiLathe> implements ISurvivalConstructable {
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("Lathe")
            ...
            .addInfo(
                DARK_AQUA
                    + "For example, using Black Plutonium item pipe casings (boost of 4) and Tier 3 voltage (HV) reduces ")
            .addInfo(DARK_AQUA + "processing time to 57% of the recipe time, making the machine 175% faster.")
