...
public class MTENanoForge extends MTEExtendedPowerMultiBlockBase<MTENanoForge> implements ISurvivalConstructable {
    ...
    private static final String[][] STRUCTURE_PIECE_TIER4_STRUCT_AIR = replaceLetters(STRUCTURE_PIECE_TIER4_STRUCT, "Z");
    private static final IStructureDefinition<MTENanoForge> STRUCTURE_DEFINITION = StructureDefinition
        .<MTENanoForge>builder()
                    ...
                    .addShape(STRUCTURE_PIECE_TIER4, STRUCTURE_PIECE_TIER4_STRUCT)
                    .addShape(STRUCTURE_PIECE_TIER4_AIR, STRUCTURE_PIECE_TIER4_STRUCT_AIR)
                    //spotless:on
