...
public class GT_MetaTileEntity_Hatch_Input_ME extends GT_MetaTileEntity_Hatch_Input implements IPowerChannelState, IAddGregtechLogo, IAddUIWidgets {
    ...
    public GT_MetaTileEntity_Hatch_Input_ME(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional, 1, 0,
            new String[]{
    ...
    public GT_MetaTileEntity_Hatch_Input_ME(String aName, int aTier, String[] aDescription,
                                            ITexture[][][] aTextures) {
    ...
    public FluidStack[] getUseStoredFluid() {
        if (!processingRecipe) {
    ...
    public void endRecipeProcessing() {
        ...
        for (int i = 0; i < SLOT_COUNT; ++i) {
            ...
            try {
                proxy.getEnergy().extractAEPower(consume, Actionable.MODULATE, PowerMultiplier.CONFIG);
    ...
    public FluidStack drain(int maxDrain, boolean doDrain) {
        ...
        for (int i = 0; i < SLOT_COUNT; i++) {
            ...
            try {
                IMEMonitor<IAEFluidStack> sg = proxy.getStorage().getFluidInventory();
                IAEFluidStack request = AEFluidStack.create(fluidStack);
                IAEFluidStack result = sg.extractItems(request, doDrain ? Actionable.MODULATE : Actionable.SIMULATE, getRequestSource());
                FluidStack s = (result != null) ? result.getFluidStack() : null;
                if (s == null) {
                    continue;
                }
    ...
    public void saveNBTData(NBTTagCompound aNBT) {
        ...
        aNBT.setIntArray("sizes", savedStackSizes);
    ...
    public boolean onRightclick(IGregTechTileEntity aBaseMetaTileEntity, EntityPlayer aPlayer, ForgeDirection side,
        ...
        if (!autoPullFluidList) {
            NBTTagList stockingItems = nbt.getTagList("fluidsToStock", 10);
            for (int i = 0; i < stockingItems.tagCount(); i++) {
                this.storedFluid[i] = GT_Utility.loadFluid(stockingItems.getCompoundTagAt(i));
            }
        }
    ...
    public void onLeftclick(IGregTechTileEntity aBaseMetaTileEntity, EntityPlayer aPlayer) {
        ...
        if (!autoPullFluidList) {
            for (int index = 0; index < SLOT_COUNT; index++) {
                ...
                stockingItems.appendTag(fluidStack.writeToNBT(new NBTTagCompound()));
            }
    ...
    public void addUIWidgets(ModularWindow.Builder builder, UIBuildContext buildContext) {
        final Pos2d[] saSlotPos = new Pos2d[]{
            new Pos2d(97 + 18 * 0, 9 + 18 * 0),
            new Pos2d(97 + 18 * 1, 9 + 18 * 0),
            new Pos2d(97 + 18 * 2, 9 + 18 * 0),
            new Pos2d(97 + 18 * 3, 9 + 18 * 0),
            new Pos2d(97 + 18 * 0, 9 + 18 * 1),
            new Pos2d(97 + 18 * 1, 9 + 18 * 1),
            new Pos2d(97 + 18 * 2, 9 + 18 * 1),
            new Pos2d(97 + 18 * 3, 9 + 18 * 1),
            new Pos2d(97 + 18 * 0, 9 + 18 * 2),
            new Pos2d(97 + 18 * 1, 9 + 18 * 2),
            new Pos2d(97 + 18 * 2, 9 + 18 * 2),
            new Pos2d(97 + 18 * 3, 9 + 18 * 2),
            new Pos2d(97 + 18 * 0, 9 + 18 * 3),
            new Pos2d(97 + 18 * 1, 9 + 18 * 3),
            new Pos2d(97 + 18 * 2, 9 + 18 * 3),
            new Pos2d(97 + 18 * 3, 9 + 18 * 3),
        };
        for (int i = 0; i < SLOT_COUNT; i++) {
