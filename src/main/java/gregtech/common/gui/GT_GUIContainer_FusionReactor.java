    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (mContainer != null) {
            ...
            if (mContainer.mDisplayErrorCode == 0) {
                if (mContainer.mActive == 0) {
                    fontRendererObj.drawString(
                            "Hit with Soft Mallet to (re-)start the Machine if it doesn't start.", -70, 170, 16448255);
                } else {
            ...
            if (this.mContainer.mEnergy > 160000000 && this.mContainer.mEnergy < 160010000)
                ...
                fontRendererObj.drawString(
                        GT_Utility.formatNumbers(this.mContainer.mEnergyLong) + " EU", 50, 155, 0x00ff0000);
        }
    }
