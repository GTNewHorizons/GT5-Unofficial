...
public class ColorPickerWidget extends ParentWidget<ColorPickerWidget> {
    ...
    public ColorPickerWidget(Consumer<Integer> resultConsumer, int startColor, boolean controlAlpha) {
        ...
        IWidget alphaSlider = controlAlpha ? new Row().widthRel(1f)
            .height(12)
            .child(
                IKey.str("A: ")
                    .asWidget()
                    .heightRel(1f))
            .child(
                createSlider(this.sliderBackgroundA).bounds(0, 255)
                    .value(
                        new DoubleValue.Dynamic(
                            () -> Color.getAlpha(this.color),
                ...
                new Row().widthRel(1f)
                    ...
                    .child(
                        IKey.str("R: ")
                            ...
                            .heightRel(1f))
                    .child(
                        createSlider(this.sliderBackgroundR).bounds(0, 255)
                            .value(
                                new DoubleValue.Dynamic(
                                    () -> Color.getRed(this.color),
                ...
                new Row().widthRel(1f)
                    ...
                    .child(
                        IKey.str("G: ")
                            ...
                            .heightRel(1f))
                    .child(
                        createSlider(this.sliderBackgroundG).bounds(0, 255)
                            .value(
                                new DoubleValue.Dynamic(
                                    () -> Color.getGreen(this.color),
                ...
                new Row().widthRel(1f)
                    ...
                    .child(
                        IKey.str("B: ")
                            ...
                            .heightRel(1f))
                    .child(
                        createSlider(this.sliderBackgroundB).bounds(0, 255)
                            .value(
                                new DoubleValue.Dynamic(
                                    () -> Color.getBlue(this.color),
                ...
                new Row().widthRel(1f)
                    ...
                    .child(
                        IKey.str("H: ")
                            ...
                            .heightRel(1f))
                    .child(
                        createSlider(new HueBar(GuiAxis.X)).bounds(0, 360)
                            .value(
                                new DoubleValue.Dynamic(
                                    () -> Color.getHue(this.color),
                ...
                new Row().widthRel(1f)
                    ...
                    .child(
                        IKey.str("S: ")
                            ...
                            .heightRel(1f))
                    .child(
                        createSlider(this.sliderBackgroundS).bounds(0, 1)
                            .value(
                                new DoubleValue.Dynamic(
                                    () -> Color.getHSVSaturation(this.color),
                ...
                new Row().widthRel(1f)
                    ...
                    .child(
                        IKey.str("V: ")
                            ...
                            .heightRel(1f))
                    .child(
                        createSlider(this.sliderBackgroundV).bounds(0, 1)
                            .value(
                                new DoubleValue.Dynamic(
    ...
    public void updateColor(int color) {
        ...
        this.sliderBackgroundS
            .setHorizontalGradient(Color.withHSVSaturation(color, 0f), Color.withHSVSaturation(color, 1f));
