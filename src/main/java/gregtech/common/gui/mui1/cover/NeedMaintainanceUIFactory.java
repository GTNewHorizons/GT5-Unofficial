                ...
                new CoverDataControllerWidget.CoverDataIndexedControllerWidget_ToggleButtons<>(
                        ...
                        getUIBuildContext())
                                ...
                                .addToggleButton(
                                        ...
                                        CoverDataFollowerToggleButtonWidget.ofCheck(),
                                        widget -> widget
                                                .addTooltip(translateToLocal("gt.interact.desc.need_maint_rotor_lo"))
                                                .setPos(spaceX * 4 + 4, spaceY * 1))
                                .addToggleButton(
                                        6,
                                        CoverDataFollowerToggleButtonWidget.ofCheck(),
                                        widget -> widget
                                                .addTooltip(translateToLocal("gt.interact.desc.need_maint_rotor_hi"))
