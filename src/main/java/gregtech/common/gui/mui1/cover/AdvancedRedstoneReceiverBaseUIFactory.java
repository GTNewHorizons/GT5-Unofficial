        ...
        controller
                .addFollower(
                        ...
                        widget -> widget.setStaticTexture(GTUITextures.OVERLAY_BUTTON_GATE_AND)
                                .addTooltip(GTUtility.trans("331", "AND Gate")).setPos(spaceX * 0, spaceY * 2))
                .addFollower(
                        CoverDataFollowerToggleButtonWidget.ofDisableable(),
                        ...
                        widget -> widget.setStaticTexture(GTUITextures.OVERLAY_BUTTON_GATE_NAND)
                                .addTooltip(GTUtility.trans("332", "NAND Gate")).setPos(spaceX * 1, spaceY * 2))
                .addFollower(
                        CoverDataFollowerToggleButtonWidget.ofDisableable(),
                        ...
                        widget -> widget.setStaticTexture(GTUITextures.OVERLAY_BUTTON_GATE_OR)
                                .addTooltip(GTUtility.trans("333", "OR Gate")).setPos(spaceX * 2, spaceY * 2))
                .addFollower(
                        CoverDataFollowerToggleButtonWidget.ofDisableable(),
                        ...
                        widget -> widget.setStaticTexture(GTUITextures.OVERLAY_BUTTON_GATE_NOR)
                                .addTooltip(GTUtility.trans("334", "NOR Gate")).setPos(spaceX * 3, spaceY * 2))
                .addFollower(
                        CoverDataFollowerToggleButtonWidget.ofDisableable(),
                        coverData -> coverData.getGateMode()
                                == CoverAdvancedRedstoneReceiverBase.GateMode.SINGLE_SOURCE,
                        (coverData, state) -> coverData
                                .setMode(CoverAdvancedRedstoneReceiverBase.GateMode.SINGLE_SOURCE),
                        widget -> widget.setStaticTexture(GTUITextures.OVERLAY_BUTTON_ANALOG)
                                .addTooltips(
                                        Arrays.asList(
                                                GTUtility.breakLines(
                                                        StatCollector.translateToLocal(
                                                                "GT5U.gui.tooltip.redstone_receiver.analog"))))
