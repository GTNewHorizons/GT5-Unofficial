 ...
 */
public class EnumColumnBuilder<E extends Enum<E>> {
    ...
    public EnumColumnBuilder(@NotNull Class<E> enumClass) {
     ...
     */
    public EnumColumnBuilder<E> value(EnumSyncValue<E> syncValue) {
        this.syncValue = syncValue;
        return this;
    }

    public EnumColumnBuilder<E> overlay(IDrawable... overlay) {
        this.overlay = overlay;
        return this;
    }

    public EnumColumnBuilder<E> overlay(int size, IDrawable... overlay) {
    ...
    public EnumColumnBuilder<E> tooltip(IKey... tooltip) {
