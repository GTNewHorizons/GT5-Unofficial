...
public class GlitchRenderer extends GT_GeneratedMaterial_Renderer {
    ...
    private static final Pos2d[] points = {new Pos2d(2.0,0.0),
...
//            t.startDrawingQuads();
//            t.addVertexWithUV(circleRadius+points[index.get(0)].x, circleRadius+points[index.get(0)].y, 0, icon.getMinU(), icon.getMinV());
//            t.addVertexWithUV(circleRadius+points[index.get(1)].x, 16-circleRadius+points[index.get(1)].y, 0, icon.getMinU(), icon.getMaxV());
//            t.addVertexWithUV(16-circleRadius+points[index.get(2)].x, 16-circleRadius+points[index.get(2)].y, 0, icon.getMaxU(), icon.getMaxV());
//            t.addVertexWithUV(16-circleRadius+points[index.get(3)].x, circleRadius+points[index.get(3)].y, 0, icon.getMaxU(), icon.getMinV());
//            t.draw();

            double padding = 0.0d;

            t.startDrawingQuads();
            t.addVertexWithUV(-padding + circleRadius+points[(int) ((animationTicks + index.get(0)) % points.length)].x, -padding + circleRadius+points[(int) ((animationTicks + index.get(0)) % points.length)].y, 0, icon.getMinU(), icon.getMinV());
            t.addVertexWithUV(-padding + circleRadius+points[(int) ((animationTicks + index.get(1)) % points.length)].x,  padding + 16 - circleRadius+points[(int) ((animationTicks + index.get(1)) % points.length)].y, 0, icon.getMinU(), icon.getMaxV());
            t.addVertexWithUV( padding + 16-circleRadius+points[(int) ((animationTicks + index.get(2)) % points.length)].x,  padding + 16 - circleRadius+points[(int) ((animationTicks + index.get(2)) % points.length)].y, 0, icon.getMaxU(), icon.getMaxV());
            t.addVertexWithUV( padding + 16-circleRadius+points[(int) ((animationTicks + index.get(3)) % points.length)].x, -padding + circleRadius+points[(int) ((animationTicks + index.get(3)) % points.length)].y, 0, icon.getMaxU(), icon.getMinV());
            t.draw();
