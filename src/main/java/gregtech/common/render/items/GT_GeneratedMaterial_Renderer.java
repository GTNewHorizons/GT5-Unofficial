...
import gregtech.api.interfaces.IContainerMaterialRenderer;
import gregtech.api.interfaces.IIconContainer;
import gregtech.api.interfaces.IRegularMaterialRenderer;
...
public class GT_GeneratedMaterial_Renderer implements IItemRenderer, IRegularMaterialRenderer, IContainerMaterialRenderer {
    ...
    @Override
    public final void renderItem(ItemRenderType type, ItemStack aStack, Object... data) {
        ...
        if (tIcon != null) {
            renderRegularItem(type, aStack, tIcon, tOverlay);
        }
    ...
    public void renderRegularItem(ItemRenderType type, ItemStack aStack, IIcon icon, IIcon overlay) {
        GT_MetaGenerated_Item aItem = (GT_MetaGenerated_Item) aStack.getItem();
