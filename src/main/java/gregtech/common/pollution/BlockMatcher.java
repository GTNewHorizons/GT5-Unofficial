...
public class BlockMatcher {
    ...
    public void updateClassList(String[] cfg) {
        ...
        blackList.clear();
        for (String line : cfg) {
            GTLoggers.GT_FML_LOGGER.info("Checking for block:{}", line);
            ...
            if (lines.length > 1) {
                try {
                    ...
                    GTLoggers.GT_FML_LOGGER.error("Invalid type [{}]", line);
                    continue;
                }
            }
            ...
            if (lines[0].startsWith("-")) {
                try {
                    ...
                    GTLoggers.GT_FML_LOGGER.info("\t added blacklist:{}", lines[0].substring(1));
                ...
                try {
                    ...
                    GTLoggers.GT_FML_LOGGER.info("\t added whitelist:{}", lines[0]);
                } catch (ClassNotFoundException ignored) {}
            }
        }
        // updateBlockIDs();
