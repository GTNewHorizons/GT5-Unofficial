...
public class AEInventoryItemIO implements IItemIO {
    ...
    public @NotNull InventorySourceIterator iterator() {
        int[] effectiveSlots = allowedSourceSlots != null ? GTDataUtils.intersect(allowedSourceSlots, inventory.allSlots) : inventory.allSlots;
        ...
        return new AbstractInventorySourceIterator(effectiveSlots) {
            ...
            public ItemStack extract(int amount) {
                ...
                IAEItemStack extracted = inSlot.copy().setStackSize(toExtract);
    ...
    public ItemStack store(ItemStack itemStack) {
        ...
        int[] slots = allowedSinkSlots != null ? GTDataUtils.intersect(allowedSinkSlots, inventory.allSlots) : inventory.allSlots;
