...
public enum IDMetaItem01 {
    ...
    Single_Use_File(284),
    Single_Use_Wrench(285),
    Single_Use_Crowbar(286),
    Single_Use_Wire_Cutter(287),
    Single_Use_Hard_Hammer(288),
    Single_Use_Soft_Mallet(289),
    Single_Use_Screwdriver(290),
    Single_Use_Saw(291),
    Shape_Mold_Single_Use_File(292),
    Shape_Mold_Single_Use_Wrench(293),
    Shape_Mold_Single_Use_Crowbar(294),
    Shape_Mold_Single_Use_Wire_Cutter(295),
    Shape_Mold_Single_Use_Hard_Hammer(296),
    Shape_Mold_Single_Use_SoftMallet(297),
    Shape_Mold_Single_Use_Screwdriver(298),
    Shape_Mold_Single_Use_Saw(299),
    Shape_Empty(300),
    ...
    Cover_Crafting(744),
    Cover_Drain(745),
    Cover_RedstoneReceiver(746),
    Cover_WirelessController(747),
