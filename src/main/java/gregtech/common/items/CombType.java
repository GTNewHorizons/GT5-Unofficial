...
public enum CombType {
    ...
    // Alloy Line
    REDALLOY(11, "red_alloy", true, Materials2Materials.RedAlloy, 100, 0xE60000, 0xB80000, ItemComb.Voltage.LV),
    REDSTONEALLOY(12, "redstone_alloy", true, Materials2Materials.RedstoneAlloy, 90, 0xB80000, 0xA50808,
        ItemComb.Voltage.LV),
    CONDUCTIVEIRON(13, "conductive_iron", true, Materials2Materials.ConductiveIron, 80, 0x817671, 0xCEADA3,
        ItemComb.Voltage.MV),
    VIBRANTALLOY(14, "vibrant_alloy", true, Materials2Materials.VibrantAlloy, 50, 0x86A12D, 0xC4F2AE,
        ItemComb.Voltage.HV),
    ENERGETICALLOY(15, "energetic_alloy", true, Materials2Materials.EnergeticAlloy, 70, 0xFF9933, 0xFFAD5C,
        ItemComb.Voltage.HV),
    ELECTRICALSTEEL(16, "electrical_steel", true, Materials2Materials.ElectricalSteel, 90, 0x787878, 0xD8D8D8,
        ItemComb.Voltage.LV),
    DARKSTEEL(17, "dark_steel", true, Materials2Materials.DarkSteel, 80, 0x252525, 0x443B44, ItemComb.Voltage.MV),
    PULSATINGIRON(18, "pulsating_iron", true, Materials2Materials.PulsatingIron, 80, 0x006600, 0x6DD284,
        ItemComb.Voltage.HV),
    STAINLESSSTEEL(19, "stainless_steel", true, Materials2Materials.StainlessSteel, 75, 0x778899, 0xC8C8DC,
        ItemComb.Voltage.HV),
    ENDERIUM(20, "enderium", true, Materials2Materials.Enderium, 40, 0x2E8B57, 0x599087, ItemComb.Voltage.HV),
    ...
    RUBY(39, "ruby", true, Materials2Materials.Ruby, 100, 0xE6005C, 0xCC0052, ItemComb.Voltage.LV),
    REDGARNET(40, "red_garnet", true, Materials2Materials.GarnetRed, 100, 0xBD4C4C, 0xECCECE, ItemComb.Voltage.LV),
    YELLOWGARNET(41, "yellow_garnet", true, Materials2Materials.GarnetYellow, 100, 0xA3A341, 0xEDEDCE,
        ItemComb.Voltage.LV),
    SAPPHIRE(42, "sapphire", true, Materials2Materials.Sapphire, 100, 0x0033CC, 0x00248F, ItemComb.Voltage.LV),
    DIAMOND(43, "diamond", true, Materials2Materials.Diamond, 100, 0xCCFFFF, 0xA3CCCC, ItemComb.Voltage.LV),
    OLIVINE(44, "olivine", true, Materials2Materials.Olivine, 100, 0x248F24, 0xCCFFCC, ItemComb.Voltage.LV),
    EMERALD(45, "emerald", true, Materials2Materials.Emerald, 100, 0x248F24, 0x2EB82E, ItemComb.Voltage.LV),
    PYROPE(46, "pyrope", true, Materials2Materials.Pyrope, 100, 0x763162, 0x8B8B8B, ItemComb.Voltage.LV),
    GROSSULAR(47, "grossular", true, Materials2Materials.Grossular, 100, 0x9B4E00, 0x8B8B8B, ItemComb.Voltage.LV),
    ...
    IRON(53, "iron", true, Materials2Materials.Iron, 100, 0xDA9147, 0xDE9C59, ItemComb.Voltage.LV),
    STEEL(54, "steel", true, Materials2Materials.Steel, 95, 0x808080, 0x999999, ItemComb.Voltage.LV),
    NICKEL(55, "nickel", true, Materials2Materials.Nickel, 100, 0x8585AD, 0x9D9DBD, ItemComb.Voltage.LV),
    ZINC(56, "zinc", true, Materials2Materials.Zinc, 100, 0xF0DEF0, 0xF2E1F2, ItemComb.Voltage.LV),
    SILVER(57, "silver", true, Materials2Materials.Silver, 100, 0xC2C2D6, 0xCECEDE, ItemComb.Voltage.LV),
    GOLD(58, "gold", true, Materials2Materials.Gold, 100, 0xE6B800, 0xCFA600, ItemComb.Voltage.LV),
    SULFUR(59, "sulfur", true, Materials2Materials.Sulfur, 100, 0x6F6F01, 0x8B8B8B, ItemComb.Voltage.LV),
    GALLIUM(60, "gallium", true, Materials2Materials.Gallium, 75, 0x8B8B8B, 0xC5C5E4, ItemComb.Voltage.LV),
    ARSENIC(61, "arsenic", true, Materials2Materials.Arsenic, 75, 0x736C52, 0x292412, ItemComb.Voltage.LV),

    // Rare Metals Line
    BAUXITE(62, "bauxite", true, Materials2Materials.Bauxite, 85, 0x6B3600, 0x8B8B8B, ItemComb.Voltage.LV),
    ALUMINIUM(63, "aluminium", true, Materials2Materials.Aluminium, 60, 0x008AB8, 0xD6D6FF, ItemComb.Voltage.LV),
    MANGANESE(64, "manganese", true, Materials2Materials.Manganese, 30, 0xD5D5D5, 0xAAAAAA, ItemComb.Voltage.LV),
    MAGNESIUM(65, "magnesium", true, Materials2Materials.Magnesium, 75, 0xF1D9D9, 0x8B8B8B, ItemComb.Voltage.LV),
    TITANIUM(66, "titanium", true, Materials2Materials.Ilmenite, 100, 0xCC99FF, 0xDBB8FF, ItemComb.Voltage.IV),
    CHROME(67, "chrome", true, Materials2Materials.Chrome, 50, 0xEBA1EB, 0xF2C3F2, ItemComb.Voltage.HV),
    TUNGSTEN(68, "tungsten", true, Materials2Materials.Tungstate, 100, 0x62626D, 0x161620, ItemComb.Voltage.IV),
    PLATINUM(69, "platinum", true, Materials2Materials.Platinum, 40, 0xE6E6E6, 0xFFFFCC, ItemComb.Voltage.HV),
    IRIDIUM(70, "iridium", true, Materials2Materials.Iridium, 20, 0xDADADA, 0xD1D1E0, ItemComb.Voltage.IV),
    MOLYBDENUM(71, "molybdenum", true, Materials2Materials.Molybdenum, 20, 0xAEAED4, 0x8B8B8B, ItemComb.Voltage.LV),
    OSMIUM(72, "osmium", true, Materials2Materials.Osmium, 15, 0x2B2BDA, 0x8B8B8B, ItemComb.Voltage.IV),
    LITHIUM(73, "lithium", true, Materials2Materials.Lithium, 75, 0xF0328C, 0xE1DCFF, ItemComb.Voltage.MV),
    SALT(74, "salt", true, Materials2Materials.Salt, 90, 0xF0C8C8, 0xFAFAFA, ItemComb.Voltage.MV),
    ELECTROTINE(75, "electrotine", true, Materials2Materials.Electrotine, 75, 0x1E90FF, 0x3CB4C8, ItemComb.Voltage.HV),
    ALMANDINE(76, "almandine", true, Materials2Materials.Almandine, 85, 0xC60000, 0x8B8B8B, ItemComb.Voltage.LV),

    // Radioactive Line
    URANIUM(77, "uranium", true, Materials2Materials.Uranium, 50, 0x19AF19, 0x169E16, ItemComb.Voltage.IV),
    ...
    LEDOX(94, "ledox", true, Materials2Materials.Ledox, 75, 0x0000CD, 0x0074FF, ItemComb.Voltage.IV),
    CALLISTOICE(95, "callisto_ice", true, Materials2Materials.CallistoIce, 75, 0x0074FF, 0x1EB1FF, ItemComb.Voltage.IV),
    MYTRYL(96, "mytryl", true, Materials2Materials.Mytryl, 65, 0xDAA520, 0xF26404, ItemComb.Voltage.IV),
    QUANTIUM(97, "quantium", true, Materials2Materials.Quantium, 50, 0x00FF00, 0x00D10B, ItemComb.Voltage.IV),
    ORIHARUKON(98, "oriharukon", true, Materials2Materials.Oriharukon, 50, 0x228B22, 0x677D68, ItemComb.Voltage.IV),
    MYSTERIOUSCRYSTAL(99, "mysterious_crystal", true, Materials2Materials.MysteriousCrystal, 45, 0x3CB371, 0x16856C,
        ItemComb.Voltage.LuV),
    BLACKPLUTONIUM(100, "black_plutonium", true, Materials2Materials.Quantium, 25, 0x000000, 0x323232,
        ItemComb.Voltage.LuV),
    ...
    COSMICNEUTRONIUM(117, "cosmic_neutronium", true, Materials2Materials.CosmicNeutronium, 5, 0x484848, 0x323232,
        ItemComb.Voltage.UV),
    INFINITYCATALYST(118, "infinity_catalyst", true, Materials2Materials.InfinityCatalyst, 2, 0xFFFFFF, 0xFFFFFF,
    ...
    AWAKENEDDRACONIUM(163, "awakened_draconium", true, Materials2Materials.DraconiumAwakened, 50, 0xD41238, 0xFFA157,
        ItemComb.Voltage.MV),
    PALLADIUM(164, "palladium", true, Materials2Materials.Palladium, 50, 0x8B8B8B, 0xF1D9D9, ItemComb.Voltage.MV),
    INFUSEDGOLD(165, "infused_gold", true, Materials2Materials.InfusedGold, 50, 0x80641E, 0xFFC83C,
        ItemComb.Voltage.IV),
