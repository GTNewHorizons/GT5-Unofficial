...
public enum CombType {
    ...
    STICKY(2, "sticky_resin", true, Materials.NULL, 50, 0x2E8F5B, 0xDCC289, ItemComb.Voltage.LV),
    OIL(3, "oil", true, Materials.NULL, 100, 0x333333, 0x4C4C4C, ItemComb.Voltage.LV),
    ...
    // IC2 Line
    COOLANT(6, "coolant", true, Materials.NULL, 100, 0x144F5A, 0x2494A2, ItemComb.Voltage.HV),
    ENERGY(7, "energy", true, Materials.NULL, 80, 0xC11F1F, 0xEBB9B9, ItemComb.Voltage.HV),
    LAPOTRON(8, "lapotron", true, Materials.NULL, 60, 0x1414FF, 0x6478FF, ItemComb.Voltage.HV),
    ...
    // Thaumcraft Line
    THAUMIUMDUST(21, "thaumium_dust", true, Materials.Thaumium, 100, 0x7A007A, 0x5C005C, ItemComb.Voltage.MV),
    THAUMIUMSHARD(22, "thaumium_shard", true, Materials.NULL, 85, 0x9966FF, 0xAD85FF, ItemComb.Voltage.LV),
    ...
    // Gem Line
    STONE(33, "stone", true, Materials.NULL, 70, 0x808080, 0x999999, ItemComb.Voltage.LV),
    ...
    RAREEARTH(37, "rare_earth", true, Materials.RareEarth, 100, 0x555643, 0x343428, ItemComb.Voltage.LV),
    ...
    // Metals Line
    SLAG(49, "slag", true, Materials.NULL, 50, 0xD4D4D4, 0x58300B, ItemComb.Voltage.LV),
    ...
    CHROME(67, "chrome", true, Materials.Chrome, 50, 0xEBA1EB, 0xF2C3F2, ItemComb.Voltage.HV),
    ...
    DOB(81, "d-o-b", true, Materials.NULL, 50, 0x007700, 0x002400, ItemComb.Voltage.LV),
    ...
    // Twilight
    NAGA(86, "naga", true, Materials.NULL, 100, 0x0D5A0D, 0x28874B, ItemComb.Voltage.MV),
    LICH(87, "lich", true, Materials.NULL, 90, 0x5C605E, 0xC5C5C5, ItemComb.Voltage.HV),
    HYDRA(88, "hydra", true, Materials.NULL, 80, 0x872836, 0xB8132C, ItemComb.Voltage.HV),
    URGHAST(89, "ur_ghast", true, Materials.NULL, 70, 0x7C0618, 0xA7041C, ItemComb.Voltage.EV),
    SNOWQUEEN(90, "snow_queen", true, Materials.NULL, 60, 0x9C0018, 0xD02001, ItemComb.Voltage.EV),
    ...
    // Planet
    MERCURY(102, "mercury", true, Materials.NULL, 65, 0x4A4033, 0xB5A288, ItemComb.Voltage.EV),
    VENUS(103, "venus", true, Materials.NULL, 65, 0x120E07, 0x272010, ItemComb.Voltage.EV),
    MOON(104, "moon", true, Materials.NULL, 90, 0x373735, 0x7E7E78, ItemComb.Voltage.MV),
    MARS(105, "mars", true, Materials.NULL, 80, 0x220D05, 0x3A1505, ItemComb.Voltage.MV),
    JUPITER(106, "jupiter", true, Materials.NULL, 75, 0x734B2E, 0xD0CBC4, ItemComb.Voltage.MV),
    SATURN(107, "saturn", true, Materials.NULL, 55, 0xD2A472, 0xF8C37B, ItemComb.Voltage.IV),
    URANUS(108, "uranus", true, Materials.NULL, 45, 0x75C0C9, 0x84D8EC, ItemComb.Voltage.IV),
    NEPTUNE(109, "neptune", true, Materials.NULL, 35, 0x334CFF, 0x576DFF, ItemComb.Voltage.IV),
    PLUTO(110, "pluto", true, Materials.NULL, 25, 0x34271E, 0x69503D, ItemComb.Voltage.LuV),
    HAUMEA(111, "haumea", true, Materials.NULL, 20, 0x1C1413, 0x392B28, ItemComb.Voltage.LuV),
    MAKEMAKE(112, "makemake", true, Materials.NULL, 20, 0x301811, 0x120A07, ItemComb.Voltage.LuV),
    CENTAURI(113, "centauri", true, Materials.NULL, 15, 0x2F2A14, 0xB06B32, ItemComb.Voltage.ZPM),
    TCETI(114, "tceti", true, Materials.NULL, 10, 0x46241A, 0x7B412F, ItemComb.Voltage.ZPM),
    BARNARDA(115, "barnarda", true, Materials.NULL, 10, 0x0D5A0D, 0xE6C18D, ItemComb.Voltage.ZPM),
    VEGA(116, "vega", true, Materials.NULL, 10, 0x1A2036, 0xB5C0DE, ItemComb.Voltage.ZPM),

    // Infinity
    COSMICNEUTRONIUM(117, "cosmic_neutronium", true, Materials.CosmicNeutronium, 5, 0x484848, 0x323232,
        ItemComb.Voltage.UV),
    INFINITYCATALYST(118, "infinity_catalyst", true, Materials.InfinityCatalyst, 2, 0xFFFFFF, 0xFFFFFF,
        ItemComb.Voltage.UHV),
    INFINITY(119, "infinity", true, Materials.Infinity, 1, 0xFFFFFF, 0xFFFFFF, ItemComb.Voltage.UEV),

    // HEE
    ENDDUST(120, "end_dust", true, Materials.NULL, 50, 0x003A7D, 0xCC00FA, ItemComb.Voltage.HV),
    ECTOPLASMA(121, "ectoplasma", true, Materials.NULL, 35, 0x381C40, 0xDCB0E5, ItemComb.Voltage.EV),
    ARCANESHARD(122, "arcane_shard", true, Materials.NULL, 35, 0x333D82, 0x9010AD, ItemComb.Voltage.EV),
    STARDUST(123, "stardust", true, Materials.NULL, 60, 0xDCBE13, 0xffff00, ItemComb.Voltage.HV),
    DRAGONESSENCE(124, "dragon_essence", true, Materials.NULL, 30, 0x911ECE, 0xFFA12B, ItemComb.Voltage.IV),
    ENDERMAN(125, "enderman", true, Materials.NULL, 25, 0x6200e7, 0x161616, ItemComb.Voltage.IV),
    SILVERFISH(126, "silverfish", true, Materials.NULL, 25, 0x0000000, 0xEE053D, ItemComb.Voltage.EV),
    ENDIUM(127, "endium", true, Materials.HeeEndium, 50, 0x2F5A6C, 0xa0ffff, ItemComb.Voltage.HV),
    RUNEI(128, "rune_type_1", true, Materials.NULL, 10, 0x0104D9, 0xE31010, ItemComb.Voltage.IV),
    RUNEII(129, "rune_type_2", true, Materials.NULL, 10, 0xE31010, 0x0104D9, ItemComb.Voltage.IV),
    FIREESSENSE(130, "fire_essence", true, Materials.NULL, 30, 0xFFA157, 0xD41238, ItemComb.Voltage.IV),
    ...
    XENON(134, "xenon", true, Materials.NULL, 85, 0x160822, 0x8A97B0, ItemComb.Voltage.IV),
    NEON(135, "neon", true, Materials.NULL, 90, 0xFF7200, 0xFFC826, ItemComb.Voltage.IV),
    KRYPTON(136, "krypton", true, Materials.NULL, 85, 0x160822, 0x8A97B0, ItemComb.Voltage.IV),
    ...
    SEAWEED(142, "seaweed", true, Materials.NULL, 90, 0x83FF83, 0xCBCBCB, ItemComb.Voltage.UV),
    // just Walrus
    WALRUS(143, "walrus", true, Materials.NULL, 100, 0xB5CFC9, 0xD6D580, ItemComb.Voltage.LV),
    // TC infused Air shards line. Recipes in GT_MachineRecipeLoader.java Lines 1500+ + Nether/Endershard
    INFUSEDAER(144, "infused_air", true, Materials.NULL, 100, 0x60602F, 0xFFFF7E, ItemComb.Voltage.LV),
    INFUSEDTERRA(145, "infused_terra", true, Materials.NULL, 100, 0x003300, 0x008600, ItemComb.Voltage.LV),
    ...
    ESSENTIA(158, "essentia", true, Materials.NULL, 100, 0xED3601, 0xFF6D50, ItemComb.Voltage.MV),
    ...
    KEVLAR(161, "kevlar", true, Materials.NULL, 50, 0xa2baa3, 0x2d542f, ItemComb.Voltage.MV),
    ...
    MACHINIST(168, "machinist", true, Materials.NULL, 100, 0x552582, 0xFDB927, ItemComb.Voltage.MV),
    ...
    MMM(174, "M-M-M", true, Materials.NULL, 50, 0x3F9B7B, 0x76FFCF, ItemComb.Voltage.EV),
    ELVEN(175, "elven", true, Materials.NULL, 50, 0xC72ED9, 0xEFBFF9, ItemComb.Voltage.EV),
    ...
    _NULL(-1, "INVALIDCOMB", false, Materials.NULL, 0, 0, 0, null);
