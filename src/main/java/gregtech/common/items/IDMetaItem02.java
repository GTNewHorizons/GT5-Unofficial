...
public enum IDMetaItem02 {
    ...
    Food_IceCream_Caramel(595),
    Food_IceCream_ChocolateChip(596),
    Food_IceCream_Chocolate(597),
    Food_IceCream_Coffee(598),
    Food_IceCream_CookieDough(599),
    Food_IceCream_CookiesAndCream(600),
    Food_IceCream_CottonCandy(601),
    Food_IceCream_HotFudge(602),
    Food_IceCream_JustCone(603),
    Food_IceCream_MhCSM(604),
    Food_IceCream_Mango(605),
    Food_IceCream_Meat(606),
    Food_IceCream_MintChip(607),
    Food_IceCream_Neapolitan(608),
    Food_IceCream_NoFlavor(609),
    Food_IceCream_PeanutButter(610),
    Food_IceCream_Pistachio(611),
    Food_IceCream_SaltedCaramel(612),
    Food_IceCream_Sprinkles(613),
    Food_IceCream_Strawberry(614),
    Food_IceCream_ToffeeButter(615),
    Food_IceCream_Vanilla(616),
