...
public enum IDMetaItem02 {
    ...
    Food_IceCream_Benzene(591),
    Food_IceCream_Blueberry(592),
    Food_IceCream_Brownie(593),
    Food_IceCream_ButterPecan(594),
    Food_IceCream_Butterscotch(595),
    Food_IceCream_Caramel(596),
    Food_IceCream_Chocolate(597),
    Food_IceCream_ChocolateChip(598),
    Food_IceCream_Coffee(599),
    Food_IceCream_CookieDough(600),
    Food_IceCream_CookiesAndCream(601),
    Food_IceCream_CottonCandy(602),
    Food_IceCream_HotFudge(603),
    Food_IceCream_JustCone(604),
    Food_IceCream_MhCSM(605),
    Food_IceCream_Mango(606),
    Food_IceCream_Meat(607),
    Food_IceCream_MintChip(608),
    Food_IceCream_Neapolitan(609),
    Food_IceCream_NoFlavor(610),
    Food_IceCream_PeanutButter(611),
    Food_IceCream_Pistachio(612),
    Food_IceCream_Radioactive(613),
    Food_IceCream_SaltedCaramel(614),
    Food_IceCream_Spaghetti(615),
    Food_IceCream_Sprinkles(616),
    Food_IceCream_Strawberry(617),
    Food_IceCream_ToffeeButter(618),
    Food_IceCream_Vanilla(619),
    Food_IceCreamSandwich(620),
    Food_IceCreamSandwich_Chocolate(621),
    Food_Popsicle_Chocolate(622),
    Food_Popsicle_Fruit(623),
    Food_Popsicle_Double(624),
    Food_Sorbet_Raspberry(625),
    Food_IceCream_BananaSplit(626),
    Food_Sorbet_RainbowStellar(627),
