...
public enum IDMetaItem02 {
    ...
    Food_IceCream_Banana(589),
    Food_IceCream_Benzene(590),
    Food_IceCream_Blueberry(591),
    Food_IceCream_Brownie(592),
    Food_IceCream_Chocolate(593),
    Food_IceCream_Coffee(594),
    Food_IceCream_CookieDough(595),
    Food_IceCream_CookiesAndCream(596),
    Food_IceCream_CottonCandy(597),
    Food_IceCream_JustCone(598),
    Food_IceCream_Mango(599),
    Food_IceCream_Meat(600),
    Food_IceCream_MintChip(601),
    Food_IceCream_Neapolitan(602),
    Food_IceCream_NoFlavor(603),
    Food_IceCream_PeanutButter(604),
    Food_IceCream_Pistachio(605),
    Food_IceCream_SaltedCaramel(606),
    Food_IceCream_Strawberry(607),
    Food_IceCream_Vanilla(608),
