...
public class GT_MetaGenerated_Item_01 extends GT_MetaGenerated_Item_X32 {
    ...
    public GT_MetaGenerated_Item_01() {
        ...
        ItemList.Cover_FluidLimiter.set(addItem(272, "Fluid Limiter Cover", "Limits fluid input depending on fill level (Does not work on input hatches!)"));
        ...
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Cover_FluidDetector.get(1L), new ItemStack(Blocks.redstone_torch, 4), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Titanium, 4)}, Materials.RedstoneAlloy.getFluid(432), ItemList.Cover_FluidLimiter.get(1), 80, (int) GT_Values.V[4]/2);
