...
public class MetaGeneratedItem02 extends MetaGeneratedItemX32 {
    ...
    public void registerCovers() {
        ...
        CoverFactory<CoverAdvancedRedstoneTransmitterBase.TransmitterData> transmitterDataCoverFactory = CoverFactory
            .ofData(CoverAdvancedRedstoneTransmitterBase.TransmitterData::new);
        CoverRegistry.registerCover(
            ItemList.Cover_AdvancedRedstoneTransmitterExternal.get(1L),
            TextureFactory.of(MACHINE_CASINGS[2][0], TextureFactory.of(OVERLAY_ADVANCED_REDSTONE_TRANSMITTER)),
            new CoverAdvancedRedstoneTransmitterExternal(
                TextureFactory.of(OVERLAY_ADVANCED_REDSTONE_TRANSMITTER),
                transmitterDataCoverFactory),
            transmitterDataCoverFactory);
        ...
        CoverFactory<CoverAdvancedRedstoneReceiverBase.ReceiverData> receiverDataFactory = CoverFactory
            .ofData(CoverAdvancedRedstoneReceiverBase.ReceiverData::new);
        CoverRegistry.registerCover(
            ItemList.Cover_AdvancedRedstoneReceiverExternal.get(1L),
            TextureFactory.of(MACHINE_CASINGS[2][0], TextureFactory.of(OVERLAY_ADVANCED_REDSTONE_RECEIVER)),
            new CoverAdvancedRedstoneReceiverExternal(
        ...
        CoverRegistry.registerCover(
            ItemList.Cover_AdvancedRedstoneReceiverInternal.get(1L),
            TextureFactory.of(MACHINE_CASINGS[2][0], TextureFactory.of(OVERLAY_ADVANCED_REDSTONE_RECEIVER)),
            new CoverAdvancedRedstoneReceiverInternal(
                TextureFactory.of(OVERLAY_ADVANCED_REDSTONE_RECEIVER),
                receiverDataFactory),
            receiverDataFactory);

        CoverFactory<CoverWirelessFluidDetector.FluidTransmitterData> fluidTransmitterDataCoverFactory = CoverFactory
            .ofData(CoverWirelessFluidDetector.FluidTransmitterData::new);
        CoverRegistry.registerCover(
            ...
            new CoverWirelessFluidDetector(
                TextureFactory.of(OVERLAY_WIRELESS_FLUID_DETECTOR),
                fluidTransmitterDataCoverFactory),
            fluidTransmitterDataCoverFactory);

        CoverFactory<CoverWirelessItemDetector.ItemTransmitterData> itemTransmitterDataCoverFactory = CoverFactory
            .ofData(CoverWirelessItemDetector.ItemTransmitterData::new);
        CoverRegistry.registerCover(
            ...
            new CoverWirelessItemDetector(
                TextureFactory.of(OVERLAY_WIRELESS_ITEM_DETECTOR),
                itemTransmitterDataCoverFactory),
            itemTransmitterDataCoverFactory);

        CoverFactory<CoverWirelessDoesWorkDetector.ActivityTransmitterData> activityTransmitterDataCoverFactory = CoverFactory
            .ofData(CoverWirelessDoesWorkDetector.ActivityTransmitterData::new);
        CoverRegistry.registerCover(
            ...
            new CoverWirelessDoesWorkDetector(
                TextureFactory.of(OVERLAY_WIRELESS_ACTIVITYDETECTOR),
                activityTransmitterDataCoverFactory),
            activityTransmitterDataCoverFactory);

        CoverFactory<CoverWirelessMaintenanceDetector.MaintenanceTransmitterData> maintenanceTransmitterDataCoverFactory = CoverFactory
            .ofData(CoverWirelessMaintenanceDetector.MaintenanceTransmitterData::new);
        CoverRegistry.registerCover(
            ...
            new CoverWirelessMaintenanceDetector(
                TextureFactory.of(OVERLAY_WIRELESS_MAINTENANCE_DETECTOR),
                maintenanceTransmitterDataCoverFactory),
            maintenanceTransmitterDataCoverFactory);
    }
