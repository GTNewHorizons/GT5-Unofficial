...
public class MetaGeneratedItem02 extends MetaGeneratedItemX32 {
    ...
    public MetaGeneratedItem02() {
        ...
        ItemList.Plank_Birch.set(
                addItem(Plank_Birch.ID, "Birch Plank", aTextCover, new TCAspects.TC_AspectStack(TCAspects.ARBOR, 1L)));
        ...
        ItemList.Plank_Larch.set(
                addItem(Plank_Larch.ID, "Larch Plank", aTextCover, new TCAspects.TC_AspectStack(TCAspects.ARBOR, 1L)));
        ItemList.Plank_Teak.set(
                addItem(Plank_Teak.ID, "Teak Plank", aTextCover, new TCAspects.TC_AspectStack(TCAspects.ARBOR, 1L)));
        ...
        ItemList.Plank_Lime.set(
                addItem(Plank_Lime.ID, "Lime Plank", aTextCover, new TCAspects.TC_AspectStack(TCAspects.ARBOR, 1L)));
        ...
        ItemList.Plank_Wenge.set(
                addItem(Plank_Wenge.ID, "Wenge Plank", aTextCover, new TCAspects.TC_AspectStack(TCAspects.ARBOR, 1L)));
        ...
        ItemList.Plank_Kapok.set(
                addItem(Plank_Kapok.ID, "Kapok Plank", aTextCover, new TCAspects.TC_AspectStack(TCAspects.ARBOR, 1L)));
        ItemList.Plank_Ebony.set(
                addItem(Plank_Ebony.ID, "Ebony Plank", aTextCover, new TCAspects.TC_AspectStack(TCAspects.ARBOR, 1L)));
        ...
        ItemList.Plank_Balsa.set(
                addItem(Plank_Balsa.ID, "Balsa Plank", aTextCover, new TCAspects.TC_AspectStack(TCAspects.ARBOR, 1L)));
        ...
        ItemList.Plank_Mahoe.set(
                addItem(Plank_Mahoe.ID, "Mahoe Plank", aTextCover, new TCAspects.TC_AspectStack(TCAspects.ARBOR, 1L)));
        ...
        ItemList.Plank_Palm.set(
                addItem(Plank_Palm.ID, "Palm Plank", aTextCover, new TCAspects.TC_AspectStack(TCAspects.ARBOR, 1L)));
        ...
        ItemList.Plank_Pine.set(
                addItem(Plank_Pine.ID, "Pine Plank", aTextCover, new TCAspects.TC_AspectStack(TCAspects.ARBOR, 1L)));
        ItemList.Plank_Plum.set(
                addItem(Plank_Plum.ID, "Plum Plank", aTextCover, new TCAspects.TC_AspectStack(TCAspects.ARBOR, 1L)));
        ItemList.Plank_Maple.set(
                addItem(Plank_Maple.ID, "Maple Plank", aTextCover, new TCAspects.TC_AspectStack(TCAspects.ARBOR, 1L)));
        ...
        ItemList.Item_Redstone_Sniffer.set(
                new ItemRedstoneSniffer("Item_Redstone_Sniffer", "Redstone Sniffer", "What are these frequencies?!"));
    ...
    public void initAssemblerRecipes() {
        RA.stdBuilder()
                ...
                .duration(2 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_MV).addTo(assemblerRecipes);
        RA.stdBuilder()
                .itemInputs(
        ...
        RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.Cover_WirelessFluidDetector.get(1L)).duration(2 * MINUTES + 40 * SECONDS)
        ...
        RA.stdBuilder()
                .itemInputs(
                        ...
                        ItemList.Emitter_EV.get(1L),
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.Cover_WirelessItemDetector.get(1L)).duration(2 * MINUTES + 40 * SECONDS)
                .eut(TierEU.RECIPE_MV).addTo(assemblerRecipes);
        RA.stdBuilder()
                .itemInputs(
                        ...
                        ItemList.Emitter_EV.get(1L),
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.Cover_WirelessNeedsMaintainance.get(1L)).duration(2 * MINUTES + 40 * SECONDS)
                .eut(TierEU.RECIPE_MV).addTo(assemblerRecipes);
        RA.stdBuilder()
                .itemInputs(
                        ...
                        ItemList.Emitter_EV.get(1L),
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.Cover_WirelessActivityDetector.get(1L)).duration(2 * MINUTES + 40 * SECONDS)
                .eut(TierEU.RECIPE_MV).addTo(assemblerRecipes);
    }
    ...
    public void initExtractorRecipes() {
        RA.stdBuilder().itemInputs(new ItemStack(Blocks.red_flower, 1, 0)).itemOutputs(new ItemStack(Items.dye, 2, 1))
                .duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(new ItemStack(Blocks.red_flower, 1, 1)).itemOutputs(new ItemStack(Items.dye, 2, 12))
                .duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(new ItemStack(Blocks.red_flower, 1, 2)).itemOutputs(new ItemStack(Items.dye, 2, 13))
                .duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(new ItemStack(Blocks.red_flower, 1, 3)).itemOutputs(new ItemStack(Items.dye, 2, 7))
                .duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(new ItemStack(Blocks.red_flower, 1, 4)).itemOutputs(new ItemStack(Items.dye, 2, 1))
                .duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(new ItemStack(Blocks.red_flower, 1, 5)).itemOutputs(new ItemStack(Items.dye, 2, 14))
                .duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(new ItemStack(Blocks.red_flower, 1, 6)).itemOutputs(new ItemStack(Items.dye, 2, 7))
                .duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(new ItemStack(Blocks.red_flower, 1, 7)).itemOutputs(new ItemStack(Items.dye, 2, 9))
                .duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(new ItemStack(Blocks.red_flower, 1, 8)).itemOutputs(new ItemStack(Items.dye, 2, 7))
                .duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(new ItemStack(Blocks.yellow_flower, 1, 0))
                .itemOutputs(new ItemStack(Items.dye, 2, 11)).duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(new ItemStack(Blocks.double_plant, 1, 0))
                .itemOutputs(new ItemStack(Items.dye, 3, 11)).duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(new ItemStack(Blocks.double_plant, 1, 1))
                .itemOutputs(new ItemStack(Items.dye, 3, 13)).duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(new ItemStack(Blocks.double_plant, 1, 4)).itemOutputs(new ItemStack(Items.dye, 3, 1))
                .duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(new ItemStack(Blocks.double_plant, 1, 5)).itemOutputs(new ItemStack(Items.dye, 3, 9))
                .duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_Plumbilia.get(9L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Lead, 1L)).duration(15 * SECONDS)
                .eut(16).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_Argentia.get(9L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Silver, 1L)).duration(15 * SECONDS)
                .eut(16).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_Indigo.get(1L)).itemOutputs(ItemList.Dye_Indigo.get(1L))
                .duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_MilkWart.get(1L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Milk, 1L)).duration(15 * SECONDS)
                .eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_Coppon.get(9L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Copper, 1L)).duration(15 * SECONDS)
                .eut(16).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_Tine.get(9L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Tin, 1L)).duration(15 * SECONDS)
                .eut(16).addTo(extractorRecipes);

    }

    public void initCompressorRecipes() {
        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_Coppon.get(4L)).itemOutputs(new ItemStack(Blocks.wool, 1, 1))
                .duration(15 * SECONDS).eut(2).addTo(compressorRecipes);

        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_Plumbilia.get(4L))
                .itemOutputs(ItemList.IC2_PlantballCompressed.get(1L)).duration(15 * SECONDS).eut(2)
                .addTo(compressorRecipes);

        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_Argentia.get(4L))
                .itemOutputs(ItemList.IC2_PlantballCompressed.get(1L)).duration(15 * SECONDS).eut(2)
                .addTo(compressorRecipes);

        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_Indigo.get(4L))
                .itemOutputs(ItemList.IC2_PlantballCompressed.get(1L)).duration(15 * SECONDS).eut(2)
                .addTo(compressorRecipes);

        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_Ferru.get(4L))
                .itemOutputs(ItemList.IC2_PlantballCompressed.get(1L)).duration(15 * SECONDS).eut(2)
                .addTo(compressorRecipes);

        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_Aurelia.get(4L))
                .itemOutputs(ItemList.IC2_PlantballCompressed.get(1L)).duration(15 * SECONDS).eut(2)
                .addTo(compressorRecipes);

        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_OilBerry.get(4L))
                .itemOutputs(ItemList.IC2_PlantballCompressed.get(1L)).duration(15 * SECONDS).eut(2)
                .addTo(compressorRecipes);

        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_BobsYerUncleRanks.get(4L))
                .itemOutputs(ItemList.IC2_PlantballCompressed.get(1L)).duration(15 * SECONDS).eut(2)
                .addTo(compressorRecipes);

        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_Tine.get(4L))
                .itemOutputs(ItemList.IC2_PlantballCompressed.get(1L)).duration(15 * SECONDS).eut(2)
                .addTo(compressorRecipes);

        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_Rape.get(4L))
                .itemOutputs(ItemList.IC2_PlantballCompressed.get(1L)).duration(15 * SECONDS).eut(2)
                .addTo(compressorRecipes);

        RA.stdBuilder().itemInputs(new ItemStack(Blocks.red_flower, 8, 32767))
                .itemOutputs(ItemList.IC2_PlantballCompressed.get(1L)).duration(15 * SECONDS).eut(2)
                .addTo(compressorRecipes);

        RA.stdBuilder().itemInputs(new ItemStack(Blocks.yellow_flower, 8, 32767))
                .itemOutputs(ItemList.IC2_PlantballCompressed.get(1L)).duration(15 * SECONDS).eut(2)
                .addTo(compressorRecipes);
    }

    public void initMaceratorRecipes() {
        RA.stdBuilder().itemInputs(ItemList.Food_Sliced_Cheese.get(1L))
        ...
        RA.stdBuilder().itemInputs(ItemList.Dye_Cocoa.get(1L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Cocoa, 1L)).duration(20 * SECONDS)
                .eut(2).addTo(maceratorRecipes);

        RA.stdBuilder().itemInputs(ItemList.Crop_Drop_Tine.get(1L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dustSmall, Materials.Wood, 2L)).duration(20 * SECONDS)
                .eut(2).addTo(maceratorRecipes);

        RA.stdBuilder().itemInputs(new ItemStack(Blocks.pumpkin, 1, 0))
                .itemOutputs(new ItemStack(Items.pumpkin_seeds, 4, 0)).duration(20 * SECONDS).eut(2)
                .addTo(maceratorRecipes);

        RA.stdBuilder().itemInputs(new ItemStack(Items.melon, 1, 0)).itemOutputs(new ItemStack(Items.melon_seeds, 1, 0))
                .duration(20 * SECONDS).eut(2).addTo(maceratorRecipes);

        RA.stdBuilder().itemInputs(GTModHandler.getIC2Item("crop", 1L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Wood, 1L)).duration(20 * SECONDS)
                .eut(2).addTo(maceratorRecipes);

        RA.stdBuilder().itemInputs(new ItemStack(Items.stick, 1))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dustSmall, Materials.Wood, 2L)).duration(20 * SECONDS)
                .eut(2).addTo(maceratorRecipes);

        RA.stdBuilder().itemInputs(new ItemStack(Blocks.wool, 1, WILDCARD))
                .itemOutputs(new ItemStack(Items.string, 2), new ItemStack(Items.string, 1)).outputChances(10000, 5000)
                .duration(20 * SECONDS).eut(2).addTo(maceratorRecipes);

        RA.stdBuilder().itemInputs(ItemList.Tesseract.get(1))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, MaterialsUEVplus.TranscendentMetal, 8L))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_UIV).addTo(maceratorRecipes);
    }
        ...
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 0, new ItemStack(Blocks.planks, 1, 0))),
                        0));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 1, new ItemStack(Blocks.planks, 1, 0))),
                        1));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 2, new ItemStack(Blocks.planks, 1, 0))),
                        2));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 3, new ItemStack(Blocks.planks, 1, 0))),
                        3));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 4, new ItemStack(Blocks.planks, 1, 0))),
                        4));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 5, new ItemStack(Blocks.planks, 1, 0))),
                        5));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 6, new ItemStack(Blocks.planks, 1, 0))),
                        6));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 7, new ItemStack(Blocks.planks, 1, 0))),
                        7));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 8, new ItemStack(Blocks.planks, 1, 0))),
                        8));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 9, new ItemStack(Blocks.planks, 1, 0))),
                        9));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 10, new ItemStack(Blocks.planks, 1, 0))),
                        10));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 11, new ItemStack(Blocks.planks, 1, 0))),
                        11));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 12, new ItemStack(Blocks.planks, 1, 0))),
                        12));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 13, new ItemStack(Blocks.planks, 1, 0))),
                        13));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 14, new ItemStack(Blocks.planks, 1, 0))),
                        14));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 15, new ItemStack(Blocks.planks, 1, 0))),
                        15));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 16, new ItemStack(Blocks.planks, 1, 0))),
                        0));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 17, new ItemStack(Blocks.planks, 1, 0))),
                        1));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 18, new ItemStack(Blocks.planks, 1, 0))),
                        2));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 19, new ItemStack(Blocks.planks, 1, 0))),
                        3));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 20, new ItemStack(Blocks.planks, 1, 0))),
                        4));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 21, new ItemStack(Blocks.planks, 1, 0))),
                        5));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 22, new ItemStack(Blocks.planks, 1, 0))),
                        6));
        CoverRegistry.registerDecorativeCover(
                ...
                TextureFactory.of(
                        GTUtility.getBlockFromStack(
                                GTModHandler
                                        .getModItem(Forestry.ID, "planks", 1L, 23, new ItemStack(Blocks.planks, 1, 0))),
                        7));
        CoverRegistry.registerDecorativeCover(
