...
public class GT_MetaGenerated_Item_02 extends GT_MetaGenerated_Item_X32 {
    ...
    public GT_MetaGenerated_Item_02() {
        ...
        ItemList.Crop_Drop_Rape.set(addItem(tLastID = 557, "Rapeseed", "Time to oil up!", new TC_Aspects.TC_AspectStack(TC_Aspects.MESSIS, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.HERBA, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.POTENTIA, 1L)));
