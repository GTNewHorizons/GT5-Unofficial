...
public class MetaGeneratedItem03 extends MetaGeneratedItemX32 {
    ...
    public MetaGeneratedItem03() {
        ...
        ItemList.Circuit_Wafer_Ram
            .set(addItem(Circuit_Wafer_Ram.ID, "Random Access Memory Chip (Wafer)", "Raw Circuit", "waferRAM"));
        ItemList.Circuit_Chip_Ram
            .set(addItem(Circuit_Chip_Ram.ID, "Random Access Memory Chip", "Integrated Circuit", "chipRAM"));
