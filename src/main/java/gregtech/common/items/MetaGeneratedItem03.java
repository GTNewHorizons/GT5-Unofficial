...
public class MetaGeneratedItem03 extends MetaGeneratedItemX32 implements IItemFirestoneBurning {
    ...
    public MetaGeneratedItem03() {
        ...
        ItemList.KevlarFiber.set(addItem(KevlarFiber.ID, "Kevlar Fiber", "Spun Kevlar Fiber, ready for it's bath", o));
        ItemList.WovenKevlar.set(addItem(WovenKevlar.ID, "Woven Kevlar", "Tough and ready for use, or is it?", o));
        ItemList.Spinneret.set(addItem(Spinneret.ID, "Spinneret", "For making Kevlar Fiber", o));
        ItemList.DrawnKevlarFiber
            .set(addItem(DrawnKevlarFiber.ID, "Drawn Kevlar Fiber", "Drawn through a coagulant bath", o));
