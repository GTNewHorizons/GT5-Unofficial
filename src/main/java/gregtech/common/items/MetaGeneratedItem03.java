...
public class MetaGeneratedItem03 extends MetaGeneratedItemX32 implements IItemFirestoneBurning {
    ...
    public MetaGeneratedItem03() {
        ...
        ItemList.Item_Power_Goggles.set(
                new ItemPowerGoggles(
                        "Power_Goggles",
                        "Power Goggles",
                        "For when you need to look at power storage 24/7"));
        /*
        ...
        ItemList.Circuit_Parts_GlassFiber.set(
                addItem(Circuit_Parts_GlassFiber.ID, "Glass Fiber", Materials.BorosilicateGlass.mChemicalFormula, o));
        ...
        ItemList.Circuit_Parts_ResistorASMD.set(
                addItem(Circuit_Parts_ResistorASMD.ID, "Advanced SMD Resistor", "Advanced Electronic Component", o));
        ...
        ItemList.Circuit_Parts_CapacitorASMD.set(
                addItem(Circuit_Parts_CapacitorASMD.ID, "Advanced SMD Capacitor", "Advanced Electronic Component", o));
        ...
        ItemList.Circuit_Parts_DiodeXSMD.set(
                addItem(Circuit_Parts_DiodeXSMD.ID, "Optical SMD Diode", "Highly Advanced Electronic Component", o));
        ...
        ItemList.Circuit_Parts_InductorASMD.set(
                addItem(Circuit_Parts_InductorASMD.ID, "Advanced SMD Inductor", "Advanced Electronic Component", o));
        ...
        ItemList.Circuit_Chip_Ram.set(
                addItem(Circuit_Chip_Ram.ID, "Random Access Memory Chip", "Integrated Circuit", "chipRAM", "chip"));
        ...
        ItemList.Circuit_Chip_QuantumCPU.set(
                addItem(Circuit_Chip_QuantumCPU.ID, "QBit Processing Unit", "Quantum CPU", "chipQuantumCPU", "chip"));
        ...
        ItemList.Circuit_Chip_Simple_SoC.set(
                addItem(Circuit_Chip_Simple_SoC.ID, "Simple SoC", "Simple System on a Chip", "chipSimpleSoC", "chip"));
        ...
        ItemList.Circuit_Chip_ULPIC.set(
                addItem(Circuit_Chip_ULPIC.ID, "Ultra Low Power IC", "Ultra Low Power Circuit", "chipULPIC", "chip"));
        ...
        ItemList.Circuit_Parts_RawCrystalParts.set(
                addItem(Circuit_Parts_RawCrystalParts.ID, "Raw Crystal Chip Parts", "Raw Crystal Processor Parts", o));
        ...
        ItemList.Circuit_Board_Multifiberglass_Elite.set(
                addItem(Circuit_Board_Multifiberglass_Elite.ID, "Elite Circuit Board", "A elite Circuit Board", o));
        ...
        ItemList.GalliumArsenideCrystalSmallPart.set(
                addItem(GalliumArsenideCrystalSmallPart.ID, "Small Gallium Arsenide Crystal", "For making boules", o));
        ...
        ItemList.Thermal_Superconductor.set(
                addItem(Thermal_Superconductor.ID, "Thermal Superconductor", "With the power of second sound!", o));
        ...
        ItemList.Intensely_Bonded_Netherite_Nanoparticles.set(
                addItem(Intensely_Bonded_Netherite_Nanoparticles.ID, "Intensely Bonded Netherite Nanoparticles", ""));
    ...
    private void registerCovers() {
        CoverRegistry.registerCover(
                ...
                CoverPlacer.builder().onlyPlaceIf(CoverMetricsTransmitter::isCoverPlaceable).build());
        CoverRegistry.registerCover(
