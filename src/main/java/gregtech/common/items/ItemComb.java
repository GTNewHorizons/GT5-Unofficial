...
public class ItemComb extends Item {
    ...
    public void initCombsRecipes() {
        ...
        addCentrifugeToMaterial(
                ...
                new int[] {(int) (0.01 * 100), (int) (0.05 * 100)},
                new int[] {},
                Voltage.UIV,
                96000,
                NI,
                ...
                switch (comb) {
                    case NEUTRONIUM:
                        ...
                        RA.addChemicalRecipe(
                                ...
                                Materials.Neutronium.getDustSmall(1),
                                NI,
    ...
    public void addCentrifugeToMaterial(
        ...
        for (int i = 0; i < (aMaterial.length); i++) {
            ...
            if (Math.max(1, stackSize[i]) % 9 == 0) {
                ...
                aOutPut[i] =
                        GT_OreDictUnificator.get(OrePrefixes.dustSmall, aMaterial[i], (Math.max(1, stackSize[i]) / 4));
            } else {
