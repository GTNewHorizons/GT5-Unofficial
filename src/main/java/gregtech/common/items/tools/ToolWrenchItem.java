 ...
 * a wrench actually does -- including the cross-mod interfaces -- lives entirely in {@link WrenchBehavior}, where
 * both reach it. See {@link ToolItemBase} for everything these have in common with the other standalone tools.
 */
public class ToolWrenchItem extends ToolItemBase implements WrenchBehavior {
