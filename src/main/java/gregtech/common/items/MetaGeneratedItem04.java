...
public class MetaGeneratedItem04 extends MetaGeneratedItem {
    ...
    private void addManipulatorParts() {
        ItemList.MatterManipulatorHologram.set(
            addItem(
                MatterManipulatorHologram.ID,
                "Matter Manipulator Plan",
                ""));
        ItemList.MatterManipulatorPowerCore0.set(
            addItem(
                MatterManipulatorPowerCore0.ID,
                "Prototype Matter Manipulator Power Core",
                ""));
        ItemList.MatterManipulatorComputerCore0.set(
            addItem(
                MatterManipulatorComputerCore0.ID,
                "Prototype Matter Manipulator Computer Core",
                ""));
        ItemList.MatterManipulatorTeleporterCore0.set(
            addItem(
                MatterManipulatorTeleporterCore0.ID,
                "Prototype Matter Manipulator Teleporter Core",
                ""));
        ItemList.MatterManipulatorFrame0.set(
            addItem(
                MatterManipulatorFrame0.ID,
                "Prototype Matter Manipulator Frame",
                ""));
        ItemList.MatterManipulatorLens0.set(
            addItem(
                MatterManipulatorLens0.ID,
                "Prototype Matter Manipulator Lens Assembly",
                ""));
        ItemList.MatterManipulatorPowerCore1.set(
            addItem(
                MatterManipulatorPowerCore1.ID,
                "Matter Manipulator Power Core MKI",
                ""));
        ItemList.MatterManipulatorComputerCore1.set(
            addItem(
                MatterManipulatorComputerCore1.ID,
                "Matter Manipulator Computer Core MKI",
                ""));
        ItemList.MatterManipulatorTeleporterCore1.set(
            addItem(
                MatterManipulatorTeleporterCore1.ID,
                "Matter Manipulator Teleporter Core MKI",
                ""));
        ItemList.MatterManipulatorFrame1.set(
            addItem(
                MatterManipulatorFrame1.ID,
                "Matter Manipulator Frame MKI",
                ""));
        ItemList.MatterManipulatorLens1.set(
            addItem(
                MatterManipulatorLens1.ID,
                "Matter Manipulator Lens Assembly MKI",
                ""));
        ItemList.MatterManipulatorPowerCore2.set(
            addItem(
                MatterManipulatorPowerCore2.ID,
                "Matter Manipulator Power Core MKII",
                ""));
        ItemList.MatterManipulatorComputerCore2.set(
            addItem(
                MatterManipulatorComputerCore2.ID,
                "Matter Manipulator Computer Core MKII",
                ""));
        ItemList.MatterManipulatorTeleporterCore2.set(
            addItem(
                MatterManipulatorTeleporterCore2.ID,
                "Matter Manipulator Teleporter Core MKII",
                ""));
        ItemList.MatterManipulatorFrame2.set(
            addItem(
                MatterManipulatorFrame2.ID,
                "Matter Manipulator Frame MKII",
                ""));
        ItemList.MatterManipulatorLens2.set(
            addItem(
                MatterManipulatorLens2.ID,
                "Matter Manipulator Lens Assembly MKII",
                ""));
        ItemList.MatterManipulatorPowerCore3.set(
            addItem(
                MatterManipulatorPowerCore3.ID,
                "Matter Manipulator Power Core MKIII",
                ""));
        ItemList.MatterManipulatorComputerCore3.set(
            addItem(
                MatterManipulatorComputerCore3.ID,
                "Matter Manipulator Computer Core MKIII",
                ""));
        ItemList.MatterManipulatorTeleporterCore3.set(
            addItem(
                MatterManipulatorTeleporterCore3.ID,
                "Matter Manipulator Teleporter Core MKIII",
                ""));
        ItemList.MatterManipulatorFrame3.set(
            addItem(
                MatterManipulatorFrame3.ID,
                "Matter Manipulator Frame MKIII",
                ""));
        ItemList.MatterManipulatorLens3.set(
            addItem(
                MatterManipulatorLens3.ID,
                "Matter Manipulator Lens Assembly MKIII",
                ""));
    }
