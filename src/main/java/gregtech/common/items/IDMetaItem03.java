...
public enum IDMetaItem03 {
    ...
    Steamgate_Chevron(250),
    Steamgate_Chevron_Upgrade(251),
    Steamgate_Iris_Blade(252),
    Steamgate_Iris_Upgrade(253),
    Steamgate_Plate(254),
    Steamgate_Frame(255),
    Steamgate_Core_Crystal(256),
    Hydraulic_Motor_Steam(257),
    Hydraulic_Piston_Steam(258),
    Hydraulic_Pump_Steam(259),
    Hydraulic_Arm_Steam(260),
    Hydraulic_Conveyor_Steam(261),
    Hydraulic_Regulator_Steam(262),
    Hydraulic_Vapor_Generator(263),
    Hydraulic_Emitter_Steam(264),
    Hydraulic_Sensor_Steam(265),
    Steamgate_Dialing_Device(266),
    Simple_Bronze_Turbine(267),
