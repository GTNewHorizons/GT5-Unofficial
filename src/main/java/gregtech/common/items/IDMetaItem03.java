...
public enum IDMetaItem03 {
    ...
    Steamgate_Chevron(242),
    Steamgate_Chevron_Upgrade(243),
    Steamgate_Iris_Blade(244),
    Steamgate_Iris_Upgrade(245),
    Steamgate_Plate(246),
    Steamgate_Frame(247),
    Steamgate_Core_Crystal(248),
    Hydraulic_Motor_Steam(249),
    Hydraulic_Piston_Steam(250),
    Hydraulic_Pump_Steam(251),
    Hydraulic_Arm_Steam(252),
    Hydraulic_Conveyor_Steam(253),
    Hydraulic_Regulator_Steam(254),
