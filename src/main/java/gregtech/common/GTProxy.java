    ...
    public void onItemTooltip(ItemTooltipEvent event) {
        if (event.itemStack != null) {
            ...
            if (providesProtection(aStackTemp)) {
                event.toolTip.add(EnumChatFormatting.LIGHT_PURPLE + GTLanguageManager.addStringLocalization("gt.providesfullhazmatprotection","Provides full hazmat protection."));
            }
        }
    }
