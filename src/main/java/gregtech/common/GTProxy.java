...
public abstract class GTProxy implements IGTMod, IFuelHandler {
    ...
    public Fluid addAutogeneratedPlasmaFluid(Materials aMaterial) {
        ...
        // All lower case.
        final String fluidTexture = aMaterial.mIconSet.is_custom ? ("plasma." + aMaterial.mIconSet.aTextCustomAutogenerated.toLowerCase())
    ...
    public Fluid addAutogeneratedMoltenFluid(Materials aMaterial) {
        ...
        // All lower case.
        final String fluidTexture = aMaterial.mIconSet.is_custom ? ("molten." + aMaterial.mIconSet.aTextCustomAutogenerated.toLowerCase())
