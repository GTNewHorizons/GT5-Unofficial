...
public class GTProxy implements IFuelHandler {
    ...
    public Fluid addAutoGeneratedCorrespondingFluid(Materials aMaterial) {
        ...
        // All lower case.
        final String fluidTexture = aMaterial.mIconSet.hasCustomFluid() ? "fluid." + aMaterial.mName.toLowerCase()
            : "autogenerated";
    ...
    public Fluid addAutoGeneratedCorrespondingGas(Materials aMaterial) {
        ...
        // lower case.
        final String fluidTexture = aMaterial.mIconSet.hasCustomFluid() ? ("gas." + aMaterial.mName.toLowerCase())
            : "autogenerated";
    ...
    public Fluid addAutogeneratedPlasmaFluid(Materials aMaterial) {
        ...
        // All lower case.
        final String fluidTexture = aMaterial.mIconSet.hasCustomFluid()
