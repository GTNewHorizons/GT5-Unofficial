...
public class GTProxy implements IFuelHandler {
    ...
    public Fluid addAutoGeneratedCorrespondingFluid(Material aMaterial) {
        ...
        // All lower case.
        final String fluidTexture = MaterialUtils.isCustomTextureSet(aMaterial)
    ...
    public Fluid addAutogeneratedPlasmaFluid(Material aMaterial) {
        ...
        // All lower case.
        final String fluidTexture = MaterialUtils.isCustomTextureSet(aMaterial)
            ? ("plasma." + MaterialUtils.customTextureSetName(aMaterial)
                .toLowerCase())
    ...
    public Fluid addAutogeneratedMoltenFluid(Material aMaterial) {
        ...
        // All lower case.
        final String fluidTexture = MaterialUtils.isCustomTextureSet(aMaterial)
            ? ("molten." + MaterialUtils.customTextureSetName(aMaterial)
                .toLowerCase())
        ...
        for (int i = 0; i < 3; i++) {
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    ...
                    MaterialLibAPI
                        .getFluidStack(Materials.Hydrogen, FluidShapes.fluidGas, (int) (hydrogenAmount * 800)))
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    MaterialLibAPI
                        .getFluidStack(Materials.Hydrogen, FluidShapes.fluidGas, (int) (hydrogenAmount * 1000)))
                .fluidOutputs(new FluidStack(crackedFluids[i], 800))
                .duration((8 + 4 * i) * SECONDS)
                .eut(TierEU.RECIPE_LV)
                .addTo(RecipeMaps.chemicalReactorRecipes);
