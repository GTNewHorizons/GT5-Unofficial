...
public final class GTMiscCommand extends GTBaseCommand {
    ...
    public String getCommandUsage(ICommandSender sender) {
        return "Usage: gt <chunks|cleanroom_bypass|dump_music_durations|global_energy_add|global_energy_display|global_energy_join|global_energy_set|ore-showroom|pollution|toggle>";
    }
    ...
    protected List<IChatComponent> getHelpMessages() {
        ...
        list.add(new ChatComponentText("Usage: gt <chunks|cleanroom_bypass|dump_music_durations|global_energy_add|global_energy_display|global_energy_join|global_energy_set|ore-showroom|pollution|toggle>"));
        ...
        list.add(new ChatComponentText("\"ore-showroom [confirm]\" - builds a texture-testing showroom from registered ore mixes"));
        ...
        switch (args[0]) {
            ...
            case "ore-showroom" -> {
                if (sender instanceof EntityPlayerMP player) {
                    OreShowroom.process(player, args);
                } else {
                    sendChatToPlayer(
                        sender,
                        EnumChatFormatting.RED + "The ore showroom must be generated by a player.");
                }
            }
