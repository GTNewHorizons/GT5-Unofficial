...
public abstract class GT_Proxy implements IGT_Mod, IGuiHandler, IFuelHandler, IGlobalWirelessEnergy {
    ...
    public Fluid addAutoGeneratedCorrespondingFluid(Materials aMaterial) {
        ...
        final String fluidTexture =
                aMaterial.mIconSet.isCustom ? "fluid." + aMaterial.mName.toLowerCase() : "autogenerated";
    ...
    public Fluid addAutoGeneratedCorrespondingGas(Materials aMaterial) {
        ...
        // lower case.
        final String fluidTexture =
                aMaterial.mIconSet.isCustom ? ("gas." + aMaterial.mName.toLowerCase()) : "autogenerated";
    ...
    public Fluid addAutogeneratedPlasmaFluid(Materials aMaterial) {
        ...
        // All lower case.
        final String fluidTexture =
                aMaterial.mIconSet.isCustom ? ("plasma." + aMaterial.mName.toLowerCase()) : "plasma.autogenerated";
    ...
    public Fluid addAutogeneratedMoltenFluid(Materials aMaterial) {
        ...
        // All lower case.
        final String fluidTexture =
                aMaterial.mIconSet.isCustom ? ("molten." + aMaterial.mName.toLowerCase()) : "molten.autogenerated";
