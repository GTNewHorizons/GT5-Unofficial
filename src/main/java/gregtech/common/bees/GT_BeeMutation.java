...
public class GT_BeeMutation extends BeeMutation {

    private final float split;

    public GT_BeeMutation(IAlleleBeeSpecies bee0, IAlleleBeeSpecies bee1, IAllele[] result, int chance, float split) {
