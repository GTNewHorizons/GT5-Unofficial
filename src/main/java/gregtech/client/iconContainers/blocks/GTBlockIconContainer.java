...
public class GTBlockIconContainer extends AbstractBlockIconContainer implements Runnable {
    ...
    /// This icon's domain-qualified resource path, e.g. `gregtech:iconsets/BLOCK_ADAMANTIUM`. Safe to read
    /// outside the client: it names a resource location, not a bound texture.
