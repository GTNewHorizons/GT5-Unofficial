...
public class CommonProxy implements IGuiHandler {
    ...
    public void onPostLoad() {
        ...
        GT_ModHandler.addShapelessCraftingRecipe(DetravItemList.Solar_Boiler_Low.get(1L, new Object[0]),new Object[]{"B",Character.valueOf('B'), ItemList.Machine_Bronze_Boiler_Solar});
