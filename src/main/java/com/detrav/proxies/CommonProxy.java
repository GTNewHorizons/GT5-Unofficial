...
public class CommonProxy implements IGuiHandler {
    ...
    public void onPostLoad() {
        ...
        GT_ModHandler.addCraftingRecipe(DetravItemList.Solar_Boiler_High.get(1L, new Object[0]), GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE | GT_ModHandler.RecipeBits.BUFFERED, new Object[]{"GSG", "RXR", "PMP", Character.valueOf('M'), DetravItemList.Solar_Boiler_Medium, Character.valueOf('P'), Character.valueOf('X'), ItemList.Casing_HV, Character.valueOf('S'), ItemList.Cover_SolarPanel_8V, OrePrefixes.pipeLarge.get(Materials.StainlessSteel), Character.valueOf('R'), OrePrefixes.plate.get(Materials.SterlingSilver), Character.valueOf('G'),GT_ModHandler.getIC2Item("reinforcedGlass", 1L),});
