...
public class RadioHatchMaterialLoader {
    ...
    public static void run() {
        ...
        GT_Values.RA.stdBuilder()
            ...
            .duration(3)
            .eut((int) WerkstoffLoader.Tiberium.getBridgeMaterial().getProtons())
            .metadata(DECAY_TICKS,(int) calcDecayTicks((int) WerkstoffLoader.Tiberium.getBridgeMaterial().getProtons()))
            .addTo(radioHatchRecipes);
        GT_Values.RA.stdBuilder()
            .itemInputs(
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                BW_NonMeta_MaterialItems.TheCoreCell.get(1)
            )
            .duration(96)
            .eut(140)
            .metadata(DECAY_TICKS,(int) calcDecayTicks(140))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .duration(3)
            .eut((int) WerkstoffLoader.Tiberium.getBridgeMaterial().getProtons() / 10)
            .metadata(DECAY_TICKS,(int) calcDecayTicks((int) WerkstoffLoader.Tiberium.getBridgeMaterial().getProtons() / 10))
            .addTo(radioHatchRecipes);
        GT_Values.RA.stdBuilder()
            .itemInputs(
