...
public class Electrolyzer implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Magnesium, 2L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 1L))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 5L),
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Calcium, 1L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 1L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 2L))
            .fluidOutputs(Materials.Oxygen.getGas(2000L))
            .duration(15 * SECONDS)
            .eut(90)
            .addTo(electrolyzerRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Potassium, 1L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 3L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 3L),
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Potassium, 1L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Chrome, 3L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 3L),
                OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2))
            .fluidOutputs(Materials.Oxygen.getGas(2000L))
            .duration(23 * SECONDS)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium, 1L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Vanadium, 3L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Magnalium, 6L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 6),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Boron, 3),
                OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 3))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 6L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 6),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Boron, 3),
                OreDictUnificator.get(OrePrefixes.cell, Materials.Fluorine, 3))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium, 1L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 9L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 6L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.Boron, 3),
