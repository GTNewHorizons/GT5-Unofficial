...
public class GT_MetaTileEntity_Hatch_ParamText extends GT_MetaTileEntity_Hatch_Param {
    ...
    public void addUIWidgets(ModularWindow.Builder builder, UIBuildContext buildContext) {
        ...
        addChangeNumberButton(builder, -16, -4, 7, UITextures.OVERLAY_BUTTON_MINUS_LARGE);
        addChangeNumberButton(builder, -2, -1, 25, UITextures.OVERLAY_BUTTON_MINUS_SMALL);
        addChangeNumberButton(builder, 2, 1, 133, UITextures.OVERLAY_BUTTON_PLUS_SMALL);
        addChangeNumberButton(builder, 16, 4, 151, UITextures.OVERLAY_BUTTON_PLUS_LARGE);
    ...
    private void addChangeNumberButton(ModularWindow.Builder builder, int changeNumberShift, int changeNumber, int xPos,
        ...
        builder.widget(new ButtonWidget().setOnClick((clickData, widget) -> {
            ...
            .setBackground(UITextures.BUTTON_STANDARD, overlay, TecTechUITextures.OVERLAY_BUTTON_PARAMETRIZER_ID)
            .setSize(18, 18)
            .setPos(xPos, 4));
    }
