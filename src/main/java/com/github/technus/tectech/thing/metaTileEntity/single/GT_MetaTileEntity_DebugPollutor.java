 ...
 */
public class GT_MetaTileEntity_DebugPollutor extends TieredMachineBlock implements IAddUIWidgets, IAddGregtechLogo {
    ...
    public void addUIWidgets(ModularWindow.Builder builder, UIBuildContext buildContext) {
        ...
        addChangeNumberButton(builder, UITextures.OVERLAY_BUTTON_MINUS_LARGE, val -> pollution -= val, 512, 64, 7, 4);
        addChangeNumberButton(builder, UITextures.OVERLAY_BUTTON_MINUS_LARGE, val -> pollution /= val, 512, 64, 7, 22);

        addChangeNumberButton(builder, UITextures.OVERLAY_BUTTON_MINUS_SMALL, val -> pollution -= val, 16, 1, 25, 4);
        addChangeNumberButton(builder, UITextures.OVERLAY_BUTTON_MINUS_SMALL, val -> pollution /= val, 16, 2, 25, 22);

        addChangeNumberButton(builder, UITextures.OVERLAY_BUTTON_PLUS_SMALL, val -> pollution += val, 16, 1, 133, 4);
        addChangeNumberButton(builder, UITextures.OVERLAY_BUTTON_PLUS_SMALL, val -> pollution *= val, 16, 2, 133, 22);

        addChangeNumberButton(builder, UITextures.OVERLAY_BUTTON_PLUS_LARGE, val -> pollution += val, 512, 64, 151, 4);
        addChangeNumberButton(builder, UITextures.OVERLAY_BUTTON_PLUS_LARGE, val -> pollution *= val, 512, 64, 151, 22);
