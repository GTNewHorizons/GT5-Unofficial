        ...
        if (EternalSingularity.isModLoaded()) {
            ...
            TT_recipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { CustomItemList.EOH_Infinite_Energy_Casing.get(1),
                    GregtechItemList.SpaceTimeContinuumRipper.get(4), ItemList.Sensor_UMV.get(16),
                    ItemList.Robot_Arm_UMV.get(64), ItemList.Field_Generator_UMV.get(4),
                    ItemList.EnergisedTesseract.get(32), ItemList.ZPM5.get(1),
