...
public class MachineRecipes implements Runnable {
    ...
    public void run() {
        ...
        TT_recipeAdder.addResearchableAssemblylineRecipe(
            ...
            500000,
            2,
            new Object[] { new ItemStack(BlockCasingSpaceElevator.INSTANCE, 1, 0), ItemList.Electric_Motor_UV.get(4),
        ...
        TT_recipeAdder.addResearchableAssemblylineRecipe(
            ...
            2000000,
            2,
            new Object[] { new ItemStack(BlockCasingSpaceElevator.INSTANCE, 1, 0), ItemList.Electric_Motor_UHV.get(4),
                GT_OreDictUnificator.get(OrePrefixes.ring, Materials.CosmicNeutronium, 8),
        ...
        TT_recipeAdder.addResearchableAssemblylineRecipe(
            ...
            2000000,
            2,
            new Object[] { new ItemStack(BlockCasingSpaceElevator.INSTANCE, 1, 0), ItemList.Electric_Motor_UEV.get(4),
        ...
        TT_recipeAdder.addResearchableAssemblylineRecipe(
            ...
            2000000,
            2,
            new Object[] { new ItemStack(BlockCasingSpaceElevator.INSTANCE, 1, 0), ItemList.Electric_Motor_UIV.get(4),
        ...
        TT_recipeAdder.addResearchableAssemblylineRecipe(
            ...
            2000000,
            2,
            new Object[] { new ItemStack(BlockCasingSpaceElevator.INSTANCE, 1, 0), ItemList.Electric_Motor_UMV.get(4),
