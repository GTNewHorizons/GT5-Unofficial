package com.gtnewhorizon.gtnhintergalactic.tile.multi;

import static com.gtnewhorizon.gtnhintergalactic.client.IGTextures.ADVANCED_MACHINE_FRAME_INDEX;
...
import com.gtnewhorizon.gtnhintergalactic.client.IGTextures;
...
public class TileEntityPlanetaryGasSiphon extends GT_MetaTileEntity_EnhancedMultiBlockBase<TileEntityPlanetaryGasSiphon>
    ...
    public ITexture[] getTexture(IGregTechTileEntity baseMetaTileEntity, byte side, byte facing, byte colorIndex,
        ...
        if (side == facing) {
            if (active) return new ITexture[] { Textures.BlockIcons.getCasingTextureForId(ADVANCED_MACHINE_FRAME_INDEX),
            ...
            return new ITexture[] { Textures.BlockIcons.getCasingTextureForId(ADVANCED_MACHINE_FRAME_INDEX),
                    TextureFactory.of(IGTextures.SIPHON_OVERLAY_FRONT),
