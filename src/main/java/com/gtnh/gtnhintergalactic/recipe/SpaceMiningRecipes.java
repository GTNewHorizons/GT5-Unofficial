package com.gtnh.gtnhintergalactic.recipe;

import static com.gtnh.gtnhintergalactic.item.ItemMiningDrones.DroneMaterials;
import static com.gtnh.gtnhintergalactic.item.ItemMiningDrones.DroneTiers;
...
public class SpaceMiningRecipes {
    ...
    private static final ItemStack[] MINING_DRONES = new ItemStack[DroneTiers.values().length];
    /** Drills used for recipe creation */
    private static final ItemStack[] MINING_DRILLS = new ItemStack[DroneMaterials.values().length];
    /** Rods used for recipe creation */
    private static final ItemStack[] MINING_RODS = new ItemStack[DroneMaterials.values().length];

    static {
        for (DroneTiers droneTier : DroneTiers.values()) {
            MINING_DRONES[droneTier.ordinal()] = new ItemStack(IGItems.MiningDrones, 0, droneTier.ordinal());
        }
        for (DroneMaterials mat : DroneMaterials.values()) {
