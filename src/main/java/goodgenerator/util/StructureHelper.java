        ...
        return new IStructureElement<T>() {
            ...
            public boolean check(T t, World world, int x, int y, int z) {
                ...
                if (tBlock instanceof BaseMetaPipeEntity) {
                    ...
                    if (tFrame.getMetaTileEntity() instanceof MetaPipeEntity_Frame) {
                        return ((MetaPipeEntity_Frame) tFrame.getMetaTileEntity()).mMaterial == aMaterials;
                    }
                }
                return false;
            }
            ...
            public boolean placeBlock(T t, World world, int x, int y, int z, ItemStack trigger) {
                ItemStack tFrame = OreDictUnificator.get(OrePrefixes.frameGt, aMaterials, 1);
