...
public class MaterialFix {
    ...
    public static void MaterialFluidExtractionFix(Werkstoff material) {
        if (material.hasItemType(OrePrefixes.gearGtSmall)) {
            GTValues.RA.stdBuilder().itemInputs(material.get(OrePrefixes.gearGtSmall))
                    .fluidOutputs(material.getMolten(1 * INGOTS)).duration(1 * SECONDS + 12 * TICKS).eut(8)
                    .addTo(fluidExtractionRecipes);
        }
        if (material.hasItemType(OrePrefixes.spring)) {
            GTValues.RA.stdBuilder().itemInputs(material.get(OrePrefixes.spring))
                    .fluidOutputs(material.getMolten(1 * INGOTS)).duration(1 * SECONDS + 12 * TICKS).eut(8)
                    .addTo(fluidExtractionRecipes);
        }
        if (material.hasItemType(OrePrefixes.itemCasing)) {
            GTValues.RA.stdBuilder().itemInputs(material.get(OrePrefixes.itemCasing))
                    .fluidOutputs(material.getMolten(1 * HALF_INGOTS)).duration(16 * TICKS).eut(8)
                    .addTo(fluidExtractionRecipes);
        }
        if (material.hasItemType(OrePrefixes.wireGt01)) {
            GTValues.RA.stdBuilder().itemInputs(material.get(OrePrefixes.wireGt01))
                    .fluidOutputs(material.getMolten(1 * HALF_INGOTS)).duration(16 * TICKS).eut(8)
                    .addTo(fluidExtractionRecipes);
        }
        if (material.hasItemType(OrePrefixes.cableGt01)) {
            GTValues.RA.stdBuilder().itemInputs(material.get(OrePrefixes.cableGt01))
                    .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dustSmall, Materials.Ash, 2))
                    .fluidOutputs(material.getMolten(1 * HALF_INGOTS)).duration(16 * TICKS).eut(8)
                    .addTo(fluidExtractionRecipes);
        }
        if (material.hasItemType(OrePrefixes.foil)) {
            GTValues.RA.stdBuilder().itemInputs(material.get(OrePrefixes.foil))
                    .fluidOutputs(material.getMolten(1 * QUARTER_INGOTS)).duration(8 * TICKS).eut(8)
                    .addTo(fluidExtractionRecipes);
        }
        if (material.hasItemType(OrePrefixes.springSmall)) {
            GTValues.RA.stdBuilder().itemInputs(material.get(OrePrefixes.springSmall))
                    .fluidOutputs(material.getMolten(1 * QUARTER_INGOTS)).duration(8 * TICKS).eut(8)
                    .addTo(fluidExtractionRecipes);
        }
        if (material.hasItemType(OrePrefixes.ring)) {
            GTValues.RA.stdBuilder().itemInputs(material.get(OrePrefixes.ring))
                    .fluidOutputs(material.getMolten(1 * QUARTER_INGOTS)).duration(8 * TICKS).eut(8)
                    .addTo(fluidExtractionRecipes);
        }
        if (material.hasItemType(OrePrefixes.bolt)) {
            GTValues.RA.stdBuilder().itemInputs(material.get(OrePrefixes.bolt))
                    .fluidOutputs(material.getMolten(1 * EIGHTH_INGOTS)).duration(4 * TICKS).eut(8)
                    .addTo(fluidExtractionRecipes);
        }
        if (material.hasItemType(OrePrefixes.wireFine)) {
            GTValues.RA.stdBuilder().itemInputs(material.get(OrePrefixes.wireFine))
                    .fluidOutputs(material.getMolten(1 * EIGHTH_INGOTS)).duration(4 * TICKS).eut(8)
                    .addTo(fluidExtractionRecipes);
        }
        if (material.hasItemType(OrePrefixes.round)) {
            GTValues.RA.stdBuilder().itemInputs(material.get(OrePrefixes.round))
                    .fluidOutputs(material.getMolten(1 * NUGGETS)).duration(4 * TICKS).eut(8)
                    .addTo(fluidExtractionRecipes);
        }
        if (material.hasItemType(OrePrefixes.screw)) {
            GTValues.RA.stdBuilder().itemInputs(material.get(OrePrefixes.screw))
                    .fluidOutputs(material.getMolten(1 * NUGGETS)).duration(4 * TICKS).eut(8)
                    .addTo(fluidExtractionRecipes);
        }
        if (material.hasItemType(OrePrefixes.rotor)) {
            GTValues.RA.stdBuilder().itemInputs(material.get(OrePrefixes.rotor)).fluidOutputs(material.getMolten(612))
                    .duration(136 * TICKS).eut(8).addTo(fluidExtractionRecipes);
        }
        if (material.hasItemType(OrePrefixes.gearGt)) {
            GTValues.RA.stdBuilder().itemInputs(material.get(OrePrefixes.gearGt))
                    .fluidOutputs(material.getMolten(4 * INGOTS)).duration(128 * TICKS).eut(8)
                    .addTo(fluidExtractionRecipes);
        }
    }
