...
public class GGMaterial implements Runnable {
    ...
    public static final Werkstoff atomicSeparationCatalyst = new Werkstoff(
            ...
            "Atomic Separation Catalyst",
            "The melting core...",
            new Werkstoff.Stats().setMeltingPoint(5000).disableAutoGeneratedBlastFurnaceRecipes(),
            Werkstoff.Types.COMPOUND,
    ...
    public static final Werkstoff extremelyUnstableNaquadah = new Werkstoff(
            ...
            new Werkstoff.Stats().setMeltingPoint(7000).setBlastFurnace(true).setProtons(200).setMass(450)
                    .setRadioactive(true).setDurOverride(180224).setSpeedOverride(100f).setQualityOverride((byte) 11)
                    .disableAutoGeneratedBlastFurnaceRecipes().disableAutoGeneratedVacuumFreezerRecipes(),
            Werkstoff.Types.ELEMENT,
            new Werkstoff.GenerationFeatures().onlyDust().addMolten().addMetalItems().addCraftingMetalWorkingItems()
                    .addSimpleMetalWorkingItems().addDoubleAndDensePlates().addMetaSolidifierRecipes()
                    .addMetalCraftingSolidifierRecipes(),
    ...
    public static final Werkstoff zircaloy4 = new Werkstoff(
            ...
            Werkstoff.Types.MIXTURE,
            new Werkstoff.GenerationFeatures().onlyDust().addMolten().addMetalItems().addCraftingMetalWorkingItems()
                    .addMetaSolidifierRecipes().addMetalCraftingSolidifierRecipes().addMixerRecipes((short) 4),
            OffsetID + 81,
            TextureSet.SET_METALLIC,
    ...
    public static final Werkstoff zircaloy2 = new Werkstoff(
            ...
            Werkstoff.Types.MIXTURE,
            new Werkstoff.GenerationFeatures().onlyDust().addMolten().addMetalItems().addCraftingMetalWorkingItems()
                    .addMetaSolidifierRecipes().addMetalCraftingSolidifierRecipes().addMixerRecipes((short) 2),
            OffsetID + 82,
            TextureSet.SET_METALLIC,
            Pair.of(WerkstoffLoader.Zirconium, 34),
            Pair.of(Tin, 4),
    ...
    public static final Werkstoff incoloy903 = new Werkstoff(
            ...
            Werkstoff.Types.MIXTURE,
            new Werkstoff.GenerationFeatures().onlyDust().addMolten().addMetalItems().addCraftingMetalWorkingItems()
                    .addSimpleMetalWorkingItems().addMetaSolidifierRecipes().addMetalCraftingSolidifierRecipes()
    ...
    public static final Werkstoff adamantiumAlloy = new Werkstoff(
            ...
            new Werkstoff.Stats().setCentrifuge(true).setBlastFurnace(true).setMeltingPoint(5500)
                    .setSpeedOverride(191.2F).setDurOverride(102400).disableAutoGeneratedBlastFurnaceRecipes(),
            Werkstoff.Types.MIXTURE,
            new Werkstoff.GenerationFeatures().onlyDust().addMolten().addMetalItems().addCraftingMetalWorkingItems()
                    .addSimpleMetalWorkingItems().addDoubleAndDensePlates().addMetaSolidifierRecipes()
                    .addMetalCraftingSolidifierRecipes().addMixerRecipes((short) 3),
            OffsetID + 84,
            TextureSet.SET_SHINY,
    ...
    public static final Werkstoff marM200 = new Werkstoff(
            ...
            new Werkstoff.GenerationFeatures().onlyDust().addMolten().addMetalItems().addCraftingMetalWorkingItems()
                    .addSimpleMetalWorkingItems().addDoubleAndDensePlates().addMetaSolidifierRecipes()
                    .addMetalCraftingSolidifierRecipes().addMixerRecipes((short) 7),
            OffsetID + 95,
            TextureSet.SET_SHINY,
            Pair.of(Niobium, 2),
            Pair.of(Chrome, 9),
    ...
    public static final Werkstoff signalium = new Werkstoff(
            ...
            "Signalium",
            new Werkstoff.Stats().setBlastFurnace(true).setMeltingPoint(4000).disableAutoGeneratedBlastFurnaceRecipes(),
            Werkstoff.Types.MIXTURE,
            new Werkstoff.GenerationFeatures().onlyDust().addMolten().addMetalItems().addCraftingMetalWorkingItems()
    ...
    public static final Werkstoff artheriumSn = new Werkstoff(
            ...
            Werkstoff.Types.MIXTURE,
            new Werkstoff.GenerationFeatures().onlyDust().addMolten().addMetalItems().addCraftingMetalWorkingItems()
                    .addMetaSolidifierRecipes().addMetalCraftingSolidifierRecipes().addMixerRecipes((short) 6),
            OffsetID + 101,
            TextureSet.SET_SHINY,
    ...
    public static final Werkstoff titaniumBetaC = new Werkstoff(
            ...
            Werkstoff.Types.MIXTURE,
            new Werkstoff.GenerationFeatures().onlyDust().addMolten().addMetalItems().addCraftingMetalWorkingItems()
                    .addMetaSolidifierRecipes().addMetalCraftingSolidifierRecipes().addMixerRecipes((short) 5),
            OffsetID + 102,
            TextureSet.SET_METALLIC,
            Pair.of(Titanium, 5),
    ...
    public static final Werkstoff dalisenite = new Werkstoff(
            ...
            "Dalisenite",
            new Werkstoff.Stats().setMeltingPoint(8700).setCentrifuge(true).disableAutoGeneratedBlastFurnaceRecipes(),
            Werkstoff.Types.MIXTURE,
            new Werkstoff.GenerationFeatures().onlyDust().addMolten().addMetalItems().addCraftingMetalWorkingItems()
                    .addMetaSolidifierRecipes().addMetalCraftingSolidifierRecipes().addMixerRecipes((short) 6),
            OffsetID + 103,
    ...
    public static final Werkstoff hikarium = new Werkstoff(
            ...
            Werkstoff.Types.MIXTURE,
            new Werkstoff.GenerationFeatures().onlyDust().addMolten().addMetalItems().addCraftingMetalWorkingItems()
                    .addMetaSolidifierRecipes().addMetalCraftingSolidifierRecipes().addMixerRecipes((short) 3),
            OffsetID + 104,
            TextureSet.SET_SHINY,
            Pair.of(lumiium, 18),
            Pair.of(Silver, 8),
    ...
    public static final Werkstoff preciousMetalAlloy = new Werkstoff(
            ...
            new Werkstoff.Stats().setBlastFurnace(true).setMeltingPoint(10000).setCentrifuge(true)
                    .setSpeedOverride(100F).disableAutoGeneratedBlastFurnaceRecipes(),
            Werkstoff.Types.MIXTURE,
            new Werkstoff.GenerationFeatures().onlyDust().addMolten().addMetalItems().addCraftingMetalWorkingItems()
    ...
    public static final Werkstoff enrichedNaquadahAlloy = new Werkstoff(
            ...
            new Werkstoff.Stats().setBlastFurnace(true).setMeltingPoint(11000).setCentrifuge(true)
                    .setSpeedOverride(180F).disableAutoGeneratedBlastFurnaceRecipes(),
            Werkstoff.Types.MIXTURE,
            new Werkstoff.GenerationFeatures().onlyDust().addMolten().addMetalItems().addCraftingMetalWorkingItems()
                    .addSimpleMetalWorkingItems().addDoubleAndDensePlates().addMetaSolidifierRecipes()
                    .addMetalCraftingSolidifierRecipes().addMixerRecipes((short) 4),
            OffsetID + 109,
            TextureSet.SET_METALLIC,
    ...
    public static final Werkstoff shirabon = new Werkstoff(
            ...
            new Werkstoff.Stats().setProtons(500).setMass(750).setMeltingPoint(13000).setSpeedOverride(640.0F)
                    .setDurOverride(15728640).setQualityOverride((byte) 26).disableAutoGeneratedBlastFurnaceRecipes(),
            Werkstoff.Types.ELEMENT,
            new Werkstoff.GenerationFeatures().onlyDust().addMolten().addMetalItems().addCraftingMetalWorkingItems()
                    .addSimpleMetalWorkingItems().addDoubleAndDensePlates().addMultiPlates().addMetaSolidifierRecipes()
                    .addMetalCraftingSolidifierRecipes(),
            OffsetID + 111,
            TextureSet.SET_SHINY);
