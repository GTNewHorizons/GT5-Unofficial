...
public class GGConfigLoader {
    ...
    private static void loadProperty() {
        ...
        NaquadahFuelTime[0] = GG_Config
            .get("LargeNaquadahReactor", "Uranium Based Liquid Fuel Burning Time", NaquadahFuelTime[0])
            .getInt();
        ...
        NaquadahFuelTime[1] = GG_Config
            .get("LargeNaquadahReactor", "Thorium Based Liquid Fuel Burning Time", NaquadahFuelTime[1])
            .getInt();
        ...
        NaquadahFuelTime[2] = GG_Config
            .get("LargeNaquadahReactor", "Plutonium Based Liquid Fuel Burning Time", NaquadahFuelTime[2])
            .getInt();
        NaquadahFuelVoltage[3] = GG_Config
            .get("LargeNaquadahReactor", "Naquadah Fuel MkI Basic Output Voltage", NaquadahFuelVoltage[3])
            .getInt();
        NaquadahFuelTime[3] = GG_Config
            .get("LargeNaquadahReactor", "Naquadah Fuel MkI Burning Time", NaquadahFuelTime[3])
            .getInt();
        ...
        NaquadahFuelTime[4] = GG_Config
            .get("LargeNaquadahReactor", "Naquadah Fuel MkII Burning Time", NaquadahFuelTime[4])
            .getInt();
        ...
        NaquadahFuelTime[5] = GG_Config
            .get("LargeNaquadahReactor", "Naquadah Fuel MkIII Burning Time", NaquadahFuelTime[5])
            .getInt();
        ...
        NaquadahFuelTime[6] = GG_Config
            .get("LargeNaquadahReactor", "Naquadah Fuel MkIV Burning Time", NaquadahFuelTime[6])
            .getInt();
        NaquadahFuelVoltage[7] = GG_Config
            .get("LargeNaquadahReactor", "Naquadah Fuel MkV Basic Output Voltage", NaquadahFuelVoltage[7])
            .getInt();
        NaquadahFuelTime[7] = GG_Config
            .get("LargeNaquadahReactor", "Naquadah Fuel MkV Burning Time", NaquadahFuelTime[7])
            .getInt();
        ...
        NaquadahFuelTime[8] = GG_Config
            .get("LargeNaquadahReactor", "Naquadah Fuel MkVI Burning Time", NaquadahFuelTime[8])
            .getInt();
        ...
        ExcitedLiquidCoe[0] = GG_Config
            .get("LargeNaquadahReactor", "Spatially Enlarged Fluid Magnification", ExcitedLiquidCoe[0])
            .getInt();
        ExcitedLiquidCoe[1] = GG_Config
            .get("LargeNaquadahReactor", "Atomic Separation Catalyst Magnification", ExcitedLiquidCoe[1])
            .getInt();
    ...
    private static void loadCategory() {
        GG_Config
            .addCustomCategoryComment("LargeNaquadahReactor", "Set fuel value, coolant or excited liquid property.");
