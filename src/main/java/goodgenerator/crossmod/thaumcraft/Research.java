...
public class Research {
    ...
    public static void addResearch() {
        ...
        ItemStack nitor = LoadedList.THAUMIC_TINKERER
                ? GT_ModHandler.getModItem("ThaumicTinkerer", "brightNitor", 1, 0)
                : new ItemStack(ConfigItems.itemResource, 1, 1);
        ItemStack alchemicalBoiler = LoadedList.AUTOMAGY
                ? GT_ModHandler.getModItem("Automagy", "blockBoiler", 1, 0)
                : new ItemStack(ConfigBlocks.blockStoneDevice, 1, 1);
        ItemStack essentiaLocus = LoadedList.AUTOMAGY
