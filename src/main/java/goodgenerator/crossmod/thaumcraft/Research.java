...
public class Research {
    ...
    public static void addResearch() {
        ...
        GregTechAPI.sThaumcraftCompat.addResearch(
            ...
            null,
            new Object[] { "research.ESSENTIA_SMELTERY.page.0", GregTechAPI.sThaumcraftCompat.addInfusionRecipe(
                "ESSENTIA_SMELTERY",
                ...
                new ItemStack[] { nodeLinkDevice, nitor, alchemicalFurnace, essentiaLocus, alchemicalBoiler,
                    new ItemStack(ConfigBlocks.blockCrystal, 1, 1), new ItemStack(ConfigBlocks.blockMetalDevice, 1, 3),
                    ItemList.Electric_Piston_IV.get(1), MaterialLibAPI.getStack(Materials.FierySteel, Shapes.gearGt, 1),
        ...
        GregTechAPI.sThaumcraftCompat.addResearch(
            ...
            new Object[] { "research.ESSENTIA_CELL.page.0",
                ...
                GregTechAPI.sThaumcraftCompat.addInfusionRecipe(
                    "ESSENTIA_CELL",
                    ItemRefer.Essentia_Cell_T3.get(1),
                    new ItemStack[] { MaterialLibAPI.getStack(Materials.Europium, Shapes.ring, 1),
