    ...
    public static void addResearch() {
        ...
        GregTech_API.sThaumcraftCompat.addResearch(
            ...
            new Object[] { "research.ESSENTIA_GENERATOR.page.0",
                ...
                GregTech_API.sThaumcraftCompat.addInfusionRecipe(
                    "ESSENTIA_GENERATOR",
                    OreDictUnificator.get(OrePrefixes.frameGt, Materials.Thaumium, 1),
                    new ItemStack[] { OreDictUnificator.get(OrePrefixes.pipeTiny, Materials.Titanium, 1),
                        OreDictUnificator.get(OrePrefixes.plate, Materials.ElectricalSteel, 1),
                        OreDictUnificator.get(OrePrefixes.plate, Materials.ElectricalSteel, 1),
                ...
                addArcaneCraftingRecipe(
                    ...
                    'C',
                    OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Thaumium, 1),
                    'G',
        ...
        GregTech_API.sThaumcraftCompat.addResearch(
            ...
            new Object[] { "research.ESSENTIA_CELL.page.0",
                GregTech_API.sThaumcraftCompat.addInfusionRecipe(
                    "ESSENTIA_CELL",
                    ItemRefer.Essentia_Cell_T1.get(1),
                    new ItemStack[] { OreDictUnificator.get(OrePrefixes.plate, Materials.Iridium, 1),
                        ...
                        OreDictUnificator.get(OrePrefixes.bolt, Materials.Plutonium241, 1), },
                ...
                GregTech_API.sThaumcraftCompat.addInfusionRecipe(
                    ...
                    new ItemStack[] { ItemList.Field_Generator_IV.get(1L), ItemList.Electric_Pump_LuV.get(1L),
                        ...
                        OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.Ichorium, 1) },
                ...
                GregTech_API.sThaumcraftCompat.addInfusionRecipe(
                    "ESSENTIA_CELL",
                    ItemRefer.Essentia_Cell_T3.get(1),
                    new ItemStack[] { OreDictUnificator.get(OrePrefixes.ring, Materials.Europium, 1),
                        ItemList.Emitter_LuV.get(1L), new ItemStack(ItemRegistry.bw_realglas, 1, 4),
                        OreDictUnificator.get(OrePrefixes.plate, Materials.StellarAlloy, 1),
                        OreDictUnificator.get(OrePrefixes.cellPlasma, Materials.Helium, 1),
        ...
        GregTech_API.sThaumcraftCompat.addResearch(
            ...
            new Object[] { "research.ESSENTIA_UPGRADE_BLANK.page.0",
                addArcaneCraftingRecipe(
                    ...
                    "EIF",
                    'A',
                    OreDictUnificator.get(OrePrefixes.screw, Materials.InfusedAir, 1),
                    'B',
                    OreDictUnificator.get(OrePrefixes.screw, Materials.InfusedEarth, 1),
                    'C',
                    OreDictUnificator.get(OrePrefixes.screw, Materials.InfusedFire, 1),
                    'D',
                    OreDictUnificator.get(OrePrefixes.screw, Materials.InfusedWater, 1),
                    'E',
                    OreDictUnificator.get(OrePrefixes.screw, Materials.InfusedOrder, 1),
                    'F',
                    OreDictUnificator.get(OrePrefixes.screw, Materials.InfusedEntropy, 1),
                    'M',
                    new ItemStack(ConfigItems.itemResource, 1, 10),
                    'Z',
                    broad,
                    'I',
                    OreDictUnificator.get(OrePrefixes.plateDense, Materials.PulsatingIron, 1)), });
        GregTech_API.sThaumcraftCompat.addResearch(
            ...
            Arrays.asList(
                ...
                new TC_Aspects.TC_AspectStack(TC_Aspects.ELECTRUM, 10L)),
            null,
            new Object[] { "research.ESSENTIA_UPGRADE_AIR.page.0", GregTech_API.sThaumcraftCompat.addInfusionRecipe(
                "ESSENTIA_UPGRADE_AIR",
                ItemRefer.Essentia_Upgrade_Empty.get(1),
                new ItemStack[] { OreDictUnificator.get(OrePrefixes.cell, Materials.LiquidAir, 1),
                    OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1),
                    OreDictUnificator.get(OrePrefixes.cell, Materials.Helium, 1),
                    OreDictUnificator.get(OrePrefixes.cell, Materials.Argon, 1),
        ...
        GregTech_API.sThaumcraftCompat.addResearch(
            ...
            new Object[] { "research.ESSENTIA_UPGRADE_THERMAL.page.0",
                GregTech_API.sThaumcraftCompat.addInfusionRecipe(
                    "ESSENTIA_UPGRADE_THERMAL",
                    ItemRefer.Essentia_Upgrade_Empty.get(1),
                    new ItemStack[] { OreDictUnificator.get(OrePrefixes.lens, Materials.Firestone, 1),
                        OreDictUnificator.get(OrePrefixes.dust, Materials.Netherrack, 1), Ic2Items.reactorPlatingHeat,
        ...
        GregTech_API.sThaumcraftCompat.addResearch(
            ...
            new Object[] { "research.ESSENTIA_UPGRADE_UNSTABLE.page.0",
                GregTech_API.sThaumcraftCompat.addInfusionRecipe(
                    "ESSENTIA_UPGRADE_UNSTABLE",
                    ItemRefer.Essentia_Upgrade_Empty.get(1),
                    new ItemStack[] { OreDictUnificator.get(OrePrefixes.cell, Materials.GasolinePremium, 1),
                        OreDictUnificator.get(OrePrefixes.dust, Materials.Unstable, 1),
                        OreDictUnificator.get(OrePrefixes.gearGt, Materials.Void, 1),
                        OreDictUnificator.get(OrePrefixes.gem, Materials.InfusedEntropy, 1), Ic2Items.industrialTnt,
        ...
        ItemStack meatDust = OreDictUnificator.get(OrePrefixes.dust, Materials.MeatRaw, 1);
        if (NewHorizonsCoreMod.isModLoaded())
            ...
            new Object[] { "research.ESSENTIA_UPGRADE_VICTUS.page.0",
                GregTech_API.sThaumcraftCompat.addInfusionRecipe(
                    ...
                    new ItemStack[] { meatDust, ItemList.Food_Dough_Sugar.get(1),
                        OreDictUnificator.get(OrePrefixes.plate, Materials.Calcium, 1),
            ...
            new Object[] { "research.ESSENTIA_UPGRADE_TAINTED.page.0", "research.ESSENTIA_UPGRADE_TAINTED.page.1",
                GregTech_API.sThaumcraftCompat.addInfusionRecipe(
                    ...
                    new ItemStack[] { new ItemStack(ConfigBlocks.blockTaintFibres, 1, 0),
                        ...
                        OreDictUnificator.get(OrePrefixes.spring, Materials.NaquadahEnriched, 1),
                        OreDictUnificator.get(OrePrefixes.gearGt, Materials.EndSteel, 1),
            ...
            new Object[] { "research.ESSENTIA_UPGRADE_MECHANICS.page.0",
                GregTech_API.sThaumcraftCompat.addInfusionRecipe(
                    ...
                    new ItemStack[] { new ItemStack(ConfigBlocks.blockTube, 1, 4),
                        ...
                        OreDictUnificator.get(OrePrefixes.rotor, Materials.VividAlloy, 1),
                        OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Polybenzimidazole, 1),
        ...
        GregTech_API.sThaumcraftCompat.addResearch(
            ...
            Arrays.asList(
                ...
                new TC_Aspects.TC_AspectStack(TC_Aspects.ELECTRUM, 10L)),
            null,
            new Object[] { "research.ESSENTIA_UPGRADE_SPRITE.page.0", GregTech_API.sThaumcraftCompat.addInfusionRecipe(
                "ESSENTIA_UPGRADE_SPRITE",
                ItemRefer.Essentia_Upgrade_Empty.get(1),
                new ItemStack[] { new ItemStack(ConfigBlocks.blockJar, 1, 1),
                    OreDictUnificator.get(OrePrefixes.food, Materials.Cheese, 1),
                    OreDictUnificator.get(OrePrefixes.rotor, Materials.Shadow, 1),
                    OreDictUnificator.get(OrePrefixes.spring, Materials.FierySteel, 1),
                    OreDictUnificator.get(OrePrefixes.cell, Materials.Milk, 1), ItemList.Machine_EV_Scanner.get(1) },
                ItemRefer.Essentia_Upgrade_Spirit.get(1),
                5,
                Arrays.asList(
        ...
        GregTech_API.sThaumcraftCompat.addResearch(
            ...
            new Object[] { "research.ESSENTIA_UPGRADE_ELECTRIC.page.0",
                GregTech_API.sThaumcraftCompat.addInfusionRecipe(
                    "ESSENTIA_UPGRADE_RADIATION",
                    ItemRefer.Essentia_Upgrade_Empty.get(1),
                    new ItemStack[] { OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorMV, 1),
                        OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorHV, 1),
                        OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorEV, 1),
                        OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorIV, 1),
                        OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorLuV, 1),
                        OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorZPM, 1) },
                    ItemRefer.Essentia_Upgrade_Electric.get(1),
                    10,
                ...
                new Object[] { "research.ESSENTIA_SMELTERY.page.0",
                    GregTech_API.sThaumcraftCompat.addInfusionRecipe(
                        ...
                        new ItemStack[] { nodeLinkDevice, nitor, alchemicalFurnace, essentiaLocus, alchemicalBoiler,
                            ...
                            OreDictUnificator.get(OrePrefixes.gearGt, Materials.FierySteel, 1L),
                    ...
                    addArcaneCraftingRecipe(
                        ...
                        'C',
                        OreDictUnificator.get(OrePrefixes.rotor, Materials.Void, 1),
                        'D',
                        new ItemStack(GregTech_API.sBlockCasings3, 1, 11),
                        'E',
                        OreDictUnificator.get(OrePrefixes.pipeSmall, Materials.NetherStar, 1),
                        'F',
                        thauminiteBlock) });
