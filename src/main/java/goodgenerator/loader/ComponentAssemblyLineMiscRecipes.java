...
public class ComponentAssemblyLineMiscRecipes {
    ...
    static void run() {
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, Compassline_Casing_EV.get(1))
    ...
    private static void generateCasingRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(Compassline_Casing_LV.get(1)).duration(16 * SECONDS).eut(GTValues.VP[t])
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        getCircuit(t - 1, 16))
                .fluidInputs(Materials.SolderingAlloy.getMolten((t + 1) * INGOTS))
                .itemOutputs(Compassline_Casing_MV.get(1)).duration(16 * SECONDS).eut(GTValues.VP[t])
                .addTo(assemblerRecipes);
        // hv 3
        t++;
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        getCircuit(t - 1, 16))
                .fluidInputs(Materials.SolderingAlloy.getMolten((t + 1) * INGOTS))
                .itemOutputs(Compassline_Casing_HV.get(1)).duration(16 * SECONDS).eut(GTValues.VP[t])
                .addTo(assemblerRecipes);
        // ev 4
        t++;
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        getCircuit(t - 1, 16))
                .fluidInputs(Materials.SolderingAlloy.getMolten((t + 1) * INGOTS))
                .itemOutputs(Compassline_Casing_EV.get(1)).duration(16 * SECONDS).eut(GTValues.VP[t])
                .addTo(assemblerRecipes);
        // iv 5
        t++;
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        getCircuit(t - 1, 16))
                .fluidInputs(Materials.SolderingAlloy.getMolten((t + 1) * INGOTS))
                .itemOutputs(Compassline_Casing_IV.get(1)).duration(16 * SECONDS).eut(GTValues.VP[t])
                .addTo(assemblerRecipes);
        // Assline Recipes!
        // luv 6
        t++;
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, Compassline_Casing_IV.get(1))
        ...
        // zpm 7
        t++;
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, Compassline_Casing_LuV.get(1))
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, Compassline_Casing_ZPM.get(1))
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                1,
                new Object[] { GTOreDictUnificator
                        ...
                        GTOreDictUnificator.get(OrePrefixes.wireGt04, MaterialsUEVplus.SpaceTime, 8),
                        getALCircuit(t, 8), getALCircuit(t - 1, 16) },
                new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(t * 4 * INGOTS),
                        MaterialsUEVplus.BlackDwarfMatter.getMolten(t * 2 * INGOTS),
                        MaterialsUEVplus.Eternity.getMolten(t * INGOTS),
                        MaterialsUEVplus.DimensionallyShiftedSuperfluid.getFluid(1000 * (t - 2)) },
    ...
    private static void generateWrapRecipes() {
        for (int i = 0; i <= 11; i++) {
            GTValues.RA.stdBuilder().itemInputs(getCircuit(i, 16), GTUtility.getIntegratedCircuit(16))
