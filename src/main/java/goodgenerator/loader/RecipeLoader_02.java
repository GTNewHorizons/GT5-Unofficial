...
import static gregtech.api.util.RecipeConstants.PRECISE_ASSEMBLER_CASING_TIER;
    ...
    public static void RecipeLoad() {
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.frameGt, Materials.BlueAlloy, 1),
                OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorHV, 32),
                OreDictUnificator.get(OrePrefixes.plate, Materials.Beryllium, 32),
                OreDictUnificator.get(OrePrefixes.circuit, Materials.IV, 1))
        ...
        GT_ModHandler.addCraftingRecipe(
            ...
            new Object[] { "BPB", "FOF", "BPB", 'B', OreDictUnificator.get(OrePrefixes.plate, Materials.BlackSteel, 1),
                'P', OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.StainlessSteel, 1), 'F',
                OreDictUnificator.get(OrePrefixes.plate, Materials.Polytetrafluoroethylene, 1), 'O',
                OreDictUnificator.get(OrePrefixes.frameGt, Materials.BlackSteel, 1), });

        GT_ModHandler.addCraftingRecipe(
            ItemRefer.YOTTank.get(1),
            GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.REVERSIBLE,
            new Object[] { "SPS", "ECE", "SLS", 'S', OreDictUnificator.get(OrePrefixes.screw, Materials.BlueSteel, 1),
                'P', ItemList.Cover_Screen.get(1), 'E', "circuitData", 'L',
                OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Enderium, 1), 'C',
                ItemRefer.YOTTank_Casing.get(1) });
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.screw, Materials.CertusQuartz, 8),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.plateQuadruple, Materials.Tin, 4),
                GT_Utility.getIntegratedCircuit(1))
            .fluidInputs(Materials.Plastic.getMolten(144))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.plateDense, Materials.Titanium, 8),
                OreDictUnificator.get(OrePrefixes.plateQuadruple, Materials.BlackSteel, 4),
                GT_Utility.getIntegratedCircuit(2))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                ItemRefer.Fluid_Storage_Core_T1.get(32),
                OreDictUnificator.get(OrePrefixes.plateDouble, Materials.BlackSteel, 16),
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.pipeNonuple, Materials.StainlessSteel, 4),
                ItemList.Electric_Pump_HV.get(8),
                ItemList.Quantum_Tank_LV.get(1),
                OreDictUnificator.get(OrePrefixes.plateDense, Materials.Osmium, 8),
                GT_ModHandler.getModItem(GalacticraftMars.ID, "item.null", 1L, 6),
                OreDictUnificator.get(OrePrefixes.foil, Materials.Polycaprolactam, 32))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.pipeNonuple, Materials.Titanium, 4),
                ItemList.Electric_Pump_EV.get(8),
                ItemList.Quantum_Tank_LV.get(4),
                OreDictUnificator.get(OrePrefixes.plateDense, Materials.Europium, 8),
                GT_ModHandler.getModItem(GalacticraftMars.ID, "item.null", 4L, 6),
                OreDictUnificator.get(OrePrefixes.foil, Materials.StyreneButadieneRubber, 64),
                OreDictUnificator.get(OrePrefixes.pipeLarge, Materials.TungstenSteel, 64))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.pipeNonuple, Materials.MysteriousCrystal, 4),
                ItemList.Electric_Pump_IV.get(8),
                ItemList.Quantum_Tank_HV.get(8),
                OreDictUnificator.get(OrePrefixes.plateDense, Materials.Neutronium, 8),
                GT_ModHandler.getModItem(GalacticraftMars.ID, "item.null", 16L, 6),
                OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Polycaprolactam, 24),
                OreDictUnificator.get(OrePrefixes.pipeHuge, Materials.Titanium, 64))
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.pipeNonuple, Materials.Infinity, 4),
                ...
                OreDictUnificator.get(OrePrefixes.plateDense, Materials.DraconiumAwakened, 16),
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.pipeNonuple, Materials.Infinity, 8),
                OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.InfinityCatalyst, 8),
                OreDictUnificator.get(OrePrefixes.plateDense, Materials.DraconiumAwakened, 16))
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.pipeNonuple, Materials.Infinity, 16),
                OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Infinity, 24),
                OreDictUnificator.get(OrePrefixes.plateDense, Materials.DraconiumAwakened, 16))
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.pipeNonuple, Materials.Infinity, 32),
                OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.Infinity, 36),
                OreDictUnificator.get(OrePrefixes.plateDense, Materials.DraconiumAwakened, 8))
            .fluidInputs(
                Materials.Draconium.getMolten(36864),
                new FluidStack(solderIndalloy, 30240),
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.pipeNonuple, Materials.Infinity, 32),
                OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.CosmicNeutronium, 24),
                OreDictUnificator.get(OrePrefixes.plateDouble, MaterialsUEVplus.SpaceTime, 4))
            .fluidInputs(
                Materials.Draconium.getMolten(36864),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 4),
                ItemList.Electric_Pump_HV.get(8),
                OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.StainlessSteel, 4),
                GT_Utility.getIntegratedCircuit(5))
            .fluidInputs(Materials.Plastic.getMolten(144))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                ItemList.Electric_Pump_EV.get(8),
                OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Enderium, 4),
                GT_Utility.getIntegratedCircuit(5))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .metadata(RESEARCH_TIME, 17 * MINUTES)
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.frameGt, Materials.Naquadah, 1),
                ItemRefer.Fluid_Storage_Core_T3.get(10),
                new Object[] { OrePrefixes.circuit.get(Materials.LuV), 8 },
                ItemList.Electric_Pump_IV.get(8),
                OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.NiobiumTitanium, 8),
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemInputs(
                ...
                ItemList.Electric_Pump_LuV.get(8),
                OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.MysteriousCrystal, 8),
                OreDictUnificator.get(OrePrefixes.plate, Materials.ElectrumFlux, 32))
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .metadata(RESEARCH_TIME, 1 * HOURS + 8 * MINUTES)
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.frameGt, Materials.CosmicNeutronium, 1),
                ItemRefer.Fluid_Storage_Core_T5.get(10),
                new Object[] { OrePrefixes.circuit.get(Materials.UV), 8 },
                ItemList.Electric_Pump_ZPM.get(8),
                OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.DraconiumAwakened, 8),
                OreDictUnificator.get(OrePrefixes.plate, Materials.Neutronium, 64))
            .fluidInputs(
                Materials.Draconium.getMolten(1440),
                FluidRegistry.getFluidStack("ic2coolant", 16000),
                Materials.Lubricant.getFluid(16000))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .metadata(RESEARCH_TIME, 2 * HOURS + 15 * MINUTES)
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.frameGt, Materials.Infinity, 1),
                ItemRefer.Fluid_Storage_Core_T6.get(2),
                new Object[] { OrePrefixes.circuit.get(Materials.UHV), 8L },
                ItemList.Electric_Pump_UV.get(8),
                OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.NetherStar, 8),
                OreDictUnificator.get(OrePrefixes.plate, Materials.Infinity, 64))
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemInputs(
                ...
                ItemList.Electric_Pump_UHV.get(8),
                OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.NetherStar, 16),
                OreDictUnificator.get(OrePrefixes.plate, Materials.CosmicNeutronium, 32),
                OreDictUnificator.get(OrePrefixes.plate, Materials.Infinity, 32))
            .fluidInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemInputs(
                ...
                ItemList.Electric_Pump_UEV.get(8),
                OreDictUnificator.get(OrePrefixes.pipeLarge, Materials.NetherStar, 12),
                OreDictUnificator.get(OrePrefixes.plateDouble, Materials.CosmicNeutronium, 12),
                OreDictUnificator.get(OrePrefixes.plateDouble, Materials.DraconiumAwakened, 12),
                OreDictUnificator.get(OrePrefixes.plate, Materials.Infinity, 64))
            .fluidInputs(
                Materials.DraconiumAwakened.getMolten(14400),
                FluidRegistry.getFluidStack("supercoolant", 46080),
        ...
        if (NewHorizonsCoreMod.isModLoaded()) {
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    OreDictUnificator.get(OrePrefixes.frameGt, Materials.Infinity, 2),
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemInputs(
                    OreDictUnificator.get(OrePrefixes.frameGt, MaterialsUEVplus.SpaceTime, 2),
                    ...
                    OreDictUnificator.get(OrePrefixes.pipeLarge, Materials.NetherStar, 64),
                    OreDictUnificator.get(OrePrefixes.plateDouble, Materials.CosmicNeutronium, 12),
                    OreDictUnificator.get(OrePrefixes.plateDouble, Materials.DraconiumAwakened, 12),
                    OreDictUnificator.get(OrePrefixes.plate, MaterialsUEVplus.SpaceTime, 10))
                .fluidInputs(
                    Materials.DraconiumAwakened.getMolten(14400),
                    MaterialsUEVplus.TranscendentMetal.getMolten(1440),
                    FluidRegistry.getFluidStack("supercoolant", 46080),
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                ItemRefer.Fluid_Storage_Core_T10.get(2),
                OreDictUnificator.get(OrePrefixes.frameGt, MaterialsUEVplus.SpaceTime, 1))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(unpackagerRecipes);
        ...
        GT_ModHandler.addCraftingRecipe(
            ...
            GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.REVERSIBLE,
            new Object[] { "PCP", "MHM", "GWG", 'G', OreDictUnificator.get(OrePrefixes.gearGt, Materials.Titanium, 1),
                'C', "circuitData", 'W', OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Aluminium, 1), 'P',
        ...
        GT_ModHandler.addCraftingRecipe(
            ...
            new Object[] { "PCP", "MHM", "GWG", 'G',
                OreDictUnificator.get(OrePrefixes.gearGt, Materials.TungstenSteel, 1), 'C', "circuitElite", 'W',
                OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tungsten, 1), 'P', ItemList.Electric_Piston_IV,
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(OreDictUnificator.get(OrePrefixes.crushedPurified, Materials.Lepidolite, 1))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                MyMaterial.marCeM200.get(OrePrefixes.plate, 4),
                OreDictUnificator.get(OrePrefixes.frameGt, Materials.NiobiumTitanium, 1),
        ...
        GT_ModHandler.addCraftingRecipe(
            ...
            new Object[] { "EPE", "PHP", "SPS", 'P',
                OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.TungstenSteel, 1), 'H', ItemList.Hull_IV.get(1),
                'S', MyMaterial.marM200.get(OrePrefixes.plate, 1), 'E',
        ...
        if (NewHorizonsCoreMod.isModLoaded()) {
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.cableGt08, Materials.Titanium, 4),
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ...
                    GT_ModHandler.getModItem(NewHorizonsCoreMod.ID, "item.EngravedDiamondCrystalChip", 8),
                    ItemList.Circuit_Chip_NAND.get(16),
                    OreDictUnificator.get(OrePrefixes.rotor, Materials.Aluminium, 2))
                .itemOutputs(ItemRefer.HiC_T2.get(1))
                .fluidInputs(
                    Materials.Plastic.getMolten(288),
                    MyMaterial.signalium.getMolten(144),
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ...
                    GT_ModHandler.getModItem(NewHorizonsCoreMod.ID, "item.EngravedEnergyChip", 8),
                    ItemList.Circuit_Chip_QuantumCPU.get(16),
                    OreDictUnificator.get(OrePrefixes.rotor, Materials.EnergeticAlloy, 2))
                .itemOutputs(ItemRefer.HiC_T4.get(1))
                .fluidInputs(
                    MyMaterial.marM200.getMolten(1152),
                    MyMaterial.signalium.getMolten(576),
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ...
                    GT_ModHandler.getModItem(NewHorizonsCoreMod.ID, "item.EngravedManyullynCrystalChip", 8),
                    ItemList.Circuit_Chip_BioCPU.get(1),
                    OreDictUnificator.get(OrePrefixes.rotor, Materials.TungstenCarbide, 2))
                .itemOutputs(ItemRefer.HiC_T5.get(1))
                .fluidInputs(
                    MyMaterial.titaniumBetaC.getMolten(1728),
                    MyMaterial.signalium.getMolten(1152),
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.cableGt02, Materials.Osmiridium, 2),
                    MyMaterial.marM200.get(OrePrefixes.plateDouble, 2),
                    OreDictUnificator.get(OrePrefixes.circuit, Materials.EV, 1),
                    ELEMENT.getInstance().RUTHENIUM.getBolt(32),
                    OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.Platinum, 8))
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.cableGt04, MyMaterial.lumiium.getBridgeMaterial(), 2),
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.cableGt04, Materials.ElectrumFlux, 4),
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.cableGt04, Materials.Bedrockium, 4),
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NetherStar, 8),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.circuit, Materials.LuV, 8),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.pipeHuge, Materials.Plastic, 2),
