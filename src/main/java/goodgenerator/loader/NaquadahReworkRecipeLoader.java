...
public class NaquadahReworkRecipeLoader {
    ...
    public static void RecipeLoad() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(10 * SECONDS).eut(GTValues.VP[10])
                .metadata(QFT_CATALYST, GregtechItemList.SimpleNaquadahCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 2)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.wasteLiquid.getFluidOrGas(32_000)).duration(10 * SECONDS).eut(GTValues.VP[11])
                .metadata(QFT_CATALYST, GregtechItemList.SimpleNaquadahCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 2)
                .addTo(quantumForceTransformerRecipes);
        // Naquadria (UMV)
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                        ...
                        Materials.Oxygen.getGas(100))
                .duration(5 * SECONDS).eut(GTValues.VP[12])
                .metadata(QFT_CATALYST, GregtechItemList.AdvancedNaquadahCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 3)
                .addTo(quantumForceTransformerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(Materials.Nickel.getDust(16)).fluidInputs(Materials.Nickel.getPlasma(16 * INGOTS))
                .fluidOutputs(Materials.Naquadah.getMolten(144 * STACKS)).duration(1 * MINUTES + 40 * SECONDS).eut(0)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(Materials.Titanium.getDust(16)).fluidInputs(Materials.Titanium.getPlasma(16 * INGOTS))
                .fluidOutputs(Materials.NaquadahEnriched.getMolten(144 * STACKS)).duration(1 * MINUTES + 40 * SECONDS)
                .eut(0).metadata(NKE_RANGE, computeRangeNKE(900, 850)).addTo(neutronActivatorRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GGMaterial.inertNaquadria.get(OrePrefixes.dust, 64),
                        GGMaterial.inertNaquadria.get(OrePrefixes.dust, 32))
                .itemOutputs(Materials.Americium.getDust(16)).fluidInputs(Materials.Americium.getPlasma(16 * INGOTS))
                .fluidOutputs(Materials.Naquadria.getMolten(144 * STACKS)).duration(1 * MINUTES + 40 * SECONDS).eut(0)
                .metadata(NKE_RANGE, computeRangeNKE(1100, 1080)).addTo(neutronActivatorRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GGMaterial.titaniumTrifluoride.get(OrePrefixes.dust, 4)).duration(5 * SECONDS)
                .eut(TierEU.RECIPE_HV).metadata(COIL_HEAT, 3000).addTo(blastFurnaceRecipes);

        // TiF3 + 3H = Ti + 3HF
        GTValues.RA.stdBuilder()
                .itemInputs(GGMaterial.titaniumTrifluoride.get(OrePrefixes.dust, 4), GTUtility.getIntegratedCircuit(1))
                .fluidInputs(Materials.Hydrogen.getGas(3_000)).fluidOutputs(Materials.HydrofluoricAcid.getFluid(3_000))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Titanium, 1)).duration(6 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.SeedOil.getFluid(3_000)).itemOutputs(ItemList.Cell_Empty.get(8))
                .fluidOutputs(GGMaterial.towEthyl1Hexanol.getFluidOrGas(1_000)).duration(20 * SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(UniversalChemical);

        // 2C8H18O + H3PO4 =Na,C2H6O= C16H35O3P + 2H2O
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Sodium, 2))
                .fluidInputs(
                        GGMaterial.towEthyl1Hexanol.getFluidOrGas(2_000),
                        Materials.PhosphoricAcid.getFluid(1_000),
                        Materials.Ethanol.getFluid(2_000))
                .fluidOutputs(GGMaterial.P507.getFluidOrGas(1_000)).duration(1 * MINUTES).eut(TierEU.RECIPE_EV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                        GGMaterial.naquadahAdamantiumSolution.get(OrePrefixes.cell, 30),
                        ItemList.Cell_Empty.get(10))
                .fluidOutputs(GGMaterial.fluorineRichWasteLiquid.getFluidOrGas(10_000))
                .duration(3 * MINUTES + 20 * SECONDS).eut(TierEU.RECIPE_EV).addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Quicklime, 40))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.naquadahRichSolution.getFluidOrGas(2_000)).duration(5 * SECONDS).eut(0)
                .metadata(NKE_RANGE, computeRangeNKE(230, 200)).addTo(neutronActivatorRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.SodiumHydroxide, 27))
                ...
                .fluidOutputs(GGMaterial.P507.getFluidOrGas(1_000)).duration(50 * SECONDS).eut(TierEU.RECIPE_MV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Naquadah, 1)).duration(2 * SECONDS)
                .eut(TierEU.RECIPE_IV).metadata(COIL_HEAT, 5000).addTo(blastFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.lowQualityNaquadahSolution.getFluidOrGas(9_000)).duration(50 * SECONDS)
                .eut(TierEU.RECIPE_EV).addTo(centrifugeRecipes);

        GTValues.RA.stdBuilder().itemInputs(GGMaterial.enrichedNaquadahEarth.get(OrePrefixes.dust, 4))
        ...
        // ZnSO4 + 2H = H2SO4 + Zn
        GTValues.RA.stdBuilder().itemInputs(WerkstoffLoader.ZincSulfate.get(OrePrefixes.dust, 6))
                .fluidInputs(Materials.Hydrogen.getGas(2_000)).fluidOutputs(Materials.SulfuricAcid.getFluid(1_000))
                .itemOutputs(Materials.Zinc.getDust(1)).duration(1 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_ULV)
                .addTo(UniversalChemical);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.SodiumHydroxide, 60))
                ...
                .fluidOutputs(GGMaterial.P507.getFluidOrGas(2_500)).duration(50 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(autoclaveRecipes);

        GTValues.RA.stdBuilder().itemInputs(GGMaterial.concentratedEnrichedNaquadahSludge.get(OrePrefixes.dust, 16))
                .itemOutputs(
                ...
                .duration(6 * SECONDS).eut(0).metadata(NKE_RANGE, computeRangeNKE(480, 460))
        ...
        // KeSO4 + 2H = Ke + H2SO4
        GTValues.RA.stdBuilder().itemInputs(GGMaterial.triniumSulphate.get(OrePrefixes.dust, 6))
                .fluidInputs(Materials.Hydrogen.getGas(2_000)).fluidOutputs(Materials.SulfuricAcid.getFluid(1_000))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Trinium, 1)).duration(6 * SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(multiblockChemicalReactorRecipes);

        GTValues.RA.stdBuilder().itemInputs(GGMaterial.naquadriaEarth.get(OrePrefixes.dust, 4))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(GGMaterial.naquadriaRichSolution.getFluidOrGas(9_000)).duration(5 * SECONDS).eut(0)
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Ball.get(0))
                .fluidInputs(GGMaterial.naquadahGoo.getFluidOrGas(72)).itemOutputs(ItemRefer.Naquadah_Mass.get(1))
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Ball.get(0))
                ...
                .itemOutputs(ItemRefer.Enriched_Naquadah_Mass.get(1)).duration(5 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(fluidSolidifierRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Ball.get(0))
                .fluidInputs(GGMaterial.naquadriaGoo.getFluidOrGas(72)).itemOutputs(ItemRefer.Naquadria_Mass.get(1))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_LV).addTo(fluidSolidifierRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemRefer.Naquadah_Mass.get(1))
                .itemOutputs(
                        GGMaterial.naquadahEarth.get(OrePrefixes.dust, 1),
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.Enriched_Naquadah_Mass.get(1))
                .itemOutputs(
                        GGMaterial.enrichedNaquadahEarth.get(OrePrefixes.dust, 1),
                        GGMaterial.naquadriaEarth.get(OrePrefixes.dust, 1))
                .outputChances(10000, 100).duration(5 * SECONDS).eut(2).addTo(maceratorRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemRefer.Naquadria_Mass.get(1))
                .itemOutputs(
                        GGMaterial.naquadriaEarth.get(OrePrefixes.dust, 1),
                        GGMaterial.naquadriaEarth.get(OrePrefixes.dust, 1))
                .outputChances(10000, 100).duration(5 * SECONDS).eut(2).addTo(maceratorRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.Circuit_Silicon_Ingot3.get(1)).duration(50 * SECONDS).eut(TierEU.RECIPE_IV)
                .metadata(COIL_HEAT, 4484).metadata(ADDITIVE_AMOUNT, 8000).addTo(BlastFurnaceWithGas);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(Materials.Naquadah.getNuggets(1)).duration(2 * MINUTES).eut(TierEU.RECIPE_IV)
                .metadata(COIL_HEAT, 5000).metadata(ADDITIVE_AMOUNT, 1000).addTo(BlastFurnaceWithGas);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(24))
                ...
                .fluidOutputs(Materials.Ethanol.getFluid(1_000)).duration(20 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(multiblockChemicalReactorRecipes);

        GTValues.RA.stdBuilder().itemInputs(Materials.Ethylene.getCells(1), GTUtility.getIntegratedCircuit(24))
                .fluidInputs(Materials.Steam.getGas(2_000)).itemOutputs(Materials.Ethanol.getCells(1))
                .duration(20 * SECONDS).eut(TierEU.RECIPE_HV).addTo(chemicalReactorRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.ingotHot, Materials.Naquadah, 1))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.ingot, Materials.Naquadah, 1)).duration(16 * SECONDS)
