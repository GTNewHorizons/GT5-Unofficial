...
public class RecipeLoader {
    ...
    public static void RecipeLoad() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemRefer.Radiation_Protection_Plate.get(1)).duration(20 * SECONDS).eut(TierEU.RECIPE_EV)
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Generator_Naquadah_Mark_III.get(1).copy())
                ...
                .itemOutputs(ItemRefer.Large_Naquadah_Reactor.get(1)).eut(TierEU.RECIPE_UV).duration(60 * SECONDS)
                .addTo(AssemblyLine);
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.Wrapped_Uranium_Ingot.get(4))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.High_Density_Uranium_Nugget.get(9))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.uraniumBasedLiquidFuel.getFluidOrGas(1_000)).duration(10 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.uraniumBasedLiquidFuelExcited.getFluidOrGas(10)).duration(2 * SECONDS)
                .eut(TierEU.RECIPE_IV).metadata(FUSION_THRESHOLD, 200_000_000L).addTo(fusionRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.Wrapped_Thorium_Ingot.get(1))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.High_Density_Thorium_Nugget.get(9))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GGMaterial.thoriumBasedLiquidFuel.get(OrePrefixes.cell, 1),
                        GTUtility.getIntegratedCircuit(1))
                .fluidInputs(Materials.Helium.getPlasma(250L))
                .itemOutputs(GGMaterial.thoriumBasedLiquidFuelExcited.get(OrePrefixes.cell, 1)).duration(6 * SECONDS)
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.Wrapped_Plutonium_Ingot.get(2))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.High_Density_Plutonium_Nugget.get(9))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .fluidOutputs(GGMaterial.plutoniumBasedLiquidFuel.getFluidOrGas(1_000)).duration(18 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.plutoniumBasedLiquidFuelExcited.getFluidOrGas(20)).duration(1 * SECONDS)
                .eut(TierEU.RECIPE_LuV / 2).metadata(FUSION_THRESHOLD, 220_000_000L).addTo(fusionRecipes);
        ...
        // Th + 2O = ThO2
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Thorium, 1))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1), Materials.SodiumHydroxide.getDust(12))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.SulfuricAcid.getFluid(1_000)).fluidOutputs(Materials.NitricAcid.getFluid(2_000))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsFluorides.THORIUM_TETRAFLUORIDE.getFluidStack(1_000)).duration(20 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GGMaterial.zincChloride.get(OrePrefixes.dust, 3)).duration(5 * SECONDS)
                .eut(TierEU.RECIPE_LV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .eut(TierEU.RECIPE_HV).metadata(COIL_HEAT, 1900).metadata(ADDITIVE_AMOUNT, 250)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GGMaterial.vanadiumPentoxide.get(OrePrefixes.dust, 7)).duration(10 * SECONDS)
        ...
        for (ItemStack m1 : mat1) {
            for (ItemStack m2 : mat2) {
                for (ItemStack m3 : mat3) {
                    GTValues.RA.stdBuilder().itemInputs(m1, m2, m3, GTUtility.getIntegratedCircuit(4))
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GGMaterial.orundum.get(OrePrefixes.plate, 1)).duration(20 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GGMaterial.atomicSeparationCatalyst.get(OrePrefixes.ingotHot, 1)).duration(3 * MINUTES)
                .eut(TierEU.RECIPE_HV).metadata(COIL_HEAT, 5000).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(GGMaterial.atomicSeparationCatalyst.get(OrePrefixes.ingotHot, 1))
                .itemOutputs(GGMaterial.atomicSeparationCatalyst.get(OrePrefixes.ingot, 1)).duration(10 * SECONDS)
        ...
        CrackRecipeAdder.crackerAdder(
                ...
                new FluidStack[] { GGMaterial.lightNaquadahFuel.getFluidOrGas(600),
                        Materials.Uranium.getMolten(8 * INGOTS), Materials.Thorium.getMolten(6 * INGOTS),
                        Materials.Plutonium.getMolten(11 * HALF_INGOTS), Materials.Thulium.getMolten(216),
        ...
        GTValues.RA.stdBuilder().itemInputs(Materials.GasolineRaw.getCells(9), Materials.Ethanol.getCells(1))
                .itemOutputs(GGMaterial.ethanolGasoline.get(OrePrefixes.cell, 10)).duration(15 * TICKS)
                .eut(TierEU.RECIPE_MV).addTo(UniversalChemical);

        GTValues.RA.stdBuilder().itemInputs(GGMaterial.ether.get(OrePrefixes.cell)).metadata(FUEL_VALUE, 537)
                .metadata(FUEL_TYPE, 0).addTo(GTRecipeConstants.Fuel);
        GTValues.RA.stdBuilder().itemInputs(GGMaterial.ether.get(OrePrefixes.cell)).metadata(FUEL_VALUE, 537)
                .metadata(FUEL_TYPE, 1).addTo(GTRecipeConstants.Fuel);
        GTValues.RA.stdBuilder().itemInputs(GGMaterial.ethanolGasoline.get(OrePrefixes.cell)).metadata(FUEL_VALUE, 1100)
                .metadata(FUEL_TYPE, 0).addTo(GTRecipeConstants.Fuel);
        GTValues.RA.stdBuilder().itemInputs(GGMaterial.cyclopentadiene.get(OrePrefixes.cell)).metadata(FUEL_VALUE, 70)
                .metadata(FUEL_TYPE, 1).addTo(GTRecipeConstants.Fuel);
        GTValues.RA.stdBuilder().itemInputs(GGMaterial.ironedFuel.get(OrePrefixes.cell)).metadata(FUEL_VALUE, 2248)
                .metadata(FUEL_TYPE, 0).addTo(GTRecipeConstants.Fuel);
        GTValues.RA.stdBuilder().itemInputs(GGMaterial.ironedKerosene.get(OrePrefixes.cell)).metadata(FUEL_VALUE, 1824)
                .metadata(FUEL_TYPE, 0).addTo(GTRecipeConstants.Fuel);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.antimonyTrichloride.getFluidOrGas(1_000)).duration(3 * SECONDS)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .fluidOutputs(GGMaterial.antimonyPentachlorideSolution.getFluidOrGas(1_000)).duration(9 * SECONDS)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .fluidOutputs(GGMaterial.fluoroantimonicAcid.getFluidOrGas(1_000)).duration(42 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GGMaterial.radioactiveSludge.get(OrePrefixes.dust, 3)).duration(3 * MINUTES)
        ...
        GTValues.RA.stdBuilder().itemInputs(GGMaterial.naquadahGas.get(OrePrefixes.cell)).metadata(FUEL_VALUE, 1024)
                .metadata(FUEL_TYPE, 1).addTo(GTRecipeConstants.Fuel);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.naquadahBasedFuelMkI.getFluidOrGas(100)).duration(25 * SECONDS)
                .eut(TierEU.RECIPE_LuV).metadata(FUSION_THRESHOLD, 320_000_000L).addTo(fusionRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.naquadahBasedFuelMkII.getFluidOrGas(100)).duration(25 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GGMaterial.extremelyUnstableNaquadah.get(OrePrefixes.dust, 17)).duration(3 * MINUTES)
                .eut(TierEU.RECIPE_IV / 2).metadata(COIL_HEAT, 3400).addTo(blastFurnaceRecipes);

        // Naquadah Fuel Refinery
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Generator_Naquadah_Mark_V.get(1).copy())
                ...
                .itemOutputs(ItemRefer.Naquadah_Fuel_Refinery.get(1)).eut(TierEU.RECIPE_UHV).duration(60 * SECONDS)
                .addTo(AssemblyLine);

        // Advanced Radiation Proof Plate
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.Radiation_Protection_Plate.get(1))
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.Field_Restriction_Casing.get(1))
        ...
        if (NewHorizonsCoreMod.isModLoaded()) {
            ...
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.Field_Restriction_Coil_T1.get(1))
                    ...
                    .fluidInputs(
                            ...
                            Materials.Lubricant.getFluid(128_000))
                    .itemOutputs(ItemRefer.Field_Restriction_Coil_T2.get(1)).eut(TierEU.RECIPE_UV)
                    .duration(60 * SECONDS).addTo(AssemblyLine);

            // Ultimate Field Restriction Coil
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.Field_Restriction_Coil_T2.get(1))
                    ...
                    .itemOutputs(ItemRefer.Field_Restriction_Coil_T3.get(1)).eut(TierEU.RECIPE_UHV)
                    .duration(60 * SECONDS).addTo(AssemblyLine);

            // Temporal Field Restriction Coil
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.Field_Restriction_Coil_T3.get(1))
                    ...
                    .fluidInputs(
                            ...
                            MaterialsUEVplus.DimensionallyShiftedSuperfluid.getFluid(64_000))
                    .itemOutputs(ItemRefer.Field_Restriction_Coil_T4.get(1)).eut(TierEU.RECIPE_UEV)
                    .duration(60 * SECONDS).addTo(AssemblyLine);
        }
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Quicklime, 2)).duration(10 * TICKS)
                .eut(TierEU.RECIPE_LV).addTo(UniversalChemical);

        // AlN = Al + N
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.Aluminum_Nitride_Dust.get(2))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Aluminium, 1))
                .fluidOutputs(Materials.Nitrogen.getGas(1_000)).duration(5 * SECONDS).eut(TierEU.RECIPE_MV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.AdvancedGlue.getFluid(1_000)).itemOutputs(ItemRefer.Special_Ceramics_Dust.get(9))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_EV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.Special_Ceramics_Dust.get(2), ItemList.Shape_Mold_Casing.get(0))
                .itemOutputs(ItemRefer.Special_Ceramics_Plate.get(1)).duration(20 * SECONDS).eut(TierEU.RECIPE_HV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemRefer.Special_Ceramics_Plate.get(32)).duration(20 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(formingPressRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(FluidRegistry.getFluidStack("combustionpromotor", 2_000)).duration(10 * SECONDS)
                .eut(TierEU.RECIPE_MV).addTo(multiblockChemicalReactorRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(GTUtility.getIntegratedCircuit(16), WerkstoffLoader.SodiumNitrate.get(OrePrefixes.dust, 2))
                .fluidInputs(
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "TZT", "ALB", "WGW", 'T',
                        GTOreDictUnificator.get(OrePrefixes.plateDense, Materials.Titanium, 1), 'Z', "circuitUltimate",
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(2 * SECONDS).eut(TierEU.RECIPE_MV).metadata(PRECISE_ASSEMBLER_CASING_TIER, 1)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Water.getFluid(1_000)).itemOutputs(ItemRefer.Quartz_Wafer.get(1))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.plate, Materials.Quartzite, 1),
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Sodium, 4))
                .fluidInputs(GTModHandler.getDistilledWater(1_000)).itemOutputs(ItemRefer.Quartz_Wafer.get(1))
                .requiresCleanRoom().duration(1 * MINUTES + 15 * SECONDS).eut(TierEU.RECIPE_LV).addTo(autoclaveRecipes);
        ...
        for (Materials tMat : solderingMats) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(tMat.getMolten(tMultiplier * INGOTS)).itemOutputs(ItemRefer.Inverter.get(1))
            ...
            if (NewHorizonsCoreMod.isModLoaded()) {
                GTValues.RA.stdBuilder()
                        ...
                        .fluidInputs(tMat.getMolten(2 * tMultiplier * INGOTS)).itemOutputs(ItemRefer.HiC_T1.get(1))
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "WPM", "CHI", "WPM", 'W',
                        ...
                        GTOreDictUnificator.get(OrePrefixes.plate, Materials.Lead, 1), 'M',
        ...
        GTModHandler.addCraftingRecipe(
                ...
                GTModHandler.RecipeBits.DISMANTLEABLE | GTModHandler.RecipeBits.REVERSIBLE,
                new Object[] { "WPM", "CHI", "WPM", 'W',
                        GTOreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tin, 1), 'P',
                        GTOreDictUnificator.get(OrePrefixes.plateDouble, Materials.Lead, 1), 'M',
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, Loaders.NeutronAccelerators[5].copy())
                ...
                .fluidInputs(Materials.Argon.getGas(3_000)).itemOutputs(Loaders.NeutronAccelerators[6].copy())
                .eut(TierEU.RECIPE_LuV).duration(15 * SECONDS).addTo(AssemblyLine);

        // Neutron Accelerator ZPM
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, Loaders.NeutronAccelerators[6].copy())
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, Loaders.NeutronAccelerators[7].copy())
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, Loaders.NeutronAccelerators[8].copy())
                ...
                .itemOutputs(Loaders.NeutronAccelerators[9].copy()).eut(TierEU.RECIPE_UHV).duration(15 * SECONDS)
                .addTo(AssemblyLine);

        // Neutron Accelerator UEV
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, Loaders.NeutronAccelerators[9].copy())
                .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_UHV))
                .itemInputs(
                ...
                .itemOutputs(Loaders.NeutronAccelerators[10].copy()).eut(TierEU.RECIPE_UEV).duration(15 * SECONDS)
                .addTo(AssemblyLine);

        // Neutron Accelerator UIV
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, Loaders.NeutronAccelerators[10].copy())
                ...
                .itemOutputs(Loaders.NeutronAccelerators[11].copy()).eut(TierEU.RECIPE_UIV).duration(15 * SECONDS)
                .addTo(AssemblyLine);

        // Neutron Accelerator UMV
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, Loaders.NeutronAccelerators[11].copy())
                ...
                .itemOutputs(Loaders.NeutronAccelerators[12].copy()).eut(TierEU.RECIPE_UMV).duration(15 * SECONDS)
                .addTo(AssemblyLine);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .fluidInputs(Materials.Helium.getGas(1_000)).itemOutputs(Loaders.NS.copy()).duration(10 * SECONDS)
                .eut(TierEU.RECIPE_EV).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(5 * SECONDS).eut(TierEU.RECIPE_IV).metadata(PRECISE_ASSEMBLER_CASING_TIER, 1)
                .addTo(GoodGeneratorRecipeMaps.preciseAssemblerRecipes);
    }
    ...
    public static void InitLoadRecipe() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemRefer.Aluminum_Nitride_Dust.get(2)).duration(10 * SECONDS).eut(TierEU.RECIPE_EV)
                .metadata(COIL_HEAT, 4600).addTo(blastFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GGMaterial.extremelyUnstableNaquadah.get(OrePrefixes.ingotHot, 1))
                .itemOutputs(GGMaterial.extremelyUnstableNaquadah.get(OrePrefixes.ingot, 1)).duration(20 * SECONDS)
                .eut(TierEU.RECIPE_LuV).addTo(vacuumFreezerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .itemOutputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Naquadria, 1),
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Naquadria, 1))
                .outputChances(1000, 500, 400, 50, 20, 5).fluidOutputs(GGMaterial.metastableOganesson.getMolten(122))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .fluidOutputs(WerkstoffLoader.Oganesson.getFluidOrGas(6 * INGOTS)).duration(2 * MINUTES + 5 * SECONDS)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .fluidOutputs(WerkstoffLoader.Oganesson.getFluidOrGas(1 * INGOTS)).duration(6 * MINUTES + 40 * SECONDS)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .outputChances(5000, 8000, 7500).fluidOutputs(WerkstoffLoader.Krypton.getFluidOrGas(1 * INGOTS))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .fluidOutputs(GGMaterial.thorium232Tetrafluoride.getFluidOrGas(750)).duration(5 * SECONDS)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .fluidOutputs(GGMaterial.naquadahSolution.getFluidOrGas(500)).duration(40 * SECONDS)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .outputChances(9000, 8500, 5000, 4000, 2000)
                .fluidOutputs(WerkstoffLoader.Xenon.getFluidOrGas(1 * INGOTS)).duration(5 * MINUTES)
                .eut(TierEU.RECIPE_EV).addTo(centrifugeRecipes);

        GTValues.RA.stdBuilder().itemInputs(GGMaterial.radioactiveSludge.get(OrePrefixes.dust, 4))
                .itemOutputs(
