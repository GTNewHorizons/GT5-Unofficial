...
public class Loaders {
    ...
    public static void compactMod() {
        ...
        Loaders.IC = new MTEIndustrialCrucible(32670, "IndustrialCrucible", "Industrial Crucible").getStackForm(1L);
    ...
    public static void postInitLoad() {
        ...
        if (Mods.Thaumcraft.isModLoaded()) {
            ...
            if (gregtech.api.enums.Mods.ThaumicEnergistics.isModLoaded()) {
                thaumicenergistics.api.ThEApi.instance()
                    .transportPermissions()
                    .addAspectContainerTileToBothPermissions(
