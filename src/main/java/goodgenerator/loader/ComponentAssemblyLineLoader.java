...
public class ComponentAssemblyLineLoader {
    ...
    private static void ivRecipes() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .iCircuit(FIELD_GENERATOR_CIRCUIT)
            .fluidInputs(
