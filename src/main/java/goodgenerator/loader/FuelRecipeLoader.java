...
public class FuelRecipeLoader {
    ...
    public static void RegisterFuel() {
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(MyMaterial.extremelyUnstableNaquadah.get(OrePrefixes.dust, 4),
            ...
            .fluidInputs( MyMaterial.heavyNaquadahFuel.getFluidOrGas(800),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(MyMaterial.extremelyUnstableNaquadah.get(OrePrefixes.dust, 8),
        ...
        // MK IV Naquadah Fuel
        GT_Values.RA.stdBuilder()
            .itemInputs( MyMaterial.extremelyUnstableNaquadah.get(OrePrefixes.dust, 27),
            ...
            .fluidInputs(MyMaterial.naquadahBasedFuelMkIII.getFluidOrGas(2000),
        ...
        // MK V Naquadah Fuel
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Infinity, 16),
                MyMaterial.atomicSeparationCatalyst.get(OrePrefixes.dust, 32))
            .fluidInputs(MyMaterial.naquadahBasedFuelMkIV.getFluidOrGas(2000),
        ...
        // Alternate higher tier recipe
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsUEVplus.SpaceTime, 8),
        ...
        // MK VI Naquadah Fuel
        GT_Values.RA.stdBuilder()
            .itemInputs(ELEMENT.STANDALONE.ASTRAL_TITANIUM.getDust(64),
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Tritanium, 32))
            .fluidInputs( MyMaterial.naquadahBasedFuelMkV.getFluidOrGas(2000),
        ...
        // Alternate higher tier recipe
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsUEVplus.WhiteDwarfMatter, 8),
