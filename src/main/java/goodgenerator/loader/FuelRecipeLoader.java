...
public class FuelRecipeLoader {
    ...
    public static void RegisterFuel() {
        ...
        for (int i = 0; i < 9; i++) {
            GTValues.RA.stdBuilder().fluidInputs(inputs[i]).fluidOutputs(outputs[i]).duration(NaquadahFuelTime[i])
                    .eut(0).metadata(LNG_BASIC_OUTPUT, NaquadahFuelVoltage[i]).addTo(naquadahReactorFuels);
        }
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.naquadahBasedFuelMkIII.getFluidOrGas(100)).duration(5 * SECONDS).eut(1_100_000)
                .metadata(NFR_COIL_TIER, 1).addTo(naquadahFuelRefineFactoryRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                        GGMaterial.heavyNaquadahFuel.getFluidOrGas(800),
                        GGMaterial.lightNaquadahFuel.getFluidOrGas(1_000))
                .fluidOutputs(GGMaterial.naquadahBasedFuelMkIII.getFluidOrGas(200)).duration(5 * SECONDS).eut(2_100_000)
                .metadata(NFR_COIL_TIER, 1).addTo(naquadahFuelRefineFactoryRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.naquadahBasedFuelMkIV.getFluidOrGas(250)).duration(8 * SECONDS).eut(46_000_000)
                .metadata(NFR_COIL_TIER, 2).addTo(naquadahFuelRefineFactoryRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.naquadahBasedFuelMkIV.getFluidOrGas(500)).duration(8 * SECONDS).eut(75_000_000)
                .metadata(NFR_COIL_TIER, 2).addTo(naquadahFuelRefineFactoryRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.naquadahBasedFuelMkIV.getFluidOrGas(250)).duration(2 * TICKS).eut(350_000_000)
                .metadata(NFR_COIL_TIER, 4).addTo(naquadahFuelRefineFactoryRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.naquadahBasedFuelMkV.getFluidOrGas(500)).duration(10 * SECONDS)
                .eut(100_000_000).metadata(NFR_COIL_TIER, 2).addTo(naquadahFuelRefineFactoryRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.naquadahBasedFuelMkV.getFluidOrGas(750)).duration(2 * SECONDS + 10 * TICKS)
                .eut(300_000_000).metadata(NFR_COIL_TIER, 3).addTo(naquadahFuelRefineFactoryRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.naquadahBasedFuelMkVI.getFluidOrGas(750)).duration(12 * SECONDS)
                .eut(320_000_000).metadata(NFR_COIL_TIER, 3).addTo(naquadahFuelRefineFactoryRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.naquadahBasedFuelMkVI.getFluidOrGas(1_250)).duration(3 * SECONDS)
                .eut(TierEU.RECIPE_UXV).metadata(NFR_COIL_TIER, 4).addTo(naquadahFuelRefineFactoryRecipes);
    }
}
