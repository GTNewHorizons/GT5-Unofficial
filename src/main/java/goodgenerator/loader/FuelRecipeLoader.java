...
public class FuelRecipeLoader {
    ...
    public static void RegisterFuel() {
        FluidStack[] inputs = new FluidStack[] {
            MaterialLibAPI.getFluidStack(Materials.UraniumBasedLiquidFuelExcitedState, FluidShapes.fluidLiquid, 1),
            MaterialLibAPI.getFluidStack(Materials.ThoriumBasedLiquidFuelExcitedState, FluidShapes.fluidLiquid, 1),
            MaterialLibAPI.getFluidStack(Materials.PlutoniumBasedLiquidFuelExcitedState, FluidShapes.fluidLiquid, 1),
            MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkI, FluidShapes.fluidLiquid, 1),
            MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkII, FluidShapes.fluidLiquid, 1),
            MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkIII, FluidShapes.fluidLiquid, 1),
            MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkIV, FluidShapes.fluidLiquid, 1),
            MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkV, FluidShapes.fluidLiquid, 1),
            MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkVI, FluidShapes.fluidLiquid, 1) };

        FluidStack[] outputs = new FluidStack[] {
            MaterialLibAPI.getFluidStack(Materials.UraniumBasedLiquidFuelDepleted, FluidShapes.fluidLiquid, 1),
            MaterialLibAPI.getFluidStack(Materials.ThoriumBasedLiquidFuelDepleted, FluidShapes.fluidLiquid, 1),
            MaterialLibAPI.getFluidStack(Materials.PlutoniumBasedLiquidFuelDepleted, FluidShapes.fluidLiquid, 1),
            MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkIDepleted, FluidShapes.fluidLiquid, 1),
            MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkIIDepleted, FluidShapes.fluidLiquid, 1),
            MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkIIIDepleted, FluidShapes.fluidLiquid, 1),
            MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkIVDepleted, FluidShapes.fluidLiquid, 1),
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialLibAPI.getFluidStack(Materials.HeavyNaquadahFuel, FluidShapes.fluidLiquid, 800),
                MaterialLibAPI.getFluidStack(Materials.LightNaquadahFuel, FluidShapes.fluidLiquid, 1_000))
            .fluidOutputs(
                MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkIII, FluidShapes.fluidLiquid, 100))
            .duration(5 * SECONDS)
            .eut(1_100_000)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                ...
                MaterialLibAPI.getFluidStack(Materials.LightNaquadahFuel, FluidShapes.fluidLiquid, 1_000))
            .fluidOutputs(
                MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkIII, FluidShapes.fluidLiquid, 200))
            .duration(5 * SECONDS)
            .eut(2_100_000)
            .metadata(NFR_COIL_TIER, 1)
            .addTo(naquadahFuelRefineFactoryRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkIII, FluidShapes.fluidLiquid, 2_000),
                MaterialLibAPI.getFluidStack(Materials.Praseodymium, FluidShapes.fluidMolten, 1 * STACKS))
            .fluidOutputs(
                MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkIV, FluidShapes.fluidLiquid, 250))
            .duration(8 * SECONDS)
            .eut(46_000_000)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(
                MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkIV, FluidShapes.fluidLiquid, 500))
            .duration(8 * SECONDS)
            .eut(75_000_000)
            .metadata(NFR_COIL_TIER, 2)
            .addTo(naquadahFuelRefineFactoryRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialLibAPI.getFluidStack(Materials.HeavyNaquadahFuel, FluidShapes.fluidLiquid, 4_000),
                MaterialLibAPI.getFluidStack(Materials.LightNaquadahFuel, FluidShapes.fluidLiquid, 5_000),
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkIV, FluidShapes.fluidLiquid, 2_000),
                MaterialUtils.fluid(Materials.HeavyRadox, 250))
            .fluidOutputs(
                MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkV, FluidShapes.fluidLiquid, 500))
            .duration(10 * SECONDS)
            .eut(100_000_000)
            .metadata(NFR_COIL_TIER, 2)
            .addTo(naquadahFuelRefineFactoryRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(
                MaterialLibAPI.getFluidStack(Materials.NaquadahBasedLiquidFuelMkV, FluidShapes.fluidLiquid, 750))
