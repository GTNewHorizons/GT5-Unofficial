...
public class RecipeLoader2 {
    ...
    public static void RecipeLoad() {
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.Compact_Fusion_Coil_T0.get(1))
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.Compact_Fusion_Coil_T1.get(1))
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.Compact_Fusion_Coil_T2.get(1))
        ...
        GTValues.RA.stdBuilder().itemInputs(GGMaterial.dalisenite.get(OrePrefixes.ingotHot, 1))
                .itemOutputs(GGMaterial.dalisenite.get(OrePrefixes.ingot, 1)).duration(16 * SECONDS)
                .eut(TierEU.RECIPE_MV).addTo(vacuumFreezerRecipes);
        GTValues.RA.stdBuilder().itemInputs(GGMaterial.shirabon.get(OrePrefixes.ingotHot, 1))
                .itemOutputs(GGMaterial.shirabon.get(OrePrefixes.ingot, 1)).duration(2 * MINUTES).eut(TierEU.RECIPE_UHV)
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "SPS", "ECE", "SLS", 'S',
                        GTOreDictUnificator.get(OrePrefixes.screw, Materials.BlueSteel, 1), 'P',
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Plastic.getMolten(1 * INGOTS)).itemOutputs(Loaders.YFH).duration(10 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemRefer.Fluid_Storage_Core_T1.get(1)).duration(10 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.Fluid_Storage_Core_T2.get(1))
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.Fluid_Storage_Core_T3.get(1))
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.Fluid_Storage_Core_T4.get(1))
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.Fluid_Storage_Core_T5.get(1))
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.Fluid_Storage_Core_T6.get(1))
                .metadata(SCANNING, new Scanning(1 * MINUTES + 30 * SECONDS, TierEU.RECIPE_UV))
                .itemInputs(
                        GTModHandler.getModItem(GalacticraftMars.ID, "item.null", 64L, 6),
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.Fluid_Storage_Core_T7.get(1))
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.Fluid_Storage_Core_T8.get(1))
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.Fluid_Storage_Core_T9.get(1))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Plastic.getMolten(1 * INGOTS)).itemOutputs(ItemRefer.YOTTank_Cell_T1.get(1))
        ...
        // Fluid Cell Block T3
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.YOTTank_Cell_T2.get(1))
                .metadata(SCANNING, new Scanning(1 * MINUTES + 30 * SECONDS, TierEU.RECIPE_EV))
                .itemInputs(
        ...
        // Fluid Cell Block T4
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.YOTTank_Cell_T3.get(1))
                .metadata(SCANNING, new Scanning(1 * MINUTES + 30 * SECONDS, TierEU.RECIPE_IV))
                .itemInputs(
        ...
        // Fluid Cell Block T5
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.YOTTank_Cell_T4.get(1))
                .metadata(SCANNING, new Scanning(1 * MINUTES + 30 * SECONDS, TierEU.RECIPE_LuV))
                .itemInputs(
        ...
        // Fluid Cell Block T6
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.YOTTank_Cell_T5.get(1))
                .metadata(SCANNING, new Scanning(1 * MINUTES + 30 * SECONDS, TierEU.RECIPE_UV))
                .itemInputs(
        ...
        // Fluid Cell Block T7
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.YOTTank_Cell_T6.get(1))
                .metadata(SCANNING, new Scanning(1 * MINUTES + 30 * SECONDS, TierEU.RECIPE_UV))
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Infinity, 1),
        ...
        // Fluid Cell Block T8
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.YOTTank_Cell_T7.get(1))
                .metadata(SCANNING, new Scanning(1 * MINUTES + 30 * SECONDS, TierEU.RECIPE_UHV))
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Infinity, 1),
        ...
        if (NewHorizonsCoreMod.isModLoaded()) {
            // Fluid Cell Block T9
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.YOTTank_Cell_T8.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES + 30 * SECONDS, TierEU.RECIPE_UEV))
                    .itemInputs(
            ...
            GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.YOTTank_Cell_T9.get(1))
                    .metadata(SCANNING, new Scanning(1 * MINUTES + 30 * SECONDS, TierEU.RECIPE_UIV))
                    .itemInputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.YOTTank_Cell_T1.get(1))
                .itemOutputs(
                        ItemRefer.Fluid_Storage_Core_T1.get(10),
                        GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.BlackSteel, 1))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_HV).addTo(unpackagerRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemRefer.YOTTank_Cell_T2.get(1))
                .itemOutputs(
                        ItemRefer.Fluid_Storage_Core_T2.get(10),
                        GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.TungstenSteel, 1))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_HV).addTo(unpackagerRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemRefer.YOTTank_Cell_T3.get(1))
                .itemOutputs(
                        ItemRefer.Fluid_Storage_Core_T3.get(10),
                        GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Naquadah, 1))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_HV).addTo(unpackagerRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemRefer.YOTTank_Cell_T4.get(1))
                .itemOutputs(
                        ItemRefer.Fluid_Storage_Core_T4.get(10),
                        GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Neutronium, 1))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_HV).addTo(unpackagerRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemRefer.YOTTank_Cell_T5.get(1))
                .itemOutputs(
                        ItemRefer.Fluid_Storage_Core_T5.get(10),
                        GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.CosmicNeutronium, 1))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_HV).addTo(unpackagerRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemRefer.YOTTank_Cell_T6.get(1))
                .itemOutputs(
                        ItemRefer.Fluid_Storage_Core_T6.get(2),
                        GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Infinity, 1))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_HV).addTo(unpackagerRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemRefer.YOTTank_Cell_T7.get(1))
                .itemOutputs(
                        ItemRefer.Fluid_Storage_Core_T7.get(2),
                        GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Infinity, 1))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_HV).addTo(unpackagerRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemRefer.YOTTank_Cell_T8.get(1))
                .itemOutputs(
                        ItemRefer.Fluid_Storage_Core_T8.get(2),
                        GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Infinity, 1))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_HV).addTo(unpackagerRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemRefer.YOTTank_Cell_T9.get(1))
                .itemOutputs(
                        ItemRefer.Fluid_Storage_Core_T9.get(2),
                        GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Infinity, 1))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_HV).addTo(unpackagerRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemRefer.YOTTank_Cell_T10.get(1))
                .itemOutputs(
                        ItemRefer.Fluid_Storage_Core_T10.get(2),
                        GTOreDictUnificator.get(OrePrefixes.frameGt, MaterialsUEVplus.SpaceTime, 1))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_HV).addTo(unpackagerRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffLoader.Tiberium.get(OrePrefixes.dust, 1))
                .itemOutputs(
                        WerkstoffLoader.Tiberium.get(OrePrefixes.gem, 1),
                        WerkstoffLoader.Tiberium.get(OrePrefixes.gem, 1))
                .outputChances(10000, 2000).fluidInputs(GGMaterial.naquadahGas.getFluidOrGas(250)).duration(400)
                .eut(TierEU.RECIPE_HV).addTo(autoclaveRecipes);

        GTValues.RA.stdBuilder().itemInputs(Materials.Firestone.getGems(1))
        ...
        GTValues.RA.stdBuilder().itemInputs(Materials.Diamond.getGems(1))
                .fluidInputs(GGMaterial.heavyNaquadahFuel.getFluidOrGas(1 * INGOTS))
                .itemOutputs(WerkstoffLoader.Tiberium.get(OrePrefixes.gem, 1)).duration(20 * SECONDS)
                .eut(TierEU.RECIPE_EV).addTo(chemicalBathRecipes);

        GTValues.RA.stdBuilder().fluidInputs(Materials.HeavyFuel.getFluid(1_000))
                .fluidOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(Materials.Coal.getGems(1)).itemOutputs(Materials.Ash.getDust(1))
        ...
        if (!OreDictionary.getOres("fuelCoke").isEmpty()) {
            GTValues.RA.stdBuilder().itemInputs(OreDictionary.getOres("fuelCoke").get(0))
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(24))
                ...
                .fluidOutputs(GGMaterial.cyclopentadiene.getFluidOrGas(6)).duration(1 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(distilleryRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(24))
                .fluidInputs(Materials.WoodTar.getFluid(100)).fluidOutputs(GGMaterial.cyclopentadiene.getFluidOrGas(4))
                .duration(1 * SECONDS).eut(TierEU.RECIPE_MV).addTo(distilleryRecipes);

        // FeCl2 + Cl = FeCl3
        GTValues.RA.stdBuilder()
                .itemInputs(GGMaterial.ferrousChloride.get(OrePrefixes.cell, 1), GTUtility.getIntegratedCircuit(1))
                .fluidInputs(Materials.Chlorine.getGas(1_000)).itemOutputs(Materials.IronIIIChloride.getCells(1))
                .duration(2 * SECONDS).eut(TierEU.RECIPE_LV).addTo(UniversalChemical);

        // FeCl3 + H = FeCl2 + HCl
        GTValues.RA.stdBuilder().itemInputs(Materials.IronIIIChloride.getCells(1), GTUtility.getIntegratedCircuit(7))
                .fluidInputs(Materials.Hydrogen.getGas(1_000)).fluidOutputs(Materials.HydrochloricAcid.getFluid(1_000))
                .itemOutputs(GGMaterial.ferrousChloride.get(OrePrefixes.cell, 1)).duration(4 * SECONDS)
        ...
        GTValues.RA.stdBuilder().itemInputs(Materials.Ammonia.getCells(1), GTUtility.getIntegratedCircuit(1))
                .fluidInputs(Materials.Ethanol.getFluid(2_000)).fluidOutputs(Materials.Water.getFluid(2_000))
                .itemOutputs(GGMaterial.diethylamine.get(OrePrefixes.cell, 1)).duration(10 * SECONDS)
                .eut(TierEU.RECIPE_MV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                ...
                .fluidOutputs(GGMaterial.impureFerroceneMixture.getFluidOrGas(15_000)).duration(2 * MINUTES)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.ferroceneWaste.getFluidOrGas(5_000)).duration(40 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.ironedKerosene.getFluidOrGas(44_000)).duration(2 * MINUTES)
                .eut(TierEU.RECIPE_EV).addTo(multiblockChemicalReactorRecipes);

        GTValues.RA.stdBuilder().itemInputs(GGMaterial.ferrocene.get(OrePrefixes.dust, 4))
                .fluidInputs(
                ...
                .fluidOutputs(GGMaterial.ironedFuel.getFluidOrGas(50_000)).duration(2 * MINUTES).eut(TierEU.RECIPE_IV)
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "PCP", "MHM", "GWG", 'G',
                        GTOreDictUnificator.get(OrePrefixes.gearGt, Materials.Titanium, 1), 'C', "circuitData", 'W',
                        GTOreDictUnificator.get(OrePrefixes.cableGt01, Materials.Aluminium, 1), 'P',
        ...
        GTModHandler.addCraftingRecipe(
                ...
                GTModHandler.RecipeBits.DISMANTLEABLE | GTModHandler.RecipeBits.REVERSIBLE,
                new Object[] { "PCP", "MHM", "GWG", 'G',
                        GTOreDictUnificator.get(OrePrefixes.gearGt, Materials.TungstenSteel, 1), 'C', "circuitElite",
                        'W', GTOreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tungsten, 1), 'P',
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GGMaterial.marCeM200.get(OrePrefixes.ingotHot, 19)).duration(4 * MINUTES + 45 * SECONDS)
                .eut(TierEU.RECIPE_ZPM).metadata(COIL_HEAT, 5400).addTo(blastFurnaceRecipes);
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "NPN", "GHG", "IPI", 'N', "circuitMaster", 'P',
                        GGMaterial.marM200.get(OrePrefixes.plate, 1), 'H', ItemList.Hull_IV.get(1), 'G',
                        GGMaterial.marCeM200.get(OrePrefixes.gearGt, 1), 'I',
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.Salty_Root.get(1)).fluidInputs(Materials.Water.getFluid(100))
        ...
        if (NewHorizonsCoreMod.isModLoaded()) {
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemRefer.Precise_Assembler.get(1)).duration(1 * MINUTES + 30 * SECONDS)
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(5 * SECONDS).eut(TierEU.RECIPE_LuV).metadata(PRECISE_ASSEMBLER_CASING_TIER, 1)
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(5 * SECONDS).eut(TierEU.RECIPE_ZPM).metadata(PRECISE_ASSEMBLER_CASING_TIER, 2)
                    .addTo(preciseAssemblerRecipes);
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ItemRefer.HiC_T2.get(2),
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(5 * SECONDS).eut(TierEU.RECIPE_UV).metadata(PRECISE_ASSEMBLER_CASING_TIER, 3)
                    .addTo(preciseAssemblerRecipes);
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ItemRefer.HiC_T3.get(2),
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(5 * SECONDS).eut(TierEU.RECIPE_UHV).metadata(PRECISE_ASSEMBLER_CASING_TIER, 3)
                    .addTo(preciseAssemblerRecipes);
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ItemRefer.HiC_T4.get(2),
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemRefer.Imprecise_Electronic_Unit.get(2)).duration(40 * SECONDS)
                    .eut(TierEU.RECIPE_IV).addTo(assemblerRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemRefer.Precise_Electronic_Unit_T4.get(4)).duration(4 * MINUTES)
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(60 * SECONDS).eut(9001).metadata(PRECISE_ASSEMBLER_CASING_TIER, 1)
                .addTo(preciseAssemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                        ...
                        GGMaterial.titaniumBetaC.getMolten(1 * INGOTS))
                .duration(40 * SECONDS).eut(14000).metadata(PRECISE_ASSEMBLER_CASING_TIER, 2)
                .addTo(preciseAssemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(40 * SECONDS).eut(114514).metadata(PRECISE_ASSEMBLER_CASING_TIER, 3)
                .addTo(preciseAssemblerRecipes);
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.Compact_Fusion_MK1.get(1))
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemRefer.Compact_Fusion_MK2.get(1))
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(1 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_UV).metadata(PRECISE_ASSEMBLER_CASING_TIER, 3)
                .addTo(preciseAssemblerRecipes);

        // Compact MK4 Fusion Disassembly Recipe
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.Compact_Fusion_Coil_T3.get(1))
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(1 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_UHV).metadata(PRECISE_ASSEMBLER_CASING_TIER, 3)
                .addTo(preciseAssemblerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.Compact_Fusion_Coil_T4.get(1))
        ...
        GTValues.RA.stdBuilder().itemInputs(Materials.Antimony.getDust(8), GTUtility.getIntegratedCircuit(24))
                .fluidInputs(
                        GGMaterial.ether.getFluidOrGas(1_000),
                        Materials.Fluorine.getGas(40_000),
                        Materials.Ice.getSolid(8_000))
                .fluidOutputs(GGMaterial.antimonyPentafluorideSolution.getFluidOrGas(8_000)).duration(40 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .fluidInputs(Materials.Concrete.getMolten(16 * INGOTS)).itemOutputs(ItemRefer.Coolant_Tower.get(1))
    ...
    public static void InitLoadRecipe() {
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemRefer.High_Energy_Mixture.get(2))
                .fluidInputs(Materials.PhosphoricAcid.getFluid(4_000))
                .itemOutputs(GGMaterial.lumiinessence.get(OrePrefixes.dust, 1)).duration(30 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GGMaterial.signalium.get(OrePrefixes.dust, 1)).duration(12 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GGMaterial.lumiium.get(OrePrefixes.dust, 1)).duration(12 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.metastableOganesson.getMolten(1 * QUARTER_INGOTS)).duration(30 * SECONDS)
                .eut(TierEU.RECIPE_UV).metadata(FUSION_THRESHOLD, 1_000_000_000L).addTo(fusionRecipes);

        // Mk5 recipe
        GTValues.RA.stdBuilder()
                .fluidInputs(Materials.Copper.getPlasma(4 * INGOTS), WerkstoffLoader.Oganesson.getFluidOrGas(1_000))
                .fluidOutputs(GGMaterial.metastableOganesson.getMolten(4 * INGOTS)).eut(TierEU.RECIPE_UEV)
                .duration(5 * SECONDS).metadata(FUSION_THRESHOLD, 6_000_000_000L).addTo(fusionRecipes);

        GTValues.RA.stdBuilder().itemInputs(GGMaterial.metastableOganesson.get(OrePrefixes.dust))
                .fluidOutputs(WerkstoffLoader.Oganesson.getFluidOrGas(250)).duration(1 * MINUTES + 40 * SECONDS).eut(0)
                .metadata(NKE_RANGE, computeRangeNKE(1100, 1000)).addTo(neutronActivatorRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemRefer.HiC_T5.get(0))
                .fluidInputs(
                        ...
                        MaterialsUEVplus.DimensionallyTranscendentResidue.getFluid(5_000))
                .fluidOutputs(GGMaterial.shirabon.getMolten(1 * INGOTS)).duration(10 * SECONDS).eut(1_500_000_000)
