...
public class RecipeLoader2 {
    ...
    public static void RecipeLoad() {
        ...
        GT_ModHandler.removeFurnaceSmelting(GGMaterial.dalisenite.get(OrePrefixes.dust)); // :doom:
        ...
        // FeCl2 + Cl = FeCl3
        GT_Values.RA.stdBuilder()
            .itemInputs(GGMaterial.ferrousChloride.get(OrePrefixes.cell, 1), GT_Utility.getIntegratedCircuit(1))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(GGMaterial.ether.get(OrePrefixes.cell, 1), GT_Utility.getIntegratedCircuit(1))
        ...
        if (NewHorizonsCoreMod.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ...
                    GT_OreDictUnificator.get(OrePrefixes.cableGt04, GGMaterial.lumiium.getBridgeMaterial(), 2),
