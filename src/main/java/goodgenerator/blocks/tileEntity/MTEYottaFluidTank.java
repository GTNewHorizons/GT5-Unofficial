...
public class MTEYottaFluidTank extends TTMultiblockBase implements ISurvivalConstructable, ICasingTextureProvider {
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("machtype.fluid_tank")
            ...
            .addOutputHatch("1+", "gt.yottank.pos.output", 2)
            .addStructureInfo("")
            .addStructureInfo("GT5U.MBTT.Structure.Base")
            .addCasing("25-57", "gt.yottank.casing.main", false)
            .addCasing("16", "gt.yottank.casing.frame", false)
            .addCasing("16", "gt.yottank.casing.glass", true)
