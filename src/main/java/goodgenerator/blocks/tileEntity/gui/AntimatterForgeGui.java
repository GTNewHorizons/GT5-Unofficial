...
public class AntimatterForgeGui extends MTEMultiBlockBaseGui {
    ...
    protected ListWidget<IWidget, ?> createTerminalTextWidget(PanelSyncManager syncManager, ModularPanel parent)
    {
        ...
        return super.createTerminalTextWidget(syncManager,parent)
            .child(
                new TextWidget(IKey.dynamic(() -> EnumChatFormatting.WHITE+StatCollector.translateToLocal("gui.AntimatterForge.0")+": "+EnumChatFormatting.BLUE +numberFormat.format(containedSync.getLongValue()) + EnumChatFormatting.WHITE+" L")))
            .child(
        new TextWidget(IKey.dynamic(() -> EnumChatFormatting.WHITE+StatCollector.translateToLocal("gui.AntimatterForge.1")+": "+EnumChatFormatting.RED +standardFormat.format(passiveConsSync.getLongValue()) + EnumChatFormatting.WHITE+" EU/t")))
        .child(
        new TextWidget(IKey.dynamic(() -> EnumChatFormatting.WHITE+StatCollector.translateToLocal("gui.AntimatterForge.2")+": "+EnumChatFormatting.LIGHT_PURPLE +standardFormat.format(activeConsSync.getLongValue()) + EnumChatFormatting.WHITE+" EU")))
        .child(
        new TextWidget(IKey.dynamic(() -> EnumChatFormatting.WHITE+StatCollector.translateToLocal("gui.AntimatterForge.3")+": "+EnumChatFormatting.AQUA + numberFormat.format(amChangeSync.getLongValue()) + EnumChatFormatting.WHITE+" L")));
