...
public class MTELargeEssentiaSmeltery extends TTMultiblockBase implements ISurvivalConstructable {
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("machtype.les")
            ...
            .addCasing("6-14", "gt.les.casing.glass", false)
            .addCasing("3-7", "gt.les.casing.furnace", false)
            .addCasing("3-7", "gt.les.casing.filter", false)
            .addEnergyHatch("1+", "gt.les.structure.magic_casing", 1)
            .addMaintenanceHatch("1", "gt.les.structure.magic_casing", 1)
            .addMufflerHatch("3-7", "gt.les.structure.muffler", 2)
            .addInputAny("1+", "gt.les.structure.magic_casing", 1)
