...
public class MTENeutronActivator extends TTMultiblockBase implements ISurvivalConstructable, ICasingTextureProvider {
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("machtype.neutron_activator")
            ...
            .addMaintenanceHatch("1", "gt.neutron_activator.pos.bottom", 2)
            .addInputAny("1+", "gt.neutron_activator.pos.top", 1)
            .addOutputAny("1+", "gt.neutron_activator.pos.bottom", 2)
            .addStructureInfo("")
            .addStructureInfo("GT5U.MBTT.Structure.Base")
            .addCasing("32", "gt.neutron_activator.casing.glass", false)
            .addCasing("7-27", "gt.neutron_activator.casing.clean", false)
            .addCasing("18", "gt.neutron_activator.casing.processor", false)
            .addCasing("16", "gt.neutron_activator.casing.frame", false)
            .addCasing("4", "gt.neutron_activator.casing.pipe", false)
            .addStructureInfo("")
            .addStructureInfo("GT5U.MBTT.Structure.Layer")
            .addCasing("8", "gt.neutron_activator.casing.glass", false)
