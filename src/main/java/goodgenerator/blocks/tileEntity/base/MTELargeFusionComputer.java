...
public abstract class MTELargeFusionComputer extends MTETooltipMultiBlockBaseEM
    ...
    {
        return "Has "+EnumChatFormatting.WHITE+"(1 + "+EnumChatFormatting.LIGHT_PURPLE+"Machine Tier"+EnumChatFormatting.WHITE+" - "+EnumChatFormatting.GREEN+"Recipe Tier"+EnumChatFormatting.WHITE+") * 64"+EnumChatFormatting.GOLD+" Parallels";
    }
    @Override
