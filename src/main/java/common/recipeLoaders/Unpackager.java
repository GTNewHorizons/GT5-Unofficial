    ...
    public void run() {
        ...
        // TFFT Recycling
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.plateDense, Materials.StellarAlloy, 12))
                .duration(5 * SECONDS)
                .eut(TierEU.RECIPE_HV)
                .addTo(unpackagerRecipes);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.plateDense, MaterialsUEVplus.TranscendentMetal, 12))
                .duration(5 * SECONDS)
                .eut(TierEU.RECIPE_HV)
                .addTo(unpackagerRecipes);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(
                    ...
                    OreDictUnificator.get(OrePrefixes.plateDense, MaterialsUEVplus.SpaceTime, 12))
                .duration(5 * SECONDS)
                .eut(TierEU.RECIPE_HV)
                .addTo(unpackagerRecipes);
        ...
        // Capacitor recycling
        {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.ZPM4.get(1L), OreDictUnificator.get(OrePrefixes.screw, Materials.Infinity, 24))
                .duration(60 * SECONDS)
                .eut(TierEU.RECIPE_LV)
                .addTo(unpackagerRecipes);
