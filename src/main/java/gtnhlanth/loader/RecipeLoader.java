...
public class RecipeLoader {
    ...
    public static void loadAccelerator() {
        ...
        // SC
        GTValues.RA.stdBuilder().fluidInputs(Materials.SolderingAlloy.getMolten(2 * INGOTS))
                .itemInputs(
                ...
                ).itemOutputs(LanthItemList.SOURCE_CHAMBER).duration(30 * GTRecipeBuilder.SECONDS)
        ...
        GTValues.RA.stdBuilder().fluidInputs(Materials.SolderingAlloy.getMolten(2 * INGOTS))
                ...
                ).itemOutputs(LanthItemList.LINAC).duration(60 * GTRecipeBuilder.SECONDS).eut(TierEU.RECIPE_ZPM)
        ...
        GTValues.RA.stdBuilder().fluidInputs(Materials.SolderingAlloy.getMolten(2 * INGOTS))
                ...
                ).itemOutputs(LanthItemList.TARGET_CHAMBER).duration(30 * GTRecipeBuilder.SECONDS)
                .eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);

        // Synchrotron
        GTValues.RA.stdBuilder().fluidInputs(Materials.SolderingAlloy.getMolten(6_000))
                .itemInputs(
                        ItemList.Hull_LuV.get(1),
                        WerkstoffMaterialPool.MuMetal.get(OrePrefixes.plateDense, 8),
                        ...
                        GTUtility.getIntegratedCircuit(15))
                .itemOutputs(LanthItemList.SYNCHROTRON).duration(60 * GTRecipeBuilder.SECONDS).eut(TierEU.RECIPE_ZPM)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(WerkstoffMaterialPool.MuMetal.get(OrePrefixes.ingot, 11)).duration(20 * SECONDS)
                .eut(TierEU.RECIPE_EV).specialValue(4500).addTo(blastFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(new ItemStack(LanthItemList.SHIELDED_ACCELERATOR_CASING, 1)).duration(40 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(new ItemStack(LanthItemList.ELECTRODE_CASING, 1)).duration(40 * SECONDS)
                .eut(TierEU.RECIPE_IV).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .metadata(SCANNING, new Scanning(30 * SECONDS, TierEU.RECIPE_IV)).duration(50 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_IV)).duration(30 * GTRecipeBuilder.SECONDS)
                .eut(TierEU.RECIPE_LuV).addTo(AssemblyLine);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(60 * GTRecipeBuilder.SECONDS).eut(TierEU.RECIPE_ZPM).addTo(AssemblyLine);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(12 * GTRecipeBuilder.SECONDS).eut(7680).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .metadata(SCANNING, new Scanning(1 * MINUTES, TierEU.RECIPE_IV)).duration(60 * GTRecipeBuilder.SECONDS)
                .eut(TierEU.RECIPE_LuV).addTo(AssemblyLine);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(new ItemStack(LanthItemList.CAPILLARY_EXCHANGE, 1)).duration(20 * SECONDS)
                .eut(TierEU.RECIPE_IV).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.SolderingAlloy.getMolten(1 * INGOTS))
                .itemOutputs(new ItemStack(LanthItemList.MM_LATTICE, 1)).duration(15 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);

        // Shielded Accelerator Glass
        GTValues.RA.stdBuilder().itemInputs(new ItemStack(LanthItemList.MM_LATTICE, 4))
                .fluidInputs(Materials.BorosilicateGlass.getMolten(1 * INGOTS))
                .itemOutputs(new ItemStack(LanthItemList.SHIELDED_ACCELERATOR_GLASS, 1)).duration(25 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.SolderingAlloy.getMolten(1 * INGOTS)).itemOutputs(LanthItemList.BEAMLINE_PIPE)
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(2 * GTRecipeBuilder.MINUTES).eut(TierEU.RECIPE_LuV).addTo(AssemblyLine);
        ...
        GTValues.RA.stdBuilder()
                ...
                .metadata(SCANNING, new Scanning(1 * MINUTES + 20 * SECONDS, TierEU.RECIPE_IV))
                .duration(4 * GTRecipeBuilder.MINUTES).eut(TierEU.RECIPE_LuV).addTo(AssemblyLine);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(15 * GTRecipeBuilder.SECONDS).eut(TierEU.RECIPE_EV).addTo(multiblockChemicalReactorRecipes);

        GTValues.RA.stdBuilder().fluidInputs(Materials.Nitrogen.getPlasma(4_000))
                .itemInputs(Materials.Silane.getCells(2))
                .fluidOutputs(WerkstoffMaterialPool.NitrogenPlasmaSilaneMix.getFluidOrGas(6_000))
                .itemOutputs(Materials.Empty.getCells(2)).duration(20 * GTRecipeBuilder.SECONDS).eut(7680)
                .addTo(mixerRecipes);

        // NB: http://www.smfl.rit.edu/pdf/process/process_nitride_etch_paper.pdf
        // Reactive Ion Etchant
        GTValues.RA.stdBuilder().fluidInputs(WerkstoffMaterialPool.Fluoroform.getFluidOrGas(3_000))
                .itemInputs(Materials.Oxygen.getCells(4))
                .fluidOutputs(WerkstoffMaterialPool.FluoroformOxygenMix.getFluidOrGas(5_000))
                .itemOutputs(Materials.Empty.getCells(4)).duration(15 * GTRecipeBuilder.SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(mixerRecipes);

        GTValues.RA.stdBuilder().fluidInputs(WerkstoffMaterialPool.FluoroformOxygenMix.getFluidOrGas(5_000))
                .itemInputs(Materials.Empty.getCells(4))
                .fluidOutputs(WerkstoffMaterialPool.Fluoroform.getFluidOrGas(3_000))
                .itemOutputs(Materials.Oxygen.getCells(4)).duration(5 * GTRecipeBuilder.SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(centrifugeRecipes);

        GTValues.RA.stdBuilder().itemInputs(Materials.Iron.getDust(2), Materials.NetherQuartz.getPlates(1))
                .itemOutputs(new ItemStack(LanthItemList.IRON_COATED_QUARTZ)).duration(10 * GTRecipeBuilder.SECONDS)
        ...
        // " + Cr T2
        //
        GTValues.RA.stdBuilder().itemInputs(new ItemStack(LanthItemList.IRON_COATED_QUARTZ))
                .fluidInputs(Materials.Oxygen.getGas(1_000))
                .itemOutputs(new ItemStack(LanthItemList.maskMap.get(MaskList.BLANK1))).outputChances(10000)
                .requiresCleanRoom().duration(144 * SECONDS).eut(TierEU.RECIPE_LuV).addTo(autoclaveRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(Materials.Glass.getPlates(1)).fluidInputs(Materials.Silane.getGas(4_000))
                .itemOutputs(new ItemStack(LanthItemList.SUBSTRATE_PRECURSOR)).duration(60 * GTRecipeBuilder.SECONDS)
                .eut(TierEU.RECIPE_LuV).requiresCleanRoom().addTo(autoclaveRecipes);

        // Now to deposit nitride
        GTValues.RA.stdBuilder().itemInputs(new ItemStack(LanthItemList.SUBSTRATE_PRECURSOR))
                .fluidInputs(WerkstoffMaterialPool.NitrogenPlasmaSilaneMix.getFluidOrGas(4_000))
                .fluidOutputs(Materials.Nitrogen.getGas(3_000)).itemOutputs(new ItemStack(LanthItemList.MASK_SUBSTRATE))
                .duration(30 * GTRecipeBuilder.SECONDS).eut(TierEU.RECIPE_LuV).specialValue(3200).requiresCleanRoom()
        ...
        for (ItemStack lens : OreDictionary.getOres("craftingLensYellow")) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(new ItemStack(LanthItemList.MASKED_MASK)).duration(30 * GTRecipeBuilder.SECONDS)
                    .eut(TierEU.RECIPE_IV).requiresCleanRoom().addTo(WaferEngravingRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(new ItemStack(LanthItemList.MASKED_MASK))
                ...
                .itemOutputs(new ItemStack(LanthItemList.ETCHED_MASK_1)).duration(60 * GTRecipeBuilder.SECONDS)
                .eut(TierEU.RECIPE_LuV).requiresCleanRoom().addTo(autoclaveRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTModHandler.getModItem(NewHorizonsCoreMod.ID, "item.PotassiumHydroxideDust", 4))
                .itemOutputs(new ItemStack(LanthItemList.maskMap.get(MaskList.BLANK2)))
                .duration(80 * GTRecipeBuilder.SECONDS).eut(TierEU.RECIPE_ZPM).metadata(COIL_HEAT, 2400)
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(2 * GTRecipeBuilder.MINUTES).eut(TierEU.RECIPE_ZPM).specialValue(3600)
                .addTo(blastFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(4 * GTRecipeBuilder.MINUTES).eut(TierEU.RECIPE_ZPM).specialValue(4200)
                .addTo(blastFurnaceRecipes);
        ...
        for (MaskList mask : MaskList.values()) {
            ...
            if (mask.getLensColour() == null) { // CR Recipe
                ...
                if (mask == MaskList.PrPIC) {
                    ...
                    GTValues.RA.stdBuilder()
                            ...
                            .duration(60 * GTRecipeBuilder.SECONDS).eut(mask.getEngraverEUt()).requiresCleanRoom()
                    ...
                    GTValues.RA.stdBuilder()
                            ...
                            .itemOutputs(new ItemStack(LanthItemList.maskMap.get(MaskList.PrNCPU)))
                            .duration(45 * GTRecipeBuilder.SECONDS).eut(mask.getEngraverEUt()).requiresCleanRoom()
                            .addTo(UniversalChemical);
            ...
            if (mask == MaskList.NAND) {
                ...
                GTValues.RA.stdBuilder().itemInputs(
                        ...
                        .duration(120 * SECONDS).eut(mask.getEngraverEUt()).addTo(WaferEngravingRecipes);
                    ...
                    if (mask == MaskList.LCC) {
                        ...
                        GTValues.RA.stdBuilder()
                                ...
                                .fluidInputs(
                                        ...
                                        // cost)
                                        Materials.BioMediumSterilized
                                                .getFluid((mask.getDamage() + 1) * 4L * 50 * 3 / 4))
                                .itemOutputs(new ItemStack(LanthItemList.maskMap.get(mask))).requiresCleanRoom()
                                .duration(120 * SECONDS).eut(mask.getEngraverEUt()).addTo(WaferEngravingRecipes);
    ...
    public static void loadGeneral() {
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(GTUtility.getIntegratedCircuit(1), WerkstoffMaterialPool.Zirconia.get(OrePrefixes.dust, 3))
                .itemOutputs(WerkstoffMaterialPool.ZirconiumTetrachloride.get(OrePrefixes.dust, 5))
                .fluidInputs(Materials.HydrochloricAcid.getFluid(4_000)).fluidOutputs(Materials.Water.getFluid(2_000))
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(30 * SECONDS).eut(TierEU.RECIPE_EV).metadata(COIL_HEAT, 4500).addTo(blastFurnaceRecipes);

        /* HAFNIUM */
        // HfCl4
        // HfO2 + 4HCl = HfCl4 + 2H2O
        GTValues.RA.stdBuilder()
                .itemInputs(GTUtility.getIntegratedCircuit(1), WerkstoffMaterialPool.Hafnia.get(OrePrefixes.dust, 3))
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(30 * SECONDS).eut(TierEU.RECIPE_EV).metadata(COIL_HEAT, 2700).addTo(blastFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(WerkstoffMaterialPool.Iodine.getFluidOrGas(4_000)).duration(15 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(WerkstoffMaterialPool.HafniumIodide.get(OrePrefixes.dust, 5)).duration(15 * SECONDS)
                .eut(TierEU.RECIPE_LV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(WerkstoffMaterialPool.Iodine.getFluidOrGas(4_000)).duration(30 * SECONDS)
                .eut(TierEU.RECIPE_HV).metadata(COIL_HEAT, 3400).addTo(blastFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(WerkstoffMaterialPool.Iodine.getFluidOrGas(36_000)).duration(4 * MINUTES + 30 * TICKS)
                .eut(TierEU.RECIPE_HV).metadata(COIL_HEAT, 3400).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.Hafnium.get(OrePrefixes.ingotHot, 1))
                .itemOutputs(WerkstoffMaterialPool.Hafnium.get(OrePrefixes.ingot, 1))
                .duration(26 * SECONDS + 14 * TICKS).eut(TierEU.RECIPE_MV).addTo(vacuumFreezerRecipes);

        // Zirconia-Hafnia
        // ??HfZr?? = HfO2 + ZrO2
        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.HafniaZirconiaBlend.get(OrePrefixes.dust, 1))
                .itemOutputs(
                        WerkstoffMaterialPool.Hafnia.get(OrePrefixes.dust, 3),
                        WerkstoffMaterialPool.Zirconia.get(OrePrefixes.dust, 3))
                .eut(TierEU.RECIPE_EV).duration(30 * SECONDS).addTo(centrifugeRecipes);

        // Ammonium Nitrate
        // HNO3 + NH3 = NH4NO3
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(12), Materials.NitricAcid.getCells(1))
                ...
                .duration(1 * SECONDS + 10 * TICKS).eut(400).addTo(chemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(12))
                ...
                .fluidOutputs(WerkstoffMaterialPool.AmmoniumNitrate.getFluidOrGas(1_000))
                .duration(1 * SECONDS + 10 * TICKS).eut(400).addTo(multiblockChemicalReactorRecipes);
        ...
        // SeaweedConcentrate
        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.SeaweedAsh.get(OrePrefixes.dust, 2))
                .itemOutputs(Materials.Calcite.getDust(1)).fluidInputs(Materials.DilutedSulfuricAcid.getFluid(1_200))
                .fluidOutputs(WerkstoffMaterialPool.SeaweedConcentrate.getFluidOrGas(1_200)).duration(30 * SECONDS)
                .eut(240).addTo(mixerRecipes);

        // Iodine
        GTValues.RA.stdBuilder().itemInputs(Materials.Benzene.getCells(1))
                ...
                .fluidOutputs(WerkstoffMaterialPool.SeaweedByproducts.getFluidOrGas(200)).eut(TierEU.RECIPE_HV)
                .duration(38 * SECONDS).addTo(centrifugeRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTModHandler.getModItem(NewHorizonsCoreMod.ID, "item.PotassiumHydroxideDust", 6),
                ...
                .fluidOutputs(Materials.Water.getFluid(1_000)).duration(7 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_HV)
                .metadata(COIL_HEAT, 1200).addTo(blastFurnaceRecipes);

        // Mn + 2O = MnO2
        GTValues.RA.stdBuilder().itemInputs(Materials.Manganese.getDust(1), GTUtility.getIntegratedCircuit(1))
                .itemOutputs(Materials.Pyrolusite.getDust(3)).fluidInputs(Materials.Oxygen.getGas(2_000))
                .duration(2 * SECONDS).eut(TierEU.RECIPE_LV).addTo(UniversalChemical);

        // 6KOH + 6Cl = KClO3 + 5KCl + 3H2O
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTModHandler.getModItem(NewHorizonsCoreMod.ID, "item.PotassiumHydroxideDust", 18),
                        GTUtility.getIntegratedCircuit(3))
                .itemOutputs(
                        Materials.RockSalt.getDust(10),
                        WerkstoffMaterialPool.PotassiumChlorate.get(OrePrefixes.dust, 5))
                .fluidInputs(Materials.Chlorine.getGas(6_000)).fluidOutputs(Materials.Water.getFluid(3_000))
                .duration(2 * SECONDS).eut(TierEU.RECIPE_LV).addTo(UniversalChemical);

        // Sodium Fluorosilicate
        // 2NaCl + H2SiF6 = 2HCl + Na2SiF6
        GTValues.RA.stdBuilder().itemInputs(Materials.Empty.getCells(2), Materials.Salt.getDust(4))
                .itemOutputs(Materials.HydrochloricAcid.getCells(2))
                .fluidInputs(WerkstoffLoader.HexafluorosilicicAcid.getFluidOrGas(1_000))
                .fluidOutputs(WerkstoffMaterialPool.SodiumFluorosilicate.getFluidOrGas(1_000)).duration(30 * SECONDS)
                .eut(450).addTo(UniversalChemical);

        // La + 6HCl = LaCl3 + 3H
        GTValues.RA.stdBuilder().itemInputs(Materials.Lanthanum.getDust(1), GTUtility.getIntegratedCircuit(1))
                ...
                .fluidOutputs(Materials.Hydrogen.getGas(3_000)).duration(10 * SECONDS).eut(480)
                .addTo(UniversalChemical);

        // Lanthanum Oxide
        GTValues.RA.stdBuilder().fluidInputs(Materials.Water.getFluid(3_000))
                ...
                .duration(10 * GTRecipeBuilder.SECONDS).eut(TierEU.RECIPE_HV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                ...
                .duration(15 * GTRecipeBuilder.SECONDS).eut(TierEU.RECIPE_EV).addTo(UniversalChemical);

        // Boron Trichloride
        GTValues.RA.stdBuilder().fluidInputs(BotWerkstoffMaterialPool.Phosgene.getFluidOrGas(3_000))
                ...
                .itemOutputs(Materials.CarbonMonoxide.getCells(3)).duration(10 * GTRecipeBuilder.SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(UniversalChemical);

        // Lanthanum Hexaboride
        GTValues.RA.stdBuilder().fluidInputs(WerkstoffMaterialPool.BoronTrichloride.getFluidOrGas(8_000))
                ...
                .duration(60 * GTRecipeBuilder.SECONDS).eut(TierEU.RECIPE_IV).addTo(autoclaveRecipes);
    }

    public static void loadLanthanideRecipes() {
        // Methanol
        // CH4O + CO + 3O =V2O5= H2C2O4 + H2O
        GTValues.RA.stdBuilder().itemInputs(GGMaterial.vanadiumPentoxide.get(OrePrefixes.dustTiny, 1))
                .fluidInputs(
                ...
                .duration(22 * SECONDS + 10 * TICKS).eut(240).addTo(multiblockChemicalReactorRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(GTUtility.getIntegratedCircuit(9), GGMaterial.vanadiumPentoxide.get(OrePrefixes.dust, 1))
                .fluidInputs(
                ...
                .duration(3 * MINUTES + 22 * SECONDS + 10 * TICKS).eut(240).addTo(multiblockChemicalReactorRecipes);

        // Ethanol
        // C2H6O + 5O =V2O5= H2C2O4 + 2H2O
        GTValues.RA.stdBuilder().itemInputs(GGMaterial.vanadiumPentoxide.get(OrePrefixes.dustTiny, 1)).itemOutputs()
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(Materials.HydrochloricAcid.getFluid(6_000)).duration(15 * SECONDS).eut(450)
                .addTo(UniversalChemical);

        // CHAIN BEGIN
        // MONAZITE
        GTValues.RA.stdBuilder().fluidInputs(Materials.NitricAcid.getFluid(700))
                ...
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).eut(1920).duration(400).metadata(COIL_HEAT, 800)
        ...
        GTValues.RA.stdBuilder()
                ...
                .eut(TierEU.RECIPE_HV).duration(900).metadata(DISSOLUTION_TANK_RATIO, 10).addTo(dissolutionTankRecipes);

        GTValues.RA.stdBuilder()
                .fluidInputs(
                        Materials.Water.getFluid(90_000),
                        WerkstoffMaterialPool.MuddyRareEarthMonaziteSolution.getFluidOrGas(9_000))
                .itemInputs(GTUtility.getIntegratedCircuit(9), Materials.Saltpeter.getDust(9))
                ...
                .eut(TierEU.RECIPE_HV).duration(8100).metadata(DISSOLUTION_TANK_RATIO, 10)
                .addTo(dissolutionTankRecipes);

        GTValues.RA.stdBuilder().fluidInputs(WerkstoffMaterialPool.DilutedRareEarthMonaziteMud.getFluidOrGas(1_000))
                .itemOutputs(
                ...
                .outputChances(90_00, 75_00, 20_00, 5_00, 20_00).duration(20 * SECONDS).eut(240).addTo(sifterRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.MonaziteSulfate.get(OrePrefixes.dust, 1))
                .fluidInputs(Materials.Water.getFluid(6_000))
                .fluidOutputs(WerkstoffMaterialPool.DilutedMonaziteSulfate.getFluidOrGas(7_000)).duration(24 * SECONDS)
                .eut(400).addTo(mixerRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(13))
                ...
                .duration(24 * SECONDS).eut(TierEU.RECIPE_HV).addTo(multiblockChemicalReactorRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(14))
                ...
                .duration(3 * MINUTES + 36 * SECONDS).eut(TierEU.RECIPE_HV).addTo(multiblockChemicalReactorRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.AcidicMonazitePowder.get(OrePrefixes.dust, 1))
                .itemOutputs(
                ...
                .outputChances(9000, 7000).duration(30 * SECONDS).eut(256).addTo(sifterRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.ThoriumPhosphateCake.get(OrePrefixes.dust, 1))
                .itemOutputs(WerkstoffMaterialPool.ThoriumPhosphateConcentrate.get(OrePrefixes.dust, 1))
                .duration(15 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 1500).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.ThoriumPhosphateConcentrate.get(OrePrefixes.dust))
                .itemOutputs(Materials.Thorium.getDust(1), Materials.Phosphate.getDust(1)).duration(10 * SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(thermalCentrifugeRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.MonaziteRareEarthFiltrate.get(OrePrefixes.dust, 1))
                .itemOutputs(WerkstoffMaterialPool.NeutralizedMonaziteRareEarthFiltrate.get(OrePrefixes.dust, 1))
                .fluidInputs(WerkstoffMaterialPool.AmmoniumNitrate.getFluidOrGas(320)).duration(6 * SECONDS).eut(240)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                        ...
                        WerkstoffMaterialPool.UraniumFiltrate.get(OrePrefixes.dust, 1))
                .outputChances(9000, 5000, 4000).duration(40 * SECONDS).eut(TierEU.RECIPE_HV).addTo(sifterRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.UraniumFiltrate.get(OrePrefixes.dust, 1))
                .itemOutputs(WerkstoffMaterialPool.NeutralizedUraniumFiltrate.get(OrePrefixes.dust, 1))
                .fluidInputs(Materials.HydrofluoricAcid.getFluid(100)).duration(18 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(chemicalBathRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.NeutralizedUraniumFiltrate.get(OrePrefixes.dust, 1))
                .itemOutputs(
                        ...
                        Materials.Uranium235.getDust(1))
                .outputChances(4500, 4000, 3000, 3000, 2000).duration(50 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(sifterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(15 * SECONDS).eut(TierEU.RECIPE_MV).metadata(COIL_HEAT, 1200).addTo(blastFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(25 * SECONDS).eut(TierEU.RECIPE_HV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.CeriumRichMixture.get(OrePrefixes.dust, 3))
                .fluidInputs(WerkstoffMaterialPool.NitratedRareEarthMonaziteConcentrate.getFluidOrGas(1_000))
                .fluidOutputs(WerkstoffMaterialPool.NitricLeachedMonaziteMixture.getFluidOrGas(2_000))
                .duration(11 * SECONDS).eut(TierEU.RECIPE_MV).addTo(mixerRecipes);

        GTValues.RA.stdBuilder().fluidInputs(WerkstoffMaterialPool.NitricLeachedMonaziteMixture.getFluidOrGas(1_000))
                .itemOutputs(WerkstoffMaterialPool.CeriumDioxide.get(OrePrefixes.dust, 1)).outputChances(11_11)
                .fluidOutputs(WerkstoffMaterialPool.NitricMonaziteLeachedConcentrate.getFluidOrGas(1_000))
                .duration(20 * SECONDS).eut(240).addTo(sifterRecipes);

        // BEGIN Cerium
        // Cerium-rich mixture + 3HCl = CeCl3 + Monazite (to allow cerium processing without bastnazite/monazite)
        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.CeriumRichMixture.get(OrePrefixes.dust, 15))
                .itemOutputs(
                        WerkstoffMaterialPool.CeriumChloride.get(OrePrefixes.dust, 1),
                        Materials.Monazite.getDust(1))
                .fluidInputs(Materials.HydrochloricAcid.getFluid(750)).fluidOutputs(Materials.Water.getFluid(750))
                .duration(25 * SECONDS).eut(450).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Hydrogen.getGas(1_000)).fluidOutputs(Materials.Steam.getGas(2_000))
                .duration(15 * SECONDS).eut(450).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(Materials.CarbonMonoxide.getGas(9_000)).duration(10 * SECONDS).eut(TierEU.RECIPE_HV)
                .metadata(COIL_HEAT, 800).addTo(blastFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(5 * SECONDS).eut(240).addTo(vacuumFreezerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .outputChances(9000, 500).duration(30 * SECONDS).eut(TierEU.RECIPE_EV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(WerkstoffMaterialPool.EuropiumOxide.get(OrePrefixes.dust, 6)).duration(15 * SECONDS)
                .eut(8400).addTo(UniversalChemical);

        // 4 EuO = 2 Eu + 2O2
        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.EuropiumOxide.get(OrePrefixes.dust, 2))
                .itemOutputs(Materials.Europium.getDust(1)).fluidOutputs(Materials.Oxygen.getGas(1_000))
                .duration(15 * SECONDS).eut(33_000).addTo(electrolyzerRecipes);

        // EuS = Eu + S
        // TODO old recipe. for compat only. remove material and recipe half a year later, i.e. after September 2023.
        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.EuropiumSulfide.get(OrePrefixes.dust, 2))
                .itemOutputs(Materials.Europium.getDust(1), Materials.Sulfur.getDust(1)).duration(30 * SECONDS)
                .eut(33_000).addTo(electrolyzerRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.MonaziteRarerEarthSediment.get(OrePrefixes.dust, 1))
                .itemOutputs(
                        WerkstoffMaterialPool.MonaziteHeterogenousHalogenicRareEarthMixture.get(OrePrefixes.dust, 1))
                .fluidInputs(Materials.Chlorine.getGas(1_000)).duration(25 * SECONDS).eut(TierEU.RECIPE_HV)
                .metadata(COIL_HEAT, 1200).addTo(blastFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Acetone.getFluid(1_000)).duration(10 * SECONDS).eut(240).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        WerkstoffMaterialPool.MonaziteHeterogenousHalogenicRareEarthMixture.get(OrePrefixes.dust, 1),
                ...
                .fluidInputs(Materials.Acetone.getFluid(1_000)).duration(20 * SECONDS).eut(240).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(Materials.Chloromethane.getGas(400)).eut(TierEU.RECIPE_EV)
                .duration(2 * MINUTES + 37 * SECONDS + 10 * TICKS).addTo(centrifugeRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.SamaricResidue.get(OrePrefixes.dust, 3))
                .itemOutputs(Materials.Samarium.getDust(2), Materials.Gadolinium.getDust(1)).outputChances(10000, 10000)
                .duration(6 * SECONDS + 13 * TICKS).eut(TierEU.RECIPE_EV).addTo(sifterRecipes);
        ...
        GTValues.RA.stdBuilder().fluidInputs(Materials.NitricAcid.getFluid(700))
                ...
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).eut(TierEU.RECIPE_EV).duration(400)
                .metadata(COIL_HEAT, 800).addTo(digesterRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .duration(30 * SECONDS).eut(TierEU.RECIPE_HV).addTo(crackingRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(40 * SECONDS).eut(TierEU.RECIPE_MV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(Gangue.get(OrePrefixes.dust, 1)).eut(TierEU.RECIPE_EV).duration(1000)
                .metadata(DISSOLUTION_TANK_RATIO, 10).addTo(dissolutionTankRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(WerkstoffMaterialPool.FilteredBastnasiteMud.getFluidOrGas(400)).eut(240)
                .duration(20 * SECONDS).addTo(sifterRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .itemOutputs(WerkstoffMaterialPool.BastnasiteRareEarthOxidePowder.get(OrePrefixes.dust, 1))
                .fluidInputs(WerkstoffMaterialPool.FilteredBastnasiteMud.getFluidOrGas(1_000)).duration(25 * SECONDS)
                .eut(600).metadata(COIL_HEAT, 1400).addTo(blastFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.HydrochloricAcid.getFluid(500)).duration(10 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(chemicalBathRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Oxygen.getGas(1_000)).fluidOutputs(Materials.Fluorine.getGas(13))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Water.getFluid(200)).duration(5 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(mixerRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.WetRareEarthOxides.get(OrePrefixes.dust, 1))
                .itemOutputs(WerkstoffMaterialPool.CeriumOxidisedRareEarthOxides.get(OrePrefixes.dust, 1))
                .fluidInputs(Materials.Fluorine.getGas(4_000)).fluidOutputs(Materials.HydrofluoricAcid.getFluid(4_000))
        ...
        GTValues.RA.stdBuilder()
                ...
                .outputChances(100_00, 90_00).eut(TierEU.RECIPE_HV).duration(30 * SECONDS).addTo(centrifugeRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.BastnasiteRarerEarthOxides.get(OrePrefixes.dust, 1))
                ...
                .duration(15 * SECONDS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(WerkstoffMaterialPool.NitratedBastnasiteRarerEarthOxides.get(OrePrefixes.cell, 1))
                .itemOutputs(Materials.Empty.getCells(1)).fluidInputs(Materials.Acetone.getFluid(1_000))
                .fluidOutputs(WerkstoffMaterialPool.SaturatedBastnasiteRarerEarthOxides.getFluidOrGas(1_000))
                .duration(35 * SECONDS).eut(TierEU.RECIPE_HV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(WerkstoffMaterialPool.DilutedAcetone.getFluidOrGas(750)).eut(TierEU.RECIPE_HV)
                .duration(45 * SECONDS).addTo(centrifugeRecipes);

        // Nd RE
        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.NeodymicRareEarthConcentrate.get(OrePrefixes.dust, 2))
                .itemOutputs(
                ...
                .fluidInputs(Materials.HydrochloricAcid.getFluid(2_000)).duration(45 * SECONDS).eut(800)
                .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.HydrofluoricAcid.getFluid(2_000)).duration(15 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.HydrofluoricAcid.getFluid(2_000)).duration(17 * SECONDS + 10 * TICKS)
                .eut(TierEU.RECIPE_HV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(1 * MINUTES + 20 * TICKS).eut(TierEU.RECIPE_EV).metadata(COIL_HEAT, 1200)
                .addTo(blastFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(30 * SECONDS).eut(TierEU.RECIPE_HV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                ).duration(2 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_EV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(15 * SECONDS).eut(TierEU.RECIPE_EV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .outputChances(90_00, 80_00).eut(TierEU.RECIPE_EV).duration(10 * SECONDS).addTo(centrifugeRecipes);

        // TODO UV Tier Ion Extracting Method

        // Lanthanum Part
        // Digester to produce Lanthanum Chloride Concentrate
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Lanthanum, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(3)).fluidInputs(Materials.Chlorine.getGas(36_000))
                .fluidOutputs(LanthanumChlorideConcentrate.getFluidOrGas(3_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        GTValues.RA.stdBuilder().itemInputs(LanthanumOreConcentrate.get(OrePrefixes.dust, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).fluidInputs(Materials.Chlorine.getGas(12_000))
                .fluidOutputs(LanthanumChlorideConcentrate.getFluidOrGas(1_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Praseodymium, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(3)).fluidInputs(Materials.Chlorine.getGas(36_000))
                .fluidOutputs(PraseodymiumChlorideConcentrate.getFluidOrGas(3_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        GTValues.RA.stdBuilder().itemInputs(PraseodymiumOreConcentrate.get(OrePrefixes.dust, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).fluidInputs(Materials.Chlorine.getGas(12_000))
                .fluidOutputs(PraseodymiumChlorideConcentrate.getFluidOrGas(1_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        // 1B oreChlorideConcentrate = 1 ore's rare earth metal + 3 any rare earth metal
        GTValues.RA.stdBuilder()
                .fluidInputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Cerium, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(3)).fluidInputs(Materials.Chlorine.getGas(36_000))
                .fluidOutputs(CeriumChlorideConcentrate.getFluidOrGas(3_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        GTValues.RA.stdBuilder().itemInputs(CeriumOreConcentrate.get(OrePrefixes.dust, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).fluidInputs(Materials.Chlorine.getGas(12_000))
                .fluidOutputs(CeriumChlorideConcentrate.getFluidOrGas(1_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        // 1B oreChlorideConcentrate = 1 ore's rare earth metal + 3 any rare earth metal
        GTValues.RA.stdBuilder()
                .fluidInputs(
                        CeriumExtractingNanoResin.getFluidOrGas(1_000),
                        CeriumChlorideConcentrate.getFluidOrGas(1_000))
                .fluidOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Neodymium, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(3)).fluidInputs(Materials.Chlorine.getGas(36_000))
                .fluidOutputs(NeodymiumChlorideConcentrate.getFluidOrGas(3_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        GTValues.RA.stdBuilder().itemInputs(NeodymiumOreConcentrate.get(OrePrefixes.dust, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).fluidInputs(Materials.Chlorine.getGas(12_000))
                .fluidOutputs(NeodymiumChlorideConcentrate.getFluidOrGas(1_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        // 1B oreChlorideConcentrate = 1 ore's rare earth metal + 3 any rare earth metal
        GTValues.RA.stdBuilder()
                .fluidInputs(
        ...
        // Promethium Part
        // Digester to produce Neodymium Chloride Concentrate
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Promethium, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(3)).fluidInputs(Materials.Chlorine.getGas(36_000))
                .fluidOutputs(PromethiumChlorideConcentrate.getFluidOrGas(3_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        GTValues.RA.stdBuilder().itemInputs(PromethiumOreConcentrate.get(OrePrefixes.dust, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).fluidInputs(Materials.Chlorine.getGas(12_000))
                .fluidOutputs(PromethiumChlorideConcentrate.getFluidOrGas(1_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Samarium, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(3)).fluidInputs(Materials.Chlorine.getGas(36_000))
                .fluidOutputs(SamariumChlorideConcentrate.getFluidOrGas(3_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        GTValues.RA.stdBuilder().itemInputs(SamariumOreConcentrate.get(OrePrefixes.dust, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).fluidInputs(Materials.Chlorine.getGas(12_000))
                .fluidOutputs(SamariumChlorideConcentrate.getFluidOrGas(1_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        // 1B oreChlorideConcentrate = 1 ore's rare earth metal + 3 any rare earth metal
        GTValues.RA.stdBuilder()
                .fluidInputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Europium, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(3)).fluidInputs(Materials.Chlorine.getGas(36_000))
                .fluidOutputs(EuropiumChlorideConcentrate.getFluidOrGas(3_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        GTValues.RA.stdBuilder().itemInputs(EuropiumOreConcentrate.get(OrePrefixes.dust, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).fluidInputs(Materials.Chlorine.getGas(12_000))
                .fluidOutputs(EuropiumChlorideConcentrate.getFluidOrGas(1_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        // 1B oreChlorideConcentrate = 1 ore's rare earth metal + 3 any rare earth metal
        GTValues.RA.stdBuilder()
                .fluidInputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Gadolinium, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(3)).fluidInputs(Materials.Chlorine.getGas(36_000))
                .fluidOutputs(GadoliniumChlorideConcentrate.getFluidOrGas(3_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        GTValues.RA.stdBuilder().itemInputs(GadoliniumOreConcentrate.get(OrePrefixes.dust, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).fluidInputs(Materials.Chlorine.getGas(12_000))
                .fluidOutputs(GadoliniumChlorideConcentrate.getFluidOrGas(1_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        // 1B oreChlorideConcentrate = 1 ore's rare earth metal + 3 any rare earth metal
        GTValues.RA.stdBuilder()
                .fluidInputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Terbium, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(3)).fluidInputs(Materials.Chlorine.getGas(36_000))
                .fluidOutputs(TerbiumChlorideConcentrate.getFluidOrGas(3_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        GTValues.RA.stdBuilder().itemInputs(TerbiumOreConcentrate.get(OrePrefixes.dust, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).fluidInputs(Materials.Chlorine.getGas(12_000))
                .fluidOutputs(TerbiumChlorideConcentrate.getFluidOrGas(1_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        // 1B oreChlorideConcentrate = 1 ore's rare earth metal + 3 any rare earth metal
        GTValues.RA.stdBuilder()
                .fluidInputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Dysprosium, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(3)).fluidInputs(Materials.Chlorine.getGas(36_000))
                .fluidOutputs(DysprosiumChlorideConcentrate.getFluidOrGas(3_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        GTValues.RA.stdBuilder().itemInputs(DysprosiumOreConcentrate.get(OrePrefixes.dust, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).fluidInputs(Materials.Chlorine.getGas(12_000))
                .fluidOutputs(DysprosiumChlorideConcentrate.getFluidOrGas(1_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        // 1B oreChlorideConcentrate = 1 ore's rare earth metal + 3 any rare earth metal
        GTValues.RA.stdBuilder()
                .fluidInputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Holmium, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(3)).fluidInputs(Materials.Chlorine.getGas(36_000))
                .fluidOutputs(HolmiumChlorideConcentrate.getFluidOrGas(3_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        GTValues.RA.stdBuilder().itemInputs(HolmiumOreConcentrate.get(OrePrefixes.dust, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).fluidInputs(Materials.Chlorine.getGas(12_000))
                .fluidOutputs(HolmiumChlorideConcentrate.getFluidOrGas(1_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        // 1B oreChlorideConcentrate = 1 ore's rare earth metal + 3 any rare earth metal
        GTValues.RA.stdBuilder()
                .fluidInputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Erbium, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(3)).fluidInputs(Materials.Chlorine.getGas(36_000))
                .fluidOutputs(ErbiumChlorideConcentrate.getFluidOrGas(3_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        GTValues.RA.stdBuilder().itemInputs(ErbiumOreConcentrate.get(OrePrefixes.dust, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).fluidInputs(Materials.Chlorine.getGas(12_000))
                .fluidOutputs(ErbiumChlorideConcentrate.getFluidOrGas(1_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        // 1B oreChlorideConcentrate = 1 ore's rare earth metal + 3 any rare earth metal
        GTValues.RA.stdBuilder()
                .fluidInputs(
                        ErbiumExtractingNanoResin.getFluidOrGas(1_000),
                        ErbiumChlorideConcentrate.getFluidOrGas(1_000))
                .fluidOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Thulium, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(3)).fluidInputs(Materials.Chlorine.getGas(36_000))
                .fluidOutputs(ThuliumChlorideConcentrate.getFluidOrGas(3_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        GTValues.RA.stdBuilder().itemInputs(ThuliumOreConcentrate.get(OrePrefixes.dust, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).fluidInputs(Materials.Chlorine.getGas(12_000))
                .fluidOutputs(ThuliumChlorideConcentrate.getFluidOrGas(1_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        // 1B oreChlorideConcentrate = 1 ore's rare earth metal + 3 any rare earth metal
        GTValues.RA.stdBuilder()
                .fluidInputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Ytterbium, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(3)).fluidInputs(Materials.Chlorine.getGas(36_000))
                .fluidOutputs(YtterbiumChlorideConcentrate.getFluidOrGas(3_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        GTValues.RA.stdBuilder().itemInputs(YtterbiumOreConcentrate.get(OrePrefixes.dust, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).fluidInputs(Materials.Chlorine.getGas(12_000))
                .fluidOutputs(YtterbiumChlorideConcentrate.getFluidOrGas(1_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        // 1B oreChlorideConcentrate = 1 ore's rare earth metal + 3 any rare earth metal
        GTValues.RA.stdBuilder()
                .fluidInputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Lutetium, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(3)).fluidInputs(Materials.Chlorine.getGas(36_000))
                .fluidOutputs(LutetiumChlorideConcentrate.getFluidOrGas(3_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        GTValues.RA.stdBuilder().itemInputs(LutetiumOreConcentrate.get(OrePrefixes.dust, 1))
                .itemOutputs(Materials.SiliconDioxide.getDust(1)).fluidInputs(Materials.Chlorine.getGas(12_000))
                .fluidOutputs(LutetiumChlorideConcentrate.getFluidOrGas(1_000)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_ZPM).duration(2 * SECONDS).addTo(digesterRecipes);
        // 1B oreChlorideConcentrate = 1 ore's rare earth metal + 3 any rare earth metal
        GTValues.RA.stdBuilder()
                .fluidInputs(
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(LanthanumExtractingNanoResin.getFluidOrGas(1_000)).eut(TierEU.RECIPE_UV)
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Carbon.getNanite(1))
                .fluidInputs(GGMaterial.P507.getFluidOrGas(4_000))
                .fluidOutputs(PraseodymiumExtractingNanoResin.getFluidOrGas(1_000)).eut(TierEU.RECIPE_UV)
                .duration(10 * SECONDS).addTo(laserEngraverRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Carbon.getNanite(1))
                .fluidInputs(GGMaterial.P507.getFluidOrGas(4_000))
                .fluidOutputs(CeriumExtractingNanoResin.getFluidOrGas(1_000)).eut(TierEU.RECIPE_UV)
                .duration(10 * SECONDS).addTo(laserEngraverRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Carbon.getNanite(1))
                .fluidInputs(GGMaterial.P507.getFluidOrGas(4_000))
                .fluidOutputs(NeodymiumExtractingNanoResin.getFluidOrGas(1_000)).eut(TierEU.RECIPE_UV)
                .duration(10 * SECONDS).addTo(laserEngraverRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Carbon.getNanite(1))
                .fluidInputs(GGMaterial.P507.getFluidOrGas(4_000))
                .fluidOutputs(PromethiumExtractingNanoResin.getFluidOrGas(1_000)).eut(TierEU.RECIPE_UV)
                .duration(10 * SECONDS).addTo(laserEngraverRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Carbon.getNanite(1))
                .fluidInputs(GGMaterial.P507.getFluidOrGas(4_000))
                .fluidOutputs(SamariumExtractingNanoResin.getFluidOrGas(1_000)).eut(TierEU.RECIPE_UV)
                .duration(10 * SECONDS).addTo(laserEngraverRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Carbon.getNanite(1))
                .fluidInputs(GGMaterial.P507.getFluidOrGas(4_000))
                .fluidOutputs(EuropiumExtractingNanoResin.getFluidOrGas(1_000)).eut(TierEU.RECIPE_UV)
                .duration(10 * SECONDS).addTo(laserEngraverRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Carbon.getNanite(1))
                .fluidInputs(GGMaterial.P507.getFluidOrGas(4_000))
                .fluidOutputs(GadoliniumExtractingNanoResin.getFluidOrGas(1_000)).eut(TierEU.RECIPE_UV)
                .duration(10 * SECONDS).addTo(laserEngraverRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Carbon.getNanite(1))
                .fluidInputs(GGMaterial.P507.getFluidOrGas(4_000))
                .fluidOutputs(TerbiumExtractingNanoResin.getFluidOrGas(1_000)).eut(TierEU.RECIPE_UV)
                .duration(10 * SECONDS).addTo(laserEngraverRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Carbon.getNanite(1))
                .fluidInputs(GGMaterial.P507.getFluidOrGas(4_000))
                .fluidOutputs(DysprosiumExtractingNanoResin.getFluidOrGas(1_000)).eut(TierEU.RECIPE_UV)
                .duration(10 * SECONDS).addTo(laserEngraverRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Carbon.getNanite(1))
                .fluidInputs(GGMaterial.P507.getFluidOrGas(4_000))
                .fluidOutputs(HolmiumExtractingNanoResin.getFluidOrGas(1_000)).eut(TierEU.RECIPE_UV)
                .duration(10 * SECONDS).addTo(laserEngraverRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Carbon.getNanite(1))
                .fluidInputs(GGMaterial.P507.getFluidOrGas(4_000))
                .fluidOutputs(ErbiumExtractingNanoResin.getFluidOrGas(1_000)).eut(TierEU.RECIPE_UV)
                .duration(10 * SECONDS).addTo(laserEngraverRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Carbon.getNanite(1))
                .fluidInputs(GGMaterial.P507.getFluidOrGas(4_000))
                .fluidOutputs(ThuliumExtractingNanoResin.getFluidOrGas(1_000)).eut(TierEU.RECIPE_UV)
                .duration(10 * SECONDS).addTo(laserEngraverRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Carbon.getNanite(1))
                .fluidInputs(GGMaterial.P507.getFluidOrGas(4_000))
                .fluidOutputs(YtterbiumExtractingNanoResin.getFluidOrGas(1_000)).eut(TierEU.RECIPE_UV)
                .duration(10 * SECONDS).addTo(laserEngraverRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Materials.Carbon.getNanite(1))
                .fluidInputs(GGMaterial.P507.getFluidOrGas(4_000))
                .fluidOutputs(LutetiumExtractingNanoResin.getFluidOrGas(1_000)).eut(TierEU.RECIPE_UV)
                .duration(10 * SECONDS).addTo(laserEngraverRecipes);

        // TODO Electrolyzer recycle Nano Resin and produce molten rare earth metal,

        // La
        GTValues.RA.stdBuilder().itemInputs(Materials.Empty.getCells(2))
                ...
                .fluidOutputs(Materials.Chlorine.getGas(3_000)).eut(TierEU.RECIPE_ZPM).duration(5 * SECONDS)
        ...
        GTValues.RA.stdBuilder().itemInputs(SamariumOreConcentrate.get(OrePrefixes.dust, 16))
                .fluidInputs(Materials.NitricAcid.getFluid(200))
                .itemOutputs(ThoriumPhosphateConcentrate.get(OrePrefixes.dust, 1))
                .fluidOutputs(MuddySamariumRareEarthSolution.getFluidOrGas(800)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_EV).duration(10 * SECONDS).addTo(digesterRecipes);

        // 1 CrushedSamariumOre = 3 SamariumOreConcentrate in process
        GTValues.RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.crushed, Materials.Samarium, 8))
                .fluidInputs(Materials.NitricAcid.getFluid(300))
                .itemOutputs(ThoriumPhosphateConcentrate.get(OrePrefixes.dust, 3))
                .fluidOutputs(MuddySamariumRareEarthSolution.getFluidOrGas(1_200)).metadata(COIL_HEAT, 800)
                .eut(TierEU.RECIPE_EV).duration(10 * SECONDS).addTo(digesterRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .fluidOutputs(SamariumRareEarthMud.getFluidOrGas(2_000)).metadata(DISSOLUTION_TANK_RATIO, 1)
                .outputChances(8000, 6000).eut(TierEU.RECIPE_EV).duration(10 * SECONDS).addTo(dissolutionTankRecipes);
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(9))
                ...
                .fluidOutputs(SamariumRareEarthMud.getFluidOrGas(18_000)).metadata(DISSOLUTION_TANK_RATIO, 1)
                .outputChances(8000, 6000).eut(TierEU.RECIPE_IV).duration(300).addTo(dissolutionTankRecipes);
        // Low Efficiency method in LCR
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .fluidInputs(Materials.NitricAcid.getFluid(1_000), MuddySamariumRareEarthSolution.getFluidOrGas(1_000))
                .itemOutputs(CeriumDioxide.get(OrePrefixes.dust, 1))
                .fluidOutputs(SamariumRareEarthMud.getFluidOrGas(1_000)).outputChances(5000).eut(TierEU.RECIPE_EV)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .metadata(DISSOLUTION_TANK_RATIO, 9).outputChances(9000, 6000).eut(TierEU.RECIPE_EV).duration(600)
                .addTo(dissolutionTankRecipes);
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(9))
                ...
                .metadata(DISSOLUTION_TANK_RATIO, 9).outputChances(9000, 6000).eut(TierEU.RECIPE_IV).duration(900)
                .addTo(dissolutionTankRecipes);
        // Low Efficiency method in LCR
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .fluidInputs(SamariumRareEarthMud.getFluidOrGas(1_000), Materials.Water.getFluid(16_000))
                .fluidOutputs(DilutedSamariumRareEarthSolution.getFluidOrGas(8_000)).eut(TierEU.RECIPE_EV)
                .duration(1200).addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(13))
                .fluidInputs(
                        DilutedSamariumRareEarthSolution.getFluidOrGas(2_000),
        ...
        GTValues.RA.stdBuilder().itemInputs(SamariumOxalate.get(OrePrefixes.dust, 5))
                .fluidInputs(Materials.HydrochloricAcid.getFluid(6_000))
                .itemOutputs(SamariumChloride.get(OrePrefixes.dust, 8))
                .fluidOutputs(Materials.CarbonMonoxide.getGas(6_000)).eut(960).duration(10 * SECONDS)
        ...
        GTValues.RA.stdBuilder().itemInputs(SamariumChloride.get(OrePrefixes.dust, 2), Materials.Salt.getDust(1))
                .itemOutputs(SamariumChlorideSodiumChlorideBlend.get(OrePrefixes.dust, 3)).eut(TierEU.RECIPE_LV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(Materials.Chlorine.getGas(4_000)).eut(TierEU.RECIPE_IV).duration(1 * SECONDS)
                .addTo(electrolyzerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidOutputs(Materials.Chlorine.getGas(36_000)).eut(TierEU.RECIPE_LuV).duration(2 * SECONDS)
                .addTo(electrolyzerRecipes);

        // distill with LanthanumDust 36*144L moltenSmCl3 = 16*144L moltenSm + 27B Cl
        GTValues.RA.stdBuilder().itemInputs(Materials.Lanthanum.getDust(9))
                .itemOutputs(ImpureLanthanumChloride.get(OrePrefixes.dust, 36))
                .fluidInputs(SamariumChloride.getMolten(5_184)).fluidOutputs(Materials.Samarium.getMolten(16 * INGOTS))
                .eut(TierEU.RECIPE_ZPM).duration(5 * SECONDS).addTo(distillationTowerRecipes);

        // Centrifuge ImpureLanthanumChlorideDust
        GTValues.RA.stdBuilder().itemInputs(ImpureLanthanumChloride.get(OrePrefixes.dust, 36))
    ...
    public static void addRandomChemCrafting() {
        ...
        // PTMEG Elastomer
        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.Butanediol.get(OrePrefixes.cell, 1))
                .itemOutputs(Materials.Empty.getCells(1))
                ...
                .duration(1 * MINUTES + 15 * SECONDS).eut(TierEU.RECIPE_HV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(1 * MINUTES).eut(TierEU.RECIPE_HV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(50 * SECONDS).eut(TierEU.RECIPE_MV).addTo(UniversalChemical);

        // THF
        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.AcidicButanediol.get(OrePrefixes.cell, 1))
                .itemOutputs(Materials.Empty.getCells(1)).fluidInputs(Materials.Ethanol.getFluid(1_000))
                .fluidOutputs(WerkstoffMaterialPool.Tetrahydrofuran.getFluidOrGas(1_000)).duration(40 * SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(UniversalChemical);

        // Acidicised Butanediol
        GTValues.RA.stdBuilder().itemInputs(Materials.SulfuricAcid.getCells(1)).itemOutputs(Materials.Water.getCells(1))
                .fluidInputs(WerkstoffMaterialPool.Butanediol.getFluidOrGas(1_000))
                .fluidOutputs(WerkstoffMaterialPool.AcidicButanediol.getFluidOrGas(1_000)).duration(30 * SECONDS)
                .eut(TierEU.RECIPE_EV).addTo(mixerRecipes);

        // Butanediol
        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.MoTeOCatalyst.get(OrePrefixes.dustTiny, 1))
                .fluidInputs(Materials.Butane.getGas(1_000))
                .fluidOutputs(WerkstoffMaterialPool.Butanediol.getFluidOrGas(1_000)).duration(45 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(6 * MINUTES + 45 * SECONDS).eut(TierEU.RECIPE_EV).addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(WerkstoffMaterialPool.MoTeOCatalyst.get(OrePrefixes.dust, 2)).duration(15 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(WerkstoffMaterialPool.TungstophosphoricAcid.getFluidOrGas(1_000)).duration(25 * SECONDS)
                .eut(1024).addTo(UniversalChemical);

        // Toluene Diisocyanate
        GTValues.RA.stdBuilder()
                .itemInputs(WerkstoffMaterialPool.Diaminotoluene.get(OrePrefixes.cell, 1), Materials.Empty.getCells(3))
                .itemOutputs().fluidInputs(BotWerkstoffMaterialPool.Phosgene.getFluidOrGas(2_000))
                .fluidOutputs(WerkstoffMaterialPool.TolueneDiisocyanate.getFluidOrGas(1_000)).duration(45 * SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(UniversalChemical);

        // Diaminotoluene
        GTValues.RA.stdBuilder().itemInputs(Materials.Hydrogen.getCells(4)).itemOutputs()
                .fluidInputs(WerkstoffMaterialPool.Dinitrotoluene.getFluidOrGas(1_000))
                .fluidOutputs(WerkstoffMaterialPool.Diaminotoluene.getFluidOrGas(1_000)).duration(15 * SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(UniversalChemical);

        // Dinitrotoluene
        GTValues.RA.stdBuilder().itemInputs(Materials.NitricAcid.getCells(2)).itemOutputs(Materials.Empty.getCells(2))
                .fluidInputs(Materials.Toluene.getFluid(1_000))
                .fluidOutputs(WerkstoffMaterialPool.Dinitrotoluene.getFluidOrGas(1_000)).duration(45 * SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Polytetrafluoroethylene.getMolten(10 * INGOTS)).duration(30 * SECONDS).eut(4096)
                .addTo(assemblerRecipes);
        // Dissolution Tank
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(Materials.Polytetrafluoroethylene.getMolten(5 * INGOTS)).duration(20 * SECONDS).eut(960)
                .addTo(assemblerRecipes);

        GTValues.RA.stdBuilder().fluidInputs(WerkstoffMaterialPool.DilutedAcetone.getFluidOrGas(50))
                .fluidOutputs(Materials.Acetone.getFluid(30)).duration(1 * SECONDS + 4 * TICKS).eut(TierEU.RECIPE_MV)
                .addTo(fluidHeaterRecipes);

        GTValues.RA.stdBuilder().fluidInputs(WerkstoffMaterialPool.HotSuperCoolant.getFluidOrGas(1_000))
                .fluidOutputs(Materials.SuperCoolant.getFluid(1_000)).duration(10 * SECONDS).eut(TierEU.RECIPE_EV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(CeriumDopedLutetiumAluminiumOxygenBlend.get(OrePrefixes.dust, 9)).eut(TierEU.RECIPE_UV)
                .duration(5 * SECONDS).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTUtility.getIntegratedCircuit(4),
        ...
        GTValues.RA.stdBuilder()
                ...
                .eut(TierEU.RECIPE_UV).duration(45 * SECONDS).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTUtility.getIntegratedCircuit(5),
                        Materials.Cerium.getDust(9),
        ...
        GTValues.RA.stdBuilder().itemInputs(CeriumDopedLutetiumAluminiumOxygenBlend.get(OrePrefixes.dust, 1))
                .itemOutputs(CeriumDopedLutetiumAluminiumGarnet.get(OrePrefixes.gem, 1))
                .fluidInputs(Materials.Lutetium.getMolten(8 * INGOTS)).outputChances(514).eut(TierEU.RECIPE_UV)
                .duration(500).addTo(autoclaveRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(CeriumDopedLutetiumAluminiumGarnet.get(OrePrefixes.dust, 1))
                .itemOutputs(CeriumDopedLutetiumAluminiumGarnet.get(OrePrefixes.gemExquisite, 1))
                .fluidInputs(CeriumDopedLutetiumAluminiumOxygenBlend.getMolten(108)).metadata(COIL_HEAT, 9100)
    ...
    public static void removeCeriumThermalCentrifuge() {
        ...
        for (GTRecipe recipe : thermalCentrifugeRecipes.getAllRecipes()) {
            ...
            for (int oreDictID : oreDict) {
                if (!(OreDictionary.getOreName(oreDictID).startsWith("crushed")
                        || OreDictionary.getOreName(oreDictID).startsWith("purified"))) {
                    continue;
                }
