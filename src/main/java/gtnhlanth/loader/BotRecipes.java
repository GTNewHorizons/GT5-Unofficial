...
public class BotRecipes {
    ...
    public static void addGTRecipe() {
        ...
        // tungsten chain
        FluidStack sodiumTungsten = SodiumTungstate.getFluidOrGas(1 * BUCKETS);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Water.getFluid(4 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.CarbonDioxide.getGas(3 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.CarbonMonoxide.getGas(1 * BUCKETS))
            .fluidOutputs(BotWerkstoffMaterialPool.Phosgene.getFluidOrGas(1 * BUCKETS))
            .duration(2 * SECONDS + 10 * TICKS)
            .eut(TierEU.RECIPE_HV)
            .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.PhosphoricAcid.getFluid(1 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(WerkstoffLoader.AmmoniumChloride.getFluidOrGas(1 * BUCKETS))
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(WerkstoffLoader.SodiumNitrate.get(dust, 5))
            .fluidOutputs(Materials.Ammonia.getGas(1 * BUCKETS), Materials.Water.getFluid(1 * BUCKETS))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_HV)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.SulfuricAcid.getFluid(1 * BUCKETS), Materials.Hydrogen.getGas(1 * BUCKETS))
            .fluidOutputs(
                Materials.Ammonia.getGas(1 * BUCKETS),
                Materials.NitricAcid.getFluid(1 * BUCKETS),
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Propane.getGas(1 * BUCKETS), Materials.NitricAcid.getFluid(2 * BUCKETS))
