...
public class WerkstoffMaterialPool implements Runnable {
    ...
    public static final Werkstoff MonaziteRarerEarthSediment = new Werkstoff(
            new short[] { 250, 214, 165 },
            "Monazite Rarer Earth Sediment",
            subscriptNumbers("Sm?Gd?"),
            new Werkstoff.Stats(),
            Werkstoff.Types.MIXTURE,
            new Werkstoff.GenerationFeatures().disable().onlyDust(),
            offsetID + 31,
    ...
    public static final Werkstoff Gangue = new Werkstoff(
            ...
            new Werkstoff.Stats(),
            Werkstoff.Types.MIXTURE,
            new Werkstoff.GenerationFeatures().disable().onlyDust().addPrefix(OrePrefixes.block)
                    .removePrefix(OrePrefixes.ingot).removePrefix(OrePrefixes.gem),
            offsetID2 + 9,
            TextureSet.SET_DULL);
    ...
    public static final Werkstoff MuMetal = new Werkstoff(
            ...
            "Mu-metal",
            new Werkstoff.Stats().setBlastFurnace(true).setCentrifuge(true).setMass(180).setSpeedOverride(3),
            Werkstoff.Types.MIXTURE,
            new Werkstoff.GenerationFeatures().disable().onlyDust().addMetalItems().addDoubleAndDensePlates()
                    .addCraftingMetalWorkingItems().enforceUnification(),
            offsetID3b + 1,
            TextureSet.SET_METALLIC,
            Pair.of(WerkstoffMaterialPool.Permalloy, 9),
            Pair.of(Materials.Copper, 1),
            Pair.of(Materials.Chrome, 1));

    public static final Werkstoff Thorium234 = new Werkstoff(
            new short[] { 0, 40, 0 },
            "Thorium 234",
            superscriptNumbers("234Th"),
    ...
    public static final Werkstoff LanthanumHexaboride = new Werkstoff(
            ...
            Werkstoff.Types.COMPOUND,
            new Werkstoff.GenerationFeatures().disable().onlyDust().addGems().addSimpleMetalWorkingItems(),
            offsetID3b + 8,
            TextureSet.SET_GEM_HORIZONTAL,
            Pair.of(Materials.Lanthanum, 1),
            Pair.of(Materials.Boron, 6));
