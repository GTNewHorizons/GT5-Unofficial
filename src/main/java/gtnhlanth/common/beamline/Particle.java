...
public enum Particle {
    ...
    // Gauge Bosons
    PHOTON(false, 0, 0, 0, "photon", "\u03B3", 0, null),
    ZBOSON(false, 1, 91188.00f, 0, "zboson", "Z\u2070", 0, null),
    WBOSON(true, 2, 80369.20f, 0, "wboson", "W\u207B", 0, null),
    HIGGS(false, 3, 125110.00f, 0, "higgs", "H\u2070", 0, null),
    GRAVITON(false, 4, 0, 0, "graviton", "G", 0, null),
    // Leptons
    ...
    LAMBDA(false, 13, 1115.68f, 0, "lambda", "\u039B \u2070", 0, null),
    OMEGA(true, 14, 1672.45f, 0, "omega", "\u03A9 \u207B", -1, null),
    // Mesons
    ETA(false, 15, 547.86f, 0, "eta", "\u03B7", 0, null),
    JPSI(false, 16, 3096.92f, 0, "j/psi", "J/\u03C8", 0, null),
    UPSILON(false, 17, 9460.3f, 0, "upsilon", "\u03A5", 0, null),
    // Nuclei
    ALPHA(true, 18, 3727.38f, 8000, "alpha", "\u03B1", 2, null);
