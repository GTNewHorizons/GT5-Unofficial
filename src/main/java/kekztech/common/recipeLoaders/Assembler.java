...
public class Assembler implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Plastic.getMolten(3 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_HV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Glass.getMolten(1 * INGOTS)).duration(5 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        // TFFTStorageField2
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Plastic.getMolten(2 * INGOTS)).duration(10 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        // TFFTStorageField3
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Epoxid.getMolten(6 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
        // TFFTStorageField5
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Epoxid.getMolten(8 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        // LSC Casing
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(new ItemStack(Blocks.yszUnit, 1)).fluidInputs(Materials.Hydrogen.getGas(4_000))
        ...
        GTValues.RA.stdBuilder().itemInputs(
                ...
                .fluidInputs(Materials.Hydrogen.getGas(16_000)).duration(2 * MINUTES).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
        // Hex Tiles
