...
public class Unpackager implements Runnable {
    ...
    public void run() {
        ...
        // TFFT Recycling
        {
            GTValues.RA.stdBuilder().itemInputs(new ItemStack(Blocks.tfftStorageField, 1, 1))
                    .itemOutputs(
        ...
        // Capacitor recycling
        {
            ...
            GTValues.RA.stdBuilder().itemInputs(new ItemStack(Blocks.lscLapotronicEnergyUnit, 1, 7))
                    .itemOutputs(
            ...
            GTValues.RA.stdBuilder().itemInputs(new ItemStack(Blocks.lscLapotronicEnergyUnit, 1, 1))
                    .itemOutputs(
                            ItemList.Energy_LapotronicOrb.get(1L),
                            new ItemStack(Blocks.lscLapotronicEnergyUnit, 1, 6))
                    .duration(60 * SECONDS).eut(TierEU.RECIPE_LV).addTo(unpackagerRecipes);

            GTValues.RA.stdBuilder().itemInputs(new ItemStack(Blocks.lscLapotronicEnergyUnit, 1, 2))
                    .itemOutputs(
                            ItemList.Energy_LapotronicOrb2.get(1L),
                            GTOreDictUnificator.get(OrePrefixes.screw, Materials.Osmiridium, 24))
                    .duration(60 * SECONDS).eut(TierEU.RECIPE_LV).addTo(unpackagerRecipes);

            GTValues.RA.stdBuilder().itemInputs(new ItemStack(Blocks.lscLapotronicEnergyUnit, 1, 3))
                    .itemOutputs(
                            ItemList.Energy_Module.get(1L),
                            GTOreDictUnificator.get(OrePrefixes.screw, Materials.NaquadahAlloy, 24))
                    .duration(60 * SECONDS).eut(TierEU.RECIPE_LV).addTo(unpackagerRecipes);

            GTValues.RA.stdBuilder().itemInputs(new ItemStack(Blocks.lscLapotronicEnergyUnit, 1, 4))
                    .itemOutputs(
                            ItemList.Energy_Cluster.get(1L),
                            GTOreDictUnificator.get(OrePrefixes.screw, Materials.Neutronium, 24))
                    .duration(60 * SECONDS).eut(TierEU.RECIPE_LV).addTo(unpackagerRecipes);

            GTValues.RA.stdBuilder().itemInputs(new ItemStack(Blocks.lscLapotronicEnergyUnit, 1, 5))
                    .itemOutputs(
                            ItemList.ZPM3.get(1L),
                            GTOreDictUnificator.get(OrePrefixes.screw, Materials.CosmicNeutronium, 24))
                    .duration(60 * SECONDS).eut(TierEU.RECIPE_LV).addTo(unpackagerRecipes);

            GTValues.RA.stdBuilder().itemInputs(new ItemStack(Blocks.lscLapotronicEnergyUnit, 1, 8))
                    .itemOutputs(
                            ItemList.ZPM4.get(1L),
                            GTOreDictUnificator.get(OrePrefixes.screw, Materials.Infinity, 24))
                    .duration(60 * SECONDS).eut(TierEU.RECIPE_LV).addTo(unpackagerRecipes);

            GTValues.RA.stdBuilder().itemInputs(new ItemStack(Blocks.lscLapotronicEnergyUnit, 1, 9))
                    .itemOutputs(
                            ItemList.ZPM5.get(1L),
                            GTOreDictUnificator.get(OrePrefixes.screw, MaterialsUEVplus.TranscendentMetal, 24))
                    .duration(60 * SECONDS).eut(TierEU.RECIPE_LV).addTo(unpackagerRecipes);

            GTValues.RA.stdBuilder().itemInputs(new ItemStack(Blocks.lscLapotronicEnergyUnit, 1, 10))
                    .itemOutputs(
