...
public class AssemblyLine implements Runnable {
    ...
    public void run() {
        ...
        // TFFTStorageField6
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, new ItemStack(Blocks.tfftStorageField, 1, 5))
                ...
                .fluidInputs(
                        Materials.Enderium.getMolten(10 * INGOTS),
                        Materials.Polybenzimidazole.getMolten(11 * INGOTS))
                .itemOutputs(new ItemStack(Blocks.tfftStorageField, 1, 6)).eut(TierEU.RECIPE_LuV).duration(30 * SECONDS)
                .addTo(AssemblyLine);

        // TFFTStorageField7
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, new ItemStack(Blocks.tfftStorageField, 1, 6))
        ...
        // TFFTStorageField8
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, new ItemStack(Blocks.tfftStorageField, 1, 7))
                .metadata(SCANNING, new Scanning(1 * MINUTES + 30 * SECONDS, TierEU.RECIPE_ZPM))
                .itemInputs(
        ...
        // TFFTStorageField9
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, new ItemStack(Blocks.tfftStorageField, 1, 8))
        ...
        // TFFTStorageField10
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, new ItemStack(Blocks.tfftStorageField, 1, 9))
        ...
        // LuV Capacitor
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, new ItemStack(Blocks.lscLapotronicEnergyUnit, 1, 1))
        ...
        // ZPM Capacitor
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, new ItemStack(Blocks.lscLapotronicEnergyUnit, 1, 2))
        ...
        // UV Capacitor
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, new ItemStack(Blocks.lscLapotronicEnergyUnit, 1, 3))
