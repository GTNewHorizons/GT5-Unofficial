                                ...
                                new MultiChildWidget()
                                                ...
                                                new TextWidget(
                                                        new Text(
                                                                StatCollector.translateToLocal(
                                                                        "kubatech.gui.text.tea_ultimate.status"))
                                        ...
                                        .addChild(
                                                new DynamicTextWidget(
                                                        () -> new Text(
                                                                StatCollector.translateToLocal(
                                                                        "kubatech.gui.text.tea_ultimate.tea")
                                                                        + ": "
                                        ...
                                        .addChild(
                                                new DynamicTextWidget(
                                                        () -> new Text(
                                                                StatCollector.translateToLocal(
                                                                        "kubatech.gui.text.tea_ultimate.tea_limit")
                                                                        + ": "
                                                                        + (NEIClientUtils.shiftKey()
                                                                                ? numberFormat.format(teaLimit.get())
                                                                                : numberFormatScientific
                                                                                        .format(teaLimit.get()))).color(
                                                                                                Color.GREEN.dark(3)))
                                                                                                        .setSynced(
                                                                                                                false)
                                                                                                        .setPos(20, 30)
                                ...
                                new MultiChildWidget()
                                        .addChild(
                                                new TextWidget(
                                                        new Text(
                                                                StatCollector.translateToLocal(
                                                                        "kubatech.gui.text.tea_ultimate.exchange"))
                                                                                .format(EnumChatFormatting.BOLD)
                                                                                .format(EnumChatFormatting.GOLD)
                                                                                .shadow()).setPos(10, 5))
                                        .addChild(
                                                new ButtonWidget()
                                                        ...
                                                        .addTooltip(
                                                                StatCollector.translateToLocal(
                                                                        "kubatech.gui.tooltip.tea_ultimate.tea_acceptor_research_note"))
                                                        .addTooltip(
                                                                new Text(
                        ...
                        .addPage(
                                new MultiChildWidget().addChild(
                                        new TextWidget(
                                                new Text(
                                                        StatCollector.translateToLocal(
                                                                "kubatech.gui.text.tea_ultimate.benefits"))
                                                                        .format(EnumChatFormatting.BOLD)
