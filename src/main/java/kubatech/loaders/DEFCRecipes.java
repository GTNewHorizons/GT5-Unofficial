...
import static gregtech.api.util.RecipeConstants.DEFC_CASING_TIER;
...
public class DEFCRecipes {
    ...
    public static void addRecipes() {
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.dust, Materials.DraconiumAwakened, 64L),
                OreDictUnificator.get(OrePrefixes.dust, Materials.DraconiumAwakened, 64L))
            .fluidInputs(Materials.Radon.getPlasma(144))
            .itemOutputs(OreDictUnificator.get(OrePrefixes.dust, Materials.Ash, 8L))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.frameGt, Materials.NaquadahAlloy, 6L),
                OreDictUnificator.get(OrePrefixes.plateDense, Materials.NaquadahAlloy, 6L))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.plateDense, Materials.Osmiridium, 6L))
            .fluidInputs(Materials.Void.getMolten(1152L))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.plateDense, Materials.Draconium, 6L),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.plateDense, Materials.CosmicNeutronium, 6L),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.plateDense, Materials.DraconiumAwakened, 6L),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                OreDictUnificator.get(OrePrefixes.plateDense, Materials.Infinity, 6L),
    ...
    private static void fusionRecipes() {
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.plate, Materials.Osmiridium, 4),
                OreDictUnificator.get(OrePrefixes.plate, Materials.Ichorium, 1),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.plate, Materials.Draconium, 8),
        ...
        if (Loader.isModLoaded("supersolarpanel")) {
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    OreDictUnificator.get(OrePrefixes.plate, Materials.DraconiumAwakened, 12),
                    OreDictUnificator.get(OrePrefixes.plate, Materials.Draconium, 4),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.plate, Materials.DraconiumAwakened, 16),
                OreDictUnificator.get(OrePrefixes.plate, Materials.BlackPlutonium, 4),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.plate, Materials.Draconium, 8),
                OreDictUnificator.get(OrePrefixes.plate, Materials.StellarAlloy, 4),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                OreDictUnificator.get(OrePrefixes.plate, Materials.DraconiumAwakened, 8),
