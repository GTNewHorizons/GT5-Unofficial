...
public class DEFCRecipes {
    ...
    public static final RecipeMap<RecipeMapBackend> fusionCraftingRecipes = RecipeMapBuilder
            .of("kubatech.defusioncrafter").maxIO(9, 1, 1, 1).minInputs(1, 0)
            .neiSpecialInfoFormatter(new SimpleSpecialValueFormatter("kubatech.defusioncrafter.tier"))
            .slotOverlays(
                    (index, isFluid, isOutput, isSpecial) -> !isFluid && !isOutput
                            ? UITexture.fullImage(Tags.MODID, "gui/slot/fusion_crafter")
                            : null)
            .build();
    ...
    public static void addRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(FluidRegistry.getFluid("molten.dragonblood"), 288)).eut(TierEU.RECIPE_UHV)
                .duration(14_000).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(kubatech.api.enums.ItemList.DEFCCasingBase.get(1)).eut(TierEU.RECIPE_UV)
                .duration(30 * SECONDS).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(Materials.Void.getMolten(8 * INGOTS))
                .itemOutputs(kubatech.api.enums.ItemList.DEFCCasingT1.get(1)).eut(TierEU.RECIPE_UV)
                .duration(30 * SECONDS).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .itemOutputs(kubatech.api.enums.ItemList.DEFCCasingT2.get(1)).eut(TierEU.RECIPE_UV)
                .duration(30 * SECONDS).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .itemOutputs(kubatech.api.enums.ItemList.DEFCCasingT3.get(1)).eut(TierEU.RECIPE_UHV)
                .duration(30 * SECONDS).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .itemOutputs(kubatech.api.enums.ItemList.DEFCCasingT4.get(1)).eut(TierEU.RECIPE_UEV)
                .duration(30 * SECONDS).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .itemOutputs(kubatech.api.enums.ItemList.DEFCCasingT5.get(1)).eut(TierEU.RECIPE_UIV)
                .duration(30 * SECONDS).addTo(assemblerRecipes);
    ...
    private static void addOldHiddenRecipe(GTRecipe recipe) {
        ...
        recipe = recipe.copy();
        recipe.mInputs = Arrays.stream(recipe.mInputs).map(i -> {
            if (i != null && i.getItem() == ItemLoader.kubaitems) {
                return new ItemStack(
                        EMTItems,
                        0,
                        16 + (i.getItemDamage()
                                - kubatech.api.enums.ItemList.DEFCDraconicSchematic.get(1).getItemDamage()));
            } else return i;
    ...
    private static void fusionRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GTModHandler.getModItem(DraconicEvolution.ID, "draconicCore", 1, 0)).eut(TierEU.RECIPE_UV)
                .duration(400).metadata(DEFC_CASING_TIER, 1).addTo(fusionCraftingRecipes)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GTModHandler.getModItem(DraconicEvolution.ID, "wyvernCore", 1, 0)).eut(TierEU.RECIPE_UHV)
                .duration(800).metadata(DEFC_CASING_TIER, 2).addTo(fusionCraftingRecipes)
                .forEach(DEFCRecipes::addOldHiddenRecipe);
        ...
        if (Mods.SuperSolarPanels.isModLoaded()) {
            GTValues.RA.stdBuilder()
                    ...
                    .eut(TierEU.RECIPE_UEV).duration(1600).metadata(DEFC_CASING_TIER, 3).addTo(fusionCraftingRecipes)
                    .forEach(DEFCRecipes::addOldHiddenRecipe);
        } else {
            GTValues.RA.stdBuilder()
                    .itemInputs(
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GTModHandler.getModItem(DraconicEvolution.ID, "chaoticCore", 1, 0)).eut(24_000_000)
                .duration(3200).metadata(DEFC_CASING_TIER, 4).addTo(fusionCraftingRecipes)
                .forEach(DEFCRecipes::addOldHiddenRecipe);
        ...
        GTValues.RA.stdBuilder()
                ...
                .eut(TierEU.RECIPE_UV).duration(1000).metadata(DEFC_CASING_TIER, 2).addTo(fusionCraftingRecipes)
                .forEach(DEFCRecipes::addOldHiddenRecipe);
        ...
        GTValues.RA.stdBuilder()
                ...
                .eut(TierEU.RECIPE_UHV).duration(2000).metadata(DEFC_CASING_TIER, 3).addTo(fusionCraftingRecipes)
                .forEach(DEFCRecipes::addOldHiddenRecipe);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Radon.getPlasma(1 * INGOTS))
                .fluidOutputs(new FluidStack(FluidRegistry.getFluid("molten.dragonblood"), 288)).eut(TierEU.RECIPE_UHV)
                .duration(4200).metadata(DEFC_CASING_TIER, 3).addTo(fusionCraftingRecipes);
        ...
        if (Witchery.isModLoaded()) {
            GTValues.RA.stdBuilder()
                    ...
                    .eut(TierEU.RECIPE_UHV).duration(3600).metadata(DEFC_CASING_TIER, 3).addTo(fusionCraftingRecipes);
        }
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(FluidRegistry.getFluid("molten.dragonblood"), 432)).eut(TierEU.RECIPE_UHV)
                .duration(2800).metadata(DEFC_CASING_TIER, 3).addTo(fusionCraftingRecipes);
        ...
        if (Witchery.isModLoaded()) {
            GTValues.RA.stdBuilder()
                    ...
                    .eut(TierEU.RECIPE_UHV).duration(2400).metadata(DEFC_CASING_TIER, 3).addTo(fusionCraftingRecipes);
        }
    }
}
