...
public class EIGIC2Mode extends EIGMode {
    ...
    public MultiblockTooltipBuilder addTooltipInfo(MultiblockTooltipBuilder builder) {
        ...
        return builder.addSeparator().addInfo(EnumChatFormatting.GOLD + "IC2 Crops:")
                .addInfo("Minimal voltage tier: " + minVoltageTier).addInfo("Minimal glass tier: " + minGlassTier)
                ...
                .addInfo("Process time: 5 sec").addInfo("All crops are accelerated by x" + acceleration + " times")
