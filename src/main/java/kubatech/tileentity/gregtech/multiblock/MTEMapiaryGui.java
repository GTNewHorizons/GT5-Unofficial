...
public class MTEMapiaryGui extends MTEKubaExtraInventoryGui<MTEMegaIndustrialApiary> {
    ...
    public final EasyIntSyncValue mPrimaryMode = new EasyIntSyncValue(
        "mPrimaryMode",
        multiblock::getPrimaryMode,
        multiblock::setPrimaryMode);
    public final EasyIntSyncValue mSecondaryMode = new EasyIntSyncValue(
        "mSecondaryMode",
        multiblock::getSecondaryMode,
        multiblock::setSecondaryMode);
    ...
    protected Flow createLeftPanelGapRow(ModularPanel parent, PanelSyncManager syncManager) {
        return super.createLeftPanelGapRow(parent, syncManager).child(new PrimaryModeButton(syncManager))
    ...
    private class PrimaryModeButton extends KubaCycleButtonWidget {
        ...
        private static final UITexture[] primaryModeIcon = { GTGuiTextures.OVERLAY_BUTTON_MACHINEMODE_PACKAGER,
            GTGuiTextures.OVERLAY_BUTTON_MACHINEMODE_UNPACKAGER, GTGuiTextures.OVERLAY_BUTTON_MACHINEMODE_CHEMBATH };
        private static final String[] primaryModeDesc = { "kubatech.infodata.mia.running_mode.input",
            "kubatech.infodata.mia.running_mode.output", "kubatech.infodata.mia.running_mode.operating" };

        private void createPrimaryModeSwitchTooltip(RichTooltip t) {
            t.addLine(getTranslationMode())
                .addLine(IKey.dynamic(() -> StatCollector.translateToLocal(primaryModeDesc[mPrimaryMode.getValue()])));
        }
    }
    ...
    private class SecondaryModeButton extends KubaCycleButtonWidget {
        ...
        private static final UITexture[] secondaryModeIcon = { GTGuiTextures.OVERLAY_BUTTON_MACHINEMODE_CHEMBATH,
            GTGuiTextures.OVERLAY_BUTTON_MACHINEMODE_SEPARATOR };

        private final String[] secondaryModeDesc = { "kubatech.infodata.mia.running_mode.operating.normal",
            "kubatech.infodata.mia.running_mode.operating.swarmer" };

        private void createSecondaryModeSwitchTooltip(RichTooltip t) {
            t.addLine(getTranslationMode())
                .addLine(
                    IKey.dynamic(() -> StatCollector.translateToLocal(secondaryModeDesc[mSecondaryMode.getValue()])));
        }
    }
}
