...
public class MTEDEFusionCrafter extends KubaTechGTMultiBlockBase<MTEDEFusionCrafter> implements ISurvivalConstructable {
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("machtype.defc")
            .addInfo("gt.defc.tips.1")
            .beginStructureBlock(5, 10, 5, false)
            .addController("front_bottom_middle")
            .addCasingInfoMin("defc.casing.7.name", 19)
            .addStructurePart("gt.blockcasings4.7.name", "gt.defc.info.1")
            .addStructurePart("gt.blockcasings4.6.name", "gt.defc.info.2")
            .addStructurePart("GT5U.tooltip.structure.tiered_fusion_casing", "gt.defc.info.3")
            .addStructureInfo("gt.defc.info.4")
