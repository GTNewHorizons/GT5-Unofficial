...
public enum Asteroids {
    ...
    // spotless : off
    EndAsteroids(
        ModContainers.Vanilla,
        DimensionDef.EndAsteroids,
        new AsteroidPropertyBuilder()
            .probability(200)
            .sizeRange(5,15)
            .specialBlockChance(5)
            .oreSpawn(
                new AsteroidPropertyBuilder.OreSpawnPropertyBuilder()
                    .baseOreChance(5)
                    ...
                    .smallOreChance(10))
            .loot(
                new AsteroidPropertyBuilder.LootPropertyBuilder()
                    .lootChestChance(1)
    ...
    KuiperBelt(
        ModContainers.GalaxySpace,
        DimensionDef.KuiperBelt,
        new AsteroidPropertyBuilder()
            .probability(200)
            .sizeRange(5,15)
            .specialBlockChance(5)
    ...
    MehenBelt(
        ModContainers.AmunRa,
        DimensionDef.MehenBelt,
        new AsteroidPropertyBuilder()
            .probability(200)
            .sizeRange(5,15)
            .specialBlockChance(5)
    ...
    Asteroids(
        ModContainers.GalacticraftMars,
        DimensionDef.Asteroids,
        new AsteroidPropertyBuilder()
            .probability(200)
            .sizeRange(5,15)
            .specialBlockChance(5)
    ...
    private Asteroids(ModContainers modContainers, DimensionDef dimensionDef, AsteroidPropertyBuilder asteroidPropertyBuilder){
