...
public class RecipesGregTech {
    ...
    private static void alloySmelterRecipes() {
        ...
        RA.stdBuilder().itemInputs(MaterialMisc.WOODS_GLASS.getDust(5), ItemList.Shape_Mold_Ball.get(0))
    ...
    private static void chemplantRecipes() {
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(17), CI.getPinkCatalyst(0))
                .fluidInputs(
                        Materials.NitrogenDioxide.getGas(4_000),
                        Materials.Air.getGas(4_000),
                        Materials.Water.getFluid(2_000))
                .fluidOutputs(Materials.NitricAcid.getFluid(4_000)).duration(10 * SECONDS).eut(TierEU.RECIPE_HV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                        ...
                        MaterialsFluorides.FLUORITE.getOre(4),
                        MaterialsFluorides.FLUORITE.getOre(4))
                .fluidInputs(Materials.NitricAcid.getFluid(4_000), Materials.Air.getGas(8_000)).duration(10 * SECONDS)
                .eut(1024).metadata(CHEMPLANT_CASING_TIER, 5).addTo(chemicalPlantRecipes);
        // Advanced recipe for Fluorine Production
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTUtility.getIntegratedCircuit(17),
                ...
                .itemOutputs(
                        ...
                        MaterialsFluorides.FLUORITE.getOre(2),
                        MaterialsFluorides.FLUORITE.getOre(2))
                .fluidInputs(Materials.NitricAcid.getFluid(5_000), Materials.Air.getGas(12_000)).duration(10 * SECONDS)
                .eut(1024).metadata(CHEMPLANT_CASING_TIER, 5).addTo(chemicalPlantRecipes);

        // 3NO2 + H2O = 2HNO3 + NO
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(16), CI.getPinkCatalyst(0))
                ...
                .duration(10 * SECONDS).eut(TierEU.RECIPE_HV).metadata(CHEMPLANT_CASING_TIER, 2)
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(30 * SECONDS).eut(TierEU.RECIPE_HV).metadata(CHEMPLANT_CASING_TIER, 3)
                .addTo(chemicalPlantRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(5 * MINUTES).eut(TierEU.RECIPE_EV).metadata(CHEMPLANT_CASING_TIER, 4)
                .addTo(chemicalPlantRecipes);

        // Modify Sapling into Pine Sapling
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(6), new ItemStack(Blocks.sapling, 32))
                .itemOutputs(new ItemStack(BOPBlockRegistrator.sapling_Pine, 16))
                .fluidInputs(
                        FluidUtils.getFluidStack("fluid.geneticmutagen", 2_000),
                        GTModHandler.getDistilledWater(8_000))
                .duration(120 * SECONDS).eut(64).metadata(CHEMPLANT_CASING_TIER, 2).addTo(chemicalPlantRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.GeneticMutagen, 8_000)).duration(30 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(20 * SECONDS).eut(TierEU.RECIPE_IV).metadata(CHEMPLANT_CASING_TIER, 5)
                .addTo(chemicalPlantRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(20 * SECONDS).eut(TierEU.RECIPE_LuV).metadata(CHEMPLANT_CASING_TIER, 6)
                .addTo(chemicalPlantRecipes);
        ...
        if (FluidUtils.doesHydrofluoricAcidGtExist()) {
            GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(22))
                    ...
                    .fluidOutputs(FluidUtils.getHydrofluoricAcid(4_500)).duration(30 * SECONDS).eut(TierEU.RECIPE_HV)
                    .metadata(CHEMPLANT_CASING_TIER, 3).addTo(chemicalPlantRecipes);
    ...
    private static void fluidHeaterRecipes() {
        RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(20)).fluidInputs(Materials.Water.getFluid(1_000))
                .fluidOutputs(FluidUtils.getHotWater(1_000)).duration(1 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_LV)
    ...
    private static void fusionRecipes() {
        ...
        RA.stdBuilder()
                ...
                .metadata(FUSION_THRESHOLD, 1_200_000_000L).addTo(fusionRecipes);

        // Rhugnor
        RA.stdBuilder()
                .fluidInputs(
                        MaterialUtils.getMaterial("Infinity", "Neutronium").getMolten(1 * INGOTS),
                        MaterialsAlloy.QUANTUM.getFluidStack(2 * INGOTS))
                .fluidOutputs(MaterialsElements.STANDALONE.RHUGNOR.getFluidStack(1 * INGOTS))
                .duration(25 * SECONDS + 12 * TICKS).eut(TierEU.RECIPE_UV).metadata(FUSION_THRESHOLD, 2_000_000_000L)
                .addTo(fusionRecipes);
        ...
        RA.stdBuilder()
                ...
                .duration(2 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_UEV).metadata(FUSION_THRESHOLD, 2_000_000_000L)
                .addTo(fusionRecipes);
    }
    ...
    private static void assemblyLineRecipes() {
        ...
        RA.stdBuilder()
                ...
                .itemOutputs(new ItemStack(ModBlocks.blockCasings3Misc, 32, 15)).eut(TierEU.RECIPE_LuV)
        ...
        int aCasingSlot = 0;
        for (int j = 6; j < 10; j++) {
            RA.stdBuilder().metadata(RESEARCH_ITEM, aResearch[aCasingSlot])
                    ...
                    .itemOutputs(aGemCasings[aCasingSlot++]).eut(GTValues.VP[j]).duration(2 * MINUTES)
                    .addTo(AssemblyLine);
        }
        ...
        aCasingSlot = 0;
        for (int j = 6; j < 10; j++) {
            RA.stdBuilder().metadata(RESEARCH_ITEM, aExoticInputs[aCasingSlot])
                    ...
                    .itemOutputs(aGemBatteries[aCasingSlot++]).eut(GTValues.VP[j]).duration(2 * MINUTES)
                    .addTo(AssemblyLine);
        }

        if (Baubles.isModLoaded()) {
            // Personal Healing Nanobooster
            RA.stdBuilder().metadata(RESEARCH_ITEM, new ItemStack(Items.golden_apple, 1, 1))
                    ...
                    .itemOutputs(GregtechItemList.PersonalHealingDevice.get(1)).eut(TierEU.RECIPE_ZPM)
            ...
            int aCurrSlot = 0;
            for (int h = 6; h < 9; h++) {
                RA.stdBuilder().metadata(RESEARCH_ITEM, aChargeResearch[aCurrSlot])
                        ...
                        .itemOutputs(aChargeOutputs[aCurrSlot]).eut(GTValues.VP[h]).duration(3 * MINUTES)
                        .addTo(AssemblyLine);
                aCurrSlot++;
            }
            ...
            RA.stdBuilder().metadata(RESEARCH_ITEM, aChargeResearch[aCurrSlot])
                    ...
                    .itemOutputs(aChargeOutputs[aCurrSlot]).eut(GTValues.VP[9]).duration(3 * MINUTES)
                    .addTo(AssemblyLine);
            ...
            RA.stdBuilder()
                    ...
                    .itemOutputs(GregtechItemList.PersonalCloakingDevice.get(1)).eut(TierEU.RECIPE_UV)
                    .duration(3 * MINUTES).addTo(AssemblyLine);
        }

        // Mega Alloy Blast Smelter
        RA.stdBuilder().metadata(RESEARCH_ITEM, GregtechItemList.Industrial_AlloyBlastSmelter.get(1, new Object() {}))
        ...
        RA.stdBuilder().metadata(RESEARCH_ITEM, new ItemStack(ModItems.itemGenericToken, 1, 4))
                ...
                .itemOutputs(GregtechItemList.ExpandableHandPump.get(1)).eut(TierEU.RECIPE_LuV).duration(30 * SECONDS)
                .addTo(AssemblyLine);
    }
    ...
    private static void laserEngraverRecipes() {
        ...
        for (int i = 1; i <= aTransParts.length; i++) {
            RA.stdBuilder().itemInputs(CI.getEmitter(i, 2), CI.getSensor(i, 2)).itemOutputs(aTransParts[i - 1].get(1))
                    .duration(5 * SECONDS).eut(GTValues.VP[i]).addTo(laserEngraverRecipes);
        }
        ...
        RA.stdBuilder()
                ...
                .itemOutputs(MaterialsElements.STANDALONE.CELESTIAL_TUNGSTEN.getDust(1)).duration(3 * MINUTES)
                .eut(TierEU.RECIPE_UEV).addTo(laserEngraverRecipes);

        RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Titanium, 8L),
                        GregtechItemList.Laser_Lens_Special.get(0))
                .itemOutputs(MaterialsElements.STANDALONE.ASTRAL_TITANIUM.getDust(1)).duration(2 * MINUTES)
                .eut(TierEU.RECIPE_UHV).addTo(laserEngraverRecipes);

        RA.stdBuilder().itemInputs(MaterialsAlloy.NITINOL_60.getBlock(2), GregtechItemList.Laser_Lens_Special.get(0))
                .itemOutputs(MaterialsElements.STANDALONE.ADVANCED_NITINOL.getBlock(1)).duration(1 * MINUTES)
        ...
        RA.stdBuilder()
                .itemInputs(
                        ...
                        GregtechItemList.Laser_Lens_Special.get(0))
                .itemOutputs(MaterialsElements.STANDALONE.CHRONOMATIC_GLASS.getDust(1)).duration(5 * MINUTES)
                .eut(TierEU.RECIPE_UHV).addTo(laserEngraverRecipes);

        RA.stdBuilder().itemInputs(CI.getFieldGenerator(6, 1), CI.getEmitter(7, 2))
    ...
    private static void breweryRecipes() {
        ...
        if (Mods.OpenBlocks.isModLoaded()) {
            RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(14))
                    .fluidInputs(FluidRegistry.getFluidStack("mobessence", 100))
                    .fluidOutputs(FluidRegistry.getFluidStack("xpjuice", 1_332)).duration(5 * SECONDS)
        ...
        RA.stdBuilder().itemInputs(new ItemStack(BOPBlockRegistrator.sapling_Rainforest))
                .fluidInputs(Materials.Water.getFluid(100)).fluidOutputs(Materials.Biomass.getFluid(100))
                .duration(1 * MINUTES).eut(3).addTo(brewingRecipes);
        RA.stdBuilder().itemInputs(new ItemStack(BOPBlockRegistrator.sapling_Rainforest))
                .fluidInputs(Materials.Honey.getFluid(100)).fluidOutputs(Materials.Biomass.getFluid(100))
                .duration(1 * MINUTES).eut(3).addTo(brewingRecipes);
        RA.stdBuilder().itemInputs(new ItemStack(BOPBlockRegistrator.sapling_Rainforest))
                .fluidInputs(FluidUtils.getFluidStack("juice", 100)).fluidOutputs(Materials.Biomass.getFluid(100))
                .duration(1 * MINUTES).eut(3).addTo(brewingRecipes);
    }

    private static void electrolyzerRecipes() {
        RA.stdBuilder().itemInputs(new ItemStack(ModItems.dustDecayedRadium226, 1))
                .fluidOutputs(Materials.Radon.getGas(1 * INGOTS)).duration(1 * MINUTES + 30 * SECONDS)
    ...
    private static void blastSmelterRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(Materials.Enderium.getMolten(8 * INGOTS)).eut(TierEU.RECIPE_EV)
                .duration(20 * SECONDS + 1 * MINUTES).addTo(alloyBlastSmelterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.signalium.getMolten(5 * INGOTS)).eut(TierEU.RECIPE_LuV).duration(5 * MINUTES)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.lumiium.getMolten(5 * INGOTS)).eut(TierEU.RECIPE_LuV).duration(5 * MINUTES)
                .addTo(alloyBlastSmelterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsAlloy.EGLIN_STEEL.getFluidStack(16 * INGOTS)).eut(TierEU.RECIPE_MV)
                .duration(45 * SECONDS).addTo(alloyBlastSmelterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsAlloy.HG1223.getFluidStack(16 * INGOTS)).eut(TierEU.RECIPE_LuV)
                .duration(2 * MINUTES).addTo(alloyBlastSmelterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsAlloy.NITINOL_60.getFluidStack(5 * INGOTS)).eut(TierEU.RECIPE_IV)
                .duration(1 * MINUTES + 15 * SECONDS).addTo(alloyBlastSmelterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsAlloy.INDALLOY_140.getFluidStack(1 * STACKS + 36 * INGOTS)).eut(TierEU.RECIPE_IV)
                .duration(40 * SECONDS).addTo(alloyBlastSmelterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsElements.getInstance().GERMANIUM.getFluidStack(1 * QUARTER_INGOTS)).eut(4_000)
                .duration(37 * SECONDS + 10 * TICKS).addTo(alloyBlastSmelterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsElements.getInstance().RHENIUM.getFluidStack(1 * EIGHTH_INGOTS)).eut(4_000)
                .duration(1 * MINUTES + 15 * SECONDS).addTo(alloyBlastSmelterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsElements.getInstance().RHENIUM.getFluidStack(1 * QUARTER_INGOTS)).eut(4_000)
                .duration(37 * SECONDS + 10 * TICKS).addTo(alloyBlastSmelterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.SulfuricAcid.getFluid(1_250))
                .fluidOutputs(MaterialsElements.getInstance().THALLIUM.getFluidStack(2 * INGOTS)).eut(TierEU.RECIPE_IV)
                .duration(1 * MINUTES + 15 * SECONDS).addTo(alloyBlastSmelterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .eut(TierEU.RECIPE_EV).duration(2 * MINUTES).addTo(alloyBlastSmelterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsAlloy.BOTMIUM.getFluidStack(16 * INGOTS)).eut(TierEU.RECIPE_UV)
                .duration(2 * MINUTES).addTo(alloyBlastSmelterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsUEVplus.PhononMedium.getFluid(1_000)).eut(TierEU.RECIPE_UIV)
                .duration(2 * MINUTES).addTo(alloyBlastSmelterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsUEVplus.MoltenProtoHalkoniteBase.getFluid(8 * INGOTS)).eut(TierEU.RECIPE_UEV)
                .duration(60 * SECONDS).addTo(alloyBlastSmelterRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(GGMaterial.incoloy903.getMolten(37 * INGOTS)).eut(TierEU.RECIPE_IV).duration(1 * MINUTES)
                .addTo(alloyBlastSmelterRecipes);
    }
    ...
    private static void dehydratorRecipes() {
        ...
        if (cropGrape != null && foodRaisins != null) {
            GTValues.RA.stdBuilder().itemInputs(cropGrape).itemOutputs(foodRaisins).eut(2).duration(10 * TICKS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .outputChances(20_00, 5_00, 10, 7, 6, 5, 4, 3, 2).fluidInputs(FluidUtils.getFluidStack("sludge", 1_000))
                .fluidOutputs(Materials.Methane.getGas(100)).eut(TierEU.RECIPE_HV).duration(2 * SECONDS)
                .addTo(chemicalDehydratorRecipes);

        // C8H10 = C8H8 + 2H
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(17), ItemList.Cell_Empty.get(3))
                .itemOutputs(
                        ItemUtils.getItemStackOfAmountFromOreDict("cellStyrene", 1),
                        ItemUtils.getItemStackOfAmountFromOreDict("cellHydrogen", 2))
                .fluidInputs(FluidUtils.getFluidStack("fluid.ethylbenzene", 1_000)).eut(TierEU.RECIPE_LV)
                .duration(3 * SECONDS).addTo(chemicalDehydratorRecipes);

        /*
         * Add custom recipes for drying leather
         */
        if (Backpack.isModLoaded()) {
            GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(18), new ItemStack(Items.leather, 2))
                    .itemOutputs(getModItem(Backpack.ID, "tannedLeather", 1))
                    .fluidInputs(FluidUtils.getFluidStack("fluid.ethylbenzene", 1_000)).eut(180).duration(5 * SECONDS)
                    .addTo(chemicalDehydratorRecipes);
            ...
            if (NewHorizonsCoreMod.isModLoaded()) {
                GTValues.RA.stdBuilder()
                        ...
                        .itemOutputs(getModItem(Backpack.ID, "tannedLeather", 1))
                        .fluidInputs(FluidUtils.getFluidStack("fluid.ethylbenzene", 1_000)).eut(180)
                        .duration(5 * SECONDS).addTo(chemicalDehydratorRecipes);
            }
        }
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.Cell_Empty.get(1))
                ...
                .fluidOutputs(MaterialMisc.ACETIC_ANHYDRIDE.getFluidStack(1_000)).eut(TierEU.RECIPE_HV)
                .duration(30 * SECONDS).addTo(chemicalDehydratorRecipes);
    }

    private static void largeChemReactorRecipes() {
        // Styrene
        // C8H10 = C8H8 + 2H
        RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(24)).itemOutputs()
    ...
    private static void assemblerRecipes() {
        ...
        RA.stdBuilder()
                ...
                .fluidInputs(Materials.Oxygen.getGas(8_000)).duration(16 * SECONDS).eut(TierEU.RECIPE_MV / 2)
        ...
        RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.Casing_Vanadium_Redox.get(1)).fluidInputs(Materials.Oxygen.getGas(16_000))
                .duration(3 * SECONDS + 4 * TICKS).eut(TierEU.RECIPE_HV / 2).addTo(assemblerRecipes);
        ...
        RA.stdBuilder()
                ...
                .fluidInputs(Materials.Nitrogen.getGas(16_000)).duration(6 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
        ...
        RA.stdBuilder()
                ...
                .fluidInputs(Materials.Helium.getGas(8_000)).duration(12 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        ...
        RA.stdBuilder()
                ...
                .fluidInputs(Materials.Argon.getGas(4_000)).duration(25 * SECONDS).eut(TierEU.RECIPE_LuV)
                .addTo(assemblerRecipes);
        ...
        RA.stdBuilder()
                ...
                .fluidInputs(Materials.Radon.getGas(4_000)).duration(50 * SECONDS).eut(TierEU.RECIPE_ZPM)
                .addTo(assemblerRecipes);
        ...
        RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.MiningExplosives.get(3)).duration(5 * SECONDS).eut(TierEU.RECIPE_MV / 2)
                .addTo(assemblerRecipes);
        ...
        RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.WitherGuard.get(64)).duration(30 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        ...
        RA.stdBuilder()
                ...
                .itemOutputs(new ItemStack(ModItems.itemGenericToken, 1, 1)).duration(10 * SECONDS)
        ...
        RA.stdBuilder()
                ...
                .itemOutputs(new ItemStack(ModItems.itemGenericToken, 1, 2)).duration(20 * SECONDS)
        ...
        RA.stdBuilder()
                ...
                .itemOutputs(new ItemStack(ModItems.itemGenericToken, 1, 3)).duration(30 * SECONDS)
        ...
        RA.stdBuilder()
                ...
                .itemOutputs(new ItemStack(ModItems.itemGenericToken, 1, 4)).duration(40 * SECONDS)
                .eut(TierEU.RECIPE_EV).addTo(assemblerRecipes);

        RA.stdBuilder().itemInputs(new ItemStack(ModItems.itemGenericToken, 1, 1), GTUtility.getIntegratedCircuit(20))
                .itemOutputs(GregtechItemList.SimpleHandPump.get(1)).duration(1 * SECONDS + 10 * TICKS)
                .eut(TierEU.RECIPE_LV).addTo(assemblerRecipes);

        RA.stdBuilder().itemInputs(new ItemStack(ModItems.itemGenericToken, 1, 2), GTUtility.getIntegratedCircuit(20))
                .itemOutputs(GregtechItemList.AdvancedHandPump.get(1)).duration(6 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(assemblerRecipes);

        RA.stdBuilder().itemInputs(new ItemStack(ModItems.itemGenericToken, 1, 3), GTUtility.getIntegratedCircuit(20))
                .itemOutputs(GregtechItemList.SuperHandPump.get(1)).duration(24 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);

        RA.stdBuilder().itemInputs(new ItemStack(ModItems.itemGenericToken, 1, 4), GTUtility.getIntegratedCircuit(20))
                .itemOutputs(GregtechItemList.UltimateHandPump.get(1)).duration(1 * MINUTES + 36 * SECONDS)
                .eut(TierEU.RECIPE_EV).addTo(assemblerRecipes);
        ...
        for (int i = 1; i < 6; i++) {
            ...
            RA.stdBuilder()
                    .itemInputs(
                            ...
                            aPackBatteries[aAS],
                            CI.getSensor(i, 4))
                    .itemOutputs(aPackOutput[aAS]).fluidInputs(CI.getTieredFluid(i, 4 * INGOTS))
                    .duration(30 * i * SECONDS).eut(GTValues.VP[i]).addTo(assemblerRecipes);
        }
        ...
        if (Baubles.isModLoaded()) {
            ...
            RA.stdBuilder()
                    ...
                    .itemOutputs(
                            ItemDummyResearch.getResearchStack(ASSEMBLY_LINE_RESEARCH.RESEARCH_8_TURBINE_AUTOMATION, 1))
                    .fluidInputs(CI.getAlternativeTieredFluid(7, 32 * INGOTS)).duration(5 * MINUTES)
            ...
            RA.stdBuilder()
                    ...
                    .fluidInputs(CI.getAlternativeTieredFluid(7, 32 * INGOTS)).duration(10 * MINUTES)
    ...
    private static void distilleryRecipes() {
        ...
        RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(4)).fluidInputs(Materials.Air.getGas(1_000))
                .fluidOutputs(Materials.Helium.getGas(1L)).duration(20 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(distilleryRecipes);

        RA.stdBuilder().fluidInputs(Materials.Air.getGas(20_000)).fluidOutputs(Materials.Helium.getGas(25L))
        ...
        RA.stdBuilder().fluidInputs(FluidUtils.getFluidStack("sulfuricapatite", 5_200))
                .fluidOutputs(
        ...
        RA.stdBuilder().fluidInputs(FluidUtils.getFluidStack("sulfurousacid", 1_000))
    ...
    private static void thermalBoilerRecipes() {
        ...
        RA.stdBuilder()
                ...
                .outputChances(444, 222, 56, 56, 56, 125, 1000).duration(1 * SECONDS).eut(0)
        ...
        RA.stdBuilder()
                .fluidInputs(
                        FluidUtils.getPahoehoeLava(1_000),
                        Materials.Water.getFluid(16_000 / GTValues.STEAM_PER_WATER))
                ...
                .itemOutputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Tungstate, 1),
                        new ItemStack(Blocks.obsidian, 1, 0))
                .outputChances(167, 56, 56, 125, 3700).duration(1 * SECONDS).eut(0).addTo(thermalBoilerRecipes);
    ...
    private static void addFuels() {
        ...
        RA.stdBuilder().itemInputs(new ItemStack(Items.lava_bucket)).metadata(FUEL_VALUE, 32).metadata(FUEL_TYPE, 2)
                .duration(0).eut(0).addTo(GTRecipeConstants.Fuel);
        RA.stdBuilder().itemInputs(GTUtility.copyAmount(2, Ic2Items.lavaCell)).metadata(FUEL_VALUE, 32)
                .metadata(FUEL_TYPE, 2).duration(0).eut(0).addTo(GTRecipeConstants.Fuel);
        RA.stdBuilder().itemInputs(Ic2Items.pahoehoelavaCell.copy()).metadata(FUEL_VALUE, 24).metadata(FUEL_TYPE, 2)
                .duration(0).eut(0).addTo(GTRecipeConstants.Fuel);
    }

    private static void extractorRecipes() {
        Logger.INFO("Registering Extractor Recipes.");
        RA.stdBuilder().itemInputs(GregtechItemList.Battery_RE_EV_Sodium.get(1L))
                .itemOutputs(ItemList.Battery_Hull_HV.get(4L)).duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(GregtechItemList.Battery_RE_EV_Cadmium.get(1L))
                .itemOutputs(ItemList.Battery_Hull_HV.get(4L)).duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
        RA.stdBuilder().itemInputs(GregtechItemList.Battery_RE_EV_Lithium.get(1L))
                .itemOutputs(ItemList.Battery_Hull_HV.get(4L)).duration(15 * SECONDS).eut(2).addTo(extractorRecipes);
    }

    private static void fluidExtractorRecipes() {
        // Gelid Cryotheum
        RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Cryotheum, 1L))
                .fluidOutputs(new FluidStack(TFFluids.fluidCryotheum, 250)).duration(10 * SECONDS)
                .eut(TierEU.RECIPE_HV / 2).addTo(fluidExtractionRecipes);

        // Blazing Pyrotheum
        RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Pyrotheum, 1L))
                .fluidOutputs(new FluidStack(TFFluids.fluidPyrotheum, 250)).duration(10 * SECONDS)
                .eut(TierEU.RECIPE_HV / 2).addTo(fluidExtractionRecipes);
    }

    private static void centrifugeRecipes() {

        RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2), MaterialMisc.SOLAR_SALT_COLD.getCell(1))
                .itemOutputs(
    ...
    private static void mixerRecipes() {
        ...
        RA.stdBuilder()
                .itemInputs(
                        ...
                        MaterialMisc.SODIUM_NITRATE.getDust(3),
                        MaterialMisc.POTASSIUM_NITRATE.getDust(2))
                .itemOutputs(MaterialMisc.SOLAR_SALT_COLD.getCell(1)).duration(2 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(mixerRecipes);
        ...
        RA.stdBuilder()
                ...
                .itemOutputs(MaterialsAlloy.LEAGRISIUM.getDust(50)).fluidInputs(Materials.Hydrogen.getGas(5_000))
        ...
        RA.stdBuilder()
                ...
                .itemOutputs(MaterialsAlloy.MARAGING250.getDust(24)).duration(1 * MINUTES).eut(TierEU.RECIPE_EV)
                .addTo(mixerRecipes);
    }
    ...
    private static void chemicalReactorRecipes() {
        ...
        RA.stdBuilder()
                ...
                .fluidOutputs(FluidUtils.getFluidStack("sulfuricapatite", 8_000)).duration(20 * SECONDS)
                .eut(TierEU.RECIPE_LV).addTo(UniversalChemical);

        // KOH + HNO3 = KNO3 + H2O
        RA.stdBuilder().itemInputs(GregtechItemList.PotassiumHydroxide.get(3), GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.PotassiumNitrade, 5L))
                .fluidInputs(Materials.NitricAcid.getFluid(1_000)).fluidOutputs(Materials.Water.getFluid(1_000))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_LV).addTo(UniversalChemical);

        // Na2CO3 + 2HNO3 = 2NaNO3 + CO2 + H2O
        RA.stdBuilder().itemInputs(Materials.SodiumCarbonate.getDust(6), GTUtility.getIntegratedCircuit(1))
                .itemOutputs(MaterialMisc.SODIUM_NITRATE.getDust(10)).fluidInputs(Materials.NitricAcid.getFluid(2_000))
                .fluidOutputs(Materials.CarbonDioxide.getGas(1_000)).duration(5 * SECONDS).eut(TierEU.RECIPE_LV)
    ...
    private static void blastFurnaceRecipes() {
        ...
        // Synthetic Graphite
        RA.stdBuilder().itemInputs(MaterialsAlloy.SILICON_CARBIDE.getDust(2), GTUtility.getIntegratedCircuit(22))
                .itemOutputs(
                ...
                .duration(7 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_IV).metadata(COIL_HEAT, 4500)
                .metadata(ADDITIVE_AMOUNT, 500).addTo(BlastFurnaceWithGas);

    }

    private static void compressorRecipes() {
        RA.stdBuilder().itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Clay, 1L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.plate, Materials.Clay, 1L)).duration(15 * SECONDS)
                .eut(2).addTo(compressorRecipes);

        RA.stdBuilder().itemInputs(ItemList.FusionComputer_UV.get(9))
    ...
    private static void macerationRecipes() {
        ...
        if (getModItem(Mods.Chisel.ID, "limestone", 1, 0) != null) {
            RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("limestone", 1))
    ...
    private static void cyclotronRecipes() {
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GregtechItemList.Pellet_RTG_PO210.get(1)).outputChances(100)
                .fluidInputs(Materials.Bismuth.getMolten(1)).duration(8 * HOURS + 20 * MINUTES).eut(TierEU.RECIPE_IV)
                .addTo(cyclotronRecipes);

        // Americium
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GregtechItemList.Pellet_RTG_AM241.get(4)).outputChances(2500)
                .fluidInputs(Materials.Americium.getMolten(1)).duration(8 * HOURS + 20 * MINUTES).eut(4080)
                .addTo(cyclotronRecipes);

        // Strontium u235
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GregtechItemList.Pellet_RTG_SR90.get(1)).outputChances(570)
                .fluidInputs(Materials.Uranium235.getMolten(10)).duration(8 * HOURS + 20 * MINUTES).eut(4080)
                .addTo(cyclotronRecipes);

        // Strontium u233
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GregtechItemList.Pellet_RTG_SR90.get(1)).outputChances(660)
                .fluidInputs(FluidUtils.getFluidStack("molten.uranium233", 10)).duration(8 * HOURS + 20 * MINUTES)
                .eut(4080).addTo(cyclotronRecipes);

        // Strontium pu239
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GregtechItemList.Pellet_RTG_SR90.get(1)).outputChances(220)
                .fluidInputs(Materials.Plutonium.getMolten(10)).duration(8 * HOURS + 20 * MINUTES).eut(4080)
                .addTo(cyclotronRecipes);

        // Plutonium
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GregtechItemList.Pellet_RTG_PU238.get(2)).outputChances(780)
                .fluidInputs(FluidUtils.getFluidStack("molten.plutonium238", 1)).duration(8 * HOURS + 20 * MINUTES)
                .eut(4080).addTo(cyclotronRecipes);

        // Neptunium
        GTValues.RA.stdBuilder().itemInputs(MaterialsElements.getInstance().URANIUM238.getDust(1))
                .itemOutputs(new ItemStack(ModItems.dustNeptunium238)).outputChances(500)
                .fluidInputs(Materials.Deuterium.getGas(400)).duration(5 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(cyclotronRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(3))
                ...
                .fluidInputs(FluidUtils.getFluidStack("plasma.hydrogen", 100)).duration(2 * MINUTES)
                .eut(TierEU.RECIPE_ZPM).addTo(cyclotronRecipes);
        // Lepton Smash
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(6))
                ...
                .outputChances(600, 40, 20, 15, 10, 5).fluidInputs(FluidUtils.getFluidStack("plasma.helium", 1_500))
                .duration(40 * MINUTES).eut(TierEU.RECIPE_ZPM).addTo(cyclotronRecipes);
        // Boson Smash
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(9))
                ...
                .outputChances(160, 260, 150, 150, 1).fluidInputs(FluidUtils.getFluidStack("plasma.helium", 1_500))
                .duration(30 * MINUTES).eut(TierEU.RECIPE_ZPM).addTo(cyclotronRecipes);
        // Mixed Smash 1
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(12))
                .itemOutputs(
                        ...
                        Particle.getBaseParticle(Particle.HIGGS_BOSON))
                .outputChances(50, 50, 50, 40, 30, 20, 20, 10).fluidInputs(Materials.Americium.getPlasma(2_500))
                .duration(16 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_UV).addTo(cyclotronRecipes);
        // Mixed Smash 1
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(12))
                .itemOutputs(
                        Particle.getBaseParticle(Particle.GRAVITON),
                ...
                .duration(1 * MINUTES + 40 * SECONDS).eut(TierEU.RECIPE_UV).addTo(cyclotronRecipes);
        // Graviton Smash
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(15))
                .itemOutputs(Particle.getBaseParticle(Particle.GRAVITON), Particle.getBaseParticle(Particle.UNKNOWN))
                .outputChances(1000, 100).fluidInputs(FluidUtils.getFluidStack("plasma.hydrogen", 100))
                .duration(1 * MINUTES + 30 * SECONDS).eut(TierEU.RECIPE_LuV).addTo(cyclotronRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.Laser_Lens_Special.get(1)).outputChances(100).fluidInputs(aPlasma)
                .duration(25 * SECONDS).eut(TierEU.RECIPE_UV).addTo(cyclotronRecipes);
        ...
        for (String y : IonParticles.MetaToNameMap.values()) {
            ...
            if (recipePlasma != null && !recipePlasma.isFluidEqual(aPlasma_NULL)) {
                GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1 + (tenCountA - 1)))
                        .itemOutputs(
                                Particle.getIon(y, 1),
                                Particle.getIon(y, 2),
                                Particle.getIon(y, 3),
                                ...
                                Particle.getIon(y, 2),
                                Particle.getIon(y, -1))
                        .outputChances(275, 250, 225, 275, 250, 225, 275, 250, 275).fluidInputs(recipePlasma)
                        .duration(20 * SECONDS * (IonCount++) * tenCountA).eut(TierEU.RECIPE_ZPM)
                        .addTo(cyclotronRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(24))
                ...
                .fluidInputs(Materials.Hydrogen.getGas(1_000)).duration(20 * SECONDS).eut(TierEU.RECIPE_LuV)
                .addTo(cyclotronRecipes);
        // Generate Hydrogen Plasma Recipe
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(21), Particle.getIon("Hydrogen", 0))
                .itemOutputs(
                        Particle.getBaseParticle(Particle.PROTON),
                        Particle.getBaseParticle(Particle.NEUTRON),
                        Particle.getBaseParticle(Particle.ELECTRON),
                        ...
                        Particle.getBaseParticle(Particle.UNKNOWN),
                        Particle.getBaseParticle(Particle.UNKNOWN))
                .outputChances(1250, 1250, 1250, 750, 750, 750).fluidInputs(Materials.Hydrogen.getGas(1_000))
                .fluidOutputs(FluidUtils.getFluidStack("plasma.hydrogen", 100)).duration(2 * MINUTES)
                .eut(TierEU.RECIPE_LuV).addTo(cyclotronRecipes);
        // Generate Protons Easily
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(20), Particle.getIon("Hydrogen", 0))
                .itemOutputs(
                        Particle.getBaseParticle(Particle.PROTON),
                        Particle.getBaseParticle(Particle.PROTON),
                        Particle.getBaseParticle(Particle.PROTON),
                        ...
                        Particle.getBaseParticle(Particle.PROTON),
                        Particle.getBaseParticle(Particle.PROTON))
                .outputChances(750, 750, 750, 750, 750, 750, 750, 750, 750).fluidInputs(Materials.Hydrogen.getGas(100))
                .duration(20 * SECONDS).eut(TierEU.RECIPE_LuV).addTo(cyclotronRecipes);
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                        ...
                        Particle.getBaseParticle(Particle.PROTON),
                        Particle.getBaseParticle(Particle.PROTON))
                .outputChances(375, 375, 375, 375, 375, 375, 375, 375, 375).fluidInputs(Materials.Hydrogen.getGas(100))
                .duration(20 * SECONDS).eut(TierEU.RECIPE_LuV).addTo(cyclotronRecipes);
        // Create Strange Dust
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        Particle.getBaseParticle(Particle.UNKNOWN),
                        Particle.getBaseParticle(Particle.UNKNOWN))
                .itemOutputs(MaterialsOres.DEEP_EARTH_REACTOR_FUEL_DEPOSIT.getDust(1)).outputChances(2500)
                .fluidInputs(new FluidStack(TFFluids.fluidEnder, 1_000)).duration(15 * MINUTES).eut(TierEU.RECIPE_ZPM)
                .addTo(cyclotronRecipes);
