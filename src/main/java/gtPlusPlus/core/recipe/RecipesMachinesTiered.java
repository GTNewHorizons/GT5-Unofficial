...
public class RecipesMachinesTiered {
    ...
    private static void wirelessChargers() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.AdvancedNitinol, Materials2Shapes.plate, 4),
                Circuits.UV.get(2))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.AbyssalAlloy, Materials2Shapes.plate, 4),
                Circuits.UHV.get(2))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Quantum, Materials2Shapes.plate, 4),
                Circuits.UEV.get(2))
    ...
    private static void energyCores() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ItemList.Hull_LV.get(1),
                MaterialLibAPI.getStack(Materials.Tumbaga, Materials2Shapes.plate, 4),
                GTOreDictUnificator.get(OrePrefixes.cableGt04, Materials.Tin, 2),
                Circuits.LV.get(2),
                MaterialLibAPI.getStack(Materials.Tumbaga, Materials2Shapes.screw, 6),
                MaterialLibAPI.getStack(Materials.Lead, Materials2Shapes.bolt, (int) (12)))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.MV.get(2),
                MaterialLibAPI.getStack(Materials.EglinSteel, Materials2Shapes.screw, 6),
                MaterialLibAPI.getStack(Materials.Aluminium, Materials2Shapes.bolt, (int) (12)))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.HV.get(2),
                MaterialLibAPI.getStack(Materials.TantalumCarbide, Materials2Shapes.screw, 6),
                MaterialLibAPI.getStack(Materials.BlackMetal, Materials2Shapes.bolt, 12))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.EV.get(2),
                MaterialLibAPI.getStack(Materials.IncoloyDS, Materials2Shapes.screw, 6),
                MaterialLibAPI.getStack(Materials.Titanium, Materials2Shapes.bolt, (int) (12)))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.IV.get(2),
                MaterialLibAPI.getStack(Materials.Inconel625, Materials2Shapes.screw, 6),
                MaterialLibAPI.getStack(Materials.HastelloyN, Materials2Shapes.bolt, 12))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.LuV.get(2),
                MaterialLibAPI.getStack(Materials.Zeron100, Materials2Shapes.screw, 6),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.ZPM.get(2),
                MaterialLibAPI.getStack(Materials.Pikyonium64B, Materials2Shapes.screw, 6),
                MaterialLibAPI.getStack(Materials.TriniumNaquadahCarbonite, Materials2Shapes.bolt, 12))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.UV.get(2),
                MaterialLibAPI.getStack(Materials.Titansteel, Materials2Shapes.screw, 6),
                MaterialLibAPI.getStack(Materials.ArceusAlloy2B, Materials2Shapes.bolt, 12))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.UHV.get(2),
                MaterialLibAPI.getStack(Materials.AbyssalAlloy, Materials2Shapes.screw, 6),
                MaterialLibAPI.getStack(Materials.Titansteel, Materials2Shapes.bolt, 12))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.UEV.get(2),
                MaterialLibAPI.getStack(Materials.Quantum, Materials2Shapes.screw, 6),
                MaterialLibAPI.getStack(Materials.AstralTitanium, Materials2Shapes.bolt, 12))
    ...
    private static void energyBuffers() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Tumbaga, Materials2Shapes.plate, 8),
                GTOreDictUnificator.get(OrePrefixes.wireGt08, Materials.Tin, 4),
                Circuits.ULV.get(4),
                MaterialLibAPI.getStack(Materials.SiliconCarbide, Materials2Shapes.stickLong, 4),
                MaterialLibAPI.getStack(Materials.Potin, Materials2Shapes.gearGt, 5))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.LV.get(4),
                MaterialLibAPI.getStack(Materials.BloodSteel, Materials2Shapes.stickLong, 4),
                MaterialLibAPI.getStack(Materials.Tumbaga, Materials2Shapes.gearGt, 5))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.TantalumCarbide, Materials2Shapes.plate, 8),
                GTOreDictUnificator.get(OrePrefixes.wireGt08, Materials.AnnealedCopper, 4),
                Circuits.MV.get(4),
                MaterialLibAPI.getStack(Materials.TantalumCarbide, Materials2Shapes.stickLong, 4),
                MaterialLibAPI.getStack(Materials.EglinSteel, Materials2Shapes.gearGt, 5))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.HV.get(4),
                MaterialLibAPI.getStack(Materials.Inconel792, Materials2Shapes.stickLong, 4),
                MaterialLibAPI.getStack(Materials.TantalumCarbide, Materials2Shapes.gearGt, 5))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.EV.get(4),
                MaterialLibAPI.getStack(Materials.Arcanite, Materials2Shapes.stickLong, 4),
                MaterialLibAPI.getStack(Materials.IncoloyDS, Materials2Shapes.gearGt, 5))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.IV.get(4),
                MaterialLibAPI.getStack(Materials.LafiumCompound, Materials2Shapes.stickLong, 4),
                MaterialLibAPI.getStack(Materials.Inconel625, Materials2Shapes.gearGt, 5))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.LuV.get(4),
                MaterialLibAPI.getStack(Materials.CinobiteA243, Materials2Shapes.stickLong, 4),
                MaterialLibAPI.getStack(Materials.Zeron100, Materials2Shapes.gearGt, 5))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.AdvancedNitinol, Materials2Shapes.plate, 8),
                GTOreDictUnificator.get(OrePrefixes.wireGt08, Materials.YttriumBariumCuprate, 4),
                Circuits.ZPM.get(4),
                MaterialLibAPI.getStack(Materials.Titansteel, Materials2Shapes.stickLong, 4),
                MaterialLibAPI.getStack(Materials.Pikyonium64B, Materials2Shapes.gearGt, 5))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.AbyssalAlloy, Materials2Shapes.plate, 8),
                GTOreDictUnificator.get(OrePrefixes.wireGt08, Materials.Naquadah, 4),
                Circuits.UV.get(4),
                MaterialLibAPI.getStack(Materials.Octiron, Materials2Shapes.stickLong, 4),
                MaterialLibAPI.getStack(Materials.Titansteel, Materials2Shapes.gearGt, 5))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Quantum, Materials2Shapes.plate, 8),
                ...
                MaterialLibAPI.getStack(Materials.AbyssalAlloy, Materials2Shapes.gearGt, 5))
    ...
    private static void integralCasings() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Potin, Materials2Shapes.plate, 8),
                MaterialLibAPI.getStack(Materials.Potin, Materials2Shapes.gearGt, 2),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Tumbaga, Materials2Shapes.plate, 8),
                MaterialLibAPI.getStack(Materials.Tumbaga, Materials2Shapes.gearGt, 2),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.EglinSteel, Materials2Shapes.plate, 8),
                MaterialLibAPI.getStack(Materials.EglinSteel, Materials2Shapes.gearGt, 2),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.TantalumCarbide, Materials2Shapes.plate, 8),
                MaterialLibAPI.getStack(Materials.TantalumCarbide, Materials2Shapes.gearGt, 2),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.IncoloyDS, Materials2Shapes.plate, 8),
                MaterialLibAPI.getStack(Materials.IncoloyDS, Materials2Shapes.gearGt, 2),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Inconel625, Materials2Shapes.plate, 8),
                MaterialLibAPI.getStack(Materials.Inconel625, Materials2Shapes.gearGt, 2),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.AdvancedNitinol, Materials2Shapes.plate, 8),
                MaterialLibAPI.getStack(Materials.Titansteel, Materials2Shapes.gearGt, 2),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.AbyssalAlloy, Materials2Shapes.plate, 8),
                MaterialLibAPI.getStack(Materials.AbyssalAlloy, Materials2Shapes.gearGt, 2),
    ...
    private static void modulators() {
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "CPC", "PHP", "CPC", 'C', "circuitElite", 'P',
                MaterialLibAPI.getStack(Materials.Inconel625, Materials2Shapes.plate, 1), 'H',
                ItemList.Casing_IV });
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "CPC", "PHP", "CPC", 'C', "circuitMaster", 'P',
                MaterialLibAPI.getStack(Materials.Zeron100, Materials2Shapes.plate, 1), 'H',
                ItemList.Casing_LuV });
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "CPC", "PHP", "CPC", 'C', "circuitUltimate", 'P',
                MaterialLibAPI.getStack(Materials.Pikyonium64B, Materials2Shapes.plate, 1), 'H',
                ItemList.Casing_ZPM });
    }
    ...
    private static void resonanceChambers() {
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "PFP", "FHF", "PFP", 'P',
                MaterialLibAPI.getStack(Materials.IncoloyDS, Materials2Shapes.plateDouble, 1), 'F',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            GTModHandler.RecipeBits.BUFFERED,
            new Object[] { "PFP", "FHF", "PFP", 'P',
                MaterialLibAPI.getStack(Materials.Inconel625, Materials2Shapes.plateDouble, 1), 'F',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            GTModHandler.RecipeBits.BUFFERED,
            new Object[] { "PFP", "FHF", "PFP", 'P',
                MaterialLibAPI.getStack(Materials.Zeron100, Materials2Shapes.plateDouble, 1), 'F',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            GTModHandler.RecipeBits.BUFFERED,
            new Object[] { "PFP", "FHF", "PFP", 'P',
                MaterialLibAPI.getStack(Materials.Pikyonium64B, Materials2Shapes.plateDouble, 1), 'F',
    ...
    private static void autoWorkbenches() {
        ...
        GTModHandler.addCraftingRecipe(
            ...
            GTModHandler.RecipeBits.BUFFERED,
            new Object[] { "PCP", "IHI", "PRP", 'P', OrePrefixes.plate.ingredient(Materials.StainlessSteel),
        ...
        GTModHandler.addCraftingRecipe(
            ...
            GTModHandler.RecipeBits.BUFFERED,
            new Object[] { "PCP", "IHI", "PRP", 'P', OrePrefixes.plate.ingredient(Materials.TungstenSteel),
    ...
    private static void chiselBuses() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Aluminium, Materials2Shapes.bolt, (int) (16)),
                new ItemStack(Blocks.chest))
            .circuit(17)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.BlackMetal, Materials2Shapes.bolt, 16),
                new ItemStack(Blocks.chest))
            .circuit(17)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Titanium, Materials2Shapes.bolt, (int) (16)),
                new ItemStack(Blocks.chest))
            .circuit(17)
    ...
    private static void semifluidGenerators() {
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "PCP", "EME", "GWG", 'M', ItemList.Hull_HV, 'P', ItemList.Electric_Piston_HV, 'E',
                ...
                MaterialLibAPI.getStack(Materials.Chrome, Materials2Shapes.gearGt, (int) (1)) });
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.HV.get(1),
                MaterialLibAPI.getStack(Materials.Chrome, Materials2Shapes.gearGt, (int) (2)))
            .circuit(14)
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "PCP", "EME", "GWG", 'M', ItemList.Hull_EV, 'P', ItemList.Electric_Piston_EV, 'E',
                ...
                MaterialLibAPI.getStack(Materials.IncoloyDS, Materials2Shapes.gearGt, 1) });
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "PCP", "EME", "GWG", 'M', ItemList.Hull_IV, 'P', ItemList.Electric_Piston_IV, 'E',
                ...
                MaterialLibAPI.getStack(Materials.Nitinol60, Materials2Shapes.gearGt, 1) });
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                Circuits.IV.get(1),
                MaterialLibAPI.getStack(Materials.Nitinol60, Materials2Shapes.gearGt, 2))
            .circuit(14)
    ...
    private static void simpleWashers() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ItemList.Hull_LV.get(1),
                MaterialLibAPI.getStack(Materials.Tumbaga, Materials2Shapes.screw, 4),
                MaterialLibAPI.getStack(Materials.Potin, Materials2Shapes.plate, 2),
                MaterialLibAPI.getStack(Materials.Tumbaga, Materials2Shapes.stick, 1),
                Circuits.LV.get(1))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.Tumbaga, Materials2Shapes.plate, 4),
                MaterialLibAPI.getStack(Materials.EglinSteel, Materials2Shapes.stick, 2),
                Circuits.MV.get(1))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ItemList.Hull_HV.get(1),
                MaterialLibAPI.getStack(Materials.TantalumCarbide, Materials2Shapes.screw, 12),
                MaterialLibAPI.getStack(Materials.EglinSteel, Materials2Shapes.plate, 6),
                MaterialLibAPI.getStack(Materials.TantalumCarbide, Materials2Shapes.stick, 3),
                Circuits.HV.get(1))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials.TantalumCarbide, Materials2Shapes.plate, 8),
                MaterialLibAPI.getStack(Materials.IncoloyDS, Materials2Shapes.stick, 4),
                Circuits.EV.get(1))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ItemList.Hull_IV.get(1),
                MaterialLibAPI.getStack(Materials.Inconel625, Materials2Shapes.screw, 20),
                MaterialLibAPI.getStack(Materials.IncoloyDS, Materials2Shapes.plate, 10),
                MaterialLibAPI.getStack(Materials.Inconel625, Materials2Shapes.stick, 5),
                Circuits.IV.get(1))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ItemList.Hull_LuV.get(1),
                MaterialLibAPI.getStack(Materials.Zeron100, Materials2Shapes.screw, 24),
                MaterialLibAPI.getStack(Materials.Inconel625, Materials2Shapes.plate, 12),
                MaterialLibAPI.getStack(Materials.Zeron100, Materials2Shapes.stick, 6),
                Circuits.LuV.get(1))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ItemList.Hull_ZPM.get(1),
                MaterialLibAPI.getStack(Materials.Pikyonium64B, Materials2Shapes.screw, 28),
                MaterialLibAPI.getStack(Materials.Zeron100, Materials2Shapes.plate, 14),
                MaterialLibAPI.getStack(Materials.Pikyonium64B, Materials2Shapes.stick, 7),
                Circuits.ZPM.get(1))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ItemList.Hull_UV.get(1),
                MaterialLibAPI.getStack(Materials.Titansteel, Materials2Shapes.screw, 32),
                MaterialLibAPI.getStack(Materials.Pikyonium64B, Materials2Shapes.plate, 16),
                MaterialLibAPI.getStack(Materials.Titansteel, Materials2Shapes.stick, 8),
                Circuits.UV.get(1))
    ...
    private static void airFilters() {
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "PFP", "PMP", "CHC", 'P', GregtechItemList.AirFilter_Tier1, 'F',
                OrePrefixes.plate.ingredient(Materials.Tin), 'M', ItemList.Electric_Motor_LV, 'C',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            GTModHandler.RecipeBits.BUFFERED,
            new Object[] { "PFP", "PMP", "CHC", 'P', GregtechItemList.AirFilter_Tier1, 'F',
                OrePrefixes.plate.ingredient(Materials.Copper), 'M', ItemList.Electric_Motor_MV, 'C',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            GTModHandler.RecipeBits.BUFFERED,
            new Object[] { "PFP", "PMP", "CHC", 'P', GregtechItemList.AirFilter_Tier1, 'F',
                OrePrefixes.plate.ingredient(Materials.Bronze), 'M', ItemList.Electric_Motor_HV, 'C',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            GTModHandler.RecipeBits.BUFFERED,
            new Object[] { "PFP", "PMP", "CHC", 'P', GregtechItemList.AirFilter_Tier1, 'F',
                OrePrefixes.plate.ingredient(Materials.Iron), 'M', ItemList.Electric_Motor_EV, 'C',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "PFP", "PMP", "CHC", 'P', GregtechItemList.AirFilter_Tier2, 'F',
                OrePrefixes.plate.ingredient(Materials.Steel), 'M', ItemList.Electric_Motor_IV, 'C',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            GTModHandler.RecipeBits.BUFFERED,
            new Object[] { "PFP", "PMP", "CHC", 'P', GregtechItemList.AirFilter_Tier2, 'F',
                MaterialLibAPI.getStack(Materials.Zeron100, Materials2Shapes.plate, 1), 'M',
    ...
    private static void tanks() {
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "TST", "IPI", "IBI", 'T', OrePrefixes.plate.ingredient(Materials.Tin), 'S',
                OrePrefixes.plate.ingredient(Materials.Steel), 'I',
                OrePrefixes.plate.ingredient(Materials.Iron), 'P',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "SIS", "BPB", "BUB", 'S', OrePrefixes.plate.ingredient(Materials.Steel), 'I',
                OrePrefixes.plate.ingredient(Materials.Iron), 'B',
                OrePrefixes.plate.ingredient(Materials.Bronze), 'P',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "DBD", "SPS", "SUS", 'D', OrePrefixes.plate.ingredient(Materials.DarkSteel), 'B',
                OrePrefixes.plate.ingredient(Materials.Bronze), 'S',
                OrePrefixes.plate.ingredient(Materials.Steel), 'P',
