...
public class RecipesSeleniumProcessing {
    ...
    public static void init() {
        ...
        GTValues.RA.stdBuilder().itemInputs(MaterialMisc.SELENIUM_DIOXIDE.getDust(1))
                .fluidInputs(Materials.Steam.getGas(500))
                .fluidOutputs(MaterialMisc.SELENIUM_DIOXIDE.getFluidStack(1_000)).duration(24 * SECONDS).eut(1024)
                .addTo(cokeOvenRecipes);

        // Produce Selenious Acid
        GTValues.RA.stdBuilder()
                .fluidInputs(FluidUtils.getHotWater(4_000), MaterialMisc.SELENIUM_DIOXIDE.getFluidStack(1_000))
                .fluidOutputs(MaterialMisc.SELENIOUS_ACID.getFluidStack(1_000)).duration(24 * SECONDS)
                .eut(TierEU.RECIPE_EV).addTo(cokeOvenRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .eut(TierEU.RECIPE_IV).duration(5 * MINUTES).addTo(alloyBlastSmelterRecipes);
    }
    ...
    public static void processCopperRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .outputChances(100_00, 3_00).fluidInputs(FluidUtils.getHotWater(1_000))
                .fluidOutputs(MaterialMisc.SELENIUM_DIOXIDE.getFluidStack(20)).eut(1024).duration(40 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                        ...
                        MaterialMisc.SELENIUM_DIOXIDE.getDust(1))
                .outputChances(100_00, 2_50).fluidInputs(FluidUtils.getHotWater(1_000))
                .fluidOutputs(MaterialMisc.SELENIUM_DIOXIDE.getFluidStack(10)).eut(1024).duration(40 * SECONDS)
                .addTo(chemicalDehydratorRecipes);
