...
public class RecipesMachines {
    ...
    public static void loadRecipes() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Iron, Materials2FluidShapes.fluidMolten, (int) (4 * INGOTS)))
            .duration(30 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials2Materials.Lead, Materials2Shapes.plateDense, (int) (9)),
                new ItemStack(Blocks.chest))
            .itemOutputs(new ItemStack(ModBlocks.blockDecayablesChest))
            .fluidInputs(
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Lead, Materials2FluidShapes.fluidMolten, (int) (16 * INGOTS)))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials2Materials.Nitinol60, Materials2Shapes.plate, 8),
                MaterialLibAPI.getStack(Materials2Materials.MaragingSteel350, Materials2Shapes.gearGt, 4),
            ...
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.NiobiumCarbide, 16 * INGOTS))
            .duration(10 * MINUTES)
            .eut(TierEU.RECIPE_IV)
            .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                GTOreDictUnificator.get(OrePrefixes.pipeSmall, Materials2Materials.StainlessSteel, 2),
            ...
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.SiliconCarbide, 8 * INGOTS))
            .duration(60 * SECONDS)
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "PCP", "CEC", "PXP", 'P', OrePrefixes.plate.ingredient(Materials2Materials.Titanium), 'C',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            GTModHandler.RecipeBits.BUFFERED,
            new Object[] { "PCP", "CEC", "PHP", 'P', OrePrefixes.plate.ingredient(Materials2Materials.Titanium), 'C',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            GTModHandler.RecipeBits.BUFFERED,
            new Object[] { "PCP", "PRP", "IHI", 'P', OrePrefixes.plate.ingredient(Materials2Materials.Redstone), 'C',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "PCP", "PRP", "IHI", 'P',
                MaterialLibAPI.getStack(Materials2Materials.Pikyonium64B, Materials2Shapes.plate, 1), 'C',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            GTModHandler.RecipeBits.BUFFERED,
            new Object[] { "PCP", "PRP", "IHI", 'P',
                MaterialLibAPI.getStack(Materials2Materials.Octiron, Materials2Shapes.plate, 1), 'C',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "PCP", "EME", "GWG", 'M', ItemList.Hull_EV, 'P', ItemList.Electric_Piston_EV, 'E',
                ...
                OrePrefixes.cableGt08.ingredient(Materials2Materials.Electrum), 'G',
                MaterialLibAPI.getStack(Materials2Materials.Inconel792, Materials2Shapes.gearGt, 1) });
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.Zeron100, 8 * INGOTS))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MU.stack(OrePrefixes.frameGt, Materials2Materials.TriniumNaquadahCarbonite, 4),
            ...
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.MaragingSteel350, 16 * INGOTS))
            .duration(5 * SECONDS)
            .eut(TierEU.RECIPE_LuV)
            .addTo(assemblerRecipes);
    }
