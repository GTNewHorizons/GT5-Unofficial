...
public class RecipesMachines {
    ...
    private static void advHeatExchanger() {
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.tieredMaterials[5].getMolten(8 * INGOTS)).duration(60 * SECONDS).eut(TierEU.RECIPE_LuV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.tieredMaterials[5].getMolten(2 * INGOTS)).duration(5 * SECONDS).eut(TierEU.RECIPE_LuV)
                .addTo(assemblerRecipes);
    ...
    private static void multiForgeHammer() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.getTieredFluid(4, 12 * INGOTS)).duration(30 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);

        GTModHandler.addCraftingRecipe(
                GregtechItemList.Casing_IndustrialForgeHammer.get(1),
                CI.bitsd,
                new Object[] { "IBI", "HCH", "IHI", 'I', CI.getPlate(4, 1), 'B',
    ...
    private static void multiMolecularTransformer() {
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.getTieredFluid(5, 16 * INGOTS)).duration(60 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.Controller_MolecularTransformer.get(1)).eut(TierEU.RECIPE_LuV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.getTieredFluid(5, 4 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTUtility.getIntegratedCircuit(16),
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.getTieredFluid(5, 4 * INGOTS)).duration(60 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
    ...
    private static void multiXlTurbines() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.tieredMaterials[3].getMolten(8 * INGOTS)).duration(60 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
        // Steam
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(Materials.Aluminium.getMolten(2 * INGOTS)).duration(5 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTUtility.getIntegratedCircuit(18),
                ...
                .fluidInputs(CI.tieredMaterials[4].getMolten(8 * INGOTS)).duration(60 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
        // Gas
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(CI.tieredMaterials[4].getMolten(2 * INGOTS)).duration(5 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTUtility.getIntegratedCircuit(18),
                ...
                .fluidInputs(CI.tieredMaterials[6].getMolten(8 * INGOTS)).duration(60 * SECONDS).eut(TierEU.RECIPE_LuV)
                .addTo(assemblerRecipes);
        // HP Steam
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(CI.tieredMaterials[3].getMolten(2 * INGOTS)).duration(5 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTUtility.getIntegratedCircuit(18),
                ...
                .fluidInputs(CI.tieredMaterials[5].getMolten(8 * INGOTS)).duration(60 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        // Plasma
        GTValues.RA.stdBuilder()
                .itemInputs(
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.tieredMaterials[7].getMolten(8 * INGOTS)).duration(60 * SECONDS).eut(TierEU.RECIPE_ZPM)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTUtility.getIntegratedCircuit(18),
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.adamantium alloy", 2 * INGOTS)).duration(5 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.hikarium", 8 * INGOTS)).duration(60 * SECONDS)
    ...
    private static void multiSolarTower() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.getTieredFluid(3, 16 * INGOTS)).duration(30 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTUtility.getIntegratedCircuit(17),
                ...
                .fluidInputs(CI.getTieredFluid(3, 4 * INGOTS)).duration(30 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTUtility.getIntegratedCircuit(17),
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.getAlternativeTieredFluid(3, 4 * INGOTS)).duration(30 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTUtility.getIntegratedCircuit(17),
                ...
                .fluidInputs(Materials.Titanium.getMolten(4 * INGOTS)).duration(60 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
    ...
    private static void multiElementalDuplicator() {
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Machine_IV_Replicator.get(1))
                ...
                .itemOutputs(GregtechItemList.Controller_ElementalDuplicator.get(1)).eut(TierEU.RECIPE_UV)
                .duration(60 * SECONDS).addTo(AssemblyLine);

        // Data Orb Repository
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, GregtechItemList.Modulator_III.get(1))
                ...
                .itemOutputs(GregtechItemList.Hatch_Input_Elemental_Duplicator.get(1)).eut(TierEU.RECIPE_LuV)
                .duration(60 * SECONDS).addTo(AssemblyLine);

        // Elemental Confinement Shell
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, GregtechItemList.ResonanceChamber_III.get(1))
                .metadata(SCANNING, new Scanning(1 * MINUTES + 30 * SECONDS, TierEU.RECIPE_LuV))
                .itemInputs(
                ...
                .itemOutputs(GregtechItemList.Casing_ElementalDuplicator.get(1)).eut(TierEU.RECIPE_ZPM)
    ...
    private static void zyngen() {
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.getAlternativeTieredFluid(4, 8 * INGOTS)).duration(30 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
    ...
    private static void chemPlant() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsAlloy.STEEL_BLACK.getFluidStack(8 * INGOTS)).duration(2 * MINUTES)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsAlloy.BRONZE.getFluidStack(8 * INGOTS)).duration(60 * SECONDS)
                .eut(TierEU.RECIPE_MV).addTo(assemblerRecipes);
    ...
    private static void algaeFarm() {
        ...
        GTValues.RA.stdBuilder().itemInputs(GregtechItemList.AlgaeBiomass.get(32))
                .itemOutputs(GregtechItemList.GreenAlgaeBiomass.get(4)).duration(15 * SECONDS).eut(16)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsAlloy.POTIN.getFluidStack(8 * INGOTS)).duration(60 * SECONDS)
                .eut(TierEU.RECIPE_MV).addTo(assemblerRecipes);
    ...
    private static void distillus() {
        GTValues.RA.stdBuilder()
                ...
                .duration(10 * MINUTES).eut(TierEU.RECIPE_LuV).metadata(CHEMPLANT_CASING_TIER, 5)
    ...
    private static void overflowValveCovers() {
        ...
        for (int tier = 1; tier < aOutputs.length + 1; tier++) {
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(Materials.SolderingAlloy.getMolten(tier * INGOTS)).duration(20 * SECONDS)
                    .eut(voltageTiers[tier - 1]).addTo(assemblerRecipes);
    ...
    private static void tieredMachineHulls() {
        ...
        for (int i = 0; i < 10; i++) {
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(aHulls[i].get(1)).fluidInputs(CI.getAlternativeTieredFluid(i, 2 * (i + 1) * INGOTS))
                    .duration(20 * SECONDS).eut(voltageTiers[i]).addTo(assemblerRecipes);
    ...
    private static void runModRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsElements.getInstance().TANTALUM.getFluidStack(16 * INGOTS)).duration(3 * MINUTES)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsElements.getInstance().IRON.getFluidStack(4 * INGOTS)).duration(30 * SECONDS)
        ...
        for (ItemStack plateRubber : OreDictionary.getOres("plateAnyRubber")) {
            GTValues.RA.stdBuilder()
                    ...
                    .duration(1 * MINUTES + 30 * SECONDS).eut(60).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsAlloy.NIOBIUM_CARBIDE.getFluidStack(16 * INGOTS)).duration(10 * MINUTES)
                .eut(TierEU.RECIPE_IV).addTo(assemblerRecipes);
        // Super Jukebox
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(MaterialsElements.getInstance().COPPER.getFluidStack(2 * INGOTS)).duration(30 * SECONDS)
                .eut(TierEU.RECIPE_LV).addTo(assemblerRecipes);
        // Poo Collector
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(MaterialsAlloy.TUMBAGA.getFluidStack(4 * INGOTS)).duration(60 * SECONDS)
                .eut(TierEU.RECIPE_LV).addTo(assemblerRecipes);
        // Adv. Poo Collector
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(CI.getAlternativeTieredFluid(5, 9 * INGOTS)).duration(5 * MINUTES).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.getAlternativeTieredFluid(1, 8 * INGOTS)).duration(60 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(RECIPE_IndustrialCentrifugeCasing).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(RECIPE_IndustrialCokeOvenFrame).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.Casing_Machine_Custom_2.get(2)).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(RECIPE_IndustrialElectrolyzerFrame).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        MaterialsAlloy.TUMBAGA.getFrameBox(1),
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(RECIPE_IndustrialMaterialPressFrame).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(RECIPE_IndustrialMacerationStackFrame).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(RECIPE_IndustrialWireFactoryFrame).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Plastic.getMolten(1 * INGOTS)).duration(30 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Plastic.getMolten(1 * INGOTS)).duration(30 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Plastic.getMolten(1 * INGOTS)).duration(30 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Plastic.getMolten(1 * INGOTS)).duration(30 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Polytetrafluoroethylene.getMolten(1 * INGOTS)).duration(30 * SECONDS)
                .eut(TierEU.RECIPE_IV).addTo(assemblerRecipes);
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "PCP", "EME", "GWG", 'M', ItemList.Hull_MV, 'P', ItemList.Electric_Piston_MV, 'E',
                        ...
                        OrePrefixes.cableGt01.get(Materials.AnnealedCopper), 'G',
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(RECIPE_IndustrialBlastSmelterFrame).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        CI.gearboxCasing_Tier_3,
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(RECIPE_IndustrialBlastSmelterCoil).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsAlloy.QUANTUM.getFluidStack(4 * INGOTS)).duration(1 * MINUTES + 30 * SECONDS)
                .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(RECIPE_IndustrialMatterFabFrame).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(RECIPE_IndustrialMatterFabCoil).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        MaterialsAlloy.TUMBAGA.getFrameBox(1),
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(RECIPE_IndustrialSieveFrame).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(RECIPE_IndustrialSieveGrate).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(RECIPE_TreeFarmFrame).fluidInputs(GTModHandler.getDistilledWater(2_000))
        ...
        for (int i = 0; i < washers.size(); i++) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(washers.get(i)).fluidInputs(CI.getTieredFluid(tier, tier * INGOTS))
                    .duration(20 * 5 * tier).eut(GTValues.VP[tier]).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(new ItemStack(ModItems.itemLavaFilter, 16)).fluidInputs(CI.getTieredFluid(3, 1 * INGOTS))
                .duration(1 * MINUTES + 20 * SECONDS).eut(240).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        ItemList.Field_Generator_LV.get(1))
                .itemOutputs(RECIPE_LFTRInnerCasing).duration(5 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(controlCircuit).duration(4 * MINUTES).eut(TierEU.RECIPE_HV).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.Casing_Refinery_External.get(1)).duration(5 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsAlloy.ZIRCONIUM_CARBIDE.getFluidStack(8 * INGOTS)).duration(60 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(RECIPE_CyclotronInnerCoil).fluidInputs(MaterialsAlloy.HG1223.getFluidStack(5 * INGOTS))
                .duration(2 * MINUTES).eut(TierEU.RECIPE_IV).addTo(assemblerRecipes);
        // Controller
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ItemList.Hull_IV.get(1),
                ...
                .fluidInputs(MaterialsAlloy.INCOLOY_020.getFluidStack(9 * INGOTS)).duration(5 * MINUTES)
                .eut(TierEU.RECIPE_IV).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GregtechItemList.Casing_ThermalCentrifuge.get(1L)).duration(2 * SECONDS + 10 * TICKS)
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GregtechItemList.Casing_WashPlant.get(1L)).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.getTertiaryTieredFluid(6, 4 * INGOTS)).duration(2 * MINUTES).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GregtechItemList.Gregtech_Computer_Cube.get(1))
                .itemOutputs(GregtechItemList.GT4_Multi_Crafter.get(1)).fluidInputs(CI.getTieredFluid(7, 8 * INGOTS))
                .duration(5 * MINUTES).eut(TierEU.RECIPE_IV).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GregtechItemList.Casing_Multi_Use.get(1),
                        CI.getEmitter(4, 2),
                ...
                .fluidInputs(CI.getAlternativeTieredFluid(5, 4 * INGOTS)).duration(1 * MINUTES + 30 * SECONDS)
                .eut(TierEU.RECIPE_EV).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GregtechItemList.Casing_CuttingFactoryFrame.get(1L)).duration(2 * SECONDS + 10 * TICKS)
                .eut(16).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GregtechItemList.Casing_Extruder.get(1L)).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GregtechItemList.Casing_FishPond.get(1L)).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GregtechItemList.Hatch_Input_Pyrotheum.get(1L)).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GregtechItemList.Casing_Adv_BlastFurnace.get(1L)).duration(2 * SECONDS + 10 * TICKS)
                .eut(16).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.Casing_AmazonWarehouse.get(1L)).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        MaterialsAlloy.ZIRCONIUM_CARBIDE.getFrameBox(1),
                        GTUtility.getIntegratedCircuit(1))
                .itemOutputs(GregtechItemList.Casing_Multi_Use.get(1L)).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsAlloy.MARAGING350.getFluidStack(16 * INGOTS)).duration((int) GTValues.V[4])
                .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
        ...
        if (RemoteIO.isModLoaded()) {
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(GregtechItemList.Hatch_Reservoir.get(1)).duration(5 * SECONDS).eut(TierEU.RECIPE_EV)
                    .addTo(assemblerRecipes);
        }
        // Mystic Frame
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.getTieredFluid(6, (8 * INGOTS))).duration(4 * MINUTES + 30 * SECONDS)
                .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
    ...
    private static void energyCores() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(aOutput[i]).fluidInputs(CI.getTieredFluid(i, (aTier * 4 * INGOTS)))
                    .duration(45 * 10 * 1 * (aTier)).eut(voltageTiers[i]).addTo(assemblerRecipes);
            // Energy Buffer
            GTValues.RA.stdBuilder()
                    .itemInputs(
                    ...
                    .itemOutputs(aBufferOutput[i]).fluidInputs(CI.getTieredFluid(aTier, (16 * INGOTS * aTier)))
                    .duration(45 * 20 * 1 * (aTier)).eut(voltageTiers[i]).addTo(assemblerRecipes);
    ...
    private static void wirelessChargers() {
        ...
        for (int tier = 1; tier < aChargers.length + 1; tier++) {
            ...
            GTValues.RA.stdBuilder().itemInputs(aInputs).itemOutputs(aChargers[tier - 1])
                    .fluidInputs(CI.getAlternativeTieredFluid(tier, (2 * INGOTS * (tier + 1))))
                    .duration(45 * 10 * (tier + 1)).eut(voltageTiers[tier]).addTo(assemblerRecipes);
    ...
    private static void largeArcFurnace() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.getAlternativeTieredFluid(5, 8 * INGOTS)).duration(60 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(CI.getAlternativeTieredFluid(6, 20 * INGOTS)).duration(8 * MINUTES).eut(TierEU.RECIPE_LuV)
                .addTo(assemblerRecipes);
    ...
    private static void industrialVacuumFurnace() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.getTertiaryTieredFluid(5, 8 * INGOTS)).duration(60 * SECONDS).eut(TierEU.RECIPE_LuV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(CI.getTieredFluid(6, 20 * INGOTS)).duration(12 * MINUTES).eut(TierEU.RECIPE_LuV)
                .addTo(assemblerRecipes);
    ...
    private static void milling() {
        ...
        // Isa Mill Controller
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Machine_IV_Macerator.get(1))
                ...
                .itemOutputs(GregtechItemList.Controller_IsaMill.get(1)).eut(TierEU.RECIPE_LuV).duration(10 * MINUTES)
                .addTo(AssemblyLine);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsAlloy.TUNGSTENSTEEL.getFluidStack(8 * INGOTS)).duration(2 * MINUTES)
                .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
        // Isa Mill Casing
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(MaterialsElements.getInstance().TITANIUM.getFluidStack(4 * INGOTS)).duration(2 * MINUTES)
                .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
        // Isa Mill Pipe
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(MaterialsElements.getInstance().ALUMINIUM.getFluidStack(8 * INGOTS)).duration(8 * MINUTES)
                .eut(TierEU.RECIPE_EV).addTo(assemblerRecipes);

        // Flotation Cell Controller
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Distillation_Tower.get(1))
                .metadata(SCANNING, new Scanning(40 * SECONDS, TierEU.RECIPE_IV))
                .itemInputs(
                ...
                .itemOutputs(GregtechItemList.Controller_Flotation_Cell.get(1)).eut(TierEU.RECIPE_LuV)
                .duration(60 * SECONDS).addTo(AssemblyLine);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsAlloy.STAINLESS_STEEL.getFluidStack(8 * INGOTS)).duration(2 * MINUTES)
                .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
        // Milling Bus
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(MaterialsElements.getInstance().TUNGSTEN.getFluidStack(8 * INGOTS)).duration(4 * MINUTES)
                .eut(TierEU.RECIPE_IV).addTo(assemblerRecipes);
    ...
    private static void sparging() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.Controller_Sparge_Tower.get(1)).eut(TierEU.RECIPE_LuV)
                .duration(60 * SECONDS).addTo(AssemblyLine);
    ...
    private static void chisels() {
        ...
        for (int i = 1; i < 4; i++) {
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            CI.getConveyor(i, 2),
                            CI.getRobotArm(i, 1))
                    .itemOutputs(aChisels[i - 1]).fluidInputs(CI.getTieredFluid(i, 4 * INGOTS)).duration(20 * SECONDS)
                    .eut(voltageTiers[i - 1]).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(CI.getTieredFluid(4, 8 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTUtility.getIntegratedCircuit(14),
                ...
                .fluidInputs(CI.getTieredFluid(2, 2 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
    ...
    private static void rockBreaker() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsElements.getInstance().ALUMINIUM.getFluidStack(8 * INGOTS)).duration(2 * MINUTES)
                .eut(TierEU.RECIPE_EV).addTo(assemblerRecipes);
    ...
    private static void fakeMachineCasingCovers() {
        ...
        for (int i = 0; i < aMaxTier - 1; i++) {
            GTValues.RA.stdBuilder().itemInputs(CI.getTieredMachineCasing(i), GTUtility.getIntegratedCircuit(i))
                    .itemOutputs(aTier[i]).duration(i * 5 * SECONDS).eut(GTValues.VP[i]).addTo(cutterRecipes);
        }
    }
    ...
    private static void superBuses() {
        ...
        for (int tier = 1; tier < mSuperBusesInput.length + 1; tier++) {
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(CI.getAlternativeTieredFluid(tier, 8 * INGOTS)).duration(60 * SECONDS)
                    .eut(GTValues.VP[tier]).addTo(assemblerRecipes);
        ...
        for (int tier = 1; tier < mSuperBusesOutput.length + 1; tier++) {
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(CI.getTertiaryTieredFluid(tier, 8 * INGOTS)).duration(60 * SECONDS)
                    .eut(GTValues.VP[tier]).addTo(assemblerRecipes);
        ...
        for (int tier = 1; tier < mChiselBuses.length + 1; tier++) {
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            CI.getBolt(tier, 16),
                            new ItemStack(Blocks.chest))
                    .itemOutputs(mChiselBuses[tier - 1]).fluidInputs(CI.getAlternativeTieredFluid(tier, 2 * INGOTS))
                    .duration(60 * SECONDS).eut(GTValues.VP[tier + 1]).addTo(assemblerRecipes);
        ...
        for (int i = 0; i < 4; i++) {
            ...
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            new ItemStack(Blocks.chest))
                    .itemOutputs(mSolidifierHatches[i]).fluidInputs(CI.getTieredFluid(componentTier, 2 * INGOTS))
                    .duration(30 * SECONDS).eut(GTValues.VP[componentTier]).addTo(assemblerRecipes);
