...
public class FluidUtils {
    ...
    public static Fluid addGTPlasma(final Material aMaterial) {
        ...
        if (temp != null) {
            return addGTFluid(
                    "plasma." + StringUtils.sanitizeString(aMaterial.getLocalizedName().toLowerCase()),
    ...
    public static Fluid addGTFluid(String aName, final String aTexture, final String aLocalized, final short[] aRGBa,
        ...
        if ((aFullContainer != null) && (aEmptyContainer != null)
                && !FluidContainerRegistry.registerFluidContainer(
                        ...
                        aFullContainer,
                        aEmptyContainer)) {
            GTValues.RA.stdBuilder().itemInputs(ItemList.Cell_Empty.get(1L)).itemOutputs(aFullContainer)
