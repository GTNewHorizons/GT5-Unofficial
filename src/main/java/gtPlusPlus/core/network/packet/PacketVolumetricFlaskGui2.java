...
public class PacketVolumetricFlaskGui2 extends AbstractClientMessageHandler<PacketVolumetricFlaskGui2>
    ...
    public PacketVolumetricFlaskGui2() {}

    public PacketVolumetricFlaskGui2(TileEntityVolumetricFlaskSetter tile, int aCustomValue) {
        x = tile.xCoord;
        y = tile.yCoord;
        z = tile.zCoord;
    ...
    protected TileEntityVolumetricFlaskSetter getTileEntity(PacketVolumetricFlaskGui2 message, MessageContext ctx) {
    ...
    @Override
    public IMessage handleClientMessage(EntityPlayer player, PacketVolumetricFlaskGui2 message, MessageContext ctx) {
