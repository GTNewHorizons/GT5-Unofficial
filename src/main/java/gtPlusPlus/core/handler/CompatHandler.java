...
import gregtech.loaders.oreprocessing.ProcessingAlloySmelterGtpp;
import gregtech.loaders.oreprocessing.ProcessingAssemblerGtpp;
import gregtech.loaders.oreprocessing.ProcessingDustGeneration;
import gregtech.loaders.oreprocessing.ProcessingExtruderGtpp;
import gregtech.loaders.oreprocessing.ProcessingFluidSolidifierGtpp;
import gregtech.loaders.oreprocessing.ProcessingInfusedStonesGtpp;
import gregtech.loaders.oreprocessing.ProcessingMaterialDecompositionGtpp;
import gregtech.loaders.oreprocessing.ProcessingNuclearDehydratorGtpp;
import gregtech.loaders.oreprocessing.ProcessingOreCrafting;
import gregtech.loaders.oreprocessing.ProcessingOreMachine;
import gregtech.loaders.oreprocessing.ProcessingPlasmaGtpp;
import gregtech.loaders.oreprocessing.ProcessingRecyclingGtpp;
import gregtech.loaders.oreprocessing.ProcessingShapedCraftingGtpp;
...
public class CompatHandler {
    ...
    public static void startLoadingGregAPIBasedRecipes() {
        ...
        ProcessingInfusedStonesGtpp.run();
        ProcessingOreCrafting.run();
        ProcessingOreMachine.run();
        ProcessingAlloySmelterGtpp.run();
        ProcessingAssemblerGtpp.run();
        ProcessingExtruderGtpp.run();
        ProcessingFluidSolidifierGtpp.run();
        ProcessingShapedCraftingGtpp.run();
        ProcessingMaterialDecompositionGtpp.run();
        ProcessingNuclearDehydratorGtpp.run();
        ProcessingPlasmaGtpp.run();
        ProcessingRecyclingGtpp.run();
    }
}
