...
public class ContainerSuperJukebox extends Container {

    protected TileEntitySuperJukebox tile_entity;
    public final InventorySuperJukebox inventoryChest;
    ...
    public ContainerSuperJukebox(final InventoryPlayer inventory, final TileEntitySuperJukebox te) {
        this.tile_entity = te;
    ...
    public void detectAndSendChanges() {
        ...
        for (ICrafting crafter : this.crafters) {
            crafter.sendProgressBarUpdate(this, 102, isPlaying ? 1 : 0);
            crafter.sendProgressBarUpdate(this, 103, isLooping ? 1 : 0);
        }
    }
