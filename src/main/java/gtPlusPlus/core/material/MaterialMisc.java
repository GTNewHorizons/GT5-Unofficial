...
public final class MaterialMisc {
    ...
    public static final Material RARE_EARTH_MID = new Material(
        ...
        new MaterialStack[] { new MaterialStack(MaterialsOres.LANTHANITE_ND, 1),
            ...
            new MaterialStack(MaterialsOres.ZIRCON, 1),
            new MaterialStack(MaterialUtils.generateMaterialFromGtENUM(Materials.AncientGranite), 1),
            new MaterialStack(MaterialUtils.generateMaterialFromGtENUM(Materials.BlackMetal), 1),
            new MaterialStack(MaterialUtils.generateMaterialFromGtENUM(Materials.Runite), 1) });
