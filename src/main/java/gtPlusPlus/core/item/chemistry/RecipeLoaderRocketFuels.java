...
public class RecipeLoaderRocketFuels {
    ...
    private static void createKerosene() {
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(23))
                .fluidInputs(Materials.Fuel.getFluid(250)).fluidOutputs(new FluidStack(GTPPFluids.Kerosene, 150))
                .duration(16 * TICKS).eut(TierEU.RECIPE_MV / 2).addTo(distilleryRecipes);
    }

    private static void createRP1() {
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(23))
                .fluidInputs(new FluidStack(GTPPFluids.Kerosene, 20)).fluidOutputs(new FluidStack(GTPPFluids.RP1, 15))
                .duration(16 * TICKS).eut(TierEU.RECIPE_MV).addTo(distilleryRecipes);
    }

    private static void createNitrogenTetroxide() {
        // 2HNO3 + Cu = N2O4 + H2O + CuO
        GTValues.RA.stdBuilder().itemInputs(Materials.Copper.getDust(1), GregtechItemList.OrangeMetalCatalyst.get(0))
                .itemOutputs(Materials.CupricOxide.getDust(2)).fluidInputs(Materials.NitricAcid.getFluid(2_000))
                .fluidOutputs(new FluidStack(GTPPFluids.NitrogenTetroxide, 1_000)).duration(30 * SECONDS)
                .eut(TierEU.RECIPE_HV).metadata(CHEMPLANT_CASING_TIER, 3).addTo(chemicalPlantRecipes);
    }
    ...
    private static void createHydrazine() {
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(21))
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.Hydrazine, 1_000)).duration(30 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(CHEMPLANT_CASING_TIER, 1).addTo(chemicalPlantRecipes);
    }

    private static void createMonomethylhydrazine() {
        // C + 2H + N2H4 = CH6N2
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(21), Materials.Carbon.getDust(1))
                .fluidInputs(Materials.Hydrogen.getGas(2_000), new FluidStack(GTPPFluids.Hydrazine, 1_000))
                .fluidOutputs(new FluidStack(GTPPFluids.Monomethylhydrazine, 1_000)).duration(48 * SECONDS).eut(240)
                .metadata(CHEMPLANT_CASING_TIER, 2).addTo(chemicalPlantRecipes);
    }

    private static void createLOH() {
        GTValues.RA.stdBuilder().itemInputs(Materials.Hydrogen.getCells(1))
    ...
    private static void createHydratedAmmoniumNitrateSlurry() {
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(21))
                ...
                .duration(60 * SECONDS).eut(TierEU.RECIPE_MV).metadata(CHEMPLANT_CASING_TIER, 1)
    ...
    private static void createAmmoniumNitrateDust() {
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(8))
                ...
                .fluidOutputs(Materials.Water.getFluid(2_000)).eut(TierEU.RECIPE_HV)
                .duration(1 * MINUTES + 30 * SECONDS).addTo(chemicalDehydratorRecipes);
    }
    ...
    private static void createFormaldehyde() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.Formaldehyde, 32_000)).duration(1 * MINUTES + 30 * SECONDS)
                .eut(TierEU.RECIPE_MV).metadata(CHEMPLANT_CASING_TIER, 1).addTo(chemicalPlantRecipes);
    }
    ...
    private static void createFormaldehydeCatalyst() {
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.FormaldehydeCatalystDust.get(4)).duration(8 * SECONDS)
    ...
    private static void createRocketFuels() {
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.RP1RocketFuel, 1_500)).duration(15 * SECONDS).eut(240)
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.DenseHydrazineFuelMixture, 10_000)).duration(30 * SECONDS)
                .eut(240).metadata(CHEMPLANT_CASING_TIER, 4).addTo(chemicalPlantRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(3))
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.CN3H7O3RocketFuel, 2_000)).duration(45 * SECONDS)
                .eut(TierEU.RECIPE_HV).metadata(CHEMPLANT_CASING_TIER, 5).addTo(chemicalPlantRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(4))
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.H8N4C2O4RocketFuel, 5_000)).duration(60 * SECONDS)
                .eut(TierEU.RECIPE_HV).metadata(CHEMPLANT_CASING_TIER, 6).addTo(chemicalPlantRecipes);
    }
}
