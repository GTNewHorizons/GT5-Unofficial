...
public class RecipeLoaderGenericChem {
    ...
    private static void recipeSodiumEthoxide() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.SodiumEthoxide.get(9)).fluidInputs(Materials.Ethanol.getFluid(1_000))
                .fluidOutputs(Materials.Hydrogen.getGas(1_000)).duration(20 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(CHEMPLANT_CASING_TIER, 2).addTo(chemicalPlantRecipes);
    }
    ...
    private static void recipePotassiumHydroxide() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.CarbonDioxide.getGas(1_000)).duration(30 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(CHEMPLANT_CASING_TIER, 2).addTo(chemicalPlantRecipes);
    ...
    private static void recipeEthylXanthates() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(Materials.Water.getFluid(1_000)).duration(60 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(CHEMPLANT_CASING_TIER, 4).addTo(chemicalPlantRecipes);

        // Sodium ethyl xanthate - CH3CH2ONa + CS2 → CH3CH2OCS2Na
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(17), GregtechItemList.SodiumEthoxide.get(9))
                .itemOutputs(GregtechItemList.SodiumEthylXanthate.get(12))
                .fluidInputs(new FluidStack(GTPPFluids.CarbonDisulfide, 1_000)).duration(60 * SECONDS)
                .eut(TierEU.RECIPE_MV).metadata(CHEMPLANT_CASING_TIER, 4).addTo(chemicalPlantRecipes);
    }
    ...
    private static void recipeCarbonDisulfide() {
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.CarbonDisulfide, 4_000)).duration(10 * MINUTES)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.CarbonDisulfide, 2_000)).duration(5 * MINUTES)
                .eut(TierEU.RECIPE_LV).metadata(CHEMPLANT_CASING_TIER, 2).addTo(chemicalPlantRecipes);
    }
    ...
    private static void recipeMutatedLivingSolder() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(13 * MINUTES + 20 * SECONDS).eut(3842160).metadata(CHEMPLANT_CASING_TIER, 7)
                .addTo(chemicalPlantRecipes);
    }

    private static void registerFuels() {
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("cellNitrobenzene", 1))
                .metadata(FUEL_VALUE, 1600).metadata(FUEL_TYPE, 1).duration(0).eut(0).addTo(GTRecipeConstants.Fuel);
    }
    ...
    private static void recipeGrindingBallAlumina() {
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(new FluidStack(GTPPFluids.Aniline, 4_000)).duration(3 * MINUTES).eut(TierEU.RECIPE_HV)
    ...
    private static void recipeGrindingBallSoapstone() {
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(new FluidStack(GTPPFluids.LiquidResin, 2_500)).duration(2 * MINUTES).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
    }
    ...
    private static void recipeCyclohexane() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.Cyclohexane, 1_000)).duration(2 * MINUTES).eut(TierEU.RECIPE_MV)
                .metadata(CHEMPLANT_CASING_TIER, 2).addTo(chemicalPlantRecipes);
    }
    ...
    private static void recipeCyclohexanone() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.Cyclohexanone, 1_000)).duration(2 * MINUTES)
                .eut(TierEU.RECIPE_MV).metadata(CHEMPLANT_CASING_TIER, 2).addTo(chemicalPlantRecipes);
    ...
    private static void recipeCatalystRed() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.RedMetalCatalyst.get(10)).duration(20 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(assemblerRecipes);
    }
    ...
    private static void recipeCatalystYellow() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.YellowMetalCatalyst.get(10)).duration(1 * MINUTES).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
    }
    ...
    private static void recipeCatalystBlue() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.BlueMetalCatalyst.get(10)).duration(40 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
    }
    ...
    private static void recipeCatalystOrange() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.OrangeMetalCatalyst.get(10)).duration(40 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
    }
    ...
    private static void recipeCatalystPurple() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.PurpleMetalCatalyst.get(10)).duration(2 * MINUTES).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
    }
    ...
    private static void recipeCatalystBrown() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.BrownMetalCatalyst.get(10)).duration(15 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(assemblerRecipes);
    }
    ...
    private static void recipeCatalystPink() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.PinkMetalCatalyst.get(10)).duration(30 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
    }
    ...
    private static void recipeCatalystFormaldehyde() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.FormaldehydeCatalyst.get(4)).duration(30 * SECONDS)
    ...
    private static void recipeCatalystSolidAcid() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialMisc.SOLID_ACID_MIXTURE.getFluidStack(1_000)).duration(30 * SECONDS)
    ...
    private static void recipeCatalystInfiniteMutation() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.InfiniteMutationCatalyst.get(5)).duration(5 * SECONDS)
                .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
    }

    private static void recipeCadaverineAndPutrescine() {
        // Basic Recipe
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(4), new ItemStack(Items.rotten_flesh, 64))
                ...
                .duration(2 * MINUTES).eut(TierEU.RECIPE_MV).metadata(CHEMPLANT_CASING_TIER, 1)
                .addTo(chemicalPlantRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(2 * MINUTES).eut(240).metadata(CHEMPLANT_CASING_TIER, 2).addTo(chemicalPlantRecipes);
    }
    ...
    private static void recipeAniline() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.Aniline, 1_000)).duration(30 * SECONDS).eut(TierEU.RECIPE_HV)
    ...
    private static void recipeNitroBenzene() {
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(12))
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.Nitrobenzene, 5_000)).duration(30 * SECONDS)
                .eut(TierEU.RECIPE_HV).metadata(CHEMPLANT_CASING_TIER, 4).addTo(chemicalPlantRecipes);
    }
    ...
    private static void recipe2Ethylanthraquinone() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.Ethylanthraquinone, 1_000)).duration(15 * SECONDS)
                .eut(TierEU.RECIPE_MV).metadata(CHEMPLANT_CASING_TIER, 2).addTo(chemicalPlantRecipes);
    }
    ...
    private static void recipe2Ethylanthrahydroquinone() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.Ethylanthrahydroquinone, 1_000)).duration(40 * SECONDS)
                .eut(TierEU.RECIPE_MV).metadata(CHEMPLANT_CASING_TIER, 2).addTo(chemicalPlantRecipes);
    }

    private static void recipeLithiumPeroxide() {
        // 2HLiO2 = Li2O2 + H2O2
        GTValues.RA.stdBuilder().itemInputs(GregtechItemList.LithiumHydroperoxide.get(8))
                ...
                .duration(100 * SECONDS).eut(TierEU.RECIPE_MV).addTo(chemicalDehydratorRecipes);
    }
    ...
    private static void recipeLithiumHydroperoxide() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(new FluidStack(GTPPFluids.HydrogenPeroxide, 1_000)).duration(30 * SECONDS).eut(240)
                .metadata(CHEMPLANT_CASING_TIER, 1).addTo(chemicalPlantRecipes);
    }
    ...
    private static void recipeHydrogenPeroxide() {
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(4))
                ...
                .duration(30 * SECONDS).eut(240).metadata(CHEMPLANT_CASING_TIER, 1).addTo(chemicalPlantRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(4))
                ...
                .fluidOutputs(
                        new FluidStack(GTPPFluids.Ethylanthraquinone, 5_000),
                        new FluidStack(GTPPFluids.HydrogenPeroxide, 5_000))
                .duration(5 * SECONDS).eut(240).metadata(CHEMPLANT_CASING_TIER, 1).addTo(chemicalPlantRecipes);
    }
}
