...
public class RecipeLoaderMilling {
    ...
    private static void addVacuumFurnaceRecipes() {
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .eut(TierEU.RECIPE_LuV).metadata(COIL_HEAT, 5500).duration(2 * MINUTES).addTo(vacuumFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.RedMud, 2_000), Materials.Water.getFluid(2_000))
                .eut(TierEU.RECIPE_IV).metadata(COIL_HEAT, 4500).duration(2 * MINUTES).addTo(vacuumFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.RedMud, 2_000), Materials.Water.getFluid(2_000))
                .eut(TierEU.RECIPE_EV).metadata(COIL_HEAT, 3500).duration(2 * MINUTES).addTo(vacuumFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.RedMud, 2_000), Materials.Water.getFluid(2_000))
                .eut(TierEU.RECIPE_UV).metadata(COIL_HEAT, 7500)
                // 60s UV instead of 120s ZPM to avoid fusion skip
                .duration(1 * MINUTES).addTo(vacuumFurnaceRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(Materials.PoorNetherWaste.getFluid(16_000)).eut((int) TierEU.RECIPE_LuV)
                .metadata(COIL_HEAT, 7200).duration(1 * MINUTES).addTo(vacuumFurnaceRecipes);
    }
    ...
    private static void addFlotationRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.SphaleriteFlotationFroth, 1_000)).duration(8 * MINUTES)
                .eut(TierEU.RECIPE_LuV).addTo(flotationCellRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.ChalcopyriteFlotationFroth, 1_000)).duration(8 * MINUTES)
                .eut(TierEU.RECIPE_IV).addTo(flotationCellRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.NickelFlotationFroth, 1_000)).duration(8 * MINUTES)
                .eut(TierEU.RECIPE_IV).addTo(flotationCellRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.PlatinumFlotationFroth, 1_000)).duration(8 * MINUTES)
                .eut(TierEU.RECIPE_LuV).addTo(flotationCellRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.milled, Materials.Pentlandite, 64))
                .fluidInputs(new FluidStack(GTPPFluids.PineOil, 14_000))
                .fluidOutputs(new FluidStack(GTPPFluids.PentlanditeFlotationFroth, 1_000)).duration(8 * MINUTES)
                .eut(TierEU.RECIPE_LuV).addTo(flotationCellRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.RedstoneFlotationFroth, 1_000)).duration(8 * MINUTES)
                .eut(TierEU.RECIPE_IV).addTo(flotationCellRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.milled, Materials.Spessartine, 64))
                .fluidInputs(new FluidStack(GTPPFluids.PineOil, 35_000))
                .fluidOutputs(new FluidStack(GTPPFluids.SpessartineFlotationFroth, 1_000)).duration(8 * MINUTES)
                .eut(TierEU.RECIPE_LuV).addTo(flotationCellRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.GrossularFlotationFroth, 1_000)).duration(8 * MINUTES)
                .eut(TierEU.RECIPE_LuV).addTo(flotationCellRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.AlmandineFlotationFroth, 1_000)).duration(8 * MINUTES)
                .eut(TierEU.RECIPE_IV).addTo(flotationCellRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.PyropeFlotationFroth, 1_000)).duration(8 * MINUTES)
                .eut(TierEU.RECIPE_EV).addTo(flotationCellRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.MonaziteFlotationFroth, 1_000)).duration(8 * MINUTES)
                .eut(TierEU.RECIPE_LuV).addTo(flotationCellRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.NetherrackFlotationFroth, 1_000)).duration(2 * MINUTES)
                .eut(TierEU.RECIPE_LuV).addTo(flotationCellRecipes);
    }
    ...
    private static void addPineOilExtraction() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                        ...
                        Materials.DarkAsh.getDustTiny(5))
                .fluidInputs(Materials.Steam.getGas(5_000)).fluidOutputs(new FluidStack(GTPPFluids.PineOil, 500))
                .duration(60 * SECONDS).eut(TierEU.RECIPE_MV).metadata(CHEMPLANT_CASING_TIER, 3)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.PineOil, 1_500)).duration(45 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(CHEMPLANT_CASING_TIER, 4).addTo(chemicalPlantRecipes);
    }

    private static void addPineLogRecipe(ItemStack log) {
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(14), log)
                .itemOutputs(GregtechItemList.CrushedPineMaterials.get(64)).duration(10 * SECONDS).eut(TierEU.RECIPE_MV)
                .metadata(CHEMPLANT_CASING_TIER, 3).addTo(chemicalPlantRecipes);
    }

    private static void addPineLeafRecipe(ItemStack leaf) {
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(14), leaf)
                .itemOutputs(GregtechItemList.CrushedPineMaterials.get(8)).duration(10 * SECONDS).eut(TierEU.RECIPE_LV)
                .metadata(CHEMPLANT_CASING_TIER, 3).addTo(chemicalPlantRecipes);
    }

    private static void addPineSaplingRecipe(ItemStack sapling) {
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(14), sapling)
                .itemOutputs(GregtechItemList.CrushedPineMaterials.get(16)).duration(10 * SECONDS)
                .eut(TierEU.RECIPE_MV / 2).metadata(CHEMPLANT_CASING_TIER, 3).addTo(chemicalPlantRecipes);
    }

    private static void addPineconeRecipe(ItemStack cone) {
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(14), cone)
                .itemOutputs(GregtechItemList.CrushedPineMaterials.get(4)).duration(10 * SECONDS)
                .eut(TierEU.RECIPE_MV / 2).metadata(CHEMPLANT_CASING_TIER, 3).addTo(chemicalPlantRecipes);
    }
}
