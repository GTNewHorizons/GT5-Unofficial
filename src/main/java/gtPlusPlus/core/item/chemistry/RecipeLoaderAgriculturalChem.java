...
public class RecipeLoaderAgriculturalChem {
    ...
    private static void addBasicSlurryRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .outputChances(2000, 2000, 500, 500, 250, 250).fluidInputs(new FluidStack(GTPPFluids.PoopJuice, 1_000))
                .fluidOutputs(new FluidStack(GTPPFluids.ManureSlurry, 250)).duration(10 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(centrifugeRecipes);

        // More Efficient way to get byproducts, less Slurry
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(20))
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.ManureSlurry, 50)).duration(20 * SECONDS)
        ...
        for (FluidStack aBloodStack : GTPPFluids.getBloodFluids()) {
            for (ItemStack aBoneStack : mList_Master_Bones) {
                ...
                for (ItemStack aMeatStack : mList_Master_Meats) {
                    ...
                    GTValues.RA.stdBuilder().itemInputs(aCircuit, aBone, aMeat, aInputCells).itemOutputs(aEmptyCells)
    ...
    private static void addBasicOrganiseFertRecipes() {
        ...
        for (ItemStack aPeatStack : mPeat) {
            ...
            for (ItemStack aMeatStack : mList_Master_Meats) {
                aMeat = GTUtility.copyAmount(5, aMeatStack);
                GTValues.RA.stdBuilder().itemInputs(aPeat, aMeat).itemOutputs(aOutputDust).fluidInputs(aInputFluid)
    ...
    private static void recipeFermentationBase() {
        ...
        for (ItemStack a : mList_Master_FruitVege) {
            ...
            if (a != null) {
                GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2), GTUtility.copyAmount(10, a))
                        .fluidInputs(GTModHandler.getDistilledWater(1_000))
                        .fluidOutputs(new FluidStack(GTPPFluids.FermentationBase, 1_000)).duration(30 * SECONDS).eut(2)
                        .metadata(CHEMPLANT_CASING_TIER, 0).addTo(chemicalPlantRecipes);
            }
        }

        for (ItemStack a : mList_Master_Seeds) {
            if (a != null) {
                GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(3), GTUtility.copyAmount(20, a))
                        .fluidInputs(GTModHandler.getDistilledWater(1_000))
                        .fluidOutputs(new FluidStack(GTPPFluids.FermentationBase, 1_000)).duration(30 * SECONDS).eut(2)
                        .metadata(CHEMPLANT_CASING_TIER, 0).addTo(chemicalPlantRecipes);
            }
        ...
        // Sugar Cane
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(4), new ItemStack(Items.reeds, 32))
                .fluidInputs(GTModHandler.getDistilledWater(1_000))
                .fluidOutputs(new FluidStack(GTPPFluids.FermentationBase, 1_000)).duration(30 * SECONDS)
                .eut(TierEU.RECIPE_LV).metadata(CHEMPLANT_CASING_TIER, 0).addTo(chemicalPlantRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.FermentationBase, 2_000)).duration(10 * SECONDS)
                .eut(TierEU.RECIPE_LV).metadata(CHEMPLANT_CASING_TIER, 0).addTo(chemicalPlantRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(100 * SECONDS).eut(TierEU.RECIPE_LV).metadata(CHEMPLANT_CASING_TIER, 1)
    ...
    private static void addMiscRecipes() {
        ...
        // IC2 Fertilizer
        GTValues.RA.stdBuilder()
                .itemInputs(GTUtility.getIntegratedCircuit(12), GregtechItemList.OrganicFertilizerDust.get(4))
                .itemOutputs(
                        ItemList.IC2_Fertilizer.get(3),
                        GregtechItemList.ManureByproductsDust.get(1),
                        GregtechItemList.ManureByproductsDust.get(1))
                .outputChances(10000, 2000, 2000).eut(240).duration(20 * SECONDS).addTo(chemicalDehydratorRecipes);

        // Dirt Production
        GTValues.RA.stdBuilder().itemInputs(GregtechItemList.DriedEarthDust.get(9))
                .itemOutputs(new ItemStack(Blocks.dirt)).duration(2 * SECONDS).eut(8).addTo(compressorRecipes);

        // Centrifuge Byproducts

        // Ammonium Nitrate, Phosphates, Calcium, Copper, Carbon
        GTValues.RA.stdBuilder()
                .itemInputs(GregtechItemList.ManureByproductsDust.get(4), GTUtility.getIntegratedCircuit(20))
                .itemOutputs(
        ...
        // Add Fuel Usages
        GTValues.RA.stdBuilder().fluidInputs(new FluidStack(GTPPFluids.PoopJuice, 1_000)).duration(0).eut(0)
                .metadata(FUEL_VALUE, 12).addTo(semiFluidFuels);

        GTValues.RA.stdBuilder().fluidInputs(new FluidStack(GTPPFluids.ManureSlurry, 1_000)).duration(0).eut(0)
                .metadata(FUEL_VALUE, 24).addTo(semiFluidFuels);

        GTValues.RA.stdBuilder().fluidInputs(new FluidStack(GTPPFluids.FertileManureSlurry, 1_000)).duration(0).eut(0)
                .metadata(FUEL_VALUE, 32).addTo(semiFluidFuels);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(10))
                ...
                .outputChances(3000, 3000, 2000, 2000, 1000, 1000).fluidInputs(new FluidStack(GTPPFluids.RedMud, 1_000))
    ...
    private static void addMiscForestryRecipes() {
        if (ItemList.FR_Fertilizer.hasBeenSet()) {
            GTValues.RA.stdBuilder()
                    .itemInputs(GTUtility.getIntegratedCircuit(11), GregtechItemList.OrganicFertilizerDust.get(4))
                    .itemOutputs(
                            ItemList.FR_Fertilizer.get(3),
                            GregtechItemList.ManureByproductsDust.get(1),
                            GregtechItemList.ManureByproductsDust.get(1))
                    .outputChances(100_00, 20_00, 20_00).eut(240).duration(20 * SECONDS)
