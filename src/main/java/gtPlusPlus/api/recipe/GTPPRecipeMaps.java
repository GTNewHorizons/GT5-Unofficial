...
public class GTPPRecipeMaps {
    ...
    public static final RecipeMap<RecipeMapBackend> cokeOvenRecipes = RecipeMapBuilder.of("gtpp.recipe.cokeoven")
            .maxIO(2, 9, 2, 1).minInputs(0, 0).progressBar(GTUITextures.PROGRESSBAR_SIFT, ProgressBar.Direction.DOWN)
            .build();
    ...
    public static final RecipeMap<RecipeMapBackend> quantumForceTransformerRecipes = RecipeMapBuilder
            .of("gtpp.recipe.quantumforcesmelter").maxIO(6, 6, 6, 6).minInputs(0, 0)
            .progressBar(GTUITextures.PROGRESSBAR_ARROW_MULTIPLE).recipeTransformer(recipe -> {
            ...
            }).neiSpecialInfoFormatter(new SimpleSpecialValueFormatter("GT5U.nei.tier")).neiItemInputsGetter(recipe -> {
                ItemStack catalyst = recipe.getMetadata(QFT_CATALYST);
            ...
            }).frontend(QuantumForceTransformerFrontend::new).build();
    public static final RecipeMap<RecipeMapBackend> chemicalDehydratorRecipes = RecipeMapBuilder
            ...
            .progressBar(GTUITextures.PROGRESSBAR_SIFT, ProgressBar.Direction.DOWN).build();
    public static final RecipeMap<RecipeMapBackend> vacuumFurnaceRecipes = RecipeMapBuilder.of("gtpp.recipe.vacfurnace")
            .maxIO(9, 9, 3, 3).minInputs(0, 1).neiSpecialInfoFormatter(HeatingCoilSpecialValueFormatter.INSTANCE)
    ...
    public static final RecipeMap<RecipeMapBackend> coldTrapRecipes = RecipeMapBuilder.of("gtpp.recipe.coldtrap")
            .maxIO(2, 9, 1, 1).progressBar(GTUITextures.PROGRESSBAR_SIFT, ProgressBar.Direction.DOWN).build();
    ...
    public static final RecipeMap<RecipeMapBackend> molecularTransformerRecipes = RecipeMapBuilder
            ...
            .slotOverlays(
                    (index, isFluid, isOutput,
                            isSpecial) -> !isFluid && !isOutput ? GTUITextures.OVERLAY_SLOT_MICROSCOPE : null)
            .neiHandlerInfo(
                    builder -> builder
    ...
    public static final RecipeMap<RecipeMapBackend> fishPondRecipes = RecipeMapBuilder.of("gtpp.recipe.fishpond")
            ...
            .logoPos(7, 81).progressBarPos(52, 44).frontend(ZhuhaiFrontend::new)
            .progressBar(GTUITextures.PROGRESSBAR_FISHING).build();
    public static final RecipeMap<RecipeMapBackend> spargeTowerRecipes = RecipeMapBuilder
            .of("gtpp.recipe.lftr.sparging").frontend(SpargeTowerFrontend::new).maxIO(0, 0, 9, 9).build();
    ...
    public static final RecipeMap<RecipeMapBackend> centrifugeNonCellRecipes = RecipeMapBuilder
            .of("gtpp.recipe.multicentrifuge").maxIO(6, 6, 6, 6).progressBar(GTUITextures.PROGRESSBAR_EXTRACT)
            .frontend(LargeNEIFrontend::new).build();
    public static final RecipeMap<RecipeMapBackend> electrolyzerNonCellRecipes = RecipeMapBuilder
            .of("gtpp.recipe.multielectro").maxIO(6, 6, 6, 6).progressBar(GTUITextures.PROGRESSBAR_EXTRACT)
            .frontend(LargeNEIFrontend::new).build();
    public static final RecipeMap<RecipeMapBackend> mixerNonCellRecipes = RecipeMapBuilder.of("gtpp.recipe.multimixer")
            .maxIO(9, 9, 6, 6).progressBar(GTUITextures.PROGRESSBAR_MIXER, ProgressBar.Direction.CIRCULAR_CW)
            .frontend(LargeNEIFrontend::new).build();
    ...
    public static final RecipeMap<RecipeMapBackend> treeGrowthSimulatorFakeRecipes = RecipeMapBuilder
            .of("gtpp.recipe.treefarm").maxIO(MTETreeFarm.Mode.values().length, MTETreeFarm.Mode.values().length, 0, 0)
    ...
    public static final RecipeMap<RecipeMapBackend> multiblockRockBreakerRecipes = RecipeMapBuilder
            .of("gt.recipe.multiblockrockbreaker").maxIO(2, 1, 0, 0).disableRegisterNEI().build();
}
