...
public class ItemCustomComb extends Item {
    ...
    public void initCombsRecipes() {
        ...
        addSpecialCent(tComb, OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Silicon, 1), 30);
        // addProcess(tComb, Materials.Silver, 100);
        // addProcess(tComb, Materials.Galena, 100);

        // Rubbers
        tComb = getStackForType(CustomCombs.RUBBER);
        addSpecialCent(tComb, OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Rubber, 1), 30);
        tComb = getStackForType(CustomCombs.PLASTIC);
        addSpecialCent(tComb, OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Plastic, 1), 20);
        tComb = getStackForType(CustomCombs.PTFE);
        addSpecialCent(tComb, OreDictUnificator.get(OrePrefixes.dustTiny, GTPP_Bees.PTFE, 1), 10);
        tComb = getStackForType(CustomCombs.PBS);
        addSpecialCent(tComb, OreDictUnificator.get(OrePrefixes.dustTiny, GTPP_Bees.PBS, 1), 5);
