...
public class FRItemRegistry {
    ...
    public static void Register() {
        ...
        GregtechItemList.HiveFrameVoid.set(
                new MBItemFrame(MBFrameType.USELESS, EnumRarity.common, "No more cheaty frames for GTNH players."));
        ...
        GregtechItemList.HiveFrameArborist.set(
                new MBItemFrame(MBFrameType.ARBORISTS, EnumRarity.common, "Who need Bees when you can have Trees?"));
