...
public enum GregtechItemList implements IGregtechItemContainer {
    ...
    Controller_SteamMegaWasherMulti,
    Controller_SteamMegaHammerMulti,
    Controller_SteamMegaCentrifugeMulti,
    // Bit Steam Washer
    ...
    // Steam Rock Breaker
    Controller_SteamRockBreaker,
    // Steam Extractinator
    Controller_SteamExtractinator,
    // Steam Woodcutter
    ...
    Controller_SteamCompactFusionReactor,
    // Mega Steam Fuser
    Controller_SteamMegaAlloySmelter,
