    ...
    private ITexture[] getTextureGTNH(IGregTechTileEntity aBaseMetaTileEntity, ForgeDirection aSide, int aConnections,
        ...
        if (aConnected) {
            ...
            if (tThickNess < 0.124F) return new ITexture[] { TextureFactory
                .of(Textures.BlockIcons.INSULATION_FULL, Dyes.getModulation(aColorIndex, Dyes.CABLE_INSULATION)) };
            if (tThickNess < 0.374F) // 0.375 x1
                return new ITexture[] { TextureFactory.of(wireMaterial.mIconSet.mTextures[TextureSet.INDEX_wire], vRGB),
                    TextureFactory.of(
                        ...
                        Dyes.getModulation(aColorIndex, Dyes.CABLE_INSULATION)) };
            ...
            return new ITexture[] { TextureFactory.of(wireMaterial.mIconSet.mTextures[TextureSet.INDEX_wire], vRGB),
                TextureFactory
                    .of(Textures.BlockIcons.INSULATION_HUGE, Dyes.getModulation(aColorIndex, Dyes.CABLE_INSULATION)) };
        }
