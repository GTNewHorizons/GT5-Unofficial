...
public class Gregtech4Content {
    ...
    private static void automation() {
        ...
        GregtechItemList.GT4_Electric_Auto_Workbench_LV
            .set(new GT_MetaTileEntity_ElectricAutoWorkbench(GT4_Electric_Auto_Workbench_LV.ID, 1, "Automatic crafting machine").getStackForm(1L));
        GregtechItemList.GT4_Electric_Auto_Workbench_MV
            .set(new GT_MetaTileEntity_ElectricAutoWorkbench(GT4_Electric_Auto_Workbench_MV.ID, 2, "Automatic crafting machine").getStackForm(1L));
        GregtechItemList.GT4_Electric_Auto_Workbench_HV
            .set(new GT_MetaTileEntity_ElectricAutoWorkbench(GT4_Electric_Auto_Workbench_HV.ID, 3, "Automatic crafting machine").getStackForm(1L));
        GregtechItemList.GT4_Electric_Auto_Workbench_EV
            .set(new GT_MetaTileEntity_ElectricAutoWorkbench(GT4_Electric_Auto_Workbench_EV.ID, 4, "Automatic crafting machine").getStackForm(1L));
        GregtechItemList.GT4_Electric_Auto_Workbench_IV
            .set(new GT_MetaTileEntity_ElectricAutoWorkbench(GT4_Electric_Auto_Workbench_IV.ID, 5, "Automatic crafting machine").getStackForm(1L));
        GregtechItemList.GT4_Electric_Auto_Workbench_LuV
            .set(new GT_MetaTileEntity_ElectricAutoWorkbench(GT4_Electric_Auto_Workbench_LuV.ID, 6, "Automatic crafting machine").getStackForm(1L));
        GregtechItemList.GT4_Electric_Auto_Workbench_ZPM
            .set(new GT_MetaTileEntity_ElectricAutoWorkbench(GT4_Electric_Auto_Workbench_ZPM.ID, 7, "Automatic crafting machine").getStackForm(1L));
        GregtechItemList.GT4_Electric_Auto_Workbench_UV
            .set(new GT_MetaTileEntity_ElectricAutoWorkbench(GT4_Electric_Auto_Workbench_UV.ID, 8, "Automatic crafting machine").getStackForm(1L));
    ...
    private static void basic() {
        ...
        GregtechItemList.GT4_Crop_Harvester_LV.set(
            new GT_MetaTileEntity_CropHarvestor(GT4_Crop_Harvester_LV.ID, 1, "Harvests the Cropsticks in front of it").getStackForm(1L));
        GregtechItemList.GT4_Crop_Harvester_MV.set(
            new GT_MetaTileEntity_CropHarvestor(GT4_Crop_Harvester_MV.ID, 2, "Harvests the Cropsticks in front of it").getStackForm(1L));
        GregtechItemList.GT4_Crop_Harvester_HV.set(
            new GT_MetaTileEntity_CropHarvestor(GT4_Crop_Harvester_HV.ID, 3, "Harvests the Cropsticks in front of it").getStackForm(1L));
        GregtechItemList.GT4_Crop_Harvester_EV.set(
            new GT_MetaTileEntity_CropHarvestor(GT4_Crop_Harvester_EV.ID, 4, "Harvests the Cropsticks in front of it").getStackForm(1L));
        GregtechItemList.GT4_Crop_Harvester_IV.set(
            new GT_MetaTileEntity_CropHarvestor(GT4_Crop_Harvester_IV.ID, 5, "Harvests the Cropsticks in front of it").getStackForm(1L));
        GregtechItemList.GT4_Crop_Harvester_LuV.set(
            new GT_MetaTileEntity_CropHarvestor(GT4_Crop_Harvester_LuV.ID, 6, "Harvests the Cropsticks in front of it").getStackForm(1L));
        GregtechItemList.GT4_Crop_Harvester_ZPM.set(
            new GT_MetaTileEntity_CropHarvestor(GT4_Crop_Harvester_ZPM.ID, 7, "Harvests the Cropsticks in front of it").getStackForm(1L));
        GregtechItemList.GT4_Crop_Harvester_UV.set(
            new GT_MetaTileEntity_CropHarvestor(GT4_Crop_Harvester_UV.ID, 8, "Harvests the Cropsticks in front of it").getStackForm(1L));
    }
    ...
    private static void tesseracts() {
        ...
        GregtechItemList.GT4_Tesseract_Generator.set(
            new GT_MetaTileEntity_TesseractGenerator(GT4_Tesseract_Generator.ID, "tesseract.generator", "Tesseract Generator", 4)
                .getStackForm(1L));
        GregtechItemList.GT4_Tesseract_Terminal.set(
            new GT_MetaTileEntity_TesseractTerminal(GT4_Tesseract_Terminal.ID, "tesseract.terminal", "Tesseract Terminal", 4)
                .getStackForm(1L));
    }
    ...
    private static void thermalBoiler() {
        ...
        if (CORE.ConfigSwitches.enableMultiblock_ThermalBoiler) {
            ...
            GregtechItemList.GT4_Thermal_Boiler
                .set(new GT4Entity_ThermalBoiler(GT4_Thermal_Boiler.ID, "gtplusplus.thermal.boiler", "Thermal Boiler").getStackForm(1L));
        }
    }
    ...
    private static void multiCrafter() {
        ...
        GregtechItemList.GT4_Multi_Crafter.set(
            new GT4Entity_AutoCrafter(GT4_Multi_Crafter.ID, "gtplusplus.autocrafter.multi", "Large Scale Auto-Assembler v1.01")
                .getStackForm(1L));
    }
}
