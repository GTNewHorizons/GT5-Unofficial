    ...
    public static void run() {
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { " BB", "CM ", " BB", 'M', ItemList.Transformer_LV_ULV, 'C',
                OrePrefixes.wireGt04.ingredient(Materials2Materials.Tin), 'B',
                OrePrefixes.wireGt04.ingredient(Materials2Materials.Lead) });
        GTModHandler.addCraftingRecipe(
            GregtechItemList.Transformer_HA_MV_LV.get(1L),
            GTModHandler.RecipeBits.BITS | GTModHandler.RecipeBits.DO_NOT_CHECK_FOR_COLLISIONS,
            new Object[] { " BB", "CM ", " BB", 'M', ItemList.Transformer_MV_LV, 'C',
                OrePrefixes.wireGt04.ingredient(Materials2Backings.AnyCopper), 'B',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { " BB", "CM ", " BB", 'M', ItemList.Transformer_HV_MV, 'C',
                ...
                OrePrefixes.wireGt04.ingredient(Materials2Backings.AnyCopper) });
        GTModHandler.addCraftingRecipe(
            GregtechItemList.Transformer_HA_EV_HV.get(1L),
            GTModHandler.RecipeBits.BITS | GTModHandler.RecipeBits.DO_NOT_CHECK_FOR_COLLISIONS,
            new Object[] { "KBB", "CM ", "KBB", 'M', ItemList.Transformer_EV_HV, 'C',
                OrePrefixes.wireGt04.ingredient(Materials2Materials.Aluminium), 'B',
                OrePrefixes.wireGt04.ingredient(Materials2Materials.Gold), 'K', ItemList.Casing_Coil_Cupronickel });
        GTModHandler.addCraftingRecipe(
            GregtechItemList.Transformer_HA_IV_EV.get(1L),
            GTModHandler.RecipeBits.BITS | GTModHandler.RecipeBits.DO_NOT_CHECK_FOR_COLLISIONS,
            new Object[] { "KBB", "CM ", "KBB", 'M', ItemList.Transformer_IV_EV, 'C',
                OrePrefixes.wireGt04.ingredient(Materials2Materials.Tungsten), 'B',
                OrePrefixes.wireGt04.ingredient(Materials2Materials.Aluminium), 'K', ItemList.Casing_Coil_Kanthal });
        GTModHandler.addCraftingRecipe(
            GregtechItemList.Transformer_HA_LuV_IV.get(1L),
            GTModHandler.RecipeBits.BITS | GTModHandler.RecipeBits.DO_NOT_CHECK_FOR_COLLISIONS,
            new Object[] { "KBB", "CM ", "KBB", 'M', ItemList.Transformer_LuV_IV, 'C',
                OrePrefixes.wireGt04.ingredient(Materials2Materials.VanadiumGallium), 'B',
                OrePrefixes.wireGt04.ingredient(Materials2Materials.Tungsten), 'K', ItemList.Casing_Coil_Nichrome });
        GTModHandler.addCraftingRecipe(
            GregtechItemList.Transformer_HA_ZPM_LuV.get(1L),
            GTModHandler.RecipeBits.BITS | GTModHandler.RecipeBits.DO_NOT_CHECK_FOR_COLLISIONS,
            new Object[] { "KBB", "CM ", "KBB", 'M', ItemList.Transformer_ZPM_LuV, 'C',
                OrePrefixes.wireGt04.ingredient(Materials2Materials.Naquadah), 'B',
                OrePrefixes.wireGt04.ingredient(Materials2Materials.VanadiumGallium), 'K', mItem_1 });
        GTModHandler.addCraftingRecipe(
            GregtechItemList.Transformer_HA_UV_ZPM.get(1L),
            GTModHandler.RecipeBits.BITS | GTModHandler.RecipeBits.DO_NOT_CHECK_FOR_COLLISIONS,
            new Object[] { "KBB", "CM ", "KBB", 'M', ItemList.Transformer_UV_ZPM, 'C',
                OrePrefixes.wireGt04.ingredient(Materials2Materials.NaquadahAlloy), 'B',
                OrePrefixes.wireGt04.ingredient(Materials2Materials.Naquadah), 'K', mItem_2 });
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "KBB", "CM ", "KBB", 'M', ItemList.Transformer_MAX_UV, 'C',
                OrePrefixes.wireGt04.ingredient(Materials2Materials.Bedrockium), 'B',
                OrePrefixes.wireGt04.ingredient(Materials2Materials.NaquadahAlloy), 'K', mItem_3 });
    }
}
