...
public class GregtechConduits {
    ...
    public enum PipeStats {
        ...
        public String getLocalizedNameForItem(String aFormat) {
            return formatStringSafe(aFormat.replace("%s", "%temp").replace("%material", "%s"), this.defaultLocalName)
                    .replace("%temp", "%s");
        }
    }
    ...
    public static void generatePipeRecipes(final Material material, final String materialName, final long Mass,
        ...
        if (pipeIngot != null) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(20 * TICKS).eut(eut).addTo(extruderRecipes);
            GTValues.RA.stdBuilder()
                    .itemInputs(
                    ...
                    .duration(2 * SECONDS).eut(eut).addTo(extruderRecipes);
            GTValues.RA.stdBuilder()
                    .itemInputs(
                    ...
                    .duration(4 * SECONDS).eut(eut).addTo(extruderRecipes);
        ...
        if (material != null && material.getFluid() != null) {
            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Pipe_Tiny.get(0L))
                    .itemOutputs(ItemUtils.getItemStackOfAmountFromOreDictNoBroken("pipe" + "Tiny" + output, 1))
                    .fluidInputs(material.getFluidStack(1 * HALF_INGOTS)).duration(1 * SECONDS).eut(eut)
                    .addTo(fluidSolidifierRecipes);

            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Pipe_Small.get(0L))
                    .itemOutputs(ItemUtils.getItemStackOfAmountFromOreDict("pipe" + "Small" + output, 1))
                    .fluidInputs(material.getFluidStack(1 * INGOTS)).duration(2 * SECONDS).eut(eut)
                    .addTo(fluidSolidifierRecipes);

            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Pipe_Medium.get(0L))
                    .itemOutputs(ItemUtils.getItemStackOfAmountFromOreDict("pipe" + "Medium" + output, 1))
                    .fluidInputs(material.getFluidStack(3 * INGOTS)).duration(4 * SECONDS).eut(eut)
                    .addTo(fluidSolidifierRecipes);

            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Pipe_Large.get(0L))
                    .itemOutputs(ItemUtils.getItemStackOfAmountFromOreDict("pipe" + "Large" + output, 1))
                    .fluidInputs(material.getFluidStack(6 * INGOTS)).duration(8 * SECONDS).eut(eut)
                    .addTo(fluidSolidifierRecipes);

            GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Pipe_Huge.get(0L))
                    .itemOutputs(ItemUtils.getItemStackOfAmountFromOreDict("pipe" + "Huge" + output, 1))
                    .fluidInputs(material.getFluidStack(12 * INGOTS)).duration(16 * SECONDS).eut(eut)
                    .addTo(fluidSolidifierRecipes);
        }
    }
    ...
    public static boolean generateWireRecipes(Material aMaterial) {
        ...
        if (ItemUtils.checkForInvalidItems(
            ...
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getIngot(1), GTUtility.getIntegratedCircuit(1))
                    .itemOutputs(aMaterial.getWire01(2)).duration(5 * SECONDS).eut(4).addTo(wiremillRecipes);
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getIngot(1), GTUtility.getIntegratedCircuit(2))
                    .itemOutputs(aMaterial.getWire02(1)).duration(7 * SECONDS + 10 * TICKS).eut(4)
                    .addTo(wiremillRecipes);
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getIngot(2), GTUtility.getIntegratedCircuit(4))
                    .itemOutputs(aMaterial.getWire04(1)).duration(10 * SECONDS).eut(4).addTo(wiremillRecipes);
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getIngot(4), GTUtility.getIntegratedCircuit(8))
                    .itemOutputs(aMaterial.getWire08(1)).duration(12 * SECONDS + 10 * TICKS).eut(4)
                    .addTo(wiremillRecipes);
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getIngot(6), GTUtility.getIntegratedCircuit(12))
                    .itemOutputs(aMaterial.getWire12(1)).duration(15 * SECONDS).eut(4).addTo(wiremillRecipes);
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getIngot(8), GTUtility.getIntegratedCircuit(16))
                    .itemOutputs(aMaterial.getWire16(1)).duration(17 * SECONDS + 10 * TICKS).eut(4)
                    .addTo(wiremillRecipes);
        ...
        if (ItemUtils
            ...
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getRod(1), GTUtility.getIntegratedCircuit(1))
                    .itemOutputs(aMaterial.getWire01(1)).duration(2 * SECONDS + 10 * TICKS).eut(4)
                    .addTo(wiremillRecipes);
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getRod(2), GTUtility.getIntegratedCircuit(2))
                    .itemOutputs(aMaterial.getWire02(1)).duration(5 * SECONDS).eut(4).addTo(wiremillRecipes);
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getRod(4), GTUtility.getIntegratedCircuit(4))
                    .itemOutputs(aMaterial.getWire04(1)).duration(7 * SECONDS + 10 * TICKS).eut(4)
                    .addTo(wiremillRecipes);
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getRod(8), GTUtility.getIntegratedCircuit(8))
                    .itemOutputs(aMaterial.getWire08(1)).duration(10 * SECONDS).eut(4).addTo(wiremillRecipes);
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getRod(12), GTUtility.getIntegratedCircuit(12))
                    .itemOutputs(aMaterial.getWire12(1)).duration(12 * SECONDS + 10 * TICKS).eut(4)
                    .addTo(wiremillRecipes);
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getRod(16), GTUtility.getIntegratedCircuit(16))
                    .itemOutputs(aMaterial.getWire16(1)).duration(15 * SECONDS).eut(4).addTo(wiremillRecipes);

        }

        if (ItemUtils.checkForInvalidItems(new ItemStack[] { aIngot, aFineWire })) {
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getIngot(1), GTUtility.getIntegratedCircuit(3))
                    .itemOutputs(aMaterial.getFineWire(8)).duration(5 * SECONDS).eut(4).addTo(wiremillRecipes);

        }

        if (ItemUtils.checkForInvalidItems(new ItemStack[] { aRod, aFineWire })) {
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getRod(1), GTUtility.getIntegratedCircuit(3))
                    .itemOutputs(aMaterial.getFineWire(4)).duration(2 * SECONDS + 10 * TICKS).eut(4)
                    .addTo(wiremillRecipes);

        }

        if (ItemUtils.checkForInvalidItems(new ItemStack[] { aWire01, aFineWire })) {
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getWire01(1), GTUtility.getIntegratedCircuit(1))
                    .itemOutputs(aMaterial.getFineWire(4)).duration(10 * SECONDS).eut(8).addTo(wiremillRecipes);

        }

        // Extruder
        if (ItemUtils.checkForInvalidItems(new ItemStack[] { aIngot, aWire01 })) {
            GTValues.RA.stdBuilder().itemInputs(aIngot, ItemList.Shape_Extruder_Wire.get(0))
                    .itemOutputs(aMaterial.getWire01(2)).duration(9 * SECONDS + 16 * TICKS).eut(96)
                    .addTo(extruderRecipes);
        }

        if (ItemUtils.checkForInvalidItems(new ItemStack[] { aCable01, aWire01 })) {
            GTValues.RA.stdBuilder().itemInputs(aCable01).itemOutputs(aWire01).duration(5 * SECONDS).eut(8)
        ...
        if (ItemUtils.checkForInvalidItems(new ItemStack[] { aWire01, aCable01 })) {
            GTValues.RA.stdBuilder().itemInputs(aWire01, GTUtility.getIntegratedCircuit(24)).itemOutputs(aCable01)
                    .fluidInputs(FluidUtils.getFluidStack("molten.rubber", 144)).duration(5 * SECONDS).eut(8)
        ...
        if (ItemUtils.checkForInvalidItems(new ItemStack[] { aWire02, aCable02 })) {
            GTValues.RA.stdBuilder().itemInputs(aWire02, GTUtility.getIntegratedCircuit(24)).itemOutputs(aCable02)
                    .fluidInputs(FluidUtils.getFluidStack("molten.rubber", 144)).duration(5 * SECONDS).eut(8)
                    .addTo(assemblerRecipes);
        ...
        if (ItemUtils.checkForInvalidItems(new ItemStack[] { aWire04, aCable04 })) {
            GTValues.RA.stdBuilder().itemInputs(aWire04, GTUtility.getIntegratedCircuit(24)).itemOutputs(aCable04)
                    .fluidInputs(FluidUtils.getFluidStack("molten.rubber", 288)).duration(5 * SECONDS).eut(8)
                    .addTo(assemblerRecipes);
        ...
        if (ItemUtils.checkForInvalidItems(new ItemStack[] { aWire08, aCable08 })) {
            GTValues.RA.stdBuilder().itemInputs(aWire08, GTUtility.getIntegratedCircuit(24)).itemOutputs(aCable08)
                    .fluidInputs(FluidUtils.getFluidStack("molten.rubber", 432)).duration(5 * SECONDS).eut(8)
                    .addTo(assemblerRecipes);
        ...
        if (ItemUtils.checkForInvalidItems(new ItemStack[] { aWire12, aCable12 })) {
            GTValues.RA.stdBuilder().itemInputs(aWire12, GTUtility.getIntegratedCircuit(24)).itemOutputs(aCable12)
                    .fluidInputs(FluidUtils.getFluidStack("molten.rubber", 576)).duration(5 * SECONDS).eut(8)
                    .addTo(assemblerRecipes);
        ...
        if (ItemUtils.checkForInvalidItems(new ItemStack[] { aWire16, aCable16 })) {
            GTValues.RA.stdBuilder().itemInputs(aWire16, GTUtility.getIntegratedCircuit(24)).itemOutputs(aCable16)
                    .fluidInputs(FluidUtils.getFluidStack("molten.rubber", 720)).duration(5 * SECONDS).eut(8)
                    .addTo(assemblerRecipes);
        ...
        if (ItemUtils.checkForInvalidItems(new ItemStack[] { aWire01, aWire02 })) {
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getWire01(2), GTUtility.getIntegratedCircuit(2))
                    .itemOutputs(aWire02).duration(5 * SECONDS).eut(8).addTo(assemblerRecipes);
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getWire01(4), GTUtility.getIntegratedCircuit(4))
                    .itemOutputs(aWire04).duration(5 * SECONDS).eut(8).addTo(assemblerRecipes);
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getWire01(8), GTUtility.getIntegratedCircuit(8))
                    .itemOutputs(aWire08).duration(5 * SECONDS).eut(8).addTo(assemblerRecipes);
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getWire01(12), GTUtility.getIntegratedCircuit(12))
                    .itemOutputs(aWire12).duration(5 * SECONDS).eut(8).addTo(assemblerRecipes);
            GTValues.RA.stdBuilder().itemInputs(aMaterial.getWire01(16), GTUtility.getIntegratedCircuit(16))
                    .itemOutputs(aWire16).duration(5 * SECONDS).eut(8).addTo(assemblerRecipes);
        }
