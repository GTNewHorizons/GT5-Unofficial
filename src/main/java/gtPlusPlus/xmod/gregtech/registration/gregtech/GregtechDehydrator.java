    ...
    private static void registerMTEs() {
        ...
        GregtechItemList.GT_Dehydrator_MV.set(
                new MTEBasicMachineWithRecipe(
                        ...
                        SoundResource.NONE,
                        SpecialEffects.NONE,
                        "DEHYDRATOR").setRecipeCatalystPriority(6).getStackForm(1L));
        ...
        GregtechItemList.GT_Dehydrator_HV.set(
                new MTEBasicMachineWithRecipe(
                        ...
                        SoundResource.NONE,
                        SpecialEffects.NONE,
                        "DEHYDRATOR").setRecipeCatalystPriority(5).getStackForm(1L));
        ...
        GregtechItemList.GT_Dehydrator_EV.set(
                new MTEBasicMachineWithRecipe(
                        ...
                        SoundResource.NONE,
                        SpecialEffects.NONE,
                        "DEHYDRATOR").setRecipeCatalystPriority(4).getStackForm(1L));
        ...
        GregtechItemList.GT_Dehydrator_IV.set(
                new MTEBasicMachineWithRecipe(
                        ...
                        SoundResource.NONE,
                        SpecialEffects.NONE,
                        "DEHYDRATOR").setRecipeCatalystPriority(3).getStackForm(1L));
        ...
        GregtechItemList.GT_Dehydrator_LuV.set(
                new MTEBasicMachineWithRecipe(
                        ...
                        6,
                        new String[] { "You could probably make space icecream with this..",
                                GTPPCore.GT_Tooltip.get() },
                        GTPPRecipeMaps.chemicalDehydratorRecipes,
                        2,
                        9,
                        ...
                        SoundResource.NONE,
                        SpecialEffects.NONE,
                        "DEHYDRATOR").setRecipeCatalystPriority(2).getStackForm(1L));
        ...
        GregtechItemList.GT_Dehydrator_ZPM.set(
                new MTEBasicMachineWithRecipe(
                        ...
                        7,
                        new String[] { "You can definitely make space icecream with this..",
                                GTPPCore.GT_Tooltip.get() },
                        GTPPRecipeMaps.chemicalDehydratorRecipes,
                        2,
                        9,
                        ...
                        SoundResource.NONE,
                        SpecialEffects.NONE,
                        "DEHYDRATOR").setRecipeCatalystPriority(1).getStackForm(1L));

        // Advanced
        GregtechItemList.Controller_Vacuum_Furnace.set(
                new MTEIndustrialDehydrator(
