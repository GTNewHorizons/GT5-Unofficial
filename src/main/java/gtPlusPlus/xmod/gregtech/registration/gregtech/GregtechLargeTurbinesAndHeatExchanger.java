...
public class GregtechLargeTurbinesAndHeatExchanger {
    ...
    private static void run1() {
        GregtechItemList.Large_Steam_Turbine.set(
            new GT_MTE_LargeTurbine_Steam(Large_Steam_Turbine.ID, "multimachine.largerturbine", "XL Turbo Steam Turbine")
                .getStackForm(1L));
        GregtechItemList.Large_HPSteam_Turbine.set(
            new GT_MTE_LargeTurbine_SHSteam(Large_HPSteam_Turbine.ID, "multimachine.largerhpturbine", "XL Turbo HP Steam Turbine")
                .getStackForm(1L));
        ...
        GregtechItemList.Large_Plasma_Turbine.set(
            new GT_MTE_LargeTurbine_Plasma(Large_Plasma_Turbine.ID, "multimachine.largerplasmaturbine", "XL Turbo Plasma Turbine")
                .getStackForm(1L));
        GregtechItemList.Large_SCSteam_Turbine.set(
            new GT_MTE_LargeTurbine_SCSteam(Large_SCSteam_Turbine.ID, "multimachine.largerscturbine", "XL Turbo SC Steam Turbine")
                .getStackForm(1L));
        GregtechItemList.Hatch_Turbine_Rotor
            .set(new GT_MetaTileEntity_Hatch_Turbine(Hatch_Turbine_Rotor.ID, "hatch.turbine", "Rotor Assembly", 8).getStackForm(1L));
