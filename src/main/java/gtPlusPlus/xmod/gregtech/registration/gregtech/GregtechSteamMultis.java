...
public class GregtechSteamMultis {
    ...
    public static void run() {
        ...
        GregtechItemList.Controller_SteamMaceratorMulti.set(
            new GregtechMetaTileEntity_SteamMacerator(Controller_SteamMaceratorMulti.ID, "gtpp.multimachine.steam.macerator", "Steam Grinder")
                .getStackForm(1L));
        GregtechItemList.Controller_SteamCompressorMulti.set(
            new GregtechMetaTileEntity_SteamCompressor(Controller_SteamCompressorMulti.ID, "gtpp.multimachine.steam.compressor", "Steam Squasher")
                .getStackForm(1L));
        GregtechItemList.Controller_SteamCentrifugeMulti.set(
            new GregtechMetaTileEntity_SteamCentrifuge(Controller_SteamCentrifugeMulti.ID, "gtpp.multimachine.steam.centrifuge", "Steam Centrifuge")
                .getStackForm(1));
        GregtechItemList.Controller_SteamWasherMulti.set(
            new GregtechMetaTileEntity_SteamWasher(Controller_SteamWasherMulti.ID, "gtpp.multimachine.steam.washer", "Steam Washer")
                .getStackForm(1));

        GregtechItemList.Hatch_Input_Bus_Steam.set(
            new GT_MetaTileEntity_Hatch_Steam_BusInput(Hatch_Input_Bus_Steam.ID, "hatch.input_bus.tier.steam", "Input Bus (Steam)", 0)
                .getStackForm(1L));
        GregtechItemList.Hatch_Output_Bus_Steam.set(
            new GT_MetaTileEntity_Hatch_Steam_BusOutput(Hatch_Output_Bus_Steam.ID, "hatch.output_bus.tier.steam", "Output Bus (Steam)", 0)
                .getStackForm(1L));
    }
}
