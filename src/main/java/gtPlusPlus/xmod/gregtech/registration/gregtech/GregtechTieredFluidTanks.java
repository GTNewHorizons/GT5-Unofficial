...
public class GregtechTieredFluidTanks {
    ...
    private static void run1() {
        ...
        GregtechItemList.GT_FluidTank_ULV.set(
            new GT_MetaTileEntity_TieredTank(GT_FluidTank_ULV.ID, "fluidtank.tier.00", "Ultra Low Voltage Fluid Tank", 0)
                .getStackForm(1L));
        GregtechItemList.GT_FluidTank_LV.set(
            new GT_MetaTileEntity_TieredTank(GT_FluidTank_LV.ID, "fluidtank.tier.01", "Low Voltage Fluid Tank", 1).getStackForm(1L));
        ...
        GregtechItemList.GT_FluidTank_HV.set(
            new GT_MetaTileEntity_TieredTank(GT_FluidTank_HV.ID, "fluidtank.tier.03", "High Voltage Fluid Tank", 3).getStackForm(1L));
    }
}
