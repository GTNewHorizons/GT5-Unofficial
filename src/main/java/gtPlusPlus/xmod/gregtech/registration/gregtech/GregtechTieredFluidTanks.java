...
public class GregtechTieredFluidTanks {
    ...
    private static void run1() {
        ...
        GregtechItemList.GTFluidTank_LV.set(
                new MTETieredTank(GTFluidTank_LV.ID, "fluidtank.tier.01", "Low Voltage Fluid Tank", 1)
                        .getStackForm(1L));
        GregtechItemList.GTFluidTank_MV.set(
                new MTETieredTank(GTFluidTank_MV.ID, "fluidtank.tier.02", "Medium Voltage Fluid Tank", 2)
                        .getStackForm(1L));
        GregtechItemList.GTFluidTank_HV.set(
                new MTETieredTank(GTFluidTank_HV.ID, "fluidtank.tier.03", "High Voltage Fluid Tank", 3)
                        .getStackForm(1L));
    }
}
