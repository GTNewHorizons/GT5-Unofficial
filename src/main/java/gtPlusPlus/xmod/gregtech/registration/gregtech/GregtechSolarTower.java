...
public class GregtechSolarTower {
    ...
    private static void run1() {
        ...
        // NEI recipe
        GTValues.RA.stdBuilder().fluidInputs(MaterialMisc.SOLAR_SALT_COLD.getFluidStack(1000))
                .fluidOutputs(MaterialMisc.SOLAR_SALT_HOT.getFluidStack(1000)).duration(0).eut(0)
