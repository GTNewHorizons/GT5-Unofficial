...
public class GregtechIndustrialChisel {
    ...
    public static void run() {
        GregtechItemList.GT_Chisel_LV.set(
            new GregtechMetaTileEntity_AutoChisel(GT_Chisel_LV.ID, "chisel.tier.01", "Basic Auto-Chisel", 1).getStackForm(1L));
        GregtechItemList.GT_Chisel_MV.set(
            new GregtechMetaTileEntity_AutoChisel(GT_Chisel_MV.ID, "chisel.tier.02", "Advanced Auto-Chisel", 2).getStackForm(1L));
