...
public class RecipeGenExtruder extends RecipeGenBase {
    ...
    private void generateRecipes(final Material material) {
        ...
        Logger.WARNING("Generating Extruder recipes for " + material.getLocalDefaultName());
        ...
        if (material.getIngot(1) != null && material.getBlock(1) != null) {
            ...
            Logger.WARNING("Extruder Ingot Recipe: " + material.getLocalDefaultName() + " - Success");
            ...
            Logger.WARNING("Extruder Block Recipe: " + material.getLocalDefaultName() + " - Success");
        }
        ...
        if (material.getIngot(1) != null && material.getPlate(1) != null) {
            ...
            Logger.WARNING("Extruder Plate Recipe: " + material.getLocalDefaultName() + " - Success");
        }
        ...
        if (material.getIngot(1) != null && material.getRing(1) != null) {
            if (!material.isRadioactive) {
                ...
                Logger.WARNING("Extruder Ring Recipe: " + material.getLocalDefaultName() + " - Success");
            }
        }
        ...
        if (material.getIngot(1) != null && material.getGear(1) != null && !material.isRadioactive) {
            ...
            Logger.WARNING("Extruder Gear Recipe: " + material.getLocalDefaultName() + " - Success");
        }
        ...
        if (material.getIngot(1) != null && material.getRod(1) != null) {
            ...
            Logger.WARNING("Extruder Rod Recipe: " + material.getLocalDefaultName() + " - Success");
        }
        ...
        if (material.getIngot(1) != null && material.getBolt(1) != null && !material.isRadioactive) {
            ...
            Logger.WARNING("Extruder Bolt Recipe: " + material.getLocalDefaultName() + " - Success");
        }
        ...
        if (material.getIngot(1) != null && material.getRotor(1) != null) {
            ...
            Logger.WARNING("Extruder Rotor Recipe: " + material.getLocalDefaultName() + " - Success");
        }
