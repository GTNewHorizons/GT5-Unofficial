...
public class RecipeLoaderChemicalSkips {
    ...
    private static void quantumTransformerRecipes() {
        ...
        // Platline
        GTValues.RA.stdBuilder().itemInputs(WerkstoffLoader.PTMetallicPowder.get(OrePrefixes.dust, 32))
                .itemOutputs(
                ...
                .duration(20 * SECONDS).eut(TierEU.RECIPE_UV)
                .metadata(QFT_CATALYST, GregtechItemList.PlatinumGroupCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 1)
                .addTo(quantumForceTransformerRecipes);
        // Partial platline (from Pd, Os, Ir, Rh and leach)
        GTValues.RA.stdBuilder().itemInputs(WerkstoffLoader.PDMetallicPowder.get(OrePrefixes.dust, 32))
                .itemOutputs(
                        Materials.Palladium.getDust(64),
                        Materials.Platinum.getDust(64),
                ...
                .metadata(QFT_CATALYST, GregtechItemList.PlatinumGroupCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 1)
                .addTo(quantumForceTransformerRecipes);
        GTValues.RA.stdBuilder().itemInputs(WerkstoffLoader.IrLeachResidue.get(OrePrefixes.dust, 32))
                .itemOutputs(
                        Materials.Iridium.getDust(64),
                        Materials.Platinum.getDust(64),
                ...
                .metadata(QFT_CATALYST, GregtechItemList.PlatinumGroupCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 1)
                .addTo(quantumForceTransformerRecipes);
        GTValues.RA.stdBuilder().itemInputs(WerkstoffLoader.IrOsLeachResidue.get(OrePrefixes.dust, 32))
                .itemOutputs(
                        Materials.Osmium.getDust(64),
                        Materials.Iridium.getDust(64),
                        Materials.Osmiridium.getDust(64))
                ...
                .metadata(QFT_CATALYST, GregtechItemList.PlatinumGroupCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 1)
                .addTo(quantumForceTransformerRecipes);
        GTValues.RA.stdBuilder().itemInputs(WerkstoffLoader.CrudeRhMetall.get(OrePrefixes.dust, 32))
                .itemOutputs(
                        WerkstoffLoader.Rhodium.get(OrePrefixes.dust, 64),
                        Materials.Palladium.getDust(64),
                        Materials.Platinum.getDust(64),
                ...
                .metadata(QFT_CATALYST, GregtechItemList.PlatinumGroupCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 1)
                .addTo(quantumForceTransformerRecipes);
        GTValues.RA.stdBuilder().itemInputs(WerkstoffLoader.LeachResidue.get(OrePrefixes.dust, 32))
                .itemOutputs(
                        Materials.Iridium.getDust(64),
                        Materials.Osmium.getDust(64),
                        WerkstoffLoader.Rhodium.get(OrePrefixes.dust, 64),
                ...
                .addTo(quantumForceTransformerRecipes);
        // Early Plastics
        GTValues.RA.stdBuilder().itemInputs(Materials.Carbon.getDust(64))
                .fluidInputs(
                ...
                .duration(20 * SECONDS).eut(TierEU.RECIPE_ZPM)
                .metadata(QFT_CATALYST, GregtechItemList.PlasticPolymerCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 1)
                .addTo(quantumForceTransformerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(Materials.Carbon.getDust(64))
                ...
                .duration(20 * SECONDS).eut(TierEU.RECIPE_ZPM)
                .metadata(QFT_CATALYST, GregtechItemList.RubberPolymerCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 1)
                .noBuffer().addTo(quantumForceTransformerRecipes);
        // Glues and Solders
        GTValues.RA.stdBuilder().itemInputs(Materials.Carbon.getDust(32), Materials.Bismuth.getDust(32))
                ...
                .duration(20 * SECONDS).eut(TierEU.RECIPE_UV)
                .metadata(QFT_CATALYST, GregtechItemList.AdhesionPromoterCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 1)
                .addTo(quantumForceTransformerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(20 * SECONDS).eut(TierEU.RECIPE_UV)
                .metadata(QFT_CATALYST, GregtechItemList.TitaTungstenIndiumCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 1)
                .addTo(quantumForceTransformerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(Materials.Thorium.getDust(32), Materials.Uranium.getDust(32))
                .itemOutputs(
                ...
                .duration(20 * SECONDS).eut(TierEU.RECIPE_UV)
                .metadata(QFT_CATALYST, GregtechItemList.RadioactivityCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 1)
                .addTo(quantumForceTransformerRecipes);
        // Monaline
        GTValues.RA.stdBuilder().itemInputs(Materials.Monazite.getDust(32))
                .itemOutputs(
                ...
                .duration(20 * SECONDS).eut(TierEU.RECIPE_UHV)
                .metadata(QFT_CATALYST, GregtechItemList.RareEarthGroupCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 2)
                .addTo(quantumForceTransformerRecipes);
        // Bastline
        GTValues.RA.stdBuilder().itemInputs(Materials.Bastnasite.getDust(32))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(WerkstoffMaterialPool.CeriumRichMixture.get(OrePrefixes.dust, 16))
                .itemOutputs(
                        Materials.Holmium.getDust(64),
                        Materials.Cerium.getDust(64),
                        Materials.Samarium.getDust(64),
        ...
        if (EtFuturumRequiem.isModLoaded()) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidOutputs(Materials.NefariousOil.getFluid(64_000)).duration(20 * SECONDS).eut(TierEU.RECIPE_UHV)
                    .metadata(QFT_CATALYST, GregtechItemList.HellishForceCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 2)
                    .addTo(quantumForceTransformerRecipes);
        }
        // Prismarine
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(Materials.PrismaticAcid.getFluid(32_000)).duration(20 * SECONDS).eut(TierEU.RECIPE_UHV)
                .metadata(QFT_CATALYST, GregtechItemList.CrystalColorizationCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 2)
                .addTo(quantumForceTransformerRecipes);
        // Stem Cells
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .duration(20 * SECONDS).eut(TierEU.RECIPE_UEV)
                .metadata(QFT_CATALYST, GregtechItemList.RawIntelligenceCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 3)
                .addTo(quantumForceTransformerRecipes);
        // Unknown Particles
        GTValues.RA.stdBuilder()
                .itemOutputs(
                ...
                .fluidOutputs(FluidUtils.getFluidStack("plasma.hydrogen", 1_000)).duration(5 * SECONDS)
                .eut(TierEU.RECIPE_UEV).metadata(QFT_CATALYST, GregtechItemList.ParticleAccelerationCatalyst.get(0))
                .metadata(QFT_FOCUS_TIER, 3).addTo(quantumForceTransformerRecipes);
        // Lategame Plastics (Missing Radox Polymer and Heavy Radox)
        GTValues.RA.stdBuilder().itemInputs(Materials.Carbon.getDust(64), Materials.Osmium.getDust(24))
                ...
                .metadata(QFT_CATALYST, GregtechItemList.UltimatePlasticCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 4)
                .addTo(quantumForceTransformerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .metadata(QFT_FOCUS_TIER, 4).addTo(quantumForceTransformerRecipes);
        // Rare Particles
        GTValues.RA.stdBuilder().itemInputs(GregtechItemList.Laser_Lens_Special.get(1))
                .itemOutputs(
                ...
                .duration(3 * MINUTES + 20 * SECONDS).eut(TierEU.RECIPE_UIV)
                .metadata(QFT_CATALYST, GregtechItemList.SynchrotronCapableCatalyst.get(0)).metadata(QFT_FOCUS_TIER, 4)
                .addTo(quantumForceTransformerRecipes);
    ...
    private static void fusionReactorRecipes() {
        GTValues.RA.stdBuilder().fluidInputs(Materials.Radon.getPlasma(100), Materials.Nitrogen.getPlasma(100))
                .fluidOutputs(new FluidStack(MaterialsElements.getInstance().NEPTUNIUM.getPlasma(), 100))
                .duration(30 * SECONDS).eut(TierEU.RECIPE_UHV).metadata(FUSION_THRESHOLD, 1_000_000_000L)
                .addTo(fusionRecipes);

        GTValues.RA.stdBuilder().fluidInputs(Materials.Americium.getPlasma(100), Materials.Boron.getPlasma(100))
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(1 * SECONDS + 12 * TICKS).eut(TierEU.RECIPE_UEV).metadata(FUSION_THRESHOLD, 6_000_000_000L)
                .addTo(fusionRecipes);
    ...
    private static void catalystRecipes() {
        GTValues.RA.stdBuilder()
                ...
                .duration(60 * SECONDS).eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTUtility.getIntegratedCircuit(10),
                        CI.getEmptyCatalyst(1),
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsElements.STANDALONE.HYPOGEN.getFluidStack(1 * STACKS)).duration(60 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsUEVplus.SpaceTime.getMolten(1 * STACKS)).duration(60 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(GGMaterial.shirabon.getMolten(10 * STACKS)).duration(60 * SECONDS).eut(TierEU.RECIPE_UMV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.DarkIron.getMolten(10 * STACKS)).duration(60 * SECONDS).eut(TierEU.RECIPE_UXV)
                .addTo(assemblerRecipes);
    ...
    private static void tieredCasingRecipes() {
        TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new FluidStack[] { Materials.Thulium.getMolten(144 * 10), MaterialsUEVplus.ExcitedDTCC.getFluid(5_000),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new FluidStack[] { Materials.Thulium.getMolten(144 * 12), MaterialsUEVplus.ExcitedDTPC.getFluid(5_000),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new FluidStack[] { Materials.Thulium.getMolten(144 * 15), MaterialsUEVplus.ExcitedDTRC.getFluid(5_000),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new FluidStack[] { Materials.Thulium.getMolten(20 * INGOTS),
                        MaterialsUEVplus.ExcitedDTEC.getFluid(5_000),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new ItemStack[] { MaterialsAlloy.QUANTUM.getFrameBox(1),
                        ...
                        MaterialsElements.STANDALONE.CHRONOMATIC_GLASS.getScrew(16) },
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialsAlloy.QUANTUM.getFluidStack(6 * INGOTS)).duration(10 * SECONDS)
                .eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
