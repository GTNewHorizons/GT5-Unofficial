...
public class RecipeLoaderIndustrialRockBreaker {
    ...
    public static void run() {
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(1))
                .itemOutputs(new ItemStack(Blocks.cobblestone, 1)).duration(16 * TICKS).eut(TierEU.RECIPE_LV)
                .addTo(multiblockRockBreakerRecipes);

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(2))
                .itemOutputs(new ItemStack(Blocks.stone, 1)).duration(16 * TICKS).eut(TierEU.RECIPE_LV)
                .addTo(multiblockRockBreakerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(new ItemStack(Blocks.obsidian, 1)).duration(6 * SECONDS + 8 * TICKS).eut(TierEU.RECIPE_LV)
                .addTo(multiblockRockBreakerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(new ItemStack(Blocks.netherrack, 1)).duration(16 * TICKS).eut(TierEU.RECIPE_LV)
                .addTo(multiblockRockBreakerRecipes);
        ...
        if (Mods.EtFuturumRequiem.isModLoaded()) {
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(GTOreDictUnificator.get(OrePrefixes.stone, Materials.Basalt, 1L)).duration(16 * TICKS)
                    .eut(TierEU.RECIPE_LV).addTo(multiblockRockBreakerRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(16 * TICKS).eut(TierEU.RECIPE_LV).addTo(multiblockRockBreakerRecipes);
        }
    }
}
