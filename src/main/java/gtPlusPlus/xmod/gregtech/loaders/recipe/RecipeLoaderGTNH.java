...
public class RecipeLoaderGTNH {
    ...
    public static void generate() {
        GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Ball.get(0L))
                ...
                .fluidInputs(new FluidStack(FluidRegistry.getFluid("ender"), 250)).duration(5 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(4 * SECONDS + 16 * TICKS).eut(98304).metadata(FUSION_THRESHOLD, 500_000_000L)
                .addTo(fusionRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(1 * SECONDS + 12 * TICKS).eut(196608).metadata(FUSION_THRESHOLD, 750_000_000L)
                .addTo(fusionRecipes);

        GTValues.RA.stdBuilder()
                .fluidInputs(Materials.Plutonium241.getMolten(1 * INGOTS), Materials.Calcium.getPlasma(1 * INGOTS))
                .fluidOutputs(Materials.Flerovium.getMolten(1 * INGOTS)).duration(8 * SECONDS).eut(196608)
                .metadata(FUSION_THRESHOLD, 1_000_000_000L).addTo(fusionRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(1 * SECONDS + 12 * TICKS).eut(196608).metadata(FUSION_THRESHOLD, 1_000_000_000L)
                .addTo(fusionRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(3 * SECONDS + 4 * TICKS).eut(196608).metadata(FUSION_THRESHOLD, 800_000_000L)
                .addTo(fusionRecipes);
    }
}
