...
public class RecipeLoaderNuclearFuelProcessing {
    ...
    public static void generate() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(FluidUtils.getFluidStack(aLiFBeF2ZrF4U235, 1000)).duration(30 * MINUTES)
                .eut(TierEU.RECIPE_EV).addTo(fissionFuelProcessingRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(FluidUtils.getFluidStack(aLiFBeF2ZrF4UF4, 1000)).duration(40 * MINUTES)
        ...
        GTValues.RA.stdBuilder()
                .fluidInputs(
                        ...
                        FluidUtils.getFluidStack(aUraniumTetraFluoride, 70))
                .fluidOutputs(FluidUtils.getFluidStack(aLiFBeF2ThF4UF4, 1000)).duration(50 * MINUTES)
                .eut(TierEU.RECIPE_IV).addTo(fissionFuelProcessingRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsNuclides.UF6F2.getFluidStack(1500)).duration(10 * MINUTES).eut(TierEU.RECIPE_IV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsNuclides.UF6F2.getFluidStack(3000)).duration(10 * MINUTES).eut(TierEU.RECIPE_IV)
                .addTo(reactorProcessingUnitRecipes);
        // Reactor Blanket step 1 - Fluorination
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsNuclides.UF6F2.getFluidStack(3000)).duration(5 * MINUTES).eut(TierEU.RECIPE_IV)
                .addTo(reactorProcessingUnitRecipes);
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsNuclides.UF6F2.getFluidStack(6000)).duration(5 * MINUTES).eut(TierEU.RECIPE_IV)
                .addTo(reactorProcessingUnitRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                        ...
                        MaterialsElements.getInstance().URANIUM233.getDust(1),
                        MaterialsElements.getInstance().URANIUM233.getDust(1))
                .outputChances(10000, 10000, 3000, 2000, 1000).fluidInputs(MaterialsNuclides.UF6F2.getFluidStack(3000))
                .fluidOutputs(MaterialsFluorides.SODIUM_FLUORIDE.getFluidStack(2000)).duration(10 * MINUTES)
                .eut(TierEU.RECIPE_HV).addTo(coldTrapRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(MaterialsNuclides.UF6F2FP.getCell(1)).outputChances(10000)
                .fluidInputs(MaterialsNuclides.LiFBeF2UF4FP.getFluidStack(1000))
                .fluidOutputs(new FluidStack(GTPPFluids.ImpureMoltenSaltBase, 1000)).duration(2 * HOURS)
                .eut(TierEU.RECIPE_HV).addTo(reactorProcessingUnitRecipes);
        // LiBeF2UF4FP + F2 = LiFBeF2 & UF6F2FP
        // Reactor Core step 1 - Process Burnt Salt
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(new FluidStack(GTPPFluids.ImpureMoltenSaltBase, 2000)).duration(60 * MINUTES)
                .eut(TierEU.RECIPE_HV).addTo(reactorProcessingUnitRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsFluorides.SODIUM_FLUORIDE.getFluidStack(2000)).duration(10 * MINUTES)
                .eut(TierEU.RECIPE_EV).addTo(coldTrapRecipes);

        // Reactor Core step 2B - Distillation
        GTValues.RA.stdBuilder().fluidInputs(new FluidStack(GTPPFluids.ImpureMoltenSaltBase, 1000))
                .fluidOutputs(MaterialsNuclides.LiFBeF2.getFluidStack(250)).duration(7 * MINUTES + 30 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsNuclides.LiFBeF2UF4.getFluidStack(3000)).duration(2 * MINUTES + 30 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(2 * MINUTES + 30 * SECONDS).eut(TierEU.RECIPE_IV).metadata(CHEMPLANT_CASING_TIER, 4)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsNuclides.LiFBeF2ZrF4UF4.getFluidStack(1000)).duration(12 * MINUTES)
                .eut(TierEU.RECIPE_IV).addTo(fissionFuelProcessingRecipes);
        GTValues.RA.stdBuilder()
                .fluidInputs(
                        MaterialsFluorides.THORIUM_TETRAFLUORIDE.getFluidStack(100),
                        MaterialsNuclides.LiFBeF2UF4.getFluidStack(900))
                .fluidOutputs(MaterialsNuclides.LiFBeF2ThF4UF4.getFluidStack(1000)).duration(15 * MINUTES)
                .eut(TierEU.RECIPE_IV).addTo(fissionFuelProcessingRecipes);
    }
}
