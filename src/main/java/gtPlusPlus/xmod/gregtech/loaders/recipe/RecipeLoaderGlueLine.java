...
public class RecipeLoaderGlueLine {
    ...
    private static void chemicalPlantRecipes() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                ...
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.MethylAcetate, Materials2FluidShapes.fluidLiquid, (int) (1_000)))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.AceticAcid, Materials2FluidShapes.fluidLiquid, (int) (1_000)),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Chlorine, Materials2FluidShapes.fluidGas, (int) (1_000)),
                MaterialUtils.legacyGtppFluid(Materials2Materials.AceticAnhydride, 1_000))
            .fluidOutputs(
                MaterialUtils.legacyGtppFluid(Materials2Materials.ChloroaceticMixture, 1_000),
                MaterialUtils.legacyGtppFluid(Materials2Materials.AceticAnhydride, 950))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials2Materials.SodiumCarbonate, Materials2Shapes.dust, (int) (6)),
                MaterialLibAPI.getStack(Materials2Materials.SodiumCyanide, Materials2Shapes.dust, 3))
            .circuit(19)
            .itemOutputs(
                MaterialLibAPI.getStack(Materials2Materials.CyanoaceticAcid, Materials2Shapes.dust, 9),
                MaterialLibAPI.getStack(Materials2Materials.Salt, Materials2Shapes.dust, (int) (6)))
            .fluidInputs(
                MaterialUtils.legacyGtppFluid(Materials2Materials.ChloroaceticAcid, 1_000),
                MaterialUtils.fluid(Materials2Materials.HydrochloricAcidGT5U, 2_000))
            .fluidOutputs(
                MaterialLibAPI
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials2Materials.CopperIISulfate, Materials2Shapes.dust, 6),
                MaterialLibAPI.getStack(Materials2Materials.CyanoaceticAcid, Materials2Shapes.dust, 45))
            .circuit(20)
            .itemOutputs(
                MaterialLibAPI.getStack(Materials2Materials.CopperIISulfatePentahydrate, Materials2Shapes.dust, 11))
            .fluidInputs(
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Ethanol, Materials2FluidShapes.fluidLiquid, (int) (5_000)))
            .fluidOutputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacetate, 5_000))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialLibAPI.getStack(Materials2Materials.CyanoaceticAcid, Materials2Shapes.dust, 9))
            .circuit(21)
            .fluidInputs(
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Ethanol, Materials2FluidShapes.fluidLiquid, (int) (1_000)))
            .fluidOutputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacetate, 1_000))
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(22)
            .fluidInputs(
                MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacetate, 100),
                new FluidStack(GTPPFluids.Formaldehyde, 100))
            .fluidOutputs(
                MaterialUtils.legacyGtppFluid(Materials2Materials.CyanoacrylatePolymer, 100),
                GTUtility.getWater(1_000))
            .duration(10 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(
                MaterialUtils.legacyGtppFluid(Materials2Materials.HydrogenCyanide, 2_000),
    ...
    private static void chemicalReactorRecipes() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(17)
            .itemOutputs(MaterialLibAPI.getStack(Materials2Materials.SodiumCyanide, Materials2Shapes.dust, 3))
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.HydrogenCyanide, 1_000))
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(19)
            .itemOutputs(MaterialLibAPI.getStack(Materials2Materials.CopperIISulfate, Materials2Shapes.dust, 6))
            .fluidInputs(
                MaterialLibAPI
    ...
    private static void distillationTowerRecipes() {
        GTValues.RA.stdBuilder()
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.ChloroaceticMixture, 1_000))
            .fluidOutputs(
                MaterialUtils.legacyGtppFluid(Materials2Materials.ChloroaceticAcid, 100),
                MaterialUtils.legacyGtppFluid(Materials2Materials.DichloroaceticAcid, 450),
                MaterialUtils.legacyGtppFluid(Materials2Materials.TrichloroaceticAcid, 450))
            .duration(4 * SECONDS)
            .eut(TierEU.RECIPE_IV)
    ...
    private static void fluidHeaterRecipes() {
        ...
        GTValues.RA.stdBuilder()
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.CyanoacrylatePolymer, 100))
            .fluidOutputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacrylateSuperGlue, 100))
            .duration(45 * SECONDS)
            .eut(TierEU.RECIPE_HV)
    ...
    private static void mixerRecipes() {
        GTValues.RA.stdBuilder()
            .itemInputs(MU.cellStack(Materials2Materials.DichloroaceticAcid, 1))
            .circuit(1)
            ...
            .fluidOutputs(MaterialUtils.legacyGtppFluid(Materials2Materials.ChloroaceticMixture, 2_000))
            .duration(5 * SECONDS)
            .eut(100)
            .addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials2Materials.SulfurTrioxide, Materials2CellShapes.cell, (int) (1)))
            .circuit(2)
            .itemOutputs(ItemList.Cell_Empty.get(1))
            .fluidInputs(
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.SulfuricAcid, Materials2FluidShapes.fluidLiquid, (int) (1_000)))
            .fluidOutputs(MaterialUtils.legacyGtppFluid(Materials2Materials.SolidAcidCatalystMixture, 1_000))
            .duration(5 * SECONDS)
            .eut(40)
            .addTo(mixerRecipes);
    ...
    private static void glueUsageRecipes() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                MaterialLibAPI.getStack(Materials2Materials.Polybenzimidazole, Materials2Shapes.plate, (int) (1)),
                GTModHandler.getIC2Item("carbonMesh", 1L))
            .circuit(10)
            .itemOutputs(ItemList.Duct_Tape.get(16L))
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacrylateSuperGlue, 100))
            .duration(6 * SECONDS)
            .eut(TierEU.RECIPE_LV)
        ...
        GTValues.RA.stdBuilder()
            ...
            .circuit(2)
            .itemOutputs(MaterialLibAPI.getStack(Materials2Materials.Graphene, Materials2Shapes.dust, (int) (64)))
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacrylateSuperGlue, 1000))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_IV)
            .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
            ...
            .circuit(2)
            .itemOutputs(MaterialLibAPI.getStack(Materials2Materials.Graphene, Materials2Shapes.dust, (int) (64)))
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacrylateSuperGlue, 750))
            .duration(10 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                GTUtility.copyAmountUnsafe(
                    128,
                    MaterialLibAPI.getStack(Materials2Materials.Graphene, Materials2Shapes.dust, (int) (1))))
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacrylateSuperGlue, 500))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_LuV)
            .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                GTUtility.copyAmountUnsafe(
                    512,
                    MaterialLibAPI.getStack(Materials2Materials.Graphene, Materials2Shapes.dust, (int) (1))))
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacrylateSuperGlue, 250))
            .duration(5 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials2Materials.Wood, Materials2Shapes.dust, (int) (4)))
            .circuit(1)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                MaterialLibAPI.getStack(Materials2Materials.Polybenzimidazole, Materials2Shapes.dustTiny, (int) (1)))
            .circuit(1)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacrylateSuperGlue, 200))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacrylateSuperGlue, 144))
            .duration(15 * SECONDS)
            .eut(TierEU.RECIPE_IV)
            .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacrylateSuperGlue, 288))
            .duration(10 * SECONDS)
            .eut(TierEU.RECIPE_LuV)
            .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacrylateSuperGlue, 576))
            .duration(15 * SECONDS)
            .eut(TierEU.RECIPE_ZPM)
            .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacrylateSuperGlue, 1152))
            .duration(5 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacrylateSuperGlue, 2304))
            .duration(10 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacrylateSuperGlue, 4608))
            .duration(15 * SECONDS)
            .eut(TierEU.RECIPE_UHV)
            .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacrylateSuperGlue, 9216))
            .duration(30 * SECONDS)
            .eut(TierEU.RECIPE_UHV)
            .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialUtils.legacyGtppFluid(Materials2Materials.EthylCyanoacrylateSuperGlue, 18432))
            .duration(60 * SECONDS)
            .eut(TierEU.RECIPE_UHV)
            .addTo(assemblerRecipes);
