...
public class RecipeLoaderGlueLine {
    ...
    private static void chemicalPlantRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialMisc.ACETIC_ANHYDRIDE.getFluidStack(1_000)).duration(10 * SECONDS)
                .eut(TierEU.RECIPE_HV).metadata(CHEMPLANT_CASING_TIER, 3).addTo(chemicalPlantRecipes);
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(18))
                .fluidInputs(
                ...
                .duration(2 * MINUTES + 30 * SECONDS).eut(1000).metadata(CHEMPLANT_CASING_TIER, 4)
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(20 * SECONDS).eut(1000).metadata(CHEMPLANT_CASING_TIER, 4).addTo(chemicalPlantRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialMisc.ETHYL_CYANOACETATE.getFluidStack(5_000)).duration(8 * MINUTES + 20 * SECONDS)
                .eut(6000).metadata(CHEMPLANT_CASING_TIER, 5).addTo(chemicalPlantRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(16 * MINUTES + 40 * SECONDS).eut(6000).metadata(CHEMPLANT_CASING_TIER, 5)
                .addTo(chemicalPlantRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(10 * SECONDS).eut(TierEU.RECIPE_IV).metadata(CHEMPLANT_CASING_TIER, 5)
                .addTo(chemicalPlantRecipes);
        // CH4 + NH3 + 3O = HCN + 3H2O
        GTValues.RA.stdBuilder()
                ...
                .duration(10 * SECONDS).eut(TierEU.RECIPE_HV).metadata(CHEMPLANT_CASING_TIER, 3)
                .addTo(chemicalPlantRecipes);
    ...
    private static void chemicalReactorRecipes() {
        // NaOH + HCN = NaCN + H2O
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(17), Materials.SodiumHydroxide.getDust(3))
                .itemOutputs(MaterialMisc.SODIUM_CYANIDE.getDust(3))
                .fluidInputs(MaterialMisc.HYDROGEN_CYANIDE.getFluidStack(1_000))
                .fluidOutputs(Materials.Water.getFluid(1_000)).duration(10 * SECONDS).eut(TierEU.RECIPE_LV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(MaterialMisc.COPPER_SULFATE.getDust(6)).fluidInputs(Materials.SulfuricAcid.getFluid(2_000))
                .fluidOutputs(FluidUtils.getFluidStack("dilutedsulfuricacid", 1_000)).duration(5 * SECONDS)
    ...
    private static void dehydratorRecipes() {
        GTValues.RA.stdBuilder().itemInputs(MaterialMisc.COPPER_SULFATE_HYDRATED.getDust(11))
                .itemOutputs(MaterialMisc.COPPER_SULFATE.getDust(6)).fluidOutputs(Materials.Water.getFluid(5_000))
                .eut(10).duration(5 * MINUTES).addTo(chemicalDehydratorRecipes);
    }

    private static void distillationTowerRecipes() {
        GTValues.RA.stdBuilder().fluidInputs(MaterialMisc.CHLOROACETIC_MIXTURE.getFluidStack(1_000))
                .fluidOutputs(
                ...
                .duration(4 * SECONDS).eut(TierEU.RECIPE_IV).addTo(distillationTowerRecipes);

    }

    private static void fluidHeaterRecipes() {

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(16))
                .fluidInputs(MaterialMisc.CYANOACRYLATE_POLYMER.getFluidStack(100))
                .fluidOutputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(100)).duration(45 * SECONDS)
    ...
    private static void mixerRecipes() {
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialMisc.CHLOROACETIC_MIXTURE.getFluidStack(2_000)).duration(5 * SECONDS).eut(100)
                .addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ItemUtils.getItemStackOfAmountFromOreDict("cellSulfurTrioxide", 1),
                        GTUtility.getIntegratedCircuit(2))
                .itemOutputs(ItemList.Cell_Empty.get(1)).fluidInputs(Materials.SulfuricAcid.getFluid(1_000))
                .fluidOutputs(MaterialMisc.SOLID_ACID_MIXTURE.getFluidStack(1_000)).duration(5 * SECONDS).eut(40)
                .addTo(mixerRecipes);
    ...
    private static void glueUsageRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(100)).duration(6 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(1000)).duration(10 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTUtility.getIntegratedCircuit(2))
                .itemOutputs(Materials.Graphene.getDust(64))
                .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(750)).duration(10 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(500)).duration(10 * SECONDS)
                .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        Materials.Graphite.getDust(64),
                ...
                .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(250)).duration(5 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(100)).duration(1 * MINUTES + 20 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(200)).duration(1 * SECONDS + 12 * TICKS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(144)).duration(15 * SECONDS)
                .eut(TierEU.RECIPE_IV).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(288)).duration(10 * SECONDS)
                .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(576)).duration(15 * SECONDS)
                .eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(1152)).duration(5 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(2304)).duration(10 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(4608)).duration(15 * SECONDS)
                .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(9216)).duration(30 * SECONDS)
                .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.wireGt16, Materials.SuperconductorUHV, 2),
                ...
                .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(18432)).duration(60 * SECONDS)
                .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
        ...
        if (NewHorizonsCoreMod.isModLoaded() && GalacticraftCore.isModLoaded()) {
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(MaterialMisc.ETHYL_CYANOACRYLATE.getFluidStack(576)).duration(30 * SECONDS).eut(1024)
