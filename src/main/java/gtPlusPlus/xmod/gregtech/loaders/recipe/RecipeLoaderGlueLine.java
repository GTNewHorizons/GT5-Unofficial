...
public class RecipeLoaderGlueLine {
    ...
    private static void chemicalPlantRecipes() {
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_Utility.getIntegratedCircuit(21), MaterialMisc.CYANOACETIC_ACID.getDust(9))
    ...
    private static void mixerRecipes() {
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_Utility.getIntegratedCircuit(1), MaterialMisc.DICHLOROACETIC_ACID.getCell(1))
