...
public class RecipeLoaderNuclear {
    ...
    private static void autoclave() {
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("dustZirconium", 1))
                .itemOutputs(ItemUtils.getItemStackOfAmountFromOreDict("pelletZirconium", 1))
                .fluidInputs(FluidUtils.getFluidStack("chlorine", 4_000)).duration(15 * SECONDS).eut(TierEU.RECIPE_LV)
    ...
    private static void blastFurnace() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(MaterialsNuclides.Li2BeF4.getDust(7)).duration(2 * MINUTES + 20 * SECONDS)
                .eut(TierEU.RECIPE_EV).metadata(COIL_HEAT, 3000).addTo(blastFurnaceRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("dustZrCl4", 1))
                .itemOutputs(ItemUtils.getItemStackOfAmountFromOreDict("dustCookedZrCl4", 1)).duration(1 * MINUTES)
                .eut(340).metadata(COIL_HEAT, 300).addTo(blastFurnaceRecipes);
    }

    private static void chemicalBathRecipes() {

        int[] chances = { 9000, 6000, 3000 };
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("dustTin", 12))
                .itemOutputs(
                ...
                .outputChances(chances).fluidInputs(FluidUtils.getFluidStack("chlorine", 2_400)).duration(30 * SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(chemicalBathRecipes);

        chances = new int[] { 9000, 3000, 1000 };
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("dustRutile", 5))
                .itemOutputs(
                        ItemUtils.getItemStackOfAmountFromOreDict("dustZirconium", 3),
                        ItemUtils.getItemStackOfAmountFromOreDict("dustTitanium", 1),
                        ItemUtils.getItemStackOfAmountFromOreDict("dustHafnium", 1))
                .outputChances(chances).fluidInputs(FluidUtils.getFluidStack("chlorine", 4_000)).duration(30 * SECONDS)
                .eut(1024).addTo(chemicalBathRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("dustLithiumCarbonate", 3))
                .itemOutputs(ItemUtils.getItemStackOfAmountFromOreDict("dustLithiumFluoride", 2))
                .fluidInputs(FluidUtils.getFluidStack("hydrofluoricacid", 500)).duration(9 * SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(chemicalBathRecipes);
    ...
    private static void chemicalReactorRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemUtils.getItemStackOfAmountFromOreDict("dustLi2CO3CaOH2", 11)).duration(10 * MINUTES)
                .eut(TierEU.RECIPE_LV).addTo(UniversalChemical);

        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("dustLithiumHydroxide", 3))
                .itemOutputs(ItemUtils.getItemStackOfAmountFromOreDict("dustLithiumFluoride", 2))
                .fluidInputs(FluidUtils.getFluidStack("hydrofluoricacid", 500))
                .fluidOutputs(Materials.Water.getFluid(1_000)).duration(2 * MINUTES).eut(TierEU.RECIPE_LV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.Cell_Empty.get(8)).fluidInputs(Materials.Water.getFluid(8_000))
                .fluidOutputs(FluidUtils.getFluidStack("lithiumhydroxide", 48 * INGOTS)).duration(5 * MINUTES)
                .eut(TierEU.RECIPE_LV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialMisc.HYDROXIDE.getFluidStack(1_000)).duration(8 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsFluorides.BERYLLIUM_HYDROXIDE.getFluidStack(3 * INGOTS)).duration(4 * SECONDS)
                .eut(TierEU.RECIPE_LV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.Cell_Empty.get(1)).fluidInputs(MaterialMisc.AMMONIA.getFluidStack(1_000))
                .fluidOutputs(MaterialsFluorides.AMMONIUM_BIFLUORIDE.getFluidStack(4 * INGOTS)).duration(20 * SECONDS)
                .eut(TierEU.RECIPE_LV).addTo(UniversalChemical);

        // Ammonium Bifluoride
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(3), aGtHydrofluoricAcid)
                .itemOutputs(ItemList.Cell_Empty.get(2)).fluidInputs(MaterialMisc.AMMONIA.getFluidStack(1_000))
                .fluidOutputs(MaterialsFluorides.AMMONIUM_BIFLUORIDE.getFluidStack(4 * INGOTS)).duration(40 * SECONDS)
                .eut(TierEU.RECIPE_LV).addTo(UniversalChemical);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.Cell_Empty.get(1)).fluidInputs(MaterialMisc.AMMONIA.getFluidStack(1_000))
                .fluidOutputs(MaterialMisc.AMMONIUM.getFluidStack(2_000)).duration(20 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(UniversalChemical);

        // Sodium Fluoride
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(15), Materials.SodiumHydroxide.getDust(3))
                .itemOutputs(MaterialsFluorides.SODIUM_FLUORIDE.getDust(2))
                .fluidInputs(FluidUtils.getFluidStack("hydrofluoricacid", 500))
                .fluidOutputs(Materials.Water.getFluid(1_000)).duration(1 * MINUTES).eut(TierEU.RECIPE_LV)
                .addTo(UniversalChemical);
    ...
    private static void dehydratorRecipes() {
        ...
        // Makes 7-Lithium
        GTValues.RA.stdBuilder().fluidInputs(FluidUtils.getFluidStack("sulfuriclithium", 10 * INGOTS))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(FluidUtils.getFluidStack("sulfuriclithium", 10_000)).eut(1_000)
                .duration(1 * MINUTES + 15 * SECONDS).addTo(chemicalDehydratorRecipes);

        // Calcium Hydroxide
        if (ItemUtils.getItemStackOfAmountFromOreDict("dustQuicklime", 1) != null) {
            // CaO + H2O = Ca(OH)2
            GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("dustQuicklime", 2))
                    .itemOutputs(ItemUtils.getItemStackOfAmountFromOreDict("dustCalciumHydroxide", 5))
                    .fluidInputs(Materials.Water.getFluid(1_000)).eut(TierEU.RECIPE_MV).duration(12 * SECONDS)
        ...
        // 2 LiOH + CaCO3
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("dustLi2CO3CaOH2", 11))
                .itemOutputs(
                ...
                .eut(1_000).duration(6 * MINUTES).addTo(chemicalDehydratorRecipes);

        // LiOH Liquid to Dust
        GTValues.RA.stdBuilder().itemOutputs(ItemUtils.getItemStackOfAmountFromOreDict("dustLithiumHydroxide", 1))
                .fluidInputs(FluidUtils.getFluidStack("lithiumhydroxide", 1 * INGOTS)).eut(64).duration(1 * SECONDS)
                .addTo(chemicalDehydratorRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(FluidUtils.getFluidStack("hydrofluoricacid", 400)).fluidOutputs(aHydrogenChloride)
                .eut(TierEU.RECIPE_HV).duration(15 * SECONDS).addTo(chemicalDehydratorRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        ItemUtils.getItemStackOfAmountFromOreDict("dustCookedZrCl4", 1))
                .itemOutputs(MaterialsFluorides.ZIRCONIUM_TETRAFLUORIDE.getDust(1))
                .fluidInputs(FluidUtils.getFluidStack("hydrofluoricacid_gt5u", 800)).fluidOutputs(aHydrogenChloride)
                .eut(TierEU.RECIPE_HV).duration(30 * SECONDS).addTo(chemicalDehydratorRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(MaterialsFluorides.AMMONIUM_TETRAFLUOROBERYLLATE.getFluidStack(1_000)).eut(64)
                .duration(6 * SECONDS).addTo(chemicalDehydratorRecipes);

        GTValues.RA.stdBuilder().itemInputs(MaterialsFluorides.BERYLLIUM_HYDROXIDE.getDust(3))
                .fluidInputs(MaterialsFluorides.AMMONIUM_BIFLUORIDE.getFluidStack(8 * INGOTS))
                .fluidOutputs(
                        Materials.Water.getFluid(2_000),
                        MaterialsFluorides.AMMONIUM_TETRAFLUOROBERYLLATE.getFluidStack(1_000))
                .eut(TierEU.RECIPE_MV).duration(5 * MINUTES).addTo(multiblockChemicalReactorRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(17), ItemList.Cell_Empty.get(3))
                ...
                .eut(TierEU.RECIPE_MV).duration(5 * MINUTES).addTo(chemicalDehydratorRecipes);
    ...
    private static void electroMagneticSeperator() {
        ...
        // Zirconium
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("crushedPurifiedBauxite", 1))
                .itemOutputs(
                ...
                .outputChances(10000, 2500, 4000).duration(20 * SECONDS).eut(24).addTo(electroMagneticSeparatorRecipes);
        // Zircon
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("crushedPurifiedMagnetite", 1))
                .itemOutputs(
                ...
                .outputChances(10000, 1250, 2500).duration(20 * SECONDS).eut(24).addTo(electroMagneticSeparatorRecipes);
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("crushedPurifiedCassiterite", 1))
                .itemOutputs(
    ...
    private static void fluidExtractorRecipes() {
        ...
        // FLiBe fuel
        GTValues.RA.stdBuilder().itemInputs(MaterialsNuclides.Li2BeF4.getDust(1))
                .fluidOutputs(MaterialsNuclides.Li2BeF4.getFluidStack(1 * INGOTS)).duration(5 * SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(fluidExtractionRecipes);

        // Lithium Fluoride
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("dustLithiumFluoride", 1))
                .fluidOutputs(MaterialsFluorides.LITHIUM_FLUORIDE.getFluidStack(1 * INGOTS)).duration(5 * SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(fluidExtractionRecipes);

        // Lithium Fluoride
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("dustBerylliumFluoride", 1))
                .fluidOutputs(MaterialsFluorides.BERYLLIUM_FLUORIDE.getFluidStack(1 * INGOTS)).duration(5 * SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(fluidExtractionRecipes);

        // LFTR Fuel 1
        GTValues.RA.stdBuilder().itemInputs(MaterialsNuclides.LiFBeF2ZrF4U235.getDust(1))
                .fluidOutputs(MaterialsNuclides.LiFBeF2ZrF4U235.getFluidStack(1 * INGOTS))
                .duration(12 * SECONDS + 10 * TICKS).eut(1000).addTo(fluidExtractionRecipes);

        GTValues.RA.stdBuilder().itemInputs(MaterialsNuclides.LiFBeF2ZrF4UF4.getDust(1))
                .fluidOutputs(MaterialsNuclides.LiFBeF2ZrF4UF4.getFluidStack(1 * INGOTS))
                .duration(7 * SECONDS + 10 * TICKS).eut(1500).addTo(fluidExtractionRecipes);

        GTValues.RA.stdBuilder().itemInputs(MaterialsNuclides.LiFBeF2ThF4UF4.getDust(1))
                .fluidOutputs(MaterialsNuclides.LiFBeF2ThF4UF4.getFluidStack(1 * INGOTS))
                .duration(7 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_EV).addTo(fluidExtractionRecipes);

        // ZIRCONIUM_TETRAFLUORIDE
        GTValues.RA.stdBuilder().itemInputs(MaterialsFluorides.ZIRCONIUM_TETRAFLUORIDE.getDust(1))
                .fluidOutputs(MaterialsFluorides.ZIRCONIUM_TETRAFLUORIDE.getFluidStack(1 * INGOTS))
                .duration(10 * SECONDS).eut(512 + 256).addTo(fluidExtractionRecipes);
    }
    ...
    private static void fusionChainRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(3 * SECONDS + 4 * TICKS).eut(TierEU.RECIPE_LuV).metadata(FUSION_THRESHOLD, 100_000_000L)
                .addTo(fusionRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(1 * SECONDS + 12 * TICKS).eut(TierEU.RECIPE_LuV).metadata(FUSION_THRESHOLD, 100_000_000L)
                .addTo(fusionRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(32 * TICKS).eut(TierEU.RECIPE_ZPM).metadata(FUSION_THRESHOLD, 300_000_000L)
                .addTo(fusionRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(16 * TICKS).eut(TierEU.RECIPE_UV).metadata(FUSION_THRESHOLD, 500_000_000L)
                .addTo(fusionRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(8 * TICKS).eut(TierEU.RECIPE_UV).metadata(FUSION_THRESHOLD, 500_000_000L)
                .addTo(fusionRecipes);
    }

    private static void macerator() {
        RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("pelletZirconium", 1))
                .itemOutputs(ItemUtils.getItemStackOfAmountFromOreDict("dustZrCl4", 5)).eut(2).duration(20 * SECONDS)
    ...
    private static void mixerRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(2 * MINUTES + 30 * SECONDS).eut(TierEU.RECIPE_HV).addTo(mixerRecipes);

    }

    private static void sifter() {
        // Zirconium
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("crushedPurifiedIlmenite", 1))
                .itemOutputs(
                        ...
                        ItemUtils.getItemStackOfAmountFromOreDict("dustHafnium", 1),
                        ItemUtils.getItemStackOfAmountFromOreDict("dustHafnium", 1))
                .outputChances(5000, 278, 1000, 1000, 300, 300).duration(30 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(sifterRecipes);
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("crushedPurifiedTin", 1))
                .itemOutputs(
                        ...
                        ItemUtils.getItemStackOfAmountFromOreDict("dustZirconium", 1),
                        ItemUtils.getItemStackOfAmountFromOreDict("dustZirconium", 1))
                .outputChances(10000, 556, 1500, 1000, 500, 500).duration(30 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(sifterRecipes);
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("crushedPurifiedCassiterite", 1))
                .itemOutputs(
                        ItemUtils.getItemStackOfAmountFromOreDict("dustCassiterite", 1),
                ...
                .addTo(sifterRecipes);
        // Radium
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("crushedPurifiedThorium", 1))
                .itemOutputs(
                        ...
                        ItemUtils.getItemStackOfAmountFromOreDict("dustRadium226", 1),
                        ItemUtils.getItemStackOfAmountFromOreDict("dustRadium226", 1))
                .outputChances(10000, 500, 300, 200, 100, 100).duration(30 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(sifterRecipes);
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("crushedPurifiedUranium", 1))
                .itemOutputs(
                        ...
                        ItemUtils.getItemStackOfAmountFromOreDict("dustRadium226", 1),
                        ItemUtils.getItemStackOfAmountFromOreDict("dustRadium226", 1))
                .outputChances(10000, 556, 1000, 500, 500, 500).duration(30 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(sifterRecipes);
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("crushedPurifiedUraninite", 1))
                .itemOutputs(
                        ...
                        ItemUtils.getItemStackOfAmountFromOreDict("dustRadium226", 1),
                        ItemUtils.getItemStackOfAmountFromOreDict("dustRadium226", 1))
                .outputChances(10000, 556, 500, 250, 250, 250).duration(30 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(sifterRecipes);
        GTValues.RA.stdBuilder().itemInputs(ItemUtils.getItemStackOfAmountFromOreDict("crushedPurifiedPitchblende", 1))
                .itemOutputs(
    ...
    private static void fluidHeater() {
        GTValues.RA.stdBuilder().itemInputs(MaterialsFluorides.SODIUM_FLUORIDE.getDust(1))
                .fluidOutputs(MaterialsFluorides.SODIUM_FLUORIDE.getFluidStack(1 * INGOTS)).duration(30 * SECONDS)
