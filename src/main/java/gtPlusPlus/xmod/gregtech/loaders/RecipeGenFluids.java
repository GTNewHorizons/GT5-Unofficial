    ...
    private void generateRecipes(final Material material, final boolean dO) {
        ...
        if (material.getFluidStack(1) != null && !material.getFluidStack(1)
            ...
            if (material.getIngot(1) != null) {
                ...
                Logger
                    .WARNING("144l fluid molder for 1 ingot Recipe: " + material.getLocalDefaultName() + " - Success");
            }
            ...
            if (material.getPlate(1) != null) {
                ...
                Logger
                    .WARNING("144l fluid molder for 1 plate Recipe: " + material.getLocalDefaultName() + " - Success");
            }
            ...
            if (material.getNugget(1) != null) {
                ...
                Logger
                    .WARNING("16l fluid molder for 1 nugget Recipe: " + material.getLocalDefaultName() + " - Success");
            }
            ...
            if (material.getGear(1) != null) {
                ...
                Logger.WARNING("576l fluid molder for 1 gear Recipe: " + material.getLocalDefaultName() + " - Success");
            ...
            if (material.getBlock(1) != null) {
                ...
                Logger.WARNING(
                    (144 * 9) + "l fluid molder from 1 block Recipe: " + material.getLocalDefaultName() + " - Success");
            }
            ...
            if (material.getRod(1) != null) {
                ...
                Logger.WARNING(
                    (144 * 9) + "l fluid molder from 1 rod Recipe: " + material.getLocalDefaultName() + " - Success");
            }
            ...
            if (material.getBolt(1) != null) {
                ...
                Logger.WARNING(
                    (144 * 9) + "l fluid molder from 1 bolt Recipe: " + material.getLocalDefaultName() + " - Success");
            }
            ...
            if (material.getScrew(1) != null) {
                ...
                Logger.WARNING(
                    (144 * 9) + "l fluid molder from 1 screw Recipe: " + material.getLocalDefaultName() + " - Success");
            ...
            if (material.getRing(1) != null) {
                ...
                Logger.WARNING(
                    (144 * 9) + "l fluid molder from 1 ring Recipe: " + material.getLocalDefaultName() + " - Success");
            ...
            if (material.getRotor(1) != null) {
                ...
                Logger.WARNING(
                    (144 * 9) + "l fluid molder from 1 rotor Recipe: " + material.getLocalDefaultName() + " - Success");
            }
        }
    }
}
