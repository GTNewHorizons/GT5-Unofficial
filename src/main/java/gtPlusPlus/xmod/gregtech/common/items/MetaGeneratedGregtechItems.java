...
public class MetaGeneratedGregtechItems extends GTMetaItemX32 {
    ...
    public void generateMetaItems() {
        ...
        GregtechItemList.Distillus_Upgrade_Chip.set(
                this.addItem(
                        ...
                        "Used to upgrade Distillus to Tier 2"));
    ...
    private void registerFuelRTGRecipes() {
        GTValues.RA.stdBuilder().itemInputs(GregtechItemList.Pellet_RTG_PU238.get(1)).duration(0).eut(64)
                .metadata(RTG_DURATION_IN_DAYS, MathUtils.roundToClosestInt(87.7f)).addTo(rtgFuels);

        GTValues.RA.stdBuilder().itemInputs(GregtechItemList.Pellet_RTG_SR90.get(1)).duration(0).eut(TierEU.RECIPE_LV)
                .metadata(RTG_DURATION_IN_DAYS, MathUtils.roundToClosestInt(28.8f)).addTo(rtgFuels);

        GTValues.RA.stdBuilder().itemInputs(GregtechItemList.Pellet_RTG_PO210.get(1)).duration(0).eut(TierEU.RECIPE_HV)
                .metadata(RTG_DURATION_IN_DAYS, 1).addTo(rtgFuels);

        GTValues.RA.stdBuilder().itemInputs(GregtechItemList.Pellet_RTG_AM241.get(1)).duration(0).eut(16)
                .metadata(RTG_DURATION_IN_DAYS, 216).addTo(rtgFuels);

        GTValues.RA.stdBuilder().itemInputs(GTModHandler.getIC2Item("RTGPellets", 1)).duration(0).eut(8)
                .metadata(RTG_DURATION_IN_DAYS, MathUtils.roundToClosestInt(2.6f)).addTo(rtgFuels);
    }
