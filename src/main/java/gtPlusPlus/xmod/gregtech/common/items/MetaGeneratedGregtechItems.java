...
public class MetaGeneratedGregtechItems extends GTMetaItemX32 {
    ...
    private static void registerOverflowValveCover(GregtechItemList cover, int tier, int maxOverflowPoint) {
        CoverFactory<CoverOverflowValve.OverflowValveData> ivOverflowValveFactory = CoverFactory.ofData(
            () -> new CoverOverflowValve.OverflowValveData(maxOverflowPoint, maxOverflowPoint / 10, true, true));
        CoverRegistry.registerCover(
            cover.get(1L),
            TextureFactory.of(
                Textures.BlockIcons.MACHINE_CASINGS[tier][0],
                TextureFactory.of(TexturesGtBlock.Overlay_Overflow_Valve)),
            new CoverOverflowValve(maxOverflowPoint, ivOverflowValveFactory),
            ivOverflowValveFactory);
    }
