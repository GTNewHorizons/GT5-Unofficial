...
public class MTERedstoneCircuitBlock extends MTERedstoneBase implements IRedstoneCircuitBlock, IAddUIWidgets {
    ...
    public void addUIWidgets(ModularWindow.Builder builder, UIBuildContext buildContext) {
        builder.widget(
                new DrawableWidget().setDrawable(GTPPUITextures.PICTURE_REDSTONE_CIRCUIT_SCREEN).setPos(43, 5)
                        .setSize(108, 72));
        for (int i = 0; i < 4; i++) {
            final int index = i;
        ...
        builder.widget(
                ...
                .widget(
                        new CycleButtonWidget()
                                ...
                                .addTooltip(
                                        StatCollector
                                                .translateToLocal("GT5U.gui.tooltip.redstone_circuit.toggle_active"))
                                .setPos(151, 23).setSize(18, 18))
