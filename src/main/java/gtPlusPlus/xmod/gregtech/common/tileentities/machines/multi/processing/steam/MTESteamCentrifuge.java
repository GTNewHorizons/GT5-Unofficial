...
public class MTESteamCentrifuge extends MTESteamMultiBase<MTESteamCentrifuge> implements ISurvivalConstructable {
        ...
        if (STRUCTURE_DEFINITION == null) {
            ...
            STRUCTURE_DEFINITION = StructureDefinition.<MTESteamCentrifuge>builder()
                    ...
                    .addElement(
                            'A',
                            ofChain(
                                    buildSteamInput(MTESteamCentrifuge.class).casingIndex(10).dot(1).build(),
                                    buildHatchAdder(MTESteamCentrifuge.class).atLeast(
                                            SteamHatchElement.InputBus_Steam,
                                            SteamHatchElement.OutputBus_Steam,
                                            OutputHatch).casingIndex(10).dot(1).buildAndChain(),
                                    ofBlocksTiered(
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(getMachineType())
                ...
                .addStructureInfo(
                        EnumChatFormatting.GOLD + "60-65x" + EnumChatFormatting.GRAY + " Bronze Plated Bricks")
