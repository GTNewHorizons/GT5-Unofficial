...
public class GTPPMTEBoilerHV extends GTPPMTEBoilerBase {

    public GTPPMTEBoilerHV(int aID, String aNameRegional, int aBoilerTier) {
        super(aID, aNameRegional, aBoilerTier);
    }

    public GTPPMTEBoilerHV(String aName, int aTier, String[] aDescription, ITexture[][][] aTextures) {
        super(aName, aTier, aDescription, aTextures);
    }

    @Override
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GTPPMTEBoilerHV(this.mName, 3, this.mDescriptionArray, this.mTextures);
    }
