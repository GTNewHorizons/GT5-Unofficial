...
public class MTEQuantumForceTransformer extends MTEExtendedPowerMultiBlockBase<MTEQuantumForceTransformer>
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("machtype.qft")
            ...
            .addInputBus("gt.qft.info.i_bus", 4)
            .addInputHatch("gt.qft.info.i_bus", 4)
            .addOutputHatch("gt.qft.info.o_hatch", 5)
            .addOutputBus("gt.qft.info.o_hatch", 5)
            .addEnergyHatch("gt.qft.info.i_bus", 4)
            .addStructurePart("gt.blockmachines.hatch.catalystbulk.name", "gt.qft.info.i_bus")
