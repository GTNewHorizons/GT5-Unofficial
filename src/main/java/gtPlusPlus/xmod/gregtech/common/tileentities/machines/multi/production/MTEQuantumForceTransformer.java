...
public class MTEQuantumForceTransformer extends MTEExtendedPowerMultiBlockBase<MTEQuantumForceTransformer>
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("machtype.qft")
            .addInfo("gt.qft.tips.1")
            .addSeparator()
            .addInfo("gt.qft.tips.2", TooltipHelper.parallelText("1"))
            .addSeparator()
            .addInfo("gt.qft.tips.3")
            .addSeparator()
            .addInfo("gt.qft.tips.4")
            ...
            .addCasingInfoMin("GT5U.tooltip.structure.manipulator", 236, true)
            .addCasingInfoMin("GT5U.tooltip.structure.shielding", 142, true)
            .addInputBus("gt.qft.info.1", 4)
            .addInputHatch("gt.qft.info.1", 4)
            .addOutputHatch("gt.qft.info.2", 5)
            .addOutputBus("gt.qft.info.2", 5)
            .addEnergyHatch("gt.qft.info.1", 4)
            .addStructurePart("gt.blockmachines.hatch.catalystbulk.name", "gt.qft.info.1")
