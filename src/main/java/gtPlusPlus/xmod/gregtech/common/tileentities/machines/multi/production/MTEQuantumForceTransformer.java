...
public class MTEQuantumForceTransformer extends MTEExtendedPowerMultiBlockBase<MTEQuantumForceTransformer>
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("machtype.qft")
            ...
            .addMiscHatch("1+", "gt.blockmachines.hatch.catalystbulk.name", "gt.qft.info.i_bus", 1)
            .addEnergyHatch("1+", "gt.qft.info.i_bus", 1)
            .addInputAny("1+", "gt.qft.info.i_bus", 1)
            .addOutputAny("1+", "gt.qft.info.o_hatch", 2)
            .addStructureInfo("")
