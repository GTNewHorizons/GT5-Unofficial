...
public class MTEIndustrialDehydrator extends GTPPMultiBlockBase<MTEIndustrialDehydrator>
    ...
    public IStructureDefinition<MTEIndustrialDehydrator> getStructureDefinition() {
        if (STRUCTURE_DEFINITION == null) {
            STRUCTURE_DEFINITION = StructureDefinition.<MTEIndustrialDehydrator>builder().addShape(
                    mName,
                    transpose(
                    ...
                    .addElement(
                            ...
                            activeCoils(
                                    ofCoil(
                                            MTEIndustrialDehydrator::setCoilLevel,
                                            MTEIndustrialDehydrator::getCoilLevel)))
                    .build();
        }
    ...
    protected ProcessingLogic createProcessingLogic() {
        ...
        }.noRecipeCaching().setSpeedBonus(1F / 2.2F).setEuModifier(0.5F).setMaxParallelSupplier(this::getTrueParallel);
    }
