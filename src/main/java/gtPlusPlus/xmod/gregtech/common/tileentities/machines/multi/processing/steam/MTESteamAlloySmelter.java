...
public class MTESteamAlloySmelter extends MTESteamMultiBase<MTESteamAlloySmelter> implements ISurvivalConstructable {
        ...
        if (STRUCTURE_DEFINITION == null) {
            STRUCTURE_DEFINITION = StructureDefinition.<MTESteamAlloySmelter>builder()
                    ...
                    .addElement(
                            'C',
                            ofChain(
                                    buildSteamInput(MTESteamAlloySmelter.class).casingIndex(10).dot(1).build(),
                    ...
                    .addElement(
                            ...
                            ofBlocksTiered(
                                    ...
                                    t -> t.tierPipeCasing))
                    .addElement('G', chainAllGlasses()).build();
        }
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(getMachineType())
                ...
                .addStructureInfo(
                        EnumChatFormatting.GOLD + "16-26x" + EnumChatFormatting.GRAY + " Bronze Plated Bricks")
                .addStructureInfo(EnumChatFormatting.GOLD + "2x" + EnumChatFormatting.GRAY + " Bronze Pipe Casing")
                .addCasingInfoExactly("Any Tiered Glass", 4, true).addStructureInfo("")
                ...
                .addCasingInfoExactly("Any Tiered Glass", 4, true).toolTipFinisher();
        return tt;
    }
    ...
    protected ITexture getFrontOverlay() {
        return TextureFactory.builder().addIcon(Textures.BlockIcons.OVERLAY_FRONT_STEAM_ALLOY_SMELTER_MULTI).extFacing()
                .build();
    }

    @Override
    protected ITexture getFrontOverlayActive() {
        return TextureFactory.builder().addIcon(Textures.BlockIcons.OVERLAY_FRONT_STEAM_ALLOY_SMELTER_MULTI_ACTIVE)
                .extFacing().build();
    }
