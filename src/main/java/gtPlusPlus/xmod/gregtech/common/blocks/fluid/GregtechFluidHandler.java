    ...
    private static void start() {
        ...
        if (!FluidRegistry.isFluidRegistered("cryotheum")) {
            FluidUtils.addGtFluid(
                ...
                4,
                5,
                OreDictUnificator.get(OrePrefixes.cell, GT_Materials.Cryotheum, 1L),
        ...
        if (!FluidRegistry.isFluidRegistered("pyrotheum")) {
            FluidUtils.addGtFluid(
                ...
                4,
                4000,
                OreDictUnificator.get(OrePrefixes.cell, GT_Materials.Pyrotheum, 1L),
                ItemUtils.getEmptyCell(),
                1000);
        }
        if (!FluidRegistry.isFluidRegistered("ender")) {
            FluidUtils.addGtFluid(
                ...
                4,
                4000,
                OreDictUnificator.get(OrePrefixes.cell, GT_Materials.Ender, 1L),
                ItemUtils.getEmptyCell(),
                1000);
        }
        ...
        FluidUtils.addGtFluid(
            ...
            1,
            120,
            OreDictUnificator.get(OrePrefixes.cell, GT_Materials.HydrofluoricAcid, 1L),
            ItemUtils.getEmptyCell(),
            1000,
            false);
        ...
        FluidUtils.addGtFluid(
            ...
            4,
            75,
            OreDictUnificator.get(OrePrefixes.cell, GT_Materials.SulfurousAcid, 1L),
            ItemUtils.getEmptyCell(),
            1000,
            false);
        ...
        FluidUtils.addGtFluid(
            ...
            4,
            500,
            OreDictUnificator.get(OrePrefixes.cell, GT_Materials.SulfuricApatite, 1L),
            ItemUtils.getEmptyCell(),
            1000,
            false);
        ...
        if (FluidUtils.getFluidStack("hydrogenchloride", 1) == null) {
            FluidUtils.addGtFluid(
                ...
                4,
                75,
                OreDictUnificator.get(OrePrefixes.cell, GT_Materials.HydrogenChloride, 1L),
                ItemUtils.getEmptyCell(),
                1000,
                false);
        ...
        FluidUtils.addGtFluid(
            ...
            4,
            280,
            OreDictUnificator.get(OrePrefixes.cell, GT_Materials.SulfuricLithium, 1L),
            ItemUtils.getEmptyCell(),
            1000,
            false);
        ...
        FluidUtils.addGtFluid(
            ...
            4,
            500,
            OreDictUnificator.get(OrePrefixes.cell, GT_Materials.LithiumHydroxide, 1L),
            ItemUtils.getEmptyCell(),
            1000,
            false);
