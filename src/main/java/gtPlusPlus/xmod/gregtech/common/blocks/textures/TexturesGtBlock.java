...
public class TexturesGtBlock {
    ...
    public static final CustomIcon TEXTURE_PIPE_BABBITALLOY = new CustomIcon("iconsets/MACHINE_CASING_PIPE_BABBITALLOY");
    ...
    public static final CustomIcon TEXTURE_PIPE_ABYSSALALLOY = new CustomIcon("iconsets/MACHINE_CASING_PIPE_ABYSSALALLOY");
    ...
    public static final CustomIcon TEXTURE_GEARBOX_EGLINSTEEL = new CustomIcon("iconsets/MACHINE_CASING_GEARBOX_EGLINSTEEL");
    public static final CustomIcon TEXTURE_GEARBOX_ABYSSALALLOY = new CustomIcon("iconsets/MACHINE_CASING_GEARBOX_ABYSSALALLOY");
    public static final CustomIcon TEXTURE_GEARBOX_INCOLOYMA956 = new CustomIcon("iconsets/MACHINE_CASING_GEARBOX_INCOLOYMA956");
    public static final CustomIcon TEXTURE_GEARBOX_INCONEL792 = new CustomIcon("iconsets/MACHINE_CASING_GEARBOX_INCONEL792");
    public static final CustomIcon TEXTURE_GEARBOX_NITINOL60 = new CustomIcon("iconsets/MACHINE_CASING_GEARBOX_NITINOL60");
    public static final CustomIcon TEXTURE_GEARBOX_PIKYONIUM = new CustomIcon("iconsets/MACHINE_CASING_GEARBOX_PIKYONIUM");
    public static final CustomIcon TEXTURE_GEARBOX_TITANSTEEL = new CustomIcon("iconsets/MACHINE_CASING_GEARBOX_TITANSTEEL");
    public static final CustomIcon TEXTURE_GEARBOX_ZERON100 = new CustomIcon("iconsets/MACHINE_CASING_GEARBOX_ZERON100");
