...
public class RecipeIC2 {
    ...
    public static void initRecipes() {
        ...
        GTModHandler.addCraftingRecipe(
                ...
                GTModHandler.RecipeBits.BUFFERED | GTModHandler.RecipeBits.NOT_REMOVABLE
                        | GTModHandler.RecipeBits.REVERSIBLE,
                new Object[] { "hXS", "XPX", "fXd", 'P', ItemList.Shape_Extruder_Rod, 'X',
                        OrePrefixes.plate.get(Materials.TungstenSteel), 'S',
        ...
        GTModHandler.addCraftingRecipe(
                ...
                GTModHandler.RecipeBits.BUFFERED | GTModHandler.RecipeBits.NOT_REMOVABLE
                        | GTModHandler.RecipeBits.REVERSIBLE,
                new Object[] { "hXS", "XPX", "fXd", 'P', ItemList.Shape_Extruder_Rod, 'X',
                        OrePrefixes.plate.get(Materials.Molybdenum), 'S',
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GregtechItemList.EnergeticAlloyShaft.get(1)).duration(2 * MINUTES + 8 * SECONDS).eut(250)
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GregtechItemList.Shape_Extruder_WindmillShaft.get(0))
                .itemOutputs(GregtechItemList.TungstenSteelShaft.get(1)).duration(4 * MINUTES + 16 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GregtechItemList.Shape_Extruder_WindmillShaft.get(0))
                .itemOutputs(GregtechItemList.VibrantAlloyShaft.get(1)).duration(8 * MINUTES + 32 * SECONDS)
                .eut(TierEU.RECIPE_EV).addTo(extruderRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GregtechItemList.Shape_Extruder_WindmillShaft.get(0))
                .itemOutputs(GregtechItemList.IridiumShaft.get(1)).duration(17 * MINUTES + 4 * SECONDS).eut(4000)
                .addTo(extruderRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "SBh", "BRB", "wBS", 'B', GregtechItemList.VibrantAlloyRotorBlade.get(1), 'R',
                        "ringChrome", 'S', GregtechItemList.VibrantAlloyShaft.get(1) });
        GTModHandler.addCraftingRecipe(
                GregtechItemList.IridiumRotor.get(1),
                new Object[] { "SBh", "BRB", "wBS", 'B', GregtechItemList.IridiumRotorBlade.get(1), 'R',
                        "ringOsmiridium", 'S', GregtechItemList.IridiumShaft.get(1) });
    }
    ...
    private static void addAdvancedHazmat() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Rubber.getMolten(144 * 4)).duration(30 * SECONDS).eut(TierEU.RECIPE_MV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Rubber.getMolten(144 * 10)).duration(1 * MINUTES + 30 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Rubber.getMolten(144 * 8)).duration(1 * MINUTES + 15 * SECONDS)
                .eut(TierEU.RECIPE_MV).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Rubber.getMolten(144 * 6)).duration(45 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(assemblerRecipes);
    }
}
