...
public class BartWorksRecipeMaps {
    ...
    public static final RecipeMap<RecipeMapBackend> bioLabRecipes = RecipeMapBuilder.of("bw.recipe.biolab")
            .maxIO(6, 2, 1, 0).minInputs(1, 1).useSpecialSlot().slotOverlays((index, isFluid, isOutput, isSpecial) -> {
                ...
                return null;
            }).progressBar(GTUITextures.PROGRESSBAR_ARROW_MULTIPLE).logo(BWUITextures.PICTURE_BW_LOGO_47X21)
    ...
    public static final RecipeMap<RecipeMapBackend> bacterialVatRecipes = RecipeMapBuilder.of("bw.recipe.BacteriaVat")
            ...
            .progressBar(GTUITextures.PROGRESSBAR_ARROW_MULTIPLE).frontend(BacterialVatFrontend::new)
    ...
    public static final RecipeMap<RecipeMapBackend> circuitAssemblyLineRecipes = RecipeMapBuilder.of("bw.recipe.cal")
            ...
            .progressBar(GTUITextures.PROGRESSBAR_CIRCUIT_ASSEMBLER).build();
    public static final RecipeMap<RecipeMapBackend> radioHatchFakeRecipes = RecipeMapBuilder.of("bw.recipe.radhatch")
            ...
            .logo(BWUITextures.PICTURE_BW_LOGO_47X21).logoSize(47, 21).logoPos(118, 55).dontUseProgressBar()
            .addSpecialTexture(74, 20, 29, 27, BWUITextures.PICTURE_RADIATION).frontend(RadioHatchFrontend::new)
            .build();
    public static final RecipeMap<RecipeMapBackend> electricImplosionCompressorRecipes = RecipeMapBuilder
            ...
            .slotOverlays(
                    (index, isFluid, isOutput, isSpecial) -> !isFluid && !isOutput ? GTUITextures.OVERLAY_SLOT_IMPLOSION
                            : null)
