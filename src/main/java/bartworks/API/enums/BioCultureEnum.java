...
public enum BioCultureEnum {
    ...
    SaccharomycesCerevisiaeVarBayanus("Saccharomyces cerevisiae var bayanus", 2, EnumRarity.uncommon, true,
        BioDataEnum.SaccharomycesCerevisiaeVarBayanus, BioDataEnum.SaccharomycesCerevisiaeVarBayanus,
        new Color(255, 248, 200), ItemList.CultureSaccharomycesCerevisiaeVarBayanus),
    SaccharomycesCerevisiaeVarCerevisiae("Saccharomyces cerevisiae var cerevisiae", 3, EnumRarity.uncommon, true,
        BioDataEnum.SaccharomycesCerevisiaeVarCerevisiae, BioDataEnum.SaccharomycesCerevisiaeVarCerevisiae,
        new Color(255, 248, 200), ItemList.CultureSaccharomycesCerevisiaeVarCerevisiae),
    EscherichiaCadaver("Escherichia cadaver", 4, EnumRarity.uncommon, false, BioDataEnum.BetaLactamase,
        BioDataEnum.BetaLactamase, new Color(110, 40, 25), ItemList.CultureEscherichiaCadaver),
    EscherichiaKoli("Escherichia koli", 5, EnumRarity.uncommon, true, BioDataEnum.EscherichiaKoli,
        BioDataEnum.EscherichiaKoli, new Color(149, 132, 75), ItemList.CultureEscherichiaKoli),
    PseudomonasVeronii("Pseudomonas Veronii", 6, EnumRarity.uncommon, true, BioDataEnum.PseudomonasVeronii2,
        BioDataEnum.PseudomonasVeronii, new Color(0, 0, 0), ItemList.CulturePseudomonasVeronii),
    SaccharomycesEscherichia("Saccharomyces escherichia", 7, EnumRarity.epic, true, BioDataEnum.EscherichiaKoli,
        BioDataEnum.SaccharomycesCerevisiae, new Color(127, 69, 26), ItemList.CultureSaccharomycesEscherichia),
    BarnadafisArboriatoris("Barnadafis Arboriatoris", 8, EnumRarity.rare, true, BioDataEnum.BarnadafisArboriatoris,
        BioDataEnum.BarnadafisArboriatoris, new Color(133, 0, 128), ItemList.CultureBarnadafisArboriatoris),
    TcetieisFucusSerratus("TCetiEis Fucus Serratus", 9, EnumRarity.rare, true, BioDataEnum.TcetieisFucusSerratus,
