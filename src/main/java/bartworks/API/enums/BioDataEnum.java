...
public enum BioDataEnum {
    ...
    BarnadafisArboriatoris("Barnadafis Arboriatoris", 8, EnumRarity.rare, 7_50, VoltageIndex.IV,
        ItemList.DNABarnadafisArboriatoris, ItemList.PlasmidBarnadafisArboriatoris),
    TcetieisFucusSerratus("TCetiEis Fucus Serratus", 9, EnumRarity.rare, 7_50, VoltageIndex.IV,
