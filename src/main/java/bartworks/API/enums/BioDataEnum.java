...
public enum BioDataEnum {
    ...
    BetaLactamase("beta-Lactamase", 0, EnumRarity.uncommon, 100_00, VoltageIndex.HV, ItemList.DNABetaLactamase,
    ...
    SaccharomycesCerevisiaeVarCerevisiae("Saccharomyces cerevisiae var cerevisiae", 4, EnumRarity.uncommon, 75_00,
        VoltageIndex.HV, ItemList.DNASaccharomycesCerevisiaeVarCerevisiae,
        ItemList.PlasmidSaccharomycesCerevisiaeVarCerevisiae),
    EscherichiaKoli("Escherichia koli", 5, EnumRarity.uncommon, 100_00, VoltageIndex.HV, ItemList.DNAEscherichiaKoli,
        ItemList.PlasmidEscherichiaKoli),
    PseudomonasVeronii("Pseudomonas Veronii", 6, EnumRarity.uncommon, 75_00, VoltageIndex.HV,
        ItemList.DNAPseudomonasVeronii, ItemList.PlasmidPseudomonasVeronii),
    PseudomonasVeronii2("Pseudomonas Veronii", 7, EnumRarity.uncommon, 50_00, VoltageIndex.EV,
        ItemList.DNAPseudomonasVeronii2, ItemList.PlasmidPseudomonasVeronii2),
    BarnadafisArboriatoris("Barnadafis Arboriatoris", 8, EnumRarity.epic, 38_70, VoltageIndex.IV,
        ItemList.DNABarnadafisArboriatoris, ItemList.PlasmidBarnadafisArboriatoris),
    TcetieisFucusSerratus("TCetiEis Fucus Serratus", 9, EnumRarity.epic, 38_70, VoltageIndex.IV,
        ItemList.DNATcetieisFucusSerratus, ItemList.PlasmidTcetieisFucusSerratus),
    Stemcellbac("StemCellBac", 10, EnumRarity.rare, 7_50, VoltageIndex.LuV, ItemList.DNAStemcellbac,
        ItemList.PlasmidStemcellbac),
    Biocellbac("BioCellBac", 11, EnumRarity.epic, 3_00, VoltageIndex.ZPM, ItemList.DNABiocellbac,
        ItemList.PlasmidBiocellbac),
    Binnigrowthmedium("BinniGrowthMedium", 12, EnumRarity.common, 90_00, VoltageIndex.HV, ItemList.DNABinnigrowthmedium,
        ItemList.PlasmidBinnigrowthmedium),
    Binnibacteria("BinniBacteria", 13, EnumRarity.common, 60_00, VoltageIndex.HV, ItemList.DNABinnibacteria,
        ItemList.PlasmidBinnibacteria),
    Bacterialsludgebac("BacterialSludgeBac", 14, EnumRarity.uncommon, 30_00, VoltageIndex.EV,
        ItemList.DNABacterialsludgebac, ItemList.PlasmidBacterialsludgebac),
    Mutagen("Mutagen", 15, EnumRarity.rare, 15_00, VoltageIndex.EV, ItemList.DNAMutagen, ItemList.PlasmidMutagen),
    PenicilliumChrysogenum("Penicillium chrysogenum", 16, EnumRarity.uncommon, 75_00, VoltageIndex.HV,
    ...
    BioDataEnum(String name, int id, EnumRarity rarity, int chance, int tier, ItemList DNASampleFlask,
        ItemList plasmidCell) {
        this.name = name;
        this.id = id;
        this.rarity = rarity;
        this.chance = chance;
