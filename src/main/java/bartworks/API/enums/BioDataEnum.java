...
public enum BioDataEnum {
    ...
    Stemcellbac("StemCellBac", 11, EnumRarity.rare, 7_50, VoltageIndex.LuV, ItemList.DNAStemcellbac,
        ItemList.PlasmidStemcellbac),
    Biocellbac("BioCellBac", 12, EnumRarity.epic, 3_00, VoltageIndex.ZPM, ItemList.DNABiocellbac,
        ItemList.PlasmidBiocellbac),
    Binnigrowthmedium("BinniGrowthMedium", 13, EnumRarity.common, 90_00, VoltageIndex.HV, ItemList.DNABinnigrowthmedium,
        ItemList.PlasmidBinnigrowthmedium),
    Binnibacteria("BinniBacteria", 14, EnumRarity.common, 60_00, VoltageIndex.HV, ItemList.DNABinnibacteria,
