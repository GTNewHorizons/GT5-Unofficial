...
public enum BioDNAEnum {
    ...
    PseudomonasVeronii2("Pseudomonas Veronii", 7, EnumRarity.uncommon),
    ...
    BioDNAEnum(String name, int id, EnumRarity rarity){
        this.name = name;
        this.id = id;
        this.rarity = rarity;
    }
