...
public class Assembler implements Runnable {
    ...
    public void run() {
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(GTModHandler.getIC2Coolant(1_000)).duration(5 * SECONDS).eut(TierEU.RECIPE_HV)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemRegistry.megaMachines[0]).fluidInputs(Materials.SolderingAlloy.getMolten(1 * STACKS))
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemRegistry.megaMachines[1]).fluidInputs(Materials.SolderingAlloy.getMolten(1 * STACKS))
                .duration(1 * HOURS).eut(TierEU.RECIPE_HV).addTo(assemblerRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemList.Distillation_Tower.get(64), GTUtility.getIntegratedCircuit(17))
                .itemOutputs(ItemRegistry.megaMachines[2]).fluidInputs(Materials.SolderingAlloy.getMolten(1 * STACKS))
                .duration(1 * HOURS).eut(TierEU.RECIPE_HV).addTo(assemblerRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Machine_Multi_LargeChemicalReactor.get(64), GTUtility.getIntegratedCircuit(17))
                .itemOutputs(ItemRegistry.megaMachines[3]).fluidInputs(Materials.SolderingAlloy.getMolten(1 * STACKS))
                .duration(1 * HOURS).eut(TierEU.RECIPE_HV).addTo(assemblerRecipes);

        GTValues.RA.stdBuilder().itemInputs(ItemList.OilCracker.get(64), GTUtility.getIntegratedCircuit(17))
                .itemOutputs(ItemRegistry.megaMachines[4]).fluidInputs(Materials.SolderingAlloy.getMolten(1 * STACKS))
                .duration(1 * HOURS).eut(TierEU.RECIPE_HV).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder() // DEHP
                ...
                .itemOutputs(ItemRegistry.dehp).fluidInputs(Materials.HSSE.getMolten(32 * INGOTS))
                .duration(60 * SECONDS).eut(TierEU.RECIPE_IV).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Plastic.getMolten(8 * INGOTS)).duration(1 * TICKS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.SolderingAlloy.getMolten(2 * INGOTS)).duration(30 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.Distillation_Tower.get(1)).duration(10 * SECONDS).eut(30).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(ItemList.Hatch_Output_HV.get(64), GTUtility.getIntegratedCircuit(17))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Concrete.getMolten(9 * INGOTS)).duration(2 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Lead.getMolten(6 * INGOTS)).duration(10 * SECONDS).eut(TierEU.RECIPE_LuV)
                .addTo(assemblerRecipes);
    }
}
