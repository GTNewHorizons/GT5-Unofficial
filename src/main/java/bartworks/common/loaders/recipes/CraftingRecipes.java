    ...
    public void run() {
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "DS ", "DP ", "DCB", 'D',
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Diamond, 1L), 'S',
                        GTOreDictUnificator.get(OrePrefixes.stick, Materials.TungstenSteel, 1L), 'P',
                        GTOreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 1L), 'C', "circuitGood",
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "DS ", "DP ", "DCB", 'D',
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Diamond, 1L), 'S',
                        GTOreDictUnificator.get(OrePrefixes.stick, Materials.Titanium, 1L), 'P',
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "DS ", "DP ", "DCB", 'D',
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Diamond, 1L), 'S',
                        GTOreDictUnificator.get(OrePrefixes.stick, Materials.Iridium, 1L), 'P',
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "GLP", "LSd", "PfT", 'G',
                        ...
                        GTOreDictUnificator.get(OrePrefixes.screw, Materials.Steel, 1L), 'P',
        ...
        for (int i = 0; i < 3; i++) {
            ...
            GTModHandler.addCraftingRecipe(
                    ...
                    new Object[] { "HRH", "HCH", "HKH", 'H', bats[i], 'K',
                            GTOreDictUnificator.get(OrePrefixes.cableGt01, cable, 1L), 'C', machinehull, 'R',
                            chreac[i] });
        }
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "SCS", "CHC", "ZCZ", 'S',
                        GTOreDictUnificator.get(OrePrefixes.screw, Materials.Titanium, 1L), 'C',
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "BHB", "WGW", "BWB", 'B', new ItemStack(Blocks.brick_block), 'W',
                        GTOreDictUnificator.get(OrePrefixes.gearGt, Materials.Iron, 1L), 'H',
        ...
        GTModHandler.addCraftingRecipe(
                ...
                RecipeLoader.BITSD,
                new Object[] { "WRW", "RGR", "WRW", 'R', GTOreDictUnificator.get(OrePrefixes.ring, Materials.Iron, 1L),
                        'W', "plankWood", 'G', GTOreDictUnificator.get(OrePrefixes.gearGt, Materials.Iron, 1L), });
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "BZB", "BRB", "BZB", 'B', new ItemStack(GregTechAPI.sBlockCasings8, 1, 5), 'R',
                        GTModHandler.getModItem(IndustrialCraft2.ID, "blockGenerator", 1, 5), 'Z',
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "TET", "CFC", "TST", 'T',
                        GTOreDictUnificator.get(OrePrefixes.plate, Materials.Titanium, 1L), 'E',
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "SFE", "CPC", "NFN", 'N',
                        ...
                        "circuit" + Materials.EV, 'F', ItemList.Field_Generator_EV.get(1L), 'E',
        ...
        GTModHandler.addCraftingRecipe(
                new MTEBioVat(BioVat.ID, "bw.biovat", StatCollector.translateToLocal("tile.biovat.name"))
                        .getStackForm(1L),
                RecipeLoader.BITSD,
                new Object[] { "GCG", "KHK", "GCG", 'G', new ItemStack(ItemRegistry.bw_glasses[0], 1, 1), 'C',
                        "circuit" + Materials.EV, 'K',
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { "MPM", "LSL", "PRP", 'M', ItemList.Cover_Screen.get(1), 'P',
                        ...
                        GTOreDictUnificator.get(OrePrefixes.lens, Materials.GarnetYellow, 1L), 'S',
        ...
        GTModHandler.addCraftingRecipe(
                ...
                new Object[] { " M ", "STS", "dPw", 'M', ItemList.Cover_Screen.get(1L), 'S',
                        OrePrefixes.screw.get(Materials.Titanium), 'T',
