...
public class Centrifuge implements Runnable {
    ...
    @Override
    public void run() {
        GTValues.RA.stdBuilder().itemInputs(Materials.Thorium.getDust(1))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(pellets).duration(40 * MINUTES).eut(TierEU.RECIPE_LV).addTo(centrifugeRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(40 * MINUTES).eut(TierEU.RECIPE_LV).addTo(centrifugeRecipes);
        ...
        for (MTEHighTempGasCooledReactor.HTGRMaterials.Fuel_ fuel : MTEHighTempGasCooledReactor.HTGRMaterials.sHTGR_Fuel) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(
                            ...
                            new ItemStack(MTEHighTempGasCooledReactor.HTGRMaterials.aHTGR_Materials, 64, i + 4),
                            new ItemStack(MTEHighTempGasCooledReactor.HTGRMaterials.aHTGR_Materials, 64, i + 4))
                    .duration(10 * MINUTES).eut(TierEU.RECIPE_LV).addTo(centrifugeRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(2 * MINUTES + 30 * SECONDS).eut(TierEU.RECIPE_LV).addTo(centrifugeRecipes);
            ...
            recipeBuilder.duration(1 * MINUTES).eut(TierEU.RECIPE_LV).addTo(centrifugeRecipes);

            i += MTEHighTempGasCooledReactor.HTGRMaterials.MATERIALS_PER_FUEL;
        }

        GTValues.RA.stdBuilder().itemInputs(GTUtility.getIntegratedCircuit(17)).itemOutputs(BioItemList.getOther(4))
