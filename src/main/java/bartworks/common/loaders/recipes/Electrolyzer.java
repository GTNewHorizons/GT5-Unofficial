...
public class Electrolyzer implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder().itemInputs(WerkstoffLoader.Forsterit.get(OrePrefixes.dust, 7))
                .itemOutputs(
                ...
                .fluidOutputs(Materials.Oxygen.getGas(2_000)).duration(10 * SECONDS).eut(90).addTo(electrolyzerRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffLoader.RedZircon.get(OrePrefixes.dust, 6))
                .itemOutputs(
                        WerkstoffLoader.Zirconium.get(OrePrefixes.dust, 1),
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 1L))
                .fluidOutputs(Materials.Oxygen.getGas(2_000)).duration(12 * SECONDS + 10 * TICKS).eut(90)
                .addTo(electrolyzerRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffLoader.Fayalit.get(OrePrefixes.dust, 7))
                .itemOutputs(
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 2L),
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 1L))
                .fluidOutputs(Materials.Oxygen.getGas(2_000)).duration(16 * SECONDS).eut(90).addTo(electrolyzerRecipes);

        GTValues.RA.stdBuilder().itemInputs(WerkstoffLoader.Prasiolite.get(OrePrefixes.dust, 16))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder().itemInputs(WerkstoffLoader.Hedenbergit.get(OrePrefixes.dust, 10))
                .itemOutputs(
                ...
                .fluidOutputs(Materials.Oxygen.getGas(2_000)).duration(15 * SECONDS).eut(90).addTo(electrolyzerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(Materials.Oxygen.getGas(2_000)).duration(19 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_MV)
                .addTo(electrolyzerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 3L),
                        GTOreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2))
                .fluidOutputs(Materials.Oxygen.getGas(2_000)).duration(23 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(electrolyzerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(Materials.Oxygen.getGas(19_000)).duration(35 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_MV)
                .addTo(electrolyzerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.dust, Materials.Boron, 3),
                        GTOreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 3))
                .fluidOutputs(Materials.Oxygen.getGas(19_000)).duration(36 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(electrolyzerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(Materials.Oxygen.getGas(6_000)).duration(36 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_MV)
                .addTo(electrolyzerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidOutputs(Materials.Oxygen.getGas(1_000)).duration(39 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_MV)
                .addTo(electrolyzerRecipes);
