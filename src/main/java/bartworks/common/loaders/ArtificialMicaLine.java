...
public class ArtificialMicaLine {
    ...
    public static void runArtificialMicaRecipe() {
        ...
        GTValues.RA.stdBuilder().itemInputs(Materials.Magnesium.getDust(1)).itemOutputs(Materials.Magnesia.getDust(2))
                .fluidInputs(Materials.Oxygen.getGas(1_000)).duration(2 * SECONDS).eut(8).addTo(UniversalChemical);
        // Si + 6HF = H2SiF6 + 4H

        GTValues.RA.stdBuilder().itemInputs(Materials.Silicon.getDust(1), Materials.Empty.getCells(4))
                .itemOutputs(Materials.Hydrogen.getCells(4)).fluidInputs(Materials.HydrofluoricAcid.getFluid(6_000))
                .fluidOutputs(WerkstoffLoader.HexafluorosilicicAcid.getFluidOrGas(1_000)).duration(20 * SECONDS)
        ...
        GTValues.RA.stdBuilder().itemInputs(Materials.Potassium.getDust(1), GTUtility.getIntegratedCircuit(2))
                .itemOutputs(Materials.RockSalt.getDust(2)).fluidInputs(Materials.Chlorine.getGas(1_000))
                .duration(20 * TICKS).eut(8).addTo(UniversalChemical);

        // 2KCl + H2SiF6 = 2HCl + K2SiF6
        GTValues.RA.stdBuilder().itemInputs(Materials.RockSalt.getDust(4))
                ...
                .fluidOutputs(Materials.HydrochloricAcid.getFluid(2_000)).duration(1 * SECONDS).eut(8)
                .addTo(mixerRecipes);

        // 2K + CO2 + O = K2CO3

        GTValues.RA.stdBuilder().itemInputs(Materials.Potassium.getDust(2), Materials.CarbonDioxide.getCells(1))
                .itemOutputs(WerkstoffLoader.PotassiumCarbonate.get(OrePrefixes.dust, 6), Materials.Empty.getCells(1))
                .fluidInputs(Materials.Oxygen.getGas(1_000)).duration(2 * SECONDS).eut(8).addTo(UniversalChemical);
        // K2O + CO2 = K2CO3

        GTValues.RA.stdBuilder().itemInputs(Materials.Potash.getDust(3), Materials.CarbonDioxide.getCells(1))
                .itemOutputs(WerkstoffLoader.PotassiumCarbonate.get(OrePrefixes.dust, 6), Materials.Empty.getCells(1))
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(20 * SECONDS).eut(TierEU.RECIPE_MV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs().fluidOutputs().duration(30 * SECONDS).eut(TierEU.RECIPE_MV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(
                        ...
                        WerkstoffLoader.RawFluorophlogopite.get(OrePrefixes.dust, 64),
                        WerkstoffLoader.RawFluorophlogopite.get(OrePrefixes.dust, 8))
                .duration(30 * SECONDS).eut(TierEU.RECIPE_MV).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder().itemInputs(Materials.Magnesia.getDust(1))
                .fluidOutputs(Materials.Magnesia.getMolten(1 * INGOTS)).duration(20 * TICKS).eut(TierEU.RECIPE_MV)
                .addTo(fluidExtractionRecipes);

        // 27Raw Fluorophlogopite Dust + 720MgO(l) = 4608Fluorophlogopite(l)
        GTValues.RA.stdBuilder().itemInputs(WerkstoffLoader.RawFluorophlogopite.get(OrePrefixes.dust, 27))
                .itemOutputs(Materials.Glass.getDust(1))
                .fluidInputs(BWGTMaterialReference.Magnesia.getMolten(5 * INGOTS))
                .fluidOutputs(WerkstoffLoader.HotFluorophlogopite.getFluidOrGas(32 * INGOTS)).duration(30 * SECONDS)
                .eut(TierEU.RECIPE_HV).metadata(COIL_HEAT, 1700).addTo(blastFurnaceRecipes);

        // 144Fluorophlogopite(l) = Fluorophlogopite
        GTValues.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Plate.get(0))
                .itemOutputs(WerkstoffLoader.Fluorophlogopite.get(OrePrefixes.plate, 1))
                .fluidInputs(WerkstoffLoader.HotFluorophlogopite.getFluidOrGas(1 * INGOTS)).duration(10 * TICKS)
        ...
        if (NewHorizonsCoreMod.isModLoaded()) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(10 * TICKS).eut(600).addTo(benderRecipes);
