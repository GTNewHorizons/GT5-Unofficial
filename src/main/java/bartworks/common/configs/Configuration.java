...
@Config(modid = Mods.ModIDs.BART_WORKS, filename = Mods.ModIDs.BART_WORKS)
    ...
    public static class RossRuinMetas {
        ...
        public static class LV {
            ...
            @Config.DefaultIntList({ 201, 211, 221, 231, 241, 251, 261, 271, 281, 291, 301, 311, 321, 331, 341, 351,
                361, 371, 381, 391, 401, 411, 421, 441, 451, 461, 471, 481, 491, 501, 511, 521, 531, 541, 551, 561, 571,
                581, 591, 601, 611, 621, 641, 651, 671 })
            public int[] machines;
        }
        ...
        public static class MV {
            ...
            @Config.DefaultIntList({ 202, 212, 222, 232, 242, 252, 262, 272, 282, 292, 302, 312, 322, 332, 342, 352,
                362, 372, 382, 392, 402, 412, 422, 442, 452, 462, 472, 482, 492, 502, 512, 522, 532, 542, 552, 562, 572,
                582, 592, 602, 612, 622, 642, 652, 672 })
            public int[] machines;
        }
        ...
        public static class HV {
            ...
            @Config.DefaultIntList({ 203, 213, 223, 233, 243, 253, 263, 273, 283, 293, 303, 313, 323, 333, 343, 353,
                363, 373, 383, 393, 403, 413, 423, 443, 453, 463, 473, 483, 493, 503, 513, 523, 533, 543, 553, 563, 573,
                583, 593, 603, 613, 623, 643, 653, 673 })
            public int[] machines;
        }
        ...
        public static class EV {
            ...
            @Config.DefaultIntList({ 204, 214, 224, 234, 244, 254, 264, 274, 284, 294, 304, 314, 324, 334, 344, 354,
                364, 374, 384, 394, 404, 414, 424, 444, 454, 464, 474, 484, 494, 504, 514, 524, 534, 544, 554, 564, 574,
                584, 594, 604, 614, 624, 644, 654, 674 })
            public int[] machines;
        }
    }
}
