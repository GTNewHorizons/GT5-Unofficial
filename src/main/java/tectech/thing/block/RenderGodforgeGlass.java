...
public class RenderGodforgeGlass implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        // South
        if (world.getBlock(x, y, z + 1).getClass() != BlockGodforgeGlass.class) {
        ...
        // East
        if (world.getBlock(x + 1, y, z).getClass() != BlockGodforgeGlass.class) {
        ...
        // Top
        if (world.getBlock(x, y + 1, z).getClass() != BlockGodforgeGlass.class) {
