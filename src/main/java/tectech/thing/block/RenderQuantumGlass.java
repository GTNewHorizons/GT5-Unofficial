...
public final class RenderQuantumGlass implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        // South
        if (world.getBlock(x, y, z + 1).getClass() != BlockQuantumGlass.class) {
        ...
        // East
        if (world.getBlock(x + 1, y, z).getClass() != BlockQuantumGlass.class) {
        ...
        // Top
        if (world.getBlock(x, y + 1, z).getClass() != BlockQuantumGlass.class) {
