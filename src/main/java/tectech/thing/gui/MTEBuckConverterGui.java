...
public class MTEBuckConverterGui extends MTESpecialMachineBlockBaseGui<MTEBuckConverter> {
            ...
            IKey.dynamic(
                () -> EnumChatFormatting.GRAY + ""
                    ...
                    + (isUsingTiersSyncer.getBoolValue() ? ("Tier: 0 - " + MAX_TIER)
                        : ("Voltage: 1 - " + numberFormat.format(MAX_VOLTAGE)))));
    }
        ...
        t.addLine(
            IKey.dynamic(
                () -> EnumChatFormatting.GRAY + ""
                    ...
                    + "Amperage: 1 - "
                    + numberFormat
                        .format(getMaxAmperageAtCurrentVoltage(voltageSyncer, voltageTierSyncer, isUsingTiersSyncer))));
    }
