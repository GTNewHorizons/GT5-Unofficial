...
public class GT_MetaTileEntity_EM_dataBank extends GT_MetaTileEntity_MultiblockBase_EM
        ...
        .addShape(
            ...
            transpose(
                new String[][] { { "BCCCB", "BDDDB", "BDDDB" }, { "BC~CB", "BAAAB", "BDDDB" },
                    { "BCCCB", "BDDDB", "BDDDB" } }))
        .addElement('A', ofBlock(TT_Container_Casings.sBlockCasingsTT, 1))
        .addElement('B', ofBlock(TT_Container_Casings.sBlockCasingsTT, 2))
        .addElement('C', classicHatches(GT_Block_CasingsTT.textureOffset, 1, TT_Container_Casings.sBlockCasingsTT, 0))
        .addElement(
            'D',
    ...
    public void outputAfterRecipe_EM() {
        ...
        if (stacks.size() > 0) {
            ItemStack[] arr = stacks.toArray(TT_recipeAdder.nullItem);
