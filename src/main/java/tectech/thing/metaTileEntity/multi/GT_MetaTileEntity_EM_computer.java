...
import tectech.thing.metaTileEntity.hatch.GT_MetaTileEntity_Hatch_InputData;
import tectech.thing.metaTileEntity.hatch.GT_MetaTileEntity_Hatch_OutputData;
import tectech.thing.metaTileEntity.hatch.GT_MetaTileEntity_Hatch_Rack;
import tectech.thing.metaTileEntity.hatch.GT_MetaTileEntity_Hatch_WirelessComputation_Output;
...
import tectech.thing.metaTileEntity.multi.base.render.TT_RenderedExtendedFacingTexture;
...
public class GT_MetaTileEntity_EM_computer extends GT_MetaTileEntity_MultiblockBase_EM
    ...
    private static final IStructureDefinition<GT_MetaTileEntity_EM_computer> STRUCTURE_DEFINITION = IStructureDefinition
        ...
        .addElement('B', ofBlock(TT_Container_Casings.sBlockCasingsTT, 1))
        .addElement('C', ofBlock(TT_Container_Casings.sBlockCasingsTT, 2))
        .addElement('D', ofBlock(TT_Container_Casings.sBlockCasingsTT, 3))
        .addElement(
            'A',
            buildHatchAdder(GT_MetaTileEntity_EM_computer.class)
                ...
                .dot(1)
                .buildAndChain(ofBlock(TT_Container_Casings.sBlockCasingsTT, 1)))
        .addElement(
            'E',
            RackHatchElement.INSTANCE
                .newAnyOrCasing(GT_Block_CasingsTT.textureOffset + 3, 2, TT_Container_Casings.sBlockCasingsTT, 3))
        .build();
    // endregion
