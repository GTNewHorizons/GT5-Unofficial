...
public class ForgeOfGodsUI {
    ...
    public static ButtonWidget createInputSeparationButton(final IGregTechTileEntity tileEntity,
        ...
        Widget button = new ButtonWidget().setOnClick((clickData, widget) -> {
            ...
            return ret.toArray(new IDrawable[0]);
                ...
                builder).setTooltipShowUpDelay(TOOLTIP_DELAY).setPos(mte.getInputSeparationButtonPos()).setSize(16, 16);
    ...
    public static ButtonWidget createBatchModeButton(final IGregTechTileEntity tileEntity,
        ...
        Widget button = new ButtonWidget().setOnClick((clickData, widget) -> {
            ...
            return ret.toArray(new IDrawable[0]);
                ...
                .setTooltipShowUpDelay(TOOLTIP_DELAY).setPos(mte.getBatchModeButtonPos()).setSize(16, 16);
    ...
    public static ButtonWidget createLockToSingleRecipeButton(final IGregTechTileEntity tileEntity,
        ...
        Widget button = new ButtonWidget().setOnClick((clickData, widget) -> {
            ...
            return ret.toArray(new IDrawable[0]);
                ...
                .setTooltipShowUpDelay(TOOLTIP_DELAY).setPos(mte.getRecipeLockingButtonPos()).setSize(16, 16);
    ...
    public static ButtonWidget createStructureUpdateButton(final IGregTechTileEntity tileEntity,
        ...
        Widget button = new ButtonWidget().setOnClick((clickData, widget) -> {
            ...
            return ret.toArray(new IDrawable[0]);
                ...
                builder).addTooltip(StatCollector.translateToLocal("GT5U.gui.button.structure_update"))
                .setTooltipShowUpDelay(TOOLTIP_DELAY).setPos(mte.getStructureUpdateButtonPos()).setSize(16, 16);
        return (ButtonWidget) button;
    }
    ...
    public static ButtonWidget createVoidExcessButton(final IGregTechTileEntity tileEntity,
        ...
        Widget button = new ButtonWidget().setOnClick((clickData, widget) -> {
            ...
            switch (clickData.mouseButton) {
                case 0 -> mte.setVoidingMode(mte.getVoidingMode().nextInCollection(allowed));
                case 1 -> mte.setVoidingMode(mte.getVoidingMode().previousInCollection(allowed));
            }
            widget.notifyTooltipChange();
        }).setPlayClickSound(false).setBackground(() -> {
            List<UITexture> ret = new ArrayList<>();
            ...
            return ret.toArray(new IDrawable[0]);
                ...
                new FakeSyncWidget.IntegerSyncer(
                        () -> mte.getVoidingMode().ordinal(),
                        val -> mte.setVoidingMode(VoidingMode.fromOrdinal(val))),
                builder)
                .dynamicTooltip(
                        () -> Arrays.asList(
                                StatCollector.translateToLocal("GT5U.gui.button.voiding_mode"),
                                StatCollector.translateToLocal(mte.getVoidingMode().getTransKey())))
                .setTooltipShowUpDelay(TOOLTIP_DELAY).setPos(mte.getVoidingModeButtonPos()).setSize(16, 16);
        return (ButtonWidget) button;
    }
    ...
    public static ModularWindow createGeneralInfoWindow(Supplier<Boolean> inversionGetter,
        ...
        scrollable.widget(
                new TextWidget(
                        EnumChatFormatting.BOLD + translateToLocal("gt.blockmachines.multimachine.FOG.introduction"))
                                .setDefaultColor(EnumChatFormatting.DARK_PURPLE).setTextAlignment(Alignment.TopCenter)
                                .setPos(7, 13).setSize(280, 15))
                .widget(
                ...
                .widget(
                        TextWidget.dynamicText(() -> inversionHeaderText(inversionGetter.get()))
                                ...
                                .setPos(7, 155).setSize(150, 15))
                .widget(new ButtonWidget().setOnClick((clickData, widget) -> {
                    if (inversionGetter.get()) {
                        scrollable.setVerticalScrollOffset(1766);
                    }
                }).setPlayClickSound(inversionGetter.get()).setPos(7, 155).setSize(150, 15)
                        ...
                        new TextWidget(
                                EnumChatFormatting.BOLD + "§N"
                                        + translateToLocal("gt.blockmachines.multimachine.FOG.fuel"))
                                                ...
                                                .setTextAlignment(Alignment.TopCenter).setPos(127, 160).setSize(40, 15))
                .widget(
                        new TextWidget(translateToLocal("gt.blockmachines.multimachine.FOG.fuelinfotext"))
                                .setDefaultColor(EnumChatFormatting.GOLD).setTextAlignment(Alignment.CenterLeft)
                                .setPos(7, 177).setSize(280, 250))
                .widget(
                        new TextWidget(
                                EnumChatFormatting.BOLD + "§N"
                                        + translateToLocal("gt.blockmachines.multimachine.FOG.modules"))
                                                .setDefaultColor(EnumChatFormatting.DARK_PURPLE)
                                                .setTextAlignment(Alignment.TopCenter).setPos(7, 440).setSize(280, 15))
                .widget(
                        new TextWidget(translateToLocal("gt.blockmachines.multimachine.FOG.moduleinfotext"))
                                .setDefaultColor(EnumChatFormatting.GOLD).setTextAlignment(Alignment.CenterLeft)
                                .setPos(7, 461).setSize(280, 620))
                .widget(
                        new TextWidget(
                                EnumChatFormatting.BOLD + "§N"
                                        + translateToLocal("gt.blockmachines.multimachine.FOG.upgrades"))
                                                .setDefaultColor(EnumChatFormatting.DARK_PURPLE)
                                                .setTextAlignment(Alignment.TopCenter).setPos(7, 1098).setSize(280, 15))
                .widget(
                        new TextWidget(translateToLocal("gt.blockmachines.multimachine.FOG.upgradeinfotext"))
                                .setDefaultColor(EnumChatFormatting.GOLD).setTextAlignment(Alignment.CenterLeft)
                                .setPos(7, 1115).setSize(280, 290))
                .widget(
                        new TextWidget(
                                EnumChatFormatting.BOLD + "§N"
                                        + translateToLocal("gt.blockmachines.multimachine.FOG.milestones"))
                                                .setDefaultColor(EnumChatFormatting.DARK_PURPLE)
                                                .setTextAlignment(Alignment.TopCenter).setPos(7, 1422).setSize(280, 15))
                .widget(
                        new TextWidget(translateToLocal("gt.blockmachines.multimachine.FOG.milestoneinfotext"))
                                .setDefaultColor(EnumChatFormatting.GOLD).setTextAlignment(Alignment.CenterLeft)
                                .setPos(7, 1439).setSize(280, 320))
                .widget(
                        TextWidget.dynamicText(() -> inversionHeaderText(inversionGetter.get()))
                                .setDefaultColor(EnumChatFormatting.WHITE).setTextAlignment(Alignment.TopCenter)
                                .setPos(7, 1776).setSize(280, 15))
                .widget(
                        TextWidget.dynamicText(() -> inversionInfoText(inversionGetter.get()))
                                .setDefaultColor(EnumChatFormatting.GOLD).setTextAlignment(Alignment.CenterLeft)
                                .setPos(7, 1793).setSize(280, 160))
                .widget(new TextWidget("").setPos(7, 1965).setSize(10, 10));

        builder.widget(
                new DrawableWidget().setDrawable(TecTechUITextures.BACKGROUND_GLOW_WHITE).setPos(0, 0)
                        .setSize(300, 300))
                .widget(scrollable.setSize(292, 292).setPos(4, 4))
    ...
    public static Widget createStarColorRGBMGroup(StarColorRGBM color, DoubleConsumer setter, DoubleSupplier getter) {
        ...
        widget.addChild(
                new TextWidget(translateToLocal(color.title)).setDefaultColor(color.mcColor)
                        .setTextAlignment(Alignment.CenterLeft).setPos(0, 0).setSize(32, 16));

        // Color slider
        widget.addChild(new SliderWidget().setSetter(val -> {
            int aux = (int) (val * 10);
            setter.accept(aux / 10d);
        }).setGetter(() -> (float) getter.getAsDouble()).setBounds(color.lowerBound, color.upperBound)
                .setHandleSize(new Size(4, 0)).dynamicTooltip(() -> {
        ...
        Widget numberEntry = new NumericWidget().setSetter(setter).setGetter(getter)
                .setBounds(color.lowerBound, color.upperBound).setDefaultValue(color.defaultValue)
                .setTextAlignment(Alignment.Center).setTextColor(color.muiColor).setSize(32, 16).setPos(152, 0)
                .setTooltipShowUpDelay(TOOLTIP_DELAY).setBackground(GTUITextures.BACKGROUND_TEXT_FIELD);
    ...
    public static Widget createStarColorButton(String text, String tooltip,
        ...
        widget.addChild(
                new ButtonWidget().setOnClick(onClick).setSize(35, 15).setBackground(GTUITextures.BUTTON_STANDARD)
                        .addTooltip(translateToLocal(tooltip)).setTooltipShowUpDelay(TOOLTIP_DELAY).setPos(0, 0));

        widget.addChild(TextWidget.localised(text).setTextAlignment(Alignment.Center).setPos(0, 0).setSize(35, 15));
        ...
        widget.addChild(
                new ButtonWidget().setOnClick(onClick).setSize(35, 15).setBackground(GTUITextures.BUTTON_STANDARD)
                        .dynamicTooltip(() -> {
                            ...
                            return ret;
                        }).setUpdateTooltipEveryTick(true).setTooltipShowUpDelay(TOOLTIP_DELAY).setPos(0, 0));

        widget.addChild(
                new DynamicTextWidget(() -> new Text(translateToLocal(text.get()))).setTextAlignment(Alignment.Center)
                        .setPos(0, 0).setSize(35, 15));
    ...
    public static Widget getIndividualUpgradeGroup(ForgeOfGodsUpgrade upgrade, Supplier<Integer> shardGetter,
        ...
        // Close window button
        widget.addChild(ButtonWidget.closeWindowButton(true).setPos(w - 15, 3));
        ...
        // Background overlay
        widget.addChild(
                new DrawableWidget().setDrawable(upgrade.getOverlay()).setPos(w / 4, h / 4).setSize(w / 2, h / 2));

        // Upgrade name title
        widget.addChild(
                new TextWidget(upgrade.getNameText()).setTextAlignment(Alignment.Center)
                        .setDefaultColor(EnumChatFormatting.GOLD).setSize(w - 15, 30).setPos(9, 5));

        // Upgrade body text
        widget.addChild(
                new TextWidget(upgrade.getBodyText()).setTextAlignment(Alignment.Center)
                        .setDefaultColor(EnumChatFormatting.WHITE).setSize(w - 15, upgrade.getLoreYPos() - 30)
                        .setPos(9, 30));

        // Lore Text
        widget.addChild(
                new TextWidget(EnumChatFormatting.ITALIC + upgrade.getLoreText()).setTextAlignment(Alignment.Center)
                        .setDefaultColor(0xbbbdbd).setSize(w - 15, (int) (h * 0.9) - upgrade.getLoreYPos())
        ...
        widget.addChild(
                new TextWidget(translateToLocal("gt.blockmachines.multimachine.FOG.shardcost") + costStr)
                        .setTextAlignment(Alignment.Center).setScale(0.7f).setMaxWidth(70).setDefaultColor(0x9c9c9c)
                        .setPos(11, h - 25));

        // Available shards text
        widget.addChild(
                new TextWidget(translateToLocal("gt.blockmachines.multimachine.FOG.availableshards"))
                        .setTextAlignment(Alignment.Center).setScale(0.7f).setMaxWidth(90).setDefaultColor(0x9c9c9c)
                        .setPos(w - 87, h - 25));
        ...
        completeGroup.addChild(new ButtonWidget().setOnClick(($, $$) -> {
            if (check.get()) {
                ...
                .dynamicTooltip(() -> constructionStatusString(check)).setTooltipShowUpDelay(TOOLTIP_DELAY));

        // Complete text overlay
        completeGroup.addChild(
                TextWidget.dynamicText(() -> constructionStatusText(check)).setTextAlignment(Alignment.Center)
                        .setScale(0.7f).setMaxWidth(36).setPos(3, 5));
    ...
    public static Widget createMaterialInputButton(ForgeOfGodsUpgrade upgrade, Supplier<Boolean> check,
        ...
        return new ButtonWidget().setOnClick(clickAction).setPlayClickSound(true)
                .setBackground(
                ...
                .setPos(w / 2 - 40, (int) (h * 0.9)).setSize(15, 15)
                .dynamicTooltip(() -> upgradeMaterialRequirements(check)).addTooltip(
    ...
    private static Text getAvailableShardsText(ForgeOfGodsUpgrade upgrade, Supplier<Integer> shardGetter,
        ...
        return new Text(enoughShards + formatGetter.get().format(shardGetter.get()));
    }
    ...
    public static Widget createExtraCostWidget(final ItemStack costStack, Supplier<Short> paidAmount) {
        ...
        if (costStack == null) {
            ...
            widget.addChild(new DrawableWidget().setDrawable(GTUITextures.BUTTON_STANDARD_DISABLED).setSize(18, 18));
            return widget;
        }
        ...
        widget.addChild(
                new SlotWidget(handler, 0).setAccess(false, false).setRenderStackSize(false).disableInteraction()
        ...
        }).setTextAlignment(Alignment.Center).setScale(0.8f).setPos(18, 5).setSize(18, 9)
                .setEnabled(w -> paidAmount.get() < costStack.stackSize));

        // Completed checkmark
        widget.addChild(
                new DrawableWidget().setDrawable(TecTechUITextures.GREEN_CHECKMARK_11x9).setPos(21, 5).setSize(11, 9)
                        .setEnabled(w -> paidAmount.get() >= costStack.stackSize));
    ...
    public static ModularWindow createSpecialThanksWindow() {
        ...
        builder.setDraggable(true);
        builder.widget(ButtonWidget.closeWindowButton(true).setPos(184, 4))
                .widget(
                        new DrawableWidget().setDrawable(TecTechUITextures.PICTURE_GODFORGE_THANKS).setPos(50, 50)
                                .setSize(100, 100))
                .widget(
                        new TextWidget(translateToLocal("gt.blockmachines.multimachine.FOG.contributors"))
                                ...
                                .setScale(1f).setPos(0, 5).setSize(200, 15))
                .widget(
                        new TextWidget(
                                EnumChatFormatting.UNDERLINE
                                        + translateToLocal("gt.blockmachines.multimachine.FOG.lead")).setScale(0.8f)
                                                .setDefaultColor(EnumChatFormatting.GOLD)
                                                .setTextAlignment(Alignment.CenterLeft).setPos(7, 30).setSize(60, 10))
                .widget(
                        new TextWidget(translateToLocal("gt.blockmachines.multimachine.FOG.cloud")).setScale(0.8f)
                                .setDefaultColor(EnumChatFormatting.AQUA).setTextAlignment(Alignment.CenterLeft)
                                .setPos(7, 40).setSize(60, 10))
                .widget(
                        new TextWidget(
                                EnumChatFormatting.UNDERLINE
                                        + translateToLocal("gt.blockmachines.multimachine.FOG.programming"))
                                                .setScale(0.8f).setDefaultColor(EnumChatFormatting.GOLD)
                                                .setTextAlignment(Alignment.CenterLeft).setPos(7, 55).setSize(60, 10))
                .widget(
                        new TextWidget(
                                translateToLocal("gt.blockmachines.multimachine.FOG.serenibyss") + " "
                                        ...
                                        + translateToLocal("gt.blockmachines.multimachine.FOG.teg")).setScale(0.8f)
                                                .setTextAlignment(Alignment.CenterLeft).setPos(7, 67).setSize(60, 10))
                .widget(
                        new TextWidget(
                                EnumChatFormatting.UNDERLINE
                                        + translateToLocal("gt.blockmachines.multimachine.FOG.textures")).setScale(0.8f)
                                                .setDefaultColor(EnumChatFormatting.GOLD)
                                                .setTextAlignment(Alignment.CenterLeft).setPos(7, 85).setSize(100, 10))
                .widget(
                        new TextWidget(translateToLocal("gt.blockmachines.multimachine.FOG.ant")).setScale(0.8f)
                                ...
                                .setPos(7, 95).setSize(60, 10))
                .widget(
                        new TextWidget(
                                EnumChatFormatting.UNDERLINE
                                        + translateToLocal("gt.blockmachines.multimachine.FOG.rendering"))
                                                .setScale(0.8f).setDefaultColor(EnumChatFormatting.GOLD)
                                                .setTextAlignment(Alignment.CenterLeft).setPos(7, 110).setSize(100, 10))
                .widget(
                        new TextWidget(translateToLocal("gt.blockmachines.multimachine.FOG.bucket")).setScale(0.8f)
                                .setDefaultColor(EnumChatFormatting.WHITE).setTextAlignment(Alignment.CenterLeft)
                                .setPos(7, 120).setSize(60, 10))
                .widget(
                        new TextWidget(
                                EnumChatFormatting.UNDERLINE
                                        + translateToLocal("gt.blockmachines.multimachine.FOG.lore")).setScale(0.8f)
                                                .setDefaultColor(EnumChatFormatting.GOLD)
                                                .setTextAlignment(Alignment.CenterLeft).setPos(7, 135).setSize(100, 10))
                .widget(
                        delenoName().setSpace(-1).setAlignment(MainAxisAlignment.SPACE_BETWEEN).setPos(7, 145)
                                .setSize(60, 10))
                .widget(
                        new TextWidget(
                                EnumChatFormatting.UNDERLINE
                                        + translateToLocal("gt.blockmachines.multimachine.FOG.playtesting"))
                                                .setScale(0.8f).setDefaultColor(EnumChatFormatting.GOLD)
                                                .setTextAlignment(Alignment.CenterLeft).setPos(7, 160).setSize(100, 10))
                .widget(
                        new TextWidget(translateToLocal("gt.blockmachines.multimachine.FOG.misi")).setScale(0.8f)
                                .setDefaultColor(0xffc26f).setTextAlignment(Alignment.CenterLeft).setPos(7, 170)
                                .setSize(60, 10))
                .widget(
                        new TextWidget(
                                EnumChatFormatting.ITALIC
                                        + translateToLocal("gt.blockmachines.multimachine.FOG.thanks")).setScale(0.8f)
                                                .setDefaultColor(0xbbbdbd).setTextAlignment(Alignment.Center)
                                                .setPos(90, 140).setSize(100, 60));
        return builder.build();
    }
    ...
    private static DynamicPositionedRow delenoName() {
        ...
        for (int i = 0; i < deleno.length(); i++) {
            nameRow.addChild(
                    new TextWidget(Character.toString(deleno.charAt(i))).setDefaultColor(colors[i]).setScale(0.8f)
