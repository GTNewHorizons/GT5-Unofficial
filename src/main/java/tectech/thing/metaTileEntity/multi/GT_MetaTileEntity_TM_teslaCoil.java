...
import tectech.thing.metaTileEntity.hatch.GT_MetaTileEntity_Hatch_Capacitor;
...
import tectech.thing.metaTileEntity.hatch.GT_MetaTileEntity_Hatch_Param;
...
public class GT_MetaTileEntity_TM_teslaCoil extends GT_MetaTileEntity_MultiblockBase_EM
    ...
    private static final IStructureDefinition<GT_MetaTileEntity_TM_teslaCoil> STRUCTURE_DEFINITION = IStructureDefinition
        ...
        .addElement('A', ofBlock(TT_Container_Casings.sBlockCasingsBA0, 6))
        .addElement('B', ofBlock(TT_Container_Casings.sBlockCasingsBA0, 7))
        .addElement('C', ofBlock(TT_Container_Casings.sBlockCasingsBA0, 8))
        .addElement(
            'D',
            ofBlocksTiered(
                (block, meta) -> block != TT_Container_Casings.sBlockCasingsBA0 ? null
                    : meta <= 5 ? Integer.valueOf(meta) : meta == 9 ? 6 : null,
                IntStream.range(0, 7)
                    .map(tier -> tier == 6 ? 9 : tier)
                    .mapToObj(meta -> Pair.of(TT_Container_Casings.sBlockCasingsBA0, meta))
        ...
        .addElement(
            ...
            buildHatchAdder(GT_MetaTileEntity_TM_teslaCoil.class)
                .atLeast(
                    ...
                    Maintenance)
                .dot(1)
                .casingIndex(GT_Block_CasingsTT.textureOffset + 16 + 6)
                .buildAndChain(TT_Container_Casings.sBlockCasingsBA0, 6))
    ...
    public ITexture[] getTexture(IGregTechTileEntity aBaseMetaTileEntity, ForgeDirection side, ForgeDirection facing,
        ...
        if (side == facing) {
            return new ITexture[] { Textures.BlockIcons.casingTexturePages[GT_Block_CasingsTT.texturePage][16 + 6],
