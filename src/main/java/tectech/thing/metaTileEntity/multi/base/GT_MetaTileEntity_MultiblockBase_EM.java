...
import static tectech.thing.casing.GT_Block_CasingsTT.texturePage;
...
import tectech.thing.metaTileEntity.hatch.GT_MetaTileEntity_Hatch_DataConnector;
...
public abstract class GT_MetaTileEntity_MultiblockBase_EM
    ...
    public final int getMaxEnergyInputTier_EM() {
        return TT_Utility.getTier(maxEUinputMax);
    }

    // new Method
    public final int getMinEnergyInputTier_EM() {
        return TT_Utility.getTier(maxEUinputMin);
    }
