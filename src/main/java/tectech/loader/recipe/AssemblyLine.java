...
public class AssemblyLine implements Runnable {
    ...
    public void run() {
        // Data Bank
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Hatch_DataAccess_EV.get(1))
                ...
                .itemOutputs(CustomItemList.Machine_Multi_DataBank.get(1)).eut(TierEU.RECIPE_LuV).duration(2 * MINUTES)
                .addTo(AssemblyLine);

        // Hollow Casing
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, CustomItemList.eM_Containment.get(1))
                ...
                .itemInputs(
                        ...
                        GTOreDictUnificator.get(
                                ...
                                16))
                .fluidInputs(
                        BaseRecipeLoader.getOrDefault("Trinium", Materials.Osmium).getMolten(9 * INGOTS),
                        Materials.Osmium.getMolten(9 * INGOTS),
                        GTModHandler.getIC2Coolant(2_000),
                        Materials.Argon.getGas(1_000))
                .itemOutputs(CustomItemList.eM_Hollow.get(2)).eut(200_000).duration(10 * SECONDS).addTo(AssemblyLine);

        // EM Coil
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, CustomItemList.eM_Hollow.get(1))
                .metadata(SCANNING, new Scanning(50 * SECONDS, TierEU.RECIPE_LuV))
                .itemInputs(
                ...
                .fluidInputs(
                        ...
                        GTModHandler.getIC2Coolant(2_000),
                        BaseRecipeLoader.getOrDefault("Trinium", Materials.Osmium).getMolten(9 * INGOTS))
                .itemOutputs(CustomItemList.eM_Coil.get(4)).eut(200_000).duration(40 * SECONDS).addTo(AssemblyLine);

        // Object Holder
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Hatch_Input_Bus_ZPM.get(1))
                ...
                .itemOutputs(CustomItemList.holder_Hatch.get(1)).eut(TierEU.RECIPE_UV).duration(30 * SECONDS)
                .addTo(AssemblyLine);

        // Quantum Computer
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Tool_DataOrb.get(1))
                ...
                .itemOutputs(CustomItemList.Machine_Multi_Computer.get(1)).eut(100_000).duration(60 * SECONDS)
                .addTo(AssemblyLine);

        // Research Station
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.ScannerZPM.get(1))
                .metadata(SCANNING, new Scanning(1 * MINUTES + 30 * SECONDS, TierEU.RECIPE_LuV))
                .itemInputs(
                        CustomItemList.Machine_Multi_Switch_Adv.get(1),
                ...
                .fluidInputs(
                        ...
                        GTModHandler.getIC2Coolant(2_000),
                        Materials.Osmium.getMolten(9 * INGOTS))
                .itemOutputs(CustomItemList.Machine_Multi_Research.get(1)).eut(TierEU.RECIPE_UV).duration(3 * MINUTES)
                .addTo(AssemblyLine);

        // Multi Infuser
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, CustomItemList.Machine_Multi_Transformer.get(1))
                ...
                .fluidInputs(
                        ...
                        GTModHandler.getIC2Coolant(2_000))
                .itemOutputs(CustomItemList.Machine_Multi_Infuser.get(1)).eut(200_000).duration(60 * SECONDS)
                .addTo(AssemblyLine);
    }
}
