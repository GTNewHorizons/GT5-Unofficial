    ...
    public void run() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get("frameGtTritanium", 2),
                ...
                new Object[] { OrePrefixes.foil.ingredient(Materials.AnySyntheticRubber), 64L }, },
        ...
        if (EternalSingularity.isModLoaded()) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { MaterialLibAPI.getStack(Materials2Materials.Osmiridium, Materials2Shapes.plate, 6),
                    ...
                    GTOreDictUnificator.get("wireGt01Superconductor", 1), },
        ...
        // Batteries
        {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                (int) TierEU.RECIPE_UIV,
                32,
                new Object[] { HYPOGEN.getPlateDouble(64), new Object[] { Circuits.UMV.getIngredient(), 4 },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Energy_Module.get(16), new Object[] { Circuits.ZPM.getIngredient(), 16L },
                new Object[] { Circuits.UHV.getIngredient(), 8L }, MaterialsElements.STANDALONE.RHUGNOR.getPlate(8),
    ...
    private void itemPartsUHVAsslineRecipes() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Electric_Motor_UHV.get(1L), GTOreDictUnificator.get("pipeLargeNeutronium", 2L),
                ...
                new Object[] { OrePrefixes.ring.ingredient(Materials.AnySyntheticRubber), 32L },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Electric_Motor_UHV.get(2L),
                ...
                GTOreDictUnificator.get("cableGt04Bedrockium", 2L),
                new Object[] { OrePrefixes.plate.ingredient(Materials.AnySyntheticRubber), 40L } },
            new FluidStack[] { fluid_0, fluid_1, fluid_2 },
    ...
    private void itemPartsUEVAsslineRecipes() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Electric_Motor_UEV.get(1L), GTOreDictUnificator.get("pipeLargeNetherStar", 2L),
                ...
                new Object[] { OrePrefixes.ring.ingredient(Materials.AnySyntheticRubber), 64L },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Electric_Motor_UEV.get(2L),
                ...
                GTOreDictUnificator.get("cableGt04Draconium", 2L),
                new Object[] { OrePrefixes.plate.ingredient(Materials.AnySyntheticRubber), 64L },
                new Object[] { OrePrefixes.plate.ingredient(Materials.AnySyntheticRubber), 16L } },
            new FluidStack[] { fluid_0, fluid_1, fluid_2 },
    ...
    private void itemPartsUMVAsslineRecipes() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get("frameGtSpaceTime", 1L), ItemList.Electric_Motor_UMV.get(1L),
                ...
                ASTRAL_TITANIUM.getFoil(64), TITANSTEEL.getFoil(64), GTOreDictUnificator.get("cableGt04Quantium", 7L) },
            new FluidStack[] { fluid_0, fluid_1, fluid_2 },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get("frameGtSpaceTime", 1L),
                ...
                new Object[] { Circuits.UXV.getIngredient(), 4 }, HYPOGEN.getFineWire(64), HYPOGEN.getFineWire(64),
                HYPOGEN.getFineWire(64), HYPOGEN.getFineWire(64), HYPOGEN.getFineWire(64), HYPOGEN.getFineWire(64),
                HYPOGEN.getFineWire(64), HYPOGEN.getFineWire(64), GTOreDictUnificator.get("cableGt04Quantium", 8L) },
            new FluidStack[] { fluid_0, fluid_1, fluid_2 },
    ...
    private void itemPartsUXVAsslineRecipes() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new ItemStack[] { ItemList.EnergisedTesseract.get(1),
                ...
                GTOreDictUnificator.get("wireGt04SpaceTime", 4L), Materials.Neutronium.getNanite(4) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get("stickLongMagnetohydrodynamicallyConstrainedStarMatter", 8L),
                ...
                GTOreDictUnificator.get("wireGt04SpaceTime", 12L), Materials.Neutronium.getNanite(8) },
            new FluidStack[] { moltenMHDCSM_576, moltenSpaceTime_576, moltenUniversium_576,
                dimensionallyShiftedSuperfluid8000 },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get("frameGtMagnetohydrodynamicallyConstrainedStarMatter", 1L),
                ...
                GTOreDictUnificator.get("wireGt04SpaceTime", 14L), Materials.Neutronium.getNanite(8)
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get("frameGtMagnetohydrodynamicallyConstrainedStarMatter", 1L),
                ...
                GTOreDictUnificator.get("wireGt04SpaceTime", 16L), Materials.Neutronium.getNanite(12) },
            new FluidStack[] { moltenMHDCSM_576, moltenSpaceTime_576, moltenUniversium_576, solderingAlloy_14_400 },
