        ...
        if (EternalSingularity.isModLoaded()) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { ItemList.Casing_Dim_Trans.get(1), ItemList.MicroTransmitter_UV.get(1),
                    ...
                    getModItem(Avaritia.ID, "Singularity", 2L, 0), GTOreDictUnificator.get("wireGt01Superconductor", 6),
    ...
    private void itemPartsUHVAsslineRecipes() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.stickLong, 8),
                ...
                GTOreDictUnificator.get("cableGt04Bedrockium", 6L) },
            new FluidStack[] { fluid_0, fluid_1, fluid_2 },
    ...
    private void itemPartsUIVAsslineRecipes() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] {
                ...
                new Object[] { OrePrefixes.circuit.get(Materials.UEV), 4L },
                new Object[] { OrePrefixes.circuit.get(Materials.UHV), 8L },
                GTOreDictUnificator.get("cableGt04NetherStar", 6L) },
            new FluidStack[] { fluid_0, fluid_1, fluid_2 },
    ...
    private void itemPartsUMVAsslineRecipes() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.stickLong, 8),
                ...
                GTOreDictUnificator.get("cableGt04Quantium", 6L) },
            new FluidStack[] { fluid_0, fluid_1, fluid_2, fluid_3 },
