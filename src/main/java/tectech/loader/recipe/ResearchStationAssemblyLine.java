...
public class ResearchStationAssemblyLine implements Runnable {
    ...
    public void run() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { CustomItemList.eM_Power.get(1L), CustomItemList.LASERpipe.get(4L),
                GTOreDictUnificator.get(OrePrefixes.plateDense, Materials.ChromaticGlass, 1),
        ...
        // Batteries
        {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                (int) TierEU.RECIPE_UIV,
                32,
                new Object[] { GTOreDictUnificator.get(OrePrefixes.plateDouble, Materials.Hypogen, 64),
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                (int) TierEU.RECIPE_UMV,
                64,
                new Object[] { GTOreDictUnificator.get(OrePrefixes.plateDouble, Materials.Dragonblood, 64),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { Materials.UUMatter.getFluid(50_000), CINOBITE.getFluidStack(1 * STACKS),
                MaterialsAlloy.OCTIRON.getFluidStack(1 * STACKS), Materials.AstralTitanium.getMolten(1 * STACKS), },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { Materials.UUMatter.getFluid(8_000), CINOBITE.getFluidStack(16 * INGOTS),
                MaterialsAlloy.OCTIRON.getFluidStack(16 * INGOTS), Materials.AstralTitanium.getMolten(16 * INGOTS), },
        ...
        if (EtFuturumRequiem.isModLoaded()) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new FluidStack[] { Materials.UUMatter.getFluid(1_000), CINOBITE.getFluidStack(4 * INGOTS),
                    MaterialsAlloy.OCTIRON.getFluidStack(4 * INGOTS), Materials.AstralTitanium.getMolten(4 * INGOTS), },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { MaterialsElements.getInstance().CURIUM.getFluidStack(1 * STACKS),
                Materials.ChromaticGlass.getMolten(1 * STACKS), MaterialsAlloy.ABYSSAL.getFluidStack(1 * STACKS),
                Materials.Dragonblood.getMolten(1 * STACKS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Energy_Module.get(16), new Object[] { OrePrefixes.circuit.get(Materials.ZPM), 16L },
                ...
                GTOreDictUnificator.get(OrePrefixes.plate, Materials.Rhugnor, 8), ItemList.Emitter_UEV.get(1),
            ...
            new FluidStack[] { MaterialsElements.getInstance().NEPTUNIUM.getFluidStack(16 * INGOTS),
                Materials.ChromaticGlass.getMolten(16 * INGOTS), MaterialsAlloy.ABYSSAL.getFluidStack(16 * INGOTS),
                Materials.Dragonblood.getMolten(16 * INGOTS) },
        ...
        if (EtFuturumRequiem.isModLoaded()) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new FluidStack[] { MaterialsElements.getInstance().FERMIUM.getFluidStack(8 * INGOTS),
                    Materials.ChromaticGlass.getMolten(8 * INGOTS), MaterialsAlloy.ABYSSAL.getFluidStack(8 * INGOTS),
                    Materials.Dragonblood.getMolten(8 * INGOTS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { Materials.ChromaticGlass.getPlasma(1 * STACKS),
                MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(1 * STACKS),
    ...
    private void itemPartsUIVAsslineRecipes() {
        ...
        FluidStack fluid_0 = Materials.CelestialTungsten.getMolten(4 * INGOTS);
        FluidStack fluid_1 = MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(18 * INGOTS);
    ...
    private void itemPartsUMVAsslineRecipes() {
        ...
        FluidStack fluid_0 = Materials.Hypogen.getMolten(4 * INGOTS);
        FluidStack fluid_1 = Materials.CelestialTungsten.getMolten(4 * INGOTS);
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new ItemStack[] { GTOreDictUnificator.get(OrePrefixes.stickLong, Materials.TengamAttuned, 32L),
                ...
                GTOreDictUnificator.get(OrePrefixes.round, Materials.SpaceTime, 32L),
                GTOreDictUnificator.get(OrePrefixes.wireFine, Materials.Hypogen, 64),
                GTOreDictUnificator.get(OrePrefixes.wireFine, Materials.Hypogen, 64),
                GTOreDictUnificator.get(OrePrefixes.wireFine, Materials.Hypogen, 64),
                GTOreDictUnificator.get(OrePrefixes.wireFine, Materials.Hypogen, 64),
                GTOreDictUnificator.get(OrePrefixes.wireFine, Materials.Hypogen, 64),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.SpaceTime, 1L),
                ...
                GTOreDictUnificator.get(OrePrefixes.foil, Materials.CelestialTungsten, 64), QUANTUM.getFoil(64),
                GTOreDictUnificator.get(OrePrefixes.foil, Materials.AstralTitanium, 64), TITANSTEEL.getFoil(64),
    ...
    private void addBecCasingRecipes() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.BlockQuarkContainmentCasing.get(6), GGMaterial.tairitsu.get(OrePrefixes.frameGt, 6),
                ...
                GTOreDictUnificator.get(OrePrefixes.screw, Materials.Churitsu, 64),
                GTOreDictUnificator.get(OrePrefixes.bolt, Materials.Shijima, 64),
                GTOreDictUnificator.get(OrePrefixes.bolt, Materials.SixPhasedCopper, 24),
                GGMaterial.tairitsu.get(OrePrefixes.ring, 12),
                GTOreDictUnificator.get(OrePrefixes.screw, Materials.Hypogen, 24), ItemList.EnergisedTesseract.get(2),
                ItemList.Field_Generator_UEV.get(1) },
            new FluidStack[] { Materials.ChromaticGlass.getMolten(384 * INGOTS),
                Materials.Infinity.getMolten(48 * INGOTS), Materials.CelestialTungsten.getMolten(48 * INGOTS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.PeaceEnforcementCasing.get(6), Casings.ParticleBeamGuidancePipeCasing.toStack(6),
                ...
                GTOreDictUnificator.get(OrePrefixes.ring, Materials.Churitsu, 12),
                GTOreDictUnificator.get(OrePrefixes.screw, Materials.Shijima, 48),
                GTOreDictUnificator.get(OrePrefixes.rotor, Materials.SixPhasedCopper, 1),
                GTOreDictUnificator.get(OrePrefixes.stickLong, Materials.Churitsu, 3),
                GTOreDictUnificator.get(OrePrefixes.rotor, Materials.Hypogen, 1),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.ConflictInducementCasing.get(6), ItemList.ElectromagneticallyIsolatedCasing.get(2),
                GTOreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.SixPhasedCopper, 3),
                GTOreDictUnificator.get(OrePrefixes.gearGt, Materials.Shijima, 2),
                GTOreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.Hypogen, 3), ItemList.UIV_Coil.get(6),
                GTOreDictUnificator.get(OrePrefixes.stickLong, Materials.ProtoHalkonite, 6),
                GGMaterial.tairitsu.get(OrePrefixes.wireFine, 48),
                GTOreDictUnificator.get(OrePrefixes.foil, Materials.Churitsu, 24),
                GTOreDictUnificator.get(OrePrefixes.screw, Materials.Shijima, 48),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemRefer.Field_Restriction_Coil_T3.get(2),
                ...
                GTOreDictUnificator.get(OrePrefixes.bolt, Materials.Shijima, 32) },
            new FluidStack[] { Materials.ChromaticGlass.getMolten(96 * INGOTS),
                Materials.Infinity.getMolten(12 * INGOTS), Materials.CelestialTungsten.getMolten(12 * INGOTS),
                MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(4 * INGOTS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.CondensateGuidanceCoil.get(1),
                ...
                GGMaterial.tairitsu.get(OrePrefixes.stickLong, 6),
                GTOreDictUnificator.get(OrePrefixes.ring, Materials.Churitsu, 3),
                GTOreDictUnificator.get(OrePrefixes.plateDouble, Materials.Shijima, 6) },
            new FluidStack[] { Materials.ChromaticGlass.getMolten(96 * INGOTS),
                Materials.Infinity.getMolten(12 * INGOTS), Materials.CelestialTungsten.getMolten(12 * INGOTS),
                MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(4 * INGOTS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { Materials.ChromaticGlass.getMolten(768 * INGOTS),
                Materials.Infinity.getMolten(192 * INGOTS), Materials.CelestialTungsten.getMolten(192 * INGOTS),
    ...
    private void addGodforgeRecipes() {
        ...
        if (GalacticraftAmunRa.isModLoaded()) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Mellion, 16),
                    ...
                    GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.AstralTitanium, 8),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { CustomItemList.Godforge_BoundlessStructureCasing.get(1),
                ...
                GTOreDictUnificator.get(OrePrefixes.plate, Materials.Hypogen, 6) },
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(16 * INGOTS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { new ItemStack(BlockQuantumGlass.INSTANCE, 8),
                ...
                GTOreDictUnificator.get(OrePrefixes.plateDense, Materials.ChromaticGlass, 36),
            ...
            new FluidStack[] { Materials.Rhugnor.getMolten(16 * INGOTS), Materials.Creon.getMolten(16 * INGOTS),
                Materials.AdvancedNitinol.getMolten(16 * STACKS) },
    ...
    public void runLateRecipes() {
        if (EternalSingularity.isModLoaded()) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(2 * STACKS),
                    Materials.Bedrockium.getMolten(256 * STACKS), Materials.CelestialTungsten.getMolten(32 * STACKS),
