    ...
    public void run() {
        ...
        // UHV-UMV Energy Hatch & Dynamo
        {
            // Energy Hatches
            {
                ...
                TTRecipeAdder.addResearchableAssemblylineRecipe(
                    ...
                    new FluidStack[] { new FluidStack(FluidRegistry.getFluid("ic2coolant"), 16_000),
                ...
                TTRecipeAdder.addResearchableAssemblylineRecipe(
                    ...
                    new FluidStack[] { new FluidStack(FluidRegistry.getFluid("ic2coolant"), 32_000),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { MaterialsAlloy.INDALLOY_140.getFluidStack(20 * INGOTS),
                new FluidStack(FluidRegistry.getFluid("ic2coolant"), 10_000), Materials.Radon.getGas(2_500), },
        ...
        // Batteries
        {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(32 * INGOTS),
                    ...
                    new FluidStack(FluidRegistry.getFluid("ic2coolant"), 32_000) },
                ItemList.ZPM3.get(1),
                4000,
                1600000);
