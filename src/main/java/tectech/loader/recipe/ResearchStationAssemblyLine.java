...
public class ResearchStationAssemblyLine implements Runnable {
    ...
    public void run() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.OilDrill4.get(1),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Neutronium, Materials2Shapes.shapeGearGt, 4),
                ItemList.Sensor_UHV.get(3), ItemList.Field_Generator_UHV.get(3),
                MaterialLibAPI.getStack(Materials2Materials.Neutronium, Materials2Shapes.shapeScrew, 12) },
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(9 * INGOTS), MaterialLibAPI
                .getFluidStack(Materials2Materials.Neutronium, Materials2FluidShapes.shapeFluidMolten, 4 * INGOTS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { new Object[] { OrePrefixes.circuit.get(Materials.UHV), 1L },
                ...
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapeScrew, 8),
                ItemList.Naquarite_Universal_Insulator_Foil.get(24) },
            new FluidStack[] { MaterialLibAPI
                .getFluidStack(Materials2Materials.DraconiumAwakened, Materials2FluidShapes.shapeFluidMolten, 576), },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { MaterialLibAPI
                .getFluidStack(Materials2Materials.Infinity, Materials2FluidShapes.shapeFluidMolten, 576), },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { new Object[] { OrePrefixes.circuit.get(Materials.UIV), 1L },
                ...
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeScrew, 8),
        ...
        // UHV-UMV Energy Hatch & Dynamo
        {
            ...
            // Dynamo Hatch
            {
                ...
                TTRecipeAdder.addResearchableAssemblylineRecipe(
                    ...
                    new Object[] { ItemList.Hull_UEV.get(1L),
                        MaterialLibAPI
                            .getStack(Materials2Materials.SuperconductorUEVBase, Materials2Shapes.shapeSpring, 8),
                        ItemList.Circuit_Chip_FPIC.get(2L), new Object[] { OrePrefixes.circuit.get(Materials.UEV), 2L },
                        ItemList.UEV_Coil.get(2L), ItemList.Reactor_Coolant_Sp_6.get(1L),
                        ItemList.Reactor_Coolant_Sp_6.get(1L), ItemList.Electric_Pump_UEV.get(1L) },
                    new FluidStack[] { GTModHandler.getIC2Coolant(32_000),
                ...
                TTRecipeAdder.addResearchableAssemblylineRecipe(
                    ...
                    new Object[] { ItemList.Hull_UIV.get(1L),
                        MaterialLibAPI
                            .getStack(Materials2Materials.SuperconductorUIVBase, Materials2Shapes.shapeSpring, 8),
                        ItemList.Circuit_Chip_APIC.get(2L), new Object[] { OrePrefixes.circuit.get(Materials.UIV), 2L },
                        ItemList.UIV_Coil.get(2L), ItemList.Reactor_Coolant_Sp_6.get(1L),
                        ItemList.Reactor_Coolant_Sp_6.get(1L), ItemList.Reactor_Coolant_Sp_6.get(1L),
                        ItemList.Reactor_Coolant_Sp_6.get(1L), ItemList.Electric_Pump_UIV.get(1L) },
                ...
                TTRecipeAdder.addResearchableAssemblylineRecipe(
                    ...
                    new Object[] { ItemList.Hull_UMV.get(1L),
                        MaterialLibAPI
                            .getStack(Materials2Materials.SuperconductorUMVBase, Materials2Shapes.shapeSpring, 8),
                        ItemList.Circuit_Chip_ZPIC.get(2L), new Object[] { OrePrefixes.circuit.get(Materials.UMV), 2L },
                        ItemList.UMV_Coil.get(2L), ItemList.Reactor_Coolant_Sp_6.get(1L),
                        ItemList.Reactor_Coolant_Sp_6.get(1L), ItemList.Reactor_Coolant_Sp_6.get(1L),
                        ItemList.Reactor_Coolant_Sp_6.get(1L), ItemList.Reactor_Coolant_Sp_6.get(1L),
                ...
                TTRecipeAdder.addResearchableAssemblylineRecipe(
                    ...
                    new Object[] { ItemList.Hull_UXV.get(1L),
                        MaterialLibAPI
                            .getStack(Materials2Materials.SuperconductorUMVBase, Materials2Shapes.shapeSpring, 16),
                        ItemList.Circuit_Chip_YPIC.get(2L), new Object[] { OrePrefixes.circuit.get(Materials.UXV), 2L },
                        ItemList.UXV_Coil.get(2L), ItemList.Reactor_Coolant_Sp_6.get(1L),
                        ItemList.Reactor_Coolant_Sp_6.get(1L), ItemList.Reactor_Coolant_Sp_6.get(1L),
                        ItemList.Reactor_Coolant_Sp_6.get(1L), ItemList.Reactor_Coolant_Sp_6.get(1L),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { MaterialsAlloy.INDALLOY_140.getFluidStack(20 * INGOTS),
                ...
                MaterialLibAPI.getFluidStack(Materials2Materials.Radon, Materials2FluidShapes.shapeFluidGas, 2_500), },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Circuit_Board_Bio_Ultra.get(2L), ItemList.Circuit_Biowarecomputer.get(2L),
                ...
                MaterialLibAPI.getStack(Materials2Materials.NiobiumTitanium, Materials2Shapes.shapeWireFine, 32),
                new Object[] { OrePrefixes.foil.get(Materials.AnySyntheticRubber), 64L }, },
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(10 * INGOTS),
                ...
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.SuperCoolant, Materials2FluidShapes.shapeFluidLiquid, 10_000), },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Tritanium, 4L),
                ...
                new Object[] { OrePrefixes.foil.get(Materials.AnySyntheticRubber), 64L },
                MaterialLibAPI.getStack(Materials2Materials.Polybenzimidazole, Materials2Shapes.shapeFoil, 64) },
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(20 * INGOTS),
                ...
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.SuperCoolant, Materials2FluidShapes.shapeFluidLiquid, 20_000), },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(10 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Radon, Materials2FluidShapes.shapeFluidPlasma, 10 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.SuperCoolant, Materials2FluidShapes.shapeFluidLiquid, 10_000),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(20 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Radon, Materials2FluidShapes.shapeFluidPlasma, 20 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.SuperCoolant, Materials2FluidShapes.shapeFluidLiquid, 20_000),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(40 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Radon, Materials2FluidShapes.shapeFluidPlasma, 40 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.SuperCoolant, Materials2FluidShapes.shapeFluidLiquid, 40_000),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] {
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.ExcitedDTCC, Materials2FluidShapes.shapeFluidLiquid, 2_048_000),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.ExcitedDTPC, Materials2FluidShapes.shapeFluidLiquid, 2_048_000),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.ExcitedDTRC, Materials2FluidShapes.shapeFluidLiquid, 2_048_000),
                MaterialLibAPI.getFluidStack(
        ...
        if (EternalSingularity.isModLoaded()) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { ItemList.Casing_Dim_Bridge.get(4), ItemList.ExothermicHearth.get(16),
                    ...
                    MaterialLibAPI.getStack(Materials2Materials.Osmiridium, Materials2Shapes.shapePlateSuperdense, 4),
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                (int) TierEU.RECIPE_UIV,
                1,
                new Object[] { MaterialLibAPI.getStack(Materials2Materials.Osmiridium, Materials2Shapes.shapePlate, 4),
                    MaterialLibAPI.getStack(Materials2Materials.Ledox, Materials2Shapes.shapePlateDense, 1),
                    MaterialLibAPI.getStack(Materials2Materials.CallistoIce, Materials2Shapes.shapePlateDense, 1),
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                (int) TierEU.RECIPE_UIV,
                1,
                new Object[] { MaterialLibAPI.getStack(Materials2Materials.Osmiridium, Materials2Shapes.shapePlate, 6),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { new FluidStack(FluidRegistry.getFluid("oganesson"), 50_000),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Infinity, Materials2FluidShapes.shapeFluidMolten, 8 * STACKS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Cheese, Materials2FluidShapes.shapeFluidMolten, 232_000), },
        ...
        // Batteries
        {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                100000,
                3,
                new Object[] { MaterialLibAPI.getStack(Materials2Materials.Tritanium, Materials2Shapes.shapePlate, 64),
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                6,
                new Object[] {
                    MaterialLibAPI.getStack(Materials2Materials.Neutronium, Materials2Shapes.shapePlateDouble, 64),
                ...
                new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(32 * INGOTS), MaterialLibAPI
                    .getFluidStack(Materials2Materials.Naquadria, Materials2FluidShapes.shapeFluidMolten, 1 * STACKS),
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] {
                    MaterialLibAPI
                        .getStack(Materials2Materials.InfinityCatalyst, Materials2Shapes.shapePlateDouble, 64),
                ...
                new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(1 * STACKS), MaterialLibAPI
                    .getFluidStack(Materials2Materials.Quantium, Materials2FluidShapes.shapeFluidMolten, 2 * STACKS),
                    MaterialLibAPI.getFluidStack(
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GregtechItemList.Casing_Fusion_Internal.get(1),
                ...
                new Object[] { OrePrefixes.circuit.get(Materials.UEV), 1L },
                new Object[] { OrePrefixes.circuit.get(Materials.UEV), 1L },
                MaterialLibAPI.getStack(Materials2Materials.Neutronium, Materials2Shapes.shapePlateSuperdense, 1),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Energy_LapotronicOrb2.get(16L),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Neutronium, Materials2Shapes.shapePlate, 8),
        ...
        if (BloodMagic.isModLoaded() && DraconicEvolution.isModLoaded()) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { ItemList.AssemblingMachineUHV.get(1), new ItemStack(defcCasingBlock, 1, 8),
                    MaterialLibAPI.getStack(Materials2Materials.GaiaSpirit, Materials2Shapes.shapePlateDense, 1),
                    ...
                    MaterialLibAPI.getStack(Materials2Materials.Void, Materials2Shapes.shapePlateSuperdense, 1) },
                new FluidStack[] { MaterialsAlloy.INDALLOY_140.getFluidStack(20 * INGOTS),
                    MaterialLibAPI
                        .getFluidStack(Materials2Materials.Void, Materials2FluidShapes.shapeFluidMolten, 20 * INGOTS),
                    MaterialLibAPI.getFluidStack(
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { getModItem(DraconicEvolution.ID, "draconicCore", 1, 0),
                    MaterialLibAPI.getStack(Materials2Materials.Draconium, Materials2Shapes.shapePlateDense, 1),
                    MaterialLibAPI.getStack(Materials2Materials.Ichorium, Materials2Shapes.shapePlate, 1),
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { getModItem(DraconicEvolution.ID, "draconicCore", 4, 0),
                    MaterialLibAPI.getStack(Materials2Materials.Draconium, Materials2Shapes.shapePlateDense, 1),
                    MaterialLibAPI.getStack(Materials2Materials.Neutronium, Materials2Shapes.shapePlate, 1),
                    new Object[] { OrePrefixes.circuit.get(Materials.UEV), 1 }, },
                new FluidStack[] {
                    MaterialLibAPI
                        .getFluidStack(Materials2Materials.Neutronium, Materials2FluidShapes.shapeFluidMolten, 14400),
                    MaterialLibAPI
                        .getFluidStack(Materials2Materials.Void, Materials2FluidShapes.shapeFluidMolten, 57600), },
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { getModItem(DraconicEvolution.ID, "wyvernCore", 4, 0),
                    MaterialLibAPI.getStack(Materials2Materials.DraconiumAwakened, Materials2Shapes.shapePlateDense, 1),
                    MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapePlate, 1),
                    new Object[] { OrePrefixes.circuit.get(Materials.UIV), 1L } },
                new FluidStack[] {
                    MaterialLibAPI
                        .getFluidStack(Materials2Materials.Infinity, Materials2FluidShapes.shapeFluidMolten, 14400),
                    MaterialLibAPI
                        .getFluidStack(Materials2Materials.Void, Materials2FluidShapes.shapeFluidMolten, 115200), },
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { getModItem(DraconicEvolution.ID, "awakenedCore", 8, 0),
                    MaterialLibAPI.getStack(Materials2Materials.DraconiumAwakened, Materials2Shapes.shapePlateDense, 4),
                    MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapePlate, 1),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Hatch_AutoMaintenance.get(1L), ItemList.Robot_Arm_UV.get(1L),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Americium, Materials2Shapes.shapeWireFine, 64), },
            new FluidStack[] {
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Lubricant, Materials2FluidShapes.shapeFluidLiquid, 256_000),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemRefer.GravityStabilizationCasing.get(16), ItemRefer.Field_Restriction_Coil_T4.get(2),
                ...
                MaterialLibAPI.getStack(Materials2Materials.SuperconductorUMVBase, Materials2Shapes.shapeWireFine, 64),
            ...
            new FluidStack[] { new FluidStack(CHRONOMATIC_GLASS.getPlasma(), 1 * STACKS),
                MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(1 * STACKS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Eternity, Materials2FluidShapes.shapeFluidMolten, 1 * STACKS) },
    ...
    private void itemPartsUHVAsslineRecipes() {
        ...
        FluidStack fluid_0 = MaterialLibAPI
            .getFluidStack(Materials2Materials.Naquadria, Materials2FluidShapes.shapeFluidMolten, 18 * INGOTS);
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            research_amperage,
            new ItemStack[] {
                MaterialLibAPI.getStack(Materials2Materials.SamariumMagnetic, Materials2Shapes.shapeStickLong, 4),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeStickLong, 8),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeRing, 8),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeRound, 32),
                MaterialLibAPI.getStack(Materials2Materials.Neutronium, Materials2Shapes.shapeWireFine, 64),
                MaterialLibAPI.getStack(Materials2Materials.Neutronium, Materials2Shapes.shapeWireFine, 64),
                MaterialLibAPI.getStack(Materials2Materials.Neutronium, Materials2Shapes.shapeWireFine, 64),
                MaterialLibAPI.getStack(Materials2Materials.Neutronium, Materials2Shapes.shapeWireFine, 64),
                MaterialLibAPI.getStack(Materials2Materials.Neutronium, Materials2Shapes.shapeWireFine, 64),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Electric_Motor_UHV.get(1L),
                ...
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapePlate, 4),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeScrew, 16),
                new Object[] { OrePrefixes.ring.get(Materials.AnySyntheticRubber), 32L },
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeRotor, 4),
                GTOreDictUnificator.get(OrePrefixes.cableGt04, Materials.Bedrockium, 2L) },
            new FluidStack[] { fluid_0, fluid_1, fluid_2 },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Electric_Motor_UHV.get(2L),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapePlate, 2),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeRing, 8),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeRound, 64),
                GTOreDictUnificator.get(OrePrefixes.cableGt04, Materials.Bedrockium, 2L),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] {
                ...
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeGearGtSmall, 6),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new ItemStack[] { ItemList.Electric_Motor_UHV.get(1L),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapePlate, 6),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeRing, 8),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeRound, 64),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeStick, 8),
                GTOreDictUnificator.get(OrePrefixes.gear, Materials.CosmicNeutronium, 2L),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeGearGtSmall, 4),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.CosmicNeutronium, 1L),
                ItemList.Electric_Motor_UHV.get(1L),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeStick, 8),
                ItemList.Gravistar.get(8L), new Object[] { OrePrefixes.circuit.get(Materials.UHV), 4L },
                MaterialLibAPI.getStack(Materials2Materials.ElectrumFlux, Materials2Shapes.shapeFoil, 64),
                MaterialLibAPI.getStack(Materials2Materials.ElectrumFlux, Materials2Shapes.shapeFoil, 64),
                MaterialLibAPI.getStack(Materials2Materials.ElectrumFlux, Materials2Shapes.shapeFoil, 64),
                MaterialLibAPI.getStack(Materials2Materials.ElectrumFlux, Materials2Shapes.shapeFoil, 64),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.CosmicNeutronium, 1L),
                ItemList.Electric_Motor_UHV.get(1L),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapePlate, 8),
                ItemList.Gravistar.get(8L), new Object[] { OrePrefixes.circuit.get(Materials.UHV), 4L },
                MaterialLibAPI.getStack(Materials2Materials.ElectrumFlux, Materials2Shapes.shapeFoil, 64),
                MaterialLibAPI.getStack(Materials2Materials.ElectrumFlux, Materials2Shapes.shapeFoil, 64),
                MaterialLibAPI.getStack(Materials2Materials.ElectrumFlux, Materials2Shapes.shapeFoil, 64),
    ...
    private void itemPartsUEVAsslineRecipes() {
        ...
        FluidStack fluid_0 = MaterialLibAPI
            .getFluidStack(Materials2Materials.Quantium, Materials2FluidShapes.shapeFluidMolten, 18 * INGOTS);
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            research_amperage,
            new ItemStack[] {
                MaterialLibAPI.getStack(Materials2Materials.TengamAttuned, Materials2Shapes.shapeStickLong, 8),
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapeStickLong, 16),
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapeRing, 8),
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapeRound, 32),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeWireFine, 64),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeWireFine, 64),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeWireFine, 64),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeWireFine, 64),
                MaterialLibAPI.getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapeWireFine, 64),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Electric_Motor_UEV.get(1L),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapePlate, 4),
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapeScrew, 16),
                new Object[] { OrePrefixes.ring.get(Materials.AnySyntheticRubber), 64L },
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapeRotor, 4),
                GTOreDictUnificator.get(OrePrefixes.cableGt04, Materials.Draconium, 2L) },
            new FluidStack[] { fluid_0, fluid_1, fluid_2 },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Electric_Motor_UEV.get(2L),
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapePlate, 2),
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapeRing, 8),
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapeRound, 64),
                GTOreDictUnificator.get(OrePrefixes.cableGt04, Materials.Draconium, 2L),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            research_eu_per_tick,
            research_amperage,
            new Object[] { MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapeStickLong, 8),
                GTOreDictUnificator.get(OrePrefixes.gear, Materials.Infinity, 2L),
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapeGearGtSmall, 6),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new ItemStack[] { ItemList.Electric_Motor_UEV.get(1L),
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapePlate, 6),
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapeRing, 8),
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapeRound, 64),
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapeStick, 8),
                GTOreDictUnificator.get(OrePrefixes.gear, Materials.Infinity, 2L),
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapeGearGtSmall, 4),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Infinity, 1L),
                ItemList.Electric_Motor_UEV.get(1L),
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapeStick, 16),
                ItemList.Gravistar.get(16L), new Object[] { OrePrefixes.circuit.get(Materials.UEV), 4L },
                MaterialLibAPI.getStack(Materials2Materials.InfinityCatalyst, Materials2Shapes.shapeFoil, 64),
                MaterialLibAPI.getStack(Materials2Materials.InfinityCatalyst, Materials2Shapes.shapeFoil, 64),
                MaterialLibAPI.getStack(Materials2Materials.InfinityCatalyst, Materials2Shapes.shapeFoil, 64),
                MaterialLibAPI.getStack(Materials2Materials.InfinityCatalyst, Materials2Shapes.shapeFoil, 64),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Infinity, 1L),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapePlate, 8),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Infinity, 1L),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Tritanium, Materials2Shapes.shapeWireFine, 64),
                MaterialLibAPI.getStack(Materials2Materials.Tritanium, Materials2Shapes.shapeWireFine, 64),
                MaterialLibAPI.getStack(Materials2Materials.Tritanium, Materials2Shapes.shapeWireFine, 64),
                MaterialLibAPI.getStack(Materials2Materials.Tritanium, Materials2Shapes.shapeWireFine, 64),
                MaterialLibAPI.getStack(Materials2Materials.Tritanium, Materials2Shapes.shapeWireFine, 64),
    ...
    private void itemPartsUIVAsslineRecipes() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new ItemStack[] {
                ...
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapeStickLong, 16),
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapeRing, 8),
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapeRound, 32),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Electric_Motor_UIV.get(1L),
                ...
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapePlate, 4),
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapeScrew, 16),
                new Object[] { OrePrefixes.ring.get(Materials.AnySyntheticRubber), 64L },
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapeRotor, 4),
                GTOreDictUnificator.get(OrePrefixes.cableGt04, Materials.NetherStar, 2L) },
            new FluidStack[] { fluid_0, fluid_1, fluid_2 },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Electric_Motor_UIV.get(2L),
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapePlate, 2),
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapeRing, 8),
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapeRound, 64),
                GTOreDictUnificator.get(OrePrefixes.cableGt04, Materials.NetherStar, 2L),
                new Object[] { OrePrefixes.plate.get(Materials.AnySyntheticRubber), 64L },
                new Object[] { OrePrefixes.plate.get(Materials.AnySyntheticRubber), 16L } },
            new FluidStack[] { fluid_0, fluid_1, fluid_2 },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            research_amperage,
            new Object[] {
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapeStickLong, 8),
                GTOreDictUnificator.get(OrePrefixes.gear, Materials.TranscendentMetal, 2L),
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapeGearGtSmall, 6),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new ItemStack[] { ItemList.Electric_Motor_UIV.get(1L),
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapePlate, 6),
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapeRing, 8),
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapeRound, 64),
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapeStick, 8),
                GTOreDictUnificator.get(OrePrefixes.gear, Materials.TranscendentMetal, 2L),
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapeGearGtSmall, 4),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.TranscendentMetal, 1L),
                ItemList.Electric_Motor_UIV.get(1L),
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapeStick, 16),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.TranscendentMetal, 1L),
                ...
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapePlate, 8),
                ItemList.NuclearStar.get(2L), new Object[] { OrePrefixes.circuit.get(Materials.UIV), 4L },
                TRINIUM_REINFORCED_STEEL.getFoil(64), LAFIUM.getFoil(64), CINOBITE.getFoil(64), PIKYONIUM.getFoil(64),
                GTOreDictUnificator.get(OrePrefixes.cableGt04, Materials.NetherStar, 7L) },
            new FluidStack[] { fluid_0, fluid_1 },
    ...
    private void itemPartsUMVAsslineRecipes() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            research_amperage,
            new ItemStack[] {
                MaterialLibAPI.getStack(Materials2Materials.TengamAttuned, Materials2Shapes.shapeStickLong, 32),
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeStickLong, 16),
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeRing, 8),
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeRound, 32),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Electric_Motor_UMV.get(1L),
                ...
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapePlate, 4),
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeScrew, 16),
                new Object[] { OrePrefixes.ring.get(Materials.AnySyntheticRubber), 64L },
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeRotor, 4),
                GTOreDictUnificator.get(OrePrefixes.cableGt04, Materials.Quantium, 2L) },
            new FluidStack[] { fluid_0, fluid_1, fluid_2, fluid_3 },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Electric_Motor_UMV.get(2L),
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapePlate, 2),
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeRing, 8),
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeRound, 64),
                GTOreDictUnificator.get(OrePrefixes.cableGt04, Materials.Quantium, 2L),
                new Object[] { OrePrefixes.plate.get(Materials.AnySyntheticRubber), 64L },
                new Object[] { OrePrefixes.plate.get(Materials.AnySyntheticRubber), 16L } },
            new FluidStack[] { fluid_0, fluid_1, fluid_2, fluid_3 },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            research_eu_per_tick,
            research_amperage,
            new Object[] { MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeStickLong, 8),
                GTOreDictUnificator.get(OrePrefixes.gear, Materials.SpaceTime, 2L),
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeGearGtSmall, 6),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new ItemStack[] { ItemList.Electric_Motor_UMV.get(1L),
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapePlate, 6),
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeRing, 8),
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeRound, 64),
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeStick, 8),
                GTOreDictUnificator.get(OrePrefixes.gear, Materials.SpaceTime, 2L),
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeGearGtSmall, 4),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.SpaceTime, 1L),
                ItemList.Electric_Motor_UMV.get(1L),
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeStick, 16),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.SpaceTime, 1L),
                ...
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapePlate, 8),
                ItemList.NuclearStar.get(4L), new Object[] { OrePrefixes.circuit.get(Materials.UMV), 4L },
                MaterialsElements.STANDALONE.CELESTIAL_TUNGSTEN.getFoil(64), QUANTUM.getFoil(64),
                ASTRAL_TITANIUM.getFoil(64), TITANSTEEL.getFoil(64),
                GTOreDictUnificator.get(OrePrefixes.cableGt04, Materials.Quantium, 7L) },
    ...
    private void itemPartsUXVAsslineRecipes() {
        ...
        FluidStack moltenSpaceTime_576 = MaterialLibAPI
            .getFluidStack(Materials2Materials.SpaceTime, Materials2FluidShapes.shapeFluidMolten, 4 * INGOTS);
        FluidStack moltenUniversium_576 = MaterialLibAPI
            .getFluidStack(Materials2Materials.Universium, Materials2FluidShapes.shapeFluidMolten, 4 * INGOTS);
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new ItemStack[] { ItemList.EnergisedTesseract.get(1),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Universium, Materials2Shapes.shapeWireFine, 64),
                MaterialLibAPI.getStack(Materials2Materials.Universium, Materials2Shapes.shapeWireFine, 64),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Electric_Motor_UXV.get(1L),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Kevlar, Materials2Shapes.shapeRing, 64),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Electric_Motor_UXV.get(2L),
                ...
                GTOreDictUnificator.get(OrePrefixes.wireGt04, Materials.SpaceTime, 4L),
                MaterialLibAPI.getStack(Materials2Materials.Kevlar, Materials2Shapes.shapePlate, 64),
                MaterialLibAPI.getStack(Materials2Materials.Kevlar, Materials2Shapes.shapePlate, 16),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.MHDCSM, 1L),
                ...
                MaterialLibAPI.getStack(Materials2Materials.SpaceTime, Materials2Shapes.shapeFoil, 64),
                MaterialLibAPI.getStack(Materials2Materials.Universium, Materials2Shapes.shapeFoil, 64),
    ...
    private void addBeamcraftingRecipes() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { MaterialLibAPI
                .getFluidStack(Materials2Materials.SuperCoolant, Materials2FluidShapes.shapeFluidLiquid, 16000) },
    ...
    private void addBecCasingRecipes() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.BlockQuarkContainmentCasing.get(6), GGMaterial.tairitsu.get(OrePrefixes.frameGt, 6),
                GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Churitsu, 6),
                GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Shijima, 6),
                ...
                GGMaterial.tairitsu.get(OrePrefixes.plate, 8),
                MaterialLibAPI.getStack(Materials2Materials.Churitsu, Materials2Shapes.shapeScrew, 64),
                MaterialLibAPI.getStack(Materials2Materials.Shijima, Materials2Shapes.shapeBolt, 64),
                MaterialLibAPI.getStack(Materials2Materials.SixPhasedCopper, Materials2Shapes.shapeBolt, 24),
                GGMaterial.tairitsu.get(OrePrefixes.ring, 12), MaterialsElements.STANDALONE.HYPOGEN.getScrew(24),
                ItemList.EnergisedTesseract.get(2), ItemList.Field_Generator_UEV.get(1) },
            new FluidStack[] { MaterialsElements.STANDALONE.CHRONOMATIC_GLASS.getFluidStack(384 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Infinity, Materials2FluidShapes.shapeFluidMolten, 48 * INGOTS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.PeaceEnforcementCasing.get(6), Casings.ParticleBeamGuidancePipeCasing.toStack(6),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Churitsu, Materials2Shapes.shapeRing, 12),
                MaterialLibAPI.getStack(Materials2Materials.Shijima, Materials2Shapes.shapeScrew, 48),
                MaterialLibAPI.getStack(Materials2Materials.SixPhasedCopper, Materials2Shapes.shapeRotor, 1),
                MaterialLibAPI.getStack(Materials2Materials.Churitsu, Materials2Shapes.shapeStickLong, 3),
                HYPOGEN.getRotor(1),
                MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapeStickLong, 6),
                ItemList.Electric_Pump_UIV.get(2) },
            new FluidStack[] { CHRONOMATIC_GLASS.getFluidStack(384 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Infinity, Materials2FluidShapes.shapeFluidMolten, 48 * INGOTS),
                MaterialsElements.STANDALONE.CELESTIAL_TUNGSTEN.getFluidStack(48 * INGOTS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.ConflictInducementCasing.get(6), ItemList.ElectromagneticallyIsolatedCasing.get(2),
                MaterialLibAPI.getStack(Materials2Materials.SixPhasedCopper, Materials2Shapes.shapeGearGtSmall, 3),
                MaterialLibAPI.getStack(Materials2Materials.Shijima, Materials2Shapes.shapeGearGt, 2),
                MaterialsElements.STANDALONE.HYPOGEN.getGearSmall(3), ItemList.UIV_Coil.get(6),
                GTOreDictUnificator.get(OrePrefixes.stickLong, Materials.ProtoHalkonite, 6),
                GGMaterial.tairitsu.get(OrePrefixes.wireFine, 48),
                MaterialLibAPI.getStack(Materials2Materials.Churitsu, Materials2Shapes.shapeFoil, 24),
                MaterialLibAPI.getStack(Materials2Materials.Shijima, Materials2Shapes.shapeScrew, 48),
                GTModHandler.getModItem(Railcraft.ID, "machine.eta", 6, 8),
                GTOreDictUnificator.get(OrePrefixes.ring, Materials.ProtoHalkonite, 12),
                MaterialLibAPI.getStack(Materials2Materials.Churitsu, Materials2Shapes.shapeGearGtSmall, 6),
                MaterialLibAPI.getStack(Materials2Materials.Shijima, Materials2Shapes.shapeScrew, 48),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemRefer.Field_Restriction_Coil_T3.get(2),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Churitsu, Materials2Shapes.shapeFoil, 12),
                MaterialLibAPI.getStack(Materials2Materials.Shijima, Materials2Shapes.shapeScrew, 24),
                GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Churitsu, 2),
                GGMaterial.tairitsu.get(OrePrefixes.screw, 32),
                MaterialLibAPI.getStack(Materials2Materials.Shijima, Materials2Shapes.shapeBolt, 32) },
            new FluidStack[] { CHRONOMATIC_GLASS.getFluidStack(96 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Infinity, Materials2FluidShapes.shapeFluidMolten, 12 * INGOTS),
                MaterialsElements.STANDALONE.CELESTIAL_TUNGSTEN.getFluidStack(12 * INGOTS),
                MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(4 * INGOTS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.CondensateGuidanceCoil.get(1),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Churitsu, Materials2Shapes.shapeItemCasing, 6),
                MaterialLibAPI.getStack(Materials2Materials.Shijima, Materials2Shapes.shapeScrew, 64),
                ItemList.Field_Generator_UHV.get(3), GGMaterial.tairitsu.get(OrePrefixes.stickLong, 6),
                MaterialLibAPI.getStack(Materials2Materials.Churitsu, Materials2Shapes.shapeRing, 3),
                MaterialLibAPI.getStack(Materials2Materials.Shijima, Materials2Shapes.shapePlateDouble, 6) },
            new FluidStack[] { CHRONOMATIC_GLASS.getFluidStack(96 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Infinity, Materials2FluidShapes.shapeFluidMolten, 12 * INGOTS),
                MaterialsElements.STANDALONE.CELESTIAL_TUNGSTEN.getFluidStack(12 * INGOTS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { CHRONOMATIC_GLASS.getFluidStack(768 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Infinity, Materials2FluidShapes.shapeFluidMolten, 192 * INGOTS),
    ...
    private void addGodforgeRecipes() {
        if (EternalSingularity.isModLoaded()) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { CustomItemList.Godforge_StellarEnergySiphonCasing.get(4), ItemList.ZPM4.get(2),
                    ...
                    MaterialLibAPI.getStack(Materials2Materials.Mellion, Materials2Shapes.shapePlateDense, 16),
                    MaterialLibAPI.getStack(Materials2Materials.SixPhasedCopper, Materials2Shapes.shapePlateDense, 16),
                    MaterialLibAPI.getStack(Materials2Materials.Creon, Materials2Shapes.shapePlateDense, 16),
                ...
                new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(32 * STACKS), MaterialLibAPI
                    .getFluidStack(Materials2Materials.ExcitedDTEC, Materials2FluidShapes.shapeFluidLiquid, 8_192_000),
                    MaterialLibAPI
                        .getFluidStack(Materials2Materials.Thorium, Materials2FluidShapes.shapeFluidPlasma, 4 * STACKS),
                    MaterialLibAPI.getFluidStack(
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.TranscendentMetal, 8),
                ...
                MaterialLibAPI.getStack(Materials2Materials.TengamAttuned, Materials2Shapes.shapePlateDense, 32),
                MaterialLibAPI.getStack(Materials2Materials.Creon, Materials2Shapes.shapePlate, 16),
                MaterialsElements.STANDALONE.HYPOGEN.getScrew(8),
                MaterialLibAPI.getStack(Materials2Materials.SixPhasedCopper, Materials2Shapes.shapeScrew, 8),
                ItemList.SuperconductorComposite.get(1), ItemList.Emitter_UIV.get(2),
                ItemList.Electromagnet_Tengam.get(1) },
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(16 * INGOTS), MaterialLibAPI
                .getFluidStack(Materials2Materials.Plutonium241, Materials2FluidShapes.shapeFluidPlasma, 16 * INGOTS) },
        ...
        if (GalacticraftAmunRa.isModLoaded()) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Mellion, 16),
                    ...
                    MaterialLibAPI.getStack(Materials2Materials.Creon, Materials2Shapes.shapePlate, 6),
                ...
                new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(16 * INGOTS),
                    MaterialLibAPI
                        .getFluidStack(Materials2Materials.Lead, Materials2FluidShapes.shapeFluidPlasma, 2 * INGOTS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { CustomItemList.Godforge_BoundlessStructureCasing.get(1), ItemList.ZPM2.get(1),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Creon, Materials2Shapes.shapePlate, 6),
                MaterialLibAPI.getStack(Materials2Materials.Creon, Materials2Shapes.shapeGearGt, 8),
                MaterialLibAPI.getStack(Materials2Materials.Mellion, Materials2Shapes.shapeGearGtSmall, 8) },
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(16 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Thorium, Materials2FluidShapes.shapeFluidPlasma, 2 * INGOTS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { CustomItemList.Godforge_BoundlessStructureCasing.get(1),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Creon, Materials2Shapes.shapePlateDense, 6),
            ...
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(16 * INGOTS),
                MaterialLibAPI.getFluidStack(
                    ...
                    32 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.ExcitedDTEC, Materials2FluidShapes.shapeFluidLiquid, 128_000) },
            CustomItemList.Godforge_StellarEnergySiphonCasing.get(1),
            10 * SECONDS,
            (int) TierEU.RECIPE_UIV);
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { new ItemStack(BlockQuantumGlass.INSTANCE, 8),
                ...
                MaterialLibAPI.getStack(Materials2Materials.Creon, Materials2Shapes.shapeStickLong, 6),
                MaterialLibAPI.getStack(Materials2Materials.Mellion, Materials2Shapes.shapeStickLong, 6),
                MaterialLibAPI.getStack(Materials2Materials.SixPhasedCopper, Materials2Shapes.shapeStickLong, 6) },
            new FluidStack[] { MaterialsElements.STANDALONE.RHUGNOR.getFluidStack(16 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Creon, Materials2FluidShapes.shapeFluidMolten, 16 * INGOTS),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(32 * INGOTS),
                MaterialLibAPI.getFluidStack(
                    ...
                    32 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Infinity, Materials2FluidShapes.shapeFluidMolten, 32 * INGOTS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.TranscendentMetal, 1),
                MaterialLibAPI.getStack(Materials2Materials.Creon, Materials2Shapes.shapeStickLong, 12),
            ...
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(1 * STACKS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.PhononMedium, Materials2FluidShapes.shapeFluidLiquid, 1_000),
                MaterialLibAPI.getFluidStack(
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { CustomItemList.Godforge_SingularityShieldingCasing.get(4), ItemList.ExothermicHearth.get(64),
                ...
                MaterialLibAPI.getStack(Materials2Materials.SixPhasedCopper, Materials2Shapes.shapePlateDense, 16),
                MaterialLibAPI.getStack(Materials2Materials.Creon, Materials2Shapes.shapePlateDense, 8),
                MaterialLibAPI.getStack(Materials2Materials.Mellion, Materials2Shapes.shapePlateDense, 8),
            ...
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(16 * STACKS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.ExcitedDTEC, Materials2FluidShapes.shapeFluidLiquid, 2_048_000),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.Lead, Materials2FluidShapes.shapeFluidPlasma, 4 * STACKS),
                MaterialLibAPI.getFluidStack(
                    Materials2Materials.TranscendentMetal,
                    Materials2FluidShapes.shapeFluidMolten,
                    16 * STACKS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(16 * STACKS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.ExcitedDTEC, Materials2FluidShapes.shapeFluidLiquid, 2_048_000),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.PhononMedium, Materials2FluidShapes.shapeFluidLiquid, 32_000),
                MaterialLibAPI.getFluidStack(
                    Materials2Materials.TranscendentMetal,
                    Materials2FluidShapes.shapeFluidMolten,
                    16 * STACKS) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { CustomItemList.Godforge_SingularityShieldingCasing.get(4), ItemList.FluidHeaterUIV.get(64),
                ...
                ItemList.Robot_Arm_UIV.get(16), ItemList.Conveyor_Module_UIV.get(32),
                ItemList.Electric_Pump_UIV.get(64), ItemList.Relativistic_Heat_Capacitor.get(8),
                MaterialLibAPI.getStack(Materials2Materials.SixPhasedCopper, Materials2Shapes.shapePlateSuperdense, 2),
                MaterialLibAPI.getStack(Materials2Materials.Creon, Materials2Shapes.shapePlateSuperdense, 1),
                MaterialLibAPI.getStack(Materials2Materials.Mellion, Materials2Shapes.shapePlateSuperdense, 1),
                new Object[] { OrePrefixes.circuit.get(Materials.UIV), 32L } },
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(16 * STACKS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.ExcitedDTEC, Materials2FluidShapes.shapeFluidLiquid, 2_048_000),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { CustomItemList.Godforge_SingularityShieldingCasing.get(4),
                ...
                MaterialLibAPI.getStack(Materials2Materials.SixPhasedCopper, Materials2Shapes.shapePlateSuperdense, 4),
                MaterialLibAPI.getStack(Materials2Materials.Creon, Materials2Shapes.shapePlateSuperdense, 2),
                MaterialLibAPI.getStack(Materials2Materials.Mellion, Materials2Shapes.shapePlateSuperdense, 2),
                new Object[] { OrePrefixes.circuit.get(Materials.UIV), 64L } },
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(16 * STACKS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.ExcitedDTEC, Materials2FluidShapes.shapeFluidLiquid, 2_048_000),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.PhononMedium, Materials2FluidShapes.shapeFluidLiquid, 64_000),
                MaterialLibAPI.getFluidStack(
                    Materials2Materials.TranscendentMetal,
                    Materials2FluidShapes.shapeFluidMolten,
                    16 * STACKS) },
    ...
    private void addWirelessEnergyRecipes() {
        ...
        for (int i = 0; i < wirelessHatches.length; i++) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { energyHatches[i], new ItemStack(compactFusionCoil, 1),
                    ...
                    MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapePlateDense, 1),
                ...
                new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(9 * INGOTS),
                    MaterialLibAPI
                        .getFluidStack(Materials2Materials.ExcitedDTEC, Materials2FluidShapes.shapeFluidLiquid, 500) },
                wirelessHatches[i],
                recipeDurationTicks,
                recipeEuPerTick);
        }
        ...
        for (int i = 0; i < wirelessHatches_4A.length; i++) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(36 * INGOTS), MaterialLibAPI
                    .getFluidStack(Materials2Materials.ExcitedDTEC, Materials2FluidShapes.shapeFluidLiquid, 2_000) },
        ...
        for (int i = 0; i < wirelessHatches_16A.length; i++) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { energyHatches_16A[i], new ItemStack(compactFusionCoil, 1, 2),
                    ...
                    MaterialLibAPI.getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapePlateDense, 4),
        ...
        for (int i = 0; i < wirelessHatches_64A.length; i++) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { energyHatches_64A[i], new ItemStack(compactFusionCoil, 1, 3),
                    ...
                    ItemList.EnergisedTesseract.get(1) },
                new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(9 * STACKS), MaterialLibAPI
                    .getFluidStack(Materials2Materials.ExcitedDTEC, Materials2FluidShapes.shapeFluidLiquid, 32_000) },
        ...
        for (int i = 0; i < wirelessLasers.length; i++) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { laserTargets_UXV[i], new ItemStack(compactFusionCoil, 1, 4),
                    ...
                    MaterialLibAPI.getStack(Materials2Materials.Eternity, Materials2Shapes.shapePlateDense, 32),
                ...
                new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(36 * STACKS), MaterialLibAPI
                    .getFluidStack(Materials2Materials.ExcitedDTSC, Materials2FluidShapes.shapeFluidLiquid, 32_000) },
                wirelessLasers[i],
                recipeDurationTicks,
                recipeEuPerTick);
        }
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Hull_UMV.get(1),
                MaterialLibAPI.getStack(Materials2Materials.Diamond, Materials2Shapes.shapeLens, 64),
                MaterialLibAPI.getStack(Materials2Materials.Diamond, Materials2Shapes.shapeLens, 64),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(20 * INGOTS),
                MaterialLibAPI
                    .getFluidStack(Materials2Materials.ExcitedDTSC, Materials2FluidShapes.shapeFluidLiquid, 8000),
        ...
        if (EternalSingularity.isModLoaded()) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.SixPhasedCopper, 4),
                    MaterialLibAPI.getStack(Materials2Materials.Infinity, Materials2Shapes.shapePlateSuperdense, 2),
                    MaterialsAlloy.QUANTUM.getPlate(16),
                    GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.InfinityCatalyst, 4),
                    MaterialLibAPI.getStack(Materials2Materials.Netherite, Materials2Shapes.shapePlateSuperdense, 2),
                    getModItem(EternalSingularity.ID, "combined_singularity", 1L, 2),
                    MaterialLibAPI
                        .getStack(Materials2Materials.SuperconductorUIVBase, Materials2Shapes.shapeStickLong, 8),
                    MaterialLibAPI.getStack(Materials2Materials.Creon, Materials2Shapes.shapePlate, 16),
                    MaterialLibAPI.getStack(Materials2Materials.Mellion, Materials2Shapes.shapePlate, 16),
                    MaterialLibAPI
                        .getStack(Materials2Materials.SuperconductorUEVBase, Materials2Shapes.shapeStickLong, 8),
                    getModItem(EternalSingularity.ID, "combined_singularity", 1L, 4),
                    MaterialLibAPI
                        .getStack(Materials2Materials.TranscendentMetal, Materials2Shapes.shapePlateSuperdense, 2),
                    MaterialsAlloy.TITANSTEEL.getFrameBox(4),
                    GTOreDictUnificator.get(OrePrefixes.plate, Materials.ProtoHalkonite, 16),
                    MaterialLibAPI
                        .getStack(Materials2Materials.CosmicNeutronium, Materials2Shapes.shapePlateSuperdense, 2),
