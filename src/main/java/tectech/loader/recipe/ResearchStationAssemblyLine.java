    ...
    private void addGodforgeRecipes() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { new ItemStack(BlockQuantumGlass.INSTANCE, 8),
                ...
                ItemList.StableBosonContainmentUnit.get(4), getItemContainer("RadoxPolymerLens").get(6),
                getItemContainer("ChromaticLens").get(6), getItemContainer("MysteriousCrystalLens").get(6),
