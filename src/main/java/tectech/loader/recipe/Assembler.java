...
public class Assembler implements Runnable {
    ...
    public void run() {
        ...
        for (int i = 0; i <= 15; i++) {
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(Materials.Aluminium.getMolten(6 * INGOTS)).duration(1 * SECONDS + 12 * TICKS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(BaseRecipeLoader.getOrDefault("Trinium", Materials.Osmium).getMolten(4 * INGOTS))
                .duration(10 * SECONDS).eut(TierEU.RECIPE_UV).addTo(assemblerRecipes);

        // recipe for assline data hatches
        GTValues.RA.stdBuilder().itemInputs(ItemList.Hatch_DataAccess_EV.get(1), CustomItemList.dataIn_Hatch.get(1))
                .itemOutputs(CustomItemList.dataInAss_Hatch.get(1)).duration(1 * MINUTES + 42 * SECONDS + 8 * TICKS)
                .eut(12000).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder().itemInputs(ItemList.Hatch_DataAccess_EV.get(1), CustomItemList.dataOut_Hatch.get(1))
                .itemOutputs(CustomItemList.dataOutAss_Hatch.get(1)).duration(1 * MINUTES + 42 * SECONDS + 8 * TICKS)
                .eut(12000).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(CustomItemList.eM_Power.get(1)).fluidInputs(Materials.TungstenSteel.getMolten(4 * INGOTS))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Aluminium.getMolten(9 * INGOTS)).duration(10 * SECONDS).eut(TierEU.RECIPE_ZPM)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.SolderingAlloy.getMolten(9 * INGOTS)).duration(5 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
        // Molecular Casing
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .itemOutputs(CustomItemList.eM_Containment.get(1)).fluidInputs(Materials.Osmium.getMolten(9 * INGOTS))
                .duration(40 * SECONDS).eut(TierEU.RECIPE_UV).addTo(assemblerRecipes);
        // Tesla Base
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .itemOutputs(CustomItemList.tM_TeslaBase.get(1)).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        // Tesla Toroid
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .itemOutputs(CustomItemList.tM_TeslaToroid.get(1)).duration(2 * SECONDS + 10 * TICKS).eut(16)
                .addTo(assemblerRecipes);
        // Tesla Secondary Windings
        GTValues.RA.stdBuilder()
                .itemInputs(
                        CustomItemList.teslaComponent.getWithDamage(8, 0),
                        BaseRecipeLoader.getItemContainer("MicaInsulatorFoil").get(12))
                .itemOutputs(CustomItemList.tM_TeslaSecondary.get(1))
                .fluidInputs(Materials.Silver.getMolten(1 * INGOTS)).duration(10 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(assemblerRecipes);
        // Tesla Primary Coils T0
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.wireGt02, Materials.RedstoneAlloy, 8),
                        BaseRecipeLoader.getItemContainer("MicaInsulatorFoil").get(8))
                .itemOutputs(CustomItemList.tM_TeslaPrimary_0.get(1))
                .fluidInputs(Materials.RedAlloy.getMolten(1 * INGOTS)).duration(10 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Magnesium.getMolten(1 * INGOTS)).duration(10 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(assemblerRecipes);
        // Tesla Primary Coils T2
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.wireGt02, Materials.SuperconductorHV, 8),
                        BaseRecipeLoader.getItemContainer("MicaInsulatorFoil").get(16))
                .itemOutputs(CustomItemList.tM_TeslaPrimary_2.get(1))
                .fluidInputs(Materials.Barium.getMolten(1 * INGOTS)).duration(10 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        // Tesla Primary Coils T3
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.wireGt02, Materials.SuperconductorEV, 8),
                        BaseRecipeLoader.getItemContainer("MicaInsulatorFoil").get(20))
                .itemOutputs(CustomItemList.tM_TeslaPrimary_3.get(1))
                .fluidInputs(Materials.Platinum.getMolten(1 * INGOTS)).duration(10 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
        // Tesla Primary Coils T4
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.wireGt02, Materials.SuperconductorIV, 8),
                        BaseRecipeLoader.getItemContainer("MicaInsulatorFoil").get(24))
                .itemOutputs(CustomItemList.tM_TeslaPrimary_4.get(1))
                .fluidInputs(Materials.Vanadium.getMolten(1 * INGOTS)).duration(10 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        // Tesla Primary Coils T5
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.wireGt02, Materials.SuperconductorLuV, 8),
                        BaseRecipeLoader.getItemContainer("MicaInsulatorFoil").get(28))
                .itemOutputs(CustomItemList.tM_TeslaPrimary_5.get(1))
                .fluidInputs(Materials.Indium.getMolten(1 * INGOTS)).duration(10 * SECONDS).eut(TierEU.RECIPE_LuV)
                .addTo(assemblerRecipes);
        // Tesla Primary Coils T6
        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.wireGt02, Materials.SuperconductorZPM, 8),
                        BaseRecipeLoader.getItemContainer("MicaInsulatorFoil").get(32))
                .itemOutputs(CustomItemList.tM_TeslaPrimary_6.get(1))
                .fluidInputs(Materials.Naquadah.getMolten(1 * INGOTS)).duration(10 * SECONDS).eut(TierEU.RECIPE_ZPM)
                .addTo(assemblerRecipes);
        ...
        // Dynamo Hatches
        {
            // Dynamo Hatches 4A
            {
                ...
                GTValues.RA.stdBuilder()
                        ...
                        .fluidInputs(Materials.Silver.getMolten(1 * INGOTS)).duration(5 * SECONDS).eut(TierEU.RECIPE_HV)
                        .addTo(assemblerRecipes);
                // Dynamo IV 4A
                GTValues.RA.stdBuilder()
                        .itemInputs(
                        ...
                        .fluidInputs(Materials.Silver.getMolten(1 * INGOTS)).duration(5 * SECONDS).eut(TierEU.RECIPE_EV)
                        .addTo(assemblerRecipes);
                // Dynamo LuV 4A
                GTValues.RA.stdBuilder()
                        .itemInputs(
                        ...
                        .fluidInputs(Materials.Silver.getMolten(2 * INGOTS)).duration(5 * SECONDS).eut(TierEU.RECIPE_IV)
                        .addTo(assemblerRecipes);
                // Dynamo ZPM 4A
                GTValues.RA.stdBuilder()
                        .itemInputs(
                        ...
                        .fluidInputs(Materials.Silver.getMolten(4 * INGOTS)).duration(5 * SECONDS)
                ...
                GTValues.RA.stdBuilder()
                        ...
                        .fluidInputs(Materials.Silver.getMolten(8 * INGOTS)).duration(5 * SECONDS)
                ...
                GTValues.RA.stdBuilder()
                        ...
                        .fluidInputs(Materials.Silver.getMolten(16 * INGOTS)).duration(5 * SECONDS)
                ...
                GTValues.RA.stdBuilder()
                        ...
                        .fluidInputs(Materials.Silver.getMolten(32 * INGOTS)).duration(5 * SECONDS)
                ...
                GTValues.RA.stdBuilder()
                        ...
                        .fluidInputs(Materials.Silver.getMolten(1 * STACKS)).duration(5 * SECONDS)
                ...
                GTValues.RA.stdBuilder()
                        ...
                        .fluidInputs(Materials.Silver.getMolten(1 * STACKS)).duration(5 * SECONDS)
                        .eut((int) TierEU.RECIPE_UMV).addTo(assemblerRecipes);
            ...
            // Dynamo Hatches 16A
            {
                ...
                GTValues.RA.stdBuilder()
                        ...
                        .fluidInputs(Materials.Electrum.getMolten(1 * INGOTS)).duration(10 * SECONDS)
                ...
                GTValues.RA.stdBuilder()
                        ...
                        .fluidInputs(Materials.Electrum.getMolten(2 * INGOTS)).duration(10 * SECONDS)
                ...
                GTValues.RA.stdBuilder()
                        ...
                        .fluidInputs(Materials.Electrum.getMolten(4 * INGOTS)).duration(10 * SECONDS)
                        .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
                // Dynamo UV 16A
                GTValues.RA.stdBuilder()
                        .itemInputs(
                        ...
                        .fluidInputs(Materials.Electrum.getMolten(8 * INGOTS)).duration(10 * SECONDS)
                        .eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);
                // Dynamo UHV 16A
                GTValues.RA.stdBuilder()
                        .itemInputs(
                        ...
                        .fluidInputs(Materials.Electrum.getMolten(16 * INGOTS)).duration(10 * SECONDS)
                        .eut(TierEU.RECIPE_UV).addTo(assemblerRecipes);
                // Dynamo UEV 16A
                GTValues.RA.stdBuilder()
                        .itemInputs(
                        ...
                        .fluidInputs(Materials.Electrum.getMolten(32 * INGOTS)).duration(10 * SECONDS)
                        .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
                // Dynamo UIV 16A
                GTValues.RA.stdBuilder()
                        .itemInputs(
                        ...
                        .fluidInputs(Materials.Electrum.getMolten(1 * STACKS)).duration(10 * SECONDS)
                        .eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
                // Dynamo UMV 16A
                GTValues.RA.stdBuilder()
                        .itemInputs(
            ...
            // Dynamo Hatches 64A
            {
                ...
                GTValues.RA.stdBuilder()
                        ...
                        .fluidInputs(Materials.Tungsten.getMolten(1 * INGOTS)).duration(20 * SECONDS)
                        .eut(TierEU.RECIPE_HV).addTo(assemblerRecipes);
                // Dynamo IV 64A
                GTValues.RA.stdBuilder()
                        .itemInputs(
                ...
                GTValues.RA.stdBuilder()
                        ...
                        .fluidInputs(Materials.Tungsten.getMolten(2 * INGOTS)).duration(20 * SECONDS)
                        .eut(TierEU.RECIPE_IV).addTo(assemblerRecipes);
                // Dynamo ZPM 64A
                GTValues.RA.stdBuilder()
                        .itemInputs(
                        ...
                        .fluidInputs(Materials.Tungsten.getMolten(4 * INGOTS)).duration(20 * SECONDS)
                        .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
                // Dynamo UV 64A
                GTValues.RA.stdBuilder()
                        .itemInputs(
                        ...
                        .fluidInputs(Materials.Tungsten.getMolten(8 * INGOTS)).duration(20 * SECONDS)
                        .eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);
                // Dynamo UHV 64A
                GTValues.RA.stdBuilder()
                        .itemInputs(
                        ...
                        .fluidInputs(Materials.Tungsten.getMolten(16 * INGOTS)).duration(20 * SECONDS)
                        .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
                // Dynamo UEV 64A
                GTValues.RA.stdBuilder()
                        .itemInputs(
                        ...
                        .fluidInputs(Materials.Tungsten.getMolten(32 * INGOTS)).duration(20 * SECONDS)
                        .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
                // Dynamo UIV 64A
                GTValues.RA.stdBuilder()
                        .itemInputs(
                        ...
                        .fluidInputs(Materials.Tungsten.getMolten(1 * STACKS)).duration(20 * SECONDS)
                        .eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
                // Dynamo UMV 64A
                GTValues.RA.stdBuilder()
                        .itemInputs(
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ItemList.Transformer_LuV_IV.get(1),
                        BaseRecipeLoader.getItemContainer("Display").get(1),
                ...
                .fluidInputs(Materials.TungstenSteel.getMolten(2 * INGOTS)).duration(5 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        // Buck Converter LuV
        GTValues.RA.stdBuilder()
                .itemInputs(
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Iridium.getMolten(2 * INGOTS)).duration(5 * SECONDS).eut(TierEU.RECIPE_ZPM)
                .addTo(assemblerRecipes);
        // Buck Converter UV
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(Materials.Osmium.getMolten(2 * INGOTS)).duration(5 * SECONDS).eut(TierEU.RECIPE_UV)
                .addTo(assemblerRecipes);
        // Buck Converter UHV
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(Materials.Neutronium.getMolten(2 * INGOTS)).duration(5 * SECONDS).eut(TierEU.RECIPE_UHV)
                .addTo(assemblerRecipes);
        // Buck Converter UEV
        GTValues.RA.stdBuilder().itemInputs(
                ...
                new ItemStack(bw_realglas, 8, 5)).itemOutputs(CustomItemList.Machine_BuckConverter_UEV.get(1))
                .fluidInputs(BaseRecipeLoader.getOrDefault("Bedrockium", Materials.Neutronium).getMolten(2 * INGOTS))
                .duration(5 * SECONDS).eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
        // Buck Converter UIV
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ItemList.Transformer_UMV_UIV.get(1),
                ...
                .fluidInputs(
                        BaseRecipeLoader.getOrDefault("BlackPlutonium", Materials.Neutronium).getMolten(2 * INGOTS))
                .duration(10 * SECONDS).eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
        ...
        // Laser Dynamo
        {
            // Laser Dynamo IV-UXV 256/t
            {
                GTValues.RA.stdBuilder()
                        ...
                        .itemOutputs(CustomItemList.eM_dynamoTunnel1_IV.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_IV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel1_LuV.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel1_ZPM.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel1_UV.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_UV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel1_UHV.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel1_UEV.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel1_UIV.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_UIV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel1_UMV.get(1)).duration(30 * SECONDS)
                ...
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel1_UXV.get(1)).duration(30 * SECONDS)
            ...
            // Laser Dynamo LuV-UXV 1024/t
            {
                GTValues.RA.stdBuilder()
                        ...
                        .itemOutputs(CustomItemList.eM_dynamoTunnel2_LuV.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_ZPM.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(2))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel2_ZPM.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(2))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel2_UV.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_UV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_MAX.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(2))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel2_UHV.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UEV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(2))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel2_UEV.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UIV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(2))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel2_UIV.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_UIV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UMV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(2))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel2_UMV.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_UMV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UXV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(2))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel2_UXV.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_UXV).addTo(assemblerRecipes);
            ...
            // Laser Dynamo ZPM-UXV 4096/t
            {
                GTValues.RA.stdBuilder()
                        ...
                        .itemOutputs(CustomItemList.eM_dynamoTunnel3_ZPM.get(1)).duration(50 * SECONDS)
                        .eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(3))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel3_UV.get(1)).duration(50 * SECONDS)
                        .eut(TierEU.RECIPE_UV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_MAX.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(3))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel3_UHV.get(1)).duration(50 * SECONDS)
                        .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UEV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(3))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel3_UEV.get(1)).duration(50 * SECONDS)
                        .eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UIV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(3))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel3_UIV.get(1)).duration(50 * SECONDS)
                        .eut(TierEU.RECIPE_UIV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UMV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(3))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel3_UMV.get(1)).duration(50 * SECONDS)
                        .eut(TierEU.RECIPE_UMV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UXV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(3))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel3_UXV.get(1)).duration(50 * SECONDS)
                        .eut(TierEU.RECIPE_UXV).addTo(assemblerRecipes);
            ...
            // Laser Dynamo UV-UXV 16384/t
            {
                GTValues.RA.stdBuilder()
                        ...
                        .itemOutputs(CustomItemList.eM_dynamoTunnel4_UV.get(1)).duration(60 * SECONDS)
                        .eut(TierEU.RECIPE_UV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_MAX.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(4))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel4_UHV.get(1)).duration(60 * SECONDS)
                        .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UEV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(4))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel4_UEV.get(1)).duration(60 * SECONDS)
                        .eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UIV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(4))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel4_UIV.get(1)).duration(60 * SECONDS)
                        .eut(TierEU.RECIPE_UIV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UMV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(4))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel4_UMV.get(1)).duration(60 * SECONDS)
                        .eut(TierEU.RECIPE_UMV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UXV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(4))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel4_UXV.get(1)).duration(60 * SECONDS)
                        .eut(TierEU.RECIPE_UXV).addTo(assemblerRecipes);
            ...
            // Laser Dynamo UHV-UXV 65536/t
            {
                GTValues.RA.stdBuilder()
                        ...
                        .itemOutputs(CustomItemList.eM_dynamoTunnel5_UHV.get(1)).duration(70 * SECONDS)
                        .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UEV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(5))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel5_UEV.get(1)).duration(70 * SECONDS)
                        .eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UIV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(5))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel5_UIV.get(1)).duration(70 * SECONDS)
                        .eut(TierEU.RECIPE_UIV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UMV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(5))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel5_UMV.get(1)).duration(70 * SECONDS)
                        .eut(TierEU.RECIPE_UMV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UXV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(5))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel5_UXV.get(1)).duration(70 * SECONDS)
                        .eut(TierEU.RECIPE_UXV).addTo(assemblerRecipes);
            ...
            // Laser Dynamo UEV-UXV 262144/t
            {
                GTValues.RA.stdBuilder()
                        ...
                        .itemOutputs(CustomItemList.eM_dynamoTunnel6_UEV.get(1)).duration(80 * SECONDS)
                        .eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UIV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(6))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel6_UIV.get(1)).duration(80 * SECONDS)
                        .eut(TierEU.RECIPE_UIV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UMV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(6))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel6_UMV.get(1)).duration(80 * SECONDS)
                        .eut(TierEU.RECIPE_UMV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UXV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(6))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel6_UXV.get(1)).duration(80 * SECONDS)
                        .eut(TierEU.RECIPE_UXV).addTo(assemblerRecipes);
            ...
            // Laser Dynamo UIV-UXV 1048576/t
            {
                GTValues.RA.stdBuilder()
                        ...
                        .itemOutputs(CustomItemList.eM_dynamoTunnel7_UIV.get(1)).duration(90 * SECONDS)
                        .eut(TierEU.RECIPE_UIV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UMV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(7))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel7_UMV.get(1)).duration(90 * SECONDS)
                        .eut(TierEU.RECIPE_UMV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UXV.get(1),
                                ...
                                GTUtility.getIntegratedCircuit(7))
                        .itemOutputs(CustomItemList.eM_dynamoTunnel7_UXV.get(1)).duration(90 * SECONDS)
                        .eut(TierEU.RECIPE_UXV).addTo(assemblerRecipes);
            ...
            // Laser Target IV-UXV 256/t
            {
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt01, Materials.TungstenSteel, 2),
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_energyTunnel1_IV.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_IV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_LuV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt01, Materials.VanadiumGallium, 2),
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_energyTunnel1_LuV.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_ZPM.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt01, Materials.Naquadah, 2),
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_energyTunnel1_ZPM.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt01, Materials.NaquadahAlloy, 2),
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_energyTunnel1_UV.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_UV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_MAX.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt01, Materials.Bedrockium, 2),
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_energyTunnel1_UHV.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UEV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt01, Materials.Draconium, 2),
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_energyTunnel1_UEV.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UIV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt01, Materials.NetherStar, 2),
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_energyTunnel1_UIV.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_UIV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UMV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt01, Materials.Quantium, 2),
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_energyTunnel1_UMV.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_UMV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UXV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt01, Materials.BlackPlutonium, 2),
                                GTUtility.getIntegratedCircuit(1))
                        .itemOutputs(CustomItemList.eM_energyTunnel1_UXV.get(1)).duration(30 * SECONDS)
                        .eut(TierEU.RECIPE_UXV).addTo(assemblerRecipes);
            ...
            // Laser Target LuV-UXV 1024/t
            {
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt02, Materials.VanadiumGallium, 4),
                                GTUtility.getIntegratedCircuit(2))
                        .itemOutputs(CustomItemList.eM_energyTunnel2_LuV.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_ZPM.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt02, Materials.Naquadah, 4),
                                GTUtility.getIntegratedCircuit(2))
                        .itemOutputs(CustomItemList.eM_energyTunnel2_ZPM.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt02, Materials.NaquadahAlloy, 4),
                                GTUtility.getIntegratedCircuit(2))
                        .itemOutputs(CustomItemList.eM_energyTunnel2_UV.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_UV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_MAX.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt02, Materials.Bedrockium, 4),
                                GTUtility.getIntegratedCircuit(2))
                        .itemOutputs(CustomItemList.eM_energyTunnel2_UHV.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UEV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt02, Materials.Draconium, 4),
                                GTUtility.getIntegratedCircuit(2))
                        .itemOutputs(CustomItemList.eM_energyTunnel2_UEV.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UIV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt02, Materials.NetherStar, 4),
                                GTUtility.getIntegratedCircuit(2))
                        .itemOutputs(CustomItemList.eM_energyTunnel2_UIV.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_UIV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UMV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt02, Materials.Quantium, 4),
                                GTUtility.getIntegratedCircuit(2))
                        .itemOutputs(CustomItemList.eM_energyTunnel2_UMV.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_UMV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UXV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt02, Materials.BlackPlutonium, 4),
                                GTUtility.getIntegratedCircuit(2))
                        .itemOutputs(CustomItemList.eM_energyTunnel2_UXV.get(1)).duration(40 * SECONDS)
                        .eut(TierEU.RECIPE_UXV).addTo(assemblerRecipes);
            ...
            // Laser Target ZPM-UXV 4096/t
            {
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt04, Materials.Naquadah, 4),
                                GTUtility.getIntegratedCircuit(3))
                        .itemOutputs(CustomItemList.eM_energyTunnel3_ZPM.get(1)).duration(50 * SECONDS)
                        .eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt04, Materials.NaquadahAlloy, 4),
                                GTUtility.getIntegratedCircuit(3))
                        .itemOutputs(CustomItemList.eM_energyTunnel3_UV.get(1)).duration(50 * SECONDS)
                        .eut(TierEU.RECIPE_UV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_MAX.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt04, Materials.Bedrockium, 4),
                                GTUtility.getIntegratedCircuit(3))
                        .itemOutputs(CustomItemList.eM_energyTunnel3_UHV.get(1)).duration(50 * SECONDS)
                        .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UEV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt04, Materials.Draconium, 4),
                                GTUtility.getIntegratedCircuit(3))
                        .itemOutputs(CustomItemList.eM_energyTunnel3_UEV.get(1)).duration(50 * SECONDS)
                        .eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UIV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt04, Materials.NetherStar, 4),
                                GTUtility.getIntegratedCircuit(3))
                        .itemOutputs(CustomItemList.eM_energyTunnel3_UIV.get(1)).duration(50 * SECONDS)
                        .eut(TierEU.RECIPE_UIV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UMV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt04, Materials.Quantium, 4),
                                GTUtility.getIntegratedCircuit(3))
                        .itemOutputs(CustomItemList.eM_energyTunnel3_UMV.get(1)).duration(50 * SECONDS)
                        .eut(TierEU.RECIPE_UMV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UXV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt04, Materials.BlackPlutonium, 4),
                                GTUtility.getIntegratedCircuit(3))
                        .itemOutputs(CustomItemList.eM_energyTunnel3_UXV.get(1)).duration(50 * SECONDS)
                        .eut(TierEU.RECIPE_UXV).addTo(assemblerRecipes);
            ...
            // Laser Target UV-UXV 16384/t
            {
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt04, Materials.NaquadahAlloy, 8),
                                GTUtility.getIntegratedCircuit(4))
                        .itemOutputs(CustomItemList.eM_energyTunnel4_UV.get(1)).duration(60 * SECONDS)
                        .eut(TierEU.RECIPE_UV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_MAX.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt04, Materials.Bedrockium, 8),
                                GTUtility.getIntegratedCircuit(4))
                        .itemOutputs(CustomItemList.eM_energyTunnel4_UHV.get(1)).duration(60 * SECONDS)
                        .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UEV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt04, Materials.Draconium, 8),
                                GTUtility.getIntegratedCircuit(4))
                        .itemOutputs(CustomItemList.eM_energyTunnel4_UEV.get(1)).duration(60 * SECONDS)
                        .eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UIV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt04, Materials.NetherStar, 8),
                                GTUtility.getIntegratedCircuit(4))
                        .itemOutputs(CustomItemList.eM_energyTunnel4_UIV.get(1)).duration(60 * SECONDS)
                        .eut(TierEU.RECIPE_UIV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UMV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt04, Materials.Quantium, 8),
                                GTUtility.getIntegratedCircuit(4))
                        .itemOutputs(CustomItemList.eM_energyTunnel4_UMV.get(1)).duration(60 * SECONDS)
                        .eut(TierEU.RECIPE_UMV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UXV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt04, Materials.BlackPlutonium, 8),
                                GTUtility.getIntegratedCircuit(4))
                        .itemOutputs(CustomItemList.eM_energyTunnel4_UXV.get(1)).duration(60 * SECONDS)
                        .eut(TierEU.RECIPE_UXV).addTo(assemblerRecipes);
            ...
            // Laser Target UHV-UXV 65536/t
            {
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt08, Materials.Bedrockium, 8),
                                GTUtility.getIntegratedCircuit(5))
                        .itemOutputs(CustomItemList.eM_energyTunnel5_UHV.get(1)).duration(70 * SECONDS)
                        .eut(TierEU.RECIPE_UHV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UEV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt08, Materials.Draconium, 8),
                                GTUtility.getIntegratedCircuit(5))
                        .itemOutputs(CustomItemList.eM_energyTunnel5_UEV.get(1)).duration(70 * SECONDS)
                        .eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UIV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt08, Materials.NetherStar, 8),
                                GTUtility.getIntegratedCircuit(5))
                        .itemOutputs(CustomItemList.eM_energyTunnel5_UIV.get(1)).duration(70 * SECONDS)
                        .eut(TierEU.RECIPE_UIV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UMV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt08, Materials.Quantium, 8),
                                GTUtility.getIntegratedCircuit(5))
                        .itemOutputs(CustomItemList.eM_energyTunnel5_UMV.get(1)).duration(70 * SECONDS)
                        .eut(TierEU.RECIPE_UMV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UXV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt08, Materials.BlackPlutonium, 8),
                                GTUtility.getIntegratedCircuit(5))
                        .itemOutputs(CustomItemList.eM_energyTunnel5_UXV.get(1)).duration(70 * SECONDS)
                        .eut(TierEU.RECIPE_UXV).addTo(assemblerRecipes);
            ...
            // Laser Target UEV-UXV 262144/t
            {
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt08, Materials.Draconium, 16),
                                GTUtility.getIntegratedCircuit(6))
                        .itemOutputs(CustomItemList.eM_energyTunnel6_UEV.get(1)).duration(80 * SECONDS)
                        .eut(TierEU.RECIPE_UEV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UIV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt08, Materials.NetherStar, 16),
                                GTUtility.getIntegratedCircuit(6))
                        .itemOutputs(CustomItemList.eM_energyTunnel6_UIV.get(1)).duration(80 * SECONDS)
                        .eut(TierEU.RECIPE_UIV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UMV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt08, Materials.Quantium, 16),
                                GTUtility.getIntegratedCircuit(6))
                        .itemOutputs(CustomItemList.eM_energyTunnel6_UMV.get(1)).duration(80 * SECONDS)
                        .eut(TierEU.RECIPE_UMV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UXV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt08, Materials.BlackPlutonium, 16),
                                GTUtility.getIntegratedCircuit(6))
                        .itemOutputs(CustomItemList.eM_energyTunnel6_UXV.get(1)).duration(80 * SECONDS)
                        .eut(TierEU.RECIPE_UXV).addTo(assemblerRecipes);
            ...
            // Laser Target UIV-UXV 1048576/t
            {
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt16, Materials.NetherStar, 16),
                                GTUtility.getIntegratedCircuit(7))
                        .itemOutputs(CustomItemList.eM_energyTunnel7_UIV.get(1)).duration(90 * SECONDS)
                        .eut(TierEU.RECIPE_UIV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UMV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt16, Materials.Quantium, 16),
                                GTUtility.getIntegratedCircuit(7))
                        .itemOutputs(CustomItemList.eM_energyTunnel7_UMV.get(1)).duration(90 * SECONDS)
                        .eut(TierEU.RECIPE_UMV).addTo(assemblerRecipes);
                GTValues.RA.stdBuilder()
                        .itemInputs(
                                ItemList.Hull_UXV.get(1),
                                ...
                                GTOreDictUnificator.get(OrePrefixes.wireGt16, Materials.BlackPlutonium, 16),
                                GTUtility.getIntegratedCircuit(7))
                        .itemOutputs(CustomItemList.eM_energyTunnel7_UXV.get(1)).duration(90 * SECONDS)
                        .eut(TierEU.RECIPE_UXV).addTo(assemblerRecipes);
        ...
        // Tesla Capacitor
        {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(Materials.Epoxid.getMolten(1 * HALF_INGOTS)).duration(16 * SECONDS)
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(Materials.Epoxid.getMolten(1 * INGOTS)).duration(16 * SECONDS).eut(TierEU.RECIPE_MV)
                    .addTo(assemblerRecipes);
            // HV Tesla Capacitor
            GTValues.RA.stdBuilder()
                    .itemInputs(
                    ...
                    .fluidInputs(Materials.Epoxid.getMolten(216)).duration(16 * SECONDS).eut(TierEU.RECIPE_HV)
                    .addTo(assemblerRecipes);
            // EV Tesla Capacitor
            GTValues.RA.stdBuilder()
                    .itemInputs(
                    ...
                    .fluidInputs(Materials.Epoxid.getMolten(2 * INGOTS)).duration(16 * SECONDS).eut(TierEU.RECIPE_EV)
                    .addTo(assemblerRecipes);
            // IV Tesla Capacitor
            GTValues.RA.stdBuilder()
                    .itemInputs(
                    ...
                    .fluidInputs(Materials.Epoxid.getMolten(2 * INGOTS + 1 * HALF_INGOTS)).duration(16 * SECONDS)
                    .eut(TierEU.RECIPE_IV).addTo(assemblerRecipes);
            // LuV Tesla Capacitor
            GTValues.RA.stdBuilder()
                    .itemInputs(
                    ...
                    .fluidInputs(Materials.Epoxid.getMolten(3 * INGOTS)).duration(16 * SECONDS).eut(TierEU.RECIPE_LuV)
                    .addTo(assemblerRecipes);
            // ZPM Tesla Capacitor
            GTValues.RA.stdBuilder()
                    .itemInputs(
                    ...
                    .fluidInputs(Materials.Epoxid.getMolten(504)).duration(16 * SECONDS).eut(TierEU.RECIPE_ZPM)
                    .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Lead.getMolten(2 * INGOTS)).duration(16 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        CustomItemList.teslaComponent.getWithDamage(4, 0),
                        ...
                        GTOreDictUnificator.get(OrePrefixes.foil, Materials.Aluminium, 8))
                .itemOutputs(CustomItemList.teslaCover.getWithDamage(1, 0))
                .fluidInputs(Materials.Tin.getMolten(1 * INGOTS)).duration(16 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        CustomItemList.teslaComponent.getWithDamage(4, 0),
                        ...
                        GTOreDictUnificator.get(OrePrefixes.foil, Materials.Aluminium, 8))
                .itemOutputs(CustomItemList.teslaCover.getWithDamage(1, 0))
                .fluidInputs(Materials.SolderingAlloy.getMolten(1 * HALF_INGOTS)).duration(16 * SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Lead.getMolten(2 * INGOTS)).duration(16 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        CustomItemList.teslaComponent.getWithDamage(4, 1),
                        ...
                        GTOreDictUnificator.get(OrePrefixes.foil, Materials.Aluminium, 8))
                .itemOutputs(CustomItemList.teslaCover.getWithDamage(1, 1))
                .fluidInputs(Materials.Tin.getMolten(1 * INGOTS)).duration(16 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        CustomItemList.teslaComponent.getWithDamage(4, 1),
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                        BaseRecipeLoader.getOrDefault("Rhodium-PlatedPalladium", Materials.Chrome)
                                .getMolten(2 * INGOTS))
                .duration(16 * SECONDS).eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
        // Power Pass Upgrade Cover
        GTValues.RA.stdBuilder()
                .itemInputs(CustomItemList.Machine_Multi_Transformer.get(1), GTUtility.getIntegratedCircuit(1))
                .itemOutputs(CustomItemList.powerPassUpgradeCover.getWithDamage(1, 0)).duration(16 * SECONDS)
                .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Epoxid.getMolten(2 * INGOTS)).duration(16 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Epoxid.getMolten(4 * INGOTS)).duration(16 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Lead.getMolten(4 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Battery_Buffer_1by1_LV.get(1), CustomItemList.teslaCover.getWithDamage(1, 0))
                .itemOutputs(CustomItemList.Machine_TeslaCoil_1by1_LV.get(1))
                .fluidInputs(Materials.Tin.getMolten(2 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Battery_Buffer_1by1_LV.get(1), CustomItemList.teslaCover.getWithDamage(1, 0))
                .itemOutputs(CustomItemList.Machine_TeslaCoil_1by1_LV.get(1))
                .fluidInputs(Materials.SolderingAlloy.getMolten(1 * INGOTS)).duration(20 * SECONDS)
                .eut(TierEU.RECIPE_LV).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Lead.getMolten(4 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Battery_Buffer_1by1_MV.get(1), CustomItemList.teslaCover.getWithDamage(1, 0))
                .itemOutputs(CustomItemList.Machine_TeslaCoil_1by1_MV.get(1))
                .fluidInputs(Materials.Tin.getMolten(2 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_MV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Battery_Buffer_1by1_MV.get(1), CustomItemList.teslaCover.getWithDamage(1, 0))
                .itemOutputs(CustomItemList.Machine_TeslaCoil_1by1_MV.get(1))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Lead.getMolten(4 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Battery_Buffer_1by1_HV.get(1), CustomItemList.teslaCover.getWithDamage(1, 0))
                .itemOutputs(CustomItemList.Machine_TeslaCoil_1by1_HV.get(1))
                .fluidInputs(Materials.Tin.getMolten(2 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Battery_Buffer_1by1_HV.get(1), CustomItemList.teslaCover.getWithDamage(1, 0))
                .itemOutputs(CustomItemList.Machine_TeslaCoil_1by1_HV.get(1))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Lead.getMolten(4 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Battery_Buffer_1by1_EV.get(1), CustomItemList.teslaCover.getWithDamage(1, 0))
                .itemOutputs(CustomItemList.Machine_TeslaCoil_1by1_EV.get(1))
                .fluidInputs(Materials.Tin.getMolten(2 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Battery_Buffer_1by1_EV.get(1), CustomItemList.teslaCover.getWithDamage(1, 0))
                .itemOutputs(CustomItemList.Machine_TeslaCoil_1by1_EV.get(1))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Lead.getMolten(4 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Battery_Buffer_1by1_IV.get(1), CustomItemList.teslaCover.getWithDamage(1, 0))
                .itemOutputs(CustomItemList.Machine_TeslaCoil_1by1_IV.get(1))
                .fluidInputs(Materials.Tin.getMolten(2 * INGOTS)).duration(20 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Battery_Buffer_1by1_IV.get(1), CustomItemList.teslaCover.getWithDamage(1, 0))
                .itemOutputs(CustomItemList.Machine_TeslaCoil_1by1_IV.get(1))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Silver.getMolten(4 * INGOTS)).duration(40 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        // Microwave Grinder
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(Materials.Copper.getMolten(4 * INGOTS)).duration(40 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(assemblerRecipes);
        // Active Transformer
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ItemList.WetTransformer_ZPM_LuV.get(1),
                        BaseRecipeLoader.getItemContainer("HighEnergyFlowCircuit").get(1),
                        GTOreDictUnificator.get(
                                OrePrefixes.wireGt01,
                ...
                .fluidInputs(Materials.TungstenSteel.getMolten(4 * INGOTS)).duration(20 * SECONDS)
                .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
    }
    ...
    public void cleanroomRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(Materials.Polytetrafluoroethylene.getMolten(1 * INGOTS)).requiresCleanRoom()
                .duration(10 * SECONDS).eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
        // Data Casing
        GTValues.RA.stdBuilder().itemInputs(CustomItemList.DATApipe.get(1), ItemList.Casing_LuV.get(1))
                .itemOutputs(CustomItemList.DATApipeBlock.get(1)).requiresCleanRoom().duration(20 * TICKS)
                .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
        // Laser
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .itemOutputs(CustomItemList.LASERpipe.get(1)).requiresCleanRoom().duration(5 * SECONDS)
                .eut(TierEU.RECIPE_UV).addTo(assemblerRecipes);
        // Laser Casing
        GTValues.RA.stdBuilder().itemInputs(CustomItemList.LASERpipe.get(1), ItemList.Casing_LuV.get(1))
                .itemOutputs(CustomItemList.LASERpipeBlock.get(1)).requiresCleanRoom().duration(20 * TICKS)
                .eut(TierEU.RECIPE_LuV).addTo(assemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTOreDictUnificator.get(
                                ...
                                BaseRecipeLoader.getOrDefault("SuperconductorLuV", Materials.SuperconductorUHV),
                                4))
                .itemOutputs(CustomItemList.eM_Computer_Bus.get(1)).fluidInputs(Materials.Iridium.getMolten(9 * INGOTS))
                .requiresCleanRoom().duration(10 * SECONDS).eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);
        // Data Input
        GTValues.RA.stdBuilder()
                .itemInputs(
                        CustomItemList.eM_Computer_Casing.get(1),
                ...
                .itemOutputs(CustomItemList.dataIn_Hatch.get(1)).fluidInputs(Materials.Iridium.getMolten(9 * INGOTS))
                .requiresCleanRoom().duration(10 * SECONDS).eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);
        // Data Output
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        GTOreDictUnificator.get(OrePrefixes.circuit, Materials.LuV, 1),
                        CustomItemList.DATApipe.get(2))
                .itemOutputs(CustomItemList.dataOut_Hatch.get(1)).fluidInputs(Materials.Iridium.getMolten(9 * INGOTS))
                .requiresCleanRoom().duration(10 * SECONDS).eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);
        // Rack
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .itemOutputs(CustomItemList.rack_Hatch.get(1)).fluidInputs(Materials.Iridium.getMolten(9 * INGOTS))
                .requiresCleanRoom().duration(40 * SECONDS).eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);
        // Uncertainty X
        GTValues.RA.stdBuilder()
                .itemInputs(
                        CustomItemList.eM_Computer_Casing.get(1),
                        ...
                        GTUtility.getIntegratedCircuit(4))
                .itemOutputs(CustomItemList.UncertaintyX_Hatch.get(1)).fluidInputs(Materials.Iridium.getMolten(2592))
                .requiresCleanRoom().duration(60 * SECONDS).eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);
        // Capacitor Hatch
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .itemOutputs(CustomItemList.capacitor_Hatch.get(1)).fluidInputs(Materials.Silver.getMolten(4 * INGOTS))
                .requiresCleanRoom().duration(40 * SECONDS).eut(TierEU.RECIPE_HV).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
