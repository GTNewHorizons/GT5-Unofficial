...
public class CoverLoader implements Runnable {
    ...
    @Override
    public void run() {
        final IIconContainer TESLA_OVERLAY = Textures.BlockIcons.custom(Mods.GregTech.resourceDomain,"iconsets/TESLA_OVERLAY");
        final IIconContainer TESLA_OVERLAY_ULTIMATE = Textures.BlockIcons.custom(Mods.GregTech.resourceDomain,"iconsets/TESLA_OVERLAY_ULTIMATE");
        final IIconContainer ENDERFLUIDLINK_OVERLAY = Textures.BlockIcons.custom(Mods.GregTech.resourceDomain,"iconsets/ENDERFLUIDLINK_OVERLAY");
        final IIconContainer POWERPASSUPGRADE_OVERLAY = Textures.BlockIcons.custom(Mods.GregTech.resourceDomain,"iconsets/POWERPASSUPGRADE_OVERLAY");
