...
public class MachineLoader implements Runnable {
    ...
    public void run() {
        ...
        Machine_Multi_Microwave.set(
                new MTEMicrowave(MicrowaveGrinder.ID, "multimachine.tm.microwave", "Microwave Grinder")
                        .getStackForm(1L));
        ...
        Machine_Multi_Switch.set(
                new MTENetworkSwitch(
                        NetworkSwitchWithQoS.ID,
                        "multimachine.em.switch",
                        "Weighted Network Switch With QoS").getStackForm(1L));
        Machine_Multi_Switch_Adv.set(
                new MTENetworkSwitchAdv(
                        NetworkSwitchAdv.ID,
                        "multimachine.em.switch.adv",
                        "Static Network Switch With QoS").getStackForm(1L));
        ...
        Machine_Multi_Infuser.set(
                new MTEEnergyInfuser(EnergyInfuser.ID, "multimachine.em.infuser", "Energy Infuser").getStackForm(1));
        Machine_Multi_EyeOfHarmony.set(
                new MTEEyeOfHarmony(EyeofHarmony.ID, "multimachine.em.eye_of_harmony", "Eye of Harmony")
                        .getStackForm(1L));
        ...
        capacitor_Hatch.set(
                new MTEHatchCapacitor(CapacitorHatch.ID, "hatch.capacitor.tier.03", "Capacitor Hatch", 3)
                        .getStackForm(1L));
        ...
        LASERpipeSmart.set(
                new MTEPipeLaserMirror(LaserVacuumMirror.ID, "pipe.energymirror", "Laser Vacuum Mirror")
                        .getStackForm(1L));
        ...
        if ((boolean) Launch.blackboard.get("fml.deobfuscatedEnvironment")) {
            ...
            TestHatch.set(
                    new TestFactoryHatch(TestFactoryHatch.ID, "hatch.test", "Test Factory Hatch", 7).getStackForm(1));
        }
        ...
        Machine_OwnerDetector.set(
                new MTEOwnerDetector(Ownerdetector.ID, "machine.tt.ownerdetector", "Owner detector", 3)
                        .getStackForm(1L));
        ...
        hatch_CreativeData.set(
                new MTEHatchCreativeData(DebugDataHatch.ID, "debug.tt.data", "Debug Data Hatch", 14).getStackForm(1));
        ...
        hatch_CreativeUncertainty.set(
                new MTEHatchCreativeUncertainty(
