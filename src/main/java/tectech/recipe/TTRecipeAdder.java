...
public class TTRecipeAdder extends RecipeAdder {
    ...
    public static boolean addResearchableAssemblylineRecipe(ItemStack aResearchItem, int totalComputationRequired,
        ...
        RecipeAssemblyLine recipeGT = new RecipeAssemblyLine(
            ...
            assDuration,
            assEUt);
        RecipeAssemblyLine recipeTT = new RecipeAssemblyLine(
            aResearchItem,
            totalComputationRequired / computationRequiredPerSec,
            0,
            aInputs,
            ...
            assDuration,
            assEUt);
        RecipeAssemblyLine.sAssemblylineRecipes.add(recipeGT);
