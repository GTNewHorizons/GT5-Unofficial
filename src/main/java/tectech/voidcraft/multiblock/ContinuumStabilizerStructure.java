...
/**
 * The Continuum Stabilizer's structure definition as plain shape data (kept free of MTE references so the
 ...
 *
 * <p>
 * 5 wide × 7 tall × 5 deep: 175 cells = 1 controller + 174 casings. A WORLD-ONLY structure (built in-world
 * around a star; the assemblers reject a blueprint containing it). It is the smallest of the star-infrastructure
 * structures — one that binds to a single ripple point.
 */
public final class ContinuumStabilizerStructure {

    public static final String[][] RAW_SHAPE = { { "AAAAA", "AAAAA", "AA~AA", "AAAAA", "AAAAA" },
        { "AAAAA", "AAAAA", "AAAAA", "AAAAA", "AAAAA" }, { "AAAAA", "AAAAA", "AAAAA", "AAAAA", "AAAAA" },
        { "AAAAA", "AAAAA", "AAAAA", "AAAAA", "AAAAA" }, { "AAAAA", "AAAAA", "AAAAA", "AAAAA", "AAAAA" },
        { "AAAAA", "AAAAA", "AAAAA", "AAAAA", "AAAAA" }, { "AAAAA", "AAAAA", "AAAAA", "AAAAA", "AAAAA" } };

    /** Total structure cell count (every shape character, anchor included): 1 controller + 174 casings. */
    public static final int EXPECTED_CELLS = countCells(RAW_SHAPE);

    /** The anchor ({@code ~}) cell's offset from the machine position: bottom-center (x 2, y 0, z 2). */
    public static final int[] ANCHOR = findAnchor(RAW_SHAPE);

    private ContinuumStabilizerStructure() {}
