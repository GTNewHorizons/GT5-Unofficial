...
/**
 * The Stellar Lens's structure definition as plain shape data (kept free of MTE references so the cell-count and
 * anchor invariants are testable in a bare JVM).
 *
 * <p>
 ...
 *
 * <p>
 * 7 wide × 12 tall × 7 deep: 588 cells = 1 controller + 587 casings. A WORLD-ONLY structure (built in-world
 * around a star; the assemblers reject a blueprint containing it); a passive visual around the star.
 */
public final class StellarLensStructure {
    ...
    /** Total structure cell count (every shape character, anchor included): 1 controller + 587 casings. */
