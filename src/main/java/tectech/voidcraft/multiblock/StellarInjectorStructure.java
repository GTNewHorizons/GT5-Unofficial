...
/**
 * The Stellar Injector's structure definition as plain shape data (kept free of MTE references so the
 ...
 * around a star; the assemblers reject a blueprint containing it).
 */
public final class StellarInjectorStructure {
    ...
    private StellarInjectorStructure() {}
